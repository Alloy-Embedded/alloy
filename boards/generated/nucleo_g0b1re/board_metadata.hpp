 ...
 * @brief Generated board metadata fragment for nucleo_g0b1re
 *
 * Auto-generated from boards/*/board.yaml.
 * DO NOT EDIT MANUALLY.
 */

namespace microcore::generated::board_metadata::nucleo_g0b1re {

inline constexpr char board_id[] = "nucleo_g0b1re";
inline constexpr char board_name[] = "Nucleo-G0B1RE";
inline constexpr char board_vendor[] = "STMicroelectronics";
inline constexpr char platform[] = "stm32g0";
inline constexpr char mcu_part_number[] = "STM32G0B1RET6";
inline constexpr char architecture[] = "cortex-m0+";
inline constexpr unsigned int system_clock_hz = 64000000u;

inline constexpr char linker_script[] = "boards/nucleo_g0b1re/STM32G0B1RET6.ld";
