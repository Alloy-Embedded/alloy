...
using DebugUartTxDma = alloy::hal::dma::channel_handle<alloy::hal::dma::PeripheralId::USART2,
                                                       alloy::hal::dma::SignalId::signal_TX>;
using DebugUartRxDma = alloy::hal::dma::channel_handle<alloy::hal::dma::PeripheralId::USART2,
