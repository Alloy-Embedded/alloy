 ...
 * @brief Hardware configuration for Nucleo-G071RB
 *
...
struct BoardInfo {
    static constexpr const char* name = "Nucleo-G071RB";
    static constexpr const char* vendor = "STMicroelectronics";
    static constexpr const char* version = "1.0.0";
    static constexpr const char* mcu = "STM32G071RBT6";
    static constexpr const char* architecture = "cortex-m0+";
    static constexpr const char* description = "STM32 Nucleo-64 development board with STM32G071RB MCU";
    static constexpr const char* url = "https://www.st.com/en/evaluation-tools/nucleo-g071rb.html";
};
...
/**
 * @brief Clock configuration for Nucleo-G071RB
 *
 * Clock Source: HSI
