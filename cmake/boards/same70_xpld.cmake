...
set(MICROCORE_BOARD_NAME "Atmel SAME70 Xplained" CACHE STRING "Board name" FORCE)
set(MICROCORE_MCU "ATSAME70Q21" CACHE STRING "MCU model" FORCE)
...
# Pinout
set(MICROCORE_LED_PIN "PC8" CACHE STRING "On-board LED pin (LED0)")
set(MICROCORE_UART_TX_PIN "PA10" CACHE STRING "UART0 TX pin")
set(MICROCORE_UART_RX_PIN "PA9" CACHE STRING "UART0 RX pin")
...
if(MICROCORE_CODEGEN_AVAILABLE)
    ...
    add_compile_definitions(MICROCORE_GENERATED_NAMESPACE=alloy::hal::atmel::same70::atsame70q21)
endif()
