...
set(ALLOY_BOARD_NAME "Atmel SAMV71 Xplained Ultra" CACHE STRING "Board name" FORCE)
set(ALLOY_MCU "ATSAMV71Q21" CACHE STRING "MCU model" FORCE)
...
set(ALLOY_HAS_CAMERA ON)

# Pinout
set(ALLOY_LED_PIN "PA23" CACHE STRING "On-board LED pin (LED0)")
set(ALLOY_UART_TX_PIN "PB4" CACHE STRING "UART0 TX pin")
set(ALLOY_UART_RX_PIN "PB0" CACHE STRING "UART0 RX pin")
...
if(ALLOY_CODEGEN_AVAILABLE)
    ...
    add_compile_definitions(ALLOY_GENERATED_NAMESPACE=alloy::hal::atmel::samv71::atsamv71q21)
endif()
