...
set(ALLOY_BOARD_NAME "STM32F746 Discovery" CACHE STRING "Board name" FORCE)
set(ALLOY_MCU "STM32F746VG" CACHE STRING "MCU model" FORCE)
set(ALLOY_ARCH "arm-cortex-m7f" CACHE STRING "CPU architecture" FORCE)

# Clock configuration
set(ALLOY_CLOCK_FREQ_HZ 216000000 CACHE STRING "System clock frequency (216 MHz)")
...
set(ALLOY_HAS_DSP ON)
set(ALLOY_HAS_LCD ON)

# Pinout
set(ALLOY_LED_PIN "PI1" CACHE STRING "On-board LED pin (PI1 - Green)")

# Memory
set(ALLOY_FLASH_SIZE_STR "1MB" CACHE STRING "Flash size (human-readable)" FORCE)
set(ALLOY_RAM_SIZE_STR "340KB" CACHE STRING "RAM size (human-readable)" FORCE)
set(ALLOY_FLASH_SIZE 1048576 CACHE STRING "Flash size in bytes" FORCE)
set(ALLOY_RAM_SIZE 348160 CACHE STRING "RAM size in bytes (256KB + 64KB + 16KB + 4KB)" FORCE)
...
if(ALLOY_CODEGEN_AVAILABLE)
    ...
    add_compile_definitions(ALLOY_GENERATED_NAMESPACE=alloy::generated::stm32f746)
endif()
