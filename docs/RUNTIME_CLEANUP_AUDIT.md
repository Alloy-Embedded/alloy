...
| [`src/hal/dma`](/Users/lgili/Documents/01%20-%20Codes/01%20-%20Github/alloy/src/hal/dma) | rewrite | DMA now exposes typed binding handles, but transfer semantics are still missing from `alloy-devices` | finish when `driver_semantics/dma.hpp` is published |
