...
- [x] 1.3 Regen STM32G0 + STM32F4; verify IrqSemanticTraits IRQ numbers match CMSIS.
      (driver_semantics/irq.hpp.j2 template added to emitter; generated via
       alloy_cpp_emit.emit() from peripheral irq_numbers data.
       G071RB: USART1=27, DMA1=9. F401RE: USART1=42.
       test_irq_hal.cpp verified clean on both targets.)
