...
- [ ] 3.1 `enum class InterruptKind { RxComplete, TxComplete,
...
- [ ] 3.3 `port_handle<P>` satisfies `EthernetMac` concept from
...
- [ ] 4.1 Replace hand-rolled `Same70Gmac` callers with
