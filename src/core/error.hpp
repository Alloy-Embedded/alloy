...
///
/// Provides deterministic error handling without exceptions using a legacy
/// Result<T> type (hardcoded to ErrorCode). This enables type-safe error
/// handling with zero runtime overhead in embedded systems.
///
/// NOTE: This is the LEGACY Result API. New code should use result.hpp
/// which provides Result<T, E> with two template parameters.
