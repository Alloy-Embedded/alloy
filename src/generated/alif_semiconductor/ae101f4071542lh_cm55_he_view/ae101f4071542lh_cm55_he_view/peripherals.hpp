...
namespace alloy::generated::ae101f4071542lh_cm55_he_view {
...
namespace traits {
    ...
    constexpr uint32_t num_mhu_instances = 4;
...
namespace cgu {
    ...
    struct Registers {
        ...
        volatile uint32_t ESCLK_SEL;  ///< Offset: 0x10 - Clock Select Register for M55-HE
...
namespace spi {
    ...
    constexpr uint32_t OSPI_BASE = 0x83000000;
...
namespace dac {
    /// Base addresses
    constexpr uint32_t DAC12_BASE = 0x49028000;
...
namespace crypto {
    /// Base addresses
    constexpr uint32_t AES_BASE = 0x83001000;
...
#endif // ALLOY_GENERATED_AE101F4071542LH_CM55_HE_VIEW_PERIPHERALS_HPP