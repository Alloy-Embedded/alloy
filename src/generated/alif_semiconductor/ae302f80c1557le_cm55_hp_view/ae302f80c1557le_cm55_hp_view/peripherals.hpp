...
#ifndef ALLOY_GENERATED_AE302F80C1557LE_CM55_HP_VIEW_PERIPHERALS_HPP
#define ALLOY_GENERATED_AE302F80C1557LE_CM55_HP_VIEW_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::ae302f80c1557le_cm55_hp_view {
...
namespace traits {
    ...
    constexpr bool has_evtrtr1 = true;
    constexpr uint32_t num_evtrtr1_instances = 1;
    constexpr bool has_m55hp = true;
    constexpr uint32_t num_m55hp_instances = 3;
    ...
    constexpr uint32_t num_m55he_instances = 1;
    ...
    template<>
    struct peripheral_count<struct evtrtr1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct m55hp_tag> {
        static constexpr uint32_t value = 3;
    };
    template<>
...
namespace mhu {
    /// Base addresses
    constexpr uint32_t MHU_SECPU_M55HP_0_RX_BASE = 0x40040000;
    constexpr uint32_t MHU_M55HP_SECPU_0_TX_BASE = 0x40050000;
    constexpr uint32_t MHU_SECPU_M55HP_1_RX_BASE = 0x40060000;
    constexpr uint32_t MHU_M55HP_SECPU_1_TX_BASE = 0x40070000;
    constexpr uint32_t MHU_M55HE_M55HP_0_RX_BASE = 0x40080000;
    constexpr uint32_t MHU_M55HP_M55HE_0_TX_BASE = 0x40090000;
    constexpr uint32_t MHU_M55HE_M55HP_1_RX_BASE = 0x400A0000;
    constexpr uint32_t MHU_M55HP_M55HE_1_TX_BASE = 0x400B0000;
    ...
    /// Peripheral instances
    inline Registers* MHU_SECPU_M55HP_0_RX = reinterpret_cast<Registers*>(MHU_SECPU_M55HP_0_RX_BASE);
    inline Registers* MHU_M55HP_SECPU_0_TX = reinterpret_cast<Registers*>(MHU_M55HP_SECPU_0_TX_BASE);
    inline Registers* MHU_SECPU_M55HP_1_RX = reinterpret_cast<Registers*>(MHU_SECPU_M55HP_1_RX_BASE);
    inline Registers* MHU_M55HP_SECPU_1_TX = reinterpret_cast<Registers*>(MHU_M55HP_SECPU_1_TX_BASE);
    inline Registers* MHU_M55HE_M55HP_0_RX = reinterpret_cast<Registers*>(MHU_M55HE_M55HP_0_RX_BASE);
    inline Registers* MHU_M55HP_M55HE_0_TX = reinterpret_cast<Registers*>(MHU_M55HP_M55HE_0_TX_BASE);
    inline Registers* MHU_M55HE_M55HP_1_RX = reinterpret_cast<Registers*>(MHU_M55HE_M55HP_1_RX_BASE);
    inline Registers* MHU_M55HP_M55HE_1_TX = reinterpret_cast<Registers*>(MHU_M55HP_M55HE_1_TX_BASE);
...
namespace dma {
    /// Base addresses
    constexpr uint32_t DMA1_SEC_BASE = 0x400C0000;
    constexpr uint32_t DMA1_NS_BASE = 0x400E0000;
    ...
    /// Peripheral instances
    inline Registers* DMA1_SEC = reinterpret_cast<Registers*>(DMA1_SEC_BASE);
    inline Registers* DMA1_NS = reinterpret_cast<Registers*>(DMA1_NS_BASE);
...
namespace npu {
    /// Base addresses
    constexpr uint32_t NPU_HP_BASE = 0x400E1000;

    /// NPU Register structure
    struct Registers {
        volatile uint32_t NPUHP_ID;  ///< Offset: 0x00 - ID Register
        volatile uint32_t NPUHP_STATUS;  ///< Offset: 0x04 - Status Register
        volatile uint32_t NPUHP_CMD;  ///< Offset: 0x08 - Command Register
        volatile uint32_t NPUHP_RESET;  ///< Offset: 0x0C - Reset Register
        volatile uint32_t NPUHP_QBASE0;  ///< Offset: 0x10 - Queue Base Register 0
        volatile uint32_t NPUHP_QBASE1;  ///< Offset: 0x14 - Queue Base Register 1
        volatile uint32_t NPUHP_QREAD;  ///< Offset: 0x18 - Queue Read Register
        volatile uint32_t NPUHP_QCONFIG;  ///< Offset: 0x1C - Queue Configuration Register
        volatile uint32_t NPUHP_QSIZE;  ///< Offset: 0x20 - Queue Size Register
        volatile uint32_t NPUHP_PROT;  ///< Offset: 0x24 - Protection Register
        volatile uint32_t NPUHP_CONFIG;  ///< Offset: 0x28 - Module Configuration Register
        volatile uint32_t NPUHP_LOCK;  ///< Offset: 0x2C - Lock Register
        volatile uint32_t NPUHP_REGIONCFG;  ///< Offset: 0x3C - Region Configuration Register
        volatile uint32_t NPUHP_AXI_LIMIT0;  ///< Offset: 0x40 - AXI Limit Register 0
        volatile uint32_t NPUHP_AXI_LIMIT1;  ///< Offset: 0x44 - AXI Limit Register 1
        volatile uint32_t NPUHP_AXI_LIMIT2;  ///< Offset: 0x48 - AXI Limit Register 2
        volatile uint32_t NPUHP_AXI_LIMIT3;  ///< Offset: 0x4C - AXI Limit Register 3
        volatile uint32_t NPUHP_BASEP0;  ///< Offset: 0x80 - Base Pointer Register 0
        volatile uint32_t NPUHP_BASEP1;  ///< Offset: 0x84 - Base Pointer Register 1
        volatile uint32_t NPUHP_BASEP2;  ///< Offset: 0x88 - Base Pointer Register 2
        volatile uint32_t NPUHP_BASEP3;  ///< Offset: 0x8C - Base Pointer Register 3
        volatile uint32_t NPUHP_BASEP4;  ///< Offset: 0x90 - Base Pointer Register 4
        volatile uint32_t NPUHP_BASEP5;  ///< Offset: 0x94 - Base Pointer Register 5
        volatile uint32_t NPUHP_BASEP6;  ///< Offset: 0x98 - Base Pointer Register 6
        volatile uint32_t NPUHP_BASEP7;  ///< Offset: 0x9C - Base Pointer Register 7
        volatile uint32_t NPUHP_BASEP8;  ///< Offset: 0xA0 - Base Pointer Register 8
        volatile uint32_t NPUHP_BASEP9;  ///< Offset: 0xA4 - Base Pointer Register 9
        volatile uint32_t NPUHP_BASEP10;  ///< Offset: 0xA8 - Base Pointer Register 10
        volatile uint32_t NPUHP_BASEP11;  ///< Offset: 0xAC - Base Pointer Register 11
        volatile uint32_t NPUHP_BASEP12;  ///< Offset: 0xB0 - Base Pointer Register 12
        volatile uint32_t NPUHP_BASEP13;  ///< Offset: 0xB4 - Base Pointer Register 13
        volatile uint32_t NPUHP_BASEP14;  ///< Offset: 0xB8 - Base Pointer Register 14
        volatile uint32_t NPUHP_BASEP15;  ///< Offset: 0xBC - Base Pointer Register 15
        volatile uint32_t NPUHP_PMCR;  ///< Offset: 0x180 - Performance Monitor Control Register
        volatile uint32_t NPUHP_PMCNTENSET;  ///< Offset: 0x184 - Performance Monitor Count Enable Set Register
        volatile uint32_t NPUHP_PMCNTENCLR;  ///< Offset: 0x188 - Performance Monitor Count Enable Clear Register
        volatile uint32_t NPUHP_PMOVSSET;  ///< Offset: 0x18C - Performance Monitor Overflow Status Set Register
        volatile uint32_t NPUHP_PMOVSCLR;  ///< Offset: 0x190 - Performance Monitor Overflow Status Clear Register
        volatile uint32_t NPUHP_PMINTSET;  ///< Offset: 0x194 - Performance Monitor Interrupt Set Register
        volatile uint32_t NPUHP_PMINTCLR;  ///< Offset: 0x198 - Performance Monitor Interrupt Clear Register
        volatile uint32_t NPUHP_PMCCNTR_LO;  ///< Offset: 0x1A0 - Performance Monitor Cycle Count Low Register
        volatile uint32_t NPUHP_PMCCNTR_HI;  ///< Offset: 0x1A4 - Performance Monitor Cycle Count High Register
        volatile uint32_t NPUHP_PMCAXI_CHAN;  ///< Offset: 0x1AC - Performance Monitor AXI Channel Select Register
        volatile uint32_t NPUHP_PMEVCNTR0;  ///< Offset: 0x300 - Performance Monitor Event Count Register 0
        volatile uint32_t NPUHP_PMEVCNTR1;  ///< Offset: 0x304 - Performance Monitor Event Count Register 1
        volatile uint32_t NPUHP_PMEVCNTR2;  ///< Offset: 0x308 - Performance Monitor Event Count Register 2
        volatile uint32_t NPUHP_PMEVCNTR3;  ///< Offset: 0x30C - Performance Monitor Event Count Register 3
        volatile uint32_t NPUHP_PMEVTYPER0;  ///< Offset: 0x380 - Performance Monitor Event Type Register 0
        volatile uint32_t NPUHP_PMEVTYPER1;  ///< Offset: 0x384 - Performance Monitor Event Type Register 1
        volatile uint32_t NPUHP_PMEVTYPER2;  ///< Offset: 0x388 - Performance Monitor Event Type Register 2
        volatile uint32_t NPUHP_PMEVTYPER3;  ///< Offset: 0x38C - Performance Monitor Event Type Register 3
        volatile uint32_t NPUHP_PID4;  ///< Offset: 0xFD0 - Peripheral ID Register 4
        volatile uint32_t NPUHP_PID5;  ///< Offset: 0xFD4 - Peripheral ID Register 5
        volatile uint32_t NPUHP_PID6;  ///< Offset: 0xFD8 - Peripheral ID Register 6
        volatile uint32_t NPUHP_PID7;  ///< Offset: 0xFDC - Peripheral ID Register 7
        volatile uint32_t NPUHP_PID0;  ///< Offset: 0xFE0 - Peripheral ID Register 0
        volatile uint32_t NPUHP_PID1;  ///< Offset: 0xFE4 - Peripheral ID Register 1
        volatile uint32_t NPUHP_PID2;  ///< Offset: 0xFE8 - Peripheral ID Register 2
        volatile uint32_t NPUHP_PID3;  ///< Offset: 0xFEC - Peripheral ID Register 3
        volatile uint32_t NPUHP_CID0;  ///< Offset: 0xFF0 - Component ID Register 0
        volatile uint32_t NPUHP_CID1;  ///< Offset: 0xFF4 - Component ID Register 1
        volatile uint32_t NPUHP_CID2;  ///< Offset: 0xFF8 - Component ID Register 2
        volatile uint32_t NPUHP_CID3;  ///< Offset: 0xFFC - Component ID Register 3
    };

    /// Peripheral instances
    inline Registers* NPU_HP = reinterpret_cast<Registers*>(NPU_HP_BASE);
...
namespace evtrtr1 {
    /// Base addresses
    constexpr uint32_t EVTRTR1_BASE = 0x400E2000;

    /// EVTRTR1 Register structure
    struct Registers {
    ...
    /// Peripheral instances
    inline Registers* EVTRTR1 = reinterpret_cast<Registers*>(EVTRTR1_BASE);
...
namespace m55hp {
    /// Base addresses
    constexpr uint32_t M55HP_CFG_BASE = 0x400F0000;
    constexpr uint32_t M55HP_NVIC_S_BASE = 0xE000E100;
    constexpr uint32_t M55HP_NVIC_NS_BASE = 0xE002E100;

    /// M55HP Register structure
    struct Registers {
        volatile uint32_t HP_DMA_CTRL;  ///< Offset: 0x00 - DMA1 Boot Control Register
        volatile uint32_t HP_DMA_IRQ;  ///< Offset: 0x04 - DMA1 Boot IRQ Non-Secure Register
        volatile uint32_t HP_DMA_PERIPH;  ///< Offset: 0x08 - DMA1 Boot Peripheral Non-Secure Register
        volatile uint32_t HP_DMA_SEL;  ///< Offset: 0x0C - DMA1 Select Register
        volatile uint32_t HP_CLK_ENA;  ///< Offset: 0x10 - Peripheral Clock Enable Register
    };

    /// Peripheral instances
    inline Registers* M55HP_CFG = reinterpret_cast<Registers*>(M55HP_CFG_BASE);
    inline Registers* M55HP_NVIC_S = reinterpret_cast<Registers*>(M55HP_NVIC_S_BASE);
    inline Registers* M55HP_NVIC_NS = reinterpret_cast<Registers*>(M55HP_NVIC_NS_BASE);
...
namespace wdg {
    /// Base addresses
    constexpr uint32_t WDT_HP_CTRL_BASE = 0x40100000;
    constexpr uint32_t WDT_HP_REFRESH_BASE = 0x40101000;
    ...
    /// Peripheral instances
    inline Registers* WDT_HP_CTRL = reinterpret_cast<Registers*>(WDT_HP_CTRL_BASE);
    inline Registers* WDT_HP_REFRESH = reinterpret_cast<Registers*>(WDT_HP_REFRESH_BASE);
...
#endif // ALLOY_GENERATED_AE302F80C1557LE_CM55_HP_VIEW_PERIPHERALS_HPP