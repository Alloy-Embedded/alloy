...
#ifndef ALLOY_GENERATED_AE722F80F55D5LS_CM55_HE_VIEW_PERIPHERALS_HPP
#define ALLOY_GENERATED_AE722F80F55D5LS_CM55_HE_VIEW_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::ae722f80f55d5ls_cm55_he_view {
...
namespace traits {
    ...
    constexpr uint32_t num_wdg_instances = 6;
    ...
    constexpr uint32_t num_mhu_instances = 12;
...
namespace clkctl {
    ...
    struct Registers {
        ...
        volatile uint32_t HOSTCPUCLK_CTRL;  ///< Offset: 0x800 - APSS_CLK Clock Control Register
        volatile uint32_t HOSTCPUCLK_DIV0;  ///< Offset: 0x804 - APSS_CLK Clock Divider 0 Register
        volatile uint32_t HOSTCPUCLK_DIV1;  ///< Offset: 0x808 - APSS_CLK Clock Divider 1 Register
...
namespace wdg {
    /// Base addresses
    constexpr uint32_t WDT_AP_CTRL_BASE = 0x1A300000;
    constexpr uint32_t WDT_AP_REFRESH_BASE = 0x1A310000;
    constexpr uint32_t WDT_AP_S_CTRL_BASE = 0x1A320000;
    constexpr uint32_t WDT_AP_S_REFRESH_BASE = 0x1A330000;
    constexpr uint32_t WDT_HE_CTRL_BASE = 0x40100000;
    constexpr uint32_t WDT_HE_REFRESH_BASE = 0x40101000;

    /// WDG Register structure
    struct Registers {
        volatile uint32_t WDT_WRR;  ///< Offset: 0x00 - Watchdog Refresh Register
        volatile uint32_t WDT_WCS;  ///< Offset: 0x00 - Watchdog Control and Status Register
        volatile uint32_t WDT_WOR_31_0;  ///< Offset: 0x08 - Watchdog Offset Register, lower bits
        volatile uint32_t WDT_WOR_63_32;  ///< Offset: 0x0C - Watchdog Offset Register, upper bits
        volatile uint32_t WDT_WCV_31_0;  ///< Offset: 0x10 - Watchdog Compare Value Register, lower bits
        volatile uint32_t WDT_WCV_63_32;  ///< Offset: 0x14 - Watchdog Compare Value Register, upper bits
        volatile uint32_t WDT_IIDR;  ///< Offset: 0xFCC - Interface Identification Register
    };

    /// Peripheral instances
    inline Registers* WDT_AP_CTRL = reinterpret_cast<Registers*>(WDT_AP_CTRL_BASE);
    inline Registers* WDT_AP_REFRESH = reinterpret_cast<Registers*>(WDT_AP_REFRESH_BASE);
    inline Registers* WDT_AP_S_CTRL = reinterpret_cast<Registers*>(WDT_AP_S_CTRL_BASE);
    inline Registers* WDT_AP_S_REFRESH = reinterpret_cast<Registers*>(WDT_AP_S_REFRESH_BASE);
...
namespace mhu {
    /// Base addresses
    constexpr uint32_t MHU_A32_M55HE_0_RX_BASE = 0x40000000;
    constexpr uint32_t MHU_M55HE_A32_0_TX_BASE = 0x40010000;
    constexpr uint32_t MHU_A32_M55HE_1_RX_BASE = 0x40020000;
    constexpr uint32_t MHU_M55HE_A32_1_TX_BASE = 0x40030000;
    ...
    /// Peripheral instances
    inline Registers* MHU_A32_M55HE_0_RX = reinterpret_cast<Registers*>(MHU_A32_M55HE_0_RX_BASE);
    inline Registers* MHU_M55HE_A32_0_TX = reinterpret_cast<Registers*>(MHU_M55HE_A32_0_TX_BASE);
    inline Registers* MHU_A32_M55HE_1_RX = reinterpret_cast<Registers*>(MHU_A32_M55HE_1_RX_BASE);
    inline Registers* MHU_M55HE_A32_1_TX = reinterpret_cast<Registers*>(MHU_M55HE_A32_1_TX_BASE);
...
#endif // ALLOY_GENERATED_AE722F80F55D5LS_CM55_HE_VIEW_PERIPHERALS_HPP