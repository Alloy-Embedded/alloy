...
extern "C" {
    ...
    void UART2_RX_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void DUALTIMER_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void SPI_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void UART3_RX_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void UART4_RX_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}