...
namespace crypto {
    ...
    namespace continue_bits {
        constexpr uint32_t CONTINUE = (1U << 0);  ///< Set this bit to 1 to continue GCM operation.
    }
...
namespace dma {
    ...
    struct Registers {
        volatile uint32_t IN_CONF0_CH%s;  ///< Offset: 0x00 - Configure 0 register of Rx channel 0
        volatile uint32_t IN_CONF1_CH%s;  ///< Offset: 0x04 - Configure 1 register of Rx channel 0
        volatile uint32_t IN_INT_RAW_CH%s;  ///< Offset: 0x08 - Raw status interrupt of Rx channel 0
        volatile uint32_t IN_INT_ST_CH%s;  ///< Offset: 0x0C - Masked interrupt of Rx channel 0
        volatile uint32_t IN_INT_ENA_CH%s;  ///< Offset: 0x10 - Interrupt enable bits of Rx channel 0
        volatile uint32_t IN_INT_CLR_CH%s;  ///< Offset: 0x14 - Interrupt clear bits of Rx channel 0
        volatile uint32_t INFIFO_STATUS_CH%s;  ///< Offset: 0x18 - Receive FIFO status of Rx channel 0
        volatile uint32_t IN_POP_CH%s;  ///< Offset: 0x1C - Pop control register of Rx channel 0
        volatile uint32_t IN_LINK_CH%s;  ///< Offset: 0x20 - Link descriptor configure and control register of Rx channel 0
        volatile uint32_t IN_STATE_CH%s;  ///< Offset: 0x24 - Receive status of Rx channel 0
        volatile uint32_t IN_SUC_EOF_DES_ADDR_CH%s;  ///< Offset: 0x28 - Inlink descriptor address when EOF occurs of Rx channel 0
        volatile uint32_t IN_ERR_EOF_DES_ADDR_CH%s;  ///< Offset: 0x2C - Inlink descriptor address when errors occur of Rx channel 0
        volatile uint32_t IN_DSCR_CH%s;  ///< Offset: 0x30 - Current inlink descriptor address of Rx channel 0
        volatile uint32_t IN_DSCR_BF0_CH%s;  ///< Offset: 0x34 - The last inlink descriptor address of Rx channel 0
        volatile uint32_t IN_DSCR_BF1_CH%s;  ///< Offset: 0x38 - The second-to-last inlink descriptor address of Rx channel 0
        volatile uint32_t IN_WIGHT_CH%s;  ///< Offset: 0x3C - Weight register of Rx channel 0
        volatile uint32_t IN_PRI_CH%s;  ///< Offset: 0x44 - Priority register of Rx channel 0
        volatile uint32_t IN_PERI_SEL_CH%s;  ///< Offset: 0x48 - Peripheral selection of Rx channel 0
        volatile uint32_t OUT_CONF0_CH%s;  ///< Offset: 0x60 - Configure 0 register of Tx channel 0
        volatile uint32_t OUT_CONF1_CH%s;  ///< Offset: 0x64 - Configure 1 register of Tx channel 0
        volatile uint32_t OUT_INT_RAW_CH%s;  ///< Offset: 0x68 - Raw status interrupt of Tx channel 0
        volatile uint32_t OUT_INT_ST_CH%s;  ///< Offset: 0x6C - Masked interrupt of Tx channel 0
        volatile uint32_t OUT_INT_ENA_CH%s;  ///< Offset: 0x70 - Interrupt enable bits of Tx channel 0
        volatile uint32_t OUT_INT_CLR_CH%s;  ///< Offset: 0x74 - Interrupt clear bits of Tx channel 0
        volatile uint32_t OUTFIFO_STATUS_CH%s;  ///< Offset: 0x78 - Transmit FIFO status of Tx channel 0
        volatile uint32_t OUT_PUSH_CH%s;  ///< Offset: 0x7C - Push control register of Rx channel 0
        volatile uint32_t OUT_LINK_CH%s;  ///< Offset: 0x80 - Link descriptor configure and control register of Tx channel 0
        volatile uint32_t OUT_STATE_CH%s;  ///< Offset: 0x84 - Transmit status of Tx channel 0
        volatile uint32_t OUT_EOF_DES_ADDR_CH%s;  ///< Offset: 0x88 - Outlink descriptor address when EOF occurs of Tx channel 0
        volatile uint32_t OUT_EOF_BFR_DES_ADDR_CH%s;  ///< Offset: 0x8C - The last outlink descriptor address when EOF occurs of...
        volatile uint32_t OUT_DSCR_CH%s;  ///< Offset: 0x90 - Current inlink descriptor address of Tx channel 0
        volatile uint32_t OUT_DSCR_BF0_CH%s;  ///< Offset: 0x94 - The last inlink descriptor address of Tx channel 0
        volatile uint32_t OUT_DSCR_BF1_CH%s;  ///< Offset: 0x98 - The second-to-last inlink descriptor address of Tx channel 0
        volatile uint32_t OUT_WIGHT_CH%s;  ///< Offset: 0x9C - Weight register of Rx channel 0
        volatile uint32_t OUT_PRI_CH%s;  ///< Offset: 0xA4 - Priority register of Tx channel 0.
        volatile uint32_t OUT_PERI_SEL_CH%s;  ///< Offset: 0xA8 - Peripheral selection of Tx channel 0
        ...
        volatile uint32_t IN_SRAM_SIZE_CH%s;  ///< Offset: 0x3CC - Receive L2 FIFO depth of Rx channel 0
        volatile uint32_t OUT_SRAM_SIZE_CH%s;  ///< Offset: 0x3D0 - Transmit L2 FIFO depth of Tx channel 0
    ...
    /// IN_WIGHT_CH%s Register bits
    namespace in_wight_ch%s_bits {
    ...
    /// OUT_WIGHT_CH%s Register bits
    namespace out_wight_ch%s_bits {
    ...
    /// IN_SRAM_SIZE_CH%s Register bits
    namespace in_sram_size_ch%s_bits {
    ...
    /// OUT_SRAM_SIZE_CH%s Register bits
    namespace out_sram_size_ch%s_bits {
...
namespace rmt {
    ...
    struct Registers {
        ...
        volatile uint32_t CH%s_TX_CONF0;  ///< Offset: 0x20 - Channel %s configure register 0
        volatile uint32_t CH%s_RX_CONF0;  ///< Offset: 0x30 - Channel %s configure register 0
        volatile uint32_t CH%s_RX_CONF1;  ///< Offset: 0x34 - Channel %s configure register 1
        volatile uint32_t CH%s_TX_STATUS;  ///< Offset: 0x50 - Channel %s status register
        volatile uint32_t CH%s_RX_STATUS;  ///< Offset: 0x60 - Channel %s status register
    ...
    namespace int_raw_bits {
        ...
        constexpr uint32_t CH%s_TX_ERR = (1U << 4);  ///< The interrupt raw bit for CHANNEL%s. Triggered when error occurs.
        ...
        constexpr uint32_t CH%s_RX_END = (1U << 16);  ///< The interrupt raw bit for CHANNEL4. Triggered when reception done.
        constexpr uint32_t CH%s_RX_ERR = (1U << 20);  ///< The interrupt raw bit for CHANNEL4. Triggered when error occurs.
        constexpr uint32_t CH%s_RX_THR_EVENT = (1U << 24);  ///< The interrupt raw bit for CHANNEL4. Triggered when receiver receive more data than configured value.
    ...
    namespace int_st_bits {
        ...
        constexpr uint32_t CH%s_TX_ERR = (1U << 4);  ///< The masked interrupt status bit for CH%s_ERR_INT.
        constexpr uint32_t CH%s_TX_THR_EVENT = (1U << 8);  ///< The masked interrupt status bit for CH%s_TX_THR_EVENT_INT.
        constexpr uint32_t CH%s_TX_LOOP = (1U << 12);  ///< The masked interrupt status bit for CH%s_TX_LOOP_INT.
        constexpr uint32_t CH%s_RX_END = (1U << 16);  ///< The masked interrupt status bit for CH4_RX_END_INT.
        constexpr uint32_t CH%s_RX_ERR = (1U << 20);  ///< The masked interrupt status bit for CH4_ERR_INT.
        constexpr uint32_t CH%s_RX_THR_EVENT = (1U << 24);  ///< The masked interrupt status bit for CH4_RX_THR_EVENT_INT.
    ...
    namespace int_ena_bits {
        ...
        constexpr uint32_t CH%s_TX_ERR = (1U << 4);  ///< The interrupt enable bit for CH%s_ERR_INT.
        constexpr uint32_t CH%s_TX_THR_EVENT = (1U << 8);  ///< The interrupt enable bit for CH%s_TX_THR_EVENT_INT.
        constexpr uint32_t CH%s_TX_LOOP = (1U << 12);  ///< The interrupt enable bit for CH%s_TX_LOOP_INT.
        constexpr uint32_t CH%s_RX_END = (1U << 16);  ///< The interrupt enable bit for CH4_RX_END_INT.
        constexpr uint32_t CH%s_RX_ERR = (1U << 20);  ///< The interrupt enable bit for CH4_ERR_INT.
        constexpr uint32_t CH%s_RX_THR_EVENT = (1U << 24);  ///< The interrupt enable bit for CH4_RX_THR_EVENT_INT.
    ...
    namespace int_clr_bits {
        ...
        constexpr uint32_t CH%s_TX_ERR = (1U << 4);  ///< Set this bit to clear theCH%s_ERR_INT interrupt.
        ...
        constexpr uint32_t CH%s_RX_END = (1U << 16);  ///< Set this bit to clear theCH4_RX_END_INT interrupt.
        constexpr uint32_t CH%s_RX_ERR = (1U << 20);  ///< Set this bit to clear theCH4_ERR_INT interrupt.
        constexpr uint32_t CH%s_RX_THR_EVENT = (1U << 24);  ///< Set this bit to clear theCH4_RX_THR_EVENT_INT interrupt.
    ...
    namespace ref_cnt_rst_bits {
        constexpr uint32_t CH%s = (1U << 0);  ///< This register is used to reset the clock divider of CHANNEL%s.
    }
