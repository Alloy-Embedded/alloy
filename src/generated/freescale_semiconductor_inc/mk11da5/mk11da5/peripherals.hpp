...
namespace fmc {
    ...
    struct Registers {
        ...
        volatile uint32_t DATAW1S%sU;  ///< Offset: 0x210 - Cache Data Storage (upper word)
        volatile uint32_t DATAW1S%sL;  ///< Offset: 0x214 - Cache Data Storage (lower word)
        volatile uint32_t DATAW2S%sU;  ///< Offset: 0x220 - Cache Data Storage (upper word)
        volatile uint32_t DATAW2S%sL;  ///< Offset: 0x224 - Cache Data Storage (lower word)
        volatile uint32_t DATAW3S%sU;  ///< Offset: 0x230 - Cache Data Storage (upper word)
        volatile uint32_t DATAW3S%sL;  ///< Offset: 0x234 - Cache Data Storage (lower word)
    };
