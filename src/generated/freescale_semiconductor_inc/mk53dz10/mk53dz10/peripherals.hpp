/// Auto-generated code for MK53DZ10
/// Generated by Alloy Code Generator
/// Source: nxp_mk53.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:01:12
#ifndef ALLOY_GENERATED_MK53DZ10_PERIPHERALS_HPP
#define ALLOY_GENERATED_MK53DZ10_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mk53dz10 {
...
namespace tsi0 {
    ...
    struct Registers {
        ...
        volatile uint32_t THRESHLD%s;  ///< Offset: 0x120 - Channel n threshold register
    };
    ...
    /// THRESHLD%s Register bits
    namespace threshld%s_bits {
...
namespace sim {
    ...
    namespace sopt1_bits {
        ...
        constexpr uint32_t USBSTBY = (1U << 30);  ///< USB voltage regulator in standby mode
    ...
    namespace scgc3_bits {
        constexpr uint32_t RNGB = (1U << 0);  ///< RNGB Clock Gate Control
...
namespace rng {
    ...
    struct Registers {
        volatile uint32_t VER;  ///< Offset: 0x00 - RNGB Version ID Register
        volatile uint32_t CMD;  ///< Offset: 0x04 - RNGB Command Register
        volatile uint32_t CR;  ///< Offset: 0x08 - RNGB Control Register
        volatile uint32_t SR;  ///< Offset: 0x0C - RNGB Status Register
        volatile uint32_t ESR;  ///< Offset: 0x10 - RNGB Error Status Register
        volatile uint32_t OUT;  ///< Offset: 0x14 - RNGB Output FIFO
    };
    ...
    /// VER Register bits
    namespace ver_bits {
        constexpr uint32_t MINOR = (8 << 0);  ///< Minor version number.
        constexpr uint32_t MAJOR = (8 << 8);  ///< Major version number.
        constexpr uint32_t TYPE = (4 << 28);  ///< Random number generator type
    }

    /// CMD Register bits
    namespace cmd_bits {
        constexpr uint32_t ST = (1U << 0);  ///< Self test.
        constexpr uint32_t GS = (1U << 1);  ///< Generate seed.
        constexpr uint32_t CI = (1U << 4);  ///< Clear interrupt.
        constexpr uint32_t CE = (1U << 5);  ///< Clear error.
        constexpr uint32_t SR = (1U << 6);  ///< Software reset.
    }

    /// CR Register bits
    namespace cr_bits {
        constexpr uint32_t FUFMOD = (2 << 0);  ///< FIFO underflow response mode.
        constexpr uint32_t AR = (1U << 4);  ///< Auto-reseed.
        constexpr uint32_t MASKDONE = (1U << 5);  ///< Mask done interrupt.
        constexpr uint32_t MASKERR = (1U << 6);  ///< Mask error interrupt.
    }

    /// SR Register bits
    namespace sr_bits {
        constexpr uint32_t BUSY = (1U << 1);  ///< Busy.
        constexpr uint32_t SLP = (1U << 2);  ///< Sleep.
        constexpr uint32_t RS = (1U << 3);  ///< Reseed needed.
        constexpr uint32_t STDN = (1U << 4);  ///< Self test done.
        constexpr uint32_t SDN = (1U << 5);  ///< Seed done.
        constexpr uint32_t NSDN = (1U << 6);  ///< New seed done.
        constexpr uint32_t FIFO_LVL = (4 << 8);  ///< FIFO level.
        constexpr uint32_t FIFO_SIZE = (4 << 12);  ///< FIFO size.
        constexpr uint32_t ERR = (1U << 16);  ///< Error.
        constexpr uint32_t ST_PF = (3 << 21);  ///< Self Test Pass Fail.
        constexpr uint32_t STATPF = (8 << 24);  ///< Statistics test pass fail.
    }

    /// ESR Register bits
    namespace esr_bits {
        constexpr uint32_t LFE = (1U << 0);  ///< Linear feedback shift register (LFSR) error.
        constexpr uint32_t OSCE = (1U << 1);  ///< Oscillator error.
        constexpr uint32_t STE = (1U << 2);  ///< Self test error.
        constexpr uint32_t SATE = (1U << 3);  ///< Statistical test error.
        constexpr uint32_t FUFE = (1U << 4);  ///< FIFO underflow error
    }
...
namespace lcd {
    ...
    struct Registers {
        ...
        volatile uint32_t BPEN%s;  ///< Offset: 0x18 - LCD backplane enable register
...
#endif // ALLOY_GENERATED_MK53DZ10_PERIPHERALS_HPP