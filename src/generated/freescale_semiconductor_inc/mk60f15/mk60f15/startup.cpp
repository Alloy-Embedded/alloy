...
extern "C" {
    ...
    void PORTF_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void NFC_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void I2S1_Tx_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void I2S1_Rx_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}