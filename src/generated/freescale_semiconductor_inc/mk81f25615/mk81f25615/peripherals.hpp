/// Auto-generated code for MK81F25615
/// Generated by Alloy Code Generator
/// Source: nxp_mk81.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:01:19
#ifndef ALLOY_GENERATED_MK81F25615_PERIPHERALS_HPP
#define ALLOY_GENERATED_MK81F25615_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mk81f25615 {
...
namespace rtc {
    ...
    /// TTR Register bits
    namespace ttr_bits {
        constexpr uint32_t VDTH = (3 << 0);  ///< Voltage Detect Trim High
        constexpr uint32_t VDTL = (3 << 3);  ///< Voltage Detect Trim Low
...
namespace dry {
    ...
    struct Registers {
        ...
        volatile uint32_t ATR%s;  ///< Offset: 0x30 - DryIce Active Tamper Register
        volatile uint32_t PGFR%s;  ///< Offset: 0x40 - DryIce Pin Glitch Filter Register
        ...
        volatile uint32_t SKR%s;  ///< Offset: 0x1000 - Secure Key Register
...
namespace sim {
    ...
    namespace scgc5_bits {
        ...
        constexpr uint32_t DRYICE = (1U << 2);  ///< DryIce Access Control
        constexpr uint32_t SECREG = (1U << 3);  ///< Secure Register Access Control
...
namespace otfad {
    ...
    struct Registers {
        ...
        volatile uint32_t CTX%s_KEY_W0;  ///< Offset: 0x100 - AES Key Word0
        volatile uint32_t CTX%s_KEY_W1;  ///< Offset: 0x104 - AES Key Word1
        volatile uint32_t CTX%s_KEY_W2;  ///< Offset: 0x108 - AES Key Word2
        volatile uint32_t CTX%s_KEY_W3;  ///< Offset: 0x10C - AES Key Word3
        volatile uint32_t CTX%s_CTR_W0;  ///< Offset: 0x110 - AES Counter Word0
        volatile uint32_t CTX%s_CTR_W1;  ///< Offset: 0x114 - AES Counter Word1
        volatile uint32_t CTX%s_RGD_W0;  ///< Offset: 0x118 - AES Region Descriptor Word0
        volatile uint32_t CTX%s_RGD_W1;  ///< Offset: 0x11C - AES Region Descriptor Word1
    };
    ...
    /// CTX%s_KEY_W0 Register bits
    namespace ctx%s_key_w0_bits {
        constexpr uint32_t W0KEY = (32 << 0);  ///< AES Key
    }

    /// CTX%s_KEY_W1 Register bits
    namespace ctx%s_key_w1_bits {
        constexpr uint32_t W1KEY = (32 << 0);  ///< AES Key
    }

    /// CTX%s_KEY_W2 Register bits
    namespace ctx%s_key_w2_bits {
        constexpr uint32_t W2KEY = (32 << 0);  ///< AES Key
    }

    /// CTX%s_KEY_W3 Register bits
    namespace ctx%s_key_w3_bits {
        constexpr uint32_t W3KEY = (32 << 0);  ///< AES Key
    }

    /// CTX%s_CTR_W0 Register bits
    namespace ctx%s_ctr_w0_bits {
        constexpr uint32_t W0CTR = (32 << 0);  ///< AES Counter
    }

    /// CTX%s_CTR_W1 Register bits
    namespace ctx%s_ctr_w1_bits {
        constexpr uint32_t W1CTR = (32 << 0);  ///< AES Counter
    }

    /// CTX%s_RGD_W0 Register bits
    namespace ctx%s_rgd_w0_bits {
        constexpr uint32_t SRTADDR = (22 << 10);  ///< Start Address
    }

    /// CTX%s_RGD_W1 Register bits
    namespace ctx%s_rgd_w1_bits {
        constexpr uint32_t VLD = (1U << 0);  ///< Valid
...
#endif // ALLOY_GENERATED_MK81F25615_PERIPHERALS_HPP