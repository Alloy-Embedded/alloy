...
extern "C" {
    ...
    void PIT0CH0_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void PIT0CH1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void PIT0CH2_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void PIT0CH3_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void LPTMR0_LPTMR1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void QuadSPI0_IRQHandler() __attribute__((weak, alias("Default_Handler")));
