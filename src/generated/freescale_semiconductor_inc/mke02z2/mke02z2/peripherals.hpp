/// Auto-generated code for MKE02Z2
/// Generated by Alloy Code Generator
/// Source: nxp_mke02.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:27
#ifndef ALLOY_GENERATED_MKE02Z2_PERIPHERALS_HPP
#define ALLOY_GENERATED_MKE02Z2_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mke02z2 {
...
namespace traits {
    ...
    constexpr bool has_ftmrh = true;
    constexpr uint32_t num_ftmrh_instances = 1;
    ...
    template<>
    struct peripheral_count<struct ftmrh_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace flash {
    /// Base addresses
    constexpr uint32_t FTMRH_FlashConfig_BASE = 0x00000400;
    ...
    struct Registers {
        ...
        volatile uint32_t EEPROT;  ///< Offset: 0x0C - Non-volatile E-Flash Protection Register
    ...
    inline Registers* FTMRH_FlashConfig = reinterpret_cast<Registers*>(FTMRH_FlashConfig_BASE);
    ...
    /// EEPROT Register bits
    namespace eeprot_bits {
        constexpr uint32_t DPS = (3 << 0);  ///< no description available
...
namespace ftmrh {
    ...
    /// FTMRH Register structure
    struct Registers {
        volatile uint32_t FCLKDIV;  ///< Offset: 0x00 - Flash Clock Divider Register
        volatile uint32_t FSEC;  ///< Offset: 0x01 - Flash Security Register
        volatile uint32_t FCCOBIX;  ///< Offset: 0x02 - Flash CCOB Index Register
        volatile uint32_t FCNFG;  ///< Offset: 0x04 - Flash Configuration Register
        volatile uint32_t FERCNFG;  ///< Offset: 0x05 - Flash Error Configuration Register
        volatile uint32_t FSTAT;  ///< Offset: 0x06 - Flash Status Register
        volatile uint32_t FERSTAT;  ///< Offset: 0x07 - Flash Error Status Register
        volatile uint32_t FPROT;  ///< Offset: 0x08 - Flash Protection Register
        volatile uint32_t EEPROT;  ///< Offset: 0x09 - EEPROM Protection Register
        volatile uint32_t FCCOBHI;  ///< Offset: 0x0A - Flash Common Command Object Register:High
        volatile uint32_t FCCOBLO;  ///< Offset: 0x0B - Flash Common Command Object Register: Low
        volatile uint32_t FOPT;  ///< Offset: 0x0C - Flash Option Register
    };

    /// Peripheral instances
    inline Registers* FTMRH = reinterpret_cast<Registers*>(FTMRH_BASE);
    ...
    /// EEPROT Register bits
    namespace eeprot_bits {
        constexpr uint32_t DPS = (3 << 0);  ///< EEPROM Protection Size
        constexpr uint32_t DPOPEN = (1U << 7);  ///< EEPROM Protection Control
    }
...
namespace sim {
    ...
    struct Registers {
        ...
        volatile uint32_t UUIDH;  ///< Offset: 0x14 - Universally Unique Identifier High Register
        volatile uint32_t BUSDIV;  ///< Offset: 0x18 - BUS Clock Divider Register
    };
    ...
    namespace sopt_bits {
        ...
        constexpr uint32_t ADHWT = (2 << 8);  ///< ADC Hardware Trigger Source
        ...
        constexpr uint32_t RXDFE = (1U << 13);  ///< UART0_RX Filter Select
    ...
    namespace pinsel_bits {
        ...
        constexpr uint32_t FTM0PS0 = (1U << 8);  ///< FTM0[0] Port Pin Select
        constexpr uint32_t FTM0PS1 = (1U << 9);  ///< FTM0[1] Port Pin Select
        constexpr uint32_t FTM1PS0 = (1U << 10);  ///< FTM1[0] Port Pin Select
        constexpr uint32_t FTM1PS1 = (1U << 11);  ///< FTM1[1] Port Pin Select
        constexpr uint32_t FTM2PS0 = (1U << 12);  ///< FTM2[0] Port Pin Select
        constexpr uint32_t FTM2PS1 = (1U << 13);  ///< FTM2[1] Port Pin Select
        constexpr uint32_t FTM2PS2 = (1U << 14);  ///< FTM2[2] Port Pin Select
        constexpr uint32_t FTM2PS3 = (1U << 15);  ///< FTM2[3] Port Pin Select
    }
    ...
    /// UUIDH Register bits
    namespace uuidh_bits {
        constexpr uint32_t ID = (32 << 0);  ///< Universally Unique Identifier
    }

    /// BUSDIV Register bits
    namespace busdiv_bits {
        constexpr uint32_t BUSDIV = (1U << 0);  ///< BUS Clock Divider
    }
...
namespace gpio {
    ...
    struct Registers {
        ...
        volatile uint32_t PUEH;  ///< Offset: 0x08 - Port Pullup Enable High Register
...
#endif // ALLOY_GENERATED_MKE02Z2_PERIPHERALS_HPP