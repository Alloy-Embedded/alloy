...
extern "C" {
    ...
    void PORTAE_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void PORTBCD_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void PWT_LPTMR0_IRQHandler() __attribute__((weak, alias("Default_Handler")));
