...
extern "C" {
    ...
    void CAN1_ORed_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void CAN1_Reserved1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void CAN1_Reserved2_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void CAN1_Reserved3_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}