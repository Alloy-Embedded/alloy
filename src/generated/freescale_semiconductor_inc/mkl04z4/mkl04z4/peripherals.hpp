/// Auto-generated code for MKL04Z4
/// Generated by Alloy Code Generator
/// Source: nxp_mkl04.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:56
#ifndef ALLOY_GENERATED_MKL04Z4_PERIPHERALS_HPP
#define ALLOY_GENERATED_MKL04Z4_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::mkl04z4 {
...
namespace nvic {
    ...
    namespace nvic_ipr0_bits {
        constexpr uint32_t PRI_0 = (2 << 6);  ///< Priority of the DMA channel 0 transfer complete interrupt
        constexpr uint32_t PRI_1 = (2 << 14);  ///< Priority of the DMA channel 1 transfer complete interrupt
        constexpr uint32_t PRI_2 = (2 << 22);  ///< Priority of the DMA channel 2 transfer complete interrupt
        constexpr uint32_t PRI_3 = (2 << 30);  ///< Priority of the DMA channel 3 transfer complete interrupt
    }
    ...
    namespace nvic_ipr2_bits {
        ...
        constexpr uint32_t PRI_9 = (2 << 14);  ///< Priority of the Reserved iv 25 interrupt
        constexpr uint32_t PRI_10 = (2 << 22);  ///< Priority of the Serial Peripheral Interface 0 interrupt
        constexpr uint32_t PRI_11 = (2 << 30);  ///< Priority of the Reserved iv 27 interrupt
    }
    ...
    namespace nvic_ipr3_bits {
        ...
        constexpr uint32_t PRI_13 = (2 << 14);  ///< Priority of the Reserved iv 29 interrupt
        constexpr uint32_t PRI_14 = (2 << 22);  ///< Priority of the Reserved iv 30 interrupt
    ...
    namespace nvic_ipr4_bits {
        constexpr uint32_t PRI_16 = (2 << 6);  ///< Priority of the Comparator 0 interrupt
        ...
        constexpr uint32_t PRI_19 = (2 << 30);  ///< Priority of the Reserved iv 35 interrupt
    }
    ...
    namespace nvic_ipr5_bits {
        ...
        constexpr uint32_t PRI_23 = (2 << 30);  ///< Priority of the Reserved iv 39 interrupt
    }

    /// NVIC_IPR6 Register bits
    namespace nvic_ipr6_bits {
        constexpr uint32_t PRI_24 = (2 << 6);  ///< Priority of the Reserved iv 40 interrupt
        constexpr uint32_t PRI_25 = (2 << 14);  ///< Priority of the Reserved iv 41 interrupt
    ...
    namespace nvic_ipr7_bits {
        constexpr uint32_t PRI_28 = (2 << 6);  ///< Priority of the Low-Power Timer interrupt
        constexpr uint32_t PRI_29 = (2 << 14);  ///< Priority of the Reserved iv 45 interrupt
        constexpr uint32_t PRI_30 = (2 << 22);  ///< Priority of the PORTA Pin detect interrupt
        constexpr uint32_t PRI_31 = (2 << 30);  ///< Priority of the PORTB Pin detect interrupt
    }
...
#endif // ALLOY_GENERATED_MKL04Z4_PERIPHERALS_HPP