/// Auto-generated code for MKL27Z644
/// Generated by Alloy Code Generator
/// Source: nxp_mkl27.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:08
#ifndef ALLOY_GENERATED_MKL27Z644_PERIPHERALS_HPP
#define ALLOY_GENERATED_MKL27Z644_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mkl27z644 {
...
namespace usb {
    ...
    namespace keep_alive_ctrl_bits {
        ...
        constexpr uint32_t OWN_OVERRD_EN = (1U << 1);  ///< When set to 1, during KEEP_ALIVE mode, if received token is not SETUP, the OWN bit of current BD will be forced to 0, so usb core will response with NAK
        constexpr uint32_t STOP_ACK_DLY_EN = (1U << 2);  ///< When set to 1, will respond the ipg_stop when usb core state is idle and no AHB transfer; when set to 0, will respond the ipg_stop when no AHB transfer
        constexpr uint32_t AHB_DLY_EN = (1U << 3);  ///< Must be set to 1 to delay the first USB AHB bus transfer until after the USB has exited KEEP_ALIVE mode
...
#endif // ALLOY_GENERATED_MKL27Z644_PERIPHERALS_HPP