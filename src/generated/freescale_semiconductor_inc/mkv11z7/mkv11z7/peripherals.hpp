/// Auto-generated code for MKV11Z7
/// Generated by Alloy Code Generator
/// Source: nxp_mkv11.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:00:25
#ifndef ALLOY_GENERATED_MKV11Z7_PERIPHERALS_HPP
#define ALLOY_GENERATED_MKV11Z7_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mkv11z7 {
...
namespace traits {
    ...
    constexpr bool has_ftm4 = true;
    constexpr uint32_t num_ftm4_instances = 1;
    constexpr bool has_ftm5 = true;
    constexpr uint32_t num_ftm5_instances = 1;
    ...
    template<>
    struct peripheral_count<struct ftm4_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct ftm5_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace ftm4 {
    /// Base addresses
    constexpr uint32_t FTM4_BASE = 0x40027000;

    /// FTM4 Register structure
    struct Registers {
        volatile uint32_t SC;  ///< Offset: 0x00 - Status And Control
        volatile uint32_t CNT;  ///< Offset: 0x04 - Counter
        volatile uint32_t MOD;  ///< Offset: 0x08 - Modulo
    ...
    /// Peripheral instances
    inline Registers* FTM4 = reinterpret_cast<Registers*>(FTM4_BASE);
...
namespace ftm5 {
    /// Base addresses
    constexpr uint32_t FTM5_BASE = 0x40028000;

    /// FTM5 Register structure
    struct Registers {
        volatile uint32_t SC;  ///< Offset: 0x00 - Status And Control
        volatile uint32_t CNT;  ///< Offset: 0x04 - Counter
        volatile uint32_t MOD;  ///< Offset: 0x08 - Modulo
    ...
    /// Peripheral instances
    inline Registers* FTM5 = reinterpret_cast<Registers*>(FTM5_BASE);
...
namespace sim {
    ...
    struct Registers {
        ...
        volatile uint32_t SOPT6;  ///< Offset: 0x1014 - Systems Option Register 6
    ...
    namespace sopt6_bits {
        constexpr uint32_t FTM3FLT0 = (1U << 0);  ///< FTM3 Fault 0 Select
        constexpr uint32_t FTM4FLT0 = (1U << 2);  ///< FTM4 Fault 0 Select
        constexpr uint32_t FTM5FLT0 = (1U << 3);  ///< FTM5 Fault 0 Select
        constexpr uint32_t FTM3TRG0SRC = (1U << 7);  ///< FlexTimer 3 Hardware Trigger 0 Source Select
        constexpr uint32_t FTM3TRG1SRC = (1U << 8);  ///< FlexTimer 3 Hardware Trigger 1 Source Select
        constexpr uint32_t FTM3TRG2SRC = (1U << 9);  ///< FlexTimer 3 Hardware Trigger 2 Source Select
        constexpr uint32_t FTM4TRG0SRC = (1U << 10);  ///< FlexTimer 4 Hardware Trigger 0 Source Select
        constexpr uint32_t FTM4TRG1SRC = (1U << 11);  ///< FlexTimer 4 Hardware Trigger 1 Source Select
        constexpr uint32_t FTM4TRG2SRC = (1U << 12);  ///< FlexTimer 4 Hardware Trigger 2 Source Select
        constexpr uint32_t FTM5TRG0SRC = (1U << 13);  ///< FlexTimer 5 Hardware Trigger 0 Source Select
        constexpr uint32_t FTM5TRG1SRC = (1U << 14);  ///< FlexTimer 5 Hardware Trigger 1 Source Select
        constexpr uint32_t FTM5TRG2SRC = (1U << 15);  ///< FlexTimer 5 Hardware Trigger 2 Source Select
        constexpr uint32_t FTM4CH0SRC = (2 << 18);  ///< FTM4 channel 0 input capture source select
        constexpr uint32_t FTM5CH0SRC = (2 << 20);  ///< FTM5 channel 0 input capture source select
        constexpr uint32_t FTM3CLKSEL = (2 << 24);  ///< FTM3 External Clock Pin Select
        constexpr uint32_t FTM4CLKSEL = (2 << 26);  ///< FTM4 External Clock Pin Select
        constexpr uint32_t FTM5CLKSEL = (2 << 28);  ///< FTM5 External Clock Pin Select
    }
    ...
    namespace sopt7_bits {
        ...
        constexpr uint32_t ADC0ALTTRGEN = (2 << 6);  ///< Enable alternative conversion triggers for ADC0.
        constexpr uint32_t ADC1TRGSEL = (4 << 8);  ///< ADC1 Trigger Select
        constexpr uint32_t ADC1PRETRGSEL = (1U << 12);  ///< ADC1 Pre-trigger Select
        constexpr uint32_t ADC1ALTTRGEN = (2 << 14);  ///< Enable alternative conversion triggers for ADC1.
    ...
    namespace sopt8_bits {
        ...
        constexpr uint32_t FTM3SYNCBIT = (1U << 3);  ///< FlexTimer 3 Hardware Trigger 0 configure by software
        constexpr uint32_t FTM4SYNCBIT = (1U << 4);  ///< FlexTimer 4 Hardware Trigger 0 configure by software
        constexpr uint32_t FTM5SYNCBIT = (1U << 5);  ///< FlexTimer 5 Hardware Trigger 0 configure by software
        constexpr uint32_t CARRIER_SELECT0 = (2 << 8);  ///< Carrier frequency selection for FTM0/2 output channel
    ...
    namespace sopt9_bits {
        constexpr uint32_t CARRIER_SELECT1 = (2 << 8);  ///< Carrier frequency selection for FTM3/4 output channel
        constexpr uint32_t FTM3OCH0SRC = (1U << 16);  ///< FTM3 channel 0 output PWM/OCMP mode source select
        constexpr uint32_t FTM3OCH1SRC = (1U << 17);  ///< FTM3 channel 1 output PWM/OCMP mode source select
        constexpr uint32_t FTM3OCH2SRC = (1U << 18);  ///< FTM3 channel 2 output PWM/OCMP mode source select
        constexpr uint32_t FTM3OCH3SRC = (1U << 19);  ///< FTM3 channel 3 output PWM/OCMP mode source select
        constexpr uint32_t FTM3OCH4SRC = (1U << 20);  ///< FTM3 channel 4 output PWM/OCMP mode source select
        constexpr uint32_t FTM3OCH5SRC = (1U << 21);  ///< FTM3 channel 5 output PWM/OCMP mode source select
        constexpr uint32_t FTM4OCH0SRC = (1U << 22);  ///< FTM4 channel 0 output PWM/OCMP mode source select
        constexpr uint32_t FTM4OCH1SRC = (1U << 23);  ///< FTM4 channel 1 output PWM/OCMP mode source select
    }
    ...
    namespace sdid_bits {
        ...
        constexpr uint32_t SRAMSIZE = (4 << 16);  ///< Specifies the size of the System SRAM.
    ...
    namespace scgc6_bits {
        ...
        constexpr uint32_t FTM4 = (1U << 7);  ///< FTM4 Clock Gate Control
        constexpr uint32_t FTM5 = (1U << 8);  ///< FTM5 Clock Gate Control
...
#endif // ALLOY_GENERATED_MKV11Z7_PERIPHERALS_HPP