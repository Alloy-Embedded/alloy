...
extern "C" {
    ...
    void FTM4_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void DAC0_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void FTM5_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void PDB0_PDB1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void PORTA_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void PORTB_PORTC_PORTD_PORTE_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}