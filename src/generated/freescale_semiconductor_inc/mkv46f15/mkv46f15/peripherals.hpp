/// Auto-generated code for MKV46F15
/// Generated by Alloy Code Generator
/// Source: nxp_mkv46.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:43:58
#ifndef ALLOY_GENERATED_MKV46F15_PERIPHERALS_HPP
#define ALLOY_GENERATED_MKV46F15_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::mkv46f15 {
...
namespace spi {
    /// Base addresses
    constexpr uint32_t SPI_BASE = 0x4002C000;
...
namespace pwm {
    /// Base addresses
    constexpr uint32_t PWMA_BASE = 0x40033000;
    ...
    namespace smctrl2_bits {
        ...
        constexpr uint32_t FRCEN = (1U << 7);  ///< Force Initialization Enable
...
namespace tim {
    ...
    constexpr uint32_t LPTMR_BASE = 0x40040000;
...
namespace dac {
    /// Base addresses
    constexpr uint32_t DAC_BASE = 0x4003F000;
...
namespace sim {
    ...
    struct Registers {
        ...
        volatile uint32_t MISCTRL;  ///< Offset: 0x106C - Miscellaneous Control Register
        volatile uint32_t MISCTRL2;  ///< Offset: 0x1070 - Miscellaneous Control Register 2
    ...
    namespace sopt2_bits {
        ...
        constexpr uint32_t NANOEDGECLK2XSEL = (1U << 31);  ///< Nanoedge clock(PWM 2x clock) select
    }
    ...
    namespace sopt4_bits {
        ...
        constexpr uint32_t FTM0FLT3 = (1U << 3);  ///< no description available
    ...
    namespace scgc5_bits {
        ...
        constexpr uint32_t ENC = (1U << 21);  ///< no description available
    ...
    /// MISCTRL2 Register bits
    namespace misctrl2_bits {
...
namespace enc {
    ...
    /// WTR Register bits
    namespace wtr_bits {
        constexpr uint32_t WDOG = (16 << 0);  ///< no description available
    }

    /// POSD Register bits
    namespace posd_bits {
        constexpr uint32_t POSD = (16 << 0);  ///< no description available
    }

    /// POSDH Register bits
    namespace posdh_bits {
        constexpr uint32_t POSDH = (16 << 0);  ///< no description available
    }

    /// REV Register bits
    namespace rev_bits {
        constexpr uint32_t REV = (16 << 0);  ///< no description available
    }

    /// REVH Register bits
    namespace revh_bits {
        constexpr uint32_t REVH = (16 << 0);  ///< no description available
    }

    /// UPOS Register bits
    namespace upos_bits {
        constexpr uint32_t POS = (16 << 0);  ///< no description available
    }
    ...
    namespace uposh_bits {
        constexpr uint32_t POSH = (16 << 0);  ///< no description available
    }
    ...
    /// IMR Register bits
    namespace imr_bits {
        constexpr uint32_t HOME = (1U << 0);  ///< no description available
        constexpr uint32_t INDEX = (1U << 1);  ///< no description available
        constexpr uint32_t PHB = (1U << 2);  ///< no description available
        constexpr uint32_t PHA = (1U << 3);  ///< no description available
        constexpr uint32_t FHOM = (1U << 4);  ///< no description available
        constexpr uint32_t FIND = (1U << 5);  ///< no description available
        constexpr uint32_t FPHB = (1U << 6);  ///< no description available
        constexpr uint32_t FPHA = (1U << 7);  ///< no description available
    }

    /// TST Register bits
    namespace tst_bits {
        constexpr uint32_t TEST_COUNT = (8 << 0);  ///< no description available
        constexpr uint32_t TEST_PERIOD = (5 << 8);  ///< no description available
    ...
    namespace ucomp_bits {
        constexpr uint32_t COMP = (16 << 0);  ///< no description available
    }
...
namespace xbara {
    ...
    namespace sel10_bits {
        constexpr uint32_t SEL20 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL21 = (6 << 8);  ///< no description available
    }
    ...
    namespace sel12_bits {
        constexpr uint32_t SEL24 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL25 = (6 << 8);  ///< no description available
    }
    ...
    namespace sel15_bits {
        constexpr uint32_t SEL30 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL31 = (6 << 8);  ///< no description available
    }

    /// SEL16 Register bits
    namespace sel16_bits {
        constexpr uint32_t SEL32 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL33 = (6 << 8);  ///< no description available
    }

    /// SEL17 Register bits
    namespace sel17_bits {
        constexpr uint32_t SEL34 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL35 = (6 << 8);  ///< no description available
    }

    /// SEL18 Register bits
    namespace sel18_bits {
        constexpr uint32_t SEL36 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL37 = (6 << 8);  ///< no description available
    }

    /// SEL19 Register bits
    namespace sel19_bits {
        constexpr uint32_t SEL38 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL39 = (6 << 8);  ///< no description available
    }

    /// SEL20 Register bits
    namespace sel20_bits {
        constexpr uint32_t SEL40 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL41 = (6 << 8);  ///< no description available
    }

    /// SEL21 Register bits
    namespace sel21_bits {
        constexpr uint32_t SEL42 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL43 = (6 << 8);  ///< no description available
    }

    /// SEL22 Register bits
    namespace sel22_bits {
        constexpr uint32_t SEL44 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL45 = (6 << 8);  ///< no description available
    }

    /// SEL23 Register bits
    namespace sel23_bits {
        constexpr uint32_t SEL46 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL47 = (6 << 8);  ///< no description available
    }

    /// SEL24 Register bits
    namespace sel24_bits {
        constexpr uint32_t SEL48 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL49 = (6 << 8);  ///< no description available
    }

    /// SEL25 Register bits
    namespace sel25_bits {
        constexpr uint32_t SEL50 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL51 = (6 << 8);  ///< no description available
    }

    /// SEL26 Register bits
    namespace sel26_bits {
        constexpr uint32_t SEL52 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL53 = (6 << 8);  ///< no description available
    }

    /// SEL27 Register bits
    namespace sel27_bits {
        constexpr uint32_t SEL54 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL55 = (6 << 8);  ///< no description available
    }

    /// SEL28 Register bits
    namespace sel28_bits {
        constexpr uint32_t SEL56 = (6 << 0);  ///< no description available
        constexpr uint32_t SEL57 = (6 << 8);  ///< no description available
    }

    /// SEL29 Register bits
    namespace sel29_bits {
        constexpr uint32_t SEL58 = (6 << 0);  ///< no description available
    }
...
namespace xbarb {
    ...
    /// SEL0 Register bits
    namespace sel0_bits {
        constexpr uint32_t SEL0 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL1 = (5 << 8);  ///< no description available
    }

    /// SEL1 Register bits
    namespace sel1_bits {
        constexpr uint32_t SEL2 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL3 = (5 << 8);  ///< no description available
    }

    /// SEL2 Register bits
    namespace sel2_bits {
        constexpr uint32_t SEL4 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL5 = (5 << 8);  ///< no description available
    }

    /// SEL3 Register bits
    namespace sel3_bits {
        constexpr uint32_t SEL6 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL7 = (5 << 8);  ///< no description available
    }

    /// SEL4 Register bits
    namespace sel4_bits {
        constexpr uint32_t SEL8 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL9 = (5 << 8);  ///< no description available
    }

    /// SEL5 Register bits
    namespace sel5_bits {
        constexpr uint32_t SEL10 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL11 = (5 << 8);  ///< no description available
    }

    /// SEL6 Register bits
    namespace sel6_bits {
        constexpr uint32_t SEL12 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL13 = (5 << 8);  ///< no description available
    }

    /// SEL7 Register bits
    namespace sel7_bits {
        constexpr uint32_t SEL14 = (5 << 0);  ///< no description available
        constexpr uint32_t SEL15 = (5 << 8);  ///< no description available
    }
...
namespace adc {
    ...
    /// STAT Register bits
    namespace stat_bits {
        constexpr uint32_t UNDEFINED = (8 << 0);  ///< no description available
...
namespace osc {
    ...
    /// DIV Register bits
    namespace div_bits {
        constexpr uint32_t ERPS = (2 << 6);  ///< no description available
    }
...
namespace i2c {
    /// Base addresses
    constexpr uint32_t I2C_BASE = 0x40066000;
...
#endif // ALLOY_GENERATED_MKV46F15_PERIPHERALS_HPP