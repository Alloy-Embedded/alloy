...
extern "C" {
    ...
    void LVD_LVW_DCDC_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void BTLL_RSIM_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void PORTB_PORTC_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}