...
namespace traits {
    ...
    constexpr bool has_mce = true;
    constexpr uint32_t num_mce_instances = 1;
    ...
    constexpr bool has_imotion = true;
    constexpr uint32_t num_imotion_instances = 1;
    ...
    template<>
    struct peripheral_count<struct mce_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct imotion_tag> {
        static constexpr uint32_t value = 1;
    };
...
namespace mce {
    /// Base addresses
    constexpr uint32_t MCE_BASE = 0x40030000;

    /// MCE Register structure
    struct Registers {
    ...
    /// Peripheral instances
    inline Registers* MCE = reinterpret_cast<Registers*>(MCE_BASE);
...
namespace pau {
    ...
    namespace avail0_bits {
        ...
        constexpr uint32_t AVAIL20 = (1U << 20);  ///< MCE Global SFRs and Divider Availability Flag
        constexpr uint32_t AVAIL21 = (1U << 21);  ///< MCE CORDIC Availability Flag
    ...
    namespace privdis0_bits {
        ...
        constexpr uint32_t PDIS20 = (1U << 20);  ///< MCE Global SFRs and Divider Privilege Disable Flag
        constexpr uint32_t PDIS21 = (1U << 21);  ///< MCE CORDIC Privilege Disable Flag
...
namespace dac {
    /// Base addresses
    constexpr uint32_t DAC0_BASE = 0x50030000;
    constexpr uint32_t DAC0_CH0_BASE = 0x5003003C;
    constexpr uint32_t DAC0_CH1_BASE = 0x50030050;
    constexpr uint32_t DAC0_CH2_BASE = 0x50030064;
    constexpr uint32_t DAC0_CH3_BASE = 0x50030078;
    constexpr uint32_t DAC0_CH4_BASE = 0x5003008C;
    constexpr uint32_t DAC0_CH5_BASE = 0x500300A0;
    constexpr uint32_t DAC0_CH6_BASE = 0x500300B4;
    constexpr uint32_t DAC0_CH7_BASE = 0x500300C8;
    constexpr uint32_t DAC0_CH8_BASE = 0x500300DC;
    ...
    inline Registers* DAC0_CH0 = reinterpret_cast<Registers*>(DAC0_CH0_BASE);
    inline Registers* DAC0_CH1 = reinterpret_cast<Registers*>(DAC0_CH1_BASE);
    inline Registers* DAC0_CH2 = reinterpret_cast<Registers*>(DAC0_CH2_BASE);
    inline Registers* DAC0_CH3 = reinterpret_cast<Registers*>(DAC0_CH3_BASE);
    inline Registers* DAC0_CH4 = reinterpret_cast<Registers*>(DAC0_CH4_BASE);
    inline Registers* DAC0_CH5 = reinterpret_cast<Registers*>(DAC0_CH5_BASE);
    inline Registers* DAC0_CH6 = reinterpret_cast<Registers*>(DAC0_CH6_BASE);
    inline Registers* DAC0_CH7 = reinterpret_cast<Registers*>(DAC0_CH7_BASE);
    inline Registers* DAC0_CH8 = reinterpret_cast<Registers*>(DAC0_CH8_BASE);
...
namespace imotion {
    /// Base addresses
    constexpr uint32_t iMOTION_BASE = 0x10000F38;

    /// iMOTION Register structure
    struct Registers {
        volatile uint32_t GCTRL;  ///< Offset: 0x00 - Global Control Register
        volatile uint32_t GSTAT;  ///< Offset: 0x04 - Global Status Register
    };
    ...
    /// Peripheral instances
    inline Registers* iMOTION = reinterpret_cast<Registers*>(iMOTION_BASE);

    // Bit definitions
    /// GCTRL Register bits
    namespace gctrl_bits {
        constexpr uint32_t LOWWORD = (16 << 0);  ///< Low Word
        constexpr uint32_t HIGHWORD = (16 << 16);  ///< High Word
    }
...
#endif // ALLOY_GENERATED_IMM100A_PERIPHERALS_HPP