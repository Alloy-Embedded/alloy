/// Auto-generated code for TLE987x
/// Generated by Alloy Code Generator
/// Source: infineon_tle987x.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-30 23:30:17
#ifndef ALLOY_GENERATED_TLE987X_PERIPHERALS_HPP
#define ALLOY_GENERATED_TLE987X_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::tle987x {
...
namespace bdrv {
    ...
    namespace ctrl2_bits {
        ...
        constexpr uint32_t HS3_OC_DIS = (1U << 15);  ///< High Side Driver 3 Over-current Shutdown Disable
        constexpr uint32_t HS3_OC_STS = (1U << 14);  ///< External High Side 3 FET Over-current Status
        constexpr uint32_t HS3_SUPERR_STS = (1U << 13);  ///< High Side Driver 3 Supply Error Status
        constexpr uint32_t HS3_DS_STS = (1U << 12);  ///< High Side Driver 3 Drain Source Monitoring Status
        constexpr uint32_t HS3_DCS_EN = (1U << 11);  ///< High Side Driver 3 Diagnosis Current Source Enable
        constexpr uint32_t HS3_ON = (1U << 10);  ///< High Side Driver 3 On
        constexpr uint32_t HS3_PWM = (1U << 9);  ///< High Side Driver 3 PWM Enable
        constexpr uint32_t HS3_EN = (1U << 8);  ///< High Side Driver 3 Enable
        constexpr uint32_t LS3_OC_DIS = (1U << 7);  ///< Low Side Driver 3 Over-current Shutdown Disable
        constexpr uint32_t LS3_OC_STS = (1U << 6);  ///< External Low Side 3 FET Over-current Status
        constexpr uint32_t LS3_SUPERR_STS = (1U << 5);  ///< Low Side Driver 3 Supply Error Status
        constexpr uint32_t LS3_DS_STS = (1U << 4);  ///< Low Side Driver 3 Drain Source Monitoring Status in OFF-State
        constexpr uint32_t LS3_DCS_EN = (1U << 3);  ///< Low Side Driver 3 Diagnosis Current Source Enable
        constexpr uint32_t LS3_ON = (1U << 2);  ///< Low Side Driver 3 On
        constexpr uint32_t LS3_PWM = (1U << 1);  ///< Low Side Driver 3 PWM Enable
        constexpr uint32_t LS3_EN = (1U << 0);  ///< Low Side Driver 3 Enable
    }
    ...
    namespace trim_drvx_bits {
        ...
        constexpr uint32_t HS3DRV_OCSDN_DIS = (1U << 23);  ///< High Side 3 Predriver in overcurrent situation disable
        ...
        constexpr uint32_t HS3DRV_FDISCHG_DIS = (1U << 20);  ///< High Side 3 Predriver in overcurrent situation disable
        ...
        constexpr uint32_t LS3DRV_OCSDN_DIS = (1U << 15);  ///< Low Side 3 Predriver in overcurrent situation disable
        ...
        constexpr uint32_t LS3DRV_FDISCHG_DIS = (1U << 12);  ///< Low Side 3 Predriver in overcurrent situation disable
...
namespace cpu {
    ...
    namespace nvic_iabr0_bits {
        constexpr uint32_t Int_DMA = (1U << 15);  ///< Interrupt Active for DMA
    ...
    namespace nvic_icer0_bits {
        constexpr uint32_t Int_DMA = (1U << 15);  ///< Interrupt Clr for DMA
    ...
    namespace nvic_icpr0_bits {
        constexpr uint32_t Int_DMA = (1U << 15);  ///< Interrupt Clr Pend for DMA
    ...
    namespace nvic_ipr3_bits {
        constexpr uint32_t PRI_DMA = (8 << 24);  ///< Priority for DMA
    ...
    namespace nvic_iser0_bits {
        constexpr uint32_t Int_DMA = (1U << 15);  ///< Interrupt Set for DMA
    ...
    namespace nvic_ispr0_bits {
        constexpr uint32_t Int_DMA = (1U << 15);  ///< Interrupt Set Pend for DMA
...
namespace dma {
    /// Base addresses
    constexpr uint32_t DMA_BASE = 0x50014000;

    /// DMA Register structure
    struct Registers {
        volatile uint32_t ALT_CTRL_BASE_PTR;  ///< Offset: 0x0C - Channel Alternate Control Data Base Pointer
        volatile uint32_t CFG;  ///< Offset: 0x04 - DMA Configuration
        volatile uint32_t CHNL_ENABLE_CLR;  ///< Offset: 0x2C - Channel Enable Clear
        volatile uint32_t CHNL_ENABLE_SET;  ///< Offset: 0x28 - Channel Enable Set
        volatile uint32_t CHNL_PRI_ALT_CLR;  ///< Offset: 0x34 - Channel Primary-Alternate Clear
        volatile uint32_t CHNL_PRI_ALT_SET;  ///< Offset: 0x30 - Channel Primary-Alternate Set
        volatile uint32_t CHNL_PRIORITY_CLR;  ///< Offset: 0x3C - Channel Priority Clear
        volatile uint32_t CHNL_PRIORITY_SET;  ///< Offset: 0x38 - Channel Priority Set
        volatile uint32_t CHNL_REQ_MASK_CLR;  ///< Offset: 0x24 - Channel Request Mask Clear
        volatile uint32_t CHNL_REQ_MASK_SET;  ///< Offset: 0x20 - Channel Request Mask Set
        volatile uint32_t CHNL_SW_REQUEST;  ///< Offset: 0x14 - Channel Software Request
        volatile uint32_t CHNL_USEBURST_CLR;  ///< Offset: 0x1C - Channel Useburst Clear
        volatile uint32_t CHNL_USEBURST_SET;  ///< Offset: 0x18 - Channel Useburst Set
        volatile uint32_t CTRL_BASE_PTR;  ///< Offset: 0x08 - Channel Control Data Base Pointer
        volatile uint32_t ERR_CLR;  ///< Offset: 0x4C - Bus Error Clear
        volatile uint32_t STATUS;  ///< Offset: 0x00 - DMA Status
        volatile uint32_t WAITONREQ_STATUS;  ///< Offset: 0x10 - Channel Wait on Request Status
    };
    ...
    // Bit definitions
    /// ALT_CTRL_BASE_PTR Register bits
    namespace alt_ctrl_base_ptr_bits {
        constexpr uint32_t ALT_CTRL_BASE_PTR = (32 << 0);  ///< Base Address of the Alternate Data Structure
    }

    /// CFG Register bits
    namespace cfg_bits {
        constexpr uint32_t CHN1_PROT_CTRL = (3 << 5);  ///< CHN1_PROT_CTRL
        constexpr uint32_t MASTER_ENABLE = (1U << 0);  ///< Enable for the Controller
    }

    /// CHNL_ENABLE_CLR Register bits
    namespace chnl_enable_clr_bits {
        constexpr uint32_t CHNL_ENABLE_CLR = (14 << 0);  ///< CHNL_ENABLE_CLR
    }

    /// CHNL_ENABLE_SET Register bits
    namespace chnl_enable_set_bits {
        constexpr uint32_t CHNL_ENABLE_SET = (14 << 0);  ///< CHNL_ENABLE_SET: 0b0=on read: Channel C is disabled., 0b1=on read: Channel C is enabled., 0b0=on write: No effect. Use the CHNL_ENABLE_CLR Register to disable a channel., 0b1=on write: Enables channel C.,
    }

    /// CHNL_PRI_ALT_CLR Register bits
    namespace chnl_pri_alt_clr_bits {
        constexpr uint32_t CHNL_PRI_ALT_CLR = (14 << 0);  ///< CHNL_PRI_ALT_CLR
    }

    /// CHNL_PRI_ALT_SET Register bits
    namespace chnl_pri_alt_set_bits {
        constexpr uint32_t CHNL_PRI_ALT_SET = (14 << 0);  ///< CHNL_PRI_ALT_SET: 0b0=on read: DMA channel C is using the primary data structure., 0b1=on read: DMA channel C is using the alternate data structure., 0b0=on write: No effect. Use the CHNL_PRI_ALT_CLR Register to set bit [C] to 0., 0b1=on write: Selects the alternate data structure for channel C.,
    }

    /// CHNL_PRIORITY_CLR Register bits
    namespace chnl_priority_clr_bits {
        constexpr uint32_t CHNL_PRIORITY_CLR = (14 << 0);  ///< CHNL_PRIORITY_CLR
    }

    /// CHNL_PRIORITY_SET Register bits
    namespace chnl_priority_set_bits {
        constexpr uint32_t CHNL_PRIORITY_SET = (14 << 0);  ///< CHNL_PRIORITY_SET: 0b0=on read: DMA channel C is using the default priority level., 0b1=on read: DMA channel C is using a high priority level., 0b0=on write: No effect. Use the CHNL_ENABLE_CLR Register to set channel C to the default priority level., 0b1=on write: Channel C uses the high priority level.,
    }

    /// CHNL_REQ_MASK_CLR Register bits
    namespace chnl_req_mask_clr_bits {
        constexpr uint32_t CHNL_REQ_MASK_CLR = (14 << 0);  ///< CHNL_REQ_MASK_CLR
    }

    /// CHNL_REQ_MASK_SET Register bits
    namespace chnl_req_mask_set_bits {
        constexpr uint32_t CHNL_REQ_MASK_SET = (14 << 0);  ///< CHNL_REQ_MASK_SET: 0b0=on read: External requests are enabled for channel C., 0b1=on read: External requests are disabled for channel C., 0b0=on write: No effect. Use the CHNL_REQ_MASK_CLR Register to enable DMA requests., 0b1=on write: Disables dma_req[C] and dma_sreq[C] from generating DMA requests.,
    }

    /// CHNL_SW_REQUEST Register bits
    namespace chnl_sw_request_bits {
        constexpr uint32_t CHNL_SW_REQUEST = (14 << 0);  ///< CHNL_SW_REQUEST
    }

    /// CHNL_USEBURST_CLR Register bits
    namespace chnl_useburst_clr_bits {
        constexpr uint32_t CHNL_USEBURST_CLR = (14 << 0);  ///< CHNL_USEBURST_CLR
    }

    /// CHNL_USEBURST_SET Register bits
    namespace chnl_useburst_set_bits {
        constexpr uint32_t CHNL_USEBURST_SET = (14 << 0);  ///< CHNL_USEBURST_SET: 0b0=on read: DMA channel n responds to requests that it receives on dma_req[C] or dma_sreq[C]. The controller performs 2, or single, bus transfers., 0b1=on read: DMA channel n does not respond to requests that it receives on dma_req[C] or dma_sreq[C]. The controller only reponds to dma_req[C] requests and performs 2 transfers., 0b0=on write: No effect. Use the CHNL_USEBURST_CLR Register to set bit [C] to 0., 0b1=on write: Disables dma_sreq[C] from generating DMA requests. The controller performs 2 transfers.,
    }

    /// CTRL_BASE_PTR Register bits
    namespace ctrl_base_ptr_bits {
        constexpr uint32_t CTRL_BASE_PTR = (23 << 9);  ///< CTRL_BASE_PTR
    }

    /// ERR_CLR Register bits
    namespace err_clr_bits {
        constexpr uint32_t ERR_CLR = (1U << 0);  ///< ERR_CLR: 0b0=on read: dma_err is LOW., 0b1=on read: dma_err is HIGH., 0b0=on write: No effect, status of dma_err is unchanged., 0b1=on write: Sets dma_err LOW.,
    }

    /// STATUS Register bits
    namespace status_bits {
        constexpr uint32_t CHNLS_MINUS1 = (5 << 16);  ///< Available Channels minus 1
        constexpr uint32_t STATE = (4 << 4);  ///< Current State of the Control State Machine
        constexpr uint32_t MASTER_ENABLE = (1U << 0);  ///< Enable Status of the Controller
    }

    /// WAITONREQ_STATUS Register bits
    namespace waitonreq_status_bits {
        constexpr uint32_t WAITONREQ_STATUS = (14 << 0);  ///< Channel Wait on Request Status
    }
...
namespace mf {
    ...
    struct Registers {
        volatile uint32_t BEMFC_CTRL_STS;  ///< Offset: 0x08 - BEMF Comparator Control Status Register
        volatile uint32_t CSA_CTRL;  ///< Offset: 0x0C - Current Sense Amplifier Control Register
        ...
        volatile uint32_t TRIM_BEMFx;  ///< Offset: 0x20 - Trimming of Driver
    ...
    // Bit definitions
    /// BEMFC_CTRL_STS Register bits
    namespace bemfc_ctrl_sts_bits {
        constexpr uint32_t PHW_ZC_STS = (1U << 18);  ///< Phase W Comparator zero crossing status
        constexpr uint32_t PHV_ZC_STS = (1U << 17);  ///< Phase V Comparator zero crossing status
        constexpr uint32_t PHU_ZC_STS = (1U << 16);  ///< Phase U Comparator zero crossing status
        constexpr uint32_t CCPOS_INSEL = (1U << 12);  ///< CCPOSx_3 INSEL select, x = 0,1,2
        constexpr uint32_t PHWCOMP_ON = (1U << 10);  ///< Phase W Comparator on
        constexpr uint32_t PHVCOMP_ON = (1U << 9);  ///< Phase V Comparator on
        constexpr uint32_t PHUCOMP_ON = (1U << 8);  ///< Phase U Comparator on
        constexpr uint32_t GPT12CAPINSW = (1U << 5);  ///< GPT12 CAPIN software trigger
        constexpr uint32_t FILTBYPS = (1U << 4);  ///< BEMF Comparator Output Filter Bypass
        constexpr uint32_t DEMGFILTDIS = (1U << 3);  ///< BEMF Comparator Demagnetisation (Demag) Filter Disable
        constexpr uint32_t PHWCOMP_EN = (1U << 2);  ///< Phase W Comparator enable
        constexpr uint32_t PHVCOMP_EN = (1U << 1);  ///< Phase V Comparator enable
        constexpr uint32_t PHUCOMP_EN = (1U << 0);  ///< Phase U Comparator enable
    }

    /// CSA_CTRL Register bits
    namespace csa_ctrl_bits {
        constexpr uint32_t VZERO = (1U << 8);  ///< Current Sense Output Voltage Level to Ground
        constexpr uint32_t GAIN = (2 << 1);  ///< OPA gain setting
        constexpr uint32_t EN = (1U << 0);  ///< OPA enable
    }

    /// P2_ADCSEL_CTRL Register bits
    namespace p2_adcsel_ctrl_bits {
        constexpr uint32_t ADC1_CH1_SEL = (1U << 10);  ///< ADC1 Channel 1 Input Selection
        constexpr uint32_t ADC3_INN_SEL = (1U << 9);  ///< ADC3 Negative Input Selection
        constexpr uint32_t ADC3_INP_SEL = (1U << 8);  ///< ADC3 Positive Input Selection
        constexpr uint32_t P2_0_ADC_SEL = (1U << 0);  ///< Port 2.0 Input Selection
        constexpr uint32_t P2_2_ADC_SEL = (1U << 1);  ///< Port 2.2 Input Selection
    ...
    /// TRIM_BEMFx Register bits
    namespace trim_bemfx_bits {
        constexpr uint32_t BEMF_TFILT_SEL = (2 << 8);  ///< Filter Time for BEMF Comparator Output Signal
        constexpr uint32_t BEMF_GPT_CAPIN_SEL = (2 << 4);  ///< GPT12 CAPIN input selector
        constexpr uint32_t BEMF_BT_TFILT_SEL = (3 << 0);  ///< Blanking Time for BEMF Comparator Output Signal
    }
...
namespace pmu {
    ...
    struct Registers {
        volatile uint32_t CNF_CYC_SAMPLE_DEL;  ///< Offset: 0x30 - Sample Delay in Cyclic Sense Register
        volatile uint32_t CNF_CYC_SENSE;  ///< Offset: 0x28 - Dead Time in Cyclic Sense Register
        ...
        volatile uint32_t WAKE_CONF_GPIO0_CYC;  ///< Offset: 0xE0 - Wake Port 0 Cycle Enabled Register
        volatile uint32_t WAKE_CONF_GPIO0_FALL;  ///< Offset: 0xDC - Wake Configuration GPIO Port 0 Falling Edge Register
        volatile uint32_t WAKE_CONF_GPIO0_RISE;  ///< Offset: 0xD8 - Wake Configuration GPIO Port 0 Rising Edge Register
        volatile uint32_t WAKE_CONF_GPIO1_CYC;  ///< Offset: 0xEC - Wake Port 1 Cycle Enabled Register
        volatile uint32_t WAKE_CONF_GPIO1_FALL;  ///< Offset: 0xE8 - Wake Configuration GPIO Port 1 Falling Edge Register
        volatile uint32_t WAKE_CONF_GPIO1_RISE;  ///< Offset: 0xE4 - Wake Configuration GPIO Port 1 Rising Edge Register
        volatile uint32_t WAKE_STATUS;  ///< Offset: 0x00 - Main wake status register
        volatile uint32_t WAKE_STS_FAIL;  ///< Offset: 0x80 - Wake Status Fail Register
        volatile uint32_t WAKE_STS_GPIO0;  ///< Offset: 0x88 - Wake Status GPIO 0 Register
        volatile uint32_t WAKE_STS_GPIO1;  ///< Offset: 0x8C - Wake Status GPIO 1 Register
    ...
    // Bit definitions
    /// CNF_CYC_SAMPLE_DEL Register bits
    namespace cnf_cyc_sample_del_bits {
        constexpr uint32_t M03 = (4 << 0);  ///< Mantissa
    }

    /// CNF_CYC_SENSE Register bits
    namespace cnf_cyc_sense_bits {
        constexpr uint32_t OSC_100kHz_EN = (1U << 7);  ///< 100 kHz Oscillator Enable
    ...
    namespace cnf_pmu_settings_bits {
        ...
        constexpr uint32_t EN_0V9_N = (1U << 1);  ///< Disables the reduction of the VDDC regulator output to 0.9 V during Stop-Mode
    ...
    namespace mon_cnf_bits {
        ...
        constexpr uint32_t CYC = (1U << 3);  ///< MON for Cycle Sense Enable
    ...
    /// WAKE_CONF_GPIO0_CYC Register bits
    namespace wake_conf_gpio0_cyc_bits {
        constexpr uint32_t GPIO0_CYC_4 = (1U << 4);  ///< GPIO0_4 input for cycle sense enable
        constexpr uint32_t GPIO0_CYC_3 = (1U << 3);  ///< GPIO0_3 input for cycle sense enable
        constexpr uint32_t GPIO0_CYC_2 = (1U << 2);  ///< GPIO0_2 input for cycle sense enable
        constexpr uint32_t GPIO0_CYC_1 = (1U << 1);  ///< GPIO0_1 input for cycle sense enable
        constexpr uint32_t GPIO0_CYC_0 = (1U << 0);  ///< GPIO0_0 input for cycle sense enable
    }

    /// WAKE_CONF_GPIO0_FALL Register bits
    namespace wake_conf_gpio0_fall_bits {
        constexpr uint32_t GPIO0_FA_4 = (1U << 4);  ///< Port 0_4 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO0_FA_3 = (1U << 3);  ///< Port 0_3 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO0_FA_2 = (1U << 2);  ///< Port 0_2 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO0_FA_1 = (1U << 1);  ///< Port 0_1 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO0_FA_0 = (1U << 0);  ///< Port 0_0 Wake-up on Falling Edge enable
    }

    /// WAKE_CONF_GPIO0_RISE Register bits
    namespace wake_conf_gpio0_rise_bits {
        constexpr uint32_t GPIO0_RI_4 = (1U << 4);  ///< Port 0_4 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO0_RI_3 = (1U << 3);  ///< Port 0_3 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO0_RI_2 = (1U << 2);  ///< Port 0_2 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO0_RI_1 = (1U << 1);  ///< Port 0_1 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO0_RI_0 = (1U << 0);  ///< Port 0_0 Wake-up on Rising Edge enable
    }

    /// WAKE_CONF_GPIO1_CYC Register bits
    namespace wake_conf_gpio1_cyc_bits {
        constexpr uint32_t GPIO1_CYC_4 = (1U << 4);  ///< GPIO1_4 input for cycle sense enable
        constexpr uint32_t GPIO1_CYC_3 = (1U << 3);  ///< GPIO1_3 input for cycle sense enable
        constexpr uint32_t GPIO1_CYC_2 = (1U << 2);  ///< GPIO1_2 input for cycle sense enable
        constexpr uint32_t GPIO1_CYC_1 = (1U << 1);  ///< GPIO1_1 input for cycle sense enable
        constexpr uint32_t GPIO1_CYC_0 = (1U << 0);  ///< GPIO1_0 input for cycle sense enable
    }

    /// WAKE_CONF_GPIO1_FALL Register bits
    namespace wake_conf_gpio1_fall_bits {
        constexpr uint32_t GPIO1_FA_4 = (1U << 4);  ///< Port 1_4 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO1_FA_3 = (1U << 3);  ///< Port 1_3 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO1_FA_2 = (1U << 2);  ///< Port 1_2 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO1_FA_1 = (1U << 1);  ///< Port 1_1 Wake-up on Falling Edge enable
        constexpr uint32_t GPIO1_FA_0 = (1U << 0);  ///< Port 1_0 Wake-up on Falling Edge enable
    }

    /// WAKE_CONF_GPIO1_RISE Register bits
    namespace wake_conf_gpio1_rise_bits {
        constexpr uint32_t GPIO1_RI_4 = (1U << 4);  ///< Port 1_4 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO1_RI_3 = (1U << 3);  ///< Port 1_3 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO1_RI_2 = (1U << 2);  ///< Port 1_2 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO1_RI_1 = (1U << 1);  ///< Port 1_1 Wake-up on Rising Edge enable
        constexpr uint32_t GPIO1_RI_0 = (1U << 0);  ///< Port 1_0 Wake-up on Rising Edge enable
    }
    ...
    /// WAKE_STS_FAIL Register bits
    namespace wake_sts_fail_bits {
        constexpr uint32_t VDDEXTSHORT = (1U << 2);  ///< Stop-Exit due to short circuit at the VDDEXT Supply
        constexpr uint32_t SUPPFAIL = (1U << 0);  ///< Stop-Exit due to overvoltage at the VDDEXT Supply
    }

    /// WAKE_STS_GPIO0 Register bits
    namespace wake_sts_gpio0_bits {
    ...
    /// WAKE_STS_GPIO1 Register bits
    namespace wake_sts_gpio1_bits {
        constexpr uint32_t GPIO1_STS_4 = (1U << 4);  ///< Wake GPIO1_4
        constexpr uint32_t GPIO1_STS_3 = (1U << 3);  ///< Wake GPIO1_3
        constexpr uint32_t GPIO1_STS_2 = (1U << 2);  ///< Wake GPIO1_2
        constexpr uint32_t GPIO1_STS_1 = (1U << 1);  ///< Wake GPIO1_1
        constexpr uint32_t GPIO1_STS_0 = (1U << 0);  ///< Wake GPIO1_0
    }
...
namespace gpio {
    ...
    namespace p2_data_bits {
        constexpr uint32_t P0 = (1U << 0);  ///< Port 2 Pin 0 Data Value
        constexpr uint32_t P2 = (1U << 2);  ///< Port 2 Pin 2 Data Value
    ...
    namespace p2_dir_bits {
        constexpr uint32_t P0 = (1U << 0);  ///< Port 2 Pin 0 Driver Control
        constexpr uint32_t P2 = (1U << 2);  ///< Port 2 Pin 2 Driver Control
    ...
    namespace p2_puden_bits {
        constexpr uint32_t P0 = (1U << 0);  ///< Pull-Up/Pull-Down Enable at Port 2 Bit 0
        constexpr uint32_t P2 = (1U << 2);  ///< Pull-Up/Pull-Down Enable at Port 2 Bit 2
    ...
    namespace p2_pudsel_bits {
        constexpr uint32_t P0 = (1U << 0);  ///< Pull-Up/Pull-Down Select Port 2 Bit 0
        constexpr uint32_t P2 = (1U << 2);  ///< Pull-Up/Pull-Down Select Port 2 Bit 2
...
namespace scu {
    ...
    struct Registers {
        ...
        volatile uint32_t DMAIEN1;  ///< Offset: 0x144 - DMA Interrupt Enable Register 1, RESET_TYPE_3
        volatile uint32_t DMAIEN2;  ///< Offset: 0x148 - DMA Interrupt Enable Register 2, RESET_TYPE_3
        volatile uint32_t DMAIRC1;  ///< Offset: 0x154 - DMA Interrupt Control Register 1, RESET_TYPE_3
        volatile uint32_t DMAIRC1CLR;  ///< Offset: 0x184 - DMA Interrupt Control 1 Clear Register, RESET_TYPE_3
        volatile uint32_t DMAIRC2;  ///< Offset: 0x158 - ADC1 Interrupt Control Register 2, RESET_TYPE_3
        volatile uint32_t DMAIRC2CLR;  ///< Offset: 0x188 - ADC1 Interrupt Control 2 Clear Register, RESET_TYPE_3
        volatile uint32_t DMASRCCLR;  ///< Offset: 0x198 - DMA Source Selection Clear Register, RESET_TYPE_3
        volatile uint32_t DMASRCSEL;  ///< Offset: 0x14C - DMA Source Selection Register, RESET_TYPE_3
        volatile uint32_t DMASRCSEL2;  ///< Offset: 0x180 - DMA Source Selection Register 2, RESET_TYPE_3
    ...
    /// DMAIEN1 Register bits
    namespace dmaien1_bits {
        constexpr uint32_t CH8IE = (1U << 7);  ///< DMA Channel 11 Interrupt Enable (ADC1 Channel 7)
        constexpr uint32_t CH7IE = (1U << 6);  ///< DMA Channel 10 Interrupt Enable (ADC1 Channel 6)
        constexpr uint32_t CH6IE = (1U << 5);  ///< DMA Channel 9 Interrupt Enable (ADC1 Channel 5)
        constexpr uint32_t CH5IE = (1U << 4);  ///< DMA Channel 8 Interrupt Enable (ADC1 Channel 4)
        constexpr uint32_t CH4IE = (1U << 3);  ///< DMA Channel 7 Interrupt Enable (ADC1 Channel 3)
        constexpr uint32_t CH3IE = (1U << 2);  ///< DMA Channel 6 Interrupt Enable (ADC1 Channel 2)
        constexpr uint32_t CH2IE = (1U << 1);  ///< DMA Channel 5 Interrupt Enable (ADC1 Channel 1)
        constexpr uint32_t CH1IE = (1U << 0);  ///< DMA Channel 4 Interrupt Enable (ADC1 Channel 0)
    }

    /// DMAIEN2 Register bits
    namespace dmaien2_bits {
        constexpr uint32_t SDADCIE = (1U << 6);  ///< DMA Channel 13 Interrupt Enable (SDADC)
        constexpr uint32_t GPT12IE = (1U << 5);  ///< DMA Channel 12 Interrupt Enable (GPT12/Timer3)
        constexpr uint32_t SSCRXIE = (1U << 4);  ///< DMA Channel 3 Interrupt Enable (SSCx Receive)
        constexpr uint32_t SSCTXIE = (1U << 3);  ///< DMA Channel 2 Interrupt Enable (SSCx Transmit)
        constexpr uint32_t TRSEQ2RDYIE = (1U << 2);  ///< DMA Channel 1 Interrupt Enable (ADC1 ESM)
        constexpr uint32_t TRSEQ1RDYIE = (1U << 1);  ///< DMA Channel 0 Interrupt Enable (ADC1 Sequence)
        constexpr uint32_t TRERRIE = (1U << 0);  ///< DMA Transfer Error Interrupt Enable
    }

    /// DMAIRC1 Register bits
    namespace dmairc1_bits {
        constexpr uint32_t CH8 = (1U << 7);  ///< DMA Channel 11 Interrupt Status (ADC1 Channel 7)
        constexpr uint32_t CH7 = (1U << 6);  ///< DMA Channel 10 Interrupt Status (ADC1 Channel 6)
        constexpr uint32_t CH6 = (1U << 5);  ///< DMA Channel 9 Interrupt Status (ADC1 Channel 5)
        constexpr uint32_t CH5 = (1U << 4);  ///< DMA Channel 8 Interrupt Status (ADC1 Channel 4)
        constexpr uint32_t CH4 = (1U << 3);  ///< DMA Channel 7 Interrupt Status (ADC1 Channel 3)
        constexpr uint32_t CH3 = (1U << 2);  ///< DMA Channel 6 Interrupt Status (ADC1 Channel 2)
        constexpr uint32_t CH2 = (1U << 1);  ///< DMA Channel 5 Interrupt Status (ADC1 Channel 1)
        constexpr uint32_t CH1 = (1U << 0);  ///< DMA Channel 4 Interrupt Status (ADC1 Channel 0)
    }

    /// DMAIRC1CLR Register bits
    namespace dmairc1clr_bits {
        constexpr uint32_t CH8C = (1U << 7);  ///< DMA Channel 11 Interrupt Status Clear (ADC1 Channel 7)
        constexpr uint32_t CH7C = (1U << 6);  ///< DMA Channel 10 Interrupt Status Clear (ADC1 Channel 6)
        constexpr uint32_t CH6C = (1U << 5);  ///< DMA Channel 9 Interrupt Status Clear (ADC1 Channel 5)
        constexpr uint32_t CH5C = (1U << 4);  ///< DMA Channel 8 Interrupt Status Clear (ADC1 Channel 4)
        constexpr uint32_t CH4C = (1U << 3);  ///< DMA Channel 7 Interrupt Status Clear (ADC1 Channel 3)
        constexpr uint32_t CH3C = (1U << 2);  ///< DMA Channel 6 Interrupt Status Clear (ADC1 Channel 2)
        constexpr uint32_t CH2C = (1U << 1);  ///< DMA Channel 5 Interrupt Status Clear (ADC1 Channel 1)
        constexpr uint32_t CH1C = (1U << 0);  ///< DMA Channel 4 Interrupt Status Clear (ADC1 Channel 0)
    }

    /// DMAIRC2 Register bits
    namespace dmairc2_bits {
        constexpr uint32_t SDADC = (1U << 6);  ///< DMA Channel 13 Interrupt Status (SDADC)
        constexpr uint32_t GPT12 = (1U << 5);  ///< DMA Channel 12 Interrupt Status (GPT12/Timer3)
        constexpr uint32_t SSC2RDY = (1U << 4);  ///< DMA Channel 3 Interrupt Status (SSCx Receive)
        constexpr uint32_t SSC1RDY = (1U << 3);  ///< DMA Channel 2 Interrupt Status (SSCx Transmit)
        constexpr uint32_t TRSEQ2DY = (1U << 2);  ///< DMA Channel 1 Interrupt Status (ADC1 ESM)
        constexpr uint32_t TRSEQ1DY = (1U << 1);  ///< DMA Channel 0 Interrupt Status (ADC1 Sequence)
        constexpr uint32_t STRDY = (1U << 0);  ///< DMA Single Transfer Ready
    }

    /// DMAIRC2CLR Register bits
    namespace dmairc2clr_bits {
        constexpr uint32_t SDADCC = (1U << 6);  ///< DMA Channel 13 Interrupt Status Clear (SDADC)
        constexpr uint32_t GPT12C = (1U << 5);  ///< DMA Channel 12 Interrupt Status Clear (GPT12/Timer3)
        constexpr uint32_t SSC2C = (1U << 4);  ///< DMA Channel 3 Interrupt Status Clear (SSCx Receive)
        constexpr uint32_t SSC1C = (1U << 3);  ///< DMA Channel 2 Interrupt Status Clear (SSCx Transmit)
        constexpr uint32_t TRSEQ2DYC = (1U << 2);  ///< DMA Channel 1 Interrupt Status Clear (ADC1 ESM)
        constexpr uint32_t TRSEQ1DYC = (1U << 1);  ///< DMA Channel 0 Interrupt Status Clear (ADC1 Sequence)
    }

    /// DMASRCCLR Register bits
    namespace dmasrcclr_bits {
        constexpr uint32_t GPT12_T3C = (1U << 7);  ///< GPT12 Transmit Request Clear
        constexpr uint32_t SSCRXC = (1U << 6);  ///< SSC Receive Request Clear
        constexpr uint32_t SSCTXC = (1U << 5);  ///< SSC Transmit Request Clear
    }

    /// DMASRCSEL Register bits
    namespace dmasrcsel_bits {
        constexpr uint32_t GPT12_T3 = (1U << 7);  ///< DMA Channel 12 Request (GPT12E, Timer3)
        constexpr uint32_t SSCRX = (1U << 6);  ///< DMA Channel 3 Request (SSCx Receive)
        constexpr uint32_t SSCTX = (1U << 5);  ///< DMA Channel 2 Request (SSCx Transmit)
        constexpr uint32_t T12PM_DMAEN = (1U << 3);  ///< CC6_T12_PM (Period Match) DMA muxer, DMA channel 11
        constexpr uint32_t T12ZM_DMAEN = (1U << 2);  ///< CC6_T12_ZM (Zero Match) DMA muxer, DMA channel 9
        constexpr uint32_t SSCRXSRCSEL = (1U << 1);  ///< SSCx Receive Source Select
        constexpr uint32_t SSCTXSRCSEL = (1U << 0);  ///< SSCx Transmit Source Select
    }

    /// DMASRCSEL2 Register bits
    namespace dmasrcsel2_bits {
        constexpr uint32_t GPT12_DMAEN = (2 << 0);  ///< GPT12 T3 DMA muxer, DMA channel 12
    }
...
namespace scupm {
    ...
    namespace bdrv_irq_ctrl_bits {
        ...
        constexpr uint32_t HS3_OC_IE = (1U << 15);  ///< External High Side 3 FET Over-current Interrupt Enable
        constexpr uint32_t LS3_OC_IE = (1U << 14);  ///< External Low Side 3 FET Over-current Interrupt Enable
        ...
        constexpr uint32_t HS3_DS_IE = (1U << 5);  ///< Bridge Driver High Side 3 Pre-Driver Short Interrupt Enable
        constexpr uint32_t LS3_DS_IE = (1U << 4);  ///< Bridge Driver Low Side 3 Pre-Driver Short Interrupt Enable
    ...
    namespace bdrv_is_bits {
        ...
        constexpr uint32_t HS3_OC_IS = (1U << 15);  ///< External High Side 3 FET Over-current Status
        constexpr uint32_t LS3_OC_IS = (1U << 14);  ///< External Low Side 3 FET Over-current Status
        ...
        constexpr uint32_t HS3_DS_IS = (1U << 5);  ///< Bridge Driver High Side 3 Pre-Driver short Interrupt Status
        constexpr uint32_t LS3_DS_IS = (1U << 4);  ///< Bridge Driver Low Side 3 Pre-Driver short Interrupt Status
    ...
    namespace bdrv_isclr_bits {
        ...
        constexpr uint32_t HS3_OC_ICLR = (1U << 15);  ///< External High Side 3 FET Over-current Status
        constexpr uint32_t LS3_OC_ICLR = (1U << 14);  ///< External Low Side 3 FET Over-current Status
        ...
        constexpr uint32_t HS3_DS_ICLR = (1U << 5);  ///< Bridge Driver High Side 3 Pre-Driver short Interrupt Status
        constexpr uint32_t LS3_DS_ICLR = (1U << 4);  ///< Bridge Driver Low Side 3 Pre-Driver short Interrupt Status
    ...
    namespace sys_irq_ctrl_bits {
        ...
        constexpr uint32_t PHW_ZCHI_IE = (1U << 21);  ///< Phase W Zero Crossing Comperator High Interrupt Enable
        constexpr uint32_t PHW_ZCLOW_IE = (1U << 20);  ///< Phase W Zero Crossing Comperator Low Interrupt Enable
        constexpr uint32_t PHV_ZCHI_IE = (1U << 19);  ///< Phase V Zero Crossing Comperator High Interrupt Enable
        constexpr uint32_t PHV_ZCLOW_IE = (1U << 18);  ///< Phase V Zero Crossing Comperator Low Interrupt Enable
        constexpr uint32_t PHU_ZCHI_IE = (1U << 17);  ///< Phase U Zero Crossing Comperator High Interrupt Enable
        constexpr uint32_t PHU_ZCLOW_IE = (1U << 16);  ///< Phase U Zero Crossing Comperator Low Interrupt Enable
    ...
    namespace sys_is_bits {
        constexpr uint32_t PHW_ZCHI_STS = (1U << 29);  ///< Phase W Zero Crossing Comperator High Status
        constexpr uint32_t PHW_ZCLOW_STS = (1U << 28);  ///< Phase W Zero Crossing Comperator Low Status
        constexpr uint32_t PHV_ZCHI_STS = (1U << 27);  ///< Phase V Zero Crossing Comperator High Status
        constexpr uint32_t PHV_ZCLOW_STS = (1U << 26);  ///< Phase V Zero Crossing Comperator Low Status
        constexpr uint32_t PHU_ZCHI_STS = (1U << 25);  ///< Phase U Zero Crossing Comperator High Status
        constexpr uint32_t PHU_ZCLOW_STS = (1U << 24);  ///< Phase U Zero Crossing Comperator Low Status
        ...
        constexpr uint32_t PHW_ZCHI_IS = (1U << 21);  ///< Phase W Zero Crossing Comperator High Interrupt Status
        constexpr uint32_t PHW_ZCLOW_IS = (1U << 20);  ///< Phase W Zero Crossing Comperator Low Interrupt Status
        constexpr uint32_t PHV_ZCHI_IS = (1U << 19);  ///< Phase V Zero Crossing Comperator High Interrupt Status
        constexpr uint32_t PHV_ZCLOW_IS = (1U << 18);  ///< Phase V Zero Crossing Comperator Low Interrupt Status
        constexpr uint32_t PHU_ZCHI_IS = (1U << 17);  ///< Phase U Zero Crossing Comperator High Interrupt Status
        constexpr uint32_t PHU_ZCLOW_IS = (1U << 16);  ///< Phase U Zero Crossing Comperator Low Interrupt Status
    ...
    namespace sys_isclr_bits {
        constexpr uint32_t PHW_ZCHI_SCLR = (1U << 29);  ///< Phase W Zero Crossing Comperator High Status
        constexpr uint32_t PHW_ZCLOW_SCLR = (1U << 28);  ///< Phase W Zero Crossing Comperator Low Status
        constexpr uint32_t PHV_ZCHI_SCLR = (1U << 27);  ///< Phase V Zero Crossing Comperator High Status
        constexpr uint32_t PHV_ZCLOW_SCLR = (1U << 26);  ///< Phase V Zero Crossing Comperator Low Status
        constexpr uint32_t PHU_ZCHI_SCLR = (1U << 25);  ///< Phase U Zero Crossing Comperator High Status
        constexpr uint32_t PHU_ZCLOW_SCLR = (1U << 24);  ///< Phase U Zero Crossing Comperator Low Status
        ...
        constexpr uint32_t PHW_ZCHI_ICLR = (1U << 21);  ///< Phase W Zero Crossing Comperator High Interrupt Status
        constexpr uint32_t PHW_ZCLOW_ICLR = (1U << 20);  ///< Phase W Zero Crossing Comperator Low Interrupt Status
        constexpr uint32_t PHV_ZCHI_ICLR = (1U << 19);  ///< Phase V Zero Crossing Comperator High Interrupt Status
        constexpr uint32_t PHV_ZCLOW_ICLR = (1U << 18);  ///< Phase V Zero Crossing Comperator Low Interrupt Status
        constexpr uint32_t PHU_ZCHI_ICLR = (1U << 17);  ///< Phase U Zero Crossing Comperator High Interrupt Status
        constexpr uint32_t PHU_ZCLOW_ICLR = (1U << 16);  ///< Phase U Zero Crossing Comperator Low Interrupt Status
    ...
    namespace sys_supply_irq_clr_bits {
        ...
        constexpr uint32_t MON_OV_SCLR = (1U << 20);  ///< MON Overvoltage Status
        ...
        constexpr uint32_t MON_UV_SCLR = (1U << 16);  ///< MON Undervoltage Status
        ...
        constexpr uint32_t MON_OV_ICLR = (1U << 4);  ///< MON Overvoltage Interrupt Status (ADC2 channel 4)
        ...
        constexpr uint32_t MON_UV_ICLR = (1U << 0);  ///< MON Undervoltage Interrupt Status (ADC2 channel 4)
    }
    ...
    namespace sys_supply_irq_ctrl_bits {
        ...
        constexpr uint32_t MON_OV_IE = (1U << 4);  ///< MON Overvoltage Interrupt Enable
        ...
        constexpr uint32_t MON_UV_IE = (1U << 0);  ///< MON Undervoltage Interrupt Enable
    }
    ...
    namespace sys_supply_irq_sts_bits {
        ...
        constexpr uint32_t MON_OV_STS = (1U << 20);  ///< MON Overvoltage Status
        ...
        constexpr uint32_t MON_UV_STS = (1U << 16);  ///< MON Undervoltage Status
        ...
        constexpr uint32_t MON_OV_IS = (1U << 4);  ///< MON Overvoltage Interrupt Status (ADC2 channel 4)
        ...
        constexpr uint32_t MON_UV_IS = (1U << 0);  ///< MON Undervoltage Interrupt Status (ADC2 channel 4)
    }
...
#endif // ALLOY_GENERATED_TLE987X_PERIPHERALS_HPP