...
#ifndef ALLOY_GENERATED_XMC1200_PERIPHERALS_HPP
#define ALLOY_GENERATED_XMC1200_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::xmc1200 {
...
namespace traits {
    ...
    constexpr bool has_ledts1 = true;
    constexpr uint32_t num_ledts1_instances = 1;
    ...
    constexpr bool has_bccu0 = true;
    constexpr uint32_t num_bccu0_instances = 13;
    ...
    template<>
    struct peripheral_count<struct ledts1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct bccu0_tag> {
...
namespace pau {
    ...
    namespace avail2_bits {
        constexpr uint32_t AVAIL13 = (1U << 13);  ///< LEDTS0 Sync Master Availability Flag
        constexpr uint32_t AVAIL14 = (1U << 14);  ///< LEDTS1 Sync Slave Availability Flag
    ...
    namespace privdis2_bits {
        constexpr uint32_t PDIS13 = (1U << 13);  ///< LEDTS0 Sync Master Privilege Disable Flag
        constexpr uint32_t PDIS14 = (1U << 14);  ///< LEDTS1 Sync Slave Privilege Disable Flag
...
namespace comp {
    ...
    namespace anacmp0_bits {
        ...
        constexpr uint32_t ACMP0_SEL = (1U << 6);  ///< Connect ACMP0.INP to ACMP1.INP
...
#endif // ALLOY_GENERATED_XMC1200_PERIPHERALS_HPP