...
namespace pau {
    ...
    namespace avail2_bits {
        constexpr uint32_t AVAIL0 = (1U << 0);  ///< CC80 and CCU80 kernel SFRs Availability Flag
        constexpr uint32_t AVAIL1 = (1U << 1);  ///< CC81 Availability Flag
        constexpr uint32_t AVAIL2 = (1U << 2);  ///< CC82 Availability Flag
        constexpr uint32_t AVAIL3 = (1U << 3);  ///< CC83 Availability Flag
    ...
    namespace privdis2_bits {
        ...
        constexpr uint32_t PDIS1 = (1U << 1);  ///< CC81 Privilege Disable Flag
        constexpr uint32_t PDIS2 = (1U << 2);  ///< CC82 Privilege Disable Flag
        constexpr uint32_t PDIS3 = (1U << 3);  ///< CC83 Privilege Disable Flag
...
#endif // ALLOY_GENERATED_XMC1300_PERIPHERALS_HPP