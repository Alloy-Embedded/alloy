...
extern "C" {
    ...
    void TWIM0_TWIS0_TWI0_SPIM1_SPIS1_SPI1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void SPIM0_SPIS0_SPI0_IRQHandler() __attribute__((weak, alias("Default_Handler")));
