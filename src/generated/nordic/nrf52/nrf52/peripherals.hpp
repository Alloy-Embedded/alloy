/// Auto-generated code for nrf52
/// Generated by Alloy Code Generator
/// Source: nordic_nrf52.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:35
#ifndef ALLOY_GENERATED_NRF52_PERIPHERALS_HPP
#define ALLOY_GENERATED_NRF52_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::nrf52 {
...
namespace traits {
    ...
    constexpr uint32_t num_spi_instances = 9;
...
namespace ficr {
    ...
    struct Registers {
        ...
        volatile uint32_t DEVICEID__;  ///< Offset: 0x60 - Description collection[0]: Device identifier (renamed from DEVICEID__)
        volatile uint32_t ER__;  ///< Offset: 0x80 - Description collection[0]: Encryption Root, word 0 (renamed from ER__)
        volatile uint32_t IR__;  ///< Offset: 0x90 - Description collection[0]: Identity Root, word 0 (renamed from IR__)
        volatile uint32_t DEVICEADDRTYPE;  ///< Offset: 0xA0 - Device address type
        volatile uint32_t DEVICEADDR__;  ///< Offset: 0xA4 - Description collection[0]: Device address 0 (renamed from DEVICEADDR__)
        ...
        volatile uint32_t UNUSED0__;  ///< Offset: 0x14 - Description collection[0]: Unspecified (renamed from UNUSED0__)
...
namespace uicr {
    ...
    struct Registers {
        volatile uint32_t UNUSED0;  ///< Offset: 0x00 - Unspecified
        volatile uint32_t UNUSED1;  ///< Offset: 0x04 - Unspecified
        volatile uint32_t UNUSED2;  ///< Offset: 0x08 - Unspecified
        volatile uint32_t UNUSED3;  ///< Offset: 0x10 - Unspecified
        volatile uint32_t NRFFW__;  ///< Offset: 0x14 - Description collection[0]: Reserved for Nordic firmware design (renamed from NRFFW__)
        volatile uint32_t NRFHW__;  ///< Offset: 0x50 - Description collection[0]: Reserved for Nordic hardware design (renamed from NRFHW__)
        volatile uint32_t CUSTOMER__;  ///< Offset: 0x80 - Description collection[0]: Reserved for customer (renamed from CUSTOMER__)
        volatile uint32_t PSELRESET__;  ///< Offset: 0x200 - Description collection[0]: Mapping of the nRESET... (renamed from PSELRESET__)
    ...
    namespace pselreset___bits {
        constexpr uint32_t PIN = (6 << 0);  ///< GPIO number P0.n onto which Reset is exposed
        constexpr uint32_t CONNECT = (1U << 31);  ///< Connection
    }

    /// APPROTECT Register bits
    namespace approtect_bits {
        constexpr uint32_t PALL = (8 << 0);  ///< Enable or disable Access Port protection. Any other value than 0xFF being written to this field will enable protection.
    }
...
namespace bprot {
    ...
    struct Registers {
        ...
        volatile uint32_t DISABLEINDEBUG;  ///< Offset: 0x608 - Disable protection mechanism in debug interface mode
        volatile uint32_t UNUSED0;  ///< Offset: 0x60C - Unspecified
        volatile uint32_t CONFIG2;  ///< Offset: 0x610 - Block protect configuration register 2
        volatile uint32_t CONFIG3;  ///< Offset: 0x614 - Block protect configuration register 3
    };
    ...
    namespace config1_bits {
        ...
        constexpr uint32_t REGION48 = (1U << 16);  ///< Enable protection for region 48. Write '0' has no effect.
        constexpr uint32_t REGION49 = (1U << 17);  ///< Enable protection for region 49. Write '0' has no effect.
        constexpr uint32_t REGION50 = (1U << 18);  ///< Enable protection for region 50. Write '0' has no effect.
        constexpr uint32_t REGION51 = (1U << 19);  ///< Enable protection for region 51. Write '0' has no effect.
        constexpr uint32_t REGION52 = (1U << 20);  ///< Enable protection for region 52. Write '0' has no effect.
        constexpr uint32_t REGION53 = (1U << 21);  ///< Enable protection for region 53. Write '0' has no effect.
        constexpr uint32_t REGION54 = (1U << 22);  ///< Enable protection for region 54. Write '0' has no effect.
        constexpr uint32_t REGION55 = (1U << 23);  ///< Enable protection for region 55. Write '0' has no effect.
        constexpr uint32_t REGION56 = (1U << 24);  ///< Enable protection for region 56. Write '0' has no effect.
        constexpr uint32_t REGION57 = (1U << 25);  ///< Enable protection for region 57. Write '0' has no effect.
        constexpr uint32_t REGION58 = (1U << 26);  ///< Enable protection for region 58. Write '0' has no effect.
        constexpr uint32_t REGION59 = (1U << 27);  ///< Enable protection for region 59. Write '0' has no effect.
        constexpr uint32_t REGION60 = (1U << 28);  ///< Enable protection for region 60. Write '0' has no effect.
        constexpr uint32_t REGION61 = (1U << 29);  ///< Enable protection for region 61. Write '0' has no effect.
        constexpr uint32_t REGION62 = (1U << 30);  ///< Enable protection for region 62. Write '0' has no effect.
        constexpr uint32_t REGION63 = (1U << 31);  ///< Enable protection for region 63. Write '0' has no effect.
    }

    /// DISABLEINDEBUG Register bits
    namespace disableindebug_bits {
        constexpr uint32_t DISABLEINDEBUG = (1U << 0);  ///< Disable the protection mechanism for NVM regions while in debug interface mode. This register will only disable the protection mechanism if the device is in debug interface mode.
    }

    /// CONFIG2 Register bits
    namespace config2_bits {
        constexpr uint32_t REGION64 = (1U << 0);  ///< Enable protection for region 64. Write '0' has no effect.
        constexpr uint32_t REGION65 = (1U << 1);  ///< Enable protection for region 65. Write '0' has no effect.
        constexpr uint32_t REGION66 = (1U << 2);  ///< Enable protection for region 66. Write '0' has no effect.
        constexpr uint32_t REGION67 = (1U << 3);  ///< Enable protection for region 67. Write '0' has no effect.
        constexpr uint32_t REGION68 = (1U << 4);  ///< Enable protection for region 68. Write '0' has no effect.
        constexpr uint32_t REGION69 = (1U << 5);  ///< Enable protection for region 69. Write '0' has no effect.
        constexpr uint32_t REGION70 = (1U << 6);  ///< Enable protection for region 70. Write '0' has no effect.
        constexpr uint32_t REGION71 = (1U << 7);  ///< Enable protection for region 71. Write '0' has no effect.
        constexpr uint32_t REGION72 = (1U << 8);  ///< Enable protection for region 72. Write '0' has no effect.
        constexpr uint32_t REGION73 = (1U << 9);  ///< Enable protection for region 73. Write '0' has no effect.
        constexpr uint32_t REGION74 = (1U << 10);  ///< Enable protection for region 74. Write '0' has no effect.
        constexpr uint32_t REGION75 = (1U << 11);  ///< Enable protection for region 75. Write '0' has no effect.
        constexpr uint32_t REGION76 = (1U << 12);  ///< Enable protection for region 76. Write '0' has no effect.
        constexpr uint32_t REGION77 = (1U << 13);  ///< Enable protection for region 77. Write '0' has no effect.
        constexpr uint32_t REGION78 = (1U << 14);  ///< Enable protection for region 78. Write '0' has no effect.
        constexpr uint32_t REGION79 = (1U << 15);  ///< Enable protection for region 79. Write '0' has no effect.
        constexpr uint32_t REGION80 = (1U << 16);  ///< Enable protection for region 80. Write '0' has no effect.
        constexpr uint32_t REGION81 = (1U << 17);  ///< Enable protection for region 81. Write '0' has no effect.
        constexpr uint32_t REGION82 = (1U << 18);  ///< Enable protection for region 82. Write '0' has no effect.
        constexpr uint32_t REGION83 = (1U << 19);  ///< Enable protection for region 83. Write '0' has no effect.
        constexpr uint32_t REGION84 = (1U << 20);  ///< Enable protection for region 84. Write '0' has no effect.
        constexpr uint32_t REGION85 = (1U << 21);  ///< Enable protection for region 85. Write '0' has no effect.
        constexpr uint32_t REGION86 = (1U << 22);  ///< Enable protection for region 86. Write '0' has no effect.
        constexpr uint32_t REGION87 = (1U << 23);  ///< Enable protection for region 87. Write '0' has no effect.
        constexpr uint32_t REGION88 = (1U << 24);  ///< Enable protection for region 88. Write '0' has no effect.
        constexpr uint32_t REGION89 = (1U << 25);  ///< Enable protection for region 89. Write '0' has no effect.
        constexpr uint32_t REGION90 = (1U << 26);  ///< Enable protection for region 90. Write '0' has no effect.
        constexpr uint32_t REGION91 = (1U << 27);  ///< Enable protection for region 91. Write '0' has no effect.
        constexpr uint32_t REGION92 = (1U << 28);  ///< Enable protection for region 92. Write '0' has no effect.
        constexpr uint32_t REGION93 = (1U << 29);  ///< Enable protection for region 93. Write '0' has no effect.
        constexpr uint32_t REGION94 = (1U << 30);  ///< Enable protection for region 94. Write '0' has no effect.
        constexpr uint32_t REGION95 = (1U << 31);  ///< Enable protection for region 95. Write '0' has no effect.
    }

    /// CONFIG3 Register bits
    namespace config3_bits {
        constexpr uint32_t REGION96 = (1U << 0);  ///< Enable protection for region 96. Write '0' has no effect.
        constexpr uint32_t REGION97 = (1U << 1);  ///< Enable protection for region 97. Write '0' has no effect.
        constexpr uint32_t REGION98 = (1U << 2);  ///< Enable protection for region 98. Write '0' has no effect.
        constexpr uint32_t REGION99 = (1U << 3);  ///< Enable protection for region 99. Write '0' has no effect.
        constexpr uint32_t REGION100 = (1U << 4);  ///< Enable protection for region 100. Write '0' has no effect.
        constexpr uint32_t REGION101 = (1U << 5);  ///< Enable protection for region 101. Write '0' has no effect.
        constexpr uint32_t REGION102 = (1U << 6);  ///< Enable protection for region 102. Write '0' has no effect.
        constexpr uint32_t REGION103 = (1U << 7);  ///< Enable protection for region 103. Write '0' has no effect.
        constexpr uint32_t REGION104 = (1U << 8);  ///< Enable protection for region 104. Write '0' has no effect.
        constexpr uint32_t REGION105 = (1U << 9);  ///< Enable protection for region 105. Write '0' has no effect.
        constexpr uint32_t REGION106 = (1U << 10);  ///< Enable protection for region 106. Write '0' has no effect.
        constexpr uint32_t REGION107 = (1U << 11);  ///< Enable protection for region 107. Write '0' has no effect.
        constexpr uint32_t REGION108 = (1U << 12);  ///< Enable protection for region 108. Write '0' has no effect.
        constexpr uint32_t REGION109 = (1U << 13);  ///< Enable protection for region 109. Write '0' has no effect.
        constexpr uint32_t REGION110 = (1U << 14);  ///< Enable protection for region 110. Write '0' has no effect.
        constexpr uint32_t REGION111 = (1U << 15);  ///< Enable protection for region 111. Write '0' has no effect.
        constexpr uint32_t REGION112 = (1U << 16);  ///< Enable protection for region 112. Write '0' has no effect.
        constexpr uint32_t REGION113 = (1U << 17);  ///< Enable protection for region 113. Write '0' has no effect.
        constexpr uint32_t REGION114 = (1U << 18);  ///< Enable protection for region 114. Write '0' has no effect.
        constexpr uint32_t REGION115 = (1U << 19);  ///< Enable protection for region 115. Write '0' has no effect.
        constexpr uint32_t REGION116 = (1U << 20);  ///< Enable protection for region 116. Write '0' has no effect.
        constexpr uint32_t REGION117 = (1U << 21);  ///< Enable protection for region 117. Write '0' has no effect.
        constexpr uint32_t REGION118 = (1U << 22);  ///< Enable protection for region 118. Write '0' has no effect.
        constexpr uint32_t REGION119 = (1U << 23);  ///< Enable protection for region 119. Write '0' has no effect.
        constexpr uint32_t REGION120 = (1U << 24);  ///< Enable protection for region 120. Write '0' has no effect.
        constexpr uint32_t REGION121 = (1U << 25);  ///< Enable protection for region 121. Write '0' has no effect.
        constexpr uint32_t REGION122 = (1U << 26);  ///< Enable protection for region 122. Write '0' has no effect.
        constexpr uint32_t REGION123 = (1U << 27);  ///< Enable protection for region 123. Write '0' has no effect.
        constexpr uint32_t REGION124 = (1U << 28);  ///< Enable protection for region 124. Write '0' has no effect.
        constexpr uint32_t REGION125 = (1U << 29);  ///< Enable protection for region 125. Write '0' has no effect.
        constexpr uint32_t REGION126 = (1U << 30);  ///< Enable protection for region 126. Write '0' has no effect.
        constexpr uint32_t REGION127 = (1U << 31);  ///< Enable protection for region 127. Write '0' has no effect.
    }
...
namespace pwr {
    ...
    struct Registers {
        ...
        volatile uint32_t RAMON;  ///< Offset: 0x524 - Deprecated register - RAM on/off register (this register...
        volatile uint32_t RAMONB;  ///< Offset: 0x554 - Deprecated register - RAM on/off register (this register...
        volatile uint32_t DCDCEN;  ///< Offset: 0x578 - DC/DC enable register
        volatile uint32_t POWER;  ///< Offset: 0x00 - Description cluster[0]: RAM0 power control register
        volatile uint32_t POWERSET;  ///< Offset: 0x04 - Description cluster[0]: RAM0 power control set register
        volatile uint32_t POWERCLR;  ///< Offset: 0x08 - Description cluster[0]: RAM0 power control clear register
    };
    ...
    namespace intenset_bits {
        constexpr uint32_t POFWARN = (1U << 2);  ///< Write '1' to Enable interrupt for POFWARN event
        constexpr uint32_t SLEEPENTER = (1U << 5);  ///< Write '1' to Enable interrupt for SLEEPENTER event
        constexpr uint32_t SLEEPEXIT = (1U << 6);  ///< Write '1' to Enable interrupt for SLEEPEXIT event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t POFWARN = (1U << 2);  ///< Write '1' to Disable interrupt for POFWARN event
        constexpr uint32_t SLEEPENTER = (1U << 5);  ///< Write '1' to Disable interrupt for SLEEPENTER event
        constexpr uint32_t SLEEPEXIT = (1U << 6);  ///< Write '1' to Disable interrupt for SLEEPEXIT event
    }
    ...
    namespace ramon_bits {
        constexpr uint32_t ONRAM0 = (1U << 0);  ///< Keep RAM block 0 on or off in system ON Mode
        constexpr uint32_t ONRAM1 = (1U << 1);  ///< Keep RAM block 1 on or off in system ON Mode
        constexpr uint32_t OFFRAM0 = (1U << 16);  ///< Keep retention on RAM block 0 when RAM block is switched off
        constexpr uint32_t OFFRAM1 = (1U << 17);  ///< Keep retention on RAM block 1 when RAM block is switched off
    }

    /// RAMONB Register bits
    namespace ramonb_bits {
        constexpr uint32_t ONRAM2 = (1U << 0);  ///< Keep RAM block 2 on or off in system ON Mode
        constexpr uint32_t ONRAM3 = (1U << 1);  ///< Keep RAM block 3 on or off in system ON Mode
        constexpr uint32_t OFFRAM2 = (1U << 16);  ///< Keep retention on RAM block 2 when RAM block is switched off
        constexpr uint32_t OFFRAM3 = (1U << 17);  ///< Keep retention on RAM block 3 when RAM block is switched off
    }
    ...
    namespace powerset_bits {
        constexpr uint32_t S0POWER = (1U << 0);  ///< Keep RAM section S0 of RAM0 on or off in System ON mode
        constexpr uint32_t S1POWER = (1U << 1);  ///< Keep RAM section S1 of RAM0 on or off in System ON mode
...
namespace rcc {
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t HFCLKSTARTED = (1U << 0);  ///< Write '1' to Enable interrupt for HFCLKSTARTED event
        constexpr uint32_t LFCLKSTARTED = (1U << 1);  ///< Write '1' to Enable interrupt for LFCLKSTARTED event
        constexpr uint32_t DONE = (1U << 3);  ///< Write '1' to Enable interrupt for DONE event
        constexpr uint32_t CTTO = (1U << 4);  ///< Write '1' to Enable interrupt for CTTO event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t HFCLKSTARTED = (1U << 0);  ///< Write '1' to Disable interrupt for HFCLKSTARTED event
        constexpr uint32_t LFCLKSTARTED = (1U << 1);  ///< Write '1' to Disable interrupt for LFCLKSTARTED event
        constexpr uint32_t DONE = (1U << 3);  ///< Write '1' to Disable interrupt for DONE event
        constexpr uint32_t CTTO = (1U << 4);  ///< Write '1' to Disable interrupt for CTTO event
    }
    ...
    namespace traceconfig_bits {
        ...
        constexpr uint32_t TRACEMUX = (2 << 16);  ///< Pin multiplexing of trace signals.
    }
...
namespace radio {
    ...
    struct Registers {
        ...
        volatile uint32_t SHORTS;  ///< Offset: 0x200 - Shortcut register
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
        ...
        volatile uint32_t UNUSED0;  ///< Offset: 0x540 - Unspecified
        ...
        volatile uint32_t DAB__;  ///< Offset: 0x600 - Description collection[0]: Device address base segment 0 (renamed from DAB__)
        volatile uint32_t DAP__;  ///< Offset: 0x620 - Description collection[0]: Device address prefix 0 (renamed from DAP__)
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Write '1' to Enable interrupt for READY event
        constexpr uint32_t ADDRESS = (1U << 1);  ///< Write '1' to Enable interrupt for ADDRESS event
        constexpr uint32_t PAYLOAD = (1U << 2);  ///< Write '1' to Enable interrupt for PAYLOAD event
        constexpr uint32_t END = (1U << 3);  ///< Write '1' to Enable interrupt for END event
        constexpr uint32_t DISABLED = (1U << 4);  ///< Write '1' to Enable interrupt for DISABLED event
        constexpr uint32_t DEVMATCH = (1U << 5);  ///< Write '1' to Enable interrupt for DEVMATCH event
        constexpr uint32_t DEVMISS = (1U << 6);  ///< Write '1' to Enable interrupt for DEVMISS event
        constexpr uint32_t RSSIEND = (1U << 7);  ///< Write '1' to Enable interrupt for RSSIEND event
        constexpr uint32_t BCMATCH = (1U << 10);  ///< Write '1' to Enable interrupt for BCMATCH event
        constexpr uint32_t CRCOK = (1U << 12);  ///< Write '1' to Enable interrupt for CRCOK event
        constexpr uint32_t CRCERROR = (1U << 13);  ///< Write '1' to Enable interrupt for CRCERROR event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Write '1' to Disable interrupt for READY event
        constexpr uint32_t ADDRESS = (1U << 1);  ///< Write '1' to Disable interrupt for ADDRESS event
        constexpr uint32_t PAYLOAD = (1U << 2);  ///< Write '1' to Disable interrupt for PAYLOAD event
        constexpr uint32_t END = (1U << 3);  ///< Write '1' to Disable interrupt for END event
        constexpr uint32_t DISABLED = (1U << 4);  ///< Write '1' to Disable interrupt for DISABLED event
        constexpr uint32_t DEVMATCH = (1U << 5);  ///< Write '1' to Disable interrupt for DEVMATCH event
        constexpr uint32_t DEVMISS = (1U << 6);  ///< Write '1' to Disable interrupt for DEVMISS event
        constexpr uint32_t RSSIEND = (1U << 7);  ///< Write '1' to Disable interrupt for RSSIEND event
        constexpr uint32_t BCMATCH = (1U << 10);  ///< Write '1' to Disable interrupt for BCMATCH event
        constexpr uint32_t CRCOK = (1U << 12);  ///< Write '1' to Disable interrupt for CRCOK event
        constexpr uint32_t CRCERROR = (1U << 13);  ///< Write '1' to Disable interrupt for CRCERROR event
    }
    ...
    namespace dab___bits {
        constexpr uint32_t DAB = (32 << 0);  ///< Device address base segment 0
    }

    /// DAP__ Register bits
    namespace dap___bits {
        constexpr uint32_t DAP = (16 << 0);  ///< Device address prefix 0
    }
...
namespace usart {
    ...
    /// SHORTS Register bits
    namespace shorts_bits {
        constexpr uint32_t ENDRX_STARTRX = (1U << 5);  ///< Shortcut between ENDRX event and STARTRX task
        constexpr uint32_t ENDRX_STOPRX = (1U << 6);  ///< Shortcut between ENDRX event and STOPRX task
    }

    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t CTS = (1U << 0);  ///< Enable or disable interrupt for CTS event
        constexpr uint32_t NCTS = (1U << 1);  ///< Enable or disable interrupt for NCTS event
        constexpr uint32_t RXDRDY = (1U << 2);  ///< Enable or disable interrupt for RXDRDY event
        constexpr uint32_t ENDRX = (1U << 4);  ///< Enable or disable interrupt for ENDRX event
        constexpr uint32_t TXDRDY = (1U << 7);  ///< Enable or disable interrupt for TXDRDY event
        constexpr uint32_t ENDTX = (1U << 8);  ///< Enable or disable interrupt for ENDTX event
        constexpr uint32_t ERROR = (1U << 9);  ///< Enable or disable interrupt for ERROR event
        constexpr uint32_t RXTO = (1U << 17);  ///< Enable or disable interrupt for RXTO event
        constexpr uint32_t RXSTARTED = (1U << 19);  ///< Enable or disable interrupt for RXSTARTED event
        constexpr uint32_t TXSTARTED = (1U << 20);  ///< Enable or disable interrupt for TXSTARTED event
        constexpr uint32_t TXSTOPPED = (1U << 22);  ///< Enable or disable interrupt for TXSTOPPED event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t CTS = (1U << 0);  ///< Write '1' to Enable interrupt for CTS event
        constexpr uint32_t NCTS = (1U << 1);  ///< Write '1' to Enable interrupt for NCTS event
        constexpr uint32_t RXDRDY = (1U << 2);  ///< Write '1' to Enable interrupt for RXDRDY event
        constexpr uint32_t ENDRX = (1U << 4);  ///< Write '1' to Enable interrupt for ENDRX event
        constexpr uint32_t TXDRDY = (1U << 7);  ///< Write '1' to Enable interrupt for TXDRDY event
        constexpr uint32_t ENDTX = (1U << 8);  ///< Write '1' to Enable interrupt for ENDTX event
        constexpr uint32_t ERROR = (1U << 9);  ///< Write '1' to Enable interrupt for ERROR event
        constexpr uint32_t RXTO = (1U << 17);  ///< Write '1' to Enable interrupt for RXTO event
        constexpr uint32_t RXSTARTED = (1U << 19);  ///< Write '1' to Enable interrupt for RXSTARTED event
        constexpr uint32_t TXSTARTED = (1U << 20);  ///< Write '1' to Enable interrupt for TXSTARTED event
        constexpr uint32_t TXSTOPPED = (1U << 22);  ///< Write '1' to Enable interrupt for TXSTOPPED event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t CTS = (1U << 0);  ///< Write '1' to Disable interrupt for CTS event
        constexpr uint32_t NCTS = (1U << 1);  ///< Write '1' to Disable interrupt for NCTS event
        constexpr uint32_t RXDRDY = (1U << 2);  ///< Write '1' to Disable interrupt for RXDRDY event
        constexpr uint32_t ENDRX = (1U << 4);  ///< Write '1' to Disable interrupt for ENDRX event
        constexpr uint32_t TXDRDY = (1U << 7);  ///< Write '1' to Disable interrupt for TXDRDY event
        constexpr uint32_t ENDTX = (1U << 8);  ///< Write '1' to Disable interrupt for ENDTX event
        constexpr uint32_t ERROR = (1U << 9);  ///< Write '1' to Disable interrupt for ERROR event
        constexpr uint32_t RXTO = (1U << 17);  ///< Write '1' to Disable interrupt for RXTO event
        constexpr uint32_t RXSTARTED = (1U << 19);  ///< Write '1' to Disable interrupt for RXSTARTED event
        constexpr uint32_t TXSTARTED = (1U << 20);  ///< Write '1' to Disable interrupt for TXSTARTED event
        constexpr uint32_t TXSTOPPED = (1U << 22);  ///< Write '1' to Disable interrupt for TXSTOPPED event
    }
    ...
    namespace maxcnt_bits {
        constexpr uint32_t MAXCNT = (8 << 0);  ///< Maximum number of bytes in transmit buffer
    }

    /// AMOUNT Register bits
    namespace amount_bits {
        constexpr uint32_t AMOUNT = (8 << 0);  ///< Number of bytes transferred in the last transaction
    }
...
namespace spi {
    ...
    struct Registers {
        ...
        volatile uint32_t ORC;  ///< Offset: 0x5C0 - Over-read character. Character clocked out in case and...
    };
    ...
    /// SHORTS Register bits
    namespace shorts_bits {
        constexpr uint32_t END_START = (1U << 17);  ///< Shortcut between END event and START task
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Enable interrupt for STOPPED event
        constexpr uint32_t ENDRX = (1U << 4);  ///< Write '1' to Enable interrupt for ENDRX event
        constexpr uint32_t END = (1U << 6);  ///< Write '1' to Enable interrupt for END event
        constexpr uint32_t ENDTX = (1U << 8);  ///< Write '1' to Enable interrupt for ENDTX event
        constexpr uint32_t STARTED = (1U << 19);  ///< Write '1' to Enable interrupt for STARTED event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Disable interrupt for STOPPED event
        constexpr uint32_t ENDRX = (1U << 4);  ///< Write '1' to Disable interrupt for ENDRX event
        constexpr uint32_t END = (1U << 6);  ///< Write '1' to Disable interrupt for END event
        constexpr uint32_t ENDTX = (1U << 8);  ///< Write '1' to Disable interrupt for ENDTX event
        constexpr uint32_t STARTED = (1U << 19);  ///< Write '1' to Disable interrupt for STARTED event
    }
    ...
    /// ORC Register bits
    namespace orc_bits {
        constexpr uint32_t ORC = (8 << 0);  ///< Over-read character. Character clocked out in case and over-read of the TXD buffer.
    }
...
namespace i2c {
    ...
    struct Registers {
        ...
        volatile uint32_t EVENTS_SUSPENDED;  ///< Offset: 0x148 - Last byte has been sent out after the SUSPEND task has...
        ...
        volatile uint32_t FREQUENCY;  ///< Offset: 0x524 - TWI frequency
        volatile uint32_t PTR;  ///< Offset: 0x00 - Data pointer
        volatile uint32_t MAXCNT;  ///< Offset: 0x04 - Maximum number of bytes in transmit buffer
        volatile uint32_t AMOUNT;  ///< Offset: 0x08 - Number of bytes transferred in the last transaction
        volatile uint32_t LIST;  ///< Offset: 0x0C - EasyDMA list type
    ...
    /// SHORTS Register bits
    namespace shorts_bits {
        constexpr uint32_t LASTTX_STARTRX = (1U << 7);  ///< Shortcut between LASTTX event and STARTRX task
        constexpr uint32_t LASTTX_SUSPEND = (1U << 8);  ///< Shortcut between LASTTX event and SUSPEND task
        constexpr uint32_t LASTTX_STOP = (1U << 9);  ///< Shortcut between LASTTX event and STOP task
        constexpr uint32_t LASTRX_STARTTX = (1U << 10);  ///< Shortcut between LASTRX event and STARTTX task
        constexpr uint32_t LASTRX_STOP = (1U << 12);  ///< Shortcut between LASTRX event and STOP task
    }

    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Enable or disable interrupt for STOPPED event
        constexpr uint32_t ERROR = (1U << 9);  ///< Enable or disable interrupt for ERROR event
        constexpr uint32_t SUSPENDED = (1U << 18);  ///< Enable or disable interrupt for SUSPENDED event
        constexpr uint32_t RXSTARTED = (1U << 19);  ///< Enable or disable interrupt for RXSTARTED event
        constexpr uint32_t TXSTARTED = (1U << 20);  ///< Enable or disable interrupt for TXSTARTED event
        constexpr uint32_t LASTRX = (1U << 23);  ///< Enable or disable interrupt for LASTRX event
        constexpr uint32_t LASTTX = (1U << 24);  ///< Enable or disable interrupt for LASTTX event
    }
    ...
    namespace intenset_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Enable interrupt for STOPPED event
        constexpr uint32_t ERROR = (1U << 9);  ///< Write '1' to Enable interrupt for ERROR event
        constexpr uint32_t SUSPENDED = (1U << 18);  ///< Write '1' to Enable interrupt for SUSPENDED event
        constexpr uint32_t RXSTARTED = (1U << 19);  ///< Write '1' to Enable interrupt for RXSTARTED event
        constexpr uint32_t TXSTARTED = (1U << 20);  ///< Write '1' to Enable interrupt for TXSTARTED event
        constexpr uint32_t LASTRX = (1U << 23);  ///< Write '1' to Enable interrupt for LASTRX event
        constexpr uint32_t LASTTX = (1U << 24);  ///< Write '1' to Enable interrupt for LASTTX event
    }
    ...
    namespace intenclr_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Disable interrupt for STOPPED event
        constexpr uint32_t ERROR = (1U << 9);  ///< Write '1' to Disable interrupt for ERROR event
        constexpr uint32_t SUSPENDED = (1U << 18);  ///< Write '1' to Disable interrupt for SUSPENDED event
        constexpr uint32_t RXSTARTED = (1U << 19);  ///< Write '1' to Disable interrupt for RXSTARTED event
        constexpr uint32_t TXSTARTED = (1U << 20);  ///< Write '1' to Disable interrupt for TXSTARTED event
        constexpr uint32_t LASTRX = (1U << 23);  ///< Write '1' to Disable interrupt for LASTRX event
        constexpr uint32_t LASTTX = (1U << 24);  ///< Write '1' to Disable interrupt for LASTTX event
    }
    ...
    /// AMOUNT Register bits
    namespace amount_bits {
        constexpr uint32_t AMOUNT = (8 << 0);  ///< Number of bytes transferred in the last transaction. In case of NACK error, includes the NACK'ed byte.
    }
...
namespace nfct {
    ...
    struct Registers {
        volatile uint32_t TASKS_ACTIVATE;  ///< Offset: 0x00 - Activate NFC peripheral for incoming and outgoing...
        volatile uint32_t TASKS_DISABLE;  ///< Offset: 0x04 - Disable NFC peripheral
        volatile uint32_t TASKS_SENSE;  ///< Offset: 0x08 - Enable NFC sense field mode, change state to sense mode
        volatile uint32_t TASKS_STARTTX;  ///< Offset: 0x0C - Start transmission of a outgoing frame, change state to transmit
        ...
        volatile uint32_t EVENTS_READY;  ///< Offset: 0x100 - The NFC peripheral is ready to receive and send frames
        ...
        volatile uint32_t EVENTS_RXFRAMEEND;  ///< Offset: 0x118 - Received data have been checked (CRC, parity) and...
        ...
        volatile uint32_t RX;  ///< Offset: 0x00 - Result of last incoming frames
        volatile uint32_t CURRENTLOADCTRL;  ///< Offset: 0x430 - Current value driven to the NFC Load Control
        ...
        volatile uint32_t MAXLEN;  ///< Offset: 0x514 - Size of allocated for TXD and RXD data storage buffer in Data RAM
    ...
    /// SHORTS Register bits
    namespace shorts_bits {
        constexpr uint32_t FIELDDETECTED_ACTIVATE = (1U << 0);  ///< Shortcut between FIELDDETECTED event and ACTIVATE task
        constexpr uint32_t FIELDLOST_SENSE = (1U << 1);  ///< Shortcut between FIELDLOST event and SENSE task
    }

    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Enable or disable interrupt for READY event
        constexpr uint32_t FIELDDETECTED = (1U << 1);  ///< Enable or disable interrupt for FIELDDETECTED event
        constexpr uint32_t FIELDLOST = (1U << 2);  ///< Enable or disable interrupt for FIELDLOST event
        constexpr uint32_t TXFRAMESTART = (1U << 3);  ///< Enable or disable interrupt for TXFRAMESTART event
        constexpr uint32_t TXFRAMEEND = (1U << 4);  ///< Enable or disable interrupt for TXFRAMEEND event
        constexpr uint32_t RXFRAMESTART = (1U << 5);  ///< Enable or disable interrupt for RXFRAMESTART event
        constexpr uint32_t RXFRAMEEND = (1U << 6);  ///< Enable or disable interrupt for RXFRAMEEND event
        constexpr uint32_t ERROR = (1U << 7);  ///< Enable or disable interrupt for ERROR event
        constexpr uint32_t RXERROR = (1U << 10);  ///< Enable or disable interrupt for RXERROR event
        constexpr uint32_t ENDRX = (1U << 11);  ///< Enable or disable interrupt for ENDRX event
        constexpr uint32_t ENDTX = (1U << 12);  ///< Enable or disable interrupt for ENDTX event
        constexpr uint32_t AUTOCOLRESSTARTED = (1U << 14);  ///< Enable or disable interrupt for AUTOCOLRESSTARTED event
        constexpr uint32_t COLLISION = (1U << 18);  ///< Enable or disable interrupt for COLLISION event
        constexpr uint32_t SELECTED = (1U << 19);  ///< Enable or disable interrupt for SELECTED event
        constexpr uint32_t STARTED = (1U << 20);  ///< Enable or disable interrupt for STARTED event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Write '1' to Enable interrupt for READY event
        constexpr uint32_t FIELDDETECTED = (1U << 1);  ///< Write '1' to Enable interrupt for FIELDDETECTED event
        constexpr uint32_t FIELDLOST = (1U << 2);  ///< Write '1' to Enable interrupt for FIELDLOST event
        constexpr uint32_t TXFRAMESTART = (1U << 3);  ///< Write '1' to Enable interrupt for TXFRAMESTART event
        constexpr uint32_t TXFRAMEEND = (1U << 4);  ///< Write '1' to Enable interrupt for TXFRAMEEND event
        constexpr uint32_t RXFRAMESTART = (1U << 5);  ///< Write '1' to Enable interrupt for RXFRAMESTART event
        constexpr uint32_t RXFRAMEEND = (1U << 6);  ///< Write '1' to Enable interrupt for RXFRAMEEND event
        constexpr uint32_t ERROR = (1U << 7);  ///< Write '1' to Enable interrupt for ERROR event
        constexpr uint32_t RXERROR = (1U << 10);  ///< Write '1' to Enable interrupt for RXERROR event
        constexpr uint32_t ENDRX = (1U << 11);  ///< Write '1' to Enable interrupt for ENDRX event
        constexpr uint32_t ENDTX = (1U << 12);  ///< Write '1' to Enable interrupt for ENDTX event
        constexpr uint32_t AUTOCOLRESSTARTED = (1U << 14);  ///< Write '1' to Enable interrupt for AUTOCOLRESSTARTED event
        constexpr uint32_t COLLISION = (1U << 18);  ///< Write '1' to Enable interrupt for COLLISION event
        constexpr uint32_t SELECTED = (1U << 19);  ///< Write '1' to Enable interrupt for SELECTED event
        constexpr uint32_t STARTED = (1U << 20);  ///< Write '1' to Enable interrupt for STARTED event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Write '1' to Disable interrupt for READY event
        constexpr uint32_t FIELDDETECTED = (1U << 1);  ///< Write '1' to Disable interrupt for FIELDDETECTED event
        constexpr uint32_t FIELDLOST = (1U << 2);  ///< Write '1' to Disable interrupt for FIELDLOST event
        constexpr uint32_t TXFRAMESTART = (1U << 3);  ///< Write '1' to Disable interrupt for TXFRAMESTART event
        constexpr uint32_t TXFRAMEEND = (1U << 4);  ///< Write '1' to Disable interrupt for TXFRAMEEND event
        constexpr uint32_t RXFRAMESTART = (1U << 5);  ///< Write '1' to Disable interrupt for RXFRAMESTART event
        constexpr uint32_t RXFRAMEEND = (1U << 6);  ///< Write '1' to Disable interrupt for RXFRAMEEND event
        constexpr uint32_t ERROR = (1U << 7);  ///< Write '1' to Disable interrupt for ERROR event
        constexpr uint32_t RXERROR = (1U << 10);  ///< Write '1' to Disable interrupt for RXERROR event
        constexpr uint32_t ENDRX = (1U << 11);  ///< Write '1' to Disable interrupt for ENDRX event
        constexpr uint32_t ENDTX = (1U << 12);  ///< Write '1' to Disable interrupt for ENDTX event
        constexpr uint32_t AUTOCOLRESSTARTED = (1U << 14);  ///< Write '1' to Disable interrupt for AUTOCOLRESSTARTED event
        constexpr uint32_t COLLISION = (1U << 18);  ///< Write '1' to Disable interrupt for COLLISION event
        constexpr uint32_t SELECTED = (1U << 19);  ///< Write '1' to Disable interrupt for SELECTED event
        constexpr uint32_t STARTED = (1U << 20);  ///< Write '1' to Disable interrupt for STARTED event
    }
    ...
    namespace errorstatus_bits {
        ...
        constexpr uint32_t NFCFIELDTOOSTRONG = (1U << 2);  ///< Field level is too high at max load resistance
        constexpr uint32_t NFCFIELDTOOWEAK = (1U << 3);  ///< Field level is too low at min load resistance
    }

    /// RX Register bits
    namespace rx_bits {
        constexpr uint32_t CRCERROR = (1U << 0);  ///< No valid End of Frame detected
        constexpr uint32_t PARITYSTATUS = (1U << 2);  ///< Parity status of received frame
        constexpr uint32_t OVERRUN = (1U << 3);  ///< Overrun detected
    }

    /// CURRENTLOADCTRL Register bits
    namespace currentloadctrl_bits {
        constexpr uint32_t CURRENTLOADCTRL = (6 << 0);  ///< Current value driven to the NFC Load Control
    }

    /// FIELDPRESENT Register bits
    namespace fieldpresent_bits {
        constexpr uint32_t FIELDPRESENT = (1U << 0);  ///< Indicates the presence or not of a valid field. Available only in the activated state.
    ...
    namespace framedelaymax_bits {
        constexpr uint32_t FRAMEDELAYMAX = (16 << 0);  ///< Maximum frame delay in number of 13.56 MHz clocks
    }
    ...
    namespace maxlen_bits {
        constexpr uint32_t MAXLEN = (9 << 0);  ///< Size of allocated for TXD and RXD data storage buffer in Data RAM
    }

    /// FRAMECONFIG Register bits
    namespace frameconfig_bits {
        constexpr uint32_t PARITY = (1U << 0);  ///< Parity expected or not in RX frame
    ...
    namespace selres_bits {
        ...
        constexpr uint32_t CASCADE = (1U << 2);  ///< Cascade bit (controlled by hardware, write has no effect)
...
namespace gpio {
    ...
    struct Registers {
        volatile uint32_t TASKS_OUT__;  ///< Offset: 0x00 - Description collection[0]: Task for writing to pin... (renamed from TASKS_OUT__)
        volatile uint32_t TASKS_SET__;  ///< Offset: 0x30 - Description collection[0]: Task for writing to pin... (renamed from TASKS_SET__)
        volatile uint32_t TASKS_CLR__;  ///< Offset: 0x60 - Description collection[0]: Task for writing to pin... (renamed from TASKS_CLR__)
        volatile uint32_t EVENTS_IN__;  ///< Offset: 0x100 - Description collection[0]: Event generated from pin... (renamed from EVENTS_IN__)
        volatile uint32_t EVENTS_PORT;  ///< Offset: 0x17C - Event generated from multiple input GPIO pins with SENSE...
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
        volatile uint32_t CONFIG__;  ///< Offset: 0x510 - Description collection[0]: Configuration for OUT[n],... (renamed from CONFIG__)
    };
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t IN0 = (1U << 0);  ///< Write '1' to Enable interrupt for IN[0] event
        constexpr uint32_t IN1 = (1U << 1);  ///< Write '1' to Enable interrupt for IN[1] event
        constexpr uint32_t IN2 = (1U << 2);  ///< Write '1' to Enable interrupt for IN[2] event
        constexpr uint32_t IN3 = (1U << 3);  ///< Write '1' to Enable interrupt for IN[3] event
        constexpr uint32_t IN4 = (1U << 4);  ///< Write '1' to Enable interrupt for IN[4] event
        constexpr uint32_t IN5 = (1U << 5);  ///< Write '1' to Enable interrupt for IN[5] event
        constexpr uint32_t IN6 = (1U << 6);  ///< Write '1' to Enable interrupt for IN[6] event
        constexpr uint32_t IN7 = (1U << 7);  ///< Write '1' to Enable interrupt for IN[7] event
        constexpr uint32_t PORT = (1U << 31);  ///< Write '1' to Enable interrupt for PORT event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t IN0 = (1U << 0);  ///< Write '1' to Disable interrupt for IN[0] event
        constexpr uint32_t IN1 = (1U << 1);  ///< Write '1' to Disable interrupt for IN[1] event
        constexpr uint32_t IN2 = (1U << 2);  ///< Write '1' to Disable interrupt for IN[2] event
        constexpr uint32_t IN3 = (1U << 3);  ///< Write '1' to Disable interrupt for IN[3] event
        constexpr uint32_t IN4 = (1U << 4);  ///< Write '1' to Disable interrupt for IN[4] event
        constexpr uint32_t IN5 = (1U << 5);  ///< Write '1' to Disable interrupt for IN[5] event
        constexpr uint32_t IN6 = (1U << 6);  ///< Write '1' to Disable interrupt for IN[6] event
        constexpr uint32_t IN7 = (1U << 7);  ///< Write '1' to Disable interrupt for IN[7] event
        constexpr uint32_t PORT = (1U << 31);  ///< Write '1' to Disable interrupt for PORT event
    }
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t LIMITH;  ///< Offset: 0x00 - Description cluster[0]: Last results is equal or above...
        volatile uint32_t LIMITL;  ///< Offset: 0x04 - Description cluster[0]: Last results is equal or below...
        volatile uint32_t INTEN;  ///< Offset: 0x300 - Enable or disable interrupt
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
        volatile uint32_t STATUS;  ///< Offset: 0x400 - Status
        volatile uint32_t ENABLE;  ///< Offset: 0x500 - Enable or disable ADC
        volatile uint32_t PSELP;  ///< Offset: 0x00 - Description cluster[0]: Input positive pin selection for CH[0]
        volatile uint32_t PSELN;  ///< Offset: 0x04 - Description cluster[0]: Input negative pin selection for CH[0]
        volatile uint32_t CONFIG;  ///< Offset: 0x08 - Description cluster[0]: Input configuration for CH[0]
        volatile uint32_t LIMIT;  ///< Offset: 0x0C - Description cluster[0]: High/low limits for event...
    ...
    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t STARTED = (1U << 0);  ///< Enable or disable interrupt for STARTED event
        constexpr uint32_t END = (1U << 1);  ///< Enable or disable interrupt for END event
        constexpr uint32_t DONE = (1U << 2);  ///< Enable or disable interrupt for DONE event
        constexpr uint32_t RESULTDONE = (1U << 3);  ///< Enable or disable interrupt for RESULTDONE event
        constexpr uint32_t CALIBRATEDONE = (1U << 4);  ///< Enable or disable interrupt for CALIBRATEDONE event
        constexpr uint32_t STOPPED = (1U << 5);  ///< Enable or disable interrupt for STOPPED event
        constexpr uint32_t CH0LIMITH = (1U << 6);  ///< Enable or disable interrupt for CH[0].LIMITH event
        constexpr uint32_t CH0LIMITL = (1U << 7);  ///< Enable or disable interrupt for CH[0].LIMITL event
        constexpr uint32_t CH1LIMITH = (1U << 8);  ///< Enable or disable interrupt for CH[1].LIMITH event
        constexpr uint32_t CH1LIMITL = (1U << 9);  ///< Enable or disable interrupt for CH[1].LIMITL event
        constexpr uint32_t CH2LIMITH = (1U << 10);  ///< Enable or disable interrupt for CH[2].LIMITH event
        constexpr uint32_t CH2LIMITL = (1U << 11);  ///< Enable or disable interrupt for CH[2].LIMITL event
        constexpr uint32_t CH3LIMITH = (1U << 12);  ///< Enable or disable interrupt for CH[3].LIMITH event
        constexpr uint32_t CH3LIMITL = (1U << 13);  ///< Enable or disable interrupt for CH[3].LIMITL event
        constexpr uint32_t CH4LIMITH = (1U << 14);  ///< Enable or disable interrupt for CH[4].LIMITH event
        constexpr uint32_t CH4LIMITL = (1U << 15);  ///< Enable or disable interrupt for CH[4].LIMITL event
        constexpr uint32_t CH5LIMITH = (1U << 16);  ///< Enable or disable interrupt for CH[5].LIMITH event
        constexpr uint32_t CH5LIMITL = (1U << 17);  ///< Enable or disable interrupt for CH[5].LIMITL event
        constexpr uint32_t CH6LIMITH = (1U << 18);  ///< Enable or disable interrupt for CH[6].LIMITH event
        constexpr uint32_t CH6LIMITL = (1U << 19);  ///< Enable or disable interrupt for CH[6].LIMITL event
        constexpr uint32_t CH7LIMITH = (1U << 20);  ///< Enable or disable interrupt for CH[7].LIMITH event
        constexpr uint32_t CH7LIMITL = (1U << 21);  ///< Enable or disable interrupt for CH[7].LIMITL event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t STARTED = (1U << 0);  ///< Write '1' to Enable interrupt for STARTED event
        constexpr uint32_t END = (1U << 1);  ///< Write '1' to Enable interrupt for END event
        constexpr uint32_t DONE = (1U << 2);  ///< Write '1' to Enable interrupt for DONE event
        constexpr uint32_t RESULTDONE = (1U << 3);  ///< Write '1' to Enable interrupt for RESULTDONE event
        constexpr uint32_t CALIBRATEDONE = (1U << 4);  ///< Write '1' to Enable interrupt for CALIBRATEDONE event
        constexpr uint32_t STOPPED = (1U << 5);  ///< Write '1' to Enable interrupt for STOPPED event
        constexpr uint32_t CH0LIMITH = (1U << 6);  ///< Write '1' to Enable interrupt for CH[0].LIMITH event
        constexpr uint32_t CH0LIMITL = (1U << 7);  ///< Write '1' to Enable interrupt for CH[0].LIMITL event
        constexpr uint32_t CH1LIMITH = (1U << 8);  ///< Write '1' to Enable interrupt for CH[1].LIMITH event
        constexpr uint32_t CH1LIMITL = (1U << 9);  ///< Write '1' to Enable interrupt for CH[1].LIMITL event
        constexpr uint32_t CH2LIMITH = (1U << 10);  ///< Write '1' to Enable interrupt for CH[2].LIMITH event
        constexpr uint32_t CH2LIMITL = (1U << 11);  ///< Write '1' to Enable interrupt for CH[2].LIMITL event
        constexpr uint32_t CH3LIMITH = (1U << 12);  ///< Write '1' to Enable interrupt for CH[3].LIMITH event
        constexpr uint32_t CH3LIMITL = (1U << 13);  ///< Write '1' to Enable interrupt for CH[3].LIMITL event
        constexpr uint32_t CH4LIMITH = (1U << 14);  ///< Write '1' to Enable interrupt for CH[4].LIMITH event
        constexpr uint32_t CH4LIMITL = (1U << 15);  ///< Write '1' to Enable interrupt for CH[4].LIMITL event
        constexpr uint32_t CH5LIMITH = (1U << 16);  ///< Write '1' to Enable interrupt for CH[5].LIMITH event
        constexpr uint32_t CH5LIMITL = (1U << 17);  ///< Write '1' to Enable interrupt for CH[5].LIMITL event
        constexpr uint32_t CH6LIMITH = (1U << 18);  ///< Write '1' to Enable interrupt for CH[6].LIMITH event
        constexpr uint32_t CH6LIMITL = (1U << 19);  ///< Write '1' to Enable interrupt for CH[6].LIMITL event
        constexpr uint32_t CH7LIMITH = (1U << 20);  ///< Write '1' to Enable interrupt for CH[7].LIMITH event
        constexpr uint32_t CH7LIMITL = (1U << 21);  ///< Write '1' to Enable interrupt for CH[7].LIMITL event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t STARTED = (1U << 0);  ///< Write '1' to Disable interrupt for STARTED event
        constexpr uint32_t END = (1U << 1);  ///< Write '1' to Disable interrupt for END event
        constexpr uint32_t DONE = (1U << 2);  ///< Write '1' to Disable interrupt for DONE event
        constexpr uint32_t RESULTDONE = (1U << 3);  ///< Write '1' to Disable interrupt for RESULTDONE event
        constexpr uint32_t CALIBRATEDONE = (1U << 4);  ///< Write '1' to Disable interrupt for CALIBRATEDONE event
        constexpr uint32_t STOPPED = (1U << 5);  ///< Write '1' to Disable interrupt for STOPPED event
        constexpr uint32_t CH0LIMITH = (1U << 6);  ///< Write '1' to Disable interrupt for CH[0].LIMITH event
        constexpr uint32_t CH0LIMITL = (1U << 7);  ///< Write '1' to Disable interrupt for CH[0].LIMITL event
        constexpr uint32_t CH1LIMITH = (1U << 8);  ///< Write '1' to Disable interrupt for CH[1].LIMITH event
        constexpr uint32_t CH1LIMITL = (1U << 9);  ///< Write '1' to Disable interrupt for CH[1].LIMITL event
        constexpr uint32_t CH2LIMITH = (1U << 10);  ///< Write '1' to Disable interrupt for CH[2].LIMITH event
        constexpr uint32_t CH2LIMITL = (1U << 11);  ///< Write '1' to Disable interrupt for CH[2].LIMITL event
        constexpr uint32_t CH3LIMITH = (1U << 12);  ///< Write '1' to Disable interrupt for CH[3].LIMITH event
        constexpr uint32_t CH3LIMITL = (1U << 13);  ///< Write '1' to Disable interrupt for CH[3].LIMITL event
        constexpr uint32_t CH4LIMITH = (1U << 14);  ///< Write '1' to Disable interrupt for CH[4].LIMITH event
        constexpr uint32_t CH4LIMITL = (1U << 15);  ///< Write '1' to Disable interrupt for CH[4].LIMITL event
        constexpr uint32_t CH5LIMITH = (1U << 16);  ///< Write '1' to Disable interrupt for CH[5].LIMITH event
        constexpr uint32_t CH5LIMITL = (1U << 17);  ///< Write '1' to Disable interrupt for CH[5].LIMITL event
        constexpr uint32_t CH6LIMITH = (1U << 18);  ///< Write '1' to Disable interrupt for CH[6].LIMITH event
        constexpr uint32_t CH6LIMITL = (1U << 19);  ///< Write '1' to Disable interrupt for CH[6].LIMITL event
        constexpr uint32_t CH7LIMITH = (1U << 20);  ///< Write '1' to Disable interrupt for CH[7].LIMITH event
        constexpr uint32_t CH7LIMITL = (1U << 21);  ///< Write '1' to Disable interrupt for CH[7].LIMITL event
    }
...
namespace tim {
    ...
    struct Registers {
        ...
        volatile uint32_t TASKS_CAPTURE__;  ///< Offset: 0x40 - Description collection[0]: Capture Timer value to CC[0] register (renamed from TASKS_CAPTURE__)
        volatile uint32_t EVENTS_COMPARE__;  ///< Offset: 0x140 - Description collection[0]: Compare event on CC[0] match (renamed from EVENTS_COMPARE__)
        volatile uint32_t SHORTS;  ///< Offset: 0x200 - Shortcut register
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
        ...
        volatile uint32_t CC__;  ///< Offset: 0x540 - Description collection[0]: Capture/Compare register 0 (renamed from CC__)
    };
    ...
    /// SHORTS Register bits
    namespace shorts_bits {
        constexpr uint32_t COMPARE0_CLEAR = (1U << 0);  ///< Shortcut between COMPARE[0] event and CLEAR task
        constexpr uint32_t COMPARE1_CLEAR = (1U << 1);  ///< Shortcut between COMPARE[1] event and CLEAR task
        constexpr uint32_t COMPARE2_CLEAR = (1U << 2);  ///< Shortcut between COMPARE[2] event and CLEAR task
        constexpr uint32_t COMPARE3_CLEAR = (1U << 3);  ///< Shortcut between COMPARE[3] event and CLEAR task
        constexpr uint32_t COMPARE4_CLEAR = (1U << 4);  ///< Shortcut between COMPARE[4] event and CLEAR task
        constexpr uint32_t COMPARE5_CLEAR = (1U << 5);  ///< Shortcut between COMPARE[5] event and CLEAR task
        constexpr uint32_t COMPARE0_STOP = (1U << 8);  ///< Shortcut between COMPARE[0] event and STOP task
        constexpr uint32_t COMPARE1_STOP = (1U << 9);  ///< Shortcut between COMPARE[1] event and STOP task
        constexpr uint32_t COMPARE2_STOP = (1U << 10);  ///< Shortcut between COMPARE[2] event and STOP task
        constexpr uint32_t COMPARE3_STOP = (1U << 11);  ///< Shortcut between COMPARE[3] event and STOP task
        constexpr uint32_t COMPARE4_STOP = (1U << 12);  ///< Shortcut between COMPARE[4] event and STOP task
        constexpr uint32_t COMPARE5_STOP = (1U << 13);  ///< Shortcut between COMPARE[5] event and STOP task
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Write '1' to Enable interrupt for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Write '1' to Enable interrupt for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Write '1' to Enable interrupt for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Write '1' to Enable interrupt for COMPARE[3] event
        constexpr uint32_t COMPARE4 = (1U << 20);  ///< Write '1' to Enable interrupt for COMPARE[4] event
        constexpr uint32_t COMPARE5 = (1U << 21);  ///< Write '1' to Enable interrupt for COMPARE[5] event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Write '1' to Disable interrupt for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Write '1' to Disable interrupt for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Write '1' to Disable interrupt for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Write '1' to Disable interrupt for COMPARE[3] event
        constexpr uint32_t COMPARE4 = (1U << 20);  ///< Write '1' to Disable interrupt for COMPARE[4] event
        constexpr uint32_t COMPARE5 = (1U << 21);  ///< Write '1' to Disable interrupt for COMPARE[5] event
    }
...
namespace rtc {
    ...
    struct Registers {
        ...
        volatile uint32_t CC__;  ///< Offset: 0x540 - Description collection[0]: Compare register 0 (renamed from CC__)
    };
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t TICK = (1U << 0);  ///< Write '1' to Enable interrupt for TICK event
        constexpr uint32_t OVRFLW = (1U << 1);  ///< Write '1' to Enable interrupt for OVRFLW event
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Write '1' to Enable interrupt for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Write '1' to Enable interrupt for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Write '1' to Enable interrupt for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Write '1' to Enable interrupt for COMPARE[3] event
    ...
    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t TICK = (1U << 0);  ///< Write '1' to Disable interrupt for TICK event
        constexpr uint32_t OVRFLW = (1U << 1);  ///< Write '1' to Disable interrupt for OVRFLW event
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Write '1' to Disable interrupt for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Write '1' to Disable interrupt for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Write '1' to Disable interrupt for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Write '1' to Disable interrupt for COMPARE[3] event
    ...
    namespace evten_bits {
        constexpr uint32_t TICK = (1U << 0);  ///< Enable or disable event routing for TICK event
        constexpr uint32_t OVRFLW = (1U << 1);  ///< Enable or disable event routing for OVRFLW event
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Enable or disable event routing for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Enable or disable event routing for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Enable or disable event routing for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Enable or disable event routing for COMPARE[3] event
    }

    /// EVTENSET Register bits
    namespace evtenset_bits {
        constexpr uint32_t TICK = (1U << 0);  ///< Write '1' to Enable event routing for TICK event
        constexpr uint32_t OVRFLW = (1U << 1);  ///< Write '1' to Enable event routing for OVRFLW event
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Write '1' to Enable event routing for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Write '1' to Enable event routing for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Write '1' to Enable event routing for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Write '1' to Enable event routing for COMPARE[3] event
    }

    /// EVTENCLR Register bits
    namespace evtenclr_bits {
        constexpr uint32_t TICK = (1U << 0);  ///< Write '1' to Disable event routing for TICK event
        constexpr uint32_t OVRFLW = (1U << 1);  ///< Write '1' to Disable event routing for OVRFLW event
        constexpr uint32_t COMPARE0 = (1U << 16);  ///< Write '1' to Disable event routing for COMPARE[0] event
        constexpr uint32_t COMPARE1 = (1U << 17);  ///< Write '1' to Disable event routing for COMPARE[1] event
        constexpr uint32_t COMPARE2 = (1U << 18);  ///< Write '1' to Disable event routing for COMPARE[2] event
        constexpr uint32_t COMPARE3 = (1U << 19);  ///< Write '1' to Disable event routing for COMPARE[3] event
    }
...
namespace temp {
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t DATARDY = (1U << 0);  ///< Write '1' to Enable interrupt for DATARDY event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t DATARDY = (1U << 0);  ///< Write '1' to Disable interrupt for DATARDY event
    }
...
namespace rng {
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t VALRDY = (1U << 0);  ///< Write '1' to Enable interrupt for VALRDY event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t VALRDY = (1U << 0);  ///< Write '1' to Disable interrupt for VALRDY event
    }
...
namespace ecb {
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t ENDECB = (1U << 0);  ///< Write '1' to Enable interrupt for ENDECB event
        constexpr uint32_t ERRORECB = (1U << 1);  ///< Write '1' to Enable interrupt for ERRORECB event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t ENDECB = (1U << 0);  ///< Write '1' to Disable interrupt for ENDECB event
        constexpr uint32_t ERRORECB = (1U << 1);  ///< Write '1' to Disable interrupt for ERRORECB event
    }
...
namespace ccm {
    ...
    struct Registers {
        ...
        volatile uint32_t EVENTS_ERROR;  ///< Offset: 0x108 - CCM error event
        volatile uint32_t SHORTS;  ///< Offset: 0x200 - Shortcut register
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t ENDKSGEN = (1U << 0);  ///< Write '1' to Enable interrupt for ENDKSGEN event
        constexpr uint32_t ENDCRYPT = (1U << 1);  ///< Write '1' to Enable interrupt for ENDCRYPT event
        constexpr uint32_t ERROR = (1U << 2);  ///< Write '1' to Enable interrupt for ERROR event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t ENDKSGEN = (1U << 0);  ///< Write '1' to Disable interrupt for ENDKSGEN event
        constexpr uint32_t ENDCRYPT = (1U << 1);  ///< Write '1' to Disable interrupt for ENDCRYPT event
        constexpr uint32_t ERROR = (1U << 2);  ///< Write '1' to Disable interrupt for ERROR event
    }
    ...
    /// MODE Register bits
    namespace mode_bits {
        constexpr uint32_t MODE = (1U << 0);  ///< The mode of operation to be used
        constexpr uint32_t DATARATE = (1U << 16);  ///< Data rate that the CCM shall run in synch with
...
namespace aar {
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t END = (1U << 0);  ///< Write '1' to Enable interrupt for END event
        constexpr uint32_t RESOLVED = (1U << 1);  ///< Write '1' to Enable interrupt for RESOLVED event
        constexpr uint32_t NOTRESOLVED = (1U << 2);  ///< Write '1' to Enable interrupt for NOTRESOLVED event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t END = (1U << 0);  ///< Write '1' to Disable interrupt for END event
        constexpr uint32_t RESOLVED = (1U << 1);  ///< Write '1' to Disable interrupt for RESOLVED event
        constexpr uint32_t NOTRESOLVED = (1U << 2);  ///< Write '1' to Disable interrupt for NOTRESOLVED event
    }
...
namespace wdg {
    ...
    struct Registers {
        ...
        volatile uint32_t RR__;  ///< Offset: 0x600 - Description collection[0]: Reload request 0 (renamed from RR__)
    };
    ...
    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t TIMEOUT = (1U << 0);  ///< Write '1' to Enable interrupt for TIMEOUT event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t TIMEOUT = (1U << 0);  ///< Write '1' to Disable interrupt for TIMEOUT event
    }
...
namespace qdec {
    ...
    namespace shorts_bits {
        ...
        constexpr uint32_t REPORTRDY_RDCLRACC = (1U << 2);  ///< Shortcut between REPORTRDY event and RDCLRACC task
        constexpr uint32_t REPORTRDY_STOP = (1U << 3);  ///< Shortcut between REPORTRDY event and STOP task
        constexpr uint32_t DBLRDY_RDCLRDBL = (1U << 4);  ///< Shortcut between DBLRDY event and RDCLRDBL task
        constexpr uint32_t DBLRDY_STOP = (1U << 5);  ///< Shortcut between DBLRDY event and STOP task
        constexpr uint32_t SAMPLERDY_READCLRACC = (1U << 6);  ///< Shortcut between SAMPLERDY event and READCLRACC task
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t SAMPLERDY = (1U << 0);  ///< Write '1' to Enable interrupt for SAMPLERDY event
        constexpr uint32_t REPORTRDY = (1U << 1);  ///< Write '1' to Enable interrupt for REPORTRDY event
        constexpr uint32_t ACCOF = (1U << 2);  ///< Write '1' to Enable interrupt for ACCOF event
        constexpr uint32_t DBLRDY = (1U << 3);  ///< Write '1' to Enable interrupt for DBLRDY event
        constexpr uint32_t STOPPED = (1U << 4);  ///< Write '1' to Enable interrupt for STOPPED event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t SAMPLERDY = (1U << 0);  ///< Write '1' to Disable interrupt for SAMPLERDY event
        constexpr uint32_t REPORTRDY = (1U << 1);  ///< Write '1' to Disable interrupt for REPORTRDY event
        constexpr uint32_t ACCOF = (1U << 2);  ///< Write '1' to Disable interrupt for ACCOF event
        constexpr uint32_t DBLRDY = (1U << 3);  ///< Write '1' to Disable interrupt for DBLRDY event
        constexpr uint32_t STOPPED = (1U << 4);  ///< Write '1' to Disable interrupt for STOPPED event
    }
...
namespace comp {
    ...
    struct Registers {
        ...
        volatile uint32_t ISOURCE;  ///< Offset: 0x53C - Current source select on analog input
    };
    ...
    namespace shorts_bits {
        ...
        constexpr uint32_t READY_STOP = (1U << 1);  ///< Shortcut between READY event and STOP task
    ...
    namespace inten_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Enable or disable interrupt for READY event
        constexpr uint32_t DOWN = (1U << 1);  ///< Enable or disable interrupt for DOWN event
        constexpr uint32_t UP = (1U << 2);  ///< Enable or disable interrupt for UP event
        constexpr uint32_t CROSS = (1U << 3);  ///< Enable or disable interrupt for CROSS event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Write '1' to Enable interrupt for READY event
        constexpr uint32_t DOWN = (1U << 1);  ///< Write '1' to Enable interrupt for DOWN event
        constexpr uint32_t UP = (1U << 2);  ///< Write '1' to Enable interrupt for UP event
        constexpr uint32_t CROSS = (1U << 3);  ///< Write '1' to Enable interrupt for CROSS event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t READY = (1U << 0);  ///< Write '1' to Disable interrupt for READY event
        constexpr uint32_t DOWN = (1U << 1);  ///< Write '1' to Disable interrupt for DOWN event
        constexpr uint32_t UP = (1U << 2);  ///< Write '1' to Disable interrupt for UP event
        constexpr uint32_t CROSS = (1U << 3);  ///< Write '1' to Disable interrupt for CROSS event
    }
    ...
    /// ISOURCE Register bits
    namespace isource_bits {
        constexpr uint32_t ISOURCE = (2 << 0);  ///< Comparator hysteresis
    }
...
namespace egu0 {
    ...
    struct Registers {
        volatile uint32_t TASKS_TRIGGER__;  ///< Offset: 0x00 - Description collection[0]: Trigger 0 for triggering the... (renamed from TASKS_TRIGGER__)
        volatile uint32_t EVENTS_TRIGGERED__;  ///< Offset: 0x100 - Description collection[0]: Event number 0 generated by... (renamed from EVENTS_TRIGGERED__)
        volatile uint32_t INTEN;  ///< Offset: 0x300 - Enable or disable interrupt
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
    };
    ...
    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t TRIGGERED0 = (1U << 0);  ///< Enable or disable interrupt for TRIGGERED[0] event
        constexpr uint32_t TRIGGERED1 = (1U << 1);  ///< Enable or disable interrupt for TRIGGERED[1] event
        constexpr uint32_t TRIGGERED2 = (1U << 2);  ///< Enable or disable interrupt for TRIGGERED[2] event
        constexpr uint32_t TRIGGERED3 = (1U << 3);  ///< Enable or disable interrupt for TRIGGERED[3] event
        constexpr uint32_t TRIGGERED4 = (1U << 4);  ///< Enable or disable interrupt for TRIGGERED[4] event
        constexpr uint32_t TRIGGERED5 = (1U << 5);  ///< Enable or disable interrupt for TRIGGERED[5] event
        constexpr uint32_t TRIGGERED6 = (1U << 6);  ///< Enable or disable interrupt for TRIGGERED[6] event
        constexpr uint32_t TRIGGERED7 = (1U << 7);  ///< Enable or disable interrupt for TRIGGERED[7] event
        constexpr uint32_t TRIGGERED8 = (1U << 8);  ///< Enable or disable interrupt for TRIGGERED[8] event
        constexpr uint32_t TRIGGERED9 = (1U << 9);  ///< Enable or disable interrupt for TRIGGERED[9] event
        constexpr uint32_t TRIGGERED10 = (1U << 10);  ///< Enable or disable interrupt for TRIGGERED[10] event
        constexpr uint32_t TRIGGERED11 = (1U << 11);  ///< Enable or disable interrupt for TRIGGERED[11] event
        constexpr uint32_t TRIGGERED12 = (1U << 12);  ///< Enable or disable interrupt for TRIGGERED[12] event
        constexpr uint32_t TRIGGERED13 = (1U << 13);  ///< Enable or disable interrupt for TRIGGERED[13] event
        constexpr uint32_t TRIGGERED14 = (1U << 14);  ///< Enable or disable interrupt for TRIGGERED[14] event
        constexpr uint32_t TRIGGERED15 = (1U << 15);  ///< Enable or disable interrupt for TRIGGERED[15] event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t TRIGGERED0 = (1U << 0);  ///< Write '1' to Enable interrupt for TRIGGERED[0] event
        constexpr uint32_t TRIGGERED1 = (1U << 1);  ///< Write '1' to Enable interrupt for TRIGGERED[1] event
        constexpr uint32_t TRIGGERED2 = (1U << 2);  ///< Write '1' to Enable interrupt for TRIGGERED[2] event
        constexpr uint32_t TRIGGERED3 = (1U << 3);  ///< Write '1' to Enable interrupt for TRIGGERED[3] event
        constexpr uint32_t TRIGGERED4 = (1U << 4);  ///< Write '1' to Enable interrupt for TRIGGERED[4] event
        constexpr uint32_t TRIGGERED5 = (1U << 5);  ///< Write '1' to Enable interrupt for TRIGGERED[5] event
        constexpr uint32_t TRIGGERED6 = (1U << 6);  ///< Write '1' to Enable interrupt for TRIGGERED[6] event
        constexpr uint32_t TRIGGERED7 = (1U << 7);  ///< Write '1' to Enable interrupt for TRIGGERED[7] event
        constexpr uint32_t TRIGGERED8 = (1U << 8);  ///< Write '1' to Enable interrupt for TRIGGERED[8] event
        constexpr uint32_t TRIGGERED9 = (1U << 9);  ///< Write '1' to Enable interrupt for TRIGGERED[9] event
        constexpr uint32_t TRIGGERED10 = (1U << 10);  ///< Write '1' to Enable interrupt for TRIGGERED[10] event
        constexpr uint32_t TRIGGERED11 = (1U << 11);  ///< Write '1' to Enable interrupt for TRIGGERED[11] event
        constexpr uint32_t TRIGGERED12 = (1U << 12);  ///< Write '1' to Enable interrupt for TRIGGERED[12] event
        constexpr uint32_t TRIGGERED13 = (1U << 13);  ///< Write '1' to Enable interrupt for TRIGGERED[13] event
        constexpr uint32_t TRIGGERED14 = (1U << 14);  ///< Write '1' to Enable interrupt for TRIGGERED[14] event
        constexpr uint32_t TRIGGERED15 = (1U << 15);  ///< Write '1' to Enable interrupt for TRIGGERED[15] event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t TRIGGERED0 = (1U << 0);  ///< Write '1' to Disable interrupt for TRIGGERED[0] event
        constexpr uint32_t TRIGGERED1 = (1U << 1);  ///< Write '1' to Disable interrupt for TRIGGERED[1] event
        constexpr uint32_t TRIGGERED2 = (1U << 2);  ///< Write '1' to Disable interrupt for TRIGGERED[2] event
        constexpr uint32_t TRIGGERED3 = (1U << 3);  ///< Write '1' to Disable interrupt for TRIGGERED[3] event
        constexpr uint32_t TRIGGERED4 = (1U << 4);  ///< Write '1' to Disable interrupt for TRIGGERED[4] event
        constexpr uint32_t TRIGGERED5 = (1U << 5);  ///< Write '1' to Disable interrupt for TRIGGERED[5] event
        constexpr uint32_t TRIGGERED6 = (1U << 6);  ///< Write '1' to Disable interrupt for TRIGGERED[6] event
        constexpr uint32_t TRIGGERED7 = (1U << 7);  ///< Write '1' to Disable interrupt for TRIGGERED[7] event
        constexpr uint32_t TRIGGERED8 = (1U << 8);  ///< Write '1' to Disable interrupt for TRIGGERED[8] event
        constexpr uint32_t TRIGGERED9 = (1U << 9);  ///< Write '1' to Disable interrupt for TRIGGERED[9] event
        constexpr uint32_t TRIGGERED10 = (1U << 10);  ///< Write '1' to Disable interrupt for TRIGGERED[10] event
        constexpr uint32_t TRIGGERED11 = (1U << 11);  ///< Write '1' to Disable interrupt for TRIGGERED[11] event
        constexpr uint32_t TRIGGERED12 = (1U << 12);  ///< Write '1' to Disable interrupt for TRIGGERED[12] event
        constexpr uint32_t TRIGGERED13 = (1U << 13);  ///< Write '1' to Disable interrupt for TRIGGERED[13] event
        constexpr uint32_t TRIGGERED14 = (1U << 14);  ///< Write '1' to Disable interrupt for TRIGGERED[14] event
        constexpr uint32_t TRIGGERED15 = (1U << 15);  ///< Write '1' to Disable interrupt for TRIGGERED[15] event
    }
...
namespace pwm {
    ...
    struct Registers {
        ...
        volatile uint32_t TASKS_SEQSTART__;  ///< Offset: 0x08 - Description collection[0]: Loads the first PWM value on... (renamed from TASKS_SEQSTART__)
        ...
        volatile uint32_t EVENTS_SEQSTARTED__;  ///< Offset: 0x108 - Description collection[0]: First PWM period started on sequence 0 (renamed from EVENTS_SEQSTARTED__)
        volatile uint32_t EVENTS_SEQEND__;  ///< Offset: 0x110 - Description collection[0]: Emitted at end of every... (renamed from EVENTS_SEQEND__)
        ...
        volatile uint32_t LOOP;  ///< Offset: 0x514 - Amount of playback of a loop
        volatile uint32_t PTR;  ///< Offset: 0x00 - Description cluster[0]: Beginning address in Data RAM of...
        volatile uint32_t CNT;  ///< Offset: 0x04 - Description cluster[0]: Amount of values (duty cycles)...
        volatile uint32_t REFRESH;  ///< Offset: 0x08 - Description cluster[0]: Amount of additional PWM periods...
        volatile uint32_t ENDDELAY;  ///< Offset: 0x0C - Description cluster[0]: Time added after the sequence
        volatile uint32_t OUT__;  ///< Offset: 0x00 - Description collection[0]: Output pin select for PWM channel 0 (renamed from OUT__)
    };
    ...
    /// SHORTS Register bits
    namespace shorts_bits {
        constexpr uint32_t SEQEND0_STOP = (1U << 0);  ///< Shortcut between SEQEND[0] event and STOP task
        constexpr uint32_t SEQEND1_STOP = (1U << 1);  ///< Shortcut between SEQEND[1] event and STOP task
        constexpr uint32_t LOOPSDONE_SEQSTART0 = (1U << 2);  ///< Shortcut between LOOPSDONE event and SEQSTART[0] task
        constexpr uint32_t LOOPSDONE_SEQSTART1 = (1U << 3);  ///< Shortcut between LOOPSDONE event and SEQSTART[1] task
        constexpr uint32_t LOOPSDONE_STOP = (1U << 4);  ///< Shortcut between LOOPSDONE event and STOP task
    }

    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Enable or disable interrupt for STOPPED event
        constexpr uint32_t SEQSTARTED0 = (1U << 2);  ///< Enable or disable interrupt for SEQSTARTED[0] event
        constexpr uint32_t SEQSTARTED1 = (1U << 3);  ///< Enable or disable interrupt for SEQSTARTED[1] event
        constexpr uint32_t SEQEND0 = (1U << 4);  ///< Enable or disable interrupt for SEQEND[0] event
        constexpr uint32_t SEQEND1 = (1U << 5);  ///< Enable or disable interrupt for SEQEND[1] event
        constexpr uint32_t PWMPERIODEND = (1U << 6);  ///< Enable or disable interrupt for PWMPERIODEND event
        constexpr uint32_t LOOPSDONE = (1U << 7);  ///< Enable or disable interrupt for LOOPSDONE event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Enable interrupt for STOPPED event
        constexpr uint32_t SEQSTARTED0 = (1U << 2);  ///< Write '1' to Enable interrupt for SEQSTARTED[0] event
        constexpr uint32_t SEQSTARTED1 = (1U << 3);  ///< Write '1' to Enable interrupt for SEQSTARTED[1] event
        constexpr uint32_t SEQEND0 = (1U << 4);  ///< Write '1' to Enable interrupt for SEQEND[0] event
        constexpr uint32_t SEQEND1 = (1U << 5);  ///< Write '1' to Enable interrupt for SEQEND[1] event
        constexpr uint32_t PWMPERIODEND = (1U << 6);  ///< Write '1' to Enable interrupt for PWMPERIODEND event
        constexpr uint32_t LOOPSDONE = (1U << 7);  ///< Write '1' to Enable interrupt for LOOPSDONE event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Disable interrupt for STOPPED event
        constexpr uint32_t SEQSTARTED0 = (1U << 2);  ///< Write '1' to Disable interrupt for SEQSTARTED[0] event
        constexpr uint32_t SEQSTARTED1 = (1U << 3);  ///< Write '1' to Disable interrupt for SEQSTARTED[1] event
        constexpr uint32_t SEQEND0 = (1U << 4);  ///< Write '1' to Disable interrupt for SEQEND[0] event
        constexpr uint32_t SEQEND1 = (1U << 5);  ///< Write '1' to Disable interrupt for SEQEND[1] event
        constexpr uint32_t PWMPERIODEND = (1U << 6);  ///< Write '1' to Disable interrupt for PWMPERIODEND event
        constexpr uint32_t LOOPSDONE = (1U << 7);  ///< Write '1' to Disable interrupt for LOOPSDONE event
    }
    ...
    /// MODE Register bits
    namespace mode_bits {
        constexpr uint32_t UPDOWN = (1U << 0);  ///< Selects up or up and down as wave counter mode
    }

    /// COUNTERTOP Register bits
    namespace countertop_bits {
        constexpr uint32_t COUNTERTOP = (15 << 0);  ///< Value up to which the pulse generator counter counts. This register is ignored when DECODER.MODE=WaveForm and only values from RAM will be used.
    }

    /// PRESCALER Register bits
    namespace prescaler_bits {
        constexpr uint32_t PRESCALER = (3 << 0);  ///< Pre-scaler of PWM_CLK
    }
    ...
    /// LOOP Register bits
    namespace loop_bits {
        constexpr uint32_t CNT = (16 << 0);  ///< Amount of playback of pattern cycles
    }

    /// PTR Register bits
    namespace ptr_bits {
        constexpr uint32_t PTR = (32 << 0);  ///< Beginning address in Data RAM of this sequence
    }

    /// CNT Register bits
    namespace cnt_bits {
        constexpr uint32_t CNT = (15 << 0);  ///< Amount of values (duty cycles) in this sequence
    }

    /// REFRESH Register bits
    namespace refresh_bits {
        constexpr uint32_t CNT = (24 << 0);  ///< Amount of additional PWM periods between samples loaded into compare register (load every REFRESH.CNT+1 PWM periods)
    }
...
namespace pdm {
    ...
    namespace inten_bits {
        constexpr uint32_t STARTED = (1U << 0);  ///< Enable or disable interrupt for STARTED event
        constexpr uint32_t STOPPED = (1U << 1);  ///< Enable or disable interrupt for STOPPED event
        constexpr uint32_t END = (1U << 2);  ///< Enable or disable interrupt for END event
    }
    ...
    namespace intenset_bits {
        constexpr uint32_t STARTED = (1U << 0);  ///< Write '1' to Enable interrupt for STARTED event
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Enable interrupt for STOPPED event
        constexpr uint32_t END = (1U << 2);  ///< Write '1' to Enable interrupt for END event
    }
    ...
    namespace intenclr_bits {
        constexpr uint32_t STARTED = (1U << 0);  ///< Write '1' to Disable interrupt for STARTED event
        constexpr uint32_t STOPPED = (1U << 1);  ///< Write '1' to Disable interrupt for STOPPED event
        constexpr uint32_t END = (1U << 2);  ///< Write '1' to Disable interrupt for END event
    }
...
namespace nvmc {
    ...
    namespace eraseall_bits {
        constexpr uint32_t ERASEALL = (1U << 0);  ///< Erase all non-volatile memory including UICR registers. Note that code erase has to be enabled by CONFIG.EEN before the UICR can be erased.
    }
    ...
    namespace eraseuicr_bits {
        constexpr uint32_t ERASEUICR = (1U << 0);  ///< Register starting erase of all User Information Configuration Registers. Note that code erase has to be enabled by CONFIG.EEN before the UICR can be erased.
    }
...
namespace ppi {
    ...
    struct Registers {
        volatile uint32_t EN;  ///< Offset: 0x00 - Description cluster[0]: Enable channel group 0
        volatile uint32_t DIS;  ///< Offset: 0x04 - Description cluster[0]: Disable channel group 0
        ...
        volatile uint32_t EEP;  ///< Offset: 0x00 - Description cluster[0]: Channel 0 event end-point
        volatile uint32_t TEP;  ///< Offset: 0x00 - Description cluster[0]: Channel 0 task end-point
        volatile uint32_t CHG__;  ///< Offset: 0x800 - Description collection[0]: Channel group 0 (renamed from CHG__)
    };
...
namespace mwu {
    ...
    struct Registers {
        volatile uint32_t WA;  ///< Offset: 0x00 - Description cluster[0]: Write access to peripheral...
        volatile uint32_t RA;  ///< Offset: 0x04 - Description cluster[0]: Read access to peripheral region...
        volatile uint32_t INTEN;  ///< Offset: 0x300 - Enable or disable interrupt
        volatile uint32_t INTENSET;  ///< Offset: 0x304 - Enable interrupt
        volatile uint32_t INTENCLR;  ///< Offset: 0x308 - Disable interrupt
        volatile uint32_t NMIEN;  ///< Offset: 0x320 - Enable or disable non-maskable interrupt
        volatile uint32_t NMIENSET;  ///< Offset: 0x324 - Enable non-maskable interrupt
        volatile uint32_t NMIENCLR;  ///< Offset: 0x328 - Disable non-maskable interrupt
        volatile uint32_t SUBSTATWA;  ///< Offset: 0x00 - Description cluster[0]: Source of event/interrupt in...
        volatile uint32_t SUBSTATRA;  ///< Offset: 0x04 - Description cluster[0]: Source of event/interrupt in...
        ...
        volatile uint32_t START;  ///< Offset: 0x00 - Description cluster[0]: Reserved for future use
        volatile uint32_t END;  ///< Offset: 0x04 - Description cluster[0]: Reserved for future use
        volatile uint32_t SUBS;  ///< Offset: 0x08 - Description cluster[0]: Subregions of region 0
    };
    ...
    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t REGION0WA = (1U << 0);  ///< Enable or disable interrupt for REGION[0].WA event
        constexpr uint32_t REGION0RA = (1U << 1);  ///< Enable or disable interrupt for REGION[0].RA event
        constexpr uint32_t REGION1WA = (1U << 2);  ///< Enable or disable interrupt for REGION[1].WA event
        constexpr uint32_t REGION1RA = (1U << 3);  ///< Enable or disable interrupt for REGION[1].RA event
        constexpr uint32_t REGION2WA = (1U << 4);  ///< Enable or disable interrupt for REGION[2].WA event
        constexpr uint32_t REGION2RA = (1U << 5);  ///< Enable or disable interrupt for REGION[2].RA event
        constexpr uint32_t REGION3WA = (1U << 6);  ///< Enable or disable interrupt for REGION[3].WA event
        constexpr uint32_t REGION3RA = (1U << 7);  ///< Enable or disable interrupt for REGION[3].RA event
        constexpr uint32_t PREGION0WA = (1U << 24);  ///< Enable or disable interrupt for PREGION[0].WA event
        constexpr uint32_t PREGION0RA = (1U << 25);  ///< Enable or disable interrupt for PREGION[0].RA event
        constexpr uint32_t PREGION1WA = (1U << 26);  ///< Enable or disable interrupt for PREGION[1].WA event
        constexpr uint32_t PREGION1RA = (1U << 27);  ///< Enable or disable interrupt for PREGION[1].RA event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t REGION0WA = (1U << 0);  ///< Write '1' to Enable interrupt for REGION[0].WA event
        constexpr uint32_t REGION0RA = (1U << 1);  ///< Write '1' to Enable interrupt for REGION[0].RA event
        constexpr uint32_t REGION1WA = (1U << 2);  ///< Write '1' to Enable interrupt for REGION[1].WA event
        constexpr uint32_t REGION1RA = (1U << 3);  ///< Write '1' to Enable interrupt for REGION[1].RA event
        constexpr uint32_t REGION2WA = (1U << 4);  ///< Write '1' to Enable interrupt for REGION[2].WA event
        constexpr uint32_t REGION2RA = (1U << 5);  ///< Write '1' to Enable interrupt for REGION[2].RA event
        constexpr uint32_t REGION3WA = (1U << 6);  ///< Write '1' to Enable interrupt for REGION[3].WA event
        constexpr uint32_t REGION3RA = (1U << 7);  ///< Write '1' to Enable interrupt for REGION[3].RA event
        constexpr uint32_t PREGION0WA = (1U << 24);  ///< Write '1' to Enable interrupt for PREGION[0].WA event
        constexpr uint32_t PREGION0RA = (1U << 25);  ///< Write '1' to Enable interrupt for PREGION[0].RA event
        constexpr uint32_t PREGION1WA = (1U << 26);  ///< Write '1' to Enable interrupt for PREGION[1].WA event
        constexpr uint32_t PREGION1RA = (1U << 27);  ///< Write '1' to Enable interrupt for PREGION[1].RA event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t REGION0WA = (1U << 0);  ///< Write '1' to Disable interrupt for REGION[0].WA event
        constexpr uint32_t REGION0RA = (1U << 1);  ///< Write '1' to Disable interrupt for REGION[0].RA event
        constexpr uint32_t REGION1WA = (1U << 2);  ///< Write '1' to Disable interrupt for REGION[1].WA event
        constexpr uint32_t REGION1RA = (1U << 3);  ///< Write '1' to Disable interrupt for REGION[1].RA event
        constexpr uint32_t REGION2WA = (1U << 4);  ///< Write '1' to Disable interrupt for REGION[2].WA event
        constexpr uint32_t REGION2RA = (1U << 5);  ///< Write '1' to Disable interrupt for REGION[2].RA event
        constexpr uint32_t REGION3WA = (1U << 6);  ///< Write '1' to Disable interrupt for REGION[3].WA event
        constexpr uint32_t REGION3RA = (1U << 7);  ///< Write '1' to Disable interrupt for REGION[3].RA event
        constexpr uint32_t PREGION0WA = (1U << 24);  ///< Write '1' to Disable interrupt for PREGION[0].WA event
        constexpr uint32_t PREGION0RA = (1U << 25);  ///< Write '1' to Disable interrupt for PREGION[0].RA event
        constexpr uint32_t PREGION1WA = (1U << 26);  ///< Write '1' to Disable interrupt for PREGION[1].WA event
        constexpr uint32_t PREGION1RA = (1U << 27);  ///< Write '1' to Disable interrupt for PREGION[1].RA event
    }

    /// NMIEN Register bits
    namespace nmien_bits {
        constexpr uint32_t REGION0WA = (1U << 0);  ///< Enable or disable non-maskable interrupt for REGION[0].WA event
        constexpr uint32_t REGION0RA = (1U << 1);  ///< Enable or disable non-maskable interrupt for REGION[0].RA event
        constexpr uint32_t REGION1WA = (1U << 2);  ///< Enable or disable non-maskable interrupt for REGION[1].WA event
        constexpr uint32_t REGION1RA = (1U << 3);  ///< Enable or disable non-maskable interrupt for REGION[1].RA event
        constexpr uint32_t REGION2WA = (1U << 4);  ///< Enable or disable non-maskable interrupt for REGION[2].WA event
        constexpr uint32_t REGION2RA = (1U << 5);  ///< Enable or disable non-maskable interrupt for REGION[2].RA event
        constexpr uint32_t REGION3WA = (1U << 6);  ///< Enable or disable non-maskable interrupt for REGION[3].WA event
        constexpr uint32_t REGION3RA = (1U << 7);  ///< Enable or disable non-maskable interrupt for REGION[3].RA event
        constexpr uint32_t PREGION0WA = (1U << 24);  ///< Enable or disable non-maskable interrupt for PREGION[0].WA event
        constexpr uint32_t PREGION0RA = (1U << 25);  ///< Enable or disable non-maskable interrupt for PREGION[0].RA event
        constexpr uint32_t PREGION1WA = (1U << 26);  ///< Enable or disable non-maskable interrupt for PREGION[1].WA event
        constexpr uint32_t PREGION1RA = (1U << 27);  ///< Enable or disable non-maskable interrupt for PREGION[1].RA event
    }

    /// NMIENSET Register bits
    namespace nmienset_bits {
        constexpr uint32_t REGION0WA = (1U << 0);  ///< Write '1' to Enable non-maskable interrupt for REGION[0].WA event
        constexpr uint32_t REGION0RA = (1U << 1);  ///< Write '1' to Enable non-maskable interrupt for REGION[0].RA event
        constexpr uint32_t REGION1WA = (1U << 2);  ///< Write '1' to Enable non-maskable interrupt for REGION[1].WA event
        constexpr uint32_t REGION1RA = (1U << 3);  ///< Write '1' to Enable non-maskable interrupt for REGION[1].RA event
        constexpr uint32_t REGION2WA = (1U << 4);  ///< Write '1' to Enable non-maskable interrupt for REGION[2].WA event
        constexpr uint32_t REGION2RA = (1U << 5);  ///< Write '1' to Enable non-maskable interrupt for REGION[2].RA event
        constexpr uint32_t REGION3WA = (1U << 6);  ///< Write '1' to Enable non-maskable interrupt for REGION[3].WA event
        constexpr uint32_t REGION3RA = (1U << 7);  ///< Write '1' to Enable non-maskable interrupt for REGION[3].RA event
        constexpr uint32_t PREGION0WA = (1U << 24);  ///< Write '1' to Enable non-maskable interrupt for PREGION[0].WA event
        constexpr uint32_t PREGION0RA = (1U << 25);  ///< Write '1' to Enable non-maskable interrupt for PREGION[0].RA event
        constexpr uint32_t PREGION1WA = (1U << 26);  ///< Write '1' to Enable non-maskable interrupt for PREGION[1].WA event
        constexpr uint32_t PREGION1RA = (1U << 27);  ///< Write '1' to Enable non-maskable interrupt for PREGION[1].RA event
    }

    /// NMIENCLR Register bits
    namespace nmienclr_bits {
        constexpr uint32_t REGION0WA = (1U << 0);  ///< Write '1' to Disable non-maskable interrupt for REGION[0].WA event
        constexpr uint32_t REGION0RA = (1U << 1);  ///< Write '1' to Disable non-maskable interrupt for REGION[0].RA event
        constexpr uint32_t REGION1WA = (1U << 2);  ///< Write '1' to Disable non-maskable interrupt for REGION[1].WA event
        constexpr uint32_t REGION1RA = (1U << 3);  ///< Write '1' to Disable non-maskable interrupt for REGION[1].RA event
        constexpr uint32_t REGION2WA = (1U << 4);  ///< Write '1' to Disable non-maskable interrupt for REGION[2].WA event
        constexpr uint32_t REGION2RA = (1U << 5);  ///< Write '1' to Disable non-maskable interrupt for REGION[2].RA event
        constexpr uint32_t REGION3WA = (1U << 6);  ///< Write '1' to Disable non-maskable interrupt for REGION[3].WA event
        constexpr uint32_t REGION3RA = (1U << 7);  ///< Write '1' to Disable non-maskable interrupt for REGION[3].RA event
        constexpr uint32_t PREGION0WA = (1U << 24);  ///< Write '1' to Disable non-maskable interrupt for PREGION[0].WA event
        constexpr uint32_t PREGION0RA = (1U << 25);  ///< Write '1' to Disable non-maskable interrupt for PREGION[0].RA event
        constexpr uint32_t PREGION1WA = (1U << 26);  ///< Write '1' to Disable non-maskable interrupt for PREGION[1].WA event
        constexpr uint32_t PREGION1RA = (1U << 27);  ///< Write '1' to Disable non-maskable interrupt for PREGION[1].RA event
    }

    /// SUBSTATWA Register bits
    namespace substatwa_bits {
        constexpr uint32_t SR0 = (1U << 0);  ///< Subregion 0 in region 0 (write '1' to clear)
        constexpr uint32_t SR1 = (1U << 1);  ///< Subregion 1 in region 0 (write '1' to clear)
        constexpr uint32_t SR2 = (1U << 2);  ///< Subregion 2 in region 0 (write '1' to clear)
        constexpr uint32_t SR3 = (1U << 3);  ///< Subregion 3 in region 0 (write '1' to clear)
        constexpr uint32_t SR4 = (1U << 4);  ///< Subregion 4 in region 0 (write '1' to clear)
        constexpr uint32_t SR5 = (1U << 5);  ///< Subregion 5 in region 0 (write '1' to clear)
        constexpr uint32_t SR6 = (1U << 6);  ///< Subregion 6 in region 0 (write '1' to clear)
        constexpr uint32_t SR7 = (1U << 7);  ///< Subregion 7 in region 0 (write '1' to clear)
        constexpr uint32_t SR8 = (1U << 8);  ///< Subregion 8 in region 0 (write '1' to clear)
        constexpr uint32_t SR9 = (1U << 9);  ///< Subregion 9 in region 0 (write '1' to clear)
        constexpr uint32_t SR10 = (1U << 10);  ///< Subregion 10 in region 0 (write '1' to clear)
        constexpr uint32_t SR11 = (1U << 11);  ///< Subregion 11 in region 0 (write '1' to clear)
        constexpr uint32_t SR12 = (1U << 12);  ///< Subregion 12 in region 0 (write '1' to clear)
        constexpr uint32_t SR13 = (1U << 13);  ///< Subregion 13 in region 0 (write '1' to clear)
        constexpr uint32_t SR14 = (1U << 14);  ///< Subregion 14 in region 0 (write '1' to clear)
        constexpr uint32_t SR15 = (1U << 15);  ///< Subregion 15 in region 0 (write '1' to clear)
        constexpr uint32_t SR16 = (1U << 16);  ///< Subregion 16 in region 0 (write '1' to clear)
        constexpr uint32_t SR17 = (1U << 17);  ///< Subregion 17 in region 0 (write '1' to clear)
        constexpr uint32_t SR18 = (1U << 18);  ///< Subregion 18 in region 0 (write '1' to clear)
        constexpr uint32_t SR19 = (1U << 19);  ///< Subregion 19 in region 0 (write '1' to clear)
        constexpr uint32_t SR20 = (1U << 20);  ///< Subregion 20 in region 0 (write '1' to clear)
        constexpr uint32_t SR21 = (1U << 21);  ///< Subregion 21 in region 0 (write '1' to clear)
        constexpr uint32_t SR22 = (1U << 22);  ///< Subregion 22 in region 0 (write '1' to clear)
        constexpr uint32_t SR23 = (1U << 23);  ///< Subregion 23 in region 0 (write '1' to clear)
        constexpr uint32_t SR24 = (1U << 24);  ///< Subregion 24 in region 0 (write '1' to clear)
        constexpr uint32_t SR25 = (1U << 25);  ///< Subregion 25 in region 0 (write '1' to clear)
        constexpr uint32_t SR26 = (1U << 26);  ///< Subregion 26 in region 0 (write '1' to clear)
        constexpr uint32_t SR27 = (1U << 27);  ///< Subregion 27 in region 0 (write '1' to clear)
        constexpr uint32_t SR28 = (1U << 28);  ///< Subregion 28 in region 0 (write '1' to clear)
        constexpr uint32_t SR29 = (1U << 29);  ///< Subregion 29 in region 0 (write '1' to clear)
        constexpr uint32_t SR30 = (1U << 30);  ///< Subregion 30 in region 0 (write '1' to clear)
        constexpr uint32_t SR31 = (1U << 31);  ///< Subregion 31 in region 0 (write '1' to clear)
    }
...
namespace i2s {
    ...
    /// INTEN Register bits
    namespace inten_bits {
        constexpr uint32_t RXPTRUPD = (1U << 1);  ///< Enable or disable interrupt for RXPTRUPD event
        constexpr uint32_t STOPPED = (1U << 2);  ///< Enable or disable interrupt for STOPPED event
        constexpr uint32_t TXPTRUPD = (1U << 5);  ///< Enable or disable interrupt for TXPTRUPD event
    }

    /// INTENSET Register bits
    namespace intenset_bits {
        constexpr uint32_t RXPTRUPD = (1U << 1);  ///< Write '1' to Enable interrupt for RXPTRUPD event
        constexpr uint32_t STOPPED = (1U << 2);  ///< Write '1' to Enable interrupt for STOPPED event
        constexpr uint32_t TXPTRUPD = (1U << 5);  ///< Write '1' to Enable interrupt for TXPTRUPD event
    }

    /// INTENCLR Register bits
    namespace intenclr_bits {
        constexpr uint32_t RXPTRUPD = (1U << 1);  ///< Write '1' to Disable interrupt for RXPTRUPD event
        constexpr uint32_t STOPPED = (1U << 2);  ///< Write '1' to Disable interrupt for STOPPED event
        constexpr uint32_t TXPTRUPD = (1U << 5);  ///< Write '1' to Disable interrupt for TXPTRUPD event
    }
...
namespace p0 {
    ...
    struct Registers {
        ...
        volatile uint32_t PIN_CNF__;  ///< Offset: 0x700 - Description collection[0]: Configuration of GPIO pins (renamed from PIN_CNF__)
    };
...
#endif // ALLOY_GENERATED_NRF52_PERIPHERALS_HPP