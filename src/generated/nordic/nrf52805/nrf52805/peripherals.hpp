/// Auto-generated code for nrf52805
/// Generated by Alloy Code Generator
/// Source: nordic_nrf52805.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:01:02
#ifndef ALLOY_GENERATED_NRF52805_PERIPHERALS_HPP
#define ALLOY_GENERATED_NRF52805_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::nrf52805 {
...
namespace p0 {
    ...
    struct Registers {
        ...
        volatile uint32_t DETECTMODE;  ///< Offset: 0x524 - Select between default DETECT signal behavior and LDETECT mode
...
namespace temp {
    ...
    struct Registers {
        ...
        volatile uint32_t T0;  ///< Offset: 0x560 - End point of first piecewise linear function
        volatile uint32_t T1;  ///< Offset: 0x564 - End point of second piecewise linear function
        volatile uint32_t T2;  ///< Offset: 0x568 - End point of third piecewise linear function
        volatile uint32_t T3;  ///< Offset: 0x56C - End point of fourth piecewise linear function
        volatile uint32_t T4;  ///< Offset: 0x570 - End point of fifth piecewise linear function
    };
    ...
    /// B0 Register bits
    namespace b0_bits {
        constexpr uint32_t B0 = (14 << 0);  ///< y-intercept of first piecewise linear function
    }

    /// B1 Register bits
    namespace b1_bits {
        constexpr uint32_t B1 = (14 << 0);  ///< y-intercept of second piecewise linear function
    }

    /// B2 Register bits
    namespace b2_bits {
        constexpr uint32_t B2 = (14 << 0);  ///< y-intercept of third piecewise linear function
    }

    /// B3 Register bits
    namespace b3_bits {
        constexpr uint32_t B3 = (14 << 0);  ///< y-intercept of fourth piecewise linear function
    }

    /// B4 Register bits
    namespace b4_bits {
        constexpr uint32_t B4 = (14 << 0);  ///< y-intercept of fifth piecewise linear function
    }

    /// B5 Register bits
    namespace b5_bits {
        constexpr uint32_t B5 = (14 << 0);  ///< y-intercept of sixth piecewise linear function
    }

    /// T0 Register bits
    namespace t0_bits {
        constexpr uint32_t T0 = (8 << 0);  ///< End point of first piecewise linear function
    }

    /// T1 Register bits
    namespace t1_bits {
        constexpr uint32_t T1 = (8 << 0);  ///< End point of second piecewise linear function
    }

    /// T2 Register bits
    namespace t2_bits {
        constexpr uint32_t T2 = (8 << 0);  ///< End point of third piecewise linear function
    }

    /// T3 Register bits
    namespace t3_bits {
        constexpr uint32_t T3 = (8 << 0);  ///< End point of fourth piecewise linear function
    }

    /// T4 Register bits
    namespace t4_bits {
        constexpr uint32_t T4 = (8 << 0);  ///< End point of fifth piecewise linear function
    }
...
namespace ccm {
    ...
    namespace maxpacketsize_bits {
        constexpr uint32_t MAXPACKETSIZE = (8 << 0);  ///< Length of keystream generated when MODE.LENGTH = Extended. This value must be greater or equal to the subsequent packet payload to be encrypted/decrypted.
    }
...
namespace nvmc {
    ...
    /// CONFIG Register bits
    namespace config_bits {
        constexpr uint32_t WEN = (2 << 0);  ///< Program memory access mode. It is strongly recommended to only activate erase and write modes when they are actively used.
    }
...
namespace ppi {
    ...
    struct Registers {
        ...
        volatile uint32_t EEP;  ///< Offset: 0x00 - Description cluster: Channel n event endpoint
        volatile uint32_t TEP;  ///< Offset: 0x00 - Description cluster: Channel n task endpoint
...
#endif // ALLOY_GENERATED_NRF52805_PERIPHERALS_HPP