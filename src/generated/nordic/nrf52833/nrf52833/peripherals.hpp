/// Auto-generated code for nrf52833
/// Generated by Alloy Code Generator
/// Source: nordic_nrf52833.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:33
#ifndef ALLOY_GENERATED_NRF52833_PERIPHERALS_HPP
#define ALLOY_GENERATED_NRF52833_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::nrf52833 {
...
namespace traits {
    ...
    constexpr uint32_t num_spi_instances = 10;
...
namespace uicr {
    ...
    struct Registers {
        ...
        volatile uint32_t REGOUT0;  ///< Offset: 0x304 - Output voltage from REG0 regulator stage. The maximum...
    };
    ...
    namespace regout0_bits {
        constexpr uint32_t VOUT = (3 << 0);  ///< Output voltage from REG0 regulator stage.
    }
...
namespace rcc {
    ...
    struct Registers {
        ...
        volatile uint32_t LFXODEBOUNCE;  ///< Offset: 0x52C - LFXO debounce time. The LFXO is started by triggering...
    ...
    /// LFXODEBOUNCE Register bits
    namespace lfxodebounce_bits {
        constexpr uint32_t LFXODEBOUNCE = (1U << 0);  ///< LFXO debounce time.
    }
...
namespace radio {
    ...
    namespace dfectrl2_bits {
        constexpr uint32_t TSWITCHOFFSET = (13 << 0);  ///< Signed value offset after the end of the CRC before starting switching in number of 16M cycles
        constexpr uint32_t TSAMPLEOFFSET = (12 << 16);  ///< Signed value offset before starting sampling in number of 16M cycles relative to the beginning of the REFERENCE state - 12 us after switching start
    }
...
namespace nfct {
    ...
    struct Registers {
        ...
        volatile uint32_t MODULATIONCTRL;  ///< Offset: 0x52C - Enables the modulation output to a GPIO pin which can be...
        volatile uint32_t MODULATIONPSEL;  ///< Offset: 0x538 - Pin select for Modulation control.
    ...
    /// MODULATIONCTRL Register bits
    namespace modulationctrl_bits {
        constexpr uint32_t MODULATIONCTRL = (2 << 0);  ///< Configuration of modulation control.
    }

    /// MODULATIONPSEL Register bits
    namespace modulationpsel_bits {
        constexpr uint32_t PIN = (5 << 0);  ///< Pin number
        constexpr uint32_t PORT = (1U << 5);  ///< Port number
        constexpr uint32_t CONNECT = (1U << 31);  ///< Connection
    }
...
namespace pdm {
    ...
    namespace pdmclkctrl_bits {
        constexpr uint32_t FREQ = (32 << 0);  ///< PDM_CLK frequency configuration
    }
...
namespace nvmc {
    ...
    namespace eraseall_bits {
        constexpr uint32_t ERASEALL = (1U << 0);  ///< Erase all non-volatile memory including UICR registers. The erase must be enabled using CONFIG.WEN before the non-volatile memory can be erased.
    }
    ...
    namespace eraseuicr_bits {
        constexpr uint32_t ERASEUICR = (1U << 0);  ///< Register starting erase of all user information configuration registers. The erase must be enabled using CONFIG.WEN before the UICR can be erased.
    }
    ...
    /// IHIT Register bits
    namespace ihit_bits {
        constexpr uint32_t HITS = (32 << 0);  ///< Number of cache hits. Register is writable, but only to '0'.
    }

    /// IMISS Register bits
    namespace imiss_bits {
        constexpr uint32_t MISSES = (32 << 0);  ///< Number of cache misses. Register is writable, but only to '0'.
    }
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t EVENTS_ENDISOIN;  ///< Offset: 0x12C - The whole ISOIN buffer has been consumed. The buffer can...
        ...
        volatile uint32_t EVENTS_ENDISOOUT;  ///< Offset: 0x150 - The whole ISOOUT buffer has been consumed. The buffer...
    ...
    namespace events_endepin___bits {
        constexpr uint32_t EVENTS_ENDEPIN = (1U << 0);  ///< The whole EPIN[n] buffer has been consumed. The buffer can be accessed safely by software.
    }
    ...
    namespace events_endisoin_bits {
        constexpr uint32_t EVENTS_ENDISOIN = (1U << 0);  ///< The whole ISOIN buffer has been consumed. The buffer can be accessed safely by software.
    }

    /// EVENTS_ENDEPOUT__ Register bits
    namespace events_endepout___bits {
        constexpr uint32_t EVENTS_ENDEPOUT = (1U << 0);  ///< The whole EPOUT[n] buffer has been consumed. The buffer can be accessed safely by software.
    }

    /// EVENTS_ENDISOOUT Register bits
    namespace events_endisoout_bits {
        constexpr uint32_t EVENTS_ENDISOOUT = (1U << 0);  ///< The whole ISOOUT buffer has been consumed. The buffer can be accessed safely by software.
    }
...
#endif // ALLOY_GENERATED_NRF52833_PERIPHERALS_HPP