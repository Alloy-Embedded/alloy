...
#ifndef ALLOY_GENERATED_MK66F18_PERIPHERALS_HPP
#define ALLOY_GENERATED_MK66F18_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mk66f18 {
...
namespace traits {
    ...
    constexpr bool has_sysmpu = true;
    constexpr uint32_t num_sysmpu_instances = 1;
    ...
    constexpr uint32_t num_usb_instances = 5;
    ...
    template<>
    struct peripheral_count<struct sysmpu_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace aips0 {
    ...
    /// MPRA Register bits
    namespace mpra_bits {
        constexpr uint32_t MPL6 = (1U << 4);  ///< Master 6 Privilege Level
        constexpr uint32_t MTW6 = (1U << 5);  ///< Master 6 Trusted for Writes
        constexpr uint32_t MTR6 = (1U << 6);  ///< Master 6 Trusted for Read
        constexpr uint32_t MPL5 = (1U << 8);  ///< Master 5 Privilege Level
        constexpr uint32_t MTW5 = (1U << 9);  ///< Master 5 Trusted For Writes
        constexpr uint32_t MTR5 = (1U << 10);  ///< Master 5 Trusted For Read
...
namespace sysmpu {
    /// Base addresses
    constexpr uint32_t SYSMPU_BASE = 0x4000D000;

    /// SYSMPU Register structure
    struct Registers {
    ...
    /// Peripheral instances
    inline Registers* SYSMPU = reinterpret_cast<Registers*>(SYSMPU_BASE);
...
namespace sdram {
    ...
    struct Registers {
        ...
        volatile uint32_t AC%s;  ///< Offset: 0x48 - Address and Control Register
        volatile uint32_t CM%s;  ///< Offset: 0x4C - Control Mask
    };
...
namespace fmc {
    ...
    namespace pfb01cr_bits {
        constexpr uint32_t RFU = (1U << 0);  ///< Reserved for future use
    ...
    namespace tagvdw0s%s_bits {
        ...
        constexpr uint32_t tag = (16 << 6);  ///< 16-bit tag for cache entry
    }
...
namespace can {
    ...
    namespace rxmgmask_bits {
        constexpr uint32_t MG0 = (1U << 0);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG1 = (1U << 1);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG2 = (1U << 2);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG3 = (1U << 3);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG4 = (1U << 4);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG5 = (1U << 5);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG6 = (1U << 6);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG7 = (1U << 7);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG8 = (1U << 8);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG9 = (1U << 9);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG10 = (1U << 10);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG11 = (1U << 11);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG12 = (1U << 12);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG13 = (1U << 13);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG14 = (1U << 14);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG15 = (1U << 15);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG16 = (1U << 16);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG17 = (1U << 17);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG18 = (1U << 18);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG19 = (1U << 19);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG20 = (1U << 20);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG21 = (1U << 21);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG22 = (1U << 22);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG23 = (1U << 23);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG24 = (1U << 24);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG25 = (1U << 25);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG26 = (1U << 26);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG27 = (1U << 27);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG28 = (1U << 28);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG29 = (1U << 29);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG30 = (1U << 30);  ///< Rx Mailboxes Global Mask Bits
        constexpr uint32_t MG31 = (1U << 31);  ///< Rx Mailboxes Global Mask Bits
    }

    /// RX14MASK Register bits
    namespace rx14mask_bits {
        constexpr uint32_t RX14M0 = (1U << 0);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M1 = (1U << 1);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M2 = (1U << 2);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M3 = (1U << 3);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M4 = (1U << 4);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M5 = (1U << 5);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M6 = (1U << 6);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M7 = (1U << 7);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M8 = (1U << 8);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M9 = (1U << 9);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M10 = (1U << 10);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M11 = (1U << 11);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M12 = (1U << 12);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M13 = (1U << 13);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M14 = (1U << 14);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M15 = (1U << 15);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M16 = (1U << 16);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M17 = (1U << 17);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M18 = (1U << 18);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M19 = (1U << 19);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M20 = (1U << 20);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M21 = (1U << 21);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M22 = (1U << 22);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M23 = (1U << 23);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M24 = (1U << 24);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M25 = (1U << 25);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M26 = (1U << 26);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M27 = (1U << 27);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M28 = (1U << 28);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M29 = (1U << 29);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M30 = (1U << 30);  ///< Rx Buffer 14 Mask Bits
        constexpr uint32_t RX14M31 = (1U << 31);  ///< Rx Buffer 14 Mask Bits
    }

    /// RX15MASK Register bits
    namespace rx15mask_bits {
        constexpr uint32_t RX15M0 = (1U << 0);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M1 = (1U << 1);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M2 = (1U << 2);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M3 = (1U << 3);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M4 = (1U << 4);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M5 = (1U << 5);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M6 = (1U << 6);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M7 = (1U << 7);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M8 = (1U << 8);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M9 = (1U << 9);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M10 = (1U << 10);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M11 = (1U << 11);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M12 = (1U << 12);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M13 = (1U << 13);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M14 = (1U << 14);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M15 = (1U << 15);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M16 = (1U << 16);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M17 = (1U << 17);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M18 = (1U << 18);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M19 = (1U << 19);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M20 = (1U << 20);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M21 = (1U << 21);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M22 = (1U << 22);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M23 = (1U << 23);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M24 = (1U << 24);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M25 = (1U << 25);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M26 = (1U << 26);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M27 = (1U << 27);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M28 = (1U << 28);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M29 = (1U << 29);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M30 = (1U << 30);  ///< Rx Buffer 15 Mask Bits
        constexpr uint32_t RX15M31 = (1U << 31);  ///< Rx Buffer 15 Mask Bits
    }
    ...
    namespace imask1_bits {
        constexpr uint32_t BUFLM0 = (1U << 0);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM1 = (1U << 1);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM2 = (1U << 2);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM3 = (1U << 3);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM4 = (1U << 4);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM5 = (1U << 5);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM6 = (1U << 6);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM7 = (1U << 7);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM8 = (1U << 8);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM9 = (1U << 9);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM10 = (1U << 10);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM11 = (1U << 11);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM12 = (1U << 12);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM13 = (1U << 13);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM14 = (1U << 14);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM15 = (1U << 15);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM16 = (1U << 16);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM17 = (1U << 17);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM18 = (1U << 18);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM19 = (1U << 19);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM20 = (1U << 20);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM21 = (1U << 21);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM22 = (1U << 22);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM23 = (1U << 23);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM24 = (1U << 24);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM25 = (1U << 25);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM26 = (1U << 26);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM27 = (1U << 27);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM28 = (1U << 28);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM29 = (1U << 29);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM30 = (1U << 30);  ///< Buffer MB i Mask
        constexpr uint32_t BUFLM31 = (1U << 31);  ///< Buffer MB i Mask
    }

    /// IFLAG1 Register bits
    namespace iflag1_bits {
        constexpr uint32_t BUF0I = (1U << 0);  ///< Buffer MB0 Interrupt Or "reserved"
        constexpr uint32_t BUF4TO1I0 = (1U << 1);  ///< Buffer MB i Interrupt Or "reserved"
        constexpr uint32_t BUF4TO1I1 = (1U << 2);  ///< Buffer MB i Interrupt Or "reserved"
        constexpr uint32_t BUF4TO1I2 = (1U << 3);  ///< Buffer MB i Interrupt Or "reserved"
        constexpr uint32_t BUF4TO1I3 = (1U << 4);  ///< Buffer MB i Interrupt Or "reserved"
        ...
        constexpr uint32_t BUF31TO8I0 = (1U << 8);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I1 = (1U << 9);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I2 = (1U << 10);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I3 = (1U << 11);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I4 = (1U << 12);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I5 = (1U << 13);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I6 = (1U << 14);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I7 = (1U << 15);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I8 = (1U << 16);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I9 = (1U << 17);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I10 = (1U << 18);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I11 = (1U << 19);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I12 = (1U << 20);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I13 = (1U << 21);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I14 = (1U << 22);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I15 = (1U << 23);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I16 = (1U << 24);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I17 = (1U << 25);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I18 = (1U << 26);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I19 = (1U << 27);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I20 = (1U << 28);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I21 = (1U << 29);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I22 = (1U << 30);  ///< Buffer MBi Interrupt
        constexpr uint32_t BUF31TO8I23 = (1U << 31);  ///< Buffer MBi Interrupt
    }
    ...
    namespace rxfgmask_bits {
        constexpr uint32_t FGM0 = (1U << 0);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM1 = (1U << 1);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM2 = (1U << 2);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM3 = (1U << 3);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM4 = (1U << 4);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM5 = (1U << 5);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM6 = (1U << 6);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM7 = (1U << 7);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM8 = (1U << 8);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM9 = (1U << 9);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM10 = (1U << 10);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM11 = (1U << 11);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM12 = (1U << 12);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM13 = (1U << 13);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM14 = (1U << 14);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM15 = (1U << 15);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM16 = (1U << 16);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM17 = (1U << 17);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM18 = (1U << 18);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM19 = (1U << 19);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM20 = (1U << 20);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM21 = (1U << 21);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM22 = (1U << 22);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM23 = (1U << 23);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM24 = (1U << 24);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM25 = (1U << 25);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM26 = (1U << 26);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM27 = (1U << 27);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM28 = (1U << 28);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM29 = (1U << 29);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM30 = (1U << 30);  ///< Rx FIFO Global Mask Bits
        constexpr uint32_t FGM31 = (1U << 31);  ///< Rx FIFO Global Mask Bits
    }
    ...
    namespace rximr%s_bits {
        constexpr uint32_t MI0 = (1U << 0);  ///< Individual Mask Bits
        constexpr uint32_t MI1 = (1U << 1);  ///< Individual Mask Bits
        constexpr uint32_t MI2 = (1U << 2);  ///< Individual Mask Bits
        constexpr uint32_t MI3 = (1U << 3);  ///< Individual Mask Bits
        constexpr uint32_t MI4 = (1U << 4);  ///< Individual Mask Bits
        constexpr uint32_t MI5 = (1U << 5);  ///< Individual Mask Bits
        constexpr uint32_t MI6 = (1U << 6);  ///< Individual Mask Bits
        constexpr uint32_t MI7 = (1U << 7);  ///< Individual Mask Bits
        constexpr uint32_t MI8 = (1U << 8);  ///< Individual Mask Bits
        constexpr uint32_t MI9 = (1U << 9);  ///< Individual Mask Bits
        constexpr uint32_t MI10 = (1U << 10);  ///< Individual Mask Bits
        constexpr uint32_t MI11 = (1U << 11);  ///< Individual Mask Bits
        constexpr uint32_t MI12 = (1U << 12);  ///< Individual Mask Bits
        constexpr uint32_t MI13 = (1U << 13);  ///< Individual Mask Bits
        constexpr uint32_t MI14 = (1U << 14);  ///< Individual Mask Bits
        constexpr uint32_t MI15 = (1U << 15);  ///< Individual Mask Bits
        constexpr uint32_t MI16 = (1U << 16);  ///< Individual Mask Bits
        constexpr uint32_t MI17 = (1U << 17);  ///< Individual Mask Bits
        constexpr uint32_t MI18 = (1U << 18);  ///< Individual Mask Bits
        constexpr uint32_t MI19 = (1U << 19);  ///< Individual Mask Bits
        constexpr uint32_t MI20 = (1U << 20);  ///< Individual Mask Bits
        constexpr uint32_t MI21 = (1U << 21);  ///< Individual Mask Bits
        constexpr uint32_t MI22 = (1U << 22);  ///< Individual Mask Bits
        constexpr uint32_t MI23 = (1U << 23);  ///< Individual Mask Bits
        constexpr uint32_t MI24 = (1U << 24);  ///< Individual Mask Bits
        constexpr uint32_t MI25 = (1U << 25);  ///< Individual Mask Bits
        constexpr uint32_t MI26 = (1U << 26);  ///< Individual Mask Bits
        constexpr uint32_t MI27 = (1U << 27);  ///< Individual Mask Bits
        constexpr uint32_t MI28 = (1U << 28);  ///< Individual Mask Bits
        constexpr uint32_t MI29 = (1U << 29);  ///< Individual Mask Bits
        constexpr uint32_t MI30 = (1U << 30);  ///< Individual Mask Bits
        constexpr uint32_t MI31 = (1U << 31);  ///< Individual Mask Bits
    }
...
namespace spi {
    ...
    namespace mcr_bits {
        ...
        constexpr uint32_t PCSIS0 = (1U << 16);  ///< Peripheral Chip Select x Inactive State
        constexpr uint32_t PCSIS1 = (1U << 17);  ///< Peripheral Chip Select x Inactive State
        constexpr uint32_t PCSIS2 = (1U << 18);  ///< Peripheral Chip Select x Inactive State
        constexpr uint32_t PCSIS3 = (1U << 19);  ///< Peripheral Chip Select x Inactive State
        constexpr uint32_t PCSIS4 = (1U << 20);  ///< Peripheral Chip Select x Inactive State
        constexpr uint32_t PCSIS5 = (1U << 21);  ///< Peripheral Chip Select x Inactive State
    ...
    namespace pushr_bits {
        ...
        constexpr uint32_t PCS0 = (1U << 16);  ///< Select which PCS signals are to be asserted for the transfer
        constexpr uint32_t PCS1 = (1U << 17);  ///< Select which PCS signals are to be asserted for the transfer
        constexpr uint32_t PCS2 = (1U << 18);  ///< Select which PCS signals are to be asserted for the transfer
        constexpr uint32_t PCS3 = (1U << 19);  ///< Select which PCS signals are to be asserted for the transfer
        constexpr uint32_t PCS4 = (1U << 20);  ///< Select which PCS signals are to be asserted for the transfer
        constexpr uint32_t PCS5 = (1U << 21);  ///< Select which PCS signals are to be asserted for the transfer
...
namespace i2s {
    ...
    namespace tcr3_bits {
        ...
        constexpr uint32_t TCE0 = (1U << 16);  ///< Transmit Channel Enable
        constexpr uint32_t TCE1 = (1U << 17);  ///< Transmit Channel Enable
        constexpr uint32_t CFR0 = (1U << 24);  ///< Channel FIFO Reset
        constexpr uint32_t CFR1 = (1U << 25);  ///< Channel FIFO Reset
    }
    ...
    /// TMR Register bits
    namespace tmr_bits {
        constexpr uint32_t TWM0 = (1U << 0);  ///< Transmit Word Mask
        constexpr uint32_t TWM1 = (1U << 1);  ///< Transmit Word Mask
        constexpr uint32_t TWM2 = (1U << 2);  ///< Transmit Word Mask
        constexpr uint32_t TWM3 = (1U << 3);  ///< Transmit Word Mask
        constexpr uint32_t TWM4 = (1U << 4);  ///< Transmit Word Mask
        constexpr uint32_t TWM5 = (1U << 5);  ///< Transmit Word Mask
        constexpr uint32_t TWM6 = (1U << 6);  ///< Transmit Word Mask
        constexpr uint32_t TWM7 = (1U << 7);  ///< Transmit Word Mask
        constexpr uint32_t TWM8 = (1U << 8);  ///< Transmit Word Mask
        constexpr uint32_t TWM9 = (1U << 9);  ///< Transmit Word Mask
        constexpr uint32_t TWM10 = (1U << 10);  ///< Transmit Word Mask
        constexpr uint32_t TWM11 = (1U << 11);  ///< Transmit Word Mask
        constexpr uint32_t TWM12 = (1U << 12);  ///< Transmit Word Mask
        constexpr uint32_t TWM13 = (1U << 13);  ///< Transmit Word Mask
        constexpr uint32_t TWM14 = (1U << 14);  ///< Transmit Word Mask
        constexpr uint32_t TWM15 = (1U << 15);  ///< Transmit Word Mask
        constexpr uint32_t TWM16 = (1U << 16);  ///< Transmit Word Mask
        constexpr uint32_t TWM17 = (1U << 17);  ///< Transmit Word Mask
        constexpr uint32_t TWM18 = (1U << 18);  ///< Transmit Word Mask
        constexpr uint32_t TWM19 = (1U << 19);  ///< Transmit Word Mask
        constexpr uint32_t TWM20 = (1U << 20);  ///< Transmit Word Mask
        constexpr uint32_t TWM21 = (1U << 21);  ///< Transmit Word Mask
        constexpr uint32_t TWM22 = (1U << 22);  ///< Transmit Word Mask
        constexpr uint32_t TWM23 = (1U << 23);  ///< Transmit Word Mask
        constexpr uint32_t TWM24 = (1U << 24);  ///< Transmit Word Mask
        constexpr uint32_t TWM25 = (1U << 25);  ///< Transmit Word Mask
        constexpr uint32_t TWM26 = (1U << 26);  ///< Transmit Word Mask
        constexpr uint32_t TWM27 = (1U << 27);  ///< Transmit Word Mask
        constexpr uint32_t TWM28 = (1U << 28);  ///< Transmit Word Mask
        constexpr uint32_t TWM29 = (1U << 29);  ///< Transmit Word Mask
        constexpr uint32_t TWM30 = (1U << 30);  ///< Transmit Word Mask
        constexpr uint32_t TWM31 = (1U << 31);  ///< Transmit Word Mask
    }
    ...
    namespace rcr3_bits {
        constexpr uint32_t WDFL = (5 << 0);  ///< Word Flag Configuration
        constexpr uint32_t RCE0 = (1U << 16);  ///< Receive Channel Enable
        constexpr uint32_t RCE1 = (1U << 17);  ///< Receive Channel Enable
        constexpr uint32_t CFR0 = (1U << 24);  ///< Channel FIFO Reset
        constexpr uint32_t CFR1 = (1U << 25);  ///< Channel FIFO Reset
    }
    ...
    /// RMR Register bits
    namespace rmr_bits {
        constexpr uint32_t RWM0 = (1U << 0);  ///< Receive Word Mask
        constexpr uint32_t RWM1 = (1U << 1);  ///< Receive Word Mask
        constexpr uint32_t RWM2 = (1U << 2);  ///< Receive Word Mask
        constexpr uint32_t RWM3 = (1U << 3);  ///< Receive Word Mask
        constexpr uint32_t RWM4 = (1U << 4);  ///< Receive Word Mask
        constexpr uint32_t RWM5 = (1U << 5);  ///< Receive Word Mask
        constexpr uint32_t RWM6 = (1U << 6);  ///< Receive Word Mask
        constexpr uint32_t RWM7 = (1U << 7);  ///< Receive Word Mask
        constexpr uint32_t RWM8 = (1U << 8);  ///< Receive Word Mask
        constexpr uint32_t RWM9 = (1U << 9);  ///< Receive Word Mask
        constexpr uint32_t RWM10 = (1U << 10);  ///< Receive Word Mask
        constexpr uint32_t RWM11 = (1U << 11);  ///< Receive Word Mask
        constexpr uint32_t RWM12 = (1U << 12);  ///< Receive Word Mask
        constexpr uint32_t RWM13 = (1U << 13);  ///< Receive Word Mask
        constexpr uint32_t RWM14 = (1U << 14);  ///< Receive Word Mask
        constexpr uint32_t RWM15 = (1U << 15);  ///< Receive Word Mask
        constexpr uint32_t RWM16 = (1U << 16);  ///< Receive Word Mask
        constexpr uint32_t RWM17 = (1U << 17);  ///< Receive Word Mask
        constexpr uint32_t RWM18 = (1U << 18);  ///< Receive Word Mask
        constexpr uint32_t RWM19 = (1U << 19);  ///< Receive Word Mask
        constexpr uint32_t RWM20 = (1U << 20);  ///< Receive Word Mask
        constexpr uint32_t RWM21 = (1U << 21);  ///< Receive Word Mask
        constexpr uint32_t RWM22 = (1U << 22);  ///< Receive Word Mask
        constexpr uint32_t RWM23 = (1U << 23);  ///< Receive Word Mask
        constexpr uint32_t RWM24 = (1U << 24);  ///< Receive Word Mask
        constexpr uint32_t RWM25 = (1U << 25);  ///< Receive Word Mask
        constexpr uint32_t RWM26 = (1U << 26);  ///< Receive Word Mask
        constexpr uint32_t RWM27 = (1U << 27);  ///< Receive Word Mask
        constexpr uint32_t RWM28 = (1U << 28);  ///< Receive Word Mask
        constexpr uint32_t RWM29 = (1U << 29);  ///< Receive Word Mask
        constexpr uint32_t RWM30 = (1U << 30);  ///< Receive Word Mask
        constexpr uint32_t RWM31 = (1U << 31);  ///< Receive Word Mask
    }
...
namespace usb {
    ...
    constexpr uint32_t USBHS_BASE = 0x400A1000;
    constexpr uint32_t USBPHY_BASE = 0x400A2000;
    constexpr uint32_t USBHSDCD_BASE = 0x400A3000;
    ...
    inline Registers* USBHSDCD = reinterpret_cast<Registers*>(USBHSDCD_BASE);
...
namespace pdb0 {
    ...
    namespace ch%sc1_bits {
        constexpr uint32_t EN0 = (1U << 0);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN1 = (1U << 1);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN2 = (1U << 2);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN3 = (1U << 3);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN4 = (1U << 4);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN5 = (1U << 5);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN6 = (1U << 6);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t EN7 = (1U << 7);  ///< PDB Channel Pre-Trigger Enable
        constexpr uint32_t TOS0 = (1U << 8);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS1 = (1U << 9);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS2 = (1U << 10);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS3 = (1U << 11);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS4 = (1U << 12);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS5 = (1U << 13);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS6 = (1U << 14);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t TOS7 = (1U << 15);  ///< PDB Channel Pre-Trigger Output Select
        constexpr uint32_t BB0 = (1U << 16);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB1 = (1U << 17);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB2 = (1U << 18);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB3 = (1U << 19);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB4 = (1U << 20);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB5 = (1U << 21);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB6 = (1U << 22);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
        constexpr uint32_t BB7 = (1U << 23);  ///< PDB Channel Pre-Trigger Back-to-Back Operation Enable
    }

    /// CH%sS Register bits
    namespace ch%ss_bits {
        constexpr uint32_t ERR0 = (1U << 0);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR1 = (1U << 1);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR2 = (1U << 2);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR3 = (1U << 3);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR4 = (1U << 4);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR5 = (1U << 5);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR6 = (1U << 6);  ///< PDB Channel Sequence Error Flags
        constexpr uint32_t ERR7 = (1U << 7);  ///< PDB Channel Sequence Error Flags
    ...
    /// POEN Register bits
    namespace poen_bits {
        constexpr uint32_t POEN0 = (1U << 0);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN1 = (1U << 1);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN2 = (1U << 2);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN3 = (1U << 3);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN4 = (1U << 4);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN5 = (1U << 5);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN6 = (1U << 6);  ///< PDB Pulse-Out Enable
        constexpr uint32_t POEN7 = (1U << 7);  ///< PDB Pulse-Out Enable
    }
...
namespace sim {
    ...
    struct Registers {
        ...
        volatile uint32_t USBPHYCTL;  ///< Offset: 0x08 - USB PHY Control Register
    ...
    /// USBPHYCTL Register bits
    namespace usbphyctl_bits {
        constexpr uint32_t USBVREGSEL = (1U << 8);  ///< Selects the default input voltage source to the USB Regulator in case both VREG_IN0 and VREG_IN1 are powered
        constexpr uint32_t USBVREGPD = (1U << 9);  ///< Enables the pulldown on the output of the USB Regulator.
        constexpr uint32_t USB3VOUTTRG = (3 << 20);  ///< USB 3.3V Output Target
        constexpr uint32_t USBDISILIM = (1U << 23);  ///< USB Disable Inrush Current Limit
    }

    /// SOPT2 Register bits
    namespace sopt2_bits {
        constexpr uint32_t USBSLSRC = (1U << 0);  ///< USB Slow Clock Source
        constexpr uint32_t USBREGEN = (1U << 1);  ///< USB PHY PLL Regulator Enable
    ...
    namespace scgc3_bits {
        ...
        constexpr uint32_t USBHS = (1U << 1);  ///< USBHS Clock Gate Control
        constexpr uint32_t USBHSPHY = (1U << 2);  ///< USBHS PHY Clock Gate Control
        constexpr uint32_t USBHSDCD = (1U << 3);  ///< USBHS DCD Clock Gate Control
    ...
    namespace fcfg2_bits {
        ...
        constexpr uint32_t PFLSH = (1U << 23);  ///< Program flash only
...
namespace gpio {
    ...
    namespace gpclr_bits {
        ...
        constexpr uint32_t GPWE0 = (1U << 16);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE1 = (1U << 17);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE2 = (1U << 18);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE3 = (1U << 19);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE4 = (1U << 20);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE5 = (1U << 21);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE6 = (1U << 22);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE7 = (1U << 23);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE8 = (1U << 24);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE9 = (1U << 25);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE10 = (1U << 26);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE11 = (1U << 27);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE12 = (1U << 28);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE13 = (1U << 29);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE14 = (1U << 30);  ///< Global Pin Write Enable
        constexpr uint32_t GPWE15 = (1U << 31);  ///< Global Pin Write Enable
    }
    ...
    /// ISFR Register bits
    namespace isfr_bits {
        constexpr uint32_t ISF0 = (1U << 0);  ///< Interrupt Status Flag
        constexpr uint32_t ISF1 = (1U << 1);  ///< Interrupt Status Flag
        constexpr uint32_t ISF2 = (1U << 2);  ///< Interrupt Status Flag
        constexpr uint32_t ISF3 = (1U << 3);  ///< Interrupt Status Flag
        constexpr uint32_t ISF4 = (1U << 4);  ///< Interrupt Status Flag
        constexpr uint32_t ISF5 = (1U << 5);  ///< Interrupt Status Flag
        constexpr uint32_t ISF6 = (1U << 6);  ///< Interrupt Status Flag
        constexpr uint32_t ISF7 = (1U << 7);  ///< Interrupt Status Flag
        constexpr uint32_t ISF8 = (1U << 8);  ///< Interrupt Status Flag
        constexpr uint32_t ISF9 = (1U << 9);  ///< Interrupt Status Flag
        constexpr uint32_t ISF10 = (1U << 10);  ///< Interrupt Status Flag
        constexpr uint32_t ISF11 = (1U << 11);  ///< Interrupt Status Flag
        constexpr uint32_t ISF12 = (1U << 12);  ///< Interrupt Status Flag
        constexpr uint32_t ISF13 = (1U << 13);  ///< Interrupt Status Flag
        constexpr uint32_t ISF14 = (1U << 14);  ///< Interrupt Status Flag
        constexpr uint32_t ISF15 = (1U << 15);  ///< Interrupt Status Flag
        constexpr uint32_t ISF16 = (1U << 16);  ///< Interrupt Status Flag
        constexpr uint32_t ISF17 = (1U << 17);  ///< Interrupt Status Flag
        constexpr uint32_t ISF18 = (1U << 18);  ///< Interrupt Status Flag
        constexpr uint32_t ISF19 = (1U << 19);  ///< Interrupt Status Flag
        constexpr uint32_t ISF20 = (1U << 20);  ///< Interrupt Status Flag
        constexpr uint32_t ISF21 = (1U << 21);  ///< Interrupt Status Flag
        constexpr uint32_t ISF22 = (1U << 22);  ///< Interrupt Status Flag
        constexpr uint32_t ISF23 = (1U << 23);  ///< Interrupt Status Flag
        constexpr uint32_t ISF24 = (1U << 24);  ///< Interrupt Status Flag
        constexpr uint32_t ISF25 = (1U << 25);  ///< Interrupt Status Flag
        constexpr uint32_t ISF26 = (1U << 26);  ///< Interrupt Status Flag
        constexpr uint32_t ISF27 = (1U << 27);  ///< Interrupt Status Flag
        constexpr uint32_t ISF28 = (1U << 28);  ///< Interrupt Status Flag
        constexpr uint32_t ISF29 = (1U << 29);  ///< Interrupt Status Flag
        constexpr uint32_t ISF30 = (1U << 30);  ///< Interrupt Status Flag
        constexpr uint32_t ISF31 = (1U << 31);  ///< Interrupt Status Flag
    }
...
namespace rcc {
    ...
    /// C9 Register bits
    namespace c9_bits {
        constexpr uint32_t EXT_PLL_LOCS = (1U << 0);  ///< External PLL Loss of Clock Status
        constexpr uint32_t PLL_LOCRE = (1U << 4);  ///< MCG External PLL Loss of Clock Reset Enable
        constexpr uint32_t PLL_CME = (1U << 5);  ///< MCG External PLL Clock Monitor Enable
    }
...
namespace enet {
    ...
    struct Registers {
        ...
        volatile uint32_t IEEE_T_DROP;  ///< Offset: 0x248 - IEEE_T_DROP Reserved Statistic Register
        ...
        volatile uint32_t IEEE_T_SQE;  ///< Offset: 0x26C - no description available
    ...
    /// MRBR Register bits
    namespace mrbr_bits {
        constexpr uint32_t R_BUF_SIZE = (7 << 4);  ///< Receive buffer size in bytes
    }
    ...
    namespace ieee_t_sqe_bits {
        constexpr uint32_t COUNT = (16 << 0);  ///< Number of frames transmitted with SQE error
    }
...
#endif // ALLOY_GENERATED_MK66F18_PERIPHERALS_HPP