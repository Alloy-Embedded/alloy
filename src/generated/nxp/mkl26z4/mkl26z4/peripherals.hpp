/// Auto-generated code for MKL26Z4
/// Generated by Alloy Code Generator
/// Source: nxp_mkl26.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:06
#ifndef ALLOY_GENERATED_MKL26Z4_PERIPHERALS_HPP
#define ALLOY_GENERATED_MKL26Z4_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mkl26z4 {
...
namespace nvic {
    ...
    namespace nvic_iser_bits {
        constexpr uint32_t SETENA0 = (1U << 0);  ///< DMA channel 0 transfer complete and error interrupt set-enable bit
        constexpr uint32_t SETENA1 = (1U << 1);  ///< DMA channel 1 transfer complete and error interrupt set-enable bit
        constexpr uint32_t SETENA2 = (1U << 2);  ///< DMA channel 2 transfer complete and error interrupt set-enable bit
        constexpr uint32_t SETENA3 = (1U << 3);  ///< DMA channel 3 transfer complete and error interrupt set-enable bit
        constexpr uint32_t SETENA4 = (1U << 4);  ///< Reserved iv 20 interrupt set-enable bit
        constexpr uint32_t SETENA5 = (1U << 5);  ///< FTFA command complete and read collision interrupt set-enable bit
        constexpr uint32_t SETENA6 = (1U << 6);  ///< low-voltage detect and low-voltage warning interrupt set-enable bit
        ...
        constexpr uint32_t SETENA11 = (1U << 11);  ///< serial peripheral interface 1 interrupt set-enable bit
        constexpr uint32_t SETENA12 = (1U << 12);  ///< UART0 status and error interrupt set-enable bit
        constexpr uint32_t SETENA13 = (1U << 13);  ///< UART1 status and error interrupt set-enable bit
        constexpr uint32_t SETENA14 = (1U << 14);  ///< UART2 status and error interrupt set-enable bit
        constexpr uint32_t SETENA15 = (1U << 15);  ///< Analog-to-digital converter 0 interrupt set-enable bit
        constexpr uint32_t SETENA16 = (1U << 16);  ///< Comparator 0 interrupt set-enable bit
        ...
        constexpr uint32_t SETENA20 = (1U << 20);  ///< real time clock alarm interrupt set-enable bit
        constexpr uint32_t SETENA21 = (1U << 21);  ///< real time clock seconds interrupt set-enable bit
        constexpr uint32_t SETENA22 = (1U << 22);  ///< periodic interrupt timer all channels interrupt set-enable bit
        constexpr uint32_t SETENA23 = (1U << 23);  ///< integrated interchip sound 0 interrupt set-enable bit
        constexpr uint32_t SETENA24 = (1U << 24);  ///< universal serial bus on the go interrupt set-enable bit
        constexpr uint32_t SETENA25 = (1U << 25);  ///< digital-to-analog converter 0 interrupt set-enable bit
        constexpr uint32_t SETENA26 = (1U << 26);  ///< touch sensing input interrupt set-enable bit
        constexpr uint32_t SETENA27 = (1U << 27);  ///< multipurpose clock generator interrupt set-enable bit
        constexpr uint32_t SETENA28 = (1U << 28);  ///< Low-Power Timer interrupt set-enable bit
        constexpr uint32_t SETENA29 = (1U << 29);  ///< Reserved iv 45 interrupt set-enable bit
        constexpr uint32_t SETENA30 = (1U << 30);  ///< PORTA pin detect interrupt set-enable bit
        constexpr uint32_t SETENA31 = (1U << 31);  ///< PORTC and PORTD pin detect interrupt set-enable bit
    }

    /// NVIC_ICER Register bits
    namespace nvic_icer_bits {
        constexpr uint32_t CLRENA0 = (1U << 0);  ///< DMA channel 0 transfer complete and error interrupt clear-enable bit
        constexpr uint32_t CLRENA1 = (1U << 1);  ///< DMA channel 1 transfer complete and error interrupt clear-enable bit
        constexpr uint32_t CLRENA2 = (1U << 2);  ///< DMA channel 2 transfer complete and error interrupt clear-enable bit
        constexpr uint32_t CLRENA3 = (1U << 3);  ///< DMA channel 3 transfer complete and error interrupt clear-enable bit
        constexpr uint32_t CLRENA4 = (1U << 4);  ///< Reserved iv 20 interrupt clear-enable bit
        constexpr uint32_t CLRENA5 = (1U << 5);  ///< FTFA command complete and read collision interrupt clear-enable bit
        constexpr uint32_t CLRENA6 = (1U << 6);  ///< low-voltage detect and low-voltage warning interrupt clear-enable bit
        ...
        constexpr uint32_t CLRENA11 = (1U << 11);  ///< serial peripheral interface 1 interrupt clear-enable bit
        constexpr uint32_t CLRENA12 = (1U << 12);  ///< UART0 status and error interrupt clear-enable bit
        constexpr uint32_t CLRENA13 = (1U << 13);  ///< UART1 status and error interrupt clear-enable bit
        constexpr uint32_t CLRENA14 = (1U << 14);  ///< UART2 status and error interrupt clear-enable bit
        constexpr uint32_t CLRENA15 = (1U << 15);  ///< Analog-to-digital converter 0 interrupt clear-enable bit
        constexpr uint32_t CLRENA16 = (1U << 16);  ///< Comparator 0 interrupt clear-enable bit
        ...
        constexpr uint32_t CLRENA20 = (1U << 20);  ///< real time clock alarm interrupt clear-enable bit
        constexpr uint32_t CLRENA21 = (1U << 21);  ///< real time clock seconds interrupt clear-enable bit
        constexpr uint32_t CLRENA22 = (1U << 22);  ///< periodic interrupt timer all channels interrupt clear-enable bit
        constexpr uint32_t CLRENA23 = (1U << 23);  ///< integrated interchip sound 0 interrupt clear-enable bit
        constexpr uint32_t CLRENA24 = (1U << 24);  ///< universal serial bus on the go interrupt clear-enable bit
        constexpr uint32_t CLRENA25 = (1U << 25);  ///< digital-to-analog converter 0 interrupt clear-enable bit
        constexpr uint32_t CLRENA26 = (1U << 26);  ///< touch sensing input interrupt clear-enable bit
        constexpr uint32_t CLRENA27 = (1U << 27);  ///< multipurpose clock generator interrupt clear-enable bit
        constexpr uint32_t CLRENA28 = (1U << 28);  ///< Low-Power Timer interrupt clear-enable bit
        constexpr uint32_t CLRENA29 = (1U << 29);  ///< Reserved iv 45 interrupt clear-enable bit
        constexpr uint32_t CLRENA30 = (1U << 30);  ///< PORTA pin detect interrupt clear-enable bit
        constexpr uint32_t CLRENA31 = (1U << 31);  ///< PORTC and PORTD pin detect interrupt clear-enable bit
    }

    /// NVIC_ISPR Register bits
    namespace nvic_ispr_bits {
        constexpr uint32_t SETPEND0 = (1U << 0);  ///< DMA channel 0 transfer complete and error interrupt set-pending bit
        constexpr uint32_t SETPEND1 = (1U << 1);  ///< DMA channel 1 transfer complete and error interrupt set-pending bit
        constexpr uint32_t SETPEND2 = (1U << 2);  ///< DMA channel 2 transfer complete and error interrupt set-pending bit
        constexpr uint32_t SETPEND3 = (1U << 3);  ///< DMA channel 3 transfer complete and error interrupt set-pending bit
        constexpr uint32_t SETPEND4 = (1U << 4);  ///< Reserved iv 20 interrupt set-pending bit
        constexpr uint32_t SETPEND5 = (1U << 5);  ///< FTFA command complete and read collision interrupt set-pending bit
        constexpr uint32_t SETPEND6 = (1U << 6);  ///< low-voltage detect and low-voltage warning interrupt set-pending bit
        ...
        constexpr uint32_t SETPEND11 = (1U << 11);  ///< serial peripheral interface 1 interrupt set-pending bit
        constexpr uint32_t SETPEND12 = (1U << 12);  ///< UART0 status and error interrupt set-pending bit
        constexpr uint32_t SETPEND13 = (1U << 13);  ///< UART1 status and error interrupt set-pending bit
        constexpr uint32_t SETPEND14 = (1U << 14);  ///< UART2 status and error interrupt set-pending bit
        constexpr uint32_t SETPEND15 = (1U << 15);  ///< Analog-to-digital converter 0 interrupt set-pending bit
        constexpr uint32_t SETPEND16 = (1U << 16);  ///< Comparator 0 interrupt set-pending bit
        ...
        constexpr uint32_t SETPEND20 = (1U << 20);  ///< real time clock alarm interrupt set-pending bit
        constexpr uint32_t SETPEND21 = (1U << 21);  ///< real time clock seconds interrupt set-pending bit
        constexpr uint32_t SETPEND22 = (1U << 22);  ///< periodic interrupt timer all channels interrupt set-pending bit
        constexpr uint32_t SETPEND23 = (1U << 23);  ///< integrated interchip sound 0 interrupt set-pending bit
        constexpr uint32_t SETPEND24 = (1U << 24);  ///< universal serial bus on the go interrupt set-pending bit
        constexpr uint32_t SETPEND25 = (1U << 25);  ///< digital-to-analog converter 0 interrupt set-pending bit
        constexpr uint32_t SETPEND26 = (1U << 26);  ///< touch sensing input interrupt set-pending bit
        constexpr uint32_t SETPEND27 = (1U << 27);  ///< multipurpose clock generator interrupt set-pending bit
        constexpr uint32_t SETPEND28 = (1U << 28);  ///< Low-Power Timer interrupt set-pending bit
        constexpr uint32_t SETPEND29 = (1U << 29);  ///< Reserved iv 45 interrupt set-pending bit
        constexpr uint32_t SETPEND30 = (1U << 30);  ///< PORTA pin detect interrupt set-pending bit
        constexpr uint32_t SETPEND31 = (1U << 31);  ///< PORTC and PORTD pin detect interrupt set-pending bit
    }

    /// NVIC_ICPR Register bits
    namespace nvic_icpr_bits {
        constexpr uint32_t CLRPEND0 = (1U << 0);  ///< DMA channel 0 transfer complete and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND1 = (1U << 1);  ///< DMA channel 1 transfer complete and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND2 = (1U << 2);  ///< DMA channel 2 transfer complete and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND3 = (1U << 3);  ///< DMA channel 3 transfer complete and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND4 = (1U << 4);  ///< Reserved iv 20 interrupt clear-pending bit
        constexpr uint32_t CLRPEND5 = (1U << 5);  ///< FTFA command complete and read collision interrupt clear-pending bit
        constexpr uint32_t CLRPEND6 = (1U << 6);  ///< low-voltage detect and low-voltage warning interrupt clear-pending bit
        ...
        constexpr uint32_t CLRPEND11 = (1U << 11);  ///< serial peripheral interface 1 interrupt clear-pending bit
        constexpr uint32_t CLRPEND12 = (1U << 12);  ///< UART0 status and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND13 = (1U << 13);  ///< UART1 status and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND14 = (1U << 14);  ///< UART2 status and error interrupt clear-pending bit
        constexpr uint32_t CLRPEND15 = (1U << 15);  ///< Analog-to-digital converter 0 interrupt clear-pending bit
        constexpr uint32_t CLRPEND16 = (1U << 16);  ///< Comparator 0 interrupt clear-pending bit
        ...
        constexpr uint32_t CLRPEND20 = (1U << 20);  ///< real time clock alarm interrupt clear-pending bit
        constexpr uint32_t CLRPEND21 = (1U << 21);  ///< real time clock seconds interrupt clear-pending bit
        constexpr uint32_t CLRPEND22 = (1U << 22);  ///< periodic interrupt timer all channels interrupt clear-pending bit
        constexpr uint32_t CLRPEND23 = (1U << 23);  ///< integrated interchip sound 0 interrupt clear-pending bit
        constexpr uint32_t CLRPEND24 = (1U << 24);  ///< universal serial bus on the go interrupt clear-pending bit
        constexpr uint32_t CLRPEND25 = (1U << 25);  ///< digital-to-analog converter 0 interrupt clear-pending bit
        constexpr uint32_t CLRPEND26 = (1U << 26);  ///< touch sensing input interrupt clear-pending bit
        constexpr uint32_t CLRPEND27 = (1U << 27);  ///< multipurpose clock generator interrupt clear-pending bit
        constexpr uint32_t CLRPEND28 = (1U << 28);  ///< Low-Power Timer interrupt clear-pending bit
        constexpr uint32_t CLRPEND29 = (1U << 29);  ///< Reserved iv 45 interrupt clear-pending bit
        constexpr uint32_t CLRPEND30 = (1U << 30);  ///< PORTA pin detect interrupt clear-pending bit
        constexpr uint32_t CLRPEND31 = (1U << 31);  ///< PORTC and PORTD pin detect interrupt clear-pending bit
    }

    /// NVIC_IPR0 Register bits
    namespace nvic_ipr0_bits {
        constexpr uint32_t PRI_0 = (8 << 0);  ///< Priority of the DMA channel 0 transfer complete and error interrupt
        constexpr uint32_t PRI_1 = (8 << 8);  ///< Priority of the DMA channel 1 transfer complete and error interrupt
        constexpr uint32_t PRI_2 = (8 << 16);  ///< Priority of the DMA channel 2 transfer complete and error interrupt
        constexpr uint32_t PRI_3 = (8 << 24);  ///< Priority of the DMA channel 3 transfer complete and error interrupt
    }

    /// NVIC_IPR1 Register bits
    namespace nvic_ipr1_bits {
        constexpr uint32_t PRI_4 = (8 << 0);  ///< Priority of the Reserved iv 20 interrupt
        constexpr uint32_t PRI_5 = (8 << 8);  ///< Priority of the FTFA command complete and read collision interrupt
        constexpr uint32_t PRI_6 = (8 << 16);  ///< Priority of the low-voltage detect and low-voltage warning interrupt
        constexpr uint32_t PRI_7 = (8 << 24);  ///< Priority of the low leakage wakeup interrupt
    }

    /// NVIC_IPR2 Register bits
    namespace nvic_ipr2_bits {
        constexpr uint32_t PRI_8 = (8 << 0);  ///< Priority of the inter-integrated circuit 0 interrupt
        constexpr uint32_t PRI_9 = (8 << 8);  ///< Priority of the inter-integrated circuit 1 interrupt
        constexpr uint32_t PRI_10 = (8 << 16);  ///< Priority of the serial peripheral interface 0 interrupt
        constexpr uint32_t PRI_11 = (8 << 24);  ///< Priority of the serial peripheral interface 1 interrupt
    }

    /// NVIC_IPR3 Register bits
    namespace nvic_ipr3_bits {
        constexpr uint32_t PRI_12 = (8 << 0);  ///< Priority of the UART0 status and error interrupt
        constexpr uint32_t PRI_13 = (8 << 8);  ///< Priority of the UART1 status and error interrupt
        constexpr uint32_t PRI_14 = (8 << 16);  ///< Priority of the UART2 status and error interrupt
        constexpr uint32_t PRI_15 = (8 << 24);  ///< Priority of the Analog-to-digital converter 0 interrupt
    }

    /// NVIC_IPR4 Register bits
    namespace nvic_ipr4_bits {
        constexpr uint32_t PRI_16 = (8 << 0);  ///< Priority of the Comparator 0 interrupt
        constexpr uint32_t PRI_17 = (8 << 8);  ///< Priority of the Timer PWM module 0 interrupt
        constexpr uint32_t PRI_18 = (8 << 16);  ///< Priority of the Timer PWM module 1 interrupt
        constexpr uint32_t PRI_19 = (8 << 24);  ///< Priority of the Timer PWM module 2 interrupt
    }

    /// NVIC_IPR5 Register bits
    namespace nvic_ipr5_bits {
        constexpr uint32_t PRI_20 = (8 << 0);  ///< Priority of the real time clock alarm interrupt
        constexpr uint32_t PRI_21 = (8 << 8);  ///< Priority of the real time clock seconds interrupt
        constexpr uint32_t PRI_22 = (8 << 16);  ///< Priority of the periodic interrupt timer all channels interrupt
        constexpr uint32_t PRI_23 = (8 << 24);  ///< Priority of the integrated interchip sound 0 interrupt
    }

    /// NVIC_IPR6 Register bits
    namespace nvic_ipr6_bits {
        constexpr uint32_t PRI_24 = (8 << 0);  ///< Priority of the universal serial bus on the go interrupt
        constexpr uint32_t PRI_25 = (8 << 8);  ///< Priority of the digital-to-analog converter 0 interrupt
        constexpr uint32_t PRI_26 = (8 << 16);  ///< Priority of the touch sensing input interrupt
        constexpr uint32_t PRI_27 = (8 << 24);  ///< Priority of the multipurpose clock generator interrupt
    }

    /// NVIC_IPR7 Register bits
    namespace nvic_ipr7_bits {
        constexpr uint32_t PRI_28 = (8 << 0);  ///< Priority of the Low-Power Timer interrupt
        constexpr uint32_t PRI_29 = (8 << 8);  ///< Priority of the Reserved iv 45 interrupt
        constexpr uint32_t PRI_30 = (8 << 16);  ///< Priority of the PORTA pin detect interrupt
        constexpr uint32_t PRI_31 = (8 << 24);  ///< Priority of the PORTC and PORTD pin detect interrupt
    }
...
#endif // ALLOY_GENERATED_MKL26Z4_PERIPHERALS_HPP