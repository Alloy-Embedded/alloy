/// Auto-generated code for R7FA2L1AB
/// Generated by Alloy Code Generator
/// Source: renesas_r7fa2l1ab.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:09
#ifndef ALLOY_GENERATED_R7FA2L1AB_PERIPHERALS_HPP
#define ALLOY_GENERATED_R7FA2L1AB_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::r7fa2l1ab {
...
namespace sysc {
    ...
    struct Registers {
        ...
        volatile uint32_t DCDCCTL;  ///< Offset: 0x440 - DCDC/LDO Control Register
        volatile uint32_t VCCSEL;  ///< Offset: 0x441 - Voltage Level Selection Control Register
    ...
    /// DCDCCTL Register bits
    namespace dcdcctl_bits {
        constexpr uint32_t DCDCON = (1U << 0);  ///< LDO/DCDC on/off Control bit
        constexpr uint32_t OCPEN = (1U << 1);  ///< DCDC OCP Function Enable bit
        constexpr uint32_t STOPZA = (1U << 4);  ///< DCDC IO Buffer Power Control bit
        constexpr uint32_t LCBOOST = (1U << 5);  ///< LDO LCBOOST Mode Control bit
        constexpr uint32_t FST = (1U << 6);  ///< DCDC Fast Startup
        constexpr uint32_t PD = (1U << 7);  ///< DCDC VREF Generate Disable bit
    }

    /// VCCSEL Register bits
    namespace vccsel_bits {
        constexpr uint32_t VCCSEL = (2 << 0);  ///< DCDC Working Voltage Level Selection
    }
...
namespace pfs {
    ...
    struct Registers {
        ...
        volatile uint32_t P0PFS;  ///< Offset: 0x28 - Port 0%s Pin Function Select Register (renamed from P0PFS)
        volatile uint32_t P0PFS_HA;  ///< Offset: 0x2A - Port 0%s Pin Function Select Register (renamed from P0PFS_HA)
        volatile uint32_t P0PFS_BY;  ///< Offset: 0x2B - Port 0%s Pin Function Select Register (renamed from P0PFS_BY)
        ...
        volatile uint32_t P714PFS;  ///< Offset: 0x1F8 - Port 714 Pin Function Select Register
        volatile uint32_t P714PFS_HA;  ///< Offset: 0x1FA - Port 714 Pin Function Select Register
        volatile uint32_t P714PFS_BY;  ///< Offset: 0x1FB - Port 714 Pin Function Select Register
        volatile uint32_t P80PFS;  ///< Offset: 0x220 - Port 80%s Pin Function Select Register (renamed from P80PFS)
        volatile uint32_t P80PFS_HA;  ///< Offset: 0x222 - Port 80%s Pin Function Select Register (renamed from P80PFS_HA)
        volatile uint32_t P80PFS_BY;  ///< Offset: 0x223 - Port 80%s Pin Function Select Register (renamed from P80PFS_BY)
    ...
    /// P714PFS Register bits
    namespace p714pfs_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// P714PFS_HA Register bits
    namespace p714pfs_ha_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// P714PFS_BY Register bits
    namespace p714pfs_by_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t ADDR;  ///< Offset: 0x42 - A/D Data Registers %s (renamed from ADDR)
        ...
        volatile uint32_t ADSSTR;  ///< Offset: 0xE0 - A/D Sampling State Register (renamed from ADSSTR)
    };
...
namespace dac {
    ...
    namespace davrefcr_bits {
        constexpr uint32_t REF = (1U << 0);  ///< D/A Reference Voltage Select
    }
...
namespace ctsu {
    ...
    namespace ctsuchaca_bits {
        ...
        constexpr uint32_t CHAC29 = (1U << 29);  ///< CTSU Channel Enable Control A
    ...
    namespace ctsuchacb_bits {
        ...
        constexpr uint32_t CHAC35 = (1U << 3);  ///< CTSU Channel Enable Control B
    }
    ...
    namespace ctsuchtrca_bits {
        ...
        constexpr uint32_t CHTRC29 = (1U << 29);  ///< CTSU Channel Transmit/Receive Control A
    ...
    namespace ctsuchtrcb_bits {
        ...
        constexpr uint32_t CHTRC35 = (1U << 3);  ///< CTSU Channel Transmit/Receive Control B
    }
...
#endif // ALLOY_GENERATED_R7FA2L1AB_PERIPHERALS_HPP