/// Auto-generated code for R7FA4M1AB
/// Generated by Alloy Code Generator
/// Source: renesas_r7fa4m1ab.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:30
#ifndef ALLOY_GENERATED_R7FA4M1AB_PERIPHERALS_HPP
#define ALLOY_GENERATED_R7FA4M1AB_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::r7fa4m1ab {
...
namespace traits {
    ...
    constexpr bool has_slcdc = true;
    constexpr uint32_t num_slcdc_instances = 1;
    ...
    template<>
    struct peripheral_count<struct slcdc_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace system {
    ...
    namespace vbtoctlr_bits {
        ...
        constexpr uint32_t VOUT1LSEL = (1U << 4);  ///< VBATT Wakeup I/O 1 Output Level Selection
    ...
    namespace sckscr_bits {
        constexpr uint32_t Reserved = (5 << 3);  ///< These bits are read as 00000. The write value should be 00000.
        constexpr uint32_t CKSEL = (3 << 0);  ///< Clock Source Select Selecting the system clock source faster than 32MHz(system clock source > 32MHz ) is prohibit when SCKDIVCR.ICK[2:0] bits select the division-by-1 and MEMWAIT.MEMWAIT =0.
    }
    ...
    namespace memwait_bits {
        constexpr uint32_t Reserved = (7 << 1);  ///< These bits are read as 0000000. The write value should be 0000000.
        constexpr uint32_t MEMWAIT = (1U << 0);  ///< Memory Wait Cycle Select Note: Writing 0 to the MEMWAIT is prohibited when SCKDIVCR.ICK selects division by 1 and SCKSCR.CKSEL[2:0] bits select the system clock source that is faster than 32 MHz (ICLK > 32 MHz).
    }

    /// MOSCCR Register bits
    namespace mosccr_bits {
        constexpr uint32_t Reserved = (7 << 1);  ///< These bits are read as 0000000. The write value should be 0000000.
        constexpr uint32_t MOSTP = (1U << 0);  ///< Main Clock Oscillator Stop Note: MOMCR register must be set before setting MOSTP to 0.
    }
    ...
    namespace oscsf_bits {
        ...
        constexpr uint32_t HOCOSF = (1U << 0);  ///< HOCO Clock Oscillation Stabilization Flag NOTE: The HOCOSF bit value after a reset is 1 when the OFS1.HOCOEN bit is 0. It is 0 when the OFS1.HOCOEN bit is 1.
    }
    ...
    namespace mocoutcr_bits {
        constexpr uint32_t MOCOUTRM = (8 << 0);  ///< MOCO User Trimming 1000_0000 : -128 1000_0001 : -127 1000_0010 : -126 . . . 1111_1111 : -1 0000_0000 : Center Code 0000_0001 : +1 . . . 0111_1101 : +125 0111_1110 : +126 0111_1111 : +127 These bits are added to original MOCO trimming bits
    }

    /// HOCOUTCR Register bits
    namespace hocoutcr_bits {
        constexpr uint32_t HOCOUTRM = (8 << 0);  ///< HOCO User Trimming 1000_0000 : -128 1000_0001 : -127 1000_0010 : -126 . . . 1111_1111 : -1 0000_0000 : Center Code 0000_0001 : +1 . . . 0111_1101 : +125 0111_1110 : +126 0111_1111 : +127 These bits are added to original HOCO trimming bits
    }
    ...
    namespace usbckcr_bits {
        constexpr uint32_t Reserved = (7 << 1);  ///< These bits are read as 0000000. The write value should be 0000000.
        constexpr uint32_t USBCLKSEL = (1U << 0);  ///< USB Clock Source Select
    }
    ...
    namespace locoutcr_bits {
        constexpr uint32_t LOCOUTRM = (8 << 0);  ///< LOCO User Trimming 1000_0000 : -128 1000_0001 : -127 1000_0010 : -126 . . . 1111_1111 : -1 0000_0000 : Center Code 0000_0001 : +1 . . . 0111_1101 : +125 0111_1110 : +126 0111_1111 : +127 These bits are added to original LOCO trimming bits
    }
    ...
    namespace snzreqcr_bits {
        constexpr uint32_t Reserved = (1U << 13);  ///< This bit is read as 0. The write value should be 0.
        constexpr uint32_t SNZREQEN30 = (1U << 30);  ///< Snooze Request Enable 30 Enable AGT1 compare match B snooze request
        constexpr uint32_t SNZREQEN29 = (1U << 29);  ///< Snooze Request Enable 29 Enable AGT1 compare match A snooze request
        constexpr uint32_t SNZREQEN28 = (1U << 28);  ///< Snooze Request Enable 28 Enable AGT1 underflow snooze request
        constexpr uint32_t SNZREQEN25 = (1U << 25);  ///< Snooze Request Enable 25 Enable RTC period snooze request
        constexpr uint32_t SNZREQEN24 = (1U << 24);  ///< Snooze Request Enable 24 Enable RTC alarm snooze request
        constexpr uint32_t SNZREQEN23 = (1U << 23);  ///< Snooze Request Enable 23 Enable RTC alarm snooze request
        constexpr uint32_t SNZREQEN17 = (1U << 17);  ///< Snooze Request Enable 17 Enable KINT snooze request
        constexpr uint32_t SNZREQEN15 = (1U << 15);  ///< Snooze Request Enable 15 Enable IRQ15 pin snooze request
        constexpr uint32_t SNZREQEN14 = (1U << 14);  ///< Snooze Request Enable 14 Enable IRQ14 pin snooze request
        constexpr uint32_t SNZREQEN12 = (1U << 12);  ///< Snooze Request Enable 12 Enable IRQ12 pin snooze request
        constexpr uint32_t SNZREQEN11 = (1U << 11);  ///< Snooze Request Enable 11 Enable IRQ11 pin snooze request
        constexpr uint32_t SNZREQEN10 = (1U << 10);  ///< Snooze Request Enable 10 Enable IRQ10 pin snooze request
        constexpr uint32_t SNZREQEN9 = (1U << 9);  ///< Snooze Request Enable 9 Enable IRQ9 pin snooze request
        constexpr uint32_t SNZREQEN8 = (1U << 8);  ///< Snooze Request Enable 8 Enable IRQ8 pin snooze request
        constexpr uint32_t SNZREQEN7 = (1U << 7);  ///< Snooze Request Enable 7 Enable IRQ7 pin snooze request
        constexpr uint32_t SNZREQEN6 = (1U << 6);  ///< Snooze Request Enable 6 Enable IRQ6 pin snooze request
        constexpr uint32_t SNZREQEN5 = (1U << 5);  ///< Snooze Request Enable 5 Enable IRQ5 pin snooze request
        constexpr uint32_t SNZREQEN4 = (1U << 4);  ///< Snooze Request Enable 4 Enable IRQ4 pin snooze request
        constexpr uint32_t SNZREQEN3 = (1U << 3);  ///< Snooze Request Enable 3 Enable IRQ3 pin snooze request
        constexpr uint32_t SNZREQEN2 = (1U << 2);  ///< Snooze Request Enable 2 Enable IRQ2 pin snooze request
        constexpr uint32_t SNZREQEN1 = (1U << 1);  ///< Snooze Request Enable 1 Enable IRQ1 pin snooze request
        constexpr uint32_t SNZREQEN0 = (1U << 0);  ///< Snooze Request Enable 0 Enable IRQ0 pin snooze request
    }
    ...
    namespace rstsr0_bits {
        constexpr uint32_t Reserved = (4 << 4);  ///< These bits are read as 0000. The write value should be 0000.
        constexpr uint32_t LVD2RF = (1U << 3);  ///< Voltage Monitor 2 Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written with 0 after the reset flag is read as 1.
        constexpr uint32_t LVD1RF = (1U << 2);  ///< Voltage Monitor 1 Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written with 0 after the reset flag is read as 1.
        constexpr uint32_t LVD0RF = (1U << 1);  ///< Voltage Monitor 0 Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written with 0 after the reset flag is read as 1.
        constexpr uint32_t PORF = (1U << 0);  ///< Power-On Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written with 0 after the reset flag is read as 1.
    }

    /// RSTSR2 Register bits
    namespace rstsr2_bits {
        constexpr uint32_t Reserved = (7 << 1);  ///< These bits are read as 0000000. The write value should be 0000000.
        constexpr uint32_t CWSF = (1U << 0);  ///< Cold/Warm Start Determination Flag Note: Only 1 can be written to set the flag.
    }

    /// RSTSR1 Register bits
    namespace rstsr1_bits {
        constexpr uint32_t Reserved = (5 << 3);  ///< These bits are read as 00000. The write value should be 00000.
        constexpr uint32_t SPERF = (1U << 12);  ///< SP Error Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t BUSMRF = (1U << 11);  ///< Bus Master MPU Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t BUSSRF = (1U << 10);  ///< Bus Slave MPU Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t REERF = (1U << 9);  ///< RAM ECC Error Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t RPERF = (1U << 8);  ///< RAM Parity Error Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t SWRF = (1U << 2);  ///< Software Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t WDTRF = (1U << 1);  ///< Watchdog Timer Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
        constexpr uint32_t IWDTRF = (1U << 0);  ///< Independent Watchdog Timer Reset Detect Flag Note: Only 0 can be written to clear the flag. The reset flag must be written as 0 after the reset flag is read as 1.
    }
...
namespace can {
    ...
    namespace mb_d1_bits {
        constexpr uint32_t DATA1 = (8 << 0);  ///< Data Bytes 1 DATA1 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_D2 Register bits
    namespace mb_d2_bits {
        constexpr uint32_t DATA2 = (8 << 0);  ///< Data Bytes 2 DATA2 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_D3 Register bits
    namespace mb_d3_bits {
        constexpr uint32_t DATA3 = (8 << 0);  ///< Data Bytes 3 DATA3 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_D4 Register bits
    namespace mb_d4_bits {
        constexpr uint32_t DATA4 = (8 << 0);  ///< Data Bytes 4 DATA4 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_D5 Register bits
    namespace mb_d5_bits {
        constexpr uint32_t DATA5 = (8 << 0);  ///< Data Bytes 5 DATA5 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_D6 Register bits
    namespace mb_d6_bits {
        constexpr uint32_t DATA6 = (8 << 0);  ///< Data Bytes 6 DATA6 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_D7 Register bits
    namespace mb_d7_bits {
        constexpr uint32_t DATA7 = (8 << 0);  ///< Data Bytes 7 DATA7 store the transmitted or received CAN message data. Transmission or reception starts from DATA0. The bit order on the CAN bus is MSB first, and transmission or reception starts from bit 7.
    }

    /// MB_TS Register bits
    namespace mb_ts_bits {
        constexpr uint32_t TSH = (8 << 8);  ///< Time Stamp Lower Byte Bits TSH[7:0] store the counter value of the time stamp when received messages are stored in the mailbox.
        constexpr uint32_t TSL = (8 << 0);  ///< Time Stamp Higher Byte Bits TSL[7:0] store the counter value of the time stamp when received messages are stored in the mailbox.
    }
    ...
    /// RECR Register bits
    namespace recr_bits {
        constexpr uint32_t RECR = (8 << 0);  ///< Receive error count function RECR increments or decrements the counter value according to the error status of the CAN module during reception.
    }

    /// TECR Register bits
    namespace tecr_bits {
        constexpr uint32_t TECR = (8 << 0);  ///< Transmit error count function TECR increments or decrements the counter value according to the error status of the CAN module during transmission.
    }
...
namespace crc {
    ...
    namespace crcsar_bits {
        constexpr uint32_t Reserved = (2 << 14);  ///< These bits are read as 00. The write value should be 00.
        constexpr uint32_t CRCSA = (14 << 0);  ///< snoop address bit Set the I/O register address to snoop
    }
...
namespace ctsu {
    ...
    namespace ctsusdprs_bits {
        ...
        constexpr uint32_t CTSUPRRATIO = (4 << 0);  ///< CTSU Measurement Time and Pulse Count Adjustment Recommended setting: 3 (0011b)
    }

    /// CTSUSST Register bits
    namespace ctsusst_bits {
        constexpr uint32_t CTSUSST = (8 << 0);  ///< CTSU Sensor Stabilization Wait Control NOTE: The value of these bits should be fixed to 00010000b.
    }
    ...
    namespace ctsumch1_bits {
        constexpr uint32_t Reserved = (2 << 6);  ///< These bits are read as 00. The write value should be 00.
        constexpr uint32_t CTSUMCH1 = (6 << 0);  ///< CTSU Measurement Channel 1 Note1: If the value of CTSUMCH1 was set to b'111111, the measurement is stopped.
    }

    /// CTSUCHAC0 Register bits
    namespace ctsuchac0_bits {
        constexpr uint32_t CTSUCHAC0 = (8 << 0);  ///< CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: CTSUCHAC0[0] corresponds to TS00 and CTSUCHAC0[7] corresponds to TS07. but the write value of CTSUCHAC0[2] should be 0.
    }

    /// CTSUCHAC1 Register bits
    namespace ctsuchac1_bits {
        constexpr uint32_t CTSUCHAC1 = (8 << 0);  ///< CTSU Channel Enable Control 1. 0: Not measurement target 1: Measurement target Note: CTSUCHAC1[0] corresponds to TS08 and CTSUCHAC1[7] corresponds to TS15.
    }

    /// CTSUCHAC2 Register bits
    namespace ctsuchac2_bits {
        constexpr uint32_t CTSUCHAC2 = (8 << 0);  ///< CTSU Channel Enable Control 2. 0: Not measurement target 1: Measurement target Note: CTSUCHAC2[0] corresponds to TS16 and CTSUCHAC2[7] corresponds to TS23.
    }

    /// CTSUCHAC3 Register bits
    namespace ctsuchac3_bits {
        constexpr uint32_t CTSUCHAC3 = (8 << 0);  ///< CTSU Channel Enable Control 3. 0: Not measurement target 1: Measurement target Note: CTSUCHAC3[0] corresponds to TS24 and CTSUCHAC3[7] corresponds to TS31.
    }

    /// CTSUCHAC4 Register bits
    namespace ctsuchac4_bits {
        constexpr uint32_t Reserved = (4 << 4);  ///< These bits are read as 0000. The write value should be 0000.
        constexpr uint32_t CTSUCHAC4 = (4 << 0);  ///< CTSU Channel Enable Control 4. 0: Not measurement target 1: Measurement target Note: CTSUCHAC4[0] corresponds to TS32 and CTSUCHAC4[3] corresponds to TS35. but the write value of CTSUCHAC0[4],CTSUCHAC4[5],CTSUCHAC4[6],CTSUCHAC4[7] should be 0.
    }
    ...
    namespace ctsudclkc_bits {
        constexpr uint32_t Reserved = (2 << 2);  ///< These bits are read as 00. The write value should be 00.
        constexpr uint32_t CTSUSSCNT = (2 << 4);  ///< CTSU Diffusion Clock Mode Control NOTE: This bit should be set to 11b.
        constexpr uint32_t CTSUSSMOD = (2 << 0);  ///< CTSU Diffusion Clock Mode Select NOTE: This bit should be set to 00b.
    }
    ...
    namespace ctsuso0_bits {
        ...
        constexpr uint32_t CTSUSO = (10 << 0);  ///< CTSU Sensor Offset Adjustment Current offset amount is CTSUSO ( 0 to 1023 )
    }
    ...
    namespace ctsuso1_bits {
        ...
        constexpr uint32_t CTSUSDPA = (5 << 8);  ///< CTSU Base Clock Setting Operating clock divided by ( CTSUSDPA + 1 ) x 2
        constexpr uint32_t CTSURICOA = (8 << 0);  ///< CTSU Reference ICO Current Adjustment Current offset amount is CTSUSO ( 0 to 255 )
    }

    /// CTSUSC Register bits
    namespace ctsusc_bits {
        constexpr uint32_t CTSUSC = (16 << 0);  ///< CTSU Sensor Counter These bits indicate the measurement result of the CTSU. These bits indicate FFFFh when an overflow occurs.
    }

    /// CTSURC Register bits
    namespace ctsurc_bits {
        constexpr uint32_t CTSURC = (16 << 0);  ///< CTSU Reference Counter These bits indicate the measurement result of the reference ICO. These bits indicate FFFFh when an overflow occurs.
    }
...
namespace dac {
    ...
    namespace dadr0_bits {
        constexpr uint32_t DADR = (16 << 0);  ///< D/A Data Register NOTE: When DADPR.DPSEL = 0, the high-order 4 bits are fixed to 0: right justified format. When DADPR.DPSEL = 1, the low-order 4 bits are fixed to 0: left justified format.
    }
...
namespace doc {
    ...
    namespace docr_bits {
        ...
        constexpr uint32_t DOPCF = (1U << 5);  ///< Data Operation Circuit Flag Indicates the result of an operation.
...
namespace dtc {
    ...
    namespace dtcsts_bits {
        ...
        constexpr uint32_t VECN = (8 << 0);  ///< DTC-Activating Vector Number Monitoring These bits indicate the vector number for the activating source when DTC transfer is in progress. The value is only valid if DTC transfer is in progress (the value of the ACT flag is 1)
    }
...
namespace gpio {
    ...
    namespace pcntr2_bits {
        constexpr uint32_t Reserved = (16 << 16);  ///< These bits are read as 0000000000000000.
...
namespace pfs {
    ...
    struct Registers {
        volatile uint32_t P000PFS;  ///< Offset: 0x00 - P00%s Pin Function Control Register
        volatile uint32_t P000PFS_HA;  ///< Offset: 0x02 - P00%s Pin Function Control Register
        volatile uint32_t P000PFS_BY;  ///< Offset: 0x03 - P00%s Pin Function Control Register
        ...
        volatile uint32_t P0PFS;  ///< Offset: 0x28 - P0%s Pin Function Control Register (renamed from P0PFS)
        volatile uint32_t P0PFS_HA;  ///< Offset: 0x2A - P0%s Pin Function Control Register (renamed from P0PFS_HA)
        volatile uint32_t P0PFS_BY;  ///< Offset: 0x2B - P0%s Pin Function Control Register (renamed from P0PFS_BY)
        volatile uint32_t P10PFS;  ///< Offset: 0x40 - P10%s Pin Function Control Register (renamed from P10PFS)
        volatile uint32_t P10PFS_HA;  ///< Offset: 0x42 - P10%s Pin Function Control Register (renamed from P10PFS_HA)
        volatile uint32_t P10PFS_BY;  ///< Offset: 0x43 - P10%s Pin Function Control Register (renamed from P10PFS_BY)
        ...
        volatile uint32_t P80PFS;  ///< Offset: 0x220 - P80%s Pin Function Control Register (renamed from P80PFS)
        volatile uint32_t P80PFS_HA;  ///< Offset: 0x222 - P80%s Pin Function Control Register (renamed from P80PFS_HA)
        volatile uint32_t P80PFS_BY;  ///< Offset: 0x223 - P80%s Pin Function Control Register (renamed from P80PFS_BY)
        volatile uint32_t P9PFS;  ///< Offset: 0x278 - P9%s Pin Function Control Register (renamed from P9PFS)
        volatile uint32_t P9PFS_HA;  ///< Offset: 0x27A - P9%s Pin Function Control Register (renamed from P9PFS_HA)
        volatile uint32_t P9PFS_BY;  ///< Offset: 0x27B - P9%s Pin Function Control Register (renamed from P9PFS_BY)
    };
...
namespace icu {
    ...
    struct Registers {
        volatile uint32_t IRQCR;  ///< Offset: 0x0E - IRQ Control Register %s (renamed from IRQCR)
    ...
    namespace ielsr_bits {
        ...
        constexpr uint32_t IELS = (8 << 0);  ///< ICU Event selection to NVIC Set the number for the event signal to be linked .
    }
...
namespace wdg {
    ...
    namespace iwdtsr_bits {
        ...
        constexpr uint32_t CNTVAL = (14 << 0);  ///< Counter Value Value counted by the counter
    }
...
namespace mstp {
    ...
    namespace mstpcrc_bits {
        constexpr uint32_t MSTPC31 = (1U << 31);  ///< SCE5 Module Stop
...
namespace mmpu {
    ...
    namespace mmpuctla_bits {
        constexpr uint32_t KEY = (8 << 8);  ///< Key Code These bits are used to enable or disable writing of the OAD and ENABLE bit.
        constexpr uint32_t Reserved = (6 << 2);  ///< These bits are read as 000000. The write value should be 000000.
    ...
    namespace mmpuea_bits {
        constexpr uint32_t MMPUEA = (32 << 0);  ///< Region end address register Address where the region end, for use in region determination. NOTE: The low-order 2 bits are fixed to 1.
    }
...
namespace spmon {
    ...
    namespace pspmpuoad_bits {
        constexpr uint32_t KEY = (8 << 8);  ///< Key Code The data written to these bits are not stored.
        constexpr uint32_t Reserved = (7 << 1);  ///< These bits are read as 0000000. The write value should be 0000000.
        constexpr uint32_t OAD = (1U << 0);  ///< Operation after detection
    }
...
namespace poeg {
    ...
    namespace poegg_bits {
        ...
        constexpr uint32_t OSTPE = (1U << 6);  ///< Oscillation Stop Detection Enable Note: Can be modified only once after a reset.
        constexpr uint32_t IOCE = (1U << 5);  ///< Output-disable Request Enable from GPT Note: Can be modified only once after a reset.
        constexpr uint32_t PIDE = (1U << 4);  ///< Port Input Detection Enable Note: Can be modified only once after a reset.
...
namespace sci0 {
    ...
    namespace ssr_smci_bits {
        ...
        constexpr uint32_t PER = (1U << 3);  ///< Parity Error Flag
        constexpr uint32_t TEND = (1U << 2);  ///< Transmit End Flag
        constexpr uint32_t MPB = (1U << 1);  ///< Multi-Processor This bit should be 0 in smart card interface mode.
        constexpr uint32_t MPBT = (1U << 0);  ///< Multi-Processor Bit Transfer This bit should be 0 in smart card interface mode.
    }
    ...
    namespace simr1_bits {
        constexpr uint32_t IICDL = (5 << 3);  ///< SDA Delay Output Select Cycles below are of the clock signal from the on-chip baud rate generator.
...
namespace slcdc {
    ...
    struct Registers {
        ...
        volatile uint32_t SEG;  ///< Offset: 0x100 - LCD Display Data Register %s (renamed from SEG)
    };
...
namespace ssie0 {
    ...
    struct Registers {
        ...
        volatile uint32_t SSITDMR;  ///< Offset: 0x20 - TDM Mode Register
    ...
    namespace ssisr_bits {
        constexpr uint32_t Reserved = (25 << 0);  ///< These bits are read as 0000000000000000000000000. The write value should be 0000000000000000000000000.
    ...
    namespace ssifcr_bits {
        ...
        constexpr uint32_t Reserved = (7 << 4);  ///< These bits are read as 0000000. The write value should be 0000000.
    ...
    namespace ssifsr_bits {
        constexpr uint32_t Reserved = (7 << 1);  ///< These bits are read as 0000000. The write value should be 0000000.
        constexpr uint32_t TDC = (4 << 24);  ///< Number of Transmit FIFO Data Indication Flag Number of transmit FIFO data indication flag.
        constexpr uint32_t TDE = (1U << 16);  ///< Transmit Data Empty Flag
        constexpr uint32_t RDC = (4 << 8);  ///< Number of Receive FIFO Data Indication Flag Number of receive FIFO data indication flag.
    ...
    /// SSITDMR Register bits
    namespace ssitdmr_bits {
        constexpr uint32_t Reserved = (6 << 2);  ///< These bits are read as 000000. The write value should be 000000.
    ...
    namespace ssiscr_bits {
        constexpr uint32_t Reserved = (5 << 3);  ///< These bits are read as 00000. The write value should be 00000.
        constexpr uint32_t TDES = (3 << 8);  ///< TDE Setting Condition Select
        constexpr uint32_t RDFS = (3 << 0);  ///< RDF Setting Condition Select
    }
...
namespace tsn {
    ...
    namespace tscdrh_bits {
        constexpr uint32_t TSCDRH = (8 << 0);  ///< The calibration data stores the higher 8 bits of the converted value.
    }

    /// TSCDRL Register bits
    namespace tscdrl_bits {
        constexpr uint32_t TSCDRL = (8 << 0);  ///< The calibration data stores the lower 8 bits of the converted value.
    }
...
namespace usb {
    ...
    namespace syssts0_bits {
        constexpr uint32_t OVCMON = (2 << 14);  ///< External USB0_OVRCURA/ USB0_OVRCURB Input Pin Monitor The OCVMON[1] bit indicates the status of the USBHS_OVRCURA pin. The OCVMON[0] bit indicates the status of the USBHS_OVRCURB pin.
    ...
    namespace cfifo_bits {
        constexpr uint32_t FIFOPORT = (16 << 0);  ///< FIFO Port Read receive data from the FIFO buffer or write transmit data to the FIFO buffer by accessing these bits.
    }
    ...
    namespace cfifoctr_bits {
        ...
        constexpr uint32_t BCLR = (1U << 14);  ///< CPU Buffer Clear Note: Only 0 can be read.
        ...
        constexpr uint32_t DTLN = (9 << 0);  ///< Receive Data Length Indicates the length of the receive data.
    }

    /// D0FIFOSEL Register bits
    namespace d0fifosel_bits {
        constexpr uint32_t RCNT = (1U << 15);  ///< Read Count Mode
        constexpr uint32_t REW = (1U << 14);  ///< Buffer Pointer Rewind Note: Only 0 can be read.
    ...
    namespace frmnum_bits {
        ...
        constexpr uint32_t FRNM = (11 << 0);  ///< Frame Number Latest frame number
    }

    /// USBREQ Register bits
    namespace usbreq_bits {
        constexpr uint32_t BREQUEST = (8 << 8);  ///< Request These bits store the USB request bRequest value.
        constexpr uint32_t BMREQUESTTYPE = (8 << 0);  ///< Request Type These bits store the USB request bmRequestType value.
    }

    /// USBVAL Register bits
    namespace usbval_bits {
        constexpr uint32_t WVALUE = (16 << 0);  ///< Value These bits store the USB request Value value.
    }

    /// USBINDX Register bits
    namespace usbindx_bits {
        constexpr uint32_t WINDEX = (16 << 0);  ///< Index These bits store the USB request wIndex value.
    }

    /// USBLENG Register bits
    namespace usbleng_bits {
        constexpr uint32_t WLENTUH = (16 << 0);  ///< Length These bits store the USB request wLength value.
    }
    ...
    namespace dcpmaxp_bits {
        ...
        constexpr uint32_t MXPS = (7 << 0);  ///< Maximum Packet Size These bits set the maximum amount of data (maximum packet size) in payloads for the DCP.
    }
    ...
    namespace pipecfg_bits {
        ...
        constexpr uint32_t SHTNAK = (1U << 7);  ///< Pipe Disabled at End of Transfer
        constexpr uint32_t DIR = (1U << 4);  ///< Transfer Direction
        constexpr uint32_t EPNUM = (4 << 0);  ///< Endpoint Number These bits specify the endpoint number for the selected pipe. Setting 0000b means unused pipe.
    }
    ...
    namespace pipemaxp_bits {
        ...
        constexpr uint32_t MXPS = (9 << 0);  ///< Maximum Packet Size PIPE1 and PIPE2: 1 byte (001h) to 256 bytes (100h) PIPE3 to PIPE5: 8 bytes (008h), 16 bytes (010h), 32 bytes (020h), 64 bytes (040h) (Bits [8:7] and [2:0] are not provided.) PIPE6 to PIPE9: 1 byte (001h) to 64 bytes (040h) (Bits [8:7] are not provided.)
    }
    ...
    namespace pipeperi_bits {
        ...
        constexpr uint32_t IITV = (3 << 0);  ///< Interval Error Detection Interval Specifies the interval error detection timing for the selected pipe in terms of frames, which is expressed as nth power of 2.
    }
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t ADSSTR;  ///< Offset: 0xE0 - A/D Sampling State Register %s (renamed from ADSSTR)
    };
...
namespace agt0 {
    ...
    /// AGT Register bits
    namespace agt_bits {
        constexpr uint32_t AGT = (16 << 0);  ///< 16bit counter and reload register NOTE : When 1 is written to the TSTOP bit in the AGTCRn register, the 16-bit counter is forcibly stopped and set to FFFFH.
    }
    ...
    namespace agtioc_bits {
        ...
        constexpr uint32_t TEDGSEL = (1U << 0);  ///< I/O polarity switch Function varies depending on the operating mode.
    }
...
namespace gpt320 {
    ...
    namespace gtstr_bits {
        constexpr uint32_t Reserved = (24 << 8);  ///< These bits are read as 000000000000000000000000. The write value should be 000000000000000000000000.
    ...
    namespace gtstp_bits {
        constexpr uint32_t Reserved = (24 << 8);  ///< These bits are read as 111111111111111111111111. The write value should be 111111111111111111111111.
    ...
    namespace gtclr_bits {
        constexpr uint32_t Reserved = (24 << 8);  ///< The write value should be 000000000000000000000000.
    ...
    namespace gtber_bits {
        ...
        constexpr uint32_t BD = (2 << 0);  ///< BD[1]: GTPR Buffer Operation Disable BD[0]: GTCCR Buffer Operation Disable
    }
...
namespace gpt {
    ...
    namespace opscr_bits {
        constexpr uint32_t NFCS = (2 << 30);  ///< External Input Noise Filter Clock selection Noise filter sampling clock setting of the external input.
        ...
        constexpr uint32_t FB = (1U << 16);  ///< External Feedback Signal Enable This bit selects the input phase from the software settings and external input.
        constexpr uint32_t EN = (1U << 8);  ///< Enable-Phase Output Control
        constexpr uint32_t W = (1U << 6);  ///< Input W-Phase Monitor This bit monitors the state of the input phase. OPSCR.FB=0:External input monitoring by PCLK OPSCR.FB=1:Software settings (UF/VF/WF)
        constexpr uint32_t V = (1U << 5);  ///< Input V-Phase Monitor This bit monitors the state of the input phase. OPSCR.FB=0:External input monitoring by PCLK OPSCR.FB=1:Software settings (UF/VF/WF)
        constexpr uint32_t U = (1U << 4);  ///< Input U-Phase Monitor This bit monitors the state of the input phase. OPSCR.FB=0:External input monitoring by PCLK OPSCR.FB=1:Software settings (UF/VF/WF)
        constexpr uint32_t WF = (1U << 2);  ///< Input Phase Soft Setting UF This bit sets the input phase by the software settings. This bit setting is valid when the OPSCR.FB bit = 1.
        constexpr uint32_t VF = (1U << 1);  ///< Input Phase Soft Setting VF This bit sets the input phase by the software settings. This bit setting is valid when the OPSCR.FB bit = 1.
        constexpr uint32_t UF = (1U << 0);  ///< Input Phase Soft Setting WF This bit sets the input phase by the software settings. This bit setting is valid when the OPSCR.FB bit = 1.
    }
...
#endif // ALLOY_GENERATED_R7FA4M1AB_PERIPHERALS_HPP