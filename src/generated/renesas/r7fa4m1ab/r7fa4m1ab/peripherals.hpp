...
namespace bus {
    ...
    struct Registers {
        ...
        volatile uint32_t BUSSCNT%s;  ///< Offset: 0x1114 - Slave Bus Control Register %s
...
namespace pfs {
    ...
    struct Registers {
        ...
        volatile uint32_t P80%sPFS;  ///< Offset: 0x220 - P80%s Pin Function Control Register
        volatile uint32_t P80%sPFS_HA;  ///< Offset: 0x222 - P80%s Pin Function Control Register
        volatile uint32_t P80%sPFS_BY;  ///< Offset: 0x223 - P80%s Pin Function Control Register
...
namespace icu {
    ...
    struct Registers {
        volatile uint32_t IRQCR%s;  ///< Offset: 0x0E - IRQ Control Register %s
