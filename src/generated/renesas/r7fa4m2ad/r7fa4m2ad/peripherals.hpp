...
#ifndef ALLOY_GENERATED_R7FA4M2AD_PERIPHERALS_HPP
#define ALLOY_GENERATED_R7FA4M2AD_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::r7fa4m2ad {
...
namespace sysc {
    ...
    namespace dpfsar_bits {
        constexpr uint32_t DPFSA00 = (1U << 0);  ///< Deep Software Standby Interrupt Factor Security Attribute bit 0
        constexpr uint32_t DPFSA01 = (1U << 1);  ///< Deep Software Standby Interrupt Factor Security Attribute bit 1
        constexpr uint32_t DPFSA04 = (1U << 4);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA05 = (1U << 5);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA06 = (1U << 6);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA07 = (1U << 7);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA08 = (1U << 8);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA09 = (1U << 9);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA10 = (1U << 10);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA11 = (1U << 11);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA12 = (1U << 12);  ///< Deep Software Standby Interrupt Factor Security Attribute bit n (n = 4 to 12)
        constexpr uint32_t DPFSA14 = (1U << 14);  ///< Deep Software Standby Interrupt Factor Security Attribute bit 14
        constexpr uint32_t DPFSA15 = (1U << 15);  ///< Deep Software Standby Interrupt Factor Security Attribute bit 15
...
#endif // ALLOY_GENERATED_R7FA4M2AD_PERIPHERALS_HPP