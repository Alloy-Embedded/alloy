...
namespace pfs {
    ...
    struct Registers {
        ...
        volatile uint32_t P3PFS_HA;  ///< Offset: 0xEA - P3%s Pin Function Control Register (renamed from P3PFS_HA)
        volatile uint32_t P3PFS_BY;  ///< Offset: 0xEB - P3%s Pin Function Control Register (renamed from P3PFS_BY)
        ...
        volatile uint32_t P70PFS;  ///< Offset: 0x1E0 - P70%s Pin Function Control Register (renamed from P70PFS)
        volatile uint32_t P70PFS_HA;  ///< Offset: 0x1E2 - P70%s Pin Function Control Register (renamed from P70PFS_HA)
        volatile uint32_t P70PFS_BY;  ///< Offset: 0x1E3 - P70%s Pin Function Control Register (renamed from P70PFS_BY)
        volatile uint32_t P7PFS;  ///< Offset: 0x1E8 - P7%s Pin Function Control Register (renamed from P7PFS)
        volatile uint32_t P7PFS_HA;  ///< Offset: 0x1EA - P7%s Pin Function Control Register (renamed from P7PFS_HA)
        volatile uint32_t P7PFS_BY;  ///< Offset: 0x1EB - P7%s Pin Function Control Register (renamed from P7PFS_BY)
        ...
        volatile uint32_t P90PFS;  ///< Offset: 0x240 - P90%s Pin Function Control Register (renamed from P90PFS)
        volatile uint32_t P90PFS_HA;  ///< Offset: 0x242 - P90%s Pin Function Control Register (renamed from P90PFS_HA)
        volatile uint32_t P90PFS_BY;  ///< Offset: 0x243 - P90%s Pin Function Control Register (renamed from P90PFS_BY)
...
namespace dac {
    ...
    struct Registers {
        volatile uint32_t DACS;  ///< Offset: 0x00 - D/A Conversion Value Setting Register %s (renamed from DACS)
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t ADDR;  ///< Offset: 0x20 - A/D Data Register %s (renamed from ADDR)
