/// Auto-generated code for R7FA6M1AD
/// Generated by Alloy Code Generator
/// Source: renesas_r7fa6m1ad.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:01:02
#ifndef ALLOY_GENERATED_R7FA6M1AD_PERIPHERALS_HPP
#define ALLOY_GENERATED_R7FA6M1AD_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::r7fa6m1ad {
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t PHYSLEW;  ///< Offset: 0xF0 - PHY Cross Point Adjustment Register
    ...
    namespace dvstctr0_bits {
        ...
        constexpr uint32_t EXICEN = (1U << 10);  ///< USB0_EXICEN Output Pin Control
        constexpr uint32_t VBUSEN = (1U << 9);  ///< USB0_VBUSEN Output Pin Control
    ...
    namespace usbaddr_bits {
        ...
        constexpr uint32_t USBADDR = (7 << 0);  ///< USB AddressWhen the function controller is selected, these bits indicate the USB address assigned by the host when the SET_ADDRESS request is successfully processed.
    }
    ...
    /// PHYSLEW Register bits
    namespace physlew_bits {
        constexpr uint32_t SLEWF01 = (1U << 3);  ///< Receiver Cross Point Adjustment 01
        constexpr uint32_t SLEWF00 = (1U << 2);  ///< Receiver Cross Point Adjustment 00
        constexpr uint32_t SLEWR01 = (1U << 1);  ///< Receiver Cross Point Adjustment 01
        constexpr uint32_t SLEWR00 = (1U << 0);  ///< Receiver Cross Point Adjustment 00
    }

    /// DPUSR0R Register bits
    namespace dpusr0r_bits {
        constexpr uint32_t DVBSTS0 = (1U << 23);  ///< USB VBUS InputIndicates the VBUS input signal of the USB.
        constexpr uint32_t DOVCB0 = (1U << 21);  ///< USB OVRCURB InputIndicates the OVRCURB input signal of the USB.
        constexpr uint32_t DOVCA0 = (1U << 20);  ///< USB OVRCURA InputIndicates the OVRCURA input signal of the USB.
        constexpr uint32_t DM0 = (1U << 17);  ///< USB D-InputIndicates the D- input signal of the USB.
        constexpr uint32_t DP0 = (1U << 16);  ///< USB0 D+ InputIndicates the D+ input signal of the USB.
        ...
        constexpr uint32_t SRPC0 = (1U << 0);  ///< USB Single End Receiver Control
    }
...
namespace spi {
    ...
    struct Registers {
        volatile uint32_t SFMSMD;  ///< Offset: 0x00 - Transfer Mode Control Register
        volatile uint32_t SFMSSC;  ///< Offset: 0x04 - Chip Selection Control Register
        volatile uint32_t SFMSKC;  ///< Offset: 0x08 - Clock Control Register
        volatile uint32_t SFMSST;  ///< Offset: 0x0C - Status Register
        volatile uint32_t SFMCOM;  ///< Offset: 0x10 - Communication Port Register
        volatile uint32_t SFMCMD;  ///< Offset: 0x14 - Communication Mode Control Register
        volatile uint32_t SFMCST;  ///< Offset: 0x18 - Communication Status Register
        volatile uint32_t SFMSIC;  ///< Offset: 0x20 - Instruction Code Register
        volatile uint32_t SFMSAC;  ///< Offset: 0x24 - Address Mode Control Register
        volatile uint32_t SFMSDC;  ///< Offset: 0x28 - Dummy Cycle Control Register
        volatile uint32_t SFMSPC;  ///< Offset: 0x30 - SPI Protocol Control Register
        volatile uint32_t SFMPMD;  ///< Offset: 0x34 - Port Control Register
        volatile uint32_t SFMCNT1;  ///< Offset: 0x804 - External QSPI Address Register 1
    };
    ...
    // Bit definitions
    /// SFMSMD Register bits
    namespace sfmsmd_bits {
        constexpr uint32_t SFMCCE = (1U << 15);  ///< Read instruction code selection.
        constexpr uint32_t SFMOSW = (1U << 11);  ///< Setup time adjustment for serial transmission
        constexpr uint32_t SFMOHW = (1U << 10);  ///< Hold time adjustment for serial transmission
        constexpr uint32_t SFMOEX = (1U << 9);  ///< Extension of the I/O buffer output enable signal for the serial interface
        constexpr uint32_t SFMMD3 = (1U << 8);  ///< SPI mode selection. An initial value is determined by input to CFGMD3.
        constexpr uint32_t SFMPAE = (1U << 7);  ///< Selection of the function for stopping prefetch at locations other than on byte boundaries
        constexpr uint32_t SFMPFE = (1U << 6);  ///< Selection of the prefetch function
        constexpr uint32_t SFMSE = (2 << 4);  ///< Selection of the prefetch function
        constexpr uint32_t SFMRM = (3 << 0);  ///< Serial interface read mode selection
    }

    /// SFMSSC Register bits
    namespace sfmssc_bits {
        constexpr uint32_t SFMSLD = (1U << 5);  ///< QSSL signal output timing selection
        constexpr uint32_t SFMSHD = (1U << 4);  ///< QSSL signal release timing selection
        constexpr uint32_t SFMSW = (4 << 0);  ///< Selection of a minimum high-level width of the QSSL signal
    }

    /// SFMSKC Register bits
    namespace sfmskc_bits {
        constexpr uint32_t SFMDTY = (1U << 5);  ///< Selection of a duty ratio correction function for the SCK signal
        constexpr uint32_t SFMDV = (5 << 0);  ///< Serial interface reference cycle selection (* Pay attention to the irregularity.)NOTE: When PCLKA multiplied by an odd number is selected, the high-level width of the SCK signal is longer than the low-level width by 1 x PCLKA before duty ratio correction.
    }

    /// SFMSST Register bits
    namespace sfmsst_bits {
        constexpr uint32_t PFOFF = (1U << 7);  ///< Prefetch function operation state
        constexpr uint32_t PFFUL = (1U << 6);  ///< Prefetch buffer state
        constexpr uint32_t PFCNT = (5 << 0);  ///< Number of bytes of prefetched dataRange: 00000 - 10010 (No combination other than the above is available.)
    }

    /// SFMCOM Register bits
    namespace sfmcom_bits {
        constexpr uint32_t SFMD = (8 << 0);  ///< Port for direct communication with the SPI bus.Input/output to and from this port is converted to an SPI bus cycle. This port is accessible in the direct communication mode (DCOM=1) only.Access to this port is ignored in the ROM access mode.
    }

    /// SFMCMD Register bits
    namespace sfmcmd_bits {
        constexpr uint32_t DCOM = (1U << 0);  ///< Selection of a mode of communication with the SPI bus
    }

    /// SFMCST Register bits
    namespace sfmcst_bits {
        constexpr uint32_t EROMR = (1U << 7);  ///< Status of ROM access detection in the direct communication modeNOTE: Writing of 0 only is possible. Writing of 1 is ignored.
        constexpr uint32_t COMBSY = (1U << 0);  ///< SPI bus cycle completion state in direct communication
    }

    /// SFMSIC Register bits
    namespace sfmsic_bits {
        constexpr uint32_t SFMCIC = (8 << 0);  ///< Serial ROM instruction code to substitute
    }

    /// SFMSAC Register bits
    namespace sfmsac_bits {
        constexpr uint32_t SFM4BC = (1U << 4);  ///< Selection of a default instruction code, when Serial Interface address width is selected 4 bytes.
        constexpr uint32_t SFMAS = (2 << 0);  ///< Selection the number of address bits of the serial interface
    }

    /// SFMSDC Register bits
    namespace sfmsdc_bits {
        constexpr uint32_t SFMXD = (8 << 8);  ///< Mode data for serial ROM. (Control XIP mode)
        constexpr uint32_t SFMXEN = (1U << 7);  ///< XIP mode permission
        constexpr uint32_t SFMXST = (1U << 6);  ///< XIP mode status
        constexpr uint32_t SFMDN = (4 << 0);  ///< Selection of the number of dummy cycles of Fast Read instructions
    }

    /// SFMSPC Register bits
    namespace sfmspc_bits {
        constexpr uint32_t SFMSDE = (1U << 4);  ///< Selection of the minimum time of input output switch, when Dual SPI protocol or Quad SPI protocol is selected.
        constexpr uint32_t SFMSPI = (2 << 0);  ///< Selection of SPI protocolNOTE: Serial ROM's SPI protocol is required to be set by software separately.
    }

    /// SFMPMD Register bits
    namespace sfmpmd_bits {
        constexpr uint32_t SFMWPL = (1U << 2);  ///< Specify level of WP pin
    }

    /// SFMCNT1 Register bits
    namespace sfmcnt1_bits {
        constexpr uint32_t QSPI_EXT = (6 << 26);  ///< BANK Switching AddressWhen accessing from 0x6000_0000 to 0x63FF_FFFF, Addres bus is Set QSPI_EXT[5:0] to high-order 6bits of SHADDR[31:0]NOTE: Setting 6'h3F is prihibited.
    }
...
namespace system {
    ...
    namespace lvd%scr1_bits {
        constexpr uint32_t IRQSEL = (1U << 2);  ///< Voltage Monitor %s Interrupt Type Select
        constexpr uint32_t IDTSEL = (2 << 0);  ///< Voltage Monitor %s Interrupt Generation Condition Select
    }

    /// LVD%sSR Register bits
    namespace lvd%ssr_bits {
        constexpr uint32_t MON = (1U << 1);  ///< Voltage Monitor %s Signal Monitor Flag
        constexpr uint32_t DET = (1U << 0);  ///< Voltage Monitor %s Voltage Change Detection Flag NOTE: Only 0 can be written to this bit. After writing 0 to this bit, it takes 2 system clock cycles for the bit to be read as 0.
    }
    ...
    namespace lvd%scr0_bits {
        constexpr uint32_t RN = (1U << 7);  ///< Voltage Monitor %s Reset Negate Select
        constexpr uint32_t RI = (1U << 6);  ///< Voltage Monitor %s Circuit Mode Select
        constexpr uint32_t FSAMP = (2 << 4);  ///< Sampling Clock Select
        constexpr uint32_t CMPE = (1U << 2);  ///< Voltage Monitor %s Circuit Comparison Result Output Enable
        constexpr uint32_t DFDIS = (1U << 1);  ///< Voltage Monitor %s Digital Filter Disable Mode Select
        constexpr uint32_t RIE = (1U << 0);  ///< Voltage Monitor %s Interrupt/Reset Enable
    }
...
namespace bus {
    ...
    struct Registers {
        ...
        volatile uint32_t CS%sCR;  ///< Offset: 0x842 - CS%s Control Register
        volatile uint32_t CS%sREC;  ///< Offset: 0x84A - CS%s Recovery Cycle Register
        volatile uint32_t CSRECEN;  ///< Offset: 0x880 - CS Recovery Cycle Insertion Enable Register
        volatile uint32_t CS%sMOD;  ///< Offset: 0x42 - CS%s Mode Register
        volatile uint32_t CS%sWCR1;  ///< Offset: 0x44 - CS%s Wait Control Register 1
        volatile uint32_t CS%sWCR2;  ///< Offset: 0x48 - CS%s Wait Control Register 2
...
namespace pfs {
    ...
    struct Registers {
        ...
        volatile uint32_t P20%sPFS;  ///< Offset: 0x94 - P20%s Pin Function Control Register
        volatile uint32_t P20%sPFS_HA;  ///< Offset: 0x96 - P20%s Pin Function Control Register
        volatile uint32_t P20%sPFS_BY;  ///< Offset: 0x97 - P20%s Pin Function Control Register
...
namespace sdhi0 {
    ...
    namespace sd_cmd_bits {
        ...
        constexpr uint32_t RSPTP = (3 << 8);  ///< Mode/Response Type NOTE: As some commands cannot be used in normal mode, see section 1.4.10, Example of SD_CMD Register Setting to select mode/response type.
        constexpr uint32_t ACMD = (2 << 6);  ///< Command Type Select
        constexpr uint32_t CMDIDX = (6 << 0);  ///< Command Index These bits specify Command Format[45:40] (command index). [Examples] CMD6: SD_CMD[7:0] = 8'b00_000110 CMD18: SD_CMD[7:0] = 8'b00_010010 ACMD13: SD_CMD[7:0] = 8'b01_001101
    }

    /// SD_ARG Register bits
    namespace sd_arg_bits {
        constexpr uint32_t SD_ARG = (32 << 0);  ///< Argument Register Set command format[39:8] (argument)
    }

    /// SD_ARG1 Register bits
    namespace sd_arg1_bits {
        constexpr uint32_t Reserved = (16 << 16);  ///< These bits are read as 0000000000000000. The write value should be 0000000000000000.
        constexpr uint32_t SD_ARG1 = (16 << 0);  ///< Argument Register 1 Set command format[39:24] (argument)
    }
    ...
    namespace sd_seccnt_bits {
        constexpr uint32_t SD_SECCNT = (32 << 0);  ///< Number of Transfer Blocks NOTE: Do not change the value of this bit when the CBSY bit in SD_INFO2 is set to 1.
    }
    ...
    namespace sd_rsp76_bits {
        constexpr uint32_t Reserved = (8 << 24);  ///< These bits are read as 00000000.
        constexpr uint32_t SD_RSP76 = (24 << 0);  ///< Store the response from the SD card/MMC
    }

    /// SD_RSP7 Register bits
    namespace sd_rsp7_bits {
        constexpr uint32_t Reserved = (24 << 8);  ///< These bits are read as 000000000000000000000000.
    ...
    namespace sd_info2_bits {
        constexpr uint32_t Reserved = (3 << 10);  ///< These bits are read as 000. The write value should be 000.
        ...
        constexpr uint32_t SDD0MON = (1U << 7);  ///< SDDAT0 Indicates the SDDAT0 state of the port specified by SD_PORTSEL.
    ...
    namespace sd_clk_ctrl_bits {
        constexpr uint32_t Reserved = (1U << 10);  ///< This bit is read as 0. The write value should be 0.
    ...
    namespace sd_option_bits {
        ...
        constexpr uint32_t WIDTH = (1U << 15);  ///< Bus Width NOTE: The initial value is applied at a reset and when the SOFT_RST.SDRST flag is 0.
        constexpr uint32_t WIDTH8 = (1U << 13);  ///< Bus Width see b15, WIDTH bit
        constexpr uint32_t TOUTMASK = (1U << 8);  ///< Timeout MASK When timeout occurs in case of inactivating timeout, software reset should be executed to terminate command sequence.
    ...
    namespace sd_err_sts1_bits {
        ...
        constexpr uint32_t CRCTK = (3 << 12);  ///< CRC Status Token Store the CRC status token value (normal value is 010b)
        constexpr uint32_t CRCTKE = (1U << 11);  ///< CRC Status Token Error
        constexpr uint32_t RDCRCE = (1U << 10);  ///< Read Data CRC Error
        constexpr uint32_t RSPCRCE1 = (1U << 9);  ///< Response CRC Error 1 NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is indicated in RSPCRCE0.
        constexpr uint32_t RSPCRCE0 = (1U << 8);  ///< Response CRC Error 0 NOTE: other than a response to a command issued within a command sequence
        constexpr uint32_t CRCLENE = (1U << 5);  ///< CRC Status Token Length Error
        constexpr uint32_t RDLENE = (1U << 4);  ///< Read Data Length Error
        constexpr uint32_t RSPLENE1 = (1U << 3);  ///< Response Length Error 1 NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is indicated in RSPLENE0.
        constexpr uint32_t RSPLENE0 = (1U << 2);  ///< Response Length Error 0 NOTE: other than a response to a command issued within a command sequence
        constexpr uint32_t CMDE1 = (1U << 1);  ///< Command Error 1 NOTE: In cases where CMD12 is issued by setting a command index in SD_CMD, this is Indicated in CMDE0.
        constexpr uint32_t CMDE0 = (1U << 0);  ///< Command Error 0 NOTE: other than a response to a command issued within a command sequence
    }

    /// SD_ERR_STS2 Register bits
    namespace sd_err_sts2_bits {
        constexpr uint32_t Reserved = (25 << 7);  ///< These bits are read as 0000000000000000000000000.
    ...
    namespace sdio_info1_bits {
        constexpr uint32_t Reserved = (2 << 1);  ///< These bits are read as 00. The write value should be 00.
        constexpr uint32_t EXWT = (1U << 15);  ///< EXWT Status Flag NOTE: See manual
        constexpr uint32_t EXPUB52 = (1U << 14);  ///< EXPUB52 Status Flag NOTE: See manual
        constexpr uint32_t IOIRQ = (1U << 0);  ///< SDIO Interrupt Status
    }

    /// SDIO_INFO1_MASK Register bits
    namespace sdio_info1_mask_bits {
        constexpr uint32_t Reserved = (2 << 1);  ///< These bits are read as 11. The write value should be 11.
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t ADSSTR0%s;  ///< Offset: 0xE5 - A/D Sampling State Register %s (Corresponding Channel is AN00%s )
...
namespace ctsu {
    ...
    namespace ctsuchac0_bits {
        constexpr uint32_t CTSUCHAC0 = (1U << 7);  ///< CTSU Channel Enable Control 0. 0: Not measurement target 1: Measurement target Note: Bit 1 corresponds to TS01 and Bit 7 corresponds to TS07.
    }

    /// CTSUCHAC1 Register bits
    namespace ctsuchac1_bits {
        constexpr uint32_t CTSUCHAC1 = (5 << 0);  ///< CTSU Channel Enable Control 1. 0: Not measurement target 1: Measurement target Note: CTSUCHAC1[0] corresponds to TS08 and CTSUCHAC1[4] corresponds to TS12.
    }
...
#endif // ALLOY_GENERATED_R7FA6M1AD_PERIPHERALS_HPP