/// Auto-generated code for R7FA6M3AH
/// Generated by Alloy Code Generator
/// Source: renesas_r7fa6m3ah.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:51
#ifndef ALLOY_GENERATED_R7FA6M3AH_PERIPHERALS_HPP
#define ALLOY_GENERATED_R7FA6M3AH_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::r7fa6m3ah {
...
namespace traits {
    ...
    constexpr uint32_t num_gpio_instances = 12;
    ...
    constexpr bool has_glcdc = true;
    constexpr uint32_t num_glcdc_instances = 1;
    constexpr bool has_drw = true;
    constexpr uint32_t num_drw_instances = 1;
    ...
    constexpr bool has_sci5 = true;
    constexpr uint32_t num_sci5_instances = 1;
    constexpr bool has_sci6 = true;
    constexpr uint32_t num_sci6_instances = 1;
    constexpr bool has_sci7 = true;
    constexpr uint32_t num_sci7_instances = 1;
    ...
    constexpr bool has_iic2 = true;
    constexpr uint32_t num_iic2_instances = 1;
    constexpr bool has_system = true;
    constexpr uint32_t num_system_instances = 1;
    constexpr bool has_dma = true;
    constexpr uint32_t num_dma_instances = 11;
    constexpr bool has_eth = true;
    constexpr uint32_t num_eth_instances = 1;
    constexpr bool has_eptpc = true;
    constexpr uint32_t num_eptpc_instances = 2;
    constexpr bool has_eptpc0 = true;
    constexpr uint32_t num_eptpc0_instances = 1;
    constexpr bool has_sdhi0 = true;
    constexpr uint32_t num_sdhi0_instances = 1;
    constexpr bool has_sdhi1 = true;
    constexpr uint32_t num_sdhi1_instances = 1;
    ...
    constexpr bool has_gpt3213 = true;
    constexpr uint32_t num_gpt3213_instances = 1;
    constexpr bool has_rtc = true;
    constexpr uint32_t num_rtc_instances = 1;
    constexpr bool has_ssie0 = true;
    constexpr uint32_t num_ssie0_instances = 1;
    constexpr bool has_ssie1 = true;
    constexpr uint32_t num_ssie1_instances = 1;
    ...
    constexpr bool has_ami = true;
    constexpr uint32_t num_ami_instances = 1;
    ...
    constexpr bool has_pdc = true;
    constexpr uint32_t num_pdc_instances = 1;
    ...
    template<>
    struct peripheral_count<struct glcdc_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct drw_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct sci5_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct sci6_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct sci7_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct iic2_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct eptpc_tag> {
        static constexpr uint32_t value = 2;
    };
    template<>
    struct peripheral_count<struct eptpc0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct sdhi0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct sdhi1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct gpt3213_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct ssie0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct ssie1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct ami_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct pdc_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    constexpr uint32_t num_gpio_ports = 12;
    constexpr uint32_t max_gpio_pins = 192;  // 16 pins per port
...
namespace pfs {
    ...
    struct Registers {
        ...
        volatile uint32_t P00PFS;  ///< Offset: 0x20 - P00%s Pin Function Control Register (renamed from P00PFS)
        volatile uint32_t P00PFS_HA;  ///< Offset: 0x22 - P00%s Pin Function Control Register (renamed from P00PFS_HA)
        volatile uint32_t P00PFS_BY;  ///< Offset: 0x23 - P00%s Pin Function Control Register (renamed from P00PFS_BY)
        ...
        volatile uint32_t P20PFS;  ///< Offset: 0x88 - P20%s Pin Function Control Register (renamed from P20PFS)
        volatile uint32_t P20PFS_HA;  ///< Offset: 0x8A - P20%s Pin Function Control Register (renamed from P20PFS_HA)
        volatile uint32_t P20PFS_BY;  ///< Offset: 0x8B - P20%s Pin Function Control Register (renamed from P20PFS_BY)
        ...
        volatile uint32_t P3PFS;  ///< Offset: 0xE8 - P3%s Pin Function Control Register (renamed from P3PFS)
        volatile uint32_t P3PFS_HA;  ///< Offset: 0xEA - P30%s Pin Function Control Register (renamed from P3PFS_HA)
        volatile uint32_t P3PFS_BY;  ///< Offset: 0xEB - P30%s Pin Function Control Register (renamed from P3PFS_BY)
        ...
        volatile uint32_t P5PFS;  ///< Offset: 0x16C - P5%s Pin Function Control Register (renamed from P5PFS)
        volatile uint32_t P5PFS_HA;  ///< Offset: 0x16E - P5%s Pin Function Control Register (renamed from P5PFS_HA)
        volatile uint32_t P5PFS_BY;  ///< Offset: 0x16F - P5%s Pin Function Control Register (renamed from P5PFS_BY)
        volatile uint32_t P60PFS;  ///< Offset: 0x180 - P60%s Pin Function Control Register (renamed from P60PFS)
        volatile uint32_t P60PFS_HA;  ///< Offset: 0x182 - P60%s Pin Function Control Register (renamed from P60PFS_HA)
        volatile uint32_t P60PFS_BY;  ///< Offset: 0x183 - P60%s Pin Function Control Register (renamed from P60PFS_BY)
        volatile uint32_t P6PFS;  ///< Offset: 0x1A8 - P6%s Pin Function Control Register (renamed from P6PFS)
        volatile uint32_t P6PFS_HA;  ///< Offset: 0x1AA - P6%s Pin Function Control Register (renamed from P6PFS_HA)
        volatile uint32_t P6PFS_BY;  ///< Offset: 0x1AB - P6%s Pin Function Control Register (renamed from P6PFS_BY)
        volatile uint32_t P70PFS;  ///< Offset: 0x1C0 - P70%s Pin Function Control Register (renamed from P70PFS)
        volatile uint32_t P70PFS_HA;  ///< Offset: 0x1C2 - P70%s Pin Function Control Register (renamed from P70PFS_HA)
        volatile uint32_t P70PFS_BY;  ///< Offset: 0x1C3 - P70%s Pin Function Control Register (renamed from P70PFS_BY)
        volatile uint32_t P80PFS;  ///< Offset: 0x200 - P80%s Pin Function Control Register (renamed from P80PFS)
        volatile uint32_t P80PFS_HA;  ///< Offset: 0x202 - P80%s Pin Function Control Register (renamed from P80PFS_HA)
        volatile uint32_t P80PFS_BY;  ///< Offset: 0x203 - P80%s Pin Function Control Register (renamed from P80PFS_BY)
        volatile uint32_t P90PFS;  ///< Offset: 0x254 - P90%s Pin Function Control Register (renamed from P90PFS)
        volatile uint32_t P90PFS_HA;  ///< Offset: 0x256 - P90%s Pin Function Control Register (renamed from P90PFS_HA)
        volatile uint32_t P90PFS_BY;  ///< Offset: 0x257 - P90%s Pin Function Control Register (renamed from P90PFS_BY)
        volatile uint32_t PA0PFS;  ///< Offset: 0x2A0 - PA0%s Pin Function Control Register (renamed from PA0PFS)
        volatile uint32_t PA0PFS_HA;  ///< Offset: 0x2A2 - PA0%s Pin Function Control Register (renamed from PA0PFS_HA)
        volatile uint32_t PA0PFS_BY;  ///< Offset: 0x2A3 - PA0%s Pin Function Control Register (renamed from PA0PFS_BY)
        ...
        volatile uint32_t PB0PFS;  ///< Offset: 0x2C0 - PB0%s Pin Function Control Register (renamed from PB0PFS)
        volatile uint32_t PB0PFS_HA;  ///< Offset: 0x2C2 - PB0%s Pin Function Control Register (renamed from PB0PFS_HA)
        volatile uint32_t PB0PFS_BY;  ///< Offset: 0x2C3 - PB0%s Pin Function Control Register (renamed from PB0PFS_BY)
    };
...
namespace glcdc {
    /// Base addresses
    constexpr uint32_t GLCDC_BASE = 0x400E0000;

    /// GLCDC Register structure
    struct Registers {
        volatile uint32_t GR1_CLUT0__;  ///< Offset: 0x00 - Color Palette 0 Plane for Graphics 1 Plane (renamed from GR1_CLUT0__)
        volatile uint32_t GR1_CLUT1__;  ///< Offset: 0x400 - Color Palette 1 Plane for Graphics 1 Plane (renamed from GR1_CLUT1__)
        volatile uint32_t GR2_CLUT0__;  ///< Offset: 0x800 - Color Palette 0 Plane for Graphics 2 Plane (renamed from GR2_CLUT0__)
        volatile uint32_t GR2_CLUT1__;  ///< Offset: 0xC00 - Color Palette 1 Plane for Graphics 2 Plane (renamed from GR2_CLUT1__)
        volatile uint32_t BG_EN;  ///< Offset: 0x1000 - Background Plane Setting Operation Control Register
        volatile uint32_t BG_PERI;  ///< Offset: 0x1004 - Background Plane Setting Free-Running Period Register
        volatile uint32_t BG_SYNC;  ///< Offset: 0x1008 - Background Plane Setting Synchronization Position Register
        volatile uint32_t BG_VSIZE;  ///< Offset: 0x100C - Background Plane Setting Full Image Vertical Size Register
        volatile uint32_t BG_HSIZE;  ///< Offset: 0x1010 - Background Plane Setting Full Image Horizontal Size Register
        volatile uint32_t BG_BGC;  ///< Offset: 0x1014 - Background Plane Setting Background Color Register
        volatile uint32_t BG_MON;  ///< Offset: 0x1018 - Background Plane Setting Status Monitor Register
        volatile uint32_t GR_VEN;  ///< Offset: 0x1100 - Graphics %s Register Update Control Register (renamed from GR_VEN)
        volatile uint32_t GR_FLMRD;  ///< Offset: 0x1104 - Graphics %s Frame Buffer Read Control Register (renamed from GR_FLMRD)
        volatile uint32_t GR_FLM1;  ///< Offset: 0x1108 - Graphics %s Frame Buffer Control Register 1 (renamed from GR_FLM1)
        volatile uint32_t GR_FLM2;  ///< Offset: 0x110C - Graphics %s Frame Buffer Control Register 2 (renamed from GR_FLM2)
        volatile uint32_t GR_FLM3;  ///< Offset: 0x1110 - Graphics %s Frame Buffer Control Register 3 (renamed from GR_FLM3)
        volatile uint32_t GR_FLM5;  ///< Offset: 0x1118 - Graphics %s Frame Buffer Control Register 5 (renamed from GR_FLM5)
        volatile uint32_t GR_FLM6;  ///< Offset: 0x111C - Graphics %s Frame Buffer Control Register 6 (renamed from GR_FLM6)
        volatile uint32_t GR_AB1;  ///< Offset: 0x1120 - Graphics %s Alpha Blending Control Register 1 (renamed from GR_AB1)
        volatile uint32_t GR_AB2;  ///< Offset: 0x1124 - Graphics %s Alpha Blending Control Register 2 (renamed from GR_AB2)
        volatile uint32_t GR_AB3;  ///< Offset: 0x1128 - Graphics %s Alpha Blending Control Register 3 (renamed from GR_AB3)
        volatile uint32_t GR_AB4;  ///< Offset: 0x112C - Graphics %s Alpha Blending Control Register 4 (renamed from GR_AB4)
        volatile uint32_t GR_AB5;  ///< Offset: 0x1130 - Graphics %s Alpha Blending Control Register 5 (renamed from GR_AB5)
        volatile uint32_t GR_AB6;  ///< Offset: 0x1134 - Graphics %s Alpha Blending Control Register 6 (renamed from GR_AB6)
        volatile uint32_t GR_AB7;  ///< Offset: 0x1138 - Graphics %s Alpha Blending Control Register 7 (renamed from GR_AB7)
        volatile uint32_t GR_AB8;  ///< Offset: 0x113C - Graphics %s Alpha Blending Control Register 8 (renamed from GR_AB8)
        volatile uint32_t GR_AB9;  ///< Offset: 0x1140 - Graphics %s Alpha Blending Control Register 9 (renamed from GR_AB9)
        volatile uint32_t GR_BASE;  ///< Offset: 0x114C - Graphics %s Background Color Control Register (renamed from GR_BASE)
        volatile uint32_t GR_CLUTINT;  ///< Offset: 0x1150 - Graphics %s CLUT Table Interrupt Control Register (renamed from GR_CLUTINT)
        volatile uint32_t GR_MON;  ///< Offset: 0x1154 - Graphics %s Status Monitor Register (renamed from GR_MON)
        volatile uint32_t GAM_LATCH;  ///< Offset: 0x1300 - Gamma %s Register Update Control Register (renamed from GAM_LATCH)
        volatile uint32_t GAM_SW;  ///< Offset: 0x1304 - Gamma Correction Block Function Switch Register
        volatile uint32_t GAM_LUT1;  ///< Offset: 0x1308 - Gamma %s Correction Block Table Setting Register 1 (renamed from GAM_LUT1)
        volatile uint32_t GAM_LUT2;  ///< Offset: 0x130C - Gamma %s Correction Block Table Setting Register 2 (renamed from GAM_LUT2)
        volatile uint32_t GAM_LUT3;  ///< Offset: 0x1310 - Gamma %s Correction Block Table Setting Register 3 (renamed from GAM_LUT3)
        volatile uint32_t GAM_LUT4;  ///< Offset: 0x1314 - Gamma %s Correction Block Table Setting Register 4 (renamed from GAM_LUT4)
        volatile uint32_t GAM_LUT5;  ///< Offset: 0x1318 - Gamma %s Correction Block Table Setting Register 5 (renamed from GAM_LUT5)
        volatile uint32_t GAM_LUT6;  ///< Offset: 0x131C - Gamma %s Correction Block Table Setting Register 6 (renamed from GAM_LUT6)
        volatile uint32_t GAM_LUT7;  ///< Offset: 0x1320 - Gamma %s Correction Block Table Setting Register 7 (renamed from GAM_LUT7)
        volatile uint32_t GAM_LUT8;  ///< Offset: 0x1324 - Gamma %s Correction Block Table Setting Register 8 (renamed from GAM_LUT8)
        volatile uint32_t GAM_AREA1;  ///< Offset: 0x1328 - Gamma %s Correction Block Area Setting Register 1 (renamed from GAM_AREA1)
        volatile uint32_t GAM_AREA2;  ///< Offset: 0x132C - Gamma %s Correction Block Area Setting Register 2 (renamed from GAM_AREA2)
        volatile uint32_t GAM_AREA3;  ///< Offset: 0x1330 - Gamma %s Correction Block Area Setting Register 3 (renamed from GAM_AREA3)
        volatile uint32_t GAM_AREA4;  ///< Offset: 0x1334 - Gamma %s Correction Block Area Setting Register 4 (renamed from GAM_AREA4)
        volatile uint32_t GAM_AREA5;  ///< Offset: 0x1338 - Gamma %s Correction Block Area Setting Register 5 (renamed from GAM_AREA5)
        volatile uint32_t OUT_VLATCH;  ///< Offset: 0x13C0 - Output Control Block Register Update Control Register
        volatile uint32_t OUT_SET;  ///< Offset: 0x13C4 - Output Control Block Output Interface Register
        volatile uint32_t OUT_BRIGHT1;  ///< Offset: 0x13C8 - Output Control Block Brightness Correction Register 1
        volatile uint32_t OUT_BRIGHT2;  ///< Offset: 0x13CC - Output Control Block Brightness Correction Register 2
        volatile uint32_t OUT_CONTRAST;  ///< Offset: 0x13D0 - Output Control Block Contrast Correction Register
        volatile uint32_t OUT_PDTHA;  ///< Offset: 0x13D4 - Output Control Block Panel Dither Correction Register
        volatile uint32_t OUT_CLKPHASE;  ///< Offset: 0x13E4 - Output Control Block Output Phase Control Register
        volatile uint32_t TCON_TIM;  ///< Offset: 0x1404 - TCON Reference Timing Setting Register
        volatile uint32_t TCON_STV1;  ///< Offset: 0x1408 - TCON Vertical Timing Setting Register %s1 (renamed from TCON_STV1)
        volatile uint32_t TCON_STV2;  ///< Offset: 0x140C - TCON Vertical Timing Setting Register %s2 (renamed from TCON_STV2)
        volatile uint32_t TCON_STH1;  ///< Offset: 0x1418 - TCON Horizontal Timing Setting Register STH%s1 (renamed from TCON_STH1)
        volatile uint32_t TCON_STH2;  ///< Offset: 0x141C - TCON Horizontal Timing Setting Register STH%s2 (renamed from TCON_STH2)
        volatile uint32_t TCON_DE;  ///< Offset: 0x1428 - TCON Data Enable Polarity Setting Register
        volatile uint32_t SYSCNT_DTCTEN;  ///< Offset: 0x1440 - System Control Block State Detection Control Register
        volatile uint32_t SYSCNT_INTEN;  ///< Offset: 0x1444 - System Control Block Interrupt Request Enable Control Register
        volatile uint32_t SYSCNT_STCLR;  ///< Offset: 0x1448 - System Control Block Status Clear Register
        volatile uint32_t SYSCNT_STMON;  ///< Offset: 0x144C - System Control Block Status Monitor Register
        volatile uint32_t SYSCNT_PANEL_CLK;  ///< Offset: 0x1450 - System Control Block Version and Panel Clock Control Register
    };

    /// Peripheral instances
    inline Registers* GLCDC = reinterpret_cast<Registers*>(GLCDC_BASE);

    // Bit definitions
    /// GR1_CLUT0__ Register bits
    namespace gr1_clut0___bits {
        constexpr uint32_t A = (8 << 24);  ///< Alpha Blending Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t R = (8 << 16);  ///< R Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t G = (8 << 8);  ///< G Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t B = (8 << 0);  ///< B Value of Color Palette n Plane for Graphics m Plane
    }

    /// GR1_CLUT1__ Register bits
    namespace gr1_clut1___bits {
        constexpr uint32_t A = (8 << 24);  ///< Alpha Blending Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t R = (8 << 16);  ///< R Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t G = (8 << 8);  ///< G Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t B = (8 << 0);  ///< B Value of Color Palette n Plane for Graphics m Plane
    ...
    /// GR2_CLUT0__ Register bits
    namespace gr2_clut0___bits {
        constexpr uint32_t A = (8 << 24);  ///< Alpha Blending Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t R = (8 << 16);  ///< R Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t G = (8 << 8);  ///< G Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t B = (8 << 0);  ///< B Value of Color Palette n Plane for Graphics m Plane
    ...
    /// GR2_CLUT1__ Register bits
    namespace gr2_clut1___bits {
        constexpr uint32_t A = (8 << 24);  ///< Alpha Blending Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t R = (8 << 16);  ///< R Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t G = (8 << 8);  ///< G Value of Color Palette n Plane for Graphics m Plane
        constexpr uint32_t B = (8 << 0);  ///< B Value of Color Palette n Plane for Graphics m Plane
    ...
    /// BG_EN Register bits
    namespace bg_en_bits {
        constexpr uint32_t SWRST = (1U << 16);  ///< Entire module SW reset control
        constexpr uint32_t VEN = (1U << 8);  ///< Control of LCDC internal register value reflection to internal operations
        constexpr uint32_t EN = (1U << 0);  ///< Background plane generation module operation enable
    }

    /// BG_PERI Register bits
    namespace bg_peri_bits {
        constexpr uint32_t FV = (11 << 16);  ///< Background plane vertical synchronization signal period on the basis of line.
        constexpr uint32_t FH = (11 << 0);  ///< Background plane horizontal synchronization signal period on the basis of pixel clock (PXCLK).
    }

    /// BG_SYNC Register bits
    namespace bg_sync_bits {
        constexpr uint32_t VP = (4 << 16);  ///< Background plane vertical synchronization signal assertion position on the basis of line.
        constexpr uint32_t HP = (4 << 0);  ///< Background plane horizontal synchronization signal assertion position on the basis of pixel clock (PXCLK).
    }

    /// BG_VSIZE Register bits
    namespace bg_vsize_bits {
        constexpr uint32_t VP = (11 << 16);  ///< Background plane vertical valid pixel start position on the basis of line
        constexpr uint32_t VW = (11 << 0);  ///< Background plane vertical valid pixel width on the basis of line
    }

    /// BG_HSIZE Register bits
    namespace bg_hsize_bits {
        constexpr uint32_t HP = (11 << 16);  ///< Background plane horizontal valid pixel start position on the basis of pixel clock (PXCLK).
        constexpr uint32_t HW = (11 << 0);  ///< Background plane horizontall valid pixel width on the basis of pixel clock (PXCLK)Note: When serial RGB is selected as the output format for the output control block, add two to the horizontal enable signal width and set the resulting value to this field.
    }

    /// BG_BGC Register bits
    namespace bg_bgc_bits {
        constexpr uint32_t R = (8 << 16);  ///< R value for background plane valid pixel area.Unsigned; 8-bit integer.
        constexpr uint32_t G = (8 << 8);  ///< G value for background plane valid pixel areaUnsigned; 8-bit integer
        constexpr uint32_t B = (8 << 0);  ///< B value for background plane valid pixel areaUnsigned; 8-bit integer
    }

    /// BG_MON Register bits
    namespace bg_mon_bits {
        constexpr uint32_t SWRST = (1U << 16);  ///< Entire module SW reset state monitor.
        constexpr uint32_t VEN = (1U << 8);  ///< Entire module internal operation reflection control signal monitor.The signal state for controlling reflection of the register values to the internal operations upon assertion of the vertical synchronization signal.
        constexpr uint32_t EN = (1U << 0);  ///< Background plane generation module operation state monitor.
    }

    /// GR_VEN Register bits
    namespace gr_ven_bits {
        constexpr uint32_t PVEN = (1U << 0);  ///< Control of graphics n module register value reflection to internal operations.Reflection of the register values to the internal operation at the assertion of the vertical synchronization signal (VS).
    }

    /// GR_FLMRD Register bits
    namespace gr_flmrd_bits {
        constexpr uint32_t RENB = (1U << 0);  ///< Graphics data (frame buffer data) read enable.
    }

    /// GR_FLM1 Register bits
    namespace gr_flm1_bits {
        constexpr uint32_t BSTMD = (2 << 0);  ///< Burst transfer control for graphics data (frame buffer data)access
    }

    /// GR_FLM2 Register bits
    namespace gr_flm2_bits {
        constexpr uint32_t BASE = (32 << 0);  ///< Base address for accessing graphics data (frame buffer data)Set the head address in the frame buffer where graphics data is to be stored. GRn_FLM2.BASE[5:0] should be fixed to 0 during 64-byte burst transfer.
    }

    /// GR_FLM3 Register bits
    namespace gr_flm3_bits {
        constexpr uint32_t LNOFF = (16 << 16);  ///< Macro line offset address for accessing graphics data(frame buffer data)Signed; 16-bit integer
    }

    /// GR_FLM5 Register bits
    namespace gr_flm5_bits {
        constexpr uint32_t LNNUM = (11 << 16);  ///< Number of lines per frame for accessing graphics data (frame buffer data).
        constexpr uint32_t DATANUM = (16 << 0);  ///< Number of data transfer times per line for accessing graphics data (frame buffer data), where one transfer is defined as 16-beat burst access (64-byte boundary)
    }

    /// GR_FLM6 Register bits
    namespace gr_flm6_bits {
        constexpr uint32_t FORMAT = (3 << 28);  ///< Data format for accessing graphics data (frame buffer data).
    }

    /// GR_AB1 Register bits
    namespace gr_ab1_bits {
        constexpr uint32_t ARCON = (1U << 12);  ///< Rectangular area alpha blending control.
        constexpr uint32_t ARCDISPON = (1U << 8);  ///< Image area border display control for rectangular area alpha blending.
        constexpr uint32_t GRCDISPON = (1U << 4);  ///< Graphics image area border display control.
        constexpr uint32_t DISPSEL = (2 << 0);  ///< Graphics display plane control.
    }

    /// GR_AB2 Register bits
    namespace gr_ab2_bits {
        constexpr uint32_t GRCVS = (11 << 16);  ///< Vertical start position of graphics image area.
        constexpr uint32_t GRCVW = (11 << 0);  ///< Vertical width of graphics image area.
    }

    /// GR_AB3 Register bits
    namespace gr_ab3_bits {
        constexpr uint32_t GRCHS = (11 << 16);  ///< Horizontal start position of graphics image area.
        constexpr uint32_t GRCHW = (11 << 0);  ///< Horizontal width of graphics image area.
    }

    /// GR_AB4 Register bits
    namespace gr_ab4_bits {
        constexpr uint32_t ARCVS = (11 << 16);  ///< Vertical start position of rectangular area alpha blending image area
        constexpr uint32_t ARCVW = (11 << 0);  ///< Vertical width of rectangular area alpha blending image area.
    }

    /// GR_AB5 Register bits
    namespace gr_ab5_bits {
        constexpr uint32_t ARCHS = (11 << 16);  ///< Horizontal start position of rectangular area alpha blending image area.
        constexpr uint32_t ARCHW = (11 << 0);  ///< Horizontal width of rectangular area alpha blending image area.
    }

    /// GR_AB6 Register bits
    namespace gr_ab6_bits {
        constexpr uint32_t ARCCOEF = (9 << 16);  ///< Alpha coefficient for alpha blending in rectangular area (-255 to 255).[8]: Sign (0: addition, 1: subtraction)[7:0]: Variation (absolute value)
        constexpr uint32_t ARCRATE = (8 << 0);  ///< Frame rate for alpha blending in rectangular area.
    }

    /// GR_AB7 Register bits
    namespace gr_ab7_bits {
        constexpr uint32_t ARCDEF = (8 << 16);  ///< Initial alpha value for alpha blending in rectangular area.
        constexpr uint32_t CKON = (1U << 0);  ///< RGB-index chroma-key processing control.
    }

    /// GR_AB8 Register bits
    namespace gr_ab8_bits {
        constexpr uint32_t CKKG = (8 << 16);  ///< G signal for RGB-index chroma-key processingUnsigned; 8 bits.
        constexpr uint32_t CKKB = (8 << 8);  ///< B signal for RGB-index chroma-key processingUnsigned; 8 bits.
        constexpr uint32_t CKKR = (8 << 0);  ///< R signal for RGB-index chroma-key processingUnsigned; 8 bits.
    }

    /// GR_AB9 Register bits
    namespace gr_ab9_bits {
        constexpr uint32_t CKA = (8 << 24);  ///< A value after RGB-index chroma-key processing replacement.
        constexpr uint32_t CKG = (8 << 16);  ///< G value after RGB-index chroma-key processing replacementUnsigned; 8 bits.
        constexpr uint32_t CKB = (8 << 8);  ///< B value after RGB-index chroma-key processing replacementUnsigned; 8 bits.
        constexpr uint32_t CKR = (8 << 0);  ///< R value after RGB-index chroma-key processing replacementUnsigned; 8 bits.
    }

    /// GR_BASE Register bits
    namespace gr_base_bits {
        constexpr uint32_t G = (8 << 16);  ///< Background color G valueUnsigned; 8 bits
        constexpr uint32_t B = (8 << 8);  ///< Background color B valueUnsigned; 8 bits
        constexpr uint32_t R = (8 << 0);  ///< Background color R valueUnsigned; 8 bits
    }

    /// GR_CLUTINT Register bits
    namespace gr_clutint_bits {
        constexpr uint32_t SEL = (1U << 16);  ///< CLUT table control
        constexpr uint32_t LINE = (11 << 0);  ///< Number of detection lines
    }

    /// GR_MON Register bits
    namespace gr_mon_bits {
        constexpr uint32_t UNDFLST = (1U << 16);  ///< Status monitor for underflow
        constexpr uint32_t ARCST = (1U << 0);  ///< Status monitor for alpha blending in rectangular area
    }

    /// GAM_LATCH Register bits
    namespace gam_latch_bits {
        constexpr uint32_t VEN = (1U << 0);  ///< Control of gamma correction x module register value reflection to internal operations.The register values to be reflected to the internal operations at the assertion of the vertical synchronization signal (VS).
    }

    /// GAM_SW Register bits
    namespace gam_sw_bits {
        constexpr uint32_t GAMON = (1U << 0);  ///< Gamma correction on/off control
    }

    /// GAM_LUT1 Register bits
    namespace gam_lut1_bits {
        constexpr uint32_t GAIN00 = (11 << 16);  ///< Gain value of area 0.Unsigned 11-bit fixed point.
        constexpr uint32_t GAIN01 = (11 << 0);  ///< Gain value of area 1Unsigned 11-bit fixed point
    }

    /// GAM_LUT2 Register bits
    namespace gam_lut2_bits {
        constexpr uint32_t GAIN02 = (11 << 16);  ///< Gain value of area 2Unsigned 11-bit fixed point
        constexpr uint32_t GAIN03 = (11 << 0);  ///< Gain value of area 3Unsigned 11-bit fixed point
    }

    /// GAM_LUT3 Register bits
    namespace gam_lut3_bits {
        constexpr uint32_t GAIN04 = (11 << 16);  ///< Gain value of area 4Unsigned 11-bit fixed point
        constexpr uint32_t GAIN05 = (11 << 0);  ///< Gain value of area 5Unsigned 11-bit fixed point
    }

    /// GAM_LUT4 Register bits
    namespace gam_lut4_bits {
        constexpr uint32_t GAIN06 = (11 << 16);  ///< Gain value of area 6Unsigned 11-bit fixed point
        constexpr uint32_t GAIN07 = (11 << 0);  ///< Gain value of area 7Unsigned 11-bit fixed point
    }

    /// GAM_LUT5 Register bits
    namespace gam_lut5_bits {
        constexpr uint32_t GAIN08 = (11 << 16);  ///< Gain value of area 8Unsigned 11-bit fixed point
        constexpr uint32_t GAIN09 = (11 << 0);  ///< Gain value of area 9Unsigned 11-bit fixed point
    }

    /// GAM_LUT6 Register bits
    namespace gam_lut6_bits {
        constexpr uint32_t GAIN10 = (11 << 16);  ///< Gain value of area 10Unsigned 11-bit fixed point
        constexpr uint32_t GAIN11 = (11 << 0);  ///< Gain value of area 11Unsigned 11-bit fixed point
    }

    /// GAM_LUT7 Register bits
    namespace gam_lut7_bits {
        constexpr uint32_t GAIN12 = (11 << 16);  ///< Gain value of area 12Unsigned 11-bit fixed point
        constexpr uint32_t GAIN13 = (11 << 0);  ///< Gain value of area 13Unsigned 11-bit fixed point
    }

    /// GAM_LUT8 Register bits
    namespace gam_lut8_bits {
        constexpr uint32_t GAIN14 = (11 << 16);  ///< Gain value of area 14Unsigned 11-bit fixed point
        constexpr uint32_t GAIN15 = (11 << 0);  ///< Gain value of area 15Unsigned 11-bit fixed point
    }

    /// GAM_AREA1 Register bits
    namespace gam_area1_bits {
        constexpr uint32_t TH01 = (10 << 20);  ///< Start threshold of area 1Unsigned 10-bit integer
        constexpr uint32_t TH02 = (10 << 10);  ///< Start threshold of area 2Unsigned 10-bit integer
        constexpr uint32_t TH03 = (10 << 0);  ///< Start threshold of area 3Unsigned 10-bit integer
    }

    /// GAM_AREA2 Register bits
    namespace gam_area2_bits {
        constexpr uint32_t TH04 = (10 << 20);  ///< Start threshold of area 4Unsigned 10-bit integer
        constexpr uint32_t TH05 = (10 << 10);  ///< Start threshold of area 5Unsigned 10-bit integer
        constexpr uint32_t TH06 = (10 << 0);  ///< Start threshold of area 6Unsigned 10-bit integer
    }

    /// GAM_AREA3 Register bits
    namespace gam_area3_bits {
        constexpr uint32_t TH07 = (10 << 20);  ///< Start threshold of area 7Unsigned 10-bit integer
        constexpr uint32_t TH08 = (10 << 10);  ///< Start threshold of area 8Unsigned 10-bit integer
        constexpr uint32_t TH09 = (10 << 0);  ///< Start threshold of area 9Unsigned 10-bit integer
    }

    /// GAM_AREA4 Register bits
    namespace gam_area4_bits {
        constexpr uint32_t TH10 = (10 << 20);  ///< Start threshold of area 10Unsigned 10-bit integer
        constexpr uint32_t TH11 = (10 << 10);  ///< Start threshold of area 11Unsigned 10-bit integer
        constexpr uint32_t TH12 = (10 << 0);  ///< Start threshold of area 12Unsigned 10-bit integer
    }

    /// GAM_AREA5 Register bits
    namespace gam_area5_bits {
        constexpr uint32_t TH13 = (10 << 20);  ///< Start threshold of area 13Unsigned 10-bit integer
        constexpr uint32_t TH14 = (10 << 10);  ///< Start threshold of area 14Unsigned 10-bit integer
        constexpr uint32_t TH15 = (10 << 0);  ///< Start threshold of area 15Unsigned 10-bit integer
    }

    /// OUT_VLATCH Register bits
    namespace out_vlatch_bits {
        constexpr uint32_t VEN = (1U << 0);  ///< Control of output control module register value reflection to internal operations.The register values to be reflected to the internal operations at the assertion of the vertical synchronization signal (VS).
    }

    /// OUT_SET Register bits
    namespace out_set_bits {
        constexpr uint32_t ENDIANON = (1U << 28);  ///< Bit endian change control
        constexpr uint32_t SWAPON = (1U << 24);  ///< Pixel order control
        constexpr uint32_t FORMAT = (2 << 12);  ///< Output format select
        constexpr uint32_t FRQSEL = (2 << 8);  ///< Clock frequency division control
        constexpr uint32_t DIRSEL = (1U << 4);  ///< Invalid data position control in serial RGB format
        constexpr uint32_t PHASE = (2 << 0);  ///< Data delay in serial RGB format (based on OUTCLK)
    }

    /// OUT_BRIGHT1 Register bits
    namespace out_bright1_bits {
        constexpr uint32_t BRTG = (10 << 0);  ///< Brightness (DC) adjustment of G signalUnsigned; 10 bits; +512 with offset; integer
    }

    /// OUT_BRIGHT2 Register bits
    namespace out_bright2_bits {
        constexpr uint32_t BRTB = (10 << 16);  ///< Brightness (DC) adjustment of B signalUnsigned; 10 bits; +512 with offset; integer
        constexpr uint32_t BRTR = (10 << 0);  ///< Brightness (DC) adjustment of R signalUnsigned; 10 bits; +512 with offset; integer
    }

    /// OUT_CONTRAST Register bits
    namespace out_contrast_bits {
        constexpr uint32_t CONTG = (8 << 16);  ///< Contrast (GAIN) adjustment of G signalUnsigned; 8 bits fixed point.
        constexpr uint32_t CONTB = (8 << 8);  ///< Contrast (GAIN) adjustment of B signalUnsigned; 8 bits fixed point
        constexpr uint32_t CONTR = (8 << 0);  ///< Contrast (GAIN) adjustment of R signalUnsigned; 8 bits fixed point
    }

    /// OUT_PDTHA Register bits
    namespace out_pdtha_bits {
        constexpr uint32_t SEL = (2 << 20);  ///< Operation mode
        constexpr uint32_t FORM = (2 << 16);  ///< Output format select
        constexpr uint32_t PA = (2 << 12);  ///< Pattern value (A) of 2 x 2 pattern ditherUnsigned 2-bit integer
        constexpr uint32_t PB = (2 << 8);  ///< Pattern value (B) of 2 x 2 pattern ditherUnsigned 2-bit integer
        constexpr uint32_t PC = (2 << 4);  ///< Pattern value (C) of 2 x 2 pattern ditherUnsigned 2-bit integer
        constexpr uint32_t PD = (2 << 0);  ///< Pattern value (D) of 2 x 2 pattern ditherUnsigned 2-bit integer
    }

    /// OUT_CLKPHASE Register bits
    namespace out_clkphase_bits {
        constexpr uint32_t FRONTGAM = (1U << 12);  ///< Correction control
        constexpr uint32_t LCDEDGE = (1U << 8);  ///< LCD_DATA Output Phase Control
        constexpr uint32_t TCON0EDGE = (1U << 6);  ///< LCD_TCON0 Output Phase Control
        constexpr uint32_t TCON1EDGE = (1U << 5);  ///< LCD_TCON1 Output Phase Control
        constexpr uint32_t TCON2EDGE = (1U << 4);  ///< LCD_TCON2 Output Phase Control
        constexpr uint32_t TCON3EDGE = (1U << 3);  ///< LCD_TCON3 Output Phase Control
    }

    /// TCON_TIM Register bits
    namespace tcon_tim_bits {
        constexpr uint32_t HALF = (11 << 16);  ///< Vertical synchronization signal generation change timing Sets the delay from the assertion of the internal horizontal synchronization signal in terms of pixels.
        constexpr uint32_t OFFSET = (11 << 0);  ///< Horizontal synchronization signal generation reference timingSets the offset from the assertion of the internal horizontal synchronization signal in terms of pixels.
    }

    /// TCON_STV1 Register bits
    namespace tcon_stv1_bits {
        constexpr uint32_t VS = (11 << 16);  ///< STVx1 first change timing
        constexpr uint32_t VW = (11 << 0);  ///< STVx1 second change timingSets the signal assertion width.
    }

    /// TCON_STV2 Register bits
    namespace tcon_stv2_bits {
        constexpr uint32_t INV = (1U << 4);  ///< STVx signal polarity inversion control
        constexpr uint32_t SEL = (3 << 0);  ///< Output signal select control for VSOUT (controlled by TCON_STVA2 register)/VEOUT (controlled by the TCON_STVB2 register) pin
    }

    /// TCON_STH1 Register bits
    namespace tcon_sth1_bits {
        constexpr uint32_t HS = (11 << 16);  ///< STHx1 first change timing
        constexpr uint32_t HW = (11 << 0);  ///< STHx1 second change timing.Sets the signal assertion width.
    }

    /// TCON_STH2 Register bits
    namespace tcon_sth2_bits {
        constexpr uint32_t HSSEL = (1U << 8);  ///< STHx signal generation reference timing control.
        constexpr uint32_t INV = (1U << 4);  ///< STVx signal polarity inversion control.
        constexpr uint32_t SEL = (3 << 0);  ///< Output signal select control for LCD_TCON2 (controlled by TCON_STHA2 register)/LCD_TCON3 (controlled by the TCON_STHB2 register) pin.
    }

    /// TCON_DE Register bits
    namespace tcon_de_bits {
        constexpr uint32_t INV = (1U << 0);  ///< DE signal polarity inversion control.
    }

    /// SYSCNT_DTCTEN Register bits
    namespace syscnt_dtcten_bits {
        constexpr uint32_t L2UNDFDTC = (1U << 2);  ///< Graphics 2 underflow detection control
        constexpr uint32_t L1UNDFDTC = (1U << 1);  ///< Graphics 1 underflow detection control
        constexpr uint32_t VPOSDTC = (1U << 0);  ///< Specified line detection control
    }

    /// SYSCNT_INTEN Register bits
    namespace syscnt_inten_bits {
        constexpr uint32_t L2UNDFINTEN = (1U << 2);  ///< Interrupt request signal GLCDC_L2UNDF enable control.
        constexpr uint32_t L1UNDFINTEN = (1U << 1);  ///< Interrupt request signal GLCDC_L1UNDF enable control.
        constexpr uint32_t VPOSINTEN = (1U << 0);  ///< Interrupt request signal GLCDC_VPOS enable control.
    }

    /// SYSCNT_STCLR Register bits
    namespace syscnt_stclr_bits {
        constexpr uint32_t L2UNDFCLR = (1U << 2);  ///< Graphics 2 underflow detection flag clear field
        constexpr uint32_t L1UNDFCLR = (1U << 1);  ///< Graphics 1 underflow detection flag clear field
        constexpr uint32_t VPOSCLR = (1U << 0);  ///< Graphics 2 specified line detection flag clear field
    }

    /// SYSCNT_STMON Register bits
    namespace syscnt_stmon_bits {
        constexpr uint32_t L2UNDF = (1U << 2);  ///< Graphics 2 underflow detection flag
        constexpr uint32_t L1UNDF = (1U << 1);  ///< Graphics 1 underflow detection flag
        constexpr uint32_t VPOS = (1U << 0);  ///< Graphics 2 specified line detection flag
    }

    /// SYSCNT_PANEL_CLK Register bits
    namespace syscnt_panel_clk_bits {
        constexpr uint32_t VER = (16 << 16);  ///< Version informationVersion information of the GLCD
        constexpr uint32_t PIXSEL = (1U << 12);  ///< Pixel clock select control.Must be set to the same value as OUT_SET.FRQSEL[1].
        constexpr uint32_t CLKSEL = (1U << 8);  ///< Panel clock supply source select
        constexpr uint32_t CLKEN = (1U << 6);  ///< Panel clock output enable controlNote: Before changing the PIXSEL,CLKSEL or DCDR bit, this bit must be set to 0.
        constexpr uint32_t DCDR = (6 << 0);  ///< Clock division ratio setting controlRefer toTable 2.7.1 for details about setting value.Note: Settings that are not listed in table 2.7.1 are prohibited.
    }
...
namespace drw {
    /// Base addresses
    constexpr uint32_t DRW_BASE = 0x400E4000;

    /// DRW Register structure
    struct Registers {
        volatile uint32_t CONTROL;  ///< Offset: 0x00 - Geometry Control Register
        volatile uint32_t CONTROL2;  ///< Offset: 0x04 - Surface Control Register
        volatile uint32_t IRQCTL;  ///< Offset: 0xC0 - Interrupt Control Register
        volatile uint32_t CACHECTL;  ///< Offset: 0xC4 - Cache Control Register
        volatile uint32_t STATUS;  ///< Offset: 0x00 - Status Control Register
        volatile uint32_t HWREVISION;  ///< Offset: 0x04 - Hardware Version and Feature Set ID Register
        volatile uint32_t COLOR1;  ///< Offset: 0x64 - Base Color Register
        volatile uint32_t COLOR2;  ///< Offset: 0x68 - Secondary Color Register
        volatile uint32_t PATTERN;  ///< Offset: 0x74 - Pattern Register
        volatile uint32_t LSTART;  ///< Offset: 0x10 - Limiter %s Start Value Register (renamed from LSTART)
        volatile uint32_t LXADD;  ///< Offset: 0x28 - Limiter %s X-Axis Increment Register (renamed from LXADD)
        volatile uint32_t LYADD;  ///< Offset: 0x40 - Limiter %s Y-Axis Increment Register (renamed from LYADD)
        volatile uint32_t LBAND;  ///< Offset: 0x58 - Limiter %s Band Width Parameter Register (renamed from LBAND)
        volatile uint32_t TEXORIGIN;  ///< Offset: 0xBC - Texture Base Address Register
        volatile uint32_t TEXPITCH;  ///< Offset: 0xB4 - Texels Per Texture Line Register
        volatile uint32_t TEXMASK;  ///< Offset: 0xB8 - Texture Size or Texture Address Mask Register
        volatile uint32_t LUSTART;  ///< Offset: 0x90 - U Limiter Start Value Register
        volatile uint32_t LUXADD;  ///< Offset: 0x94 - U Limiter X-Axis Increment Register
        volatile uint32_t LUYADD;  ///< Offset: 0x98 - U Limiter Y-Axis Increment Register
        volatile uint32_t LVSTARTI;  ///< Offset: 0x9C - V Limiter Start Value Integer Part Register
        volatile uint32_t LVSTARTF;  ///< Offset: 0xA0 - V Limiter Start Value Fractional Part Register
        volatile uint32_t LVXADDI;  ///< Offset: 0xA4 - V Limiter X-Axis Increment Integer Part Register
        volatile uint32_t LVYADDI;  ///< Offset: 0xA8 - V Limiter Y-Axis Increment Integer Part Register
        volatile uint32_t LVYXADDF;  ///< Offset: 0xAC - V Limiter Increment Fractional Parts Register
        volatile uint32_t TEXCLADDR;  ///< Offset: 0xDC - CLUT Start Address Register
        volatile uint32_t TEXCLDATA;  ///< Offset: 0xE0 - CLUT Data Register
        volatile uint32_t TEXCLOFFSET;  ///< Offset: 0xE4 - CLUT Offset Register
        volatile uint32_t COLKEY;  ///< Offset: 0xE8 - Color Key Register
        volatile uint32_t SIZE;  ///< Offset: 0x78 - Bounding Box Dimension Register
        volatile uint32_t PITCH;  ///< Offset: 0x7C - Framebuffer Pitch And Spanstore Delay Register
        volatile uint32_t ORIGIN;  ///< Offset: 0x80 - Framebuffer Base Address Register
        volatile uint32_t DLISTSTART;  ///< Offset: 0xC8 - Display List Start Address Register
        volatile uint32_t PERFTRIGGER;  ///< Offset: 0xD4 - Performance Counters Control Register
        volatile uint32_t PERFCOUNT;  ///< Offset: 0xCC - Performance Counter %s (renamed from PERFCOUNT)
    };

    /// Peripheral instances
    inline Registers* DRW = reinterpret_cast<Registers*>(DRW_BASE);

    // Bit definitions
    /// CONTROL Register bits
    namespace control_bits {
        constexpr uint32_t SPANSTORE = (1U << 23);  ///< Nextline span start is always equal or left to current-line span start
        constexpr uint32_t SPANABORT = (1U << 22);  ///< Shape is horizontally convex, only a single span per scanline
        constexpr uint32_t UNIONCD = (1U << 21);  ///< Combine outputs C & D as union (output is final)
        constexpr uint32_t UNIONAB = (1U << 20);  ///< Combine outputs A & B as union (output is called C)
        constexpr uint32_t UNION56 = (1U << 19);  ///< Combine limter 5 & 6 as union (output is called D)
        constexpr uint32_t UNION34 = (1U << 18);  ///< Combine limter 3 & 4 as union (output is called B)
        constexpr uint32_t UNION12 = (1U << 17);  ///< Combine limter 1 & 2 as union (output is called A)
        constexpr uint32_t BAND2ENABLE = (1U << 16);  ///< Enable band postprocess for limiter 1 (see L1BAND)
        constexpr uint32_t BAND1ENABLE = (1U << 15);  ///< Enable band postprocess for limiter 1 (see L1BAND)
        constexpr uint32_t LIM6THRESHOLD = (1U << 14);  ///< Enable limiter 6 threshold mode
        constexpr uint32_t LIM5THRESHOLD = (1U << 13);  ///< Enable limiter 5 threshold mode
        constexpr uint32_t LIM4THRESHOLD = (1U << 12);  ///< Enable limiter 4 threshold mode
        constexpr uint32_t LIM3THRESHOLD = (1U << 11);  ///< Enable limiter 3 threshold mode
        constexpr uint32_t LIM2THRESHOLD = (1U << 10);  ///< Enable limiter 2 threshold mode
        constexpr uint32_t LIM1THRESHOLD = (1U << 9);  ///< Enable limiter 1 threshold mode
        constexpr uint32_t QUAD3ENABLE = (1U << 8);  ///< Enable quadratic coupling of limiters 5 and 6
        constexpr uint32_t QUAD2ENABLE = (1U << 7);  ///< Enable quadratic coupling of limiters 3 and 4
        constexpr uint32_t QUAD1ENABLE = (1U << 6);  ///< Enable quadratic coupling of limiters 1 and 2
        constexpr uint32_t LIM6ENABLE = (1U << 5);  ///< Enable limiter 6
        constexpr uint32_t LIM5ENABLE = (1U << 4);  ///< Enable limiter 5
        constexpr uint32_t LIM4ENABLE = (1U << 3);  ///< Enable limiter 4
        constexpr uint32_t LIM3ENABLE = (1U << 2);  ///< Enable limiter 3
        constexpr uint32_t LIM2ENABLE = (1U << 1);  ///< Enable limiter 2
        constexpr uint32_t LIM1ENABLE = (1U << 0);  ///< Enable limiter 1
    }

    /// CONTROL2 Register bits
    namespace control2_bits {
        constexpr uint32_t RLEPIXELWIDTH = (2 << 30);  ///< Texel width for RLE unit
        constexpr uint32_t BDIA = (1U << 29);  ///< Blend destination factor inverted in alpha channel (USEACB = 1)
        constexpr uint32_t BSIA = (1U << 28);  ///< Blend source factor inverted in alpha channel (USEACB = 1)
        constexpr uint32_t CLUTFORMAT = (1U << 27);  ///< Format of the CLUT
        constexpr uint32_t COLKEYENABLE = (1U << 26);  ///< color keying enable
        constexpr uint32_t CLUTENABLE = (1U << 25);  ///< CLUT enable
        constexpr uint32_t RLEENABLE = (1U << 24);  ///< RLE enable
        constexpr uint32_t WRITEALPHA = (2 << 22);  ///< Writeback alpha source for framebufferSet the 'alpha source' for the framebuffer(USEACB = 0)Blend alpha in color 2 instead of framebuffer alpha((USEACB = 1))In not alpha channel blending mode (USEACB = 0):Set the 'alpha source' for the framebuffer.In alpha channel blending mode (USEACB = 1):Blend alpha in color 2 instead of framebuffer alpha00B: BC2A = 1: use alpha from framebuffer as destination (DST_A)else: BC2A = 0: use alpha in color 2 as destination (DST_A)
        constexpr uint32_t WRITEFORMAT10 = (2 << 20);  ///< Pixel format of the framebuffer
        constexpr uint32_t READFORMAT10 = (2 << 18);  ///< Pixel format of the texture buffer{READFORMAT32,READFORMAT10}0000: 8 bpp a(8)0001: 16 bpp RGB(565)0010: 32 bpp aRGB(8888)0011: 16 bpp aRGB(4444)0100: 16 bpp aRGB(1555)0101: 8 bpp aCLUT(44) 4 bit alpha and 4 bit indexed color1001: 8 bpp CLUT(8)/I(8), 8 bit indexed color/luminance1010: 4 bpp CLUT(4)/I(4), 4 bit indexed color/luminance1011: 2 bpp CLUT(2)/I(2), 2 bit indexed color/luminance 1100: 1 bpp CLUT(1)/I(1), 1 bit indexed color/luminance
        constexpr uint32_t TEXTUREFILTERY = (1U << 17);  ///< Linear filtering on texture V axis
        constexpr uint32_t TEXTUREFILTERX = (1U << 16);  ///< Linear filtering on texture U axis
        constexpr uint32_t TEXTURECLAMPY = (1U << 15);  ///< Calculating V limiter outside use textureThe bit describes what happens if the V limiter (y direction in texture space) calculates a V value outside of the used texture
        constexpr uint32_t TEXTURECLAMPX = (1U << 14);  ///< Calculating U limiter outside use textureThe bit describes what happens if the U limiter (x direction in texture space) calculates a U value outside of the used texture
        constexpr uint32_t BC2 = (1U << 13);  ///< Blend color 2 instead of framebuffer pixel
        constexpr uint32_t BDI = (1U << 12);  ///< Blend destination factor is inverteddst factor will be inverted (meaning 1-a or 1-1 depending on BDF)
        constexpr uint32_t BSI = (1U << 11);  ///< Blend source factor is invertedsrc factor will be inverted (meaning 1-a or 1-1 depending on BSF)
        constexpr uint32_t BDF = (1U << 10);  ///< Blend destination factordst factor is alpha (factor is 1 per default)
        constexpr uint32_t BSF = (1U << 9);  ///< Blend source factorsrc factor is alpha (factor is 1 per default)
        constexpr uint32_t WRITEFORMAT2 = (1U << 8);  ///< Bit 3 of framebuffer pixel formatSee WRITEFORMAT above description.
        constexpr uint32_t BDFA = (1U << 7);  ///< Blend destinetion factor for alpha channel in alpha channel blending mode (USEACB = 1)
        constexpr uint32_t BSFA = (1U << 6);  ///< Blend source factor for alpha channel in alpha channel blending mode (USEACB = 1)
        constexpr uint32_t READFORMAT32 = (2 << 4);  ///< Bit 4 and 3 of the texture buffer format.See READFORMAT above for description
        constexpr uint32_t USEACB = (1U << 3);  ///< Alpha blend mode
        constexpr uint32_t PATTERNSOURCEL5 = (1U << 2);  ///< Limiter 5 is used as pattern index instead of the default U limiter.Limiter 5 can be combined with limiter 6 to form a quadratic limiter which can be used to make quadratic pattern functions to draw radial patterns.
        constexpr uint32_t TEXTUREENABLE = (1U << 1);  ///< Pixel source is read from texture and used as an alpha to blend between COLOR1 and COLOR2
        constexpr uint32_t PATTERNENABLE = (1U << 0);  ///< Pixel source is a pattern color (blend of COLOR1 and COLOR2 depending on PATTERN and pattern index)
    }

    /// IRQCTL Register bits
    namespace irqctl_bits {
        constexpr uint32_t BUSIRQCLR = (1U << 5);  ///< Clear bus error interrupt BUSIRQ
        constexpr uint32_t BUSIRQEN = (1U << 4);  ///< BUSIRQ interrupt mask enable
        constexpr uint32_t DLISTIRQCLR = (1U << 3);  ///< Clear display list interrupt DLISTIRQ
        constexpr uint32_t ENUMIRQCLR = (1U << 2);  ///< Clear enumeration interrupt ENUMIRQ
        constexpr uint32_t DLISTIRQEN = (1U << 1);  ///< DLISTIRQ interrupt mask enable
        constexpr uint32_t ENUMIRQEN = (1U << 0);  ///< ENUMIRQ interrupt mask enable
    }

    /// CACHECTL Register bits
    namespace cachectl_bits {
        constexpr uint32_t CFLUSHTX = (1U << 3);  ///< Flush texture cache
        constexpr uint32_t CENABLETX = (1U << 2);  ///< Texture cache enable
        constexpr uint32_t CFLUSHFX = (1U << 1);  ///< Flush framebuffer cache
        constexpr uint32_t CENABLEFX = (1U << 0);  ///< Framebuffer cache enable
    }

    /// STATUS Register bits
    namespace status_bits {
        constexpr uint32_t BUSERRMDL = (1U << 10);  ///< display list bus error interrupt triggered
        constexpr uint32_t BUSERRMTXMRL = (1U << 9);  ///< texture bus error interrupt triggered
        constexpr uint32_t BUSERRMFB = (1U << 8);  ///< framebuffer bus error interrupt triggered
        constexpr uint32_t BUSIRQ = (1U << 6);  ///< bus error interrupt triggered
        constexpr uint32_t DLISTIRQ = (1U << 5);  ///< display list finished interrupt triggered
        constexpr uint32_t ENUMIRQ = (1U << 4);  ///< enumeration finished interrupt triggered
        constexpr uint32_t DLISTACTIVE = (1U << 3);  ///< Display list reader status
        constexpr uint32_t CACHEDIRTY = (1U << 2);  ///< Framebuffer cache status
        constexpr uint32_t BUSYWRITE = (1U << 1);  ///< Framebuffer writeback status
        constexpr uint32_t BUSYENUM = (1U << 0);  ///< Enumeration unit status
    }

    /// HWREVISION Register bits
    namespace hwrevision_bits {
        constexpr uint32_t ACBLEND = (1U << 27);  ///< Alpha channel blending feature
        constexpr uint32_t COLORKEY = (1U << 25);  ///< Colorkey feature
        constexpr uint32_t TEXCLUT256 = (1U << 24);  ///< Texture CLUT feature
        constexpr uint32_t RLEUNIT = (1U << 23);  ///< RLE unit feature
        constexpr uint32_t TEXCLU = (1U << 21);  ///< Texture CLUT with 16 or 256 entries feature
        constexpr uint32_t PERFCOUNT = (1U << 20);  ///< Two performance counter feature
        constexpr uint32_t TXCACHE = (1U << 19);  ///< Texture cache feature
        constexpr uint32_t FBCACHE = (1U << 18);  ///< Framebuffer cache feature
        constexpr uint32_t DLR = (1U << 17);  ///< Display list reader feature
        constexpr uint32_t REV = (12 << 0);  ///< Revision number
    }

    /// COLOR1 Register bits
    namespace color1_bits {
        constexpr uint32_t COLOR1A = (8 << 24);  ///< Alpha channel of color 1(0x00: transparent. . . 0xFF: opaque)
        constexpr uint32_t COLOR1R = (8 << 16);  ///< Red channel of color 1
        constexpr uint32_t COLOR1G = (8 << 8);  ///< Green channel of color 1
        constexpr uint32_t COLOR1B = (8 << 0);  ///< Blue channel of color 1
    }

    /// COLOR2 Register bits
    namespace color2_bits {
        constexpr uint32_t COLOR2A = (8 << 24);  ///< Alpha channel of color 2(0x00: transparent. . . 0xFF: opaque)
        constexpr uint32_t COLOR2R = (8 << 16);  ///< Red channel of color 2
        constexpr uint32_t COLOR2G = (8 << 8);  ///< Green channel of color 2
        constexpr uint32_t COLOR2B = (8 << 0);  ///< Blue channel of color 2
    }

    /// PATTERN Register bits
    namespace pattern_bits {
        constexpr uint32_t PATTERN = (8 << 0);  ///< Bitmap of the pattern
    }

    /// LSTART Register bits
    namespace lstart_bits {
        constexpr uint32_t LSTART = (32 << 0);  ///< Start value of the n'th limiter(n=1-6)
    }

    /// LXADD Register bits
    namespace lxadd_bits {
        constexpr uint32_t LXADD = (32 << 0);  ///< X-axis increment
    }

    /// LYADD Register bits
    namespace lyadd_bits {
        constexpr uint32_t LYADD = (32 << 0);  ///< Y-axis increment
    }

    /// LBAND Register bits
    namespace lband_bits {
        constexpr uint32_t LBAND = (32 << 0);  ///< Limiter m band width parameter
    }

    /// TEXORIGIN Register bits
    namespace texorigin_bits {
        constexpr uint32_t TEXORIGIN = (32 << 0);  ///< Texture base address
    }

    /// TEXPITCH Register bits
    namespace texpitch_bits {
        constexpr uint32_t TEXPITCH = (32 << 0);  ///< Texels per texture linevalid range: 0 to 2048
    }

    /// TEXMASK Register bits
    namespace texmask_bits {
        constexpr uint32_t TEXVMASK = (21 << 11);  ///< V maskSet TEXVMASK[20:0] = TEXPITCH * (texture_height - 1).In texture wrapping mode (CONTROL2.TEXTURECLAMPY = 0): texture_height must be a power of 2In texture clamping mode (CONTROL2.TEXTURECLAMPY = 1):all heights up to 1024 are allowed.
        constexpr uint32_t TEXUMASK = (11 << 0);  ///< U maskSet TEXUMASK[10:0] = texture_width -1In texture wrapping mode (CONTROL2.TEXTURECLAMPX = 0): texture_width must be a power of 2.In texture clamping mode (CONTROL2.TEXTURECLAMPX = 1):all widths up to 2048 are allowed.
    }

    /// LUSTART Register bits
    namespace lustart_bits {
        constexpr uint32_t LUSTART = (32 << 0);  ///< U limiter start value
    }

    /// LUXADD Register bits
    namespace luxadd_bits {
        constexpr uint32_t LUXADD = (32 << 0);  ///< U limiter x-axis increment
    }

    /// LUYADD Register bits
    namespace luyadd_bits {
        constexpr uint32_t LUYADD = (32 << 0);  ///< U limiter y-axis increment
    }

    /// LVSTARTI Register bits
    namespace lvstarti_bits {
        constexpr uint32_t LVSTARTI = (32 << 0);  ///< V limiter start value integer part
    }

    /// LVSTARTF Register bits
    namespace lvstartf_bits {
        constexpr uint32_t LVSTARTF = (16 << 0);  ///< V limiter start value fractional part
    }

    /// LVXADDI Register bits
    namespace lvxaddi_bits {
        constexpr uint32_t LVXADDI = (32 << 0);  ///< V limiter x-axis increment integer part
    }

    /// LVYADDI Register bits
    namespace lvyaddi_bits {
        constexpr uint32_t LVYADDI = (32 << 0);  ///< V limiter y-axis increment integer part
    }

    /// LVYXADDF Register bits
    namespace lvyxaddf_bits {
        constexpr uint32_t LVYADDF = (16 << 16);  ///< V y limiter increment fractional part
        constexpr uint32_t LVXADDF = (16 << 0);  ///< V xlimiter increment fractional part
    }

    /// TEXCLADDR Register bits
    namespace texcladdr_bits {
        constexpr uint32_t CLADDR = (8 << 0);  ///< Texture CLUT start address for indexed texture format
    }

    /// TEXCLDATA Register bits
    namespace texcldata_bits {
        constexpr uint32_t CLDATA = (32 << 0);  ///< Texture CLUT data for Indexed texture format
    }

    /// TEXCLOFFSET Register bits
    namespace texcloffset_bits {
        constexpr uint32_t CLOFFSET = (8 << 0);  ///< Texture CLUT offset for Indexed texture format. CLOFFSET[7:0] is or'ed with the original index
    }

    /// COLKEY Register bits
    namespace colkey_bits {
        constexpr uint32_t COLKEYR = (8 << 16);  ///< Red channel of color key
        constexpr uint32_t COLKEYG = (8 << 8);  ///< Green channel of color key
        constexpr uint32_t COLKEYB = (8 << 0);  ///< Blue channel of color key
    }

    /// SIZE Register bits
    namespace size_bits {
        constexpr uint32_t SIZEY = (16 << 16);  ///< Height of the bounding box in pixelsvalid range: 0 to 1024
        constexpr uint32_t SIZEX = (16 << 0);  ///< Width of the bounding box in pixelsvalid range: 0 to 1024
    }

    /// PITCH Register bits
    namespace pitch_bits {
        constexpr uint32_t SSD = (16 << 16);  ///< Spanstore delay
        constexpr uint32_t PITCH = (16 << 0);  ///< pitch of the framebuffer. A negative width can be used to render bottom-up instead of top-down
    }

    /// ORIGIN Register bits
    namespace origin_bits {
        constexpr uint32_t ORIGIN = (32 << 0);  ///< Address of the first pixel in framebuffer
    }

    /// DLISTSTART Register bits
    namespace dliststart_bits {
        constexpr uint32_t DLISTSTART = (32 << 0);  ///< Display list start address
    }

    /// PERFTRIGGER Register bits
    namespace perftrigger_bits {
        constexpr uint32_t PERFTRIGGER2 = (16 << 16);  ///< Selects the internal event that will increment PERFCOUNT2 register
        constexpr uint32_t PERFTRIGGER1 = (16 << 0);  ///< Selects the internal event that will increment PERFCOUNT1 register.
    }

    /// PERFCOUNT Register bits
    namespace perfcount_bits {
        constexpr uint32_t PERFCOUNT = (32 << 0);  ///< Counter value.The counter is reset by writing PERFCOUNT = 0000 0000H.
    }
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t PIPECTR;  ///< Offset: 0x70 - PIPE Control Register (renamed from PIPECTR)
        volatile uint32_t PIPETRE;  ///< Offset: 0x90 - PIPE Transaction Counter Enable Register (renamed from PIPETRE)
        volatile uint32_t PIPETRN;  ///< Offset: 0x92 - PIPE Transaction Counter Register (renamed from PIPETRN)
        volatile uint32_t DEVADD;  ///< Offset: 0xD0 - Device Address Configuration Register (renamed from DEVADD)
...
namespace dma {
    ...
    constexpr uint32_t PTPEDMAC_BASE = 0x40064400;
    ...
    inline Registers* PTPEDMAC = reinterpret_cast<Registers*>(PTPEDMAC_BASE);
...
namespace eptpc {
    /// Base addresses
    constexpr uint32_t EPTPC_BASE = 0x40065000;
    constexpr uint32_t EPTPC_CFG_BASE = 0x40064500;

    /// EPTPC Register structure
    struct Registers {
        volatile uint32_t MIESR;  ///< Offset: 0x00 - MINT Interrupt Source Status Register
        volatile uint32_t MIEIPR;  ///< Offset: 0x04 - MINT Interrupt Request Permission Register
        volatile uint32_t ELIPPR;  ///< Offset: 0x10 - ELC Output/IPLS Interrupt Request Permission Register
        volatile uint32_t ELIPACR;  ///< Offset: 0x14 - ELC Output/IPLS Interrupt Permission Automatic Clearing Register
        volatile uint32_t STSR;  ///< Offset: 0x40 - STCA Status Register
        volatile uint32_t STIPR;  ///< Offset: 0x44 - STCA Status Notification Permission Register
        volatile uint32_t STCFR;  ///< Offset: 0x50 - STCA Clock Frequency Setting Register
        volatile uint32_t STMR;  ///< Offset: 0x54 - STCA Operating Mode Register
        volatile uint32_t SYNTOR;  ///< Offset: 0x58 - Sync Message Reception Timeout Register
        volatile uint32_t IPTSELR;  ///< Offset: 0x60 - IPLS Interrupt Request Timer Select Register
        volatile uint32_t MITSELR;  ///< Offset: 0x64 - MINT Interrupt Request Timer Select Register
        volatile uint32_t ELTSELR;  ///< Offset: 0x68 - ELC Output Timer Select Register
        volatile uint32_t STCHSELR;  ///< Offset: 0x6C - Time Synchronization Channel Select Register
        volatile uint32_t SYNSTARTR;  ///< Offset: 0x80 - Slave Time Synchronization Start Register
        volatile uint32_t LCIVLDR;  ///< Offset: 0x84 - Local Time Counter Initial Value Load Directive Register
        volatile uint32_t SYNTDARU;  ///< Offset: 0x90 - Synchronization Loss Detection Threshold Registers
        volatile uint32_t SYNTDARL;  ///< Offset: 0x94 - Synchronization Loss Detection Threshold Registers
        volatile uint32_t SYNTDBRU;  ///< Offset: 0x98 - Synchronization Detection Threshold Registers
        volatile uint32_t SYNTDBRL;  ///< Offset: 0x9C - Synchronization Detection Threshold Registers
        volatile uint32_t LCIVRU;  ///< Offset: 0xB0 - Local Time Counter Initial Value Registers
        volatile uint32_t LCIVRM;  ///< Offset: 0xB4 - Local Time Counter Initial Value Registers
        volatile uint32_t LCIVRL;  ///< Offset: 0xB8 - Local Time Counter Initial Value Registers
        volatile uint32_t GETW10R;  ///< Offset: 0x124 - Worst 10 Acquisition Directive Register
        volatile uint32_t PLIMITRU;  ///< Offset: 0x128 - Positive Gradient Limit Registers
        volatile uint32_t PLIMITRM;  ///< Offset: 0x12C - Positive Gradient Limit Registers
        volatile uint32_t PLIMITRL;  ///< Offset: 0x130 - Positive Gradient Limit Registers
        volatile uint32_t MLIMITRU;  ///< Offset: 0x134 - Negative Gradient Limit Registers
        volatile uint32_t MLIMITRM;  ///< Offset: 0x138 - Negative Gradient Limit Registers
        volatile uint32_t MLIMITRL;  ///< Offset: 0x13C - Negative Gradient Limit Registers
        volatile uint32_t GETINFOR;  ///< Offset: 0x140 - Statistical Information Retention Control Register
        volatile uint32_t LCCVRU;  ///< Offset: 0x170 - Local Time Counters
        volatile uint32_t LCCVRM;  ///< Offset: 0x174 - Local Time Counters
        volatile uint32_t LCCVRL;  ///< Offset: 0x178 - Local Time Counters
        volatile uint32_t PW10VRU;  ///< Offset: 0x210 - Positive Gradient Worst 10 Value Registers
        volatile uint32_t PW10VRM;  ///< Offset: 0x214 - Positive Gradient Worst 10 Value Registers
        volatile uint32_t PW10VRL;  ///< Offset: 0x218 - Positive Gradient Worst 10 Value Registers
        volatile uint32_t MW10RU;  ///< Offset: 0x2D0 - Negative Gradient Worst 10 Value Registers
        volatile uint32_t MW10RM;  ///< Offset: 0x2D4 - Negative Gradient Worst 10 Value Registers
        volatile uint32_t MW10RL;  ///< Offset: 0x2D8 - Negative Gradient Worst 10 Value Registers
        volatile uint32_t TMSTTRU;  ///< Offset: 0x300 - Timer Start Time Setting Register %s (renamed from TMSTTRU)
        volatile uint32_t TMSTTRL;  ///< Offset: 0x304 - Timer Start Time Setting Register %s (renamed from TMSTTRL)
        volatile uint32_t TMCYCR;  ///< Offset: 0x308 - Timer Cycle Setting Registers %s (renamed from TMCYCR)
        volatile uint32_t TMPLSR;  ///< Offset: 0x30C - Timer Pulse Width Setting Register %s (renamed from TMPLSR)
        volatile uint32_t TMSTARTR;  ///< Offset: 0x37C - Timer Start Register
    };

    /// Peripheral instances
    inline Registers* EPTPC = reinterpret_cast<Registers*>(EPTPC_BASE);
    inline Registers* EPTPC_CFG = reinterpret_cast<Registers*>(EPTPC_CFG_BASE);

    // Bit definitions
    /// MIESR Register bits
    namespace miesr_bits {
        constexpr uint32_t CYC5 = (1U << 21);  ///< Pulse Output Timer 5 Rising Edge Detection Flag
        constexpr uint32_t CYC4 = (1U << 20);  ///< Pulse Output Timer 4 Rising Edge Detection Flag
        constexpr uint32_t CYC3 = (1U << 19);  ///< Pulse Output Timer 3 Rising Edge Detection Flag
        constexpr uint32_t CYC2 = (1U << 18);  ///< Pulse Output Timer 2 Rising Edge Detection Flag
        constexpr uint32_t CYC1 = (1U << 17);  ///< Pulse Output Timer 1 Rising Edge Detection Flag
        constexpr uint32_t CYC0 = (1U << 16);  ///< Pulse Output Timer 0 Rising Edge Detection Flag
        constexpr uint32_t SY0 = (1U << 1);  ///< SYNFP0 Status Flag
        constexpr uint32_t ST = (1U << 0);  ///< STCA Status Flag
    }

    /// MIEIPR Register bits
    namespace mieipr_bits {
        constexpr uint32_t CYC5 = (1U << 21);  ///< Pulse Output Timer 5 Rising Edge Detection Interrupt Request Permission
        constexpr uint32_t CYC4 = (1U << 20);  ///< Pulse Output Timer 4 Rising Edge Detection Interrupt Request Permission
        constexpr uint32_t CYC3 = (1U << 19);  ///< Pulse Output Timer 3 Rising Edge Detection Interrupt Request Permission
        constexpr uint32_t CYC2 = (1U << 18);  ///< Pulse Output Timer 2 Rising Edge Detection Interrupt Request Permission
        constexpr uint32_t CYC1 = (1U << 17);  ///< Pulse Output Timer 1 Rising Edge Detection Interrupt Request Permission
        constexpr uint32_t CYC0 = (1U << 16);  ///< Pulse Output Timer 0 Rising Edge Detection Interrupt Request Permission
        constexpr uint32_t SY0 = (1U << 1);  ///< SYNFP0 Status Interrupt Request Permission
        constexpr uint32_t ST = (1U << 0);  ///< STCA Status Interrupt Request Permission
    }

    /// ELIPPR Register bits
    namespace elippr_bits {
        constexpr uint32_t PLSN = (1U << 24);  ///< Pulse Output Timer Falling Edge Detection IPLS Interrupt Request Permission
        constexpr uint32_t PLSP = (1U << 16);  ///< Pulse Output Timer Rising Edge Detection IPLS Interrupt Request Permission
        constexpr uint32_t CYCN5 = (1U << 13);  ///< Pulse Output Timer 5 Falling Edge Detection Event Output Enable
        constexpr uint32_t CYCN4 = (1U << 12);  ///< Pulse Output Timer 4 Falling Edge Detection Event Output Enable
        constexpr uint32_t CYCN3 = (1U << 11);  ///< Pulse Output Timer 3 Falling Edge Detection Event Output Enable
        constexpr uint32_t CYCN2 = (1U << 10);  ///< Pulse Output Timer 2 Falling Edge Detection Event Output Enable
        constexpr uint32_t CYCN1 = (1U << 9);  ///< Pulse Output Timer 1 Falling Edge Detection Event Output Enable
        constexpr uint32_t CYCN0 = (1U << 8);  ///< Pulse Output Timer 0 Falling Edge Detection Event Output Enable
        constexpr uint32_t CYCP5 = (1U << 5);  ///< Pulse Output Timer 5 Rising Edge Detection Event Output Enable
        constexpr uint32_t CYCP4 = (1U << 4);  ///< Pulse Output Timer 4 Rising Edge Detection Event Output Enable
        constexpr uint32_t CYCP3 = (1U << 3);  ///< Pulse Output Timer 3 Rising Edge Detection Event Output Enable
        constexpr uint32_t CYCP2 = (1U << 2);  ///< Pulse Output Timer 2 Rising Edge Detection Event Output Enable
        constexpr uint32_t CYCP1 = (1U << 1);  ///< Pulse Output Timer 1 Rising Edge Detection Event Output Enable
        constexpr uint32_t CYCP0 = (1U << 0);  ///< Pulse Output Timer 0 Rising Edge Detection Event Output Enable
    }

    /// ELIPACR Register bits
    namespace elipacr_bits {
        constexpr uint32_t PLSN = (1U << 24);  ///< ELIPPR.PLSN Bit Automatic Clearing
        constexpr uint32_t PLSP = (1U << 16);  ///< ELIPPR.PLSP Bit Automatic Clearing
        constexpr uint32_t CYCN5 = (1U << 13);  ///< ELIPPR.CYCN5 Bit Automatic Clearing
        constexpr uint32_t CYCN4 = (1U << 12);  ///< ELIPPR.CYCN4 Bit Automatic Clearing
        constexpr uint32_t CYCN3 = (1U << 11);  ///< ELIPPR.CYCN3 Bit Automatic Clearing
        constexpr uint32_t CYCN2 = (1U << 10);  ///< ELIPPR.CYCN2 Bit Automatic Clearing
        constexpr uint32_t CYCN1 = (1U << 9);  ///< ELIPPR.CYCN1 Bit Automatic Clearing
        constexpr uint32_t CYCN0 = (1U << 8);  ///< ELIPPR.CYCN0 Bit Automatic Clearing
        constexpr uint32_t CYCP5 = (1U << 5);  ///< ELIPPR.CYCP5 Bit Automatic Clearing
        constexpr uint32_t CYCP4 = (1U << 4);  ///< ELIPPR.CYCP4 Bit Automatic Clearing
        constexpr uint32_t CYCP3 = (1U << 3);  ///< ELIPPR.CYCP3 Bit Automatic Clearing
        constexpr uint32_t CYCP2 = (1U << 2);  ///< ELIPPR.CYCP2 Bit Automatic Clearing
        constexpr uint32_t CYCP1 = (1U << 1);  ///< ELIPPR.CYCP1 Bit Automatic Clearing
        constexpr uint32_t CYCP0 = (1U << 0);  ///< ELIPPR.CYCP0 Bit Automatic Clearing
    }

    /// STSR Register bits
    namespace stsr_bits {
        constexpr uint32_t W10D = (1U << 4);  ///< Worst 10 Acquisition Completion Flag
        constexpr uint32_t SYNTOUT = (1U << 3);  ///< Sync Message Reception Timeout Detection Flag
        constexpr uint32_t SYNCOUT = (1U << 1);  ///< Synchronization Loss Detection Flag
        constexpr uint32_t SYNC = (1U << 0);  ///< Synchronized State Detection Flag
    }

    /// STIPR Register bits
    namespace stipr_bits {
        constexpr uint32_t W10D = (1U << 4);  ///< W10D Status Notification Enable
        constexpr uint32_t SYNTOUT = (1U << 3);  ///< SYNTOUT Status Notification Enable
        constexpr uint32_t SYNCOUT = (1U << 1);  ///< SYNCOUT Status Notification Enable
        constexpr uint32_t SYNC = (1U << 0);  ///< SYNC Status Notification Enable
    }

    /// STCFR Register bits
    namespace stcfr_bits {
        constexpr uint32_t STCF = (2 << 0);  ///< STCA Clock Frequency
    }

    /// STMR Register bits
    namespace stmr_bits {
        constexpr uint32_t ALEN1 = (1U << 29);  ///< Alarm Detection Enable 1
        constexpr uint32_t ALEN0 = (1U << 28);  ///< Alarm Detection Enable 0
        constexpr uint32_t DVTH = (4 << 20);  ///< Synchronization Loss Detection Threshold Setting
        constexpr uint32_t SYTH = (4 << 16);  ///< Synchronized State Detection Threshold Setting
        constexpr uint32_t W10S = (1U << 15);  ///< Worst 10 Acquisition Control Select
        constexpr uint32_t CMOD = (1U << 13);  ///< Time Synchronization Correction Mode
        constexpr uint32_t WINT = (8 << 0);  ///< Worst 10 Acquisition Time
    }

    /// SYNTOR Register bits
    namespace syntor_bits {
        constexpr uint32_t SYNTOR = (32 << 0);  ///< A Sync message not being received within 1024 x n (ns), where n is the setting, leads to a timeout for reception of Sync messages, leading to the STSR.SYNTOUT flag being set to 1.
    }

    /// IPTSELR Register bits
    namespace iptselr_bits {
        constexpr uint32_t IPTSEL5 = (1U << 5);  ///< Pulse Output Timer 5 Select
        constexpr uint32_t IPTSEL4 = (1U << 4);  ///< Pulse Output Timer 4 Select
        constexpr uint32_t IPTSEL3 = (1U << 3);  ///< Pulse Output Timer 3 Select
        constexpr uint32_t IPTSEL2 = (1U << 2);  ///< Pulse Output Timer 2 Select
        constexpr uint32_t IPTSEL1 = (1U << 1);  ///< Pulse Output Timer 1 Select
        constexpr uint32_t IPTSEL0 = (1U << 0);  ///< Pulse Output Timer 0 Select
    }

    /// MITSELR Register bits
    namespace mitselr_bits {
        constexpr uint32_t MINTEN5 = (1U << 5);  ///< Pulse Output Timer 5 MINT Interrupt Output Enable
        constexpr uint32_t MINTEN4 = (1U << 4);  ///< Pulse Output Timer 4 MINT Interrupt Output Enable
        constexpr uint32_t MINTEN3 = (1U << 3);  ///< Pulse Output Timer 3 MINT Interrupt Output Enable
        constexpr uint32_t MINTEN2 = (1U << 2);  ///< Pulse Output Timer 2 MINT Interrupt Output Enable
        constexpr uint32_t MINTEN1 = (1U << 1);  ///< Pulse Output Timer 1 MINT Interrupt Output Enable
        constexpr uint32_t MINTEN0 = (1U << 0);  ///< Pulse Output Timer 0 MINT Interrupt Output Enable
    }

    /// ELTSELR Register bits
    namespace eltselr_bits {
        constexpr uint32_t ELTDIS5 = (1U << 5);  ///< Pulse Output Timer 5 Event Generation Disable
        constexpr uint32_t ELTDIS4 = (1U << 4);  ///< Pulse Output Timer 4 Event Generation Disable
        constexpr uint32_t ELTDIS3 = (1U << 3);  ///< Pulse Output Timer 3 Event Generation Disable
        constexpr uint32_t ELTDIS2 = (1U << 2);  ///< Pulse Output Timer 2 Event Generation Disable
        constexpr uint32_t ELTDIS1 = (1U << 1);  ///< Pulse Output Timer 1 Event Generation Disable
        constexpr uint32_t ELTDIS0 = (1U << 0);  ///< Pulse Output Timer 0 Event Generation Disable
    }

    /// STCHSELR Register bits
    namespace stchselr_bits {
        constexpr uint32_t SYSEL = (1U << 0);  ///< Timer Information Input SelectNOTE: Do not change the value of this bit while the SYNSTARTR.STR bit is 1.
    }

    /// SYNSTARTR Register bits
    namespace synstartr_bits {
        constexpr uint32_t STR = (1U << 0);  ///< Slave Time Synchronization Control
    }

    /// LCIVLDR Register bits
    namespace lcivldr_bits {
        constexpr uint32_t LOAD = (1U << 0);  ///< Local Time Counter Initial Value Load Directive
    }

    /// SYNTDARU Register bits
    namespace syntdaru_bits {
        constexpr uint32_t SYNTDARU = (32 << 0);  ///< These bits hold the setting for the higher-order 32 bits of the threshold for detection of loss of synchronization.
    }

    /// SYNTDARL Register bits
    namespace syntdarl_bits {
        constexpr uint32_t SYNTDARL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the threshold for detection of loss of synchronization.
    }

    /// SYNTDBRU Register bits
    namespace syntdbru_bits {
        constexpr uint32_t SYNTDBRU = (32 << 0);  ///< These bits hold the setting for the higher-order 32 bits of the threshold for detection of synchronization.
    }

    /// SYNTDBRL Register bits
    namespace syntdbrl_bits {
        constexpr uint32_t SYNTDBRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the threshold for detection of synchronization.
    }

    /// LCIVRU Register bits
    namespace lcivru_bits {
        constexpr uint32_t LCIVRU = (16 << 0);  ///< These bits hold the setting for the higher-order 16 bits of the integer portion of the initial value for the local timer counter.
    }

    /// LCIVRM Register bits
    namespace lcivrm_bits {
        constexpr uint32_t LCIVRM = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the integer portion of the initial value for the local timer counter.
    }

    /// LCIVRL Register bits
    namespace lcivrl_bits {
        constexpr uint32_t LCIVRL = (32 << 0);  ///< These bits hold the setting for the fractional portion of the initial value of the local timer counter in nanoseconds.
    }

    /// GETW10R Register bits
    namespace getw10r_bits {
        constexpr uint32_t GW10 = (1U << 0);  ///< Worst 10 Acquisition Directive
    }

    /// PLIMITRU Register bits
    namespace plimitru_bits {
        constexpr uint32_t PLIMITRU = (31 << 0);  ///< These bits hold the setting for the higher-order 31 bits of the limit for the positive gradient.
    }

    /// PLIMITRM Register bits
    namespace plimitrm_bits {
        constexpr uint32_t PLIMITRM = (32 << 0);  ///< These bits hold the setting for the middle-order 32 bits of the limit for the positive gradient.
    }

    /// PLIMITRL Register bits
    namespace plimitrl_bits {
        constexpr uint32_t PLIMITRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the limit for the positive gradient.
    }

    /// MLIMITRU Register bits
    namespace mlimitru_bits {
        constexpr uint32_t MLIMITRU = (31 << 0);  ///< These bits hold the setting for the higher-order 31 bits of the limit for the negative gradient.
    }

    /// MLIMITRM Register bits
    namespace mlimitrm_bits {
        constexpr uint32_t MLIMITRM = (32 << 0);  ///< These bits hold the setting for the middle-order 32 bits of the limit for the negative gradient.
    }

    /// MLIMITRL Register bits
    namespace mlimitrl_bits {
        constexpr uint32_t MLIMITRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the limit for the negative gradient.
    }

    /// GETINFOR Register bits
    namespace getinfor_bits {
        constexpr uint32_t INFO = (1U << 0);  ///< Information Retention ControlNOTE: Once information fetching is directed, values of various statistical information read before completion of information fetching are not guaranteed.
    }

    /// LCCVRU Register bits
    namespace lccvru_bits {
        constexpr uint32_t LCCVRU = (16 << 0);  ///< These bits are for reading the higher-order 16 bits of the integer portion of the local timer counter's value.
    }

    /// LCCVRM Register bits
    namespace lccvrm_bits {
        constexpr uint32_t LCCVRM = (32 << 0);  ///< These bits are for reading the lower-order 32 bits of the integer portion of the local timer counter's value.
    }

    /// LCCVRL Register bits
    namespace lccvrl_bits {
        constexpr uint32_t LCCVRL = (32 << 0);  ///< These bits are for reading the fractional portion of the local timer counter's value (in nanoseconds).
    }

    /// PW10VRU Register bits
    namespace pw10vru_bits {
        constexpr uint32_t PW10VRU = (32 << 0);  ///< These bits are for reading the higher-order 32 bits of the positive gradient value.
    }

    /// PW10VRM Register bits
    namespace pw10vrm_bits {
        constexpr uint32_t PW10VRM = (32 << 0);  ///< These bits are for reading the middle-order 32 bits of the positive gradient value.
    }

    /// PW10VRL Register bits
    namespace pw10vrl_bits {
        constexpr uint32_t PW10VRL = (32 << 0);  ///< These bits are for reading the lower-order 32 bits of the positive gradient value.
    }

    /// MW10RU Register bits
    namespace mw10ru_bits {
        constexpr uint32_t MW10RU = (32 << 0);  ///< These bits are for reading the higher-order 32 bits of the negative gradient value.
    }

    /// MW10RM Register bits
    namespace mw10rm_bits {
        constexpr uint32_t MW10RM = (32 << 0);  ///< These bits are for reading the middle-order 32 bits of the negative gradient value.
    }

    /// MW10RL Register bits
    namespace mw10rl_bits {
        constexpr uint32_t MW10RL = (32 << 0);  ///< These bits are for reading the lower-order 32 bits of the negative gradient value.
    }

    /// TMSTTRU Register bits
    namespace tmsttru_bits {
        constexpr uint32_t TMSTTRU = (32 << 0);  ///< These bits hold the setting for the higher-order 32 bits of the start time of the pulse output timer in nanoseconds.
    }

    /// TMSTTRL Register bits
    namespace tmsttrl_bits {
        constexpr uint32_t TMSTTRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the start time of the pulse output timer in nanoseconds.
    }

    /// TMCYCR Register bits
    namespace tmcycr_bits {
        constexpr uint32_t TMCYCR = (30 << 0);  ///< These bits set the cycle of the pulse output timer in nanoseconds. Set a value that is equivalent to at least four cycles of the STCA clock.
    }

    /// TMPLSR Register bits
    namespace tmplsr_bits {
        constexpr uint32_t TMPLSR = (29 << 0);  ///< These bits set the width at high level of the pulse signal from the timer in nanoseconds. Set a value that is equivalent to at least two cycles of the STCA clock.
    }

    /// TMSTARTR Register bits
    namespace tmstartr_bits {
        constexpr uint32_t EN5 = (1U << 5);  ///< Pulse Output Timer 5 Start
        constexpr uint32_t EN4 = (1U << 4);  ///< Pulse Output Timer 4 Start
        constexpr uint32_t EN3 = (1U << 3);  ///< Pulse Output Timer 3 Start
        constexpr uint32_t EN2 = (1U << 2);  ///< Pulse Output Timer 2 Start
        constexpr uint32_t EN1 = (1U << 1);  ///< Pulse Output Timer 1 Start
        constexpr uint32_t EN0 = (1U << 0);  ///< Pulse Output Timer 0 Start
    }
...
namespace eptpc0 {
    /// Base addresses
    constexpr uint32_t EPTPC0_BASE = 0x40065800;

    /// EPTPC0 Register structure
    struct Registers {
        volatile uint32_t SYSR;  ///< Offset: 0x00 - SYNFP Status Register
        volatile uint32_t SYIPR;  ///< Offset: 0x04 - SYNFP Status Notification Permission Register
        volatile uint32_t SYMACRU;  ///< Offset: 0x10 - SYNFP MAC Address Registers
        volatile uint32_t SYMACRL;  ///< Offset: 0x14 - SYNFP MAC Address Registers
        volatile uint32_t SYLLCCTLR;  ///< Offset: 0x18 - SYNFP LLC-CTL Value Register
        volatile uint32_t SYIPADDRR;  ///< Offset: 0x1C - SYNFP Local IP Address Register
        volatile uint32_t SYSPVRR;  ///< Offset: 0x40 - SYNFP Specification Version Setting Register
        volatile uint32_t SYDOMR;  ///< Offset: 0x44 - SYNFP Domain Number Setting Register
        volatile uint32_t ANFR;  ///< Offset: 0x50 - Announce Message Flag Field Setting Register
        volatile uint32_t SYNFR;  ///< Offset: 0x54 - Sync Message Flag Field Setting Register
        volatile uint32_t DYRQFR;  ///< Offset: 0x58 - Delay_Req Message Flag Field Setting Register
        volatile uint32_t DYRPFR;  ///< Offset: 0x5C - Delay_Resp Message Flag Field Setting Register
        volatile uint32_t SYCIDRU;  ///< Offset: 0x60 - SYNFP Local Clock ID Registers
        volatile uint32_t SYCIDRL;  ///< Offset: 0x64 - SYNFP Local Clock ID Registers
        volatile uint32_t SYPNUMR;  ///< Offset: 0x68 - SYNFP Local Port Number Register
        volatile uint32_t SYRVLDR;  ///< Offset: 0x80 - SYNFP Register Value Load Directive Register
        volatile uint32_t SYRFL1R;  ///< Offset: 0x90 - SYNFP Reception Filter Register 1
        volatile uint32_t SYRFL2R;  ///< Offset: 0x94 - SYNFP Reception Filter Register 2
        volatile uint32_t SYTRENR;  ///< Offset: 0x98 - SYNFP Transmission Enable Register
        volatile uint32_t MTCIDU;  ///< Offset: 0xA0 - Master Clock ID Registers
        volatile uint32_t MTCIDL;  ///< Offset: 0xA4 - Master Clock ID Registers
        volatile uint32_t MTPID;  ///< Offset: 0xA8 - Master clock port number register
        volatile uint32_t SYTLIR;  ///< Offset: 0xC0 - SYNFP Transmission Interval Setting Register
        volatile uint32_t SYRLIR;  ///< Offset: 0xC4 - SYNFP Received logMessageInterval Value Indication Register
        volatile uint32_t OFMRU;  ///< Offset: 0xC8 - offsetFromMaster Value Registers
        volatile uint32_t OFMRL;  ///< Offset: 0xCC - offsetFromMaster Value Registers
        volatile uint32_t MPDRU;  ///< Offset: 0xD0 - meanPathDelay Value Registers
        volatile uint32_t MPDRL;  ///< Offset: 0xD4 - meanPathDelay Value Registers
        volatile uint32_t GMPR;  ///< Offset: 0xE0 - grandmasterPriority Field Setting Register
        volatile uint32_t GMCQR;  ///< Offset: 0xE4 - grandmasterClockQuality Field Setting Register
        volatile uint32_t GMIDRU;  ///< Offset: 0xE8 - grandmasterIdentity Field Setting Registers
        volatile uint32_t GMIDRL;  ///< Offset: 0xEC - grandmasterIdentity Field Setting Registers
        volatile uint32_t CUOTSR;  ///< Offset: 0xF0 - currentUtcOffset/timeSource Field Setting Register
        volatile uint32_t SRR;  ///< Offset: 0xF4 - stepsRemoved Field Setting Register
        volatile uint32_t PPMACRU;  ///< Offset: 0x100 - PTP-primary Message Destination MAC Address Setting Registers
        volatile uint32_t PPMACRL;  ///< Offset: 0x104 - PTP-primary Message Destination MAC Address Setting Registers
        volatile uint32_t PDMACRU;  ///< Offset: 0x108 - PTP-pdelay Message MAC Address Setting Registers
        volatile uint32_t PDMACRL;  ///< Offset: 0x10C - PTP-pdelay Message MAC Address Setting Registers
        volatile uint32_t PETYPER;  ///< Offset: 0x110 - PTP Message EtherType Setting Register
        volatile uint32_t PPIPR;  ///< Offset: 0x120 - PTP-primary Message Destination IP Address Setting Register
        volatile uint32_t PDIPR;  ///< Offset: 0x124 - PTP-pdelay Message Destination IP Address Setting Register
        volatile uint32_t PETOSR;  ///< Offset: 0x128 - PTP Event Message TOS Setting Register
        volatile uint32_t PGTOSR;  ///< Offset: 0x12C - PTP general Message TOS Setting Register
        volatile uint32_t PPTTLR;  ///< Offset: 0x130 - PTP-primary Message TTL Setting Register
        volatile uint32_t PDTTLR;  ///< Offset: 0x134 - PTP-pdelay Message TTL Setting Register
        volatile uint32_t PEUDPR;  ///< Offset: 0x138 - PTP Event Message UDP Destination Port Number Setting Register
        volatile uint32_t PGUDPR;  ///< Offset: 0x13C - PTP general Message UDP Destination Port Number Setting Register
        volatile uint32_t FFLTR;  ///< Offset: 0x140 - Frame Reception Filter Setting Register
        volatile uint32_t FMACRU;  ///< Offset: 0x160 - Frame Reception Filter MAC Address %s Setting Registers (renamed from FMACRU)
        volatile uint32_t FMACRL;  ///< Offset: 0x164 - Frame Reception Filter MAC Address %s Setting Registers (renamed from FMACRL)
        volatile uint32_t DASYMRU;  ///< Offset: 0x1C0 - Asymmetric Delay Setting Registers
        volatile uint32_t DASYMRL;  ///< Offset: 0x1C4 - Asymmetric Delay Setting Registers
        volatile uint32_t TSLATR;  ///< Offset: 0x1C8 - Timestamp Latency Setting Register
        volatile uint32_t SYCONFR;  ///< Offset: 0x1CC - SYNFP Operation Setting Register
        volatile uint32_t SYFORMR;  ///< Offset: 0x1D0 - SYNFP Frame Format Setting Register
        volatile uint32_t RSTOUTR;  ///< Offset: 0x1D4 - Response Message Reception Timeout Register
    };

    /// Peripheral instances
    inline Registers* EPTPC0 = reinterpret_cast<Registers*>(EPTPC0_BASE);

    // Bit definitions
    /// SYSR Register bits
    namespace sysr_bits {
        constexpr uint32_t GENDN = (1U << 17);  ///< Generation Stop Completion Detection Flag
        constexpr uint32_t RESDN = (1U << 16);  ///< Response Stop Completion Detection Flag
        constexpr uint32_t INFABT = (1U << 14);  ///< Control Information Abnormality Detection Flag
        constexpr uint32_t RECLP = (1U << 12);  ///< Loop Reception Detection Flag
        constexpr uint32_t DRQOVR = (1U << 6);  ///< Delay_Req Reception FIFO Overflow Detection Flag
        constexpr uint32_t INTDEV = (1U << 5);  ///< Receive logMessageInterval Value Out-of-Range Flag
        constexpr uint32_t DRPTO = (1U << 4);  ///< Delay_Resp/Pdelay_Resp Reception Timeout Detection Flag
        constexpr uint32_t MPDUD = (1U << 2);  ///< meanPathDelay Value Update Flag
        constexpr uint32_t INTCHG = (1U << 1);  ///< Receive logMessageInterval Value Change Detection Flag
        constexpr uint32_t OFMUD = (1U << 0);  ///< offsetFromMaster Value Update Flag
    }

    /// SYIPR Register bits
    namespace syipr_bits {
        constexpr uint32_t GENDN = (1U << 17);  ///< SYSR.GENDN Status Notification Permission
        constexpr uint32_t RESDN = (1U << 16);  ///< SYSR.RESDN Status Notification Permission
        constexpr uint32_t INFABT = (1U << 14);  ///< SYSR.INFABT Status Notification Permission
        constexpr uint32_t RECLP = (1U << 12);  ///< SYSR.RECLP Status Notification Permission
        constexpr uint32_t DRQOVR = (1U << 6);  ///< SYSR.DRQOVR Status Notification Permission
        constexpr uint32_t INTDEV = (1U << 5);  ///< SYSR.INTDEV Status Notification Permission
        constexpr uint32_t DRPTO = (1U << 4);  ///< SYSR.DRPTO Status Notification Permission
        constexpr uint32_t MPDUD = (1U << 2);  ///< SYSR.MPDUD Status Notification Permission
        constexpr uint32_t INTCHG = (1U << 1);  ///< SYSR.INTCHG Status Notification Permission
        constexpr uint32_t OFMUD = (1U << 0);  ///< SYSR.OFMUD Status Notification Permission
    }

    /// SYMACRU Register bits
    namespace symacru_bits {
        constexpr uint32_t SYMACRU = (24 << 0);  ///< These bits hold the setting for the higher-order 24 bits of the local MAC address.
    }

    /// SYMACRL Register bits
    namespace symacrl_bits {
        constexpr uint32_t SYMACRL = (24 << 0);  ///< These bits hold the setting for the lower-order 24 bits of the local MAC address.
    }

    /// SYLLCCTLR Register bits
    namespace syllcctlr_bits {
        constexpr uint32_t CTL = (8 << 0);  ///< LLC-CTL FieldThese bits specify the value used for the control field in the LLC sublayer when generating IEEE802.3 frames.
    }

    /// SYIPADDRR Register bits
    namespace syipaddrr_bits {
        constexpr uint32_t SYIPADDRR = (32 << 0);  ///< These bits hold the setting for the local IP address.
    }

    /// SYSPVRR Register bits
    namespace syspvrr_bits {
        constexpr uint32_t TRSP = (4 << 4);  ///< transportSpecific Field ValueThese bits are used to set the transportSpecific field value of the PTP v2 header.When a message is received, this value is compared with the transportSpecific field of the received frame.In generating messages, the value is used for the transportSpecific field of the frame for transmission.Set these bits to 0000b (IEEE 1588).
        constexpr uint32_t VER = (4 << 0);  ///< versionPTP Field ValueThese bits are used to set the versionPTP field value of the PTP v2 header.When a message is received, this value is compared with the versionPTP field of the received frame.In generating messages, the value is used for the versionPTP field of the frame for transmission.Set these bits to 0010b (PTP v2).
    }

    /// SYDOMR Register bits
    namespace sydomr_bits {
        constexpr uint32_t DNUM = (8 << 0);  ///< domainNumber Field Value SettingThese bits are used to set the domainNumber field value of the PTP v2 header.When a message is received, this value is compared with the domainNumber field of the received frame as a condition for PTP reception processing.In generating messages, the value is used for the domainNumber field of the frame for transmission.
    }

    /// ANFR Register bits
    namespace anfr_bits {
        constexpr uint32_t FLAG14 = (1U << 14);  ///< PTP profile Specific 2
        constexpr uint32_t FLAG13 = (1U << 13);  ///< PTP profile Specific 1
        constexpr uint32_t FLAG10 = (1U << 10);  ///< unicastFlag
        constexpr uint32_t FLAG8 = (1U << 8);  ///< alternateMasterFlag
        constexpr uint32_t FLAG5 = (1U << 5);  ///< frequencyTraceableThis bit is used to set the logical value of the frequencyTraceable member of timePropertiesDS.
        constexpr uint32_t FLAG4 = (1U << 4);  ///< timeTraceableThis bit is used to set the logical value of the timeTraceable member of timePropertiesDS.
        constexpr uint32_t FLAG3 = (1U << 3);  ///< ptpTimescaleThis bit is used to set the logical value of the ptpTimescale member of timePropertiesDS.
        constexpr uint32_t FLAG2 = (1U << 2);  ///< currentUtcOffsetValidThis bit is used to set the logical value of the currentUtcOffsetValid member of timePropertiesDS.
        constexpr uint32_t FLAG1 = (1U << 1);  ///< leap59This bit is used to set the logical value of the leap59 member of timePropertiesDS.
        constexpr uint32_t FLAG0 = (1U << 0);  ///< leap61This bit is used to set the logical value of the leap61 member of timePropertiesDS.
    }

    /// SYNFR Register bits
    namespace synfr_bits {
        constexpr uint32_t FLAG14 = (1U << 14);  ///< PTP profile Specific 2
        constexpr uint32_t FLAG13 = (1U << 13);  ///< PTP profile Specific 1
        constexpr uint32_t FLAG10 = (1U << 10);  ///< unicastFlag
        constexpr uint32_t FLAG9 = (1U << 9);  ///< twoStepFlag
        constexpr uint32_t FLAG8 = (1U << 8);  ///< alternateMasterFlag
    }

    /// DYRQFR Register bits
    namespace dyrqfr_bits {
        constexpr uint32_t FLAG14 = (1U << 14);  ///< PTP profile Specific 2
        constexpr uint32_t FLAG13 = (1U << 13);  ///< PTP profile Specific 1
        constexpr uint32_t FLAG10 = (1U << 10);  ///< unicastFlag
    }

    /// DYRPFR Register bits
    namespace dyrpfr_bits {
        constexpr uint32_t FLAG14 = (1U << 14);  ///< PTP profile Specific 2
        constexpr uint32_t FLAG13 = (1U << 13);  ///< PTP profile Specific 1
        constexpr uint32_t FLAG10 = (1U << 10);  ///< unicastFlag
        constexpr uint32_t FLAG9 = (1U << 9);  ///< woStepFlag
        constexpr uint32_t FLAG8 = (1U << 8);  ///< alternateMasterFlag
    }

    /// SYCIDRU Register bits
    namespace sycidru_bits {
        constexpr uint32_t SYCIDRU = (32 << 0);  ///< These bits hold the setting for the higher-order 32 bits of the clock-ID of your port.
    }

    /// SYCIDRL Register bits
    namespace sycidrl_bits {
        constexpr uint32_t SYCIDRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the clock-ID of your port.
    }

    /// SYPNUMR Register bits
    namespace sypnumr_bits {
        constexpr uint32_t PNUM = (16 << 0);  ///< Local Port Number SettingThese bits hold the setting for the port number of the local port.
    }

    /// SYRVLDR Register bits
    namespace syrvldr_bits {
        constexpr uint32_t ANUP = (1U << 2);  ///< Announce Message Generation Information Update
        constexpr uint32_t STUP = (1U << 1);  ///< State Update
        constexpr uint32_t BMUP = (1U << 0);  ///< BMC Update
    }

    /// SYRFL1R Register bits
    namespace syrfl1r_bits {
        constexpr uint32_t PDFUP2 = (1U << 30);  ///< Pdelay_Resp_Follow_Up Message Processing
        constexpr uint32_t PDFUP0 = (1U << 28);  ///< Pdelay_Resp_Follow_Up Message Processing
        constexpr uint32_t PDRP2 = (1U << 26);  ///< Pdelay_Resp Message Processing
        constexpr uint32_t PDRP0 = (1U << 24);  ///< Pdelay_Resp Message Processing
        constexpr uint32_t PDRQ2 = (1U << 22);  ///< Pdelay_Req Message Processing
        constexpr uint32_t PDRQ0 = (1U << 20);  ///< Pdelay_Req Message Processing
        constexpr uint32_t DRP2 = (1U << 18);  ///< Delay_Resp Message Processing
        constexpr uint32_t DRP0 = (1U << 16);  ///< Delay_Resp Message Processing
        constexpr uint32_t DRQ2 = (1U << 14);  ///< Delay_Req Message Processing
        constexpr uint32_t DRQ0 = (1U << 12);  ///< Delay_Req Message Processing
        constexpr uint32_t FUP2 = (1U << 10);  ///< Follow_Up Message Processing
        constexpr uint32_t FUP0 = (1U << 8);  ///< Follow_Up Message Processing
        constexpr uint32_t SYNC2 = (1U << 6);  ///< Sync Message Processing
        constexpr uint32_t SYNC0 = (1U << 4);  ///< Sync Message Processing
        constexpr uint32_t ANCE0 = (1U << 0);  ///< Announce Message Processing
    }

    /// SYRFL2R Register bits
    namespace syrfl2r_bits {
        constexpr uint32_t ILL0 = (1U << 28);  ///< Illegal Message Processing Setting
        constexpr uint32_t SIG0 = (1U << 4);  ///< Signaling Message Processing Setting
        constexpr uint32_t MAN0 = (1U << 0);  ///< Management Message Processing Setting
    }

    /// SYTRENR Register bits
    namespace sytrenr_bits {
        constexpr uint32_t PDRQ = (1U << 12);  ///< Pdelay_Req Message Transmission Enable
        constexpr uint32_t DRQ = (1U << 8);  ///< Delay_Req Message Transmission Enable
        constexpr uint32_t SYNC = (1U << 4);  ///< Sync Message Transmission Enable
        constexpr uint32_t ANCE = (1U << 0);  ///< Announce Message Transmission Enable
    }

    /// MTCIDU Register bits
    namespace mtcidu_bits {
        constexpr uint32_t MTCIDU = (32 << 0);  ///< These bits hold the setting for the higher-order 32 bits of the clock-ID of the master clock.
    }

    /// MTCIDL Register bits
    namespace mtcidl_bits {
        constexpr uint32_t MTCIDL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the clock-ID of the master clock.
    }

    /// MTPID Register bits
    namespace mtpid_bits {
        constexpr uint32_t PNUM = (16 << 0);  ///< Master Clock Port Number SettingThese bits hold the setting for the port number of the master clock.
    }

    /// SYTLIR Register bits
    namespace sytlir_bits {
        constexpr uint32_t DREQ = (8 << 16);  ///< Delay_Req Transmission Interval Average Value/ Pdelay_Req Transmission Interval SettingThe bits set the average interval for the transmission of Delay_Req messages and the interval for the transmission of Pdelay_Req messages.The setting is also placed in the logMessageInterval field of Delay_Resp messages.
        constexpr uint32_t SYNC = (8 << 8);  ///< Sync Message Transmission Interval SettingThese bits set the interval for the transmission of Sync messages. The setting is also placed in the logMessageInterval field of transmitted Sync messages.
        constexpr uint32_t ANCE = (8 << 0);  ///< Announce Message Transmission Interval SettingThese bits set the interval for the transmission of Announce messages.
    }

    /// SYRLIR Register bits
    namespace syrlir_bits {
        constexpr uint32_t DRESP = (8 << 16);  ///< Delay_Resp Message logMessageInterval Field IndicationThese bits indicate the logMessageInterval field value of a received Delay_Resp message.
        constexpr uint32_t SYNC = (8 << 8);  ///< Sync Message logMessageInterval Field IndicationThese bits indicate the logMessageInterval field value of a received Sync message.
        constexpr uint32_t ANCE = (8 << 0);  ///< Announce Message logMessageInterval Field IndicationThese bits indicate the logMessageInterval field value of a received Announce message.
    }

    /// OFMRU Register bits
    namespace ofmru_bits {
        constexpr uint32_t OFMRU = (32 << 0);  ///< These bits indicate the higher-order 32 bits of the calculated offsetFromMaster value.
    }

    /// OFMRL Register bits
    namespace ofmrl_bits {
        constexpr uint32_t OFMRL = (32 << 0);  ///< These bits indicate the lower-order 32 bits of the calculated offsetFromMaster value.
    }

    /// MPDRU Register bits
    namespace mpdru_bits {
        constexpr uint32_t MPDRU = (32 << 0);  ///< These bits indicate the higher-order 32 bits of the calculated meanPathDelay value.
    }

    /// MPDRL Register bits
    namespace mpdrl_bits {
        constexpr uint32_t MPDRL = (32 << 0);  ///< These bits indicate the lower-order 32 bits of the calculated meanPathDelay value.
    }

    /// GMPR Register bits
    namespace gmpr_bits {
        constexpr uint32_t GMPR1 = (8 << 16);  ///< grandmasterPriority1 Field Value SettingThese bits are used to set the value of the grandmasterPriority1 fields of Announce messages.
        constexpr uint32_t GMPR2 = (8 << 0);  ///< grandmasterPriority2 Field Value SettingThese bits are used to set the value of the grandmasterPriority2 fields of Announce messages.
    }

    /// GMCQR Register bits
    namespace gmcqr_bits {
        constexpr uint32_t GMCQR = (32 << 0);  ///< These bits are used to set the value of the grandmasterClockQuality fields of Announce messages. The correspondence between bits and the grandmasterClockQuality fields is as listed below.b31 to b24: clockClassb23 to b16: clockAccuracyb15 to b0: offsetScaledLogVariance
    }

    /// GMIDRU Register bits
    namespace gmidru_bits {
        constexpr uint32_t GMIDRU = (32 << 0);  ///< These bits hold the setting for the higher-order 32 bits of the value of the grandmasterIdentity fields of Announce messages.
    }

    /// GMIDRL Register bits
    namespace gmidrl_bits {
        constexpr uint32_t GMIDRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the value of the grandmasterIdentity fields of Announce messages.
    }

    /// CUOTSR Register bits
    namespace cuotsr_bits {
        constexpr uint32_t CUTO = (16 << 16);  ///< currentUtcOffset Field SettingThese bits set the value of the currentUtcOffset fields of Announce messages.
        constexpr uint32_t TSRC = (8 << 0);  ///< timeSource Field SettingThese bits set the value of the timeSource fields of Announce messages.
    }

    /// SRR Register bits
    namespace srr_bits {
        constexpr uint32_t SRMV = (16 << 0);  ///< stepsRemoved Field Value SettingThese bits set the value of the stepsRemoved fields of Announce messages.
    }

    /// PPMACRU Register bits
    namespace ppmacru_bits {
        constexpr uint32_t PPMACRU = (24 << 0);  ///< These bits hold the setting for the higher-order 24 bits of the destination MAC address for PTP-primary messages.
    }

    /// PPMACRL Register bits
    namespace ppmacrl_bits {
        constexpr uint32_t PPMACRL = (24 << 0);  ///< These bits hold the setting for the lower-order 24 bits of the destination MAC address for PTP-primary messages.
    }

    /// PDMACRU Register bits
    namespace pdmacru_bits {
        constexpr uint32_t PDMACRU = (24 << 0);  ///< These bits hold the setting for the higher-order 24 bits of the destination MAC address for PTP-pdelay messages.
    }

    /// PDMACRL Register bits
    namespace pdmacrl_bits {
        constexpr uint32_t PDMACRL = (24 << 0);  ///< These bits hold the setting for the lower-order 24 bits of the destination MAC address for PTP-pdelay messages.
    }

    /// PETYPER Register bits
    namespace petyper_bits {
        constexpr uint32_t TYPE = (16 << 0);  ///< PTP Message EtherType Value SettingThese bits hold the setting for the EtherType field value for frames in the Ethernet II format.
    }

    /// PPIPR Register bits
    namespace ppipr_bits {
        constexpr uint32_t PPIPR = (32 << 0);  ///< These bits hold the setting for the destination IP address for PTPprimary messages.
    }

    /// PDIPR Register bits
    namespace pdipr_bits {
        constexpr uint32_t PDIPR = (32 << 0);  ///< These bits hold the setting for the destination IP address for PTPpdelay messages.
    }

    /// PETOSR Register bits
    namespace petosr_bits {
        constexpr uint32_t EVTO = (8 << 0);  ///< PTP Event Message TOS Field Value SettingThese bits hold the setting for the value of the TOS field within the IPv4 headers of PTP event messages.
    }

    /// PGTOSR Register bits
    namespace pgtosr_bits {
        constexpr uint32_t GETO = (8 << 0);  ///< PTP general Message TOS Field Value SettingThese bits hold the setting for the value of the TOS field within the IPv4 headers of PTP general messages.
    }

    /// PPTTLR Register bits
    namespace ppttlr_bits {
        constexpr uint32_t PRTL = (8 << 0);  ///< PTP-primary Message TTL Field Value SettingThese bits hold the setting for the value of the TTL field within the IPv4 headers of PTP-primary messages.
    }

    /// PDTTLR Register bits
    namespace pdttlr_bits {
        constexpr uint32_t PDTL = (8 << 0);  ///< PTP-pdelay Message TTL Field ValueThese bits hold the setting for the value of the TTL field within the IPv4 headers of PTP-pdelay messages.
    }

    /// PEUDPR Register bits
    namespace peudpr_bits {
        constexpr uint32_t EVUPT = (16 << 0);  ///< PTP Event Message Destination Port Number SettingThese bits hold the setting for the value of the destination port number field within the UDP headers of PTP event messages.
    }

    /// PGUDPR Register bits
    namespace pgudpr_bits {
        constexpr uint32_t GEUPT = (16 << 0);  ///< PTP general Message Destination Port NumberThese bits hold the setting for the value of the destination port number field within the UDP headers of PTP general messages.
    }

    /// FFLTR Register bits
    namespace ffltr_bits {
        constexpr uint32_t EXTPRM = (1U << 16);  ///< Extended Promiscuous ModeSetting
        constexpr uint32_t ENB = (1U << 2);  ///< Reception Filter EnableNOTE: The setting of these bits is only effective when EXTPRM=0.
        constexpr uint32_t PRT = (1U << 1);  ///< Frame Reception EnableNOTE: The setting of these bits is only effective when EXTPRM=0 and ENB=1.
        constexpr uint32_t SEL = (1U << 0);  ///< Receive MAC Address SelectNOTE: The setting of these bits is only effective when EXTPRM=0, ENB=1and RPT=1.
    }

    /// FMACRU Register bits
    namespace fmacru_bits {
        constexpr uint32_t FMACRU = (24 << 0);  ///< These bits hold the setting for the higher-order 24 bits of the destination MAC address for received multicast frames.
    }

    /// FMACRL Register bits
    namespace fmacrl_bits {
        constexpr uint32_t FMACRL = (24 << 0);  ///< These bits hold the setting for the lower-order 24 bits of the destination MAC address for received multicast frames.
    }

    /// DASYMRU Register bits
    namespace dasymru_bits {
        constexpr uint32_t DASYMRU = (16 << 0);  ///< These bits hold the setting for the higher-order 16 bits of the asymmetric delay value.
    }

    /// DASYMRL Register bits
    namespace dasymrl_bits {
        constexpr uint32_t DASYMRL = (32 << 0);  ///< These bits hold the setting for the lower-order 32 bits of the asymmetric delay value.
    }

    /// TSLATR Register bits
    namespace tslatr_bits {
        constexpr uint32_t INGP = (16 << 16);  ///< Output Port Timestamp Latency SettingThese bits hold the setting for the time stamp latency (ns) for the output ports.
        constexpr uint32_t EGP = (16 << 0);  ///< Input Port Timestamp Latency SettingThese bits hold the setting for the time stamp latency (ns) for the input ports.
    }

    /// SYCONFR Register bits
    namespace syconfr_bits {
        constexpr uint32_t FILDIS = (1U << 16);  ///< Receive Message domainNumber Filter Disable
        constexpr uint32_t SBDIS = (1U << 12);  ///< Sync Message Transmission Bandwidth Securing Disable
        constexpr uint32_t TCYC = (8 << 0);  ///< PTP Message Transmission Interval SettingThese bits are used to set the time from the completion of one transmission to the start of the next in cycles of the transmission clock. A value n in these bits means that a transmission interval of n cycles will be secured.No interval is secured if the setting is 00h.We recommend the setting 28h (40 cycles).
    }

    /// SYFORMR Register bits
    namespace syformr_bits {
        constexpr uint32_t FORM1 = (1U << 1);  ///< Ethernet Frame Format Setting
        constexpr uint32_t FORM0 = (1U << 0);  ///< Ethernet/UDP Encapsulation
    }

    /// RSTOUTR Register bits
    namespace rstoutr_bits {
        constexpr uint32_t RSTOUTR = (32 << 0);  ///< Response Message Reception Timeout Time SettingA response message not being received within n x 1024 (ns), where n is the setting, is judged to represent a timeout.
    }
...
namespace mmpu {
    ...
    struct Registers {
        volatile uint32_t MMPUCTL;  ///< Offset: 0x00 - Bus Master MPU Control Register (renamed from MMPUCTL)
        volatile uint32_t MMPUACA;  ///< Offset: 0x200 - Group A Region %s Access Control Register (renamed from MMPUACA)
        volatile uint32_t MMPUACB;  ///< Offset: 0x600 - Group B Region %s Access Control Register (renamed from MMPUACB)
        volatile uint32_t MMPUACC;  ///< Offset: 0xA00 - Group C Region %s Access Control Register (renamed from MMPUACC)
        volatile uint32_t MMPUSA;  ///< Offset: 0x204 - Group A Region %s Start Address Register (renamed from MMPUSA)
        volatile uint32_t MMPUSB;  ///< Offset: 0x604 - Group B Region %s Start Address Register (renamed from MMPUSB)
        volatile uint32_t MMPUSC;  ///< Offset: 0xA04 - Group C Region %s Start Address Register (renamed from MMPUSC)
        volatile uint32_t MMPUEA;  ///< Offset: 0x208 - Group A Region %s End Address Register (renamed from MMPUEA)
        volatile uint32_t MMPUEB;  ///< Offset: 0x608 - Group B Region %s End Address Register (renamed from MMPUEB)
        volatile uint32_t MMPUEC;  ///< Offset: 0xA08 - Group C Region %s End Address Register (renamed from MMPUEC)
    ...
    // Bit definitions
    /// MMPUCTL Register bits
    namespace mmpuctl_bits {
    ...
    /// MMPUACB Register bits
    namespace mmpuacb_bits {
        constexpr uint32_t WP = (1U << 2);  ///< Write protection
        constexpr uint32_t RP = (1U << 1);  ///< Read protection
        constexpr uint32_t ENABLE = (1U << 0);  ///< Region enable
    }

    /// MMPUACC Register bits
    namespace mmpuacc_bits {
        constexpr uint32_t WP = (1U << 2);  ///< Write protection
        constexpr uint32_t RP = (1U << 1);  ///< Read protection
        constexpr uint32_t ENABLE = (1U << 0);  ///< Region enable
    }
    ...
    /// MMPUSB Register bits
    namespace mmpusb_bits {
    ...
    /// MMPUSC Register bits
    namespace mmpusc_bits {
    ...
    /// MMPUEB Register bits
    namespace mmpueb_bits {
    ...
    /// MMPUEC Register bits
    namespace mmpuec_bits {
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t ADSSTR0;  ///< Offset: 0xE0 - A/D Sampling State Register %s (Corresponding Channel is AN00%s ) (renamed from ADSSTR0)
...
namespace rtc {
    ...
    /// BCNT0CP Register bits
    namespace bcnt0cp_bits {
    ...
    /// BCNT1CP Register bits
    namespace bcnt1cp_bits {
    ...
    /// BCNT2CP Register bits
    namespace bcnt2cp_bits {
    ...
    /// BCNT3CP Register bits
    namespace bcnt3cp_bits {
...
namespace bus {
    ...
    struct Registers {
        ...
        volatile uint32_t CSCR;  ///< Offset: 0x812 - CS%s Control Register (renamed from CSCR)
        ...
        volatile uint32_t BUSMCNT;  ///< Offset: 0x1010 - Master Bus Control Register %s (renamed from BUSMCNT)
...
namespace jpeg {
    /// Base addresses
    constexpr uint32_t JPEG_BASE = 0x400E6000;

    /// JPEG Register structure
    struct Registers {
        volatile uint32_t JCMOD;  ///< Offset: 0x00 - JPEG Code Mode Register
        volatile uint32_t JCCMD;  ///< Offset: 0x01 - JPEG Code Command Register
        volatile uint32_t JCQTN;  ///< Offset: 0x03 - JPEG Code Quantization Table Number Register
        volatile uint32_t JCHTN;  ///< Offset: 0x04 - JPEG Code Huffman Table Number Register
        volatile uint32_t JCDRIU;  ///< Offset: 0x05 - JPEG Code DRI Upper Register
        volatile uint32_t JCDRID;  ///< Offset: 0x06 - JPEG Code DRI Lower Register
        volatile uint32_t JCVSZU;  ///< Offset: 0x07 - JPEG Code Vertical Size Upper Register
        volatile uint32_t JCVSZD;  ///< Offset: 0x08 - JPEG Code Vertical Size Lower Register
        volatile uint32_t JCHSZU;  ///< Offset: 0x09 - JPEG Code Horizontal Size Upper Register
        volatile uint32_t JCHSZD;  ///< Offset: 0x0A - JPEG Coded Horizontal Size Lower Register
        volatile uint32_t JCDTCU;  ///< Offset: 0x0B - JPEG Code Data Count Upper Register
        volatile uint32_t JCDTCM;  ///< Offset: 0x0C - JPEG Code Data Count Middle Register
        volatile uint32_t JCDTCD;  ///< Offset: 0x0D - JPEG Code Data Count Lower Register
        volatile uint32_t JINTE0;  ///< Offset: 0x0E - JPEG Interrupt Enable Register 0
        volatile uint32_t JINTS0;  ///< Offset: 0x0F - JPEG Interrupt Status Register 0
        volatile uint32_t JCDERR;  ///< Offset: 0x10 - JPEG Code Decode Error Register
        volatile uint32_t JCRST;  ///< Offset: 0x11 - JPEG Code Reset Register
        volatile uint32_t JIFECNT;  ///< Offset: 0x40 - JPEG Interface Compression Control Register
        volatile uint32_t JIFESA;  ///< Offset: 0x44 - JPEG Interface Compression Source Address Register
        volatile uint32_t JIFESOFST;  ///< Offset: 0x48 - JPEG Interface Compression Line Offset Register
        volatile uint32_t JIFEDA;  ///< Offset: 0x4C - JPEG Interface Compression Destination Address Register
        volatile uint32_t JIFESLC;  ///< Offset: 0x50 - JPEG Interface Compression Source Line Count Register
        volatile uint32_t JIFDCNT;  ///< Offset: 0x58 - JPEG Interface Decompression Control Register
        volatile uint32_t JIFDSA;  ///< Offset: 0x5C - JPEG Interface Decompression Source Address Register
        volatile uint32_t JIFDDOFST;  ///< Offset: 0x60 - JPEG Interface Decompression Line Offset Register
        volatile uint32_t JIFDDA;  ///< Offset: 0x64 - JPEG Interface Decompression Destination Address Register
        volatile uint32_t JIFDSDC;  ///< Offset: 0x68 - JPEG Interface Decompression Source Data Count Register
        volatile uint32_t JIFDDLC;  ///< Offset: 0x6C - JPEG Interface Decompression Destination Line Count Register
        volatile uint32_t JIFDADT;  ///< Offset: 0x70 - JPEG Interface Decompression alpha Set Register
        volatile uint32_t JINTE1;  ///< Offset: 0x8C - JPEG Interrupt Enable Register 1
        volatile uint32_t JINTS1;  ///< Offset: 0x90 - JPEG Interrupt Status Register 1
    };
    ...
    // Bit definitions
    /// JCMOD Register bits
    namespace jcmod_bits {
        constexpr uint32_t DSP = (1U << 3);  ///< Compression/Decompression Set Note: When changing between processing for compression and for decompression, be sure to reset this module in advance by setting the JCUSRST bit in the software reset control register 2 (SWRSTCR2) of the power-downmodes.
        constexpr uint32_t REDU = (3 << 0);  ///< Pixel FormatNOTE: Read-only in Decompression.
    }

    /// JCCMD Register bits
    namespace jccmd_bits {
        constexpr uint32_t BRST = (1U << 7);  ///< Bus Reset. NOTE: When this module is in operation, the bus reset command should not be issued.
        constexpr uint32_t JEND = (1U << 2);  ///< Interrupt Request Clear Command This bit is valid only for the interrupt sources corresponding to bits INS6, INS5, and INS3 in JINTS0. To clear an interrupt request, set this bit to 1
        constexpr uint32_t JRST = (1U << 1);  ///< JPEG Core Process Stop Clear CommandTo clear the process-stopped state caused by requests to read the image size and pixel format (enabled by the INT3 bit in JINTE0), set this bit to 1.
        constexpr uint32_t JSRT = (1U << 0);  ///< JPEG Core Process Start CommandTo start JPEG core processing, set this bit to 1. Do not write this bit to 1 again while this module is in operation.
    }

    /// JCQTN Register bits
    namespace jcqtn_bits {
        constexpr uint32_t QT3 = (2 << 4);  ///< Quantization table number for the third color component NOTE: Read-only in Decompression.
        constexpr uint32_t QT2 = (2 << 2);  ///< Quantization table number for the second color component NOTE: Read-only in Decompression.
        constexpr uint32_t QT1 = (2 << 0);  ///< Quantization table number for the first color componentNOTE: Read-only in Decompression.
    }

    /// JCHTN Register bits
    namespace jchtn_bits {
        constexpr uint32_t HTA3 = (1U << 5);  ///< Huffman table number (AC) for the third color componentNOTE: Read-only in Decompression.
        constexpr uint32_t HTD3 = (1U << 4);  ///< Huffman table number (DC) for the third color component NOTE: Read-only in Decompression.
        constexpr uint32_t HTA2 = (1U << 3);  ///< Huffman table number (AC) for the second color componentNOTE: Read-only in Decompression.
        constexpr uint32_t HTD2 = (1U << 2);  ///< Huffman table number (DC) for the second color component NOTE: Read-only in Decompression.
        constexpr uint32_t HTA1 = (1U << 1);  ///< Huffman table number (AC) for the first color componentNOTE: Read-only in Decompression.
        constexpr uint32_t HTD1 = (1U << 0);  ///< Huffman table number (DC) for the first color component NOTE: Read-only in Decompression.
    }

    /// JCDRIU Register bits
    namespace jcdriu_bits {
        constexpr uint32_t DRIU = (8 << 0);  ///< Upper Bytes of MCUs Preceding RST MarkerWhen both upper and lower bytes are set to 00h, neither a DRI nor an RST marker is placed.NOTE: Read-only in Decompression.
    }

    /// JCDRID Register bits
    namespace jcdrid_bits {
        constexpr uint32_t DRID = (8 << 0);  ///< Lower Bytes of MCUs Preceding RST MarkerWhen both upper and lower bytes are set to 00h, neither a DRI nor an RST marker is placed.NOTE: Read-only in Decompression.
    }

    /// JCVSZU Register bits
    namespace jcvszu_bits {
        constexpr uint32_t VSZU = (8 << 0);  ///< Upper Bytes of Vertical Image SizeIn decompression process, a downloaded value from the JPEG coded data is set. NOTE: Read-only in Decompression.
    }

    /// JCVSZD Register bits
    namespace jcvszd_bits {
        constexpr uint32_t VSZD = (8 << 0);  ///< Lower Bytes of Vertical Image SizeIn decompression process, a downloaded value from the JPEG coded data is set. NOTE: Read-only in Decompression.
    }

    /// JCHSZU Register bits
    namespace jchszu_bits {
        constexpr uint32_t HSZU = (8 << 0);  ///< Upper Bytes of Horizontal Image SizeIn decompression process, a downloaded value from the JPEG coded data is set. NOTE: Read-only in Decompression.
    }

    /// JCHSZD Register bits
    namespace jchszd_bits {
        constexpr uint32_t HSZD = (8 << 0);  ///< Lower Bytes of Horizontal Image SizeIn decompression process, a downloaded value from the JPEG coded data is set. NOTE: Read-only in Decompression.
    }

    /// JCDTCU Register bits
    namespace jcdtcu_bits {
        constexpr uint32_t DCU = (8 << 0);  ///< Upper bytes of the counted amount of data to be compressed The values of this register are reset before compression starts.NOTE: Read-only in Decompression.
    }

    /// JCDTCM Register bits
    namespace jcdtcm_bits {
        constexpr uint32_t DCM = (8 << 0);  ///< Middle bytes of the counted amount of data to be compressedThe values of this register are reset before compression starts. NOTE: Read-only in Decompression.
    }

    /// JCDTCD Register bits
    namespace jcdtcd_bits {
        constexpr uint32_t DCD = (8 << 0);  ///< Lower bytes of the counted amount of data to be compressedThe values of this register are reset before compression starts.NOTE: Read-only in Decompression.
    }

    /// JINTE0 Register bits
    namespace jinte0_bits {
        constexpr uint32_t INT7 = (1U << 7);  ///< This bit enables an interrupt to be generated when the number of data in the restart interval of the Huffman-coding segment is not correct in decompression.When this bit is not set to enable interrupt generation, an error code is not returned.
        constexpr uint32_t INT6 = (1U << 6);  ///< This bit enables an interrupt to be generated when the total number of data in the Huffman-coding segment is not correct in decompression. When this bit is not set to enable interrupt generation, an error code is not returned.
        constexpr uint32_t INT5 = (1U << 5);  ///< This bit enables an interrupt to be generated when the final number of MCU data in the Huffman-coding segment is not correct in decompression. When this bit is not set to enable interrupt generation, an error code is not returned.
        constexpr uint32_t INT3 = (1U << 3);  ///< This bit enables an interrupt to be generated when it has been determined that the image size and the subsampling setting of the compressed data can be read through analyzing the data.
    }

    /// JINTS0 Register bits
    namespace jints0_bits {
        constexpr uint32_t INS6 = (1U << 6);  ///< This bit is set to 1 when this module completes compression process normally.
        constexpr uint32_t INS5 = (1U << 5);  ///< This bit is set to 1 when a compressed data error occurs.
        constexpr uint32_t INS3 = (1U << 3);  ///< This bit is set to 1 when the image size and pixel format can be read. When an interrupt occurs, this module stops processing and the state is indicated by the JCRST register. To make this module resume processing, set the JPEG core process stop clear command bit (JRST) in JCCMD.
    }

    /// JCDERR Register bits
    namespace jcderr_bits {
        constexpr uint32_t ERR = (4 << 0);  ///< Error Code (See tables )Identify the type of the error which has occurred in the compressed data analysis for decompression.
    }

    /// JCRST Register bits
    namespace jcrst_bits {
        constexpr uint32_t RST = (1U << 0);  ///< Operating State
    }

    /// JIFECNT Register bits
    namespace jifecnt_bits {
        constexpr uint32_t JOUTSWAP = (3 << 8);  ///< Byte/Halfword/Word Swap Output coded data in compression is swapped.
        constexpr uint32_t DINRINI = (1U << 6);  ///< Address Initialization when Resuming Input of Image Data Lines This bit is only valid when the count mode for stopping the input of image data lines is on. Set this bit before writing 1 to the data-line resume command bit.
        constexpr uint32_t DINRCMD = (1U << 5);  ///< Input Image Data Lines Resume Command This bit is valid only when the count mode for stopping the input of image data lines is on. Setting this bit to 1 resumes reading input image data. This bit is always read as 0.
        constexpr uint32_t DINLC = (1U << 4);  ///< Count Mode Setting for Stopping Input Image Data Lines
        constexpr uint32_t DINSWAP = (3 << 0);  ///< Byte/Halfword Swap
    }

    /// JIFESA Register bits
    namespace jifesa_bits {
        constexpr uint32_t ESA = (32 << 0);  ///< Input Image Data Source Address (in 8-byte units) The lower three bits should be set to 0.
    }

    /// JIFESOFST Register bits
    namespace jifesofst_bits {
        constexpr uint32_t ESMW = (15 << 0);  ///< Input Image Data Lines Offset(in 8-byte units)The lower three bits should be set to 0.
    }

    /// JIFEDA Register bits
    namespace jifeda_bits {
        constexpr uint32_t EDA = (32 << 0);  ///< Input Image Data Lines Offset (in 8-byte units) The lower three bits should be set to 0.
    }

    /// JIFESLC Register bits
    namespace jifeslc_bits {
        constexpr uint32_t LINES = (16 << 0);  ///< Number of Input Image Data Lines to be Read (in 8-line units) The lower three bits should be set to 0.
    }

    /// JIFDCNT Register bits
    namespace jifdcnt_bits {
        constexpr uint32_t VINTER = (2 << 28);  ///< Vertical SubsamplingSubsamples vertical output image data.
        constexpr uint32_t HINTER = (2 << 26);  ///< Horizontal Subsampling Subsamples horizontal output image data.
        constexpr uint32_t OPF = (2 << 24);  ///< Specifies output image data pixel format.
        constexpr uint32_t JINRINI = (1U << 14);  ///< Address Initialization when Input Coded Data is Resumed This bit is only valid when the count mode for stopping the input of coded data is on. Set this bit before writing 1 to the data resume command bit.
        constexpr uint32_t JINRCMD = (1U << 13);  ///< Input Coded Data Resume CommandThis bit is valid only when the count mode for stopping the input of coded data is on. Setting this bit to 1 resumes reading input coded data. This bit is always read as 0.
        constexpr uint32_t JINC = (1U << 12);  ///< Count Mode Setting for Stopping Input Coded Data
        constexpr uint32_t JINSWAP = (3 << 8);  ///< Byte/Word/Longword Swap Input coded data in decompression is swapped.
        constexpr uint32_t DOUTRINI = (1U << 6);  ///< Address Initialization when Resuming Output of Image Data Lines This bit is only valid when the count mode for stopping the output of image data lines is on. Set this bit before writing 1 to the data-line resume command bit.
        constexpr uint32_t DOUTRCMD = (1U << 5);  ///< Output Image Data Lines Resume Command This bit is valid only when the count mode for stopping the output of image data lines is on. Setting this bit to 1 resumes writing image data. This bit is always read as 0.
        constexpr uint32_t DOUTLC = (1U << 4);  ///< Count Mode for Stopping Output Image Data Lines
        constexpr uint32_t DOUTSWAP = (3 << 0);  ///< Byte/Word Swap Output image data in decompression is swapped.
    }

    /// JIFDSA Register bits
    namespace jifdsa_bits {
        constexpr uint32_t DSA = (32 << 0);  ///< Input Coded Data Source AddressInput Coded Data Source Address (in 8-byte units) The lower three bits should be set to 0.
    }

    /// JIFDDOFST Register bits
    namespace jifddofst_bits {
        constexpr uint32_t DDMW = (15 << 0);  ///< Output Image Data Lines Offset (in 8-byte units) The lower three bits should be set to 0.
    }

    /// JIFDDA Register bits
    namespace jifdda_bits {
        constexpr uint32_t DDA = (32 << 0);  ///< Output Image Data Destination Address (in 8-byte units) The lower three bits should be set to 0.
    }

    /// JIFDSDC Register bits
    namespace jifdsdc_bits {
        constexpr uint32_t JDATAS = (16 << 0);  ///< Amount of Input Coded Data to be Read (in 8-byte units) The lower three bits should be set to 0.
    }

    /// JIFDDLC Register bits
    namespace jifddlc_bits {
        constexpr uint32_t LINES = (16 << 0);  ///< Number of Input Image Lines to Be ReadThe lower three bits should be set to 0. These bits are read as0.Number of input image data lines to be read, in 8-line units.
    }

    /// JIFDADT Register bits
    namespace jifdadt_bits {
        constexpr uint32_t ALPHA = (8 << 0);  ///< Setting of the alpha value for output in ARGB8888 format.
    }

    /// JINTE1 Register bits
    namespace jinte1_bits {
        constexpr uint32_t CBTEN = (1U << 6);  ///< Enables or disables a data transfer processing interrupt request (JDTI) when the CBTF bit in JINTS1 is set to 1.
        constexpr uint32_t DINLEN = (1U << 5);  ///< Enables or disables a data transfer processing interrupt request (JDTI) when the DINLF bit in JINTS1 is set to 1.
        constexpr uint32_t DBTEN = (1U << 2);  ///< Enables or disables a data transfer processing interrupt request (JDTI) when the DBTF bit in JINTS1 is set to 1.
        constexpr uint32_t JINEN = (1U << 1);  ///< Enables or disables a data transfer processing interrupt request (JDTI) when the JINF bit in JINTS1 is set to 1.
        constexpr uint32_t DOUTLEN = (1U << 0);  ///< Enables or disables a data transfer processing interrupt request (JDTI) when the DOUTLF bit in JINTS1 is set to 1
    }

    /// JINTS1 Register bits
    namespace jints1_bits {
        constexpr uint32_t CBTF = (1U << 6);  ///< This bit is set to 1 when the last output coded data is written in compression.
        constexpr uint32_t DINLF = (1U << 5);  ///< This bit is set to 1 when the number of input image data lines indicated by JIFESLC is read in compression. This bit is valid only when the DINLC bit in JIFECNT is set to 1.
        constexpr uint32_t DBTF = (1U << 2);  ///< This bit is set to 1 when the last output image data is written in decompression.
        constexpr uint32_t JINF = (1U << 1);  ///< This bit is set to 1 when the amount of input coded data indicated by JIFDSDC is read in decompression. This bit is valid only when the JINC bit in JIFDCNT is set to 1.
        constexpr uint32_t DOUTLF = (1U << 0);  ///< In decompression, this bit is set to 1 when the number of lines of output image data indicated by JIFDDLC have been written. This bit is only valid when the DOUTLC bit in JIFDCNT is set to 1.
    }
...
#endif // ALLOY_GENERATED_R7FA6M3AH_PERIPHERALS_HPP