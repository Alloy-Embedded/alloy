/// Auto-generated code for R7FA6M5BH
...
namespace alloy::generated::r7fa6m5bh {
...
namespace traits {
    ...
    constexpr bool has_agt2 = true;
    constexpr uint32_t num_agt2_instances = 1;
    constexpr bool has_agt3 = true;
    constexpr uint32_t num_agt3_instances = 1;
    constexpr bool has_agt4 = true;
    constexpr uint32_t num_agt4_instances = 1;
    constexpr bool has_agt5 = true;
    constexpr uint32_t num_agt5_instances = 1;
    ...
    constexpr bool has_eccafl0 = true;
    constexpr uint32_t num_eccafl0_instances = 1;
    constexpr bool has_eccafl1 = true;
    constexpr uint32_t num_eccafl1_instances = 1;
    ...
    template<>
    struct peripheral_count<struct agt2_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct agt3_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct agt4_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct agt5_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct eccafl0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct eccafl1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace rmpu {
    ...
    /// MMPUENEDMAC Register bits
    namespace mmpuenedmac_bits {
        constexpr uint32_t ENABLE = (1U << 0);  ///< Bus Master MPU of EDMAC enable
        constexpr uint32_t KEY = (8 << 8);  ///< These bits enable or disable writes to the ENABLE bit.
    }

    /// MMPUENPTEDMAC Register bits
    namespace mmpuenptedmac_bits {
        constexpr uint32_t PROTECT = (1U << 0);  ///< Protection of register
        constexpr uint32_t KEY = (8 << 8);  ///< These bits enable or disable writes to the PROTECT bit.
    }

    /// MMPURPTEDMAC Register bits
    namespace mmpurptedmac_bits {
        constexpr uint32_t PROTECT = (1U << 0);  ///< Protection of register
...
namespace bus {
    ...
    /// BUSSCNTEOBIU Register bits
    namespace busscnteobiu_bits {
        constexpr uint32_t ARBS = (2 << 0);  ///< Arbitration Select for three masters
    }

    /// BUSSCNTECBIU Register bits
    namespace busscntecbiu_bits {
        constexpr uint32_t ARBS = (2 << 0);  ///< Arbitration Select for three masters
    }
...
namespace dma {
    ...
    constexpr uint32_t EDMAC0_BASE = 0x40114000;
    ...
    struct Registers {
        ...
        volatile uint32_t DMBWR;  ///< Offset: 0x30 - DMA Bufferable Write Enable Register
    };
    ...
    /// DMBWR Register bits
    namespace dmbwr_bits {
        constexpr uint32_t BWE = (1U << 0);  ///< Bufferable Write Enable
    }
...
namespace icu {
    ...
    namespace wupen0_bits {
        ...
        constexpr uint32_t USBHSWUPEN = (1U << 26);  ///< USBHS Interrupt Software Standby/Snooze Mode Returns Enable bit
...
namespace sysc {
    ...
    struct Registers {
        ...
        volatile uint32_t OCTACKDIVCR;  ///< Offset: 0x6D - Octal-SPI Clock Division Control Register
        volatile uint32_t CANFDCKDIVCR;  ///< Offset: 0x6E - CANFD Clock Division Control Register
        volatile uint32_t USB60CKDIVCR;  ///< Offset: 0x6F - USB60 Clock Division Control Register
        volatile uint32_t CECCKDIVCR;  ///< Offset: 0x70 - CEC Clock Division Control Register
        volatile uint32_t USBCKCR;  ///< Offset: 0x74 - USB Clock Control Register
        volatile uint32_t OCTACKCR;  ///< Offset: 0x75 - Octal-SPI Clock Control Register
        volatile uint32_t CANFDCKCR;  ///< Offset: 0x76 - CANFD Clock Control Register
        volatile uint32_t USB60CKCR;  ///< Offset: 0x77 - USB60 Clock Control Register
        volatile uint32_t CECCKCR;  ///< Offset: 0x78 - CEC Clock Control Register
    ...
    /// OCTACKDIVCR Register bits
    namespace octackdivcr_bits {
        constexpr uint32_t OCTACKDIV = (3 << 0);  ///< Octal-SPI Clock (OCTACLK) Division Select
    }
    ...
    /// USB60CKDIVCR Register bits
    namespace usb60ckdivcr_bits {
        constexpr uint32_t USB60CKDIV = (3 << 0);  ///< USB clock (USB60CLK) Division Select
    }

    /// CECCKDIVCR Register bits
    namespace cecckdivcr_bits {
        constexpr uint32_t CECCKDIV = (3 << 0);  ///< CEC clock (CECCLK) Division Select
    }
    ...
    /// OCTACKCR Register bits
    namespace octackcr_bits {
        constexpr uint32_t OCTACKSEL = (3 << 0);  ///< Octal-SPI Clock (OCTACLK) Source Select
        constexpr uint32_t OCTACKSREQ = (1U << 6);  ///< Octal-SPI Clock (OCTACLK) Switching Request
        constexpr uint32_t OCTACKSRDY = (1U << 7);  ///< Octal-SPI Clock (OCTACLK) Switching Ready state flag
    }
    ...
    /// USB60CKCR Register bits
    namespace usb60ckcr_bits {
        constexpr uint32_t USB60CKSEL = (3 << 0);  ///< USB clock (USB60CLK) Source Select
        constexpr uint32_t USB60CKSREQ = (1U << 6);  ///< USB clock (USB60CLK) Switching Request
        constexpr uint32_t USB60CKSRDY = (1U << 7);  ///< USB clock (USB60CLK) Switching Ready state flag
    }

    /// CECCKCR Register bits
    namespace cecckcr_bits {
        constexpr uint32_t CECCKSEL = (3 << 0);  ///< CEC clock (CECCLK) Source Select
        constexpr uint32_t CECCKSREQ = (1U << 6);  ///< CEC clock (CECCLK) Switching Request
        constexpr uint32_t CECCKSRDY = (1U << 7);  ///< CEC clock (CECCLK) Switching Ready state flag
    }
    ...
    namespace cgfsar_bits {
        ...
        constexpr uint32_t NONSEC12 = (1U << 12);  ///< Non Secure Attribute bit 12
    ...
    namespace dpfsar_bits {
        ...
        constexpr uint32_t DPFSA25 = (1U << 25);  ///< Deep Software Standby Interrupt Factor Security Attribute bit 25
    ...
    namespace dpsier3_bits {
        ...
        constexpr uint32_t DUSBHSIE = (1U << 1);  ///< USBHS Suspend/Resume Deep Software Standby Cancel Signal Enable
    ...
    namespace dpsifr3_bits {
        ...
        constexpr uint32_t DUSBHSIF = (1U << 1);  ///< USBHS Suspend/Resume Deep Software Standby Cancel Flag
...
namespace gpio {
    ...
    constexpr uint32_t PORT9_BASE = 0x40080120;
    constexpr uint32_t PORTA_BASE = 0x40080140;
    constexpr uint32_t PORTB_BASE = 0x40080160;
...
namespace pfs {
    ...
    /// P010PFS Register bits
    namespace p010pfs_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// P010PFS_HA Register bits
    namespace p010pfs_ha_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// P010PFS_BY Register bits
    namespace p010pfs_by_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// PA10PFS Register bits
    namespace pa10pfs_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// PA10PFS_HA Register bits
    namespace pa10pfs_ha_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
    ...
    /// PA10PFS_BY Register bits
    namespace pa10pfs_by_bits {
        constexpr uint32_t PODR = (1U << 0);  ///< Port Output Data
        constexpr uint32_t PIDR = (1U << 1);  ///< Port State
        constexpr uint32_t PDR = (1U << 2);  ///< Port Direction
        constexpr uint32_t PCR = (1U << 4);  ///< Pull-up Control
...
namespace mstp {
    ...
    namespace mstpcrb_bits {
        constexpr uint32_t MSTPB3 = (1U << 3);  ///< CEC Module Stop
        ...
        constexpr uint32_t MSTPB16 = (1U << 16);  ///< OSPI Module Stop
    ...
    namespace mstpcre_bits {
        ...
        constexpr uint32_t MSTPE22 = (1U << 22);  ///< GPT9 Module Stop
        constexpr uint32_t MSTPE23 = (1U << 23);  ///< GPT8 Module Stop
...
namespace usb {
    ...
    constexpr uint32_t USBHS_BASE = 0x40111000;
...
namespace iic2 {
    /// Base addresses
    constexpr uint32_t IIC2_BASE = 0x4009F200;
...
namespace spi {
    /// Base addresses
    constexpr uint32_t OSPI_BASE = 0x400A6000;
    constexpr uint32_t SPI0_BASE = 0x4011A000;
    constexpr uint32_t SPI1_BASE = 0x4011A100;
    constexpr uint32_t QSPI_BASE = 0x64000000;

    /// SPI Register structure
    struct Registers {
        volatile uint32_t DCR;  ///< Offset: 0x00 - Device Command Register
        volatile uint32_t DAR;  ///< Offset: 0x04 - Device Address Register
        volatile uint32_t DCSR;  ///< Offset: 0x08 - Device Command Setting Register
        volatile uint32_t DSR0;  ///< Offset: 0x0C - Device Size Register 0
        volatile uint32_t DSR1;  ///< Offset: 0x10 - Device Size Register 1
        volatile uint32_t MDTR;  ///< Offset: 0x14 - Memory Delay Trim Register
        volatile uint32_t ACTR;  ///< Offset: 0x18 - Auto-Calibration Timer Register
        volatile uint32_t ACAR0;  ///< Offset: 0x1C - Auto-Calibration Address Register 0
        volatile uint32_t ACAR1;  ///< Offset: 0x20 - Auto-Calibration Address Register 1
        volatile uint32_t DRCSTR;  ///< Offset: 0x34 - Device Memory Map Read Chip Select Timing Setting Register
        volatile uint32_t DWCSTR;  ///< Offset: 0x38 - Device Memory Map Write Chip Select Timing Setting Register
        volatile uint32_t DCSTR;  ///< Offset: 0x3C - Device Chip Select Timing Setting Register
        volatile uint32_t CDSR;  ///< Offset: 0x40 - Controller and Device Setting Register
        volatile uint32_t MDLR;  ///< Offset: 0x44 - Memory Map Dummy Length Register
        volatile uint32_t MRWCR0;  ///< Offset: 0x48 - Memory Map Read/Write Command Register 0
        volatile uint32_t MRWCR1;  ///< Offset: 0x4C - Memory Map Read/Write Command Register 1
        volatile uint32_t MRWCSR;  ///< Offset: 0x50 - Memory Map Read/Write Setting Register
        volatile uint32_t ESR;  ///< Offset: 0x54 - Error Status Register
        volatile uint32_t CWNDR;  ///< Offset: 0x58 - Configure Write without Data Register
        volatile uint32_t CWDR;  ///< Offset: 0x5C - Configure Write Data Register
        volatile uint32_t CRR;  ///< Offset: 0x60 - Configure Read Register
        volatile uint32_t ACSR;  ///< Offset: 0x64 - Auto-Calibration Status Register
        volatile uint32_t DCSMXR;  ///< Offset: 0x7C - Device Chip Select Maximum Period Register
        volatile uint32_t DWSCTSR;  ///< Offset: 0x80 - Device Memory Map Write single continuous translating...
    };

    /// Peripheral instances
    inline Registers* OSPI = reinterpret_cast<Registers*>(OSPI_BASE);
    ...
    /// DCR Register bits
    namespace dcr_bits {
        constexpr uint32_t DVCMD0 = (8 << 0);  ///< Device Command data
        constexpr uint32_t DVCMD1 = (8 << 8);  ///< Device Command data
    }

    /// DAR Register bits
    namespace dar_bits {
        constexpr uint32_t DVAD0 = (8 << 0);  ///< Device Address data 0
        constexpr uint32_t DVAD1 = (8 << 8);  ///< Device Address data 1
        constexpr uint32_t DVAD2 = (8 << 16);  ///< Device Address data 2
        constexpr uint32_t DVAD3 = (8 << 24);  ///< Device Address data 3
    }

    /// DCSR Register bits
    namespace dcsr_bits {
        constexpr uint32_t DALEN = (8 << 0);  ///< Transfer data length setting
        constexpr uint32_t DMLEN = (8 << 8);  ///< Dummy cycle setting
        constexpr uint32_t ACDV = (1U << 19);  ///< Access Device setting
        constexpr uint32_t CMDLEN = (3 << 20);  ///< Transfer command length setting
        constexpr uint32_t DAOR = (1U << 23);  ///< Data order setting
        constexpr uint32_t ADLEN = (3 << 24);  ///< Transfer address length setting
        constexpr uint32_t DOPI = (1U << 27);  ///< DOPI single byte setting
        constexpr uint32_t ACDA = (1U << 28);  ///< Data Access Control
        constexpr uint32_t PREN = (1U << 29);  ///< Preamble bit enable for OctaRAM
    }

    /// DSR0 Register bits
    namespace dsr0_bits {
        constexpr uint32_t DV0SZ = (30 << 0);  ///< Device 0 size setting
        constexpr uint32_t DV0TYP = (2 << 30);  ///< Device 0 type setting
    }

    /// DSR1 Register bits
    namespace dsr1_bits {
        constexpr uint32_t DV1SZ = (30 << 0);  ///< Device 1 size setting
        constexpr uint32_t DV1TYP = (2 << 30);  ///< Device 1 type setting
    }

    /// MDTR Register bits
    namespace mdtr_bits {
        constexpr uint32_t DV0DEL = (8 << 0);  ///< Device 0 delay setting
        constexpr uint32_t DQSERAM = (4 << 8);  ///< OM_DQS enable counter
        constexpr uint32_t DQSESOPI = (4 << 12);  ///< OM_DQS enable counter
        constexpr uint32_t DV1DEL = (8 << 16);  ///< Device 1 delay setting
        constexpr uint32_t DQSEDOPI = (4 << 24);  ///< OM_DQS enable counter
    }

    /// ACTR Register bits
    namespace actr_bits {
        constexpr uint32_t CTP = (32 << 0);  ///< Automatic calibration cycle time setting
    }

    /// ACAR0 Register bits
    namespace acar0_bits {
        constexpr uint32_t CAD0 = (32 << 0);  ///< Automatic calibration address
    }

    /// ACAR1 Register bits
    namespace acar1_bits {
        constexpr uint32_t CAD1 = (32 << 0);  ///< Automatic calibration address
    }

    /// DRCSTR Register bits
    namespace drcstr_bits {
        constexpr uint32_t CTRW0 = (7 << 0);  ///< Device 0 single continuous read waiting cycle setting in PCLKA units
        constexpr uint32_t CTR0 = (1U << 7);  ///< Device 0 single continuous read mode setting
        constexpr uint32_t DVRDCMD0 = (3 << 8);  ///< Device 0 Command execution interval setting
        constexpr uint32_t DVRDHI0 = (3 << 11);  ///< Device 0 select signal pull-up timing setting
        constexpr uint32_t DVRDLO0 = (2 << 14);  ///< Device 0 select signal pull-down timing setting
        constexpr uint32_t CTRW1 = (7 << 16);  ///< Device 1 single continuous read waiting cycle setting in PCLKA units
        constexpr uint32_t CTR1 = (1U << 23);  ///< Device 1 single continuous read mode setting
        constexpr uint32_t DVRDCMD1 = (3 << 24);  ///< Device 1 Command execution interval
        constexpr uint32_t DVRDHI1 = (3 << 27);  ///< Device 1 select signal High timing setting
        constexpr uint32_t DVRDLO1 = (2 << 30);  ///< Device 1 select signal pull-down timing setting
    }

    /// DWCSTR Register bits
    namespace dwcstr_bits {
        constexpr uint32_t CTWW0 = (7 << 0);  ///< Device 0 single continuous write waiting cycle setting in PCLKA units
        constexpr uint32_t CTW0 = (1U << 7);  ///< Device 0 single continuous write mode setting
        constexpr uint32_t DVWCMD0 = (3 << 8);  ///< Device 0 Command execution interval setting
        constexpr uint32_t DVWHI0 = (3 << 11);  ///< Device 0 select signal pull-up timing setting
        constexpr uint32_t DVWLO0 = (2 << 14);  ///< Device 0 select signal pull-down timing setting
        constexpr uint32_t CTWW1 = (7 << 16);  ///< Device 1 single continuous write waiting cycle setting in PCLKA units
        constexpr uint32_t CTW1 = (1U << 23);  ///< Device 1 single continuous write mode setting
        constexpr uint32_t DVWCMD1 = (3 << 24);  ///< Device 1 Command execution interval setting
        constexpr uint32_t DVWHI1 = (3 << 27);  ///< Device 1 select signal pull-up timing setting
        constexpr uint32_t DVWLO1 = (2 << 30);  ///< Device 1 select signal pull-down timing setting
    }

    /// DCSTR Register bits
    namespace dcstr_bits {
        constexpr uint32_t DVSELCMD = (3 << 8);  ///< Device Command execution interval setting
        constexpr uint32_t DVSELHI = (3 << 11);  ///< Device select signal pull-up timing setting
        constexpr uint32_t DVSELLO = (2 << 14);  ///< Device select signal pull-down timing setting
    }

    /// CDSR Register bits
    namespace cdsr_bits {
        constexpr uint32_t DV0TTYP = (2 << 0);  ///< Device0_transfer_type setting
        constexpr uint32_t DV1TTYP = (2 << 2);  ///< Device1_transfer_type setting
        constexpr uint32_t DV0PC = (1U << 4);  ///< Device0_memory precycle setting
        constexpr uint32_t DV1PC = (1U << 5);  ///< Device1_memory precycle setting
        constexpr uint32_t ACMEME0 = (1U << 10);  ///< Automatic calibration memory enable setting for device 0
        constexpr uint32_t ACMEME1 = (1U << 11);  ///< Automatic calibration memory enable setting for device 1
        constexpr uint32_t ACMODE = (2 << 12);  ///< Automatic calibration mode
        constexpr uint32_t DLFT = (1U << 31);  ///< Deadlock Free Timer Enable
    }

    /// MDLR Register bits
    namespace mdlr_bits {
        constexpr uint32_t DV0RDL = (8 << 0);  ///< Device 0 Read dummy length setting
        constexpr uint32_t DV0WDL = (8 << 8);  ///< Device 0 Write dummy length setting
        constexpr uint32_t DV1RDL = (8 << 16);  ///< Device 1 Read dummy length setting
        constexpr uint32_t DV1WDL = (8 << 24);  ///< Device 1 Write dummy length setting
    }

    /// MRWCR0 Register bits
    namespace mrwcr0_bits {
        constexpr uint32_t D0MRCMD0 = (8 << 0);  ///< Memory map read command 0 setting
        constexpr uint32_t D0MRCMD1 = (8 << 8);  ///< Memory map read command 1 setting
        constexpr uint32_t D0MWCMD0 = (8 << 16);  ///< Memory map write command 0 setting
        constexpr uint32_t D0MWCMD1 = (8 << 24);  ///< Memory map write command 1 setting
    }

    /// MRWCR1 Register bits
    namespace mrwcr1_bits {
        constexpr uint32_t D1MRCMD0 = (8 << 0);  ///< Memory map read command 0 setting
        constexpr uint32_t D1MRCMD1 = (8 << 8);  ///< Memory map read command 1 setting
        constexpr uint32_t D1MWCMD0 = (8 << 16);  ///< Memory map write command 0 setting
        constexpr uint32_t D1MWCMD1 = (8 << 24);  ///< Memory map write command 1 setting
    }

    /// MRWCSR Register bits
    namespace mrwcsr_bits {
        constexpr uint32_t MRAL0 = (3 << 0);  ///< Device 0 read address length setting
        constexpr uint32_t MRCL0 = (3 << 3);  ///< Device 0 read command length setting
        constexpr uint32_t MRO0 = (1U << 6);  ///< Device 0 read order setting
        constexpr uint32_t PREN0 = (1U << 7);  ///< Preamble bit enable for mem0 memory-map read
        constexpr uint32_t MWAL0 = (3 << 8);  ///< Device 0 write address length setting
        constexpr uint32_t MWCL0 = (3 << 11);  ///< Device 0 write command length setting
        constexpr uint32_t MWO0 = (1U << 14);  ///< Device 0 write order setting
        constexpr uint32_t MRAL1 = (3 << 16);  ///< Device 1 read address length setting
        constexpr uint32_t MRCL1 = (3 << 19);  ///< Device 1 read command length setting
        constexpr uint32_t MRO1 = (1U << 22);  ///< Device 1 read order setting
        constexpr uint32_t PREN1 = (1U << 23);  ///< Preamble bit enable for mem1 memory-map read
        constexpr uint32_t MWAL1 = (3 << 24);  ///< Device 1 write address length setting
        constexpr uint32_t MWCL1 = (3 << 27);  ///< Device 1 write command length setting
        constexpr uint32_t MWO1 = (1U << 30);  ///< Device 1 write order setting
    }

    /// ESR Register bits
    namespace esr_bits {
        constexpr uint32_t MRESR = (8 << 0);  ///< Memory map read error status
        constexpr uint32_t MWESR = (8 << 8);  ///< Memory map write error status
    }

    /// CWNDR Register bits
    namespace cwndr_bits {
        constexpr uint32_t WND = (32 << 0);  ///< The write value should be 0.
    }

    /// CWDR Register bits
    namespace cwdr_bits {
        constexpr uint32_t WD0 = (8 << 0);  ///< Write data 0
        constexpr uint32_t WD1 = (8 << 8);  ///< Write data 1
        constexpr uint32_t WD2 = (8 << 16);  ///< Write data 2
        constexpr uint32_t WD3 = (8 << 24);  ///< Write data 3
    }

    /// CRR Register bits
    namespace crr_bits {
        constexpr uint32_t RD0 = (8 << 0);  ///< Read data 0
        constexpr uint32_t RD1 = (8 << 8);  ///< Read data 1
        constexpr uint32_t RD2 = (8 << 16);  ///< Read data 2
        constexpr uint32_t RD3 = (8 << 24);  ///< Read data 3
    }

    /// ACSR Register bits
    namespace acsr_bits {
        constexpr uint32_t ACSR0 = (3 << 0);  ///< Auto-calibration status of device 0
        constexpr uint32_t ACSR1 = (3 << 3);  ///< Auto-calibration status of device 1
    }

    /// DCSMXR Register bits
    namespace dcsmxr_bits {
        constexpr uint32_t CTWMX0 = (9 << 0);  ///< Indicates the maximum period that OM_CS0 and OM_CS1 are Low in single continuous write of OctaRAM.
        constexpr uint32_t CTWMX1 = (9 << 16);  ///< Indicates the maximum period that OM_CS0 and OM_CS1 are Low in single continuous read of OctaRAM.
    }

    /// DWSCTSR Register bits
    namespace dwsctsr_bits {
        constexpr uint32_t CTSN0 = (11 << 0);  ///< Indicates the number of bytes to translate in single continuous write of device 0.
        constexpr uint32_t CTSN1 = (11 << 16);  ///< Indicates the number of bytes to translate in single continuous write of device 1.
    }
...
namespace cec {
    /// Base addresses
    constexpr uint32_t CEC_BASE = 0x400AC000;

    /// CEC Register structure
    struct Registers {
        volatile uint32_t CADR;  ///< Offset: 0x00 - CEC Local Address Setting Register
        volatile uint32_t CECCTL1;  ///< Offset: 0x02 - CEC Control Register 1
        volatile uint32_t STATB;  ///< Offset: 0x04 - CEC Transmission Start Bit Width Setting Register
        volatile uint32_t STATL;  ///< Offset: 0x06 - CEC Transmission Start Bit Low Width Setting Register
        volatile uint32_t LGC0L;  ///< Offset: 0x08 - CEC Transmission Logical 0 Low Width Setting Register
        volatile uint32_t LGC1L;  ///< Offset: 0x0A - CEC Transmission Logical 1 Low Width Setting Register
        volatile uint32_t DATB;  ///< Offset: 0x0C - CEC Transmission Data Bit Width Setting Register
        volatile uint32_t NOMT;  ///< Offset: 0x0E - CEC Reception Data Sampling Time Setting Register
        volatile uint32_t STATLL;  ///< Offset: 0x10 - CEC Reception Start Bit Minimum Low Width Setting Register
        volatile uint32_t STATLH;  ///< Offset: 0x12 - CEC Reception Start Bit Maximum Low Width Setting Register
        volatile uint32_t STATBL;  ///< Offset: 0x14 - CEC Reception Start Bit Minimum Bit Width Setting Register
        volatile uint32_t STATBH;  ///< Offset: 0x16 - CEC Reception Start Bit Maximum Bit Width Setting Register
        volatile uint32_t LGC0LL;  ///< Offset: 0x18 - CEC Reception Logical 0 Minimum Low Width Setting Register
        volatile uint32_t LGC0LH;  ///< Offset: 0x1A - CEC Reception Logical 0 Maximum Low Width Setting Register
        volatile uint32_t LGC1LL;  ///< Offset: 0x1C - CEC Reception Logical 1 Minimum Low Width Setting Register
        volatile uint32_t LGC1LH;  ///< Offset: 0x1E - CEC Reception Logical 1 Maximum Low Width Setting Register
        volatile uint32_t DATBL;  ///< Offset: 0x20 - CEC Reception Data Bit Minimum Bit Width Setting Register
        volatile uint32_t DATBH;  ///< Offset: 0x22 - CEC Reception Data Bit Maximum Bit Width Setting Register
        volatile uint32_t NOMP;  ///< Offset: 0x24 - CEC Data Bit Reference Width Setting Register
        volatile uint32_t CECEXMD;  ///< Offset: 0x28 - CEC Extension Mode Register
        volatile uint32_t CECEXMON;  ///< Offset: 0x2A - CEC Extension Monitor Register
        volatile uint32_t CTXD;  ///< Offset: 0x40 - CEC Transmission Buffer Register
        volatile uint32_t CRXD;  ///< Offset: 0x41 - CEC Reception Buffer Register
        volatile uint32_t CECES;  ///< Offset: 0x42 - CEC Communication Error Status Register
        volatile uint32_t CECS;  ///< Offset: 0x43 - CEC Communication Status Register
        volatile uint32_t CECFC;  ///< Offset: 0x44 - CEC Communication Error Flag Clear Trigger Register
        volatile uint32_t CECCTL0;  ///< Offset: 0x45 - CEC Control Register 0
    };
    ...
    /// CADR Register bits
    namespace cadr_bits {
        constexpr uint32_t ADR00 = (1U << 0);  ///< Local Address at Address 0 (TV)
        constexpr uint32_t ADR01 = (1U << 1);  ///< Local Address Setting at Address 1 (recording device 1)
        constexpr uint32_t ADR02 = (1U << 2);  ///< Local Address Setting at Address 2 (recording device 2)
        constexpr uint32_t ADR03 = (1U << 3);  ///< Local Address Setting at Address 3 (tuner 1)
        constexpr uint32_t ADR04 = (1U << 4);  ///< Local Address Setting at Address 4 (playback device 1)
        constexpr uint32_t ADR05 = (1U << 5);  ///< Local Address Setting at Address 5 (audio system)
        constexpr uint32_t ADR06 = (1U << 6);  ///< Local Address Setting at Address 6 (tuner 2)
        constexpr uint32_t ADR07 = (1U << 7);  ///< Local Address Setting at Address 7 (tuner 3)
        constexpr uint32_t ADR08 = (1U << 8);  ///< Local Address Setting at Address 8 (playback device 2)
        constexpr uint32_t ADR09 = (1U << 9);  ///< Local Address Setting at Address 9 (recording device 3)
        constexpr uint32_t ADR10 = (1U << 10);  ///< Local Address Setting at Address 10 (tuner 4)
        constexpr uint32_t ADR11 = (1U << 11);  ///< Local Address Setting at Address 11 (playback device 3)
        constexpr uint32_t ADR12 = (1U << 12);  ///< Local Address Setting at Address 12 (reserved)
        constexpr uint32_t ADR13 = (1U << 13);  ///< Local Address Setting at Address 13 (reserved)
        constexpr uint32_t ADR14 = (1U << 14);  ///< Local Address Setting at Address 14 (specific use)
    }

    /// CECCTL1 Register bits
    namespace cecctl1_bits {
        constexpr uint32_t SFT = (2 << 0);  ///< Signal-Free Time Data Bit Width Select
        constexpr uint32_t CESEL = (2 << 2);  ///< Communication Complete Interrupt (INTCE) Generation Timing Select
        constexpr uint32_t STERRD = (1U << 4);  ///< Start Bit Error Detection Select
        constexpr uint32_t BLERRD = (1U << 5);  ///< Bus Lock Detection Select
        constexpr uint32_t CINTMK = (1U << 6);  ///< CEC Data Interrupt (INTDA) Generation Select
        constexpr uint32_t CDFC = (1U << 7);  ///< Digital Filter Select
    }

    /// STATB Register bits
    namespace statb_bits {
        constexpr uint32_t STATB = (9 << 0);  ///< CEC Transmission Start Bit Width Setting
    }

    /// STATL Register bits
    namespace statl_bits {
        constexpr uint32_t STATL = (9 << 0);  ///< CEC Transmission Start Bit Low Width Setting
    }

    /// LGC0L Register bits
    namespace lgc0l_bits {
        constexpr uint32_t LGC0L = (9 << 0);  ///< CEC Transmission Logical 0 Low Width Setting
    }

    /// LGC1L Register bits
    namespace lgc1l_bits {
        constexpr uint32_t LGC1L = (9 << 0);  ///< CEC Transmission Logical 1 Low Width Setting
    }

    /// DATB Register bits
    namespace datb_bits {
        constexpr uint32_t DATB = (9 << 0);  ///< CEC Transmission Data Bit Width Setting
    }

    /// NOMT Register bits
    namespace nomt_bits {
        constexpr uint32_t NOMT = (9 << 0);  ///< CEC Reception Data Sampling Time Setting,
    }

    /// STATLL Register bits
    namespace statll_bits {
        constexpr uint32_t STATLL = (9 << 0);  ///< CEC Reception Start Bit Minimum Low Width Setting
    }

    /// STATLH Register bits
    namespace statlh_bits {
        constexpr uint32_t STATLH = (9 << 0);  ///< CEC Reception Start Bit Maximum Bit Width Setting
    }

    /// STATBL Register bits
    namespace statbl_bits {
        constexpr uint32_t STATBL = (9 << 0);  ///< CEC Reception Start Bit Minimum Bit Width Setting
    }

    /// STATBH Register bits
    namespace statbh_bits {
        constexpr uint32_t STATBH = (9 << 0);  ///< CEC Reception Start Bit Maximum Bit Width Setting
    }

    /// LGC0LL Register bits
    namespace lgc0ll_bits {
        constexpr uint32_t LGC0LL = (9 << 0);  ///< CEC Reception Logical 0 Minimum Low Width Setting
    }

    /// LGC0LH Register bits
    namespace lgc0lh_bits {
        constexpr uint32_t LGC0LH = (9 << 0);  ///< CEC Reception Logical 0 Minimum Low Width Setting
    }

    /// LGC1LL Register bits
    namespace lgc1ll_bits {
        constexpr uint32_t LGC1LL = (9 << 0);  ///< CEC Reception Logical 1 Minimum Low Width Setting
    }

    /// LGC1LH Register bits
    namespace lgc1lh_bits {
        constexpr uint32_t LGC1LH = (9 << 0);  ///< CEC Reception Logical 1 Maximum Low Width Setting
    }

    /// DATBL Register bits
    namespace datbl_bits {
        constexpr uint32_t DATBL = (9 << 0);  ///< CEC Reception Data Bit Minimum Bit Width Setting
    }

    /// DATBH Register bits
    namespace datbh_bits {
        constexpr uint32_t DATBH = (9 << 0);  ///< CEC Reception Data Bit Maximum Bit Width Setting
    }

    /// NOMP Register bits
    namespace nomp_bits {
        constexpr uint32_t NOMP = (9 << 0);  ///< CEC Data Bit Reference Width Setting
    }

    /// CECEXMD Register bits
    namespace cecexmd_bits {
        constexpr uint32_t LERPLEN = (1U << 4);  ///< Pulse Output Function Enable by Long Bit Width Error
        constexpr uint32_t RERCVEN = (1U << 5);  ///< Start Detection Reception Restart Enable
        constexpr uint32_t RCVINTDSEL = (1U << 7);  ///< INTDA Reception Interrupt Timing Change
    }

    /// CECEXMON Register bits
    namespace cecexmon_bits {
        constexpr uint32_t CECLNMON = (1U << 0);  ///< CEC Line Monitor
        constexpr uint32_t ACKF = (1U << 1);  ///< ACK Flag
    }

    /// CECES Register bits
    namespace ceces_bits {
        constexpr uint32_t OERR = (1U << 0);  ///< Overrun Error Detection Flag
        constexpr uint32_t UERR = (1U << 1);  ///< Underrun Error Detection Flag
        constexpr uint32_t ACKERR = (1U << 2);  ///< ACK Error Detection Flag
        constexpr uint32_t TERR = (1U << 3);  ///< Timing Error Detection Flag
        constexpr uint32_t TXERR = (1U << 4);  ///< Transmission Error Detection Flag
        constexpr uint32_t AERR = (1U << 5);  ///< Arbitration Loss Detection Flag
        constexpr uint32_t BLERR = (1U << 6);  ///< Bus Lock Error Detection Flag
    }

    /// CECS Register bits
    namespace cecs_bits {
        constexpr uint32_t ADRF = (1U << 0);  ///< Address Match Detection Flag
        constexpr uint32_t BUSST = (1U << 1);  ///< Bus Busy Detection Flag
        constexpr uint32_t TXST = (1U << 2);  ///< Transmission Status Flag
        constexpr uint32_t EOMF = (1U << 3);  ///< EOM Flag
        constexpr uint32_t ITCEF = (1U << 4);  ///< INTCE Generation Source Flag
        constexpr uint32_t SFTST = (1U << 7);  ///< Signal-Free Time Rewrite Disable Report Flag
    }

    /// CECFC Register bits
    namespace cecfc_bits {
        constexpr uint32_t OCTRG = (1U << 0);  ///< Overrun Error Detection Flag Clear Trigger
        constexpr uint32_t UCTRG = (1U << 1);  ///< Underrun Error Detection Flag Clear Trigger
        constexpr uint32_t ACKCTRG = (1U << 2);  ///< ACK Error Detection Flag Clear Trigger
        constexpr uint32_t TCTRG = (1U << 3);  ///< Timing Error Detection Flag Clear Trigger
        constexpr uint32_t TXCTRG = (1U << 4);  ///< Transmission Error Detection Flag Clear Trigger
        constexpr uint32_t ACTRG = (1U << 5);  ///< Arbitration Loss Detection Flag Clear Trigger
        constexpr uint32_t BLCTRG = (1U << 6);  ///< Bus Lock Error Detection Flag Clear Trigger
    }

    /// CECCTL0 Register bits
    namespace cecctl0_bits {
        constexpr uint32_t EOM = (1U << 0);  ///< EOM Setting
        constexpr uint32_t CECRXEN = (1U << 1);  ///< Reception Enable Control
        constexpr uint32_t TXTRG = (1U << 2);  ///< Transmission Start Trigger
        constexpr uint32_t CCL = (3 << 3);  ///< CEC Clock Select
        constexpr uint32_t ACKTEN = (1U << 6);  ///< ACK Bit Timing Error (Bit Width) Check Enable
        constexpr uint32_t CECE = (1U << 7);  ///< CEC Operation Enable Flag
    }
...
namespace can {
    /// Base addresses
    constexpr uint32_t CANFD_BASE = 0x400B0000;
    ...
    struct Registers {
        ...
        volatile uint32_t CFDGERFL;  ///< Offset: 0x90 - Global Error Flag Register
        volatile uint32_t CFDGTSC;  ///< Offset: 0x94 - Global Timestamp Counter Register
        volatile uint32_t CFDGAFLECTR;  ///< Offset: 0x98 - Global Acceptance Filter List Entry Control Register
        ...
        volatile uint32_t CFDRFISTS;  ///< Offset: 0x2AC - RX FIFO Interrupt Flag Status Register
        volatile uint32_t CFDCFRISTS;  ///< Offset: 0x2B0 - Common FIFO RX Interrupt Flag Status Register
        volatile uint32_t CFDCFTISTS;  ///< Offset: 0x2B4 - Common FIFO TX Interrupt Flag Status Register
        volatile uint32_t CFDCFOFRISTS;  ///< Offset: 0x2B8 - Common FIFO One Frame RX Interrupt Flag Status Register
        ...
        volatile uint32_t CFDTXQISTS;  ///< Offset: 0x1190 - TX Queue Interrupt Status Register
        ...
        volatile uint32_t CFDGFDCFG;  ///< Offset: 0x1314 - Global FD Configuration Register
        volatile uint32_t CFDGLOCKK;  ///< Offset: 0x131C - Global Lock Key Register
        volatile uint32_t CFDCDTCT;  ///< Offset: 0x1330 - DMA Transfer Control Register
    ...
    namespace cfdc%sctr_bits {
        ...
        constexpr uint32_t CRCT = (1U << 30);  ///< CRC Error Test
    ...
    namespace cfdgcfg_bits {
        ...
        constexpr uint32_t CMPOC = (1U << 5);  ///< CAN-FD Message Payload Overflow Configuration
        constexpr uint32_t TSP = (4 << 8);  ///< Timestamp Prescaler
        constexpr uint32_t TSSS = (1U << 12);  ///< Timestamp Source Select
        constexpr uint32_t TSBTCS = (3 << 13);  ///< Timestamp Bit Time Channel Select
    ...
    namespace cfdgctr_bits {
        ...
        constexpr uint32_t QMEIE = (1U << 14);  ///< TXQ Message Lost Error Interrupt Enable
        constexpr uint32_t MOWEIE = (1U << 15);  ///< GW FIFO Message Overwrite Error Interrupt Enable
    ...
    namespace cfdgerfl_bits {
        ...
        constexpr uint32_t QOWES = (1U << 4);  ///< TXQ Message Overwrite Error Status
        constexpr uint32_t QMES = (1U << 6);  ///< TXQ Message Lost Error Status
        constexpr uint32_t EEF0 = (1U << 16);  ///< ECC Error Flag for Channel 0
        constexpr uint32_t EEF1 = (1U << 17);  ///< ECC Error Flag for Channel 1
    }
    ...
    namespace cfdgaflectr_bits {
        constexpr uint32_t AFLPN = (4 << 0);  ///< Acceptance Filter List Page Number
        constexpr uint32_t AFLDAE = (1U << 8);  ///< Acceptance Filter List Data Access Enable
    }

    /// CFDGAFLCFG0 Register bits
    namespace cfdgaflcfg0_bits {
        constexpr uint32_t RNC1 = (9 << 0);  ///< Rule Number for Channel 1
        constexpr uint32_t RNC0 = (9 << 16);  ///< Rule Number for Channel 0
    }

    /// CFDRMNB Register bits
    namespace cfdrmnb_bits {
        constexpr uint32_t NRXMB = (8 << 0);  ///< Number of RX Message Buffers
        constexpr uint32_t RMPLS = (3 << 8);  ///< Reception Message Buffer Payload Data Size
    }

    /// CFDRMND0 Register bits
    namespace cfdrmnd0_bits {
    ...
    namespace cfdrfsts%s_bits {
        ...
        constexpr uint32_t RFMC = (8 << 8);  ///< RX FIFO Message Count
    ...
    namespace cfdcfcc%s_bits {
        ...
        constexpr uint32_t CFM = (2 << 8);  ///< Common FIFO Mode
        ...
        constexpr uint32_t CFTML = (5 << 16);  ///< Common FIFO TX Message Buffer Link
    ...
    namespace cfdcfcce%s_bits {
        ...
        constexpr uint32_t CFMOWM = (1U << 8);  ///< Common FIFO Message Overwrite Mode
    ...
    namespace cfdcfsts%s_bits {
        ...
        constexpr uint32_t CFMC = (8 << 8);  ///< Common FIFO Message Count
        constexpr uint32_t CFFIF = (1U << 16);  ///< Common FIFO Full Interrupt Flag
        constexpr uint32_t CFOFRXIF = (1U << 17);  ///< Common FIFO One Frame Reception Interrupt Flag
        constexpr uint32_t CFOFTXIF = (1U << 18);  ///< Common FIFO One Frame Transmission Interrupt Flag
    ...
    namespace cfdfests_bits {
        constexpr uint32_t RFXEMP = (8 << 0);  ///< RX FIFO Empty Status
        constexpr uint32_t CFXEMP = (6 << 8);  ///< Common FIFO Empty Status
    }

    /// CFDFFSTS Register bits
    namespace cfdffsts_bits {
        constexpr uint32_t RFXFLL = (8 << 0);  ///< RX FIFO Full Status
        constexpr uint32_t CFXFLL = (6 << 8);  ///< Common FIFO Full Status
    }

    /// CFDFMSTS Register bits
    namespace cfdfmsts_bits {
        constexpr uint32_t RFXMLT = (8 << 0);  ///< RX FIFO Message Lost Status
        constexpr uint32_t CFXMLT = (6 << 8);  ///< Common FIFO Message Lost Status
    }

    /// CFDRFISTS Register bits
    namespace cfdrfists_bits {
        constexpr uint32_t RFXIF = (8 << 0);  ///< RX FIFO[x] Interrupt Flag Status
        constexpr uint32_t RFXFFLL = (8 << 16);  ///< RX FIFO[x] Interrupt Full Flag Status
    }

    /// CFDCFRISTS Register bits
    namespace cfdcfrists_bits {
        constexpr uint32_t CFXRXIF = (6 << 0);  ///< Common FIFO RX Interrupt Flag Status
    }

    /// CFDCFTISTS Register bits
    namespace cfdcftists_bits {
        constexpr uint32_t CFXTXIF = (6 << 0);  ///< Common FIFO [x] TX Interrupt Flag Status
    }

    /// CFDCFOFRISTS Register bits
    namespace cfdcfofrists_bits {
        constexpr uint32_t CFXOFRXIF = (6 << 0);  ///< Common FIFO One Frame RX Interrupt Flag Status
    }

    /// CFDCFOFTISTS Register bits
    namespace cfdcfoftists_bits {
        constexpr uint32_t CFXOFTXIF = (6 << 0);  ///< Common FIFO One Frame TX Interrupt Flag Status
    }

    /// CFDCFMOWSTS Register bits
    namespace cfdcfmowsts_bits {
        constexpr uint32_t CFXMOW = (6 << 0);  ///< Common FIFO Massage Overwrite Status
    }

    /// CFDFFFSTS Register bits
    namespace cfdfffsts_bits {
        constexpr uint32_t RFXFFLL = (8 << 0);  ///< RX FIFO FDC Level Full Status
    ...
    namespace cfdtxqcc0%s_bits {
        ...
        constexpr uint32_t TXQDC = (5 << 8);  ///< TX Queue Depth Configuration
        constexpr uint32_t TXQFIE = (1U << 16);  ///< TXQ Full Interrupt Enable
        constexpr uint32_t TXQOFRXIE = (1U << 17);  ///< TXQ One Frame Reception Interrupt Enable
    ...
    namespace cfdtxqsts0%s_bits {
        ...
        constexpr uint32_t TXQMC = (6 << 8);  ///< TX Queue Message Count
        constexpr uint32_t TXQFIF = (1U << 16);  ///< TXQ Full Interrupt Flag
        constexpr uint32_t TXQOFRXIF = (1U << 17);  ///< TXQ One Frame Reception Interrupt Flag
    ...
    /// CFDTXQESTS Register bits
    namespace cfdtxqests_bits {
        constexpr uint32_t TXQxEMP = (8 << 0);  ///< TXQ Empty Status
    }

    /// CFDTXQFISTS Register bits
    namespace cfdtxqfists_bits {
        constexpr uint32_t TXQ0FULL = (3 << 0);  ///< TXQ Full Interrupt Status for Channel 0
        constexpr uint32_t TXQ1FULL = (3 << 4);  ///< TXQ Full Interrupt Status for Channel 1
    }

    /// CFDTXQMSTS Register bits
    namespace cfdtxqmsts_bits {
        constexpr uint32_t TXQ0ML = (3 << 0);  ///< TXQ Message Lost Status for Channel 0
        constexpr uint32_t TXQ1ML = (3 << 4);  ///< TXQ Message Lost Status for Channel 1
    }

    /// CFDTXQISTS Register bits
    namespace cfdtxqists_bits {
        constexpr uint32_t TXQ0ISF = (4 << 0);  ///< TXQ Interrupt Status Flag for Channel 0
        constexpr uint32_t TXQ1ISF = (4 << 4);  ///< TXQ Interrupt Status Flag for Channel 1
    }

    /// CFDTXQOFTISTS Register bits
    namespace cfdtxqoftists_bits {
        constexpr uint32_t TXQ0OFTISF = (4 << 0);  ///< TXQ One Frame TX Interrupt Status Flag for Channel 0
        constexpr uint32_t TXQ1OFTISF = (4 << 4);  ///< TXQ One Frame TX Interrupt Status Flag for Channel 1
    }

    /// CFDTXQOFRISTS Register bits
    namespace cfdtxqofrists_bits {
        constexpr uint32_t TXQ0OFRISF = (3 << 0);  ///< TXQ One Frame RX Interrupt Status Flag
        constexpr uint32_t TXQ1OFRISF = (3 << 4);  ///< TXQ One Frame RX Interrupt Status Flag
    }

    /// CFDTXQFSTS Register bits
    namespace cfdtxqfsts_bits {
        constexpr uint32_t TXQ0FSF = (4 << 0);  ///< TXQ Full Status Flag for Channel 0
    ...
    /// CFDGTINTSTS0 Register bits
    namespace cfdgtintsts0_bits {
        constexpr uint32_t TSIF0 = (1U << 0);  ///< TX Successful Interrupt Flag Channel 0
        constexpr uint32_t TAI0 = (1U << 1);  ///< TX Abort Interrupt Flag Channel 0
        constexpr uint32_t TQIF0 = (1U << 2);  ///< TX Queue Interrupt Flag Channel 0
        constexpr uint32_t CFTIF0 = (1U << 3);  ///< COM FIFO TX/GW Mode Interrupt Flag Channel 0
        constexpr uint32_t THIF0 = (1U << 4);  ///< TX History List Interrupt Channel 0
        constexpr uint32_t TQOFIFO = (1U << 5);  ///< TX Queue One Frame Transmission Interrupt Flag Channel 0
        constexpr uint32_t CFOTIFO = (1U << 6);  ///< COM FIFO One Frame Transmission Interrupt Flag Channel 0
        constexpr uint32_t TSIF1 = (1U << 8);  ///< TX Successful Interrupt Flag Channel 1
        constexpr uint32_t TAIF1 = (1U << 9);  ///< TX Abort Interrupt Flag Channel 1
        constexpr uint32_t TQIF1 = (1U << 10);  ///< TX Queue Interrupt Flag Channel 1
        constexpr uint32_t CFTIF1 = (1U << 11);  ///< COM FIFO TX/GW Mode Interrupt Flag Channel 1
        constexpr uint32_t THIF1 = (1U << 12);  ///< TX History List Interrupt Channel 1
        constexpr uint32_t TQOFIF1 = (1U << 13);  ///< TX Queue One Frame Transmission Interrupt Flag Channel 1
        constexpr uint32_t CFOTIF1 = (1U << 14);  ///< COM FIFO One Frame Transmission Interrupt Flag Channel 1
    }

    /// CFDGTSTCFG Register bits
    namespace cfdgtstcfg_bits {
        constexpr uint32_t ICBCE = (2 << 0);  ///< Channel n Internal CAN Bus Communication Test Mode Enable
        constexpr uint32_t RTMPS = (10 << 16);  ///< RAM Test Mode Page Select
    }

    /// CFDGTSTCTR Register bits
    namespace cfdgtstctr_bits {
        constexpr uint32_t ICBCTME = (1U << 0);  ///< Internal CAN Bus Communication Test Mode Enable
    ...
    namespace cfdcdtct_bits {
        ...
        constexpr uint32_t RFDMAE2 = (1U << 2);  ///< DMA Transfer Enable for RXFIFO 2
        constexpr uint32_t RFDMAE3 = (1U << 3);  ///< DMA Transfer Enable for RXFIFO 3
        constexpr uint32_t RFDMAE4 = (1U << 4);  ///< DMA Transfer Enable for RXFIFO 4
        constexpr uint32_t RFDMAE5 = (1U << 5);  ///< DMA Transfer Enable for RXFIFO 5
        constexpr uint32_t RFDMAE6 = (1U << 6);  ///< DMA Transfer Enable for RXFIFO 6
        constexpr uint32_t RFDMAE7 = (1U << 7);  ///< DMA Transfer Enable for RXFIFO 7
        constexpr uint32_t CFDMAE0 = (1U << 8);  ///< DMA Transfer Enable for Common FIFO 0 of Channel 0
        constexpr uint32_t CFDMAE1 = (1U << 9);  ///< DMA Transfer Enable for Common FIFO 0 of Channel 1
    }
    ...
    namespace cfdcdtsts_bits {
        ...
        constexpr uint32_t RFDMASTS2 = (1U << 2);  ///< DMA Transfer Status for RX FIFO 2
        constexpr uint32_t RFDMASTS3 = (1U << 3);  ///< DMA Transfer Status for RX FIFO 3
        constexpr uint32_t RFDMASTS4 = (1U << 4);  ///< DMA Transfer Status for RX FIFO 4
        constexpr uint32_t RFDMASTS5 = (1U << 5);  ///< DMA Transfer Status for RX FIFO 5
        constexpr uint32_t RFDMASTS6 = (1U << 6);  ///< DMA Transfer Status for RX FIFO 6
        constexpr uint32_t RFDMASTS7 = (1U << 7);  ///< DMA Transfer Status for RX FIFO 7
        constexpr uint32_t CFDMASTS0 = (1U << 8);  ///< DMA Transfer Status only for Common FIFO 0 of Channel 0
        constexpr uint32_t CFDMASTS1 = (1U << 9);  ///< DMA Transfer Status only for Common FIFO 0 of Channel 1
    }

    /// CFDCDTTCT Register bits
    namespace cfdcdttct_bits {
        constexpr uint32_t TQ0DMAE0 = (1U << 0);  ///< DMA TX Transfer Enable for TXQ 0 of Channel 0
        constexpr uint32_t TQ0DMAE1 = (1U << 1);  ///< DMA TX Transfer Enable for TXQ 0 of Channel 1
        constexpr uint32_t TQ3DMAE0 = (1U << 8);  ///< DMA TX Transfer Enable for TXQ 3 of Channel 0
        constexpr uint32_t TQ3DMAE1 = (1U << 9);  ///< DMA TX Transfer Enable for TXQ 3 of Channel 1
        constexpr uint32_t CFDMAE0 = (1U << 16);  ///< DMA TX Transfer Enable for Common FIFO 2 of Channel 0
        constexpr uint32_t CFDMAE1 = (1U << 17);  ///< DMA TX Transfer Enable for Common FIFO 2 of Channel 1
    }

    /// CFDCDTTSTS Register bits
    namespace cfdcdttsts_bits {
        constexpr uint32_t TQ0DMASTS0 = (1U << 0);  ///< DMA TX Transfer Status for TXQ0 of Channel 0
        constexpr uint32_t TQ0DMASTS1 = (1U << 1);  ///< DMA TX Transfer Status for TXQ0 of Channel 1
        constexpr uint32_t TQ3DMASTS0 = (1U << 8);  ///< DMA TX Transfer Status for TXQ3 of Channel 0
        constexpr uint32_t TQ3DMASTS1 = (1U << 9);  ///< DMA TX Transfer Status for TXQ3 of Channel 1
        constexpr uint32_t CFDMASTS0 = (1U << 16);  ///< DMA TX Transfer Status only for Common FIFO 2 of Channel 0
    ...
    namespace cfdgrintsts%s_bits {
        ...
        constexpr uint32_t CFRFIF = (3 << 24);  ///< Common FIFO FDC Level Full Interrupt Flag Channel n (n = 0, 1)
        constexpr uint32_t CFOFRIF = (3 << 28);  ///< Common FIFO One Frame RX Interrupt Flag Channel n (n = 0, 1)
    }
    ...
    namespace cfdc%sfdcfg_bits {
        ...
        constexpr uint32_t GWEN = (1U << 24);  ///< CAN2.0, CAN-FD Multi-Gateway Enable
        constexpr uint32_t GWFDF = (1U << 25);  ///< Gateway FDF Configuration Bit
        constexpr uint32_t GWBRS = (1U << 26);  ///< Gateway BRS Configuration Bit
    ...
    namespace cfdgaflp0%s_bits {
        ...
        constexpr uint32_t GAFLSRD2 = (1U << 6);  ///< Global Acceptance Filter List Select Routing Destination 2
...
namespace pscu {
    ...
    namespace psarb_bits {
        constexpr uint32_t PSARB3 = (1U << 3);  ///< CEC and the MSTPCRB.MSTPB3 bit security attribution
        constexpr uint32_t PSARB6 = (1U << 6);  ///< QSPI and the MSTPCRB.MSTPB6 bit security attribution
        constexpr uint32_t PSARB7 = (1U << 7);  ///< IIC2 and the MSTPCRB.MSTPB7 bit security attribution
        ...
        constexpr uint32_t PSARB12 = (1U << 12);  ///< USBHS and the MSTPCRB.MSTPB12 bit security attribution
        constexpr uint32_t PSARB15 = (1U << 15);  ///< ETHER0/EDMAC0, the MSTPCRB.MSTPB15 bit and the PFENET.PHYMODE0 bit security attribution
        constexpr uint32_t PSARB16 = (1U << 16);  ///< OSPI and the MSTPCRB.MSTPB16 bit security attribution
        ...
        constexpr uint32_t PSARB23 = (1U << 23);  ///< SCI8 and the MSTPCRB.MSTPB23 bit security attribution
        constexpr uint32_t PSARB24 = (1U << 24);  ///< SCI7 and the MSTPCRB.MSTPB24 bit security attribution
        constexpr uint32_t PSARB25 = (1U << 25);  ///< SCI6 and the MSTPCRB.MSTPB25 bit security attribution
        constexpr uint32_t PSARB26 = (1U << 26);  ///< SCI5 and the MSTPCRB.MSTPB26 bit security attribution
    ...
    namespace psarc_bits {
        ...
        constexpr uint32_t PSARC27 = (1U << 27);  ///< CANFD0 and the MSTPCRC.MSTPC27 bit security attribution
    ...
    namespace psare_bits {
        ...
        constexpr uint32_t PSARE22 = (1U << 22);  ///< GPT9 and the MSTPCRE.MSTPE22 bit security attribution
        constexpr uint32_t PSARE23 = (1U << 23);  ///< GPT8 and the MSTPCRE.MSTPE23 bit security attribution
...
namespace eth {
    /// Base addresses
    constexpr uint32_t ETHERC0_BASE = 0x40114100;
    ...
    struct Registers {
        ...
        volatile uint32_t IPGR;  ///< Offset: 0x50 - Interpacket Gap Register
    ...
    /// RFLR Register bits
    namespace rflr_bits {
        constexpr uint32_t RFL = (12 << 0);  ///< Receive Frame Maximum Length
    }
    ...
    namespace ecsr_bits {
        ...
        constexpr uint32_t LCHNG = (1U << 2);  ///< Link Signal Change Flag
    ...
    /// PIR Register bits
    namespace pir_bits {
        constexpr uint32_t MDC = (1U << 0);  ///< MII/RMII Management Data Clock
        constexpr uint32_t MMD = (1U << 1);  ///< MII/RMII Management Mode
        constexpr uint32_t MDO = (1U << 2);  ///< MII/RMII Management Data-Out
        constexpr uint32_t MDI = (1U << 3);  ///< MII/RMII Management Data-In
    }

    /// PSR Register bits
    namespace psr_bits {
        constexpr uint32_t LMON = (1U << 0);  ///< ET0_LINKSTA Pin Status Flag
    }
    ...
    /// IPGR Register bits
    namespace ipgr_bits {
        constexpr uint32_t IPG = (5 << 0);  ///< IPG
    }

    /// APR Register bits
    namespace apr_bits {
        constexpr uint32_t AP = (16 << 0);  ///< Automatic PAUSE Time Setting
    }

    /// MPR Register bits
    namespace mpr_bits {
        constexpr uint32_t MP = (16 << 0);  ///< Manual PAUSE Time Setting
    }

    /// RFCF Register bits
    namespace rfcf_bits {
        constexpr uint32_t RPAUSE = (8 << 0);  ///< Received PAUSE Frame Count
    }

    /// TPAUSER Register bits
    namespace tpauser_bits {
        constexpr uint32_t TPAUSE = (16 << 0);  ///< TPAUSE
    }

    /// TPAUSECR Register bits
    namespace tpausecr_bits {
        constexpr uint32_t TXP = (8 << 0);  ///< PAUSE Frame Retransmit Count
    }

    /// BCFRR Register bits
    namespace bcfrr_bits {
        constexpr uint32_t BCF = (16 << 0);  ///< BCF
    }

    /// MAHR Register bits
    namespace mahr_bits {
        constexpr uint32_t MAHR = (32 << 0);  ///< MAC Address Upper Bit
    }

    /// MALR Register bits
    namespace malr_bits {
        constexpr uint32_t MALR = (16 << 0);  ///< MAC Address Lower Bit
    }

    /// TROCR Register bits
    namespace trocr_bits {
        constexpr uint32_t TROCR = (32 << 0);  ///< Transmit Retry Over Counter
    }

    /// CDCR Register bits
    namespace cdcr_bits {
        constexpr uint32_t CDCR = (32 << 0);  ///< Late Collision Detect Counter
    }

    /// LCCR Register bits
    namespace lccr_bits {
        constexpr uint32_t LCCR = (32 << 0);  ///< Lost Carrier Counter
    }

    /// CNDCR Register bits
    namespace cndcr_bits {
        constexpr uint32_t CNDCR = (32 << 0);  ///< Carrier Not Detect Counter
    }

    /// CEFCR Register bits
    namespace cefcr_bits {
        constexpr uint32_t CEFCR = (32 << 0);  ///< CRC Error Frame Receive Counter
    }

    /// FRECR Register bits
    namespace frecr_bits {
        constexpr uint32_t FRECR = (32 << 0);  ///< Frame Receive Error Counter
    }

    /// TSFRCR Register bits
    namespace tsfrcr_bits {
        constexpr uint32_t TSFRCR = (32 << 0);  ///< Too-Short Frame Receive Counter
    }

    /// TLFRCR Register bits
    namespace tlfrcr_bits {
        constexpr uint32_t TLFRCR = (32 << 0);  ///< Too-Long Frame Receive Counter
    }

    /// RFCR Register bits
    namespace rfcr_bits {
        constexpr uint32_t RFCR = (32 << 0);  ///< Received Alignment Error Frame Counter
    }

    /// MAFCR Register bits
    namespace mafcr_bits {
        constexpr uint32_t MAFCR = (32 << 0);  ///< Multicast Address Frame Receive Counter
    }
...
namespace sci5 {
    /// Base addresses
    constexpr uint32_t SCI5_BASE = 0x40118500;
...
namespace sci6 {
    /// Base addresses
    constexpr uint32_t SCI6_BASE = 0x40118600;
...
namespace sci7 {
    /// Base addresses
    constexpr uint32_t SCI7_BASE = 0x40118700;
...
namespace sci8 {
    /// Base addresses
    constexpr uint32_t SCI8_BASE = 0x40118800;
...
namespace eccafl0 {
    /// Base addresses
    constexpr uint32_t ECCAFL0_BASE = 0x4012F000;

    /// ECCAFL0 Register structure
    struct Registers {
    ...
    /// Peripheral instances
    inline Registers* ECCAFL0 = reinterpret_cast<Registers*>(ECCAFL0_BASE);
...
namespace eccafl1 {
    /// Base addresses
    constexpr uint32_t ECCAFL1_BASE = 0x4012F100;

    /// ECCAFL1 Register structure
    struct Registers {
    };

    /// Peripheral instances
    inline Registers* ECCAFL1 = reinterpret_cast<Registers*>(ECCAFL1_BASE);
...
namespace gpt168 {
    /// Base addresses
    constexpr uint32_t GPT168_BASE = 0x40169800;
...
namespace gpt169 {
    /// Base addresses
    constexpr uint32_t GPT169_BASE = 0x40169900;
...
#endif // ALLOY_GENERATED_R7FA6M5BH_PERIPHERALS_HPP