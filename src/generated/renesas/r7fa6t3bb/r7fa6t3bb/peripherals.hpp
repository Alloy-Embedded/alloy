...
#ifndef ALLOY_GENERATED_R7FA6T3BB_PERIPHERALS_HPP
#define ALLOY_GENERATED_R7FA6T3BB_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::r7fa6t3bb {
...
namespace sysc {
    ...
    namespace snzreqcr0_bits {
        ...
        constexpr uint32_t SNZREQEN22 = (1U << 22);  ///< Enable ACMPHS0 alarm snooze request
...
namespace rtc {
    ...
    struct Registers {
        volatile uint32_t RCR1;  ///< Offset: 0x22 - Reset Control Register 1
        volatile uint32_t RCR2;  ///< Offset: 0x24 - Reset Control Register 2
        volatile uint32_t RCR4;  ///< Offset: 0x28 - Reset Control Register 4
    ...
    /// RCR2 Register bits
    namespace rcr2_bits {
        constexpr uint32_t RESET = (1U << 1);  ///< Software Reset
    }
    ...
    namespace rtccr%s_bits {
        constexpr uint32_t TCEN = (1U << 7);  ///< P402/AGTIO and P403/AGTIO input enable
    }
...
namespace poeg {
    ...
    namespace poegga_bits {
        ...
        constexpr uint32_t CDRE0 = (1U << 8);  ///< Comparator 0 disable requests disabled
        constexpr uint32_t CDRE1 = (1U << 9);  ///< Comparator 1 disable requests disabled
        constexpr uint32_t CDRE2 = (1U << 10);  ///< Comparator 2 disable requests disabled
...
namespace acmphs0 {
    ...
    namespace cpioc_bits {
        ...
        constexpr uint32_t VREFEN = (1U << 7);  ///< VREFEN Internal Vref Enable
    }
...
namespace adc {
    ...
    struct Registers {
        ...
        volatile uint32_t ADSHMSR;  ///< Offset: 0x7C - A/D Sample and Hold Operation Mode Selection Register
        ...
        volatile uint32_t ADPGADCR0;  ///< Offset: 0x1B0 - A/D Programmable Gain Amplifier Pseudo-Differential...
    };
    ...
    namespace adshcr_bits {
        constexpr uint32_t SSTSH = (8 << 0);  ///< Channel-Dedicated Sample-and-Hold Circuit Sampling Time Setting
        constexpr uint32_t SHANS = (3 << 8);  ///< Channel-Dedicated Sample-and-Hold Circuit Bypass Select
    }
    ...
    namespace adshmsr_bits {
        constexpr uint32_t SHMD = (1U << 0);  ///< Sampling Operation Selection
    }
    ...
    namespace adpgacr_bits {
        constexpr uint32_t P000SEL0 = (1U << 0);  ///< Do not output the signal in a path bypassing the PGA amplifier
        constexpr uint32_t P000SEL1 = (1U << 1);  ///< Do not output the signal in a path through the PGA amplifier
        constexpr uint32_t P000ENAMP = (1U << 2);  ///< Do not use the PGA amplifier
        constexpr uint32_t P000GEN = (1U << 3);  ///< PGA P000 Gain Setting Enable
        constexpr uint32_t P001SEL0 = (1U << 4);  ///< PGA P001 Amplifier Bypass Enable
        constexpr uint32_t P001SEL1 = (1U << 5);  ///< PGA P001 Amplifier Transit Enable
        constexpr uint32_t P001ENAMP = (1U << 6);  ///< PGA P001 Amplifier Enable
        constexpr uint32_t P001GEN = (1U << 7);  ///< PGA P001 Gain Setting Enable
        constexpr uint32_t P002SEL0 = (1U << 8);  ///< PGA P002 Amplifier Bypass Enable
        constexpr uint32_t P002SEL1 = (1U << 9);  ///< PGA P002 Amplifier Transit Enable
        constexpr uint32_t P002ENAMP = (1U << 10);  ///< PGA P002 Amplifier Enable
        constexpr uint32_t P002GEN = (1U << 11);  ///< PGA P002 Gain Setting Enable
    }

    /// ADPGAGS0 Register bits
    namespace adpgags0_bits {
        constexpr uint32_t P000GAIN = (4 << 0);  ///< PGA P000 Gain Setting
        constexpr uint32_t P001GAIN = (4 << 4);  ///< PGA P001 Gain Setting
        constexpr uint32_t P002GAIN = (4 << 8);  ///< PGA P002 Gain Setting
    }

    /// ADPGADCR0 Register bits
    namespace adpgadcr0_bits {
        constexpr uint32_t P000DG = (2 << 0);  ///< P000 Pseudo-Differential Input Gain Setting
        constexpr uint32_t P000DEN = (1U << 3);  ///< P000 Pseudo-Differential Input Enable
        constexpr uint32_t P001DG = (2 << 4);  ///< P001 Pseudo-Differential Input Gain Setting
        constexpr uint32_t P001DEN = (1U << 7);  ///< P001 Pseudo-Differential Input Enable
        constexpr uint32_t P002DG = (2 << 8);  ///< P002 Pseudo-Differential Input Gain Setting
        constexpr uint32_t P002DEN = (1U << 11);  ///< P002 Pseudo-Differential Input Enable
    }
...
#endif // ALLOY_GENERATED_R7FA6T3BB_PERIPHERALS_HPP