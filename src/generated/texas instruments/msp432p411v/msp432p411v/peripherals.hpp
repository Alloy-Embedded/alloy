...
namespace lcd {
    ...
    struct Registers {
        ...
        volatile uint32_t LCDM[%s];  ///< Offset: 0x120 - LCD memory registers
        volatile uint32_t LCDBM[%s];  ///< Offset: 0x160 - LCD Blinking memory registers
        volatile uint32_t LCDANM[%s];  ///< Offset: 0x1A0 - LCD Animation memory registers
    };
    ...
    /// LCDM[%s] Register bits
    namespace lcdm[%s]_bits {
    ...
    /// LCDBM[%s] Register bits
    namespace lcdbm[%s]_bits {
        constexpr uint32_t LCDMEMORY = (8 << 0);  ///< LCD Memory Contains LCD Segment on/off data for Line Lx if LCDSSx = 0 Contains COM assignment for Line Lx if LCDSSx = 1
    }

    /// LCDANM[%s] Register bits
    namespace lcdanm[%s]_bits {
