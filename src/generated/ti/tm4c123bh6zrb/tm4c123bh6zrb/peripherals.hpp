...
namespace traits {
    ...
    constexpr uint32_t num_gpio_instances = 24;
    ...
    constexpr uint32_t num_gpio_ports = 24;
    constexpr uint32_t max_gpio_pins = 384;  // 16 pins per port
...
#endif // ALLOY_GENERATED_TM4C123BH6ZRB_PERIPHERALS_HPP