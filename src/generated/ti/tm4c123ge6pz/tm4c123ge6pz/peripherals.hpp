...
#ifndef ALLOY_GENERATED_TM4C123GE6PZ_PERIPHERALS_HPP
#define ALLOY_GENERATED_TM4C123GE6PZ_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::tm4c123ge6pz {
...
namespace traits {
    ...
    constexpr uint32_t num_gpio_instances = 19;
    ...
    constexpr bool has_qei1 = true;
    constexpr uint32_t num_qei1_instances = 1;
    ...
    template<>
    struct peripheral_count<struct qei1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    constexpr uint32_t num_gpio_ports = 19;
    constexpr uint32_t max_gpio_pins = 304;  // 16 pins per port
...
namespace gpio {
    ...
    constexpr uint32_t GPIOH_BASE = 0x40027000;
    constexpr uint32_t GPIOJ_BASE = 0x4003D000;
    ...
    constexpr uint32_t GPIOH_AHB_BASE = 0x4005F000;
    constexpr uint32_t GPIOJ_AHB_BASE = 0x40060000;
    ...
    inline Registers* GPIOH_AHB = reinterpret_cast<Registers*>(GPIOH_AHB_BASE);
    inline Registers* GPIOJ_AHB = reinterpret_cast<Registers*>(GPIOJ_AHB_BASE);
...
namespace pwm {
    ...
    constexpr uint32_t PWM1_BASE = 0x40029000;
...
namespace qei1 {
    /// Base addresses
    constexpr uint32_t QEI1_BASE = 0x4002D000;

    /// QEI1 Register structure
    struct Registers {
    };

    /// Peripheral instances
    inline Registers* QEI1 = reinterpret_cast<Registers*>(QEI1_BASE);
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t IDVRIS;  ///< Offset: 0x444 - USB ID Valid Detect Raw Interrupt Status
        volatile uint32_t IDVIM;  ///< Offset: 0x448 - USB ID Valid Detect Interrupt Mask
        volatile uint32_t IDVISC;  ///< Offset: 0x44C - USB ID Valid Detect Interrupt Status and Clear
...
#endif // ALLOY_GENERATED_TM4C123GE6PZ_PERIPHERALS_HPP