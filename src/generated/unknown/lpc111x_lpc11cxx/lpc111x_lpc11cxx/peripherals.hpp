/// Auto-generated code for LPC111x_LPC11Cxx
...
namespace alloy::generated::lpc111x_lpc11cxx {
...
namespace iocon {
    ...
    struct Registers {
        volatile uint32_t IOCON_PIO2_6;  ///< Offset: 0x00 - I/O configuration for pin PIO2_6/ CT32B0_MAT1
        volatile uint32_t IOCON_PIO2_0;  ///< Offset: 0x08 - I/O configuration for pin PIO2_0/DTR/SSEL1
        volatile uint32_t IOCON_RESET_PIO0_0;  ///< Offset: 0x0C - I/O configuration for pin RESET/PIO0_0
        volatile uint32_t IOCON_PIO0_1;  ///< Offset: 0x10 - I/O configuration for pin PIO0_1/CLKOUT/CT32B0_MAT2
        volatile uint32_t IOCON_PIO1_8;  ///< Offset: 0x14 - I/O configuration for pin PIO1_8/CT16B1_CAP0
        volatile uint32_t IOCON_PIO0_2;  ///< Offset: 0x1C - I/O configuration for pin PIO0_2/SSEL0/CT16B0_CAP0
        volatile uint32_t IOCON_PIO2_7;  ///< Offset: 0x20 - I/O configuration for pin PIO2_7/ CT32B0_MAT2/RXD
        volatile uint32_t IOCON_PIO2_8;  ///< Offset: 0x24 - I/O configuration for pin PIO2_8/ CT32B0_MAT3/TXD
        volatile uint32_t IOCON_PIO2_1;  ///< Offset: 0x28 - I/O configuration for pin PIO2_1/DSR/SCK1
        volatile uint32_t IOCON_PIO0_3;  ///< Offset: 0x2C - I/O configuration for pin PIO0_3
        volatile uint32_t IOCON_PIO0_4;  ///< Offset: 0x30 - I/O configuration for pin PIO0_4/SCL
        volatile uint32_t IOCON_PIO0_5;  ///< Offset: 0x34 - I/O configuration for pin PIO0_5/SDA
        volatile uint32_t IOCON_PIO1_9;  ///< Offset: 0x38 - I/O configuration for pin PIO1_9/CT16B1_MAT0/ MOSI1
        volatile uint32_t IOCON_PIO3_4;  ///< Offset: 0x3C - I/O configuration for pin PIO3_4/ CT16B0_CAP1/RXD
        volatile uint32_t IOCON_PIO2_4;  ///< Offset: 0x40 - I/O configuration for pin PIO2_4/ CT16B1_MAT1/ SSEL1
        volatile uint32_t IOCON_PIO2_5;  ///< Offset: 0x44 - I/O configuration for pin PIO2_5/ CT32B0_MAT0
        volatile uint32_t IOCON_PIO3_5;  ///< Offset: 0x48 - I/O configuration for pin PIO3_5/ CT16B1_CAP1/TXD
        volatile uint32_t IOCON_PIO0_6;  ///< Offset: 0x4C - I/O configuration for pin PIO0_6/SCK0
        volatile uint32_t IOCON_PIO0_7;  ///< Offset: 0x50 - I/O configuration for pin PIO0_7/CTS
        volatile uint32_t IOCON_PIO2_9;  ///< Offset: 0x54 - I/O configuration for pin PIO2_9/ CT32B0_CAP0
        volatile uint32_t IOCON_PIO2_10;  ///< Offset: 0x58 - I/O configuration for pin PIO2_10
        volatile uint32_t IOCON_PIO2_2;  ///< Offset: 0x5C - I/O configuration for pin PIO2_2/DCD/MISO1
        volatile uint32_t IOCON_PIO0_8;  ///< Offset: 0x60 - I/O configuration for pin PIO0_8/MISO0/CT16B0_MAT0
        volatile uint32_t IOCON_PIO0_9;  ///< Offset: 0x64 - I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1
        volatile uint32_t IOCON_SWCLK_PIO0_10;  ///< Offset: 0x68 - I/O configuration for pin SWCLK/PIO0_10/ SCK0/CT16B0_MAT2
        volatile uint32_t IOCON_PIO1_10;  ///< Offset: 0x6C - I/O configuration for pin PIO1_10/AD6/CT16B1_MAT1/ MISO1
        volatile uint32_t IOCON_PIO2_11;  ///< Offset: 0x70 - I/O configuration for pin PIO2_11/SCK0/ CT32B0_CAP1
        volatile uint32_t IOCON_R_PIO0_11;  ///< Offset: 0x74 - I/O configuration for pin R/PIO0_11/AD0/CT32B0_MAT3
        volatile uint32_t IOCON_R_PIO1_0;  ///< Offset: 0x78 - I/O configuration for pin R/PIO1_0/AD1/CT32B1_CAP0
        volatile uint32_t IOCON_R_PIO1_1;  ///< Offset: 0x7C - I/O configuration for pin R/PIO1_1/AD2/CT32B1_MAT0
        volatile uint32_t IOCON_R_PIO1_2;  ///< Offset: 0x80 - I/O configuration for pin R/PIO1_2/AD3/CT32B1_MAT1
        volatile uint32_t IOCON_PIO3_0;  ///< Offset: 0x84 - I/O configuration for pin PIO3_0/DTR/CT16B0_MAT0/TXD
        volatile uint32_t IOCON_PIO3_1;  ///< Offset: 0x88 - I/O configuration for pin PIO3_1/DSR/CT16B0_MAT1/RXD
        volatile uint32_t IOCON_PIO2_3;  ///< Offset: 0x8C - I/O configuration for pin PIO2_3/RI/MOSI1
        volatile uint32_t IOCON_SWDIO_PIO1_3;  ///< Offset: 0x90 - I/O configuration for pin SWDIO/PIO1_3/AD4/CT32B1_MAT2
        volatile uint32_t IOCON_PIO1_4;  ///< Offset: 0x94 - I/O configuration for pin PIO1_4/AD5/CT32B1_MAT3
        volatile uint32_t IOCON_PIO1_11;  ///< Offset: 0x98 - I/O configuration for pin PIO1_11/AD7/CT32B1_CAP1
        volatile uint32_t IOCON_PIO3_2;  ///< Offset: 0x9C - I/O configuration for pin PIO3_2/DCD/ CT16B0_MAT2/SCK1
        volatile uint32_t IOCON_PIO1_5;  ///< Offset: 0xA0 - I/O configuration for pin PIO1_5/RTS/CT32B0_CAP0
        volatile uint32_t IOCON_PIO1_6;  ///< Offset: 0xA4 - I/O configuration for pin PIO1_6/RXD/CT32B0_MAT0
        volatile uint32_t IOCON_PIO1_7;  ///< Offset: 0xA8 - I/O configuration for pin PIO1_7/TXD/CT32B0_MAT1
        volatile uint32_t IOCON_PIO3_3;  ///< Offset: 0xAC - I/O configuration for pin PIO3_3/RI/ CT16B0_CAP0
        volatile uint32_t IOCON_SCK0_LOC;  ///< Offset: 0xB0 - SCK0 pin location select register
        volatile uint32_t IOCON_DSR_LOC;  ///< Offset: 0xB4 - DSR pin location select register
        volatile uint32_t IOCON_DCD_LOC;  ///< Offset: 0xB8 - DCD pin location select register
        volatile uint32_t IOCON_RI_LOC;  ///< Offset: 0xBC - RI pin location select register
        volatile uint32_t IOCON_SSEL1_LOC;  ///< Offset: 0x18 - SSEL1 pin location select register
        volatile uint32_t IOCON_CT16B0_CAP0_LOC;  ///< Offset: 0xC0 - CT16B0_CAP0 pin location select register
        volatile uint32_t IOCON_SCK1_LOC;  ///< Offset: 0xC4 - SCK1 pin location select register
        volatile uint32_t IOCON_MISO1_LOC;  ///< Offset: 0xC8 - MISO1 pin location select register
        volatile uint32_t IOCON_MOSI1_LOC;  ///< Offset: 0xCC - MOSI1 pin location select register
        volatile uint32_t IOCON_CT32B0_CAP0_LOC;  ///< Offset: 0xD0 - CT32B0_CAP0 pin location select register
        volatile uint32_t IOCON_RXD_LOC;  ///< Offset: 0xD4 - RXD pin location select register
    };
...
namespace syscon {
    ...
    struct Registers {
        ...
        volatile uint32_t DEVICE_ID;  ///< Offset: 0x3F4 - Device ID register 0 for parts LPC1100, LPC1100C, LPC1100L.
    };
...
#endif // ALLOY_GENERATED_LPC111X_LPC11CXX_PERIPHERALS_HPP