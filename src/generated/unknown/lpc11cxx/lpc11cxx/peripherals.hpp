...
namespace can {
    ...
    struct Registers {
        ...
        volatile uint32_t CANIF_CMDREQ;  ///< Offset: 0x20 - Message interface 1 command request (renamed from CANIF_CMDREQ)
        volatile uint32_t CANIF_CMDMSK_W;  ///< Offset: 0x24 - Message interface 1 command mask (write direction) (renamed from CANIF_CMDMSK_W)
        volatile uint32_t CANIF_CMDMSK_R;  ///< Offset: 0x24 - Message interface 1 command mask (read direction) (renamed from CANIF_CMDMSK_R)
