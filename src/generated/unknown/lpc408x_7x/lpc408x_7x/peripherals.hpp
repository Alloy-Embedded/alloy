...
namespace flash {
    ...
    struct Registers {
        ...
        volatile uint32_t EEADDR;  ///< Offset: 0x84 - EEPROM address register
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t INCLR;  ///< Offset: 0x10C - OTG Interrupt Clear
        volatile uint32_t PORTSEL;  ///< Offset: 0x110 - USB Port Select. The USBPortSel register is identical to...
        ...
        volatile uint32_t EPIN;  ///< Offset: 0x248 - USB Endpoint Index
        ...
        volatile uint32_t I2C_TX;  ///< Offset: 0x300 - I2C Transmit
        ...
        volatile uint32_t CLKCTRL;  ///< Offset: 0xFF4 - OTG clock controller
...
namespace comp {
    /// Base addresses
    constexpr uint32_t COMPARATOR_BASE = 0x40020000;

    /// COMP Register structure
    struct Registers {
        volatile uint32_t CTRL;  ///< Offset: 0x00 - Comparator block control register
        volatile uint32_t CTRL0;  ///< Offset: 0x04 - Comparator 0 control register
        volatile uint32_t CTRL1;  ///< Offset: 0x08 - Comparator 1 control register
    };
...
#endif // ALLOY_GENERATED_LPC408X_7X_PERIPHERALS_HPP