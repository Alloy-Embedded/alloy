...
extern "C" {
    ...
    void RITIMER_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void SPI_INT_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void SGPIO_IINT_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void EVENTROUTER_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void C_CAN1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void ADCHS_IRQHandler() __attribute__((weak, alias("Default_Handler")));
