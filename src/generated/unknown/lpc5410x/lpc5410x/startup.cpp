...
extern "C" {
    ...
    void UTICK_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void CT32B2_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void CT32B3_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void CT32B4_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void MAILBOX_IRQHandler() __attribute__((weak, alias("Default_Handler")));
