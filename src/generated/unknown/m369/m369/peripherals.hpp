...
namespace alloy::generated::m369 {
...
namespace traits {
    ...
    constexpr uint32_t num_can_instances = 33;
    constexpr bool has_hc = true;
    constexpr uint32_t num_hc_instances = 1;
    ...
    constexpr bool has_em = true;
    constexpr uint32_t num_em_instances = 1;
    ...
    constexpr bool has_ada = true;
    constexpr uint32_t num_ada_instances = 1;
    constexpr bool has_adb = true;
    constexpr uint32_t num_adb_instances = 1;
    constexpr bool has_adilv = true;
    constexpr uint32_t num_adilv_instances = 1;
    constexpr bool has_da0 = true;
    constexpr uint32_t num_da0_instances = 1;
    constexpr bool has_da1 = true;
    constexpr uint32_t num_da1_instances = 1;
    constexpr bool has_exb = true;
    constexpr uint32_t num_exb_instances = 1;
    ...
    constexpr bool has_pl = true;
    constexpr uint32_t num_pl_instances = 1;
    constexpr bool has_pm = true;
    constexpr uint32_t num_pm_instances = 1;
    constexpr bool has_pn = true;
    constexpr uint32_t num_pn_instances = 1;
    ...
    constexpr bool has_mt0 = true;
    constexpr uint32_t num_mt0_instances = 1;
    constexpr bool has_mt1 = true;
    constexpr uint32_t num_mt1_instances = 1;
    constexpr bool has_mt2 = true;
    constexpr uint32_t num_mt2_instances = 1;
    constexpr bool has_mt3 = true;
    constexpr uint32_t num_mt3_instances = 1;
    ...
    constexpr bool has_sbi2 = true;
    constexpr uint32_t num_sbi2_instances = 1;
    ...
    constexpr bool has_sc3 = true;
    constexpr uint32_t num_sc3_instances = 1;
    constexpr bool has_rmc = true;
    constexpr uint32_t num_rmc_instances = 1;
    constexpr bool has_ofd = true;
    constexpr uint32_t num_ofd_instances = 1;
    ...
    constexpr bool has_trmosc = true;
    constexpr uint32_t num_trmosc_instances = 1;
    constexpr bool has_lvd = true;
    constexpr uint32_t num_lvd_instances = 1;
    constexpr bool has_mtpd0 = true;
    constexpr uint32_t num_mtpd0_instances = 1;
    constexpr bool has_mtpd1 = true;
    constexpr uint32_t num_mtpd1_instances = 1;
    constexpr bool has_en0 = true;
    constexpr uint32_t num_en0_instances = 1;
    constexpr bool has_en1 = true;
    constexpr uint32_t num_en1_instances = 1;
    ...
    struct peripheral_count<struct can_tag> {
        static constexpr uint32_t value = 33;
    };
    template<>
    struct peripheral_count<struct hc_tag> {
    ...
    template<>
    struct peripheral_count<struct em_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct ada_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct adb_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct adilv_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct da0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct da1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct exb_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct pl_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct pn_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct mt0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct mt1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct mt2_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct mt3_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct sbi2_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct sc3_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct rmc_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct ofd_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct trmosc_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct mtpd0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct mtpd1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct en0_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct en1_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace em {
    /// Base addresses
    constexpr uint32_t EM_BASE = 0x4000A000;

    /// EM Register structure
    struct Registers {
        volatile uint32_t IFVRR;  ///< Offset: 0x00 - ADiC Version_Revision Register
        volatile uint32_t IFCR;  ///< Offset: 0x04 - ADiC MODE Setting Register
        volatile uint32_t IFINTST;  ///< Offset: 0x10 - ADiC Interrupt Status Register
        volatile uint32_t IFINTEN;  ///< Offset: 0x14 - ADiC Interrupt Enable Register
        volatile uint32_t DCR;  ///< Offset: 0x1000 - EMDMAC Movement Control Register
        volatile uint32_t DTEN;  ///< Offset: 0x1008 - Transmission Instructions Register
        volatile uint32_t DREN;  ///< Offset: 0x1010 - Reception instructions Register
        volatile uint32_t DTDPR;  ///< Offset: 0x1018 - Transmission Dscripter top address setting Register
        volatile uint32_t DRDPR;  ///< Offset: 0x1020 - Reception Dscripter top address setting Register
        volatile uint32_t DINTST;  ///< Offset: 0x1028 - EMSMAC Interrupt Status Indication Register
        volatile uint32_t DINTEN;  ///< Offset: 0x1030 - EMDMAC Interrupt mask setting Register
        volatile uint32_t DERR;  ///< Offset: 0x1038 - Err Mask Setting Register
        volatile uint32_t DMFCR;  ///< Offset: 0x1040 - Disposal Frame Count Register
        volatile uint32_t DTFTR;  ///< Offset: 0x1048 - Transmission FIFO thresholding Register
        volatile uint32_t DFCDR;  ///< Offset: 0x1050 - Outside FIFO Capacity Setting Register
        volatile uint32_t DRRCR;  ///< Offset: 0x1058 - Reception Start Reset Setting Register
        volatile uint32_t DEADR;  ///< Offset: 0x1060 - DMA Error Address Register
        volatile uint32_t DTUFR;  ///< Offset: 0x1064 - Transmission FIFO Underflow Count Register
        volatile uint32_t DROFR;  ///< Offset: 0x1068 - Reception FIFO Underflow Count Register
        volatile uint32_t DRBTR;  ///< Offset: 0x1070 - Transmission FIFO Busy Transmission Thresholding Register
        volatile uint32_t DRPDR;  ///< Offset: 0x1078 - Reception Data Padding setting Register
        volatile uint32_t DTIMER;  ///< Offset: 0x107C - Transmission Interrupt Mode Setting Register
        volatile uint32_t DRBAR;  ///< Offset: 0x10C8 - Reception Buffer Light Address For debugging Register
        volatile uint32_t DRDAR;  ///< Offset: 0x10CC - Reception Dscripter Read Address For Debugging Register
        volatile uint32_t DTBAR;  ///< Offset: 0x10D4 - Transmission Read Address For Debugging Register
        volatile uint32_t DTDAR;  ///< Offset: 0x10D8 - Transmission Dscripter Read Address For Debugging Register
        volatile uint32_t CCR;  ///< Offset: 0x1100 - Ether FeLic Active Mode Register
        volatile uint32_t CRFLR;  ///< Offset: 0x1108 - Long Frame Length Check Level Setting Register
        volatile uint32_t CINTST;  ///< Offset: 0x1110 - Status indication Register
        volatile uint32_t CINTEN;  ///< Offset: 0x1118 - Interrupt mask setting Register
        volatile uint32_t CMIICR;  ///< Offset: 0x1120 - MII Control Register
        volatile uint32_t CPHYST;  ///< Offset: 0x1128 - Status Signal Register
        volatile uint32_t CICR;  ///< Offset: 0x1150 - IPG Counter Setting Register
        volatile uint32_t CAPR;  ///< Offset: 0x1154 - Auto Pause Parameter Setting Register
        volatile uint32_t CMPR;  ///< Offset: 0x1158 - Manual Pause Parameter setting Register
        volatile uint32_t CRPCR;  ///< Offset: 0x1160 - Reception PAUSE Frame Counter Register
        volatile uint32_t CPULR;  ///< Offset: 0x1164 - PAUSE Frame Retransmission Number Of Times Setting Register
        volatile uint32_t CPCR;  ///< Offset: 0x1168 - PAUSE Frame Retransmission Number Of Times Counter Register
        volatile uint32_t CBRR;  ///< Offset: 0x116C - Broadcast Frame Reception Number Of Times Setting Register
        volatile uint32_t CMAHR;  ///< Offset: 0x11C0 - Mac Address Register (High Rank)
        volatile uint32_t CMALR;  ///< Offset: 0x11C8 - Mac Address Register (Low Rank)
        volatile uint32_t CTRER;  ///< Offset: 0x11D0 - TINT1 Cunter Register
        volatile uint32_t CTCDR;  ///< Offset: 0x11D4 - TINT2 Cunter Register
        volatile uint32_t CTCLR;  ///< Offset: 0x11D8 - TINT3 Cunter Register
        volatile uint32_t CTNDR;  ///< Offset: 0x11DC - TINT4 Cunter Register
        volatile uint32_t CRCER;  ///< Offset: 0x11E4 - RINT1 Cunter Register
        volatile uint32_t CRFER;  ///< Offset: 0x11E8 - RINT2 Cunter Register
        volatile uint32_t CRLSR;  ///< Offset: 0x11EC - RINT3 Cunter Register
        volatile uint32_t CRLOR;  ///< Offset: 0x11F0 - RINT4 Cunter Register
        volatile uint32_t CRRFR;  ///< Offset: 0x11F4 - RINT5 Cunter Register
        volatile uint32_t CRMFR;  ///< Offset: 0x11F8 - RINT8 Cunter Register
    };

    /// Peripheral instances
    inline Registers* EM = reinterpret_cast<Registers*>(EM_BASE);

    // Bit definitions
    /// IFVRR Register bits
    namespace ifvrr_bits {
        constexpr uint32_t REV = (16 << 0);  ///< REV
        constexpr uint32_t VER = (16 << 16);  ///< VER
    }

    /// IFCR Register bits
    namespace ifcr_bits {
        constexpr uint32_t IOTOUT = (1U << 8);  ///< IOTOUT
        constexpr uint32_t DMATOUT = (1U << 9);  ///< DMATOUT
        constexpr uint32_t DMAERR = (1U << 10);  ///< DMAERR
    }

    /// IFINTST Register bits
    namespace ifintst_bits {
        constexpr uint32_t EMDMACINT = (1U << 0);  ///< EMDMACINT
        constexpr uint32_t SLAVE0 = (1U << 8);  ///< SLAVE0
        constexpr uint32_t SLAVE1 = (1U << 9);  ///< SLAVE1
        constexpr uint32_t SLAVE2 = (1U << 10);  ///< SLAVE2
        constexpr uint32_t SLAVE3 = (1U << 11);  ///< SLAVE3
        constexpr uint32_t IOTOUT = (1U << 15);  ///< IOTOUT
        constexpr uint32_t MASTER0 = (1U << 16);  ///< MASTER0
        constexpr uint32_t MASTER1 = (1U << 17);  ///< MASTER1
        constexpr uint32_t MASTER2 = (1U << 18);  ///< MASTER2
        constexpr uint32_t DMATOUT = (1U << 23);  ///< DMATOUT
    }

    /// IFINTEN Register bits
    namespace ifinten_bits {
        constexpr uint32_t EMDMACINT = (1U << 0);  ///< EMDMACINT
        constexpr uint32_t SLAVE0 = (1U << 8);  ///< SLAVE0
        constexpr uint32_t SLAVE1 = (1U << 9);  ///< SLAVE1
        constexpr uint32_t SLAVE2 = (1U << 10);  ///< SLAVE2
    ...
    /// DCR Register bits
    namespace dcr_bits {
        constexpr uint32_t SWR = (1U << 0);  ///< SWR
        constexpr uint32_t DL = (2 << 4);  ///< DL
        constexpr uint32_t DE = (1U << 6);  ///< DE
    }

    /// DTEN Register bits
    namespace dten_bits {
        constexpr uint32_t TRNS = (1U << 0);  ///< TRNS
    }

    /// DREN Register bits
    namespace dren_bits {
        constexpr uint32_t RCV = (1U << 0);  ///< RCV
    }

    /// DTDPR Register bits
    namespace dtdpr_bits {
        constexpr uint32_t TDPA = (32 << 0);  ///< TDPA
    }

    /// DRDPR Register bits
    namespace drdpr_bits {
        constexpr uint32_t RDPA = (32 << 0);  ///< RDPA
    }

    /// DINTST Register bits
    namespace dintst_bits {
        constexpr uint32_t RINT1 = (1U << 0);  ///< RINT1
        constexpr uint32_t RINT2 = (1U << 1);  ///< RINT2
        constexpr uint32_t RINT3 = (1U << 2);  ///< RINT3
        constexpr uint32_t RINT4 = (1U << 3);  ///< RINT4
        constexpr uint32_t RINT5 = (1U << 4);  ///< RINT5
        constexpr uint32_t RINT8 = (1U << 7);  ///< RINT8
        constexpr uint32_t TINT1 = (1U << 8);  ///< TINT1
        constexpr uint32_t TINT2 = (1U << 9);  ///< TINT2
        constexpr uint32_t TINT3 = (1U << 10);  ///< TINT3
        constexpr uint32_t TINT4 = (1U << 11);  ///< TINT4
        constexpr uint32_t RFE = (1U << 16);  ///< RFE
        constexpr uint32_t RDE = (1U << 17);  ///< RDE
        constexpr uint32_t FRC = (1U << 18);  ///< FRC
        constexpr uint32_t TFE = (1U << 19);  ///< TFE
        constexpr uint32_t TDE = (1U << 20);  ///< TDE
        constexpr uint32_t FTC = (1U << 21);  ///< FTC
        constexpr uint32_t MINT = (1U << 22);  ///< MINT
        constexpr uint32_t BER = (1U << 23);  ///< BER
        constexpr uint32_t RFRMER = (1U << 24);  ///< RFRMER
        constexpr uint32_t RABT = (1U << 25);  ///< RABT
        constexpr uint32_t TABT = (1U << 26);  ///< TABT
        constexpr uint32_t TWB = (1U << 30);  ///< TWB
    }

    /// DINTEN Register bits
    namespace dinten_bits {
        constexpr uint32_t RINT1 = (1U << 0);  ///< RINT1
        constexpr uint32_t RINT2 = (1U << 1);  ///< RINT2
        constexpr uint32_t RINT3 = (1U << 2);  ///< RINT3
        constexpr uint32_t RINT4 = (1U << 3);  ///< RINT4
    ...
    /// DMFCR Register bits
    namespace dmfcr_bits {
        constexpr uint32_t MIS = (16 << 0);  ///< MIS
    }

    /// DTFTR Register bits
    namespace dtftr_bits {
        constexpr uint32_t TFTH = (11 << 0);  ///< TFTH
    }

    /// DFCDR Register bits
    namespace dfcdr_bits {
        constexpr uint32_t RA = (5 << 0);  ///< RA
        constexpr uint32_t TA = (5 << 8);  ///< TA
    }

    /// DRRCR Register bits
    namespace drrcr_bits {
        constexpr uint32_t RR = (1U << 0);  ///< RR
        constexpr uint32_t RNR = (1U << 1);  ///< RNR
    }

    /// DEADR Register bits
    namespace deadr_bits {
        constexpr uint32_t ERRADR = (32 << 0);  ///< ERRADR
    }

    /// DTUFR Register bits
    namespace dtufr_bits {
        constexpr uint32_t UNDER = (16 << 0);  ///< UNDER
    }

    /// DROFR Register bits
    namespace drofr_bits {
        constexpr uint32_t OVER = (16 << 0);  ///< OVER
    }

    /// DRBTR Register bits
    namespace drbtr_bits {
        constexpr uint32_t RFDO = (3 << 0);  ///< RFDO
        constexpr uint32_t RFFO = (3 << 16);  ///< RFFO
    }

    /// DRPDR Register bits
    namespace drpdr_bits {
        constexpr uint32_t PADR = (6 << 0);  ///< PADR
        constexpr uint32_t PADS = (2 << 16);  ///< PADS
    }

    /// DTIMER Register bits
    namespace dtimer_bits {
        constexpr uint32_t TIS = (1U << 0);  ///< TIS
        constexpr uint32_t TIM = (1U << 4);  ///< TIM
    }

    /// DRBAR Register bits
    namespace drbar_bits {
        constexpr uint32_t RBWA = (32 << 0);  ///< RBWA
    }

    /// DRDAR Register bits
    namespace drdar_bits {
        constexpr uint32_t RDRA = (32 << 0);  ///< RDRA
    }

    /// DTBAR Register bits
    namespace dtbar_bits {
        constexpr uint32_t TBRA = (32 << 0);  ///< TBRA
    }

    /// DTDAR Register bits
    namespace dtdar_bits {
        constexpr uint32_t TDRA = (32 << 0);  ///< TDRA
    }

    /// CCR Register bits
    namespace ccr_bits {
        constexpr uint32_t PRM = (1U << 0);  ///< PRM
        constexpr uint32_t DPM = (1U << 1);  ///< DPM
        constexpr uint32_t OLB = (1U << 2);  ///< OLB
        constexpr uint32_t ILB = (1U << 3);  ///< ILB
        constexpr uint32_t TPE = (1U << 5);  ///< TPE
        constexpr uint32_t RPE = (1U << 6);  ///< RPE
        constexpr uint32_t MPM = (1U << 9);  ///< MPM
        constexpr uint32_t CER = (1U << 12);  ///< CER
        constexpr uint32_t TXF = (1U << 16);  ///< TXF
        constexpr uint32_t RXF = (1U << 17);  ///< RXF
        constexpr uint32_t PFR = (1U << 18);  ///< PFR
        constexpr uint32_t TPF = (1U << 19);  ///< TPF
        constexpr uint32_t TPC = (1U << 20);  ///< TPC
    }

    /// CRFLR Register bits
    namespace crflr_bits {
        constexpr uint32_t FLEN_ULMT = (12 << 0);  ///< FLEN_ULMT
    }

    /// CINTST Register bits
    namespace cintst_bits {
        constexpr uint32_t FCIDTCT = (1U << 0);  ///< FCIDTCT
        constexpr uint32_t MAGICPKT = (1U << 1);  ///< MAGICPKT
        constexpr uint32_t LINKCHNG = (1U << 2);  ///< LINKCHNG
        constexpr uint32_t PSRTROV = (1U << 4);  ///< PSRTROV
        constexpr uint32_t BRDSRCV = (1U << 5);  ///< BRDSRCV
    }

    /// CINTEN Register bits
    namespace cinten_bits {
        constexpr uint32_t FCIDTCT = (1U << 0);  ///< FCIDTCT
        constexpr uint32_t MAGICPKT = (1U << 1);  ///< MAGICPKT
        constexpr uint32_t LINKCHNG = (1U << 2);  ///< LINKCHNG
        constexpr uint32_t PSRTROV = (1U << 4);  ///< PSRTROV
    ...
    /// CMIICR Register bits
    namespace cmiicr_bits {
        constexpr uint32_t MDC = (1U << 0);  ///< MDC
        constexpr uint32_t MMD = (1U << 1);  ///< MMD
        constexpr uint32_t MDO = (1U << 2);  ///< MDO
        constexpr uint32_t MDI = (1U << 3);  ///< MDI
    }

    /// CPHYST Register bits
    namespace cphyst_bits {
        constexpr uint32_t LINK = (1U << 0);  ///< LINK
    }
    ...
    /// CAPR Register bits
    namespace capr_bits {
        constexpr uint32_t APAUSE = (16 << 0);  ///< APAUSE
    }

    /// CMPR Register bits
    namespace cmpr_bits {
        constexpr uint32_t MPAUSE = (16 << 0);  ///< MPAUSE
    }

    /// CRPCR Register bits
    namespace crpcr_bits {
        constexpr uint32_t RPAUSE = (8 << 0);  ///< RPAUSE
    }

    /// CPULR Register bits
    namespace cpulr_bits {
        constexpr uint32_t TXPAUSE = (16 << 0);  ///< TXPAUSE
    }
    ...
    /// CMAHR Register bits
    namespace cmahr_bits {
        constexpr uint32_t MACADRH = (32 << 0);  ///< MACADRH
    }

    /// CMALR Register bits
    namespace cmalr_bits {
        constexpr uint32_t MACADRL = (32 << 0);  ///< MACADRL
    }

    /// CTRER Register bits
    namespace ctrer_bits {
        constexpr uint32_t TINT1CNT = (32 << 0);  ///< TINT1CNT
    }

    /// CTCDR Register bits
    namespace ctcdr_bits {
        constexpr uint32_t TINT2CNT = (32 << 0);  ///< TINT2CNT
    }

    /// CTCLR Register bits
    namespace ctclr_bits {
        constexpr uint32_t TINT3CNT = (32 << 0);  ///< TINT3CNT
    }

    /// CTNDR Register bits
    namespace ctndr_bits {
        constexpr uint32_t TINT4CNT = (32 << 0);  ///< TINT4CNT
    }

    /// CRCER Register bits
    namespace crcer_bits {
        constexpr uint32_t RINT1CNT = (32 << 0);  ///< RINT1CNT
    }

    /// CRFER Register bits
    namespace crfer_bits {
        constexpr uint32_t RINT2CNT = (32 << 0);  ///< RINT2CNT
    }

    /// CRLSR Register bits
    namespace crlsr_bits {
        constexpr uint32_t RINT3CNT = (32 << 0);  ///< RINT3CNT
    }

    /// CRLOR Register bits
    namespace crlor_bits {
        constexpr uint32_t RINT4CNT = (32 << 0);  ///< RINT4CNT
    }

    /// CRRFR Register bits
    namespace crrfr_bits {
        constexpr uint32_t RINT5CNT = (32 << 0);  ///< RINT5CNT
    }

    /// CRMFR Register bits
    namespace crmfr_bits {
        constexpr uint32_t RINT8CNT = (32 << 0);  ///< RINT8CNT
    }
...
namespace ada {
    ...
    namespace reg00_bits {
        ...
        constexpr uint32_t _ADRF = (1U << 16);  ///< _ADRF
        constexpr uint32_t _ADOVRF = (1U << 17);  ///< _ADOVRF
...
namespace pc {
    ...
    struct Registers {
        ...
        volatile uint32_t FR2;  ///< Offset: 0x0C - PC Function Register 2
    ...
    /// FR2 Register bits
    namespace fr2_bits {
        constexpr uint32_t PC0F2 = (1U << 0);  ///< PC0F2
        constexpr uint32_t PC1F2 = (1U << 1);  ///< PC1F2
    }
...
namespace ph {
    ...
    namespace data_bits {
        ...
        constexpr uint32_t PH6 = (1U << 6);  ///< PH6
        constexpr uint32_t PH7 = (1U << 7);  ///< PH7
    }
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t PH6C = (1U << 6);  ///< PH6C
        constexpr uint32_t PH7C = (1U << 7);  ///< PH7C
    }
    ...
    namespace fr1_bits {
        ...
        constexpr uint32_t PH6F1 = (1U << 6);  ///< PH6F1
        constexpr uint32_t PH7F1 = (1U << 7);  ///< PH7F1
    }
    ...
    namespace fr2_bits {
        ...
        constexpr uint32_t PH7F2 = (1U << 7);  ///< PH7F2
    }
    ...
    namespace fr5_bits {
        ...
        constexpr uint32_t PH4F5 = (1U << 4);  ///< PH4F5
    }
    ...
    namespace od_bits {
        ...
        constexpr uint32_t PH6OD = (1U << 6);  ///< PH6OD
        constexpr uint32_t PH7OD = (1U << 7);  ///< PH7OD
    }
    ...
    namespace pup_bits {
        ...
        constexpr uint32_t PH6UP = (1U << 6);  ///< PH6UP
        constexpr uint32_t PH7UP = (1U << 7);  ///< PH7UP
    }
    ...
    namespace pdn_bits {
        ...
        constexpr uint32_t PN4DN = (1U << 4);  ///< PN4DN
        constexpr uint32_t PN5DN = (1U << 5);  ///< PN5DN
        constexpr uint32_t PN6DN = (1U << 6);  ///< PN6DN
        constexpr uint32_t PN7DN = (1U << 7);  ///< PN7DN
    }
    ...
    namespace ie_bits {
        ...
        constexpr uint32_t PH6IE = (1U << 6);  ///< PH6IE
        constexpr uint32_t PH7IE = (1U << 7);  ///< PH7IE
    }
...
namespace pj {
    ...
    struct Registers {
        ...
        volatile uint32_t OD;  ///< Offset: 0x28 - PJ Open Drain Control Register
    ...
    namespace od_bits {
        ...
        constexpr uint32_t PJ5OD = (1U << 5);  ///< PJ5OD
        constexpr uint32_t PJ6OD = (1U << 6);  ///< PJ6OD
        constexpr uint32_t PJ7OD = (1U << 7);  ///< PJ7OD
    }
    ...
    namespace pdn_bits {
        ...
        constexpr uint32_t PJ5DN = (1U << 5);  ///< PJ5DN
        constexpr uint32_t PJ6DN = (1U << 6);  ///< PJ6DN
        constexpr uint32_t PJ7DN = (1U << 7);  ///< PJ7DN
    }
...
namespace pl {
    ...
    namespace data_bits {
        ...
        constexpr uint32_t PL4 = (1U << 4);  ///< PL4
        constexpr uint32_t PL5 = (1U << 5);  ///< PL5
        constexpr uint32_t PL6 = (1U << 6);  ///< PL6
        constexpr uint32_t PL7 = (1U << 7);  ///< PL7
    }
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t PL4C = (1U << 4);  ///< PL4C
        constexpr uint32_t PL5C = (1U << 5);  ///< PL5C
        constexpr uint32_t PL6C = (1U << 6);  ///< PL6C
        constexpr uint32_t PL7C = (1U << 7);  ///< PL7C
    }
    ...
    namespace fr1_bits {
        ...
        constexpr uint32_t PL4F1 = (1U << 4);  ///< PL4F1
        constexpr uint32_t PL5F1 = (1U << 5);  ///< PL5F1
        constexpr uint32_t PL6F1 = (1U << 6);  ///< PL6F1
        constexpr uint32_t PL7F1 = (1U << 7);  ///< PL7F1
    }
    ...
    namespace fr2_bits {
        ...
        constexpr uint32_t PL4F2 = (1U << 4);  ///< PL4F2
        constexpr uint32_t PL5F2 = (1U << 5);  ///< PL5F2
        constexpr uint32_t PL6F2 = (1U << 6);  ///< PL6F2
        constexpr uint32_t PL7F2 = (1U << 7);  ///< PL7F2
    }
    ...
    namespace od_bits {
        ...
        constexpr uint32_t PL4OD = (1U << 4);  ///< PL4OD
        constexpr uint32_t PL5OD = (1U << 5);  ///< PL5OD
        constexpr uint32_t PL6OD = (1U << 6);  ///< PL6OD
        constexpr uint32_t PL7OD = (1U << 7);  ///< PL7OD
    }
    ...
    namespace pup_bits {
        ...
        constexpr uint32_t PL4UP = (1U << 4);  ///< PL4UP
        constexpr uint32_t PL5UP = (1U << 5);  ///< PL5UP
        constexpr uint32_t PL6UP = (1U << 6);  ///< PL6UP
        constexpr uint32_t PL7UP = (1U << 7);  ///< PL7UP
    }
    ...
    namespace pdn_bits {
        ...
        constexpr uint32_t PL4DN = (1U << 4);  ///< PL4DN
        constexpr uint32_t PL5DN = (1U << 5);  ///< PL5DN
        constexpr uint32_t PL6DN = (1U << 6);  ///< PL6DN
        constexpr uint32_t PL7DN = (1U << 7);  ///< PL7DN
    }
    ...
    namespace ie_bits {
        ...
        constexpr uint32_t PL4IE = (1U << 4);  ///< PL4IE
        constexpr uint32_t PL5IE = (1U << 5);  ///< PL5IE
        constexpr uint32_t PL6IE = (1U << 6);  ///< PL6IE
        constexpr uint32_t PL7IE = (1U << 7);  ///< PL7IE
    }
...
namespace pm {
    /// Base addresses
    constexpr uint32_t PM_BASE = 0x400C0C00;

    /// PM Register structure
    struct Registers {
        volatile uint32_t DATA;  ///< Offset: 0x00 - PM Data Register
        volatile uint32_t CR;  ///< Offset: 0x04 - PM Control Register
        volatile uint32_t FR1;  ///< Offset: 0x08 - PM Function Register 1
        volatile uint32_t FR2;  ///< Offset: 0x0C - PM Function Register 2
        volatile uint32_t OD;  ///< Offset: 0x28 - PM Open Drain Control Register
        volatile uint32_t PUP;  ///< Offset: 0x2C - PM Pull-Up Control Register
        volatile uint32_t PDN;  ///< Offset: 0x30 - PM Pull-Down Control Register
        volatile uint32_t IE;  ///< Offset: 0x38 - PM Input Enable Control Register
    };
    ...
    /// DATA Register bits
    namespace data_bits {
        constexpr uint32_t PM0 = (1U << 0);  ///< PM0
        constexpr uint32_t PM1 = (1U << 1);  ///< PM1
        constexpr uint32_t PM2 = (1U << 2);  ///< PM2
        constexpr uint32_t PM3 = (1U << 3);  ///< PM3
    }

    /// CR Register bits
    namespace cr_bits {
        constexpr uint32_t PM0C = (1U << 0);  ///< PM0C
        constexpr uint32_t PM1C = (1U << 1);  ///< PM1C
        constexpr uint32_t PM2C = (1U << 2);  ///< PM2C
        constexpr uint32_t PM3C = (1U << 3);  ///< PM3C
    }

    /// FR1 Register bits
    namespace fr1_bits {
        constexpr uint32_t PM0F1 = (1U << 0);  ///< PM0F1
        constexpr uint32_t PM1F1 = (1U << 1);  ///< PM1F1
        constexpr uint32_t PM2F1 = (1U << 2);  ///< PM2F1
    }
    ...
    namespace fr2_bits {
        ...
        constexpr uint32_t PM1F1 = (1U << 1);  ///< PM1F1
        constexpr uint32_t PM2F1 = (1U << 2);  ///< PM2F1
        constexpr uint32_t PM3F1 = (1U << 3);  ///< PM3F1
    }

    /// OD Register bits
    namespace od_bits {
        constexpr uint32_t PM0OD = (1U << 0);  ///< PM0OD
        constexpr uint32_t PM1OD = (1U << 1);  ///< PM1OD
        constexpr uint32_t PM2OD = (1U << 2);  ///< PM2OD
        constexpr uint32_t PM3OD = (1U << 3);  ///< PM3OD
    }

    /// PUP Register bits
    namespace pup_bits {
        constexpr uint32_t PM0UP = (1U << 0);  ///< PM0UP
        constexpr uint32_t PM1UP = (1U << 1);  ///< PM1UP
        constexpr uint32_t PM2UP = (1U << 2);  ///< PM2UP
        constexpr uint32_t PM3UP = (1U << 3);  ///< PM3UP
    }
    ...
    /// IE Register bits
    namespace ie_bits {
        constexpr uint32_t PM0IE = (1U << 0);  ///< PM0IE
        constexpr uint32_t PM1IE = (1U << 1);  ///< PM1IE
        constexpr uint32_t PM2IE = (1U << 2);  ///< PM2IE
        constexpr uint32_t PM3IE = (1U << 3);  ///< PM3IE
    }
...
namespace pn {
    /// Base addresses
    constexpr uint32_t PN_BASE = 0x400C0D00;

    /// PN Register structure
    struct Registers {
        volatile uint32_t DATA;  ///< Offset: 0x00 - PN Data Register
        volatile uint32_t CR;  ///< Offset: 0x04 - PN Control Register
        volatile uint32_t FR1;  ///< Offset: 0x08 - PN Function Register 1
        volatile uint32_t FR2;  ///< Offset: 0x0C - PN Function Register 2
        volatile uint32_t OD;  ///< Offset: 0x28 - PN Open Drain Control Register
        volatile uint32_t PUP;  ///< Offset: 0x2C - PN Pull-Up Control Register
        volatile uint32_t PDN;  ///< Offset: 0x30 - PN Pull-Down Control Register
        volatile uint32_t IE;  ///< Offset: 0x38 - PN Input Enable Control Register
    };

    /// Peripheral instances
    inline Registers* PN = reinterpret_cast<Registers*>(PN_BASE);

    // Bit definitions
    /// DATA Register bits
    namespace data_bits {
        constexpr uint32_t PN0 = (1U << 0);  ///< PN0
        constexpr uint32_t PN1 = (1U << 1);  ///< PN1
        constexpr uint32_t PN2 = (1U << 2);  ///< PN2
        constexpr uint32_t PN3 = (1U << 3);  ///< PN3
        constexpr uint32_t PN4 = (1U << 4);  ///< PN4
        constexpr uint32_t PN5 = (1U << 5);  ///< PN5
    }

    /// CR Register bits
    namespace cr_bits {
        constexpr uint32_t PN0C = (1U << 0);  ///< PN0C
        constexpr uint32_t PN1C = (1U << 1);  ///< PN1C
        constexpr uint32_t PN2C = (1U << 2);  ///< PN2C
        constexpr uint32_t PN3C = (1U << 3);  ///< PN3C
        constexpr uint32_t PN4C = (1U << 4);  ///< PN4C
        constexpr uint32_t PN5C = (1U << 5);  ///< PN5C
    }

    /// FR1 Register bits
    namespace fr1_bits {
        constexpr uint32_t PN0F1 = (1U << 0);  ///< PN0F1
        constexpr uint32_t PN1F1 = (1U << 1);  ///< PN1F1
        constexpr uint32_t PN2F1 = (1U << 2);  ///< PN2F1
        constexpr uint32_t PN3F1 = (1U << 3);  ///< PN3F1
        constexpr uint32_t PN4F1 = (1U << 4);  ///< PN4F1
        constexpr uint32_t PN5F1 = (1U << 5);  ///< PN5F1
    }
    ...
    /// OD Register bits
    namespace od_bits {
        constexpr uint32_t PN0OD = (1U << 0);  ///< PN0OD
        constexpr uint32_t PN1OD = (1U << 1);  ///< PN1OD
        constexpr uint32_t PN2OD = (1U << 2);  ///< PN2OD
        constexpr uint32_t PN3OD = (1U << 3);  ///< PN3OD
        constexpr uint32_t PN4OD = (1U << 4);  ///< PN4OD
        constexpr uint32_t PN5OD = (1U << 5);  ///< PN5OD
    }

    /// PUP Register bits
    namespace pup_bits {
        constexpr uint32_t PN0UP = (1U << 0);  ///< PN0UP
        constexpr uint32_t PN1UP = (1U << 1);  ///< PN1UP
        constexpr uint32_t PN2UP = (1U << 2);  ///< PN2UP
        constexpr uint32_t PN3UP = (1U << 3);  ///< PN3UP
        constexpr uint32_t PN4UP = (1U << 4);  ///< PN4UP
        constexpr uint32_t PN5UP = (1U << 5);  ///< PN5UP
    }
    ...
    /// IE Register bits
    namespace ie_bits {
        constexpr uint32_t PN0IE = (1U << 0);  ///< PN0IE
        constexpr uint32_t PN1IE = (1U << 1);  ///< PN1IE
        constexpr uint32_t PN2IE = (1U << 2);  ///< PN2IE
        constexpr uint32_t PN3IE = (1U << 3);  ///< PN3IE
        constexpr uint32_t PN4IE = (1U << 4);  ///< PN4IE
        constexpr uint32_t PN5IE = (1U << 5);  ///< PN5IE
    }
...
namespace mtpd0 {
    /// Base addresses
    constexpr uint32_t MTPD0_BASE = 0x400F6000;

    /// MTPD0 Register structure
    struct Registers {
    ...
    /// Peripheral instances
    inline Registers* MTPD0 = reinterpret_cast<Registers*>(MTPD0_BASE);
...
namespace mtpd1 {
    /// Base addresses
    constexpr uint32_t MTPD1_BASE = 0x400F6100;

    /// MTPD1 Register structure
    struct Registers {
    };

    /// Peripheral instances
    inline Registers* MTPD1 = reinterpret_cast<Registers*>(MTPD1_BASE);
...
namespace en0 {
    /// Base addresses
    constexpr uint32_t EN0_BASE = 0x400F7000;

    /// EN0 Register structure
    struct Registers {
    ...
    /// Peripheral instances
    inline Registers* EN0 = reinterpret_cast<Registers*>(EN0_BASE);
...
namespace en1 {
    /// Base addresses
    constexpr uint32_t EN1_BASE = 0x400F7100;

    /// EN1 Register structure
    struct Registers {
    };

    /// Peripheral instances
    inline Registers* EN1 = reinterpret_cast<Registers*>(EN1_BASE);
...
#endif // ALLOY_GENERATED_M369_PERIPHERALS_HPP