...
namespace alloy::generated::m36b {
...
namespace traits {
    ...
    constexpr bool has_mtpd = true;
    constexpr uint32_t num_mtpd_instances = 1;
    constexpr bool has_en = true;
    constexpr uint32_t num_en_instances = 1;
    ...
    template<>
    struct peripheral_count<struct mtpd_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct en_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace usart {
    /// Base addresses
    constexpr uint32_t UART0_BASE = 0x40048000;
    constexpr uint32_t UART1_BASE = 0x40049000;
...
namespace ad {
    ...
    struct Registers {
        ...
        volatile uint32_t REG12;  ///< Offset: 0x64 - AD Conversion Result Register 12
        volatile uint32_t REG13;  ///< Offset: 0x68 - AD Conversion Result Register 13
        volatile uint32_t REG14;  ///< Offset: 0x6C - AD Conversion Result Register 14
        volatile uint32_t REG15;  ///< Offset: 0x70 - AD Conversion Result Register 15
    ...
    namespace reg00_bits {
        ...
        constexpr uint32_t ADR_MIR = (12 << 20);  ///< ADR_MIR
    }
    ...
    namespace regsp_bits {
        ...
        constexpr uint32_t ADSPRF_MIR = (1U << 16);  ///< ADSPRF_MIR
        constexpr uint32_t ADOVRSPF_MIR = (1U << 17);  ///< ADOVRSPF_MIR
        constexpr uint32_t ADSPR_MIR = (12 << 20);  ///< ADSPR_MIR
    }
...
namespace adilv {
    /// Base addresses
    constexpr uint32_t ADILV_BASE = 0x40066000;

    /// ADILV Register structure
    struct Registers {
        volatile uint32_t TRGSEL;  ///< Offset: 0x10 - Trigger Select Register
    };
    ...
    // Bit definitions
    /// TRGSEL Register bits
    namespace trgsel_bits {
        constexpr uint32_t TRGSELEN = (1U << 0);  ///< TRGSELEN
        constexpr uint32_t TRGSEL = (4 << 8);  ///< TRGSEL
        constexpr uint32_t HPTRGSEL = (4 << 12);  ///< HPTRGSEL
    }
...
namespace pc {
    ...
    /// FR2 Register bits
    namespace fr2_bits {
        constexpr uint32_t PC5F2 = (1U << 5);  ///< PC5F2
    }
...
namespace pj {
    ...
    /// FR2 Register bits
    namespace fr2_bits {
        constexpr uint32_t PJ3F2 = (1U << 3);  ///< PJ3F2
    }
...
namespace mt0 {
    ...
    struct Registers {
        ...
        volatile uint32_t IGTRG;  ///< Offset: 0x58 - IGBT Trigger Register
    };
    ...
    namespace igcr_bits {
        ...
        constexpr uint32_t IGCLSYNC = (1U << 7);  ///< IGCLSYNC
    ...
    /// IGTRG Register bits
    namespace igtrg_bits {
        constexpr uint32_t IGTRG = (16 << 0);  ///< IGTRG
    }
...
namespace rtc {
    ...
    struct Registers {
        ...
        volatile uint32_t PROTECT;  ///< Offset: 0x0E - RTC PROTECT Register
        volatile uint32_t ADJCTL;  ///< Offset: 0x0F - RTC ADJCTL Register
        volatile uint32_t ADJDAT;  ///< Offset: 0x10 - RTC ADJDAT Register
    };
...
namespace cg {
    ...
    struct Registers {
        ...
        volatile uint32_t FSYSMSK;  ///< Offset: 0x20 - Peripheral Clock Stop Register
    ...
    /// FSYSMSK Register bits
    namespace fsysmsk_bits {
        constexpr uint32_t MSK0 = (1U << 0);  ///< MSK0
        constexpr uint32_t MSK1 = (1U << 1);  ///< MSK1
        constexpr uint32_t MSK2 = (1U << 2);  ///< MSK2
        constexpr uint32_t MSK3 = (1U << 3);  ///< MSK3
        constexpr uint32_t MSK4 = (1U << 4);  ///< MSK4
        constexpr uint32_t MSK5 = (1U << 5);  ///< MSK5
        constexpr uint32_t MSK6 = (1U << 6);  ///< MSK6
        constexpr uint32_t MSK7 = (1U << 7);  ///< MSK7
        constexpr uint32_t MSK8 = (1U << 8);  ///< MSK8
        constexpr uint32_t MSK9 = (1U << 9);  ///< MSK9
        constexpr uint32_t MSK10 = (1U << 10);  ///< MSK10
        constexpr uint32_t MSK11 = (1U << 11);  ///< MSK11
        constexpr uint32_t MSK12 = (1U << 12);  ///< MSK12
        constexpr uint32_t MSK13 = (1U << 13);  ///< MSK13
        constexpr uint32_t MSK14 = (1U << 14);  ///< MSK14
        constexpr uint32_t MSK15 = (1U << 15);  ///< MSK15
        constexpr uint32_t MSK16 = (1U << 16);  ///< MSK16
        constexpr uint32_t MSK17 = (1U << 17);  ///< MSK17
        constexpr uint32_t MSK18 = (1U << 18);  ///< MSK18
        constexpr uint32_t MSK19 = (1U << 19);  ///< MSK19
        constexpr uint32_t MSK20 = (1U << 20);  ///< MSK20
        constexpr uint32_t MSK21 = (1U << 21);  ///< MSK21
        constexpr uint32_t MSK22 = (1U << 22);  ///< MSK22
        constexpr uint32_t MSK23 = (1U << 23);  ///< MSK23
        constexpr uint32_t MSK24 = (1U << 24);  ///< MSK24
        constexpr uint32_t MSK25 = (1U << 25);  ///< MSK25
        constexpr uint32_t MSK26 = (1U << 26);  ///< MSK26
        constexpr uint32_t MSK27 = (1U << 27);  ///< MSK27
        constexpr uint32_t MSK28 = (1U << 28);  ///< MSK28
        constexpr uint32_t MSK29 = (1U << 29);  ///< MSK29
        constexpr uint32_t MSK30 = (1U << 30);  ///< MSK30
        constexpr uint32_t MSK31 = (1U << 31);  ///< MSK31
    }
    ...
    namespace imcgd_bits {
        constexpr uint32_t INTCEN = (1U << 0);  ///< INTCEN
        constexpr uint32_t EMSTC = (2 << 2);  ///< EMSTC
        constexpr uint32_t EMCGC = (3 << 4);  ///< EMCGC
...
namespace mtpd {
    ...
    struct Registers {
        ...
        volatile uint32_t TRGCMP0;  ///< Offset: 0x48 - Trigger Compare Register0
        volatile uint32_t TRGCR;  ///< Offset: 0x58 - Trigger Register
        volatile uint32_t TRGMD;  ///< Offset: 0x5C - Trigger mode Register
    };
    ...
    /// TRGCMP0 Register bits
    namespace trgcmp0_bits {
        constexpr uint32_t TRGCMP0 = (16 << 0);  ///< TRGCMP0
    }

    /// TRGCR Register bits
    namespace trgcr_bits {
        constexpr uint32_t TRG0MD = (3 << 0);  ///< TRG0MD
        constexpr uint32_t TRG0BE = (1U << 3);  ///< TRG0BE
    }

    /// TRGMD Register bits
    namespace trgmd_bits {
        constexpr uint32_t EMGTGE = (1U << 0);  ///< EMGTGE
    }
...
#endif // ALLOY_GENERATED_M36B_PERIPHERALS_HPP