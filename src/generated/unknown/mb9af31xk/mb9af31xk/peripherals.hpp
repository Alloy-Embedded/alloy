/// Auto-generated code for MB9AF31xK
/// Generated by Alloy Code Generator
/// Source: spansion_mb9af31xk.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-30 23:22:11
#ifndef ALLOY_GENERATED_MB9AF31XK_PERIPHERALS_HPP
#define ALLOY_GENERATED_MB9AF31XK_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mb9af31xk {
...
namespace ds {
    /// Base addresses
    constexpr uint32_t DS_BASE = 0x40035800;

    /// DS Register structure
    struct Registers {
        volatile uint32_t PMD_CTL;  ///< Offset: 0x00 - RTC Mode Control Register
        volatile uint32_t WRFSR;  ///< Offset: 0x04 - Deep Standby Return Cause Register 1
        volatile uint32_t WIFSR;  ///< Offset: 0x08 - Deep Standby Return Cause Register 2
        volatile uint32_t WIER;  ///< Offset: 0x0C - Deep Standby Return Enable Register
        volatile uint32_t WILVR;  ///< Offset: 0x10 - WKUP Pin Input Level Register
        volatile uint32_t DSRAMR;  ///< Offset: 0x14 - Deep Standby RAM Retention Register
        volatile uint32_t BUR01;  ///< Offset: 0x100 - Backup Registers from 1
        volatile uint32_t BUR02;  ///< Offset: 0x101 - Backup Registers from 2
        volatile uint32_t BUR03;  ///< Offset: 0x102 - Backup Registers from 3
        volatile uint32_t BUR04;  ///< Offset: 0x103 - Backup Registers from 4
        volatile uint32_t BUR05;  ///< Offset: 0x104 - Backup Registers from 5
        volatile uint32_t BUR06;  ///< Offset: 0x105 - Backup Registers from 6
        volatile uint32_t BUR07;  ///< Offset: 0x106 - Backup Registers from 7
        volatile uint32_t BUR08;  ///< Offset: 0x107 - Backup Registers from 8
        volatile uint32_t BUR09;  ///< Offset: 0x108 - Backup Registers from 9
        volatile uint32_t BUR10;  ///< Offset: 0x109 - Backup Registers from 10
        volatile uint32_t BUR11;  ///< Offset: 0x10A - Backup Registers from 11
        volatile uint32_t BUR12;  ///< Offset: 0x10B - Backup Registers from 12
        volatile uint32_t BUR13;  ///< Offset: 0x10C - Backup Registers from 13
        volatile uint32_t BUR14;  ///< Offset: 0x10D - Backup Registers from 14
        volatile uint32_t BUR15;  ///< Offset: 0x10E - Backup Registers from 15
        volatile uint32_t BUR16;  ///< Offset: 0x10F - Backup Registers from 16
    };
...
namespace rtc {
    ...
    struct Registers {
        ...
        volatile uint32_t WTCALEN;  ///< Offset: 0x25 - Frequency Correction Enable Register
    ...
    namespace wtcal_bits {
        constexpr uint32_t WTCAL = (7 << 0);  ///< Frequency correction value
    }
...
namespace usb {
    ...
    namespace upcr4_bits {
        constexpr uint32_t UPLLN = (7 << 0);  ///< Frequency division ratio (N) setting bit of the USB-PLL clock
    }
...
#endif // ALLOY_GENERATED_MB9AF31XK_PERIPHERALS_HPP