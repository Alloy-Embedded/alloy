...
#ifndef ALLOY_GENERATED_MB9AFA3XN_PERIPHERALS_HPP
#define ALLOY_GENERATED_MB9AFA3XN_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mb9afa3xn {
...
namespace intreq {
    ...
    namespace irq05mon_bits {
        ...
        constexpr uint32_t EXTINT13 = (1U << 5);  ///< Interrupt request on external interrupt ch.13
        constexpr uint32_t EXTINT12 = (1U << 4);  ///< Interrupt request on external interrupt ch.12
        constexpr uint32_t EXTINT11 = (1U << 3);  ///< Interrupt request on external interrupt ch.11
        constexpr uint32_t EXTINT10 = (1U << 2);  ///< Interrupt request on external interrupt ch.10
        constexpr uint32_t EXTINT9 = (1U << 1);  ///< Interrupt request on external interrupt ch.9
...
#endif // ALLOY_GENERATED_MB9AFA3XN_PERIPHERALS_HPP