...
#ifndef ALLOY_GENERATED_MB9B360R_PERIPHERALS_HPP
#define ALLOY_GENERATED_MB9B360R_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mb9b360r {
...
namespace intreq {
    ...
    namespace irq118mon_bits {
        constexpr uint32_t SDINT1 = (1U << 1);  ///< SD card interrupt request
        constexpr uint32_t SDINT0 = (1U << 0);  ///< Interrupt request of aggregation of all SD I/F interrupt sources
    }
    ...
    namespace irq120mon_bits {
        constexpr uint32_t MFSRINT = (1U << 0);  ///< Reception interrupt request of the MFS ch.12
    }

    /// IRQ121MON Register bits
    namespace irq121mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Status interrupt request of the MFS ch.12
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Transmission interrupt request of the MFS ch.12
    }

    /// IRQ122MON Register bits
    namespace irq122mon_bits {
        constexpr uint32_t MFSRINT = (1U << 0);  ///< Reception interrupt request of the MFS ch.13
    }

    /// IRQ123MON Register bits
    namespace irq123mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Status interrupt request of the MFS ch.13
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Transmission interrupt request of the MFS ch.13
    }

    /// IRQ124MON Register bits
    namespace irq124mon_bits {
        constexpr uint32_t MFSRINT = (1U << 0);  ///< Reception interrupt request of the MFS ch.14
    }

    /// IRQ125MON Register bits
    namespace irq125mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Status interrupt request of the MFS ch.14
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Transmission interrupt request of the MFS ch.14
    }

    /// IRQ126MON Register bits
    namespace irq126mon_bits {
        constexpr uint32_t MFSRINT = (1U << 0);  ///< Reception interrupt request of the MFS ch.15
    }

    /// IRQ127MON Register bits
    namespace irq127mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Status interrupt request of the MFS ch.15
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Transmission interrupt request of the MFS ch.15
    }
...
namespace gpio {
    ...
    /// PFR0 Register bits
    namespace pfr0_bits {
        constexpr uint32_t P0E = (1U << 14);  ///< Bit14 of PFR0
        constexpr uint32_t P0D = (1U << 13);  ///< Bit13 of PFR0
        constexpr uint32_t P0C = (1U << 12);  ///< Bit12 of PFR0
        constexpr uint32_t P0B = (1U << 11);  ///< Bit11 of PFR0
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t UPINT_ENR;  ///< Offset: 0x18 - USB-PLL Interrupt Factor Enable Register
        volatile uint32_t UPINT_STR;  ///< Offset: 0x20 - USB-PLL Interrupt Factor Status Register
        volatile uint32_t UPINT_CLR;  ///< Offset: 0x1C - USB-PLL Interrupt Factor Clear Register
    ...
    namespace upint_str_bits {
        constexpr uint32_t UPCSI = (1U << 0);  ///< USB-PLL interrupt factor status bit
    }

    /// UPINT_CLR Register bits
    namespace upint_clr_bits {
        constexpr uint32_t UPCSC = (1U << 0);  ///< USB-PLL oscillation stabilization interrupt factor clear bit
    }
...
#endif // ALLOY_GENERATED_MB9B360R_PERIPHERALS_HPP