/// Auto-generated code for MB9BF52xT
/// Generated by Alloy Code Generator
/// Source: fujitsu_mb9bf52xt.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-30 23:30:08
#ifndef ALLOY_GENERATED_MB9BF52XT_PERIPHERALS_HPP
#define ALLOY_GENERATED_MB9BF52XT_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mb9bf52xt {
...
namespace flash {
    ...
    struct Registers {
        ...
        volatile uint32_t FSTR1;  ///< Offset: 0x88 - Flash Status Register 1
    ...
    namespace crtrmm_bits {
        constexpr uint32_t TTRMM = (5 << 16);  ///< CR Temperature Trimming Data Mirror
...
namespace unique {
    ...
    namespace uidr0_bits {
        constexpr uint32_t UID27_0 = (28 << 4);  ///< Unique ID 27 through 0
    }

    /// UIDR1 Register bits
    namespace uidr1_bits {
        constexpr uint32_t UID40_28 = (13 << 0);  ///< Unique ID 40 through 28
    }
...
namespace intreq {
    ...
    namespace irq07mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.8
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.0
    }

    /// IRQ08MON Register bits
    namespace irq08mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.8
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.8
    ...
    namespace irq09mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.9
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.1
    }

    /// IRQ10MON Register bits
    namespace irq10mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.9
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.9
    ...
    namespace irq11mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.10
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.2
    }

    /// IRQ12MON Register bits
    namespace irq12mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.10
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.10
    ...
    namespace irq13mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.11
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.3
    }

    /// IRQ14MON Register bits
    namespace irq14mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.11
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.11
    ...
    namespace irq15mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.12
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.4
    }

    /// IRQ16MON Register bits
    namespace irq16mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.12
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.12
    ...
    namespace irq17mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.13
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.5
    }

    /// IRQ18MON Register bits
    namespace irq18mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.13
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.13
    ...
    namespace irq19mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.14
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.6
    }

    /// IRQ20MON Register bits
    namespace irq20mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.14
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.14
    ...
    namespace irq21mon_bits {
        constexpr uint32_t MFSINT1 = (1U << 1);  ///< Reception interrupt request on MFS ch.15
        constexpr uint32_t MFSINT0 = (1U << 0);  ///< Reception interrupt request on MFS ch.7
    }

    /// IRQ22MON Register bits
    namespace irq22mon_bits {
        constexpr uint32_t MFSINT3 = (1U << 3);  ///< Status interrupt request on MFS ch.15
        constexpr uint32_t MFSINT2 = (1U << 2);  ///< Transmission interrupt request on MFS ch.15
...
namespace gpio {
    ...
    struct Registers {
        ...
        volatile uint32_t PFR9;  ///< Offset: 0x24 - Port function setting register 9
        volatile uint32_t PFRA;  ///< Offset: 0x28 - Port function setting register A
        volatile uint32_t PFRB;  ///< Offset: 0x2C - Port function setting register B
    ...
    /// PFR2 Register bits
    namespace pfr2_bits {
        constexpr uint32_t P9 = (1U << 9);  ///< Bit9 of PFR2
        constexpr uint32_t P8 = (1U << 8);  ///< Bit8 of PFR2
        constexpr uint32_t P7 = (1U << 7);  ///< Bit7 of PFR2
        constexpr uint32_t P6 = (1U << 6);  ///< Bit6 of PFR2
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFR2
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFR2
    ...
    /// PFR5 Register bits
    namespace pfr5_bits {
        constexpr uint32_t PD = (1U << 13);  ///< Bit13 of PFR5
        constexpr uint32_t PC = (1U << 12);  ///< Bit12 of PFR5
        constexpr uint32_t PB = (1U << 11);  ///< Bit11 of PFR5
        constexpr uint32_t PA = (1U << 10);  ///< Bit10 of PFR5
        constexpr uint32_t P9 = (1U << 9);  ///< Bit9 of PFR5
        constexpr uint32_t P8 = (1U << 8);  ///< Bit8 of PFR5
        constexpr uint32_t P7 = (1U << 7);  ///< Bit7 of PFR5
    ...
    /// PFR7 Register bits
    namespace pfr7_bits {
        constexpr uint32_t PF = (1U << 15);  ///< Bit15 of PFR7
        constexpr uint32_t PE = (1U << 14);  ///< Bit14 of PFR7
        constexpr uint32_t PD = (1U << 13);  ///< Bit13 of PFR7
        constexpr uint32_t PC = (1U << 12);  ///< Bit12 of PFR7
        constexpr uint32_t PB = (1U << 11);  ///< Bit11 of PFR7
        constexpr uint32_t PA = (1U << 10);  ///< Bit10 of PFR7
        constexpr uint32_t P9 = (1U << 9);  ///< Bit9 of PFR7
        constexpr uint32_t P8 = (1U << 8);  ///< Bit8 of PFR7
        constexpr uint32_t P7 = (1U << 7);  ///< Bit7 of PFR7
        constexpr uint32_t P6 = (1U << 6);  ///< Bit6 of PFR7
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFR7
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFR7
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFR7
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFR7
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFR7
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFR7
    }

    /// PFR8 Register bits
    namespace pfr8_bits {
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFR8
    ...
    /// PFR9 Register bits
    namespace pfr9_bits {
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFR9
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFR9
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFR9
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFR9
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFR9
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFR9
    }

    /// PFRA Register bits
    namespace pfra_bits {
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFRA
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFRA
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFRA
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFRA
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFRA
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFRA
    }

    /// PFRB Register bits
    namespace pfrb_bits {
        constexpr uint32_t P7 = (1U << 7);  ///< Bit7 of PFRB
        constexpr uint32_t P6 = (1U << 6);  ///< Bit6 of PFRB
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFRB
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFRB
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFRB
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFRB
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFRB
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFRB
    }

    /// PFRC Register bits
    namespace pfrc_bits {
        constexpr uint32_t PF = (1U << 15);  ///< Bit15 of PFRC
        constexpr uint32_t PE = (1U << 14);  ///< Bit14 of PFRC
        constexpr uint32_t PD = (1U << 13);  ///< Bit13 of PFRC
        constexpr uint32_t PC = (1U << 12);  ///< Bit12 of PFRC
        constexpr uint32_t PB = (1U << 11);  ///< Bit11 of PFRC
        constexpr uint32_t PA = (1U << 10);  ///< Bit10 of PFRC
        constexpr uint32_t P9 = (1U << 9);  ///< Bit9 of PFRC
        constexpr uint32_t P8 = (1U << 8);  ///< Bit8 of PFRC
        constexpr uint32_t P7 = (1U << 7);  ///< Bit7 of PFRC
        constexpr uint32_t P6 = (1U << 6);  ///< Bit6 of PFRC
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFRC
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFRC
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFRC
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFRC
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFRC
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFRC
    }

    /// PFRD Register bits
    namespace pfrd_bits {
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFRD
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFRD
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFRD
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFRD
    }
    ...
    /// PFRF Register bits
    namespace pfrf_bits {
        constexpr uint32_t P6 = (1U << 6);  ///< Bit6 of PFRF
        constexpr uint32_t P5 = (1U << 5);  ///< Bit5 of PFRF
        constexpr uint32_t P4 = (1U << 4);  ///< Bit4 of PFRF
        constexpr uint32_t P3 = (1U << 3);  ///< Bit3 of PFRF
        constexpr uint32_t P2 = (1U << 2);  ///< Bit2 of PFRF
        constexpr uint32_t P1 = (1U << 1);  ///< Bit1 of PFRF
        constexpr uint32_t P0 = (1U << 0);  ///< Bit0 of PFRF
    }
    ...
    namespace epfr16_bits {
        constexpr uint32_t SCK11B = (2 << 26);  ///< SCK11 input/output select bit
        constexpr uint32_t SOT11B = (2 << 24);  ///< SOT11B input/output select bit
        constexpr uint32_t SIN11S = (2 << 22);  ///< SIN11S input select bit
        constexpr uint32_t SCK10B = (2 << 20);  ///< SCK10 input/output select bit
        constexpr uint32_t SOT10B = (2 << 18);  ///< SOT10B input/output select bit
        constexpr uint32_t SIN10S = (2 << 16);  ///< SIN10S input select bit
        constexpr uint32_t SCK9B = (2 << 14);  ///< SCK9 input/output select bit
        constexpr uint32_t SOT9B = (2 << 12);  ///< SCK9B input/output select bit
        constexpr uint32_t SIN9S = (2 << 10);  ///< SIN9S input select bit
        constexpr uint32_t SCK8B = (2 << 8);  ///< SCK8 input/output select bit
        constexpr uint32_t SOT8B = (2 << 6);  ///< SOT8B input/output select bit
        constexpr uint32_t SIN8S = (2 << 4);  ///< SIN8S input select bit
    }

    /// EPFR17 Register bits
    namespace epfr17_bits {
        constexpr uint32_t SCK15B = (2 << 26);  ///< SCK7 input/output select bit
        constexpr uint32_t SOT15B = (2 << 24);  ///< SOT7B input/output select bit
        constexpr uint32_t SIN15S = (2 << 22);  ///< SIN7S input select bit
        constexpr uint32_t SCK14B = (2 << 20);  ///< SCK6 input/output select bit
        constexpr uint32_t SOT14B = (2 << 18);  ///< SOT6B input/output select bit
        constexpr uint32_t SIN14S = (2 << 16);  ///< SIN6S input select bit
        constexpr uint32_t SCK13B = (2 << 14);  ///< SCK5 input/output select bit
        constexpr uint32_t SOT13B = (2 << 12);  ///< SOT5B input/output select bit
        constexpr uint32_t SIN13S = (2 << 10);  ///< SIN5S input select bit
        constexpr uint32_t SCK12B = (2 << 8);  ///< SCK4 input/output select bit
        constexpr uint32_t SOT12B = (2 << 6);  ///< SOT4B input/output select bit
        constexpr uint32_t SIN12S = (2 << 4);  ///< SIN4S input select bit
    }
...
namespace usb {
    ...
    struct Registers {
        volatile uint32_t UCCR;  ///< Offset: 0x00 - USB Clock Control Register
        volatile uint32_t UPCR1;  ///< Offset: 0x04 - USB-PLL Control Register 1
        volatile uint32_t UPCR2;  ///< Offset: 0x08 - USB-PLL Control Register 2
        volatile uint32_t UPCR3;  ///< Offset: 0x0C - USB-PLL Control Register 3
        volatile uint32_t UPCR4;  ///< Offset: 0x10 - USB-PLL Control Register 4
        volatile uint32_t UPCR5;  ///< Offset: 0x24 - USB-PLL Control Register 5
        volatile uint32_t UP_STR;  ///< Offset: 0x14 - USB-PLL Status Register
        volatile uint32_t UPINT_ENR;  ///< Offset: 0x18 - USB-PLL Interrupt Source Enable Register
        volatile uint32_t UPINT_STR;  ///< Offset: 0x20 - USB-PLL Interrupt Source Status Register
        volatile uint32_t UPINT_CLR;  ///< Offset: 0x1C - USB-PLL Interrupt Source Clear Register
        volatile uint32_t USBEN;  ///< Offset: 0x30 - USB Enable Register
    };
    ...
    /// UCCR Register bits
    namespace uccr_bits {
        constexpr uint32_t UCSEL = (1U << 1);  ///< USB clock selection bit
        constexpr uint32_t UCEN = (1U << 0);  ///< USB clock output enable bit
    }

    /// UPCR1 Register bits
    namespace upcr1_bits {
        constexpr uint32_t UPINC = (1U << 1);  ///< USB-PLL input clock selection bit
        constexpr uint32_t UPLLEN = (1U << 0);  ///< USB-PLL oscillation enable bit
    }

    /// UPCR2 Register bits
    namespace upcr2_bits {
        constexpr uint32_t UPOWT = (3 << 0);  ///< USB-PLL oscillation stabilization wait time setting bit
    }

    /// UPCR3 Register bits
    namespace upcr3_bits {
        constexpr uint32_t UPLLK = (5 << 0);  ///< Frequency division ratio (K) setting bit of the USB-PLL clock
    }

    /// UPCR4 Register bits
    namespace upcr4_bits {
        constexpr uint32_t UPLLN = (5 << 0);  ///< Frequency division ratio (N) setting bit of the USB-PLL clock
    }

    /// UPCR5 Register bits
    namespace upcr5_bits {
        constexpr uint32_t UPLLM = (4 << 0);  ///< Frequency division ratio (M) setting bit of the USB-PLL clock
    }

    /// UP_STR Register bits
    namespace up_str_bits {
        constexpr uint32_t UPRDY = (1U << 0);  ///< USB-PLL oscillation stabilization bit
    }

    /// UPINT_ENR Register bits
    namespace upint_enr_bits {
        constexpr uint32_t UPCSE = (1U << 0);  ///< USB-PLL oscillation stabilization wait complete interrupt enable bit
    }

    /// UPINT_STR Register bits
    namespace upint_str_bits {
        constexpr uint32_t UPCSI = (1U << 0);  ///< USB-PLL interrupt source status bit
    }

    /// UPINT_CLR Register bits
    namespace upint_clr_bits {
        constexpr uint32_t UPCSC = (1U << 0);  ///< USB-PLL oscillation stabilization interrupt source clear bit
    }

    /// USBEN Register bits
    namespace usben_bits {
        constexpr uint32_t USBEN = (1U << 0);  ///< USB enable bit
    }
...
#endif // ALLOY_GENERATED_MB9BF52XT_PERIPHERALS_HPP