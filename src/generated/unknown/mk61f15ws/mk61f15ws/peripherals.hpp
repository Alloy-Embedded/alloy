...
#ifndef ALLOY_GENERATED_MK61F15WS_PERIPHERALS_HPP
#define ALLOY_GENERATED_MK61F15WS_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::mk61f15ws {
...
namespace axbs {
    ...
    struct Registers {
        ...
        volatile uint32_t MGPCR3;  ///< Offset: 0xB00 - Master General Purpose Control Register
        volatile uint32_t MGPCR6;  ///< Offset: 0xE00 - Master General Purpose Control Register
        volatile uint32_t MGPCR7;  ///< Offset: 0xF00 - Master General Purpose Control Register
    };
    ...
    /// MGPCR3 Register bits
    namespace mgpcr3_bits {
        constexpr uint32_t AULB = (3 << 0);  ///< Arbitrates On Undefined Length Bursts
        constexpr uint32_t RESERVED = (29 << 3);  ///< no description available
    }
    ...
    /// MGPCR7 Register bits
    namespace mgpcr7_bits {
        constexpr uint32_t AULB = (3 << 0);  ///< Arbitrates On Undefined Length Bursts
        constexpr uint32_t RESERVED = (29 << 3);  ///< no description available
    }
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t GPTIMER%sLD;  ///< Offset: 0x80 - General Purpose Timer n Load Register
        volatile uint32_t GPTIMER%sCTL;  ///< Offset: 0x84 - General Purpose Timer n Control Register
        ...
        volatile uint32_t EPCR%s;  ///< Offset: 0x1C4 - Endpoint Control Register n
    ...
    /// GPTIMER%sLD Register bits
    namespace gptimer%sld_bits {
        constexpr uint32_t GPTLD = (24 << 0);  ///< no description available
        constexpr uint32_t RESERVED = (8 << 24);  ///< Reserved
    }

    /// GPTIMER%sCTL Register bits
    namespace gptimer%sctl_bits {
    ...
    /// EPCR%s Register bits
    namespace epcr%s_bits {
        constexpr uint32_t RXS = (1U << 0);  ///< RX endpoint Stall
...
#endif // ALLOY_GENERATED_MK61F15WS_PERIPHERALS_HPP