...
namespace gpio {
    ...
    struct Registers {
        volatile uint32_t DIR;  ///< Offset: 0x00 - GPIO Port0 Direction control register. (renamed from DIR)
        volatile uint32_t MASK;  ///< Offset: 0x10 - Mask register for Port0. (renamed from MASK)
        volatile uint32_t PIN;  ///< Offset: 0x14 - Port0 Pin value register using FIOMASK. (renamed from PIN)
        volatile uint32_t SET;  ///< Offset: 0x18 - Port0 Output Set register using FIOMASK. (renamed from SET)
        volatile uint32_t CLR;  ///< Offset: 0x1C - Port0 Output Clear register using FIOMASK. (renamed from CLR)
    };
