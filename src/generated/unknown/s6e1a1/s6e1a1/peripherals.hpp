...
namespace traits {
    ...
    constexpr bool has_lscrp = true;
    constexpr uint32_t num_lscrp_instances = 1;
    constexpr bool has_pcg = true;
    constexpr uint32_t num_pcg_instances = 1;
    constexpr bool has_dma = true;
    constexpr uint32_t num_dma_instances = 1;
    constexpr bool has_mtb = true;
    constexpr uint32_t num_mtb_instances = 1;
    constexpr bool has_fastio = true;
    constexpr uint32_t num_fastio_instances = 1;
    ...
    template<>
    struct peripheral_count<struct lscrp_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    struct peripheral_count<struct pcg_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
    ...
    template<>
    struct peripheral_count<struct fastio_tag> {
        static constexpr uint32_t value = 1;
    };
