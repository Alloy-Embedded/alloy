...
extern "C" {
    ...
    void WFG_DTIF_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void EXINT0_7_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void BTIM0_3_FLASH_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}