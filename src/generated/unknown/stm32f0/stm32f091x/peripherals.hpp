/// Auto-generated code for STM32F091x
/// Generated by Alloy Code Generator
/// Source: st_stm32f091.json
...
namespace traits {
    ...
    constexpr bool has_usart7 = true;
    constexpr bool has_usart8 = true;
}
...
namespace dac {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t TSEL10 = (1U << 3);  ///< DAC channel1 trigger selection
        constexpr uint32_t TSEL11 = (1U << 4);  ///< DAC channel1 trigger selection
        constexpr uint32_t TSEL12 = (1U << 5);  ///< DAC channel1 trigger selection
...
namespace rcc {
    ...
    namespace cfgr_bits {
        ...
        constexpr uint32_t ADCPRE = (1U << 14);  ///< ADC prescaler
        constexpr uint32_t PLLSRC = (2 << 15);  ///< PLL input clock source
        ...
        constexpr uint32_t PLLNODIV = (1U << 31);  ///< PLL clock not divided for MCO
    }
    ...
    namespace cir_bits {
        ...
        constexpr uint32_t HSI48RDYF = (1U << 6);  ///< HSI48 ready interrupt flag
        ...
        constexpr uint32_t HSI48RDYIE = (1U << 14);  ///< HSI48 ready interrupt enable
        ...
        constexpr uint32_t HSI48RDYC = (1U << 22);  ///< HSI48 Ready Interrupt Clear
    ...
    namespace apb1rstr_bits {
        ...
        constexpr uint32_t USBRST = (1U << 23);  ///< USB interface reset
        constexpr uint32_t CANRST = (1U << 25);  ///< CAN interface reset
        constexpr uint32_t CRSRST = (1U << 27);  ///< Clock Recovery System interface reset
    ...
    namespace apb1enr_bits {
        ...
        constexpr uint32_t USBRST = (1U << 23);  ///< USB interface clock enable
        constexpr uint32_t CANEN = (1U << 25);  ///< CAN interface clock enable
        constexpr uint32_t CRSEN = (1U << 27);  ///< Clock Recovery System interface clock enable
    ...
    namespace cfgr3_bits {
        ...
        constexpr uint32_t USBSW = (1U << 7);  ///< USB clock source selection
    ...
    namespace cr2_bits {
        ...
        constexpr uint32_t HSI48ON = (1U << 16);  ///< HSI48 clock enable
        constexpr uint32_t HSI48RDY = (1U << 17);  ///< HSI48 clock ready flag
        constexpr uint32_t HSI48CAL = (1U << 24);  ///< HSI48 factory clock calibration
    }
...
namespace syscfg {
    ...
    namespace cfgr1_bits {
        ...
        constexpr uint32_t I2C_PB6_FM = (1U << 16);  ///< Fast Mode Plus (FM plus) driving capability activation bits.
        ...
        constexpr uint32_t I2C1_FM_plus = (1U << 20);  ///< FM+ driving capability activation for I2C1
        constexpr uint32_t I2C2_FM_plus = (1U << 21);  ///< FM+ driving capability activation for I2C2
        constexpr uint32_t SPI2_DMA_RMP = (1U << 24);  ///< SPI2 DMA request remapping bit
        constexpr uint32_t USART2_DMA_RMP = (1U << 25);  ///< USART2 DMA request remapping bit
        constexpr uint32_t USART3_DMA_RMP = (1U << 26);  ///< USART3 DMA request remapping bit
        constexpr uint32_t I2C1_DMA_RMP = (1U << 27);  ///< I2C1 DMA request remapping bit
        constexpr uint32_t TIM1_DMA_RMP = (1U << 28);  ///< TIM1 DMA request remapping bit
        constexpr uint32_t TIM2_DMA_RMP = (1U << 29);  ///< TIM2 DMA request remapping bit
        constexpr uint32_t TIM3_DMA_RMP = (1U << 30);  ///< TIM3 DMA request remapping bit
    }
...
namespace usart {
    ...
    constexpr uint32_t USART7_BASE = 0x40011800;
    constexpr uint32_t USART8_BASE = 0x40011C00;
    ...
    inline Registers* USART7 = reinterpret_cast<Registers*>(USART7_BASE);
    inline Registers* USART8 = reinterpret_cast<Registers*>(USART8_BASE);
...
namespace comp {
    /// Base addresses
    constexpr uint32_t COMP_BASE = 0x4001001C;
    ...
    namespace csr_bits {
        ...
        constexpr uint32_t COMP1OUTSEL = (3 << 8);  ///< Comparator 1 output selection
        constexpr uint32_t COMP1POL = (1U << 11);  ///< Comparator 1 output polarity
        constexpr uint32_t COMP1HYST = (2 << 12);  ///< Comparator 1 hysteresis
        constexpr uint32_t COMP1OUT = (1U << 14);  ///< Comparator 1 output
        constexpr uint32_t COMP1LOCK = (1U << 15);  ///< Comparator 1 lock
        constexpr uint32_t COMP2EN = (1U << 16);  ///< Comparator 2 enable
        constexpr uint32_t COMP2MODE = (2 << 18);  ///< Comparator 2 mode
        constexpr uint32_t COMP2INSEL = (3 << 20);  ///< Comparator 2 inverting input selection
        constexpr uint32_t WNDWEN = (1U << 23);  ///< Window mode enable
        constexpr uint32_t COMP2OUTSEL = (3 << 24);  ///< Comparator 2 output selection
        constexpr uint32_t COMP2POL = (1U << 27);  ///< Comparator 2 output polarity
        constexpr uint32_t COMP2HYST = (2 << 28);  ///< Comparator 2 hysteresis
...
namespace usb {
    ...
    namespace lpmcsr_bits {
        ...
        constexpr uint32_t REMWAKE = (1U << 3);  ///< bRemoteWake value
