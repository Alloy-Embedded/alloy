/// Auto-generated code for STM32F101xx
/// Generated by Alloy Code Generator
/// Source: st_stm32f101.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:39
#ifndef ALLOY_GENERATED_STM32F101XX_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32F101XX_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::stm32f101xx {
...
namespace dbg {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t DBG_TIM15_STOP = (1U << 22);  ///< TIM15 counter stopped when core is halted
        constexpr uint32_t DBG_TIM16_STOP = (1U << 23);  ///< TIM16 counter stopped when core is halted
        constexpr uint32_t DBG_TIM17_STOP = (1U << 24);  ///< TIM17 counter stopped when core is halted
        constexpr uint32_t DBG_TIM12_STOP = (1U << 25);  ///< TIM12 counter stopped when core is halted
        constexpr uint32_t DBG_TIM13_STOP = (1U << 26);  ///< TIM13 counter stopped when core is halted
        constexpr uint32_t DBG_TIM14_STOP = (1U << 27);  ///< TIM14 counter stopped when core is halted
    }
