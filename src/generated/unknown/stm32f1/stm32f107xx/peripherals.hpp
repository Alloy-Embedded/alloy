/// Auto-generated code for STM32F107xx
/// Generated by Alloy Code Generator
/// Source: st_stm32f107.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:01:14
#ifndef ALLOY_GENERATED_STM32F107XX_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32F107XX_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::stm32f107xx {
...
namespace rcc {
    ...
    struct Registers {
        ...
        volatile uint32_t AHBRSTR;  ///< Offset: 0x28 - AHB peripheral clock reset register (RCC_AHBRSTR)
        volatile uint32_t CFGR2;  ///< Offset: 0x2C - Clock configuration register2 (RCC_CFGR2)
    };
    ...
    namespace cfgr_bits {
        ...
        constexpr uint32_t MCO = (4 << 24);  ///< Microcontroller clock output
    }
    ...
    namespace cir_bits {
        ...
        constexpr uint32_t PLL2RDYF = (1U << 5);  ///< PLL2 Ready Interrupt flag
        constexpr uint32_t PLL3RDYF = (1U << 6);  ///< PLL3 Ready Interrupt flag
        ...
        constexpr uint32_t PLL2RDYIE = (1U << 13);  ///< PLL2 Ready Interrupt Enable
        constexpr uint32_t PLL3RDYIE = (1U << 14);  ///< PLL3 Ready Interrupt Enable
        ...
        constexpr uint32_t PLL2RDYC = (1U << 21);  ///< PLL2 Ready Interrupt Clear
        constexpr uint32_t PLL3RDYC = (1U << 22);  ///< PLL3 Ready Interrupt Clear
    ...
    namespace ahbenr_bits {
        ...
        constexpr uint32_t OTGFSEN = (1U << 12);  ///< USB OTG FS clock enable
        constexpr uint32_t ETHMACEN = (1U << 14);  ///< Ethernet MAC clock enable
        constexpr uint32_t ETHMACTXEN = (1U << 15);  ///< Ethernet MAC TX clock enable
        constexpr uint32_t ETHMACRXEN = (1U << 16);  ///< Ethernet MAC RX clock enable
    }
    ...
    namespace apb1enr_bits {
        ...
        constexpr uint32_t CAN2EN = (1U << 26);  ///< CAN2 clock enable
    ...
    namespace ahbrstr_bits {
        ...
        constexpr uint32_t ETHMACRST = (1U << 14);  ///< Ethernet MAC reset
    }

    /// CFGR2 Register bits
    namespace cfgr2_bits {
        constexpr uint32_t PREDIV1 = (4 << 0);  ///< PREDIV1 division factor
        constexpr uint32_t PREDIV2 = (4 << 4);  ///< PREDIV2 division factor
        constexpr uint32_t PLL2MUL = (4 << 8);  ///< PLL2 Multiplication Factor
        constexpr uint32_t PLL3MUL = (4 << 12);  ///< PLL3 Multiplication Factor
        constexpr uint32_t PREDIV1SRC = (1U << 16);  ///< PREDIV1 entry clock source
        constexpr uint32_t I2S2SRC = (1U << 17);  ///< I2S2 clock source
        constexpr uint32_t I2S3SRC = (1U << 18);  ///< I2S3 clock source
    }
...
namespace afio {
    ...
    namespace mapr_bits {
        ...
        constexpr uint32_t CAN1_REMAP = (2 << 13);  ///< CAN1 remapping
        ...
        constexpr uint32_t ETH_REMAP = (1U << 21);  ///< Ethernet MAC I/O remapping
        constexpr uint32_t CAN2_REMAP = (1U << 22);  ///< CAN2 I/O remapping
        constexpr uint32_t MII_RMII_SEL = (1U << 23);  ///< MII or RMII selection
        constexpr uint32_t SWJ_CFG = (3 << 24);  ///< Serial wire JTAG configuration
        constexpr uint32_t SPI3_REMAP = (1U << 28);  ///< SPI3/I2S3 remapping
        constexpr uint32_t TIM2ITR1_IREMAP = (1U << 29);  ///< TIM2 internal trigger 1 remapping
        constexpr uint32_t PTP_PPS_REMAP = (1U << 30);  ///< Ethernet PTP PPS remapping
    }
...
namespace bkp {
    ...
    struct Registers {
        ...
        volatile uint32_t CSR;  ///< Offset: 0x30 - BKP_CSR control/status register
    };
...
namespace adc {
    ...
    namespace smpr2_bits {
        constexpr uint32_t SMP0 = (3 << 0);  ///< Channel 0 sampling time selection
...
namespace eth {
    ...
    struct Registers {
        volatile uint32_t MACCR;  ///< Offset: 0x00 - Ethernet MAC configuration register (ETH_MACCR)
        volatile uint32_t MACFFR;  ///< Offset: 0x04 - Ethernet MAC frame filter register (ETH_MACCFFR)
        ...
        volatile uint32_t MACMIIAR;  ///< Offset: 0x10 - Ethernet MAC MII address register (ETH_MACMIIAR)
        volatile uint32_t MACMIIDR;  ///< Offset: 0x14 - Ethernet MAC MII data register (ETH_MACMIIDR)
        volatile uint32_t MACFCR;  ///< Offset: 0x18 - Ethernet MAC flow control register (ETH_MACFCR)
        volatile uint32_t MACVLANTR;  ///< Offset: 0x1C - Ethernet MAC VLAN tag register (ETH_MACVLANTR)
        volatile uint32_t MACRWUFFR;  ///< Offset: 0x28 - Ethernet MAC remote wakeup frame filter register (ETH_MACRWUFFR)
        volatile uint32_t MACPMTCSR;  ///< Offset: 0x2C - Ethernet MAC PMT control and status register (ETH_MACPMTCSR)
        volatile uint32_t MACSR;  ///< Offset: 0x38 - Ethernet MAC interrupt status register (ETH_MACSR)
        volatile uint32_t MACIMR;  ///< Offset: 0x3C - Ethernet MAC interrupt mask register (ETH_MACIMR)
        volatile uint32_t MACA0HR;  ///< Offset: 0x40 - Ethernet MAC address 0 high register (ETH_MACA0HR)
        volatile uint32_t MACA0LR;  ///< Offset: 0x44 - Ethernet MAC address 0 low register
        volatile uint32_t MACA1HR;  ///< Offset: 0x48 - Ethernet MAC address 1 high register (ETH_MACA1HR)
        volatile uint32_t MACA1LR;  ///< Offset: 0x4C - Ethernet MAC address1 low register
        volatile uint32_t MACA2HR;  ///< Offset: 0x50 - Ethernet MAC address 2 high register (ETH_MACA2HR)
        volatile uint32_t MACA2LR;  ///< Offset: 0x54 - Ethernet MAC address 2 low register
        volatile uint32_t MACA3HR;  ///< Offset: 0x58 - Ethernet MAC address 3 high register (ETH_MACA3HR)
    ...
    namespace maccr_bits {
        ...
        constexpr uint32_t APCS = (1U << 7);  ///< Automatic pad/CRC stripping
        constexpr uint32_t RD = (1U << 9);  ///< Retry disable
        constexpr uint32_t IPCO = (1U << 10);  ///< IPv4 checksum offload
        constexpr uint32_t DM = (1U << 11);  ///< Duplex mode
        constexpr uint32_t LM = (1U << 12);  ///< Loopback mode
        constexpr uint32_t ROD = (1U << 13);  ///< Receive own disable
        constexpr uint32_t FES = (1U << 14);  ///< Fast Ethernet speed
        constexpr uint32_t CSD = (1U << 16);  ///< Carrier sense disable
        constexpr uint32_t IFG = (3 << 17);  ///< Interframe gap
    ...
    namespace macffr_bits {
        constexpr uint32_t PM = (1U << 0);  ///< Promiscuous mode
        constexpr uint32_t HU = (1U << 1);  ///< Hash unicast
        constexpr uint32_t HM = (1U << 2);  ///< Hash multicast
        constexpr uint32_t DAIF = (1U << 3);  ///< Destination address inverse filtering
        constexpr uint32_t PAM = (1U << 4);  ///< Pass all multicast
        constexpr uint32_t BFD = (1U << 5);  ///< Broadcast frames disable
        constexpr uint32_t PCF = (2 << 6);  ///< Pass control frames
        constexpr uint32_t SAIF = (1U << 8);  ///< Source address inverse filtering
    ...
    namespace machthr_bits {
        constexpr uint32_t HTH = (32 << 0);  ///< Hash table high
    }

    /// MACHTLR Register bits
    namespace machtlr_bits {
        constexpr uint32_t HTL = (32 << 0);  ///< Hash table low
    }

    /// MACMIIAR Register bits
    namespace macmiiar_bits {
        constexpr uint32_t MB = (1U << 0);  ///< MII busy
        constexpr uint32_t MW = (1U << 1);  ///< MII write
        constexpr uint32_t CR = (3 << 2);  ///< Clock range
        constexpr uint32_t MR = (5 << 6);  ///< MII register
        constexpr uint32_t PA = (5 << 11);  ///< PHY address
    }

    /// MACMIIDR Register bits
    namespace macmiidr_bits {
        constexpr uint32_t MD = (16 << 0);  ///< MII data
    }

    /// MACFCR Register bits
    namespace macfcr_bits {
        constexpr uint32_t FCB_BPA = (1U << 0);  ///< Flow control busy/back pressure activate
        constexpr uint32_t TFCE = (1U << 1);  ///< Transmit flow control enable
        constexpr uint32_t RFCE = (1U << 2);  ///< Receive flow control enable
        constexpr uint32_t UPFD = (1U << 3);  ///< Unicast pause frame detect
        constexpr uint32_t PLT = (2 << 4);  ///< Pause low threshold
        constexpr uint32_t ZQPD = (1U << 7);  ///< Zero-quanta pause disable
        constexpr uint32_t PT = (16 << 16);  ///< Pass control frames
    }

    /// MACVLANTR Register bits
    namespace macvlantr_bits {
        constexpr uint32_t VLANTI = (16 << 0);  ///< VLAN tag identifier (for receive frames)
        constexpr uint32_t VLANTC = (1U << 16);  ///< 12-bit VLAN tag comparison
    }
    ...
    namespace macpmtcsr_bits {
        ...
        constexpr uint32_t WFE = (1U << 2);  ///< Wakeup frame enable
        constexpr uint32_t MPR = (1U << 5);  ///< Magic packet received
        constexpr uint32_t WFR = (1U << 6);  ///< Wakeup frame received
        constexpr uint32_t GU = (1U << 9);  ///< Global unicast
        constexpr uint32_t WFFRPR = (1U << 31);  ///< Wakeup frame filter register pointer reset
    }

    /// MACSR Register bits
    namespace macsr_bits {
        constexpr uint32_t PMTS = (1U << 3);  ///< PMT status
        constexpr uint32_t MMCS = (1U << 4);  ///< MMC status
        constexpr uint32_t MMCRS = (1U << 5);  ///< MMC receive status
        constexpr uint32_t MMCTS = (1U << 6);  ///< MMC transmit status
        constexpr uint32_t TSTS = (1U << 9);  ///< Time stamp trigger status
    }

    /// MACIMR Register bits
    namespace macimr_bits {
        constexpr uint32_t PMTIM = (1U << 3);  ///< PMT interrupt mask
        constexpr uint32_t TSTIM = (1U << 9);  ///< Time stamp trigger interrupt mask
    }
    ...
    namespace maca0lr_bits {
        constexpr uint32_t MACA0L = (32 << 0);  ///< MAC address0 low
    }

    /// MACA1HR Register bits
    namespace maca1hr_bits {
        constexpr uint32_t MACA1H = (16 << 0);  ///< MAC address1 high
    ...
    namespace maca1lr_bits {
        constexpr uint32_t MACA1L = (32 << 0);  ///< MAC address1 low
    }

    /// MACA2HR Register bits
    namespace maca2hr_bits {
        constexpr uint32_t ETH_MACA2HR = (16 << 0);  ///< Ethernet MAC address 2 high register
        constexpr uint32_t MBC = (6 << 24);  ///< Mask byte control
        constexpr uint32_t SA = (1U << 30);  ///< Source address
        constexpr uint32_t AE = (1U << 31);  ///< Address enable
    }
    ...
    namespace maca2lr_bits {
        constexpr uint32_t MACA2L = (31 << 0);  ///< MAC address2 low
    }

    /// MACA3HR Register bits
    namespace maca3hr_bits {
        constexpr uint32_t MACA3H = (16 << 0);  ///< MAC address3 high
        constexpr uint32_t MBC = (6 << 24);  ///< Mask byte control
        constexpr uint32_t SA = (1U << 30);  ///< Source address
        constexpr uint32_t AE = (1U << 31);  ///< Address enable
    }
    ...
    namespace maca3lr_bits {
        constexpr uint32_t MBCA3L = (32 << 0);  ///< MAC address3 low
    }
...
namespace usb {
    /// Base addresses
    constexpr uint32_t USB_OTG_GLOBAL_BASE = 0x50000000;
    constexpr uint32_t USB_OTG_HOST_BASE = 0x50000400;
    constexpr uint32_t USB_OTG_DEVICE_BASE = 0x50000800;
    constexpr uint32_t USB_OTG_PWRCLK_BASE = 0x50000E00;
    ...
    /// Peripheral instances
    inline Registers* USB_OTG_GLOBAL = reinterpret_cast<Registers*>(USB_OTG_GLOBAL_BASE);
    inline Registers* USB_OTG_HOST = reinterpret_cast<Registers*>(USB_OTG_HOST_BASE);
    inline Registers* USB_OTG_DEVICE = reinterpret_cast<Registers*>(USB_OTG_DEVICE_BASE);
    inline Registers* USB_OTG_PWRCLK = reinterpret_cast<Registers*>(USB_OTG_PWRCLK_BASE);
    ...
    namespace fs_gusbcfg_bits {
        ...
        constexpr uint32_t PHYSEL = (1U << 7);  ///< Full Speed serial transceiver select
...
namespace nvic {
    ...
    struct Registers {
        ...
        volatile uint32_t ISER2;  ///< Offset: 0x108 - Interrupt Set-Enable Register
        ...
        volatile uint32_t ICER2;  ///< Offset: 0x188 - Interrupt Clear-Enable Register
        ...
        volatile uint32_t ISPR2;  ///< Offset: 0x208 - Interrupt Set-Pending Register
        ...
        volatile uint32_t ICPR2;  ///< Offset: 0x288 - Interrupt Clear-Pending Register
        ...
        volatile uint32_t IABR2;  ///< Offset: 0x308 - Interrupt Active Bit Register
        ...
        volatile uint32_t IPR15;  ///< Offset: 0x43C - Interrupt Priority Register
        volatile uint32_t IPR16;  ///< Offset: 0x440 - Interrupt Priority Register
    };
