/// Auto-generated code for STM32F21x
/// Generated by Alloy Code Generator
/// Source: st_stm32f21.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:03
#ifndef ALLOY_GENERATED_STM32F21X_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32F21X_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::stm32f21x {
...
namespace rcc {
    ...
    /// CFGR Register bits
    namespace cfgr_bits {
        constexpr uint32_t MCO21 = (1U << 31);  ///< Microcontroller clock output 2
        constexpr uint32_t MCO20 = (1U << 30);  ///< Microcontroller clock output 2
        constexpr uint32_t MCO2PRE2 = (1U << 29);  ///< MCO2 prescaler
        constexpr uint32_t MCO2PRE1 = (1U << 28);  ///< MCO2 prescaler
        constexpr uint32_t MCO2PRE0 = (1U << 27);  ///< MCO2 prescaler
        constexpr uint32_t MCO1PRE2 = (1U << 26);  ///< MCO1 prescaler
        constexpr uint32_t MCO1PRE1 = (1U << 25);  ///< MCO1 prescaler
        constexpr uint32_t MCO1PRE0 = (1U << 24);  ///< MCO1 prescaler
        constexpr uint32_t I2SSRC = (1U << 23);  ///< I2S clock selection
        constexpr uint32_t MCO11 = (1U << 22);  ///< Microcontroller clock output 1
        constexpr uint32_t MCO10 = (1U << 21);  ///< Microcontroller clock output 1
        constexpr uint32_t RTCPRE4 = (1U << 20);  ///< HSE division factor for RTC clock
        constexpr uint32_t RTCPRE3 = (1U << 19);  ///< HSE division factor for RTC clock
        constexpr uint32_t RTCPRE2 = (1U << 18);  ///< HSE division factor for RTC clock
        constexpr uint32_t RTCPRE1 = (1U << 17);  ///< HSE division factor for RTC clock
        constexpr uint32_t RTCPRE0 = (1U << 16);  ///< HSE division factor for RTC clock
        constexpr uint32_t PPRE22 = (1U << 15);  ///< APB high-speed prescaler (APB2)
        constexpr uint32_t PPRE21 = (1U << 14);  ///< APB high-speed prescaler (APB2)
        constexpr uint32_t PPRE20 = (1U << 13);  ///< APB high-speed prescaler (APB2)
        constexpr uint32_t PPRE12 = (1U << 12);  ///< APB Low speed prescaler (APB1)
        constexpr uint32_t PPRE11 = (1U << 11);  ///< APB Low speed prescaler (APB1)
        constexpr uint32_t PPRE10 = (1U << 10);  ///< APB Low speed prescaler (APB1)
        constexpr uint32_t HPRE3 = (1U << 7);  ///< AHB prescaler
        constexpr uint32_t HPRE2 = (1U << 6);  ///< AHB prescaler
        constexpr uint32_t HPRE1 = (1U << 5);  ///< AHB prescaler
        constexpr uint32_t HPRE0 = (1U << 4);  ///< AHB prescaler
    ...
    namespace ahb3rstr_bits {
        constexpr uint32_t FSMCRST = (1U << 0);  ///< Flexible static memory controller module reset
    }
    ...
    namespace ahb3enr_bits {
        constexpr uint32_t FSMCEN = (1U << 0);  ///< Flexible static memory controller module clock enable
    }
    ...
    namespace ahb3lpenr_bits {
        constexpr uint32_t FSMCLPEN = (1U << 0);  ///< Flexible static memory controller module clock enable during Sleep mode
    }
    ...
    namespace plli2scfgr_bits {
        constexpr uint32_t PLLI2SN0 = (1U << 6);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN1 = (1U << 7);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN2 = (1U << 8);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN3 = (1U << 9);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN4 = (1U << 10);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN5 = (1U << 11);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN6 = (1U << 12);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN7 = (1U << 13);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SN8 = (1U << 14);  ///< PLLI2S multiplication factor for VCO
        constexpr uint32_t PLLI2SR0 = (1U << 28);  ///< PLLI2S division factor for I2S clocks
        constexpr uint32_t PLLI2SR1 = (1U << 29);  ///< PLLI2S division factor for I2S clocks
        constexpr uint32_t PLLI2SR2 = (1U << 30);  ///< PLLI2S division factor for I2S clocks
    }
...
namespace syscfg {
    ...
    namespace cmpcr_bits {
        constexpr uint32_t READY = (1U << 7);  ///< READY
...
namespace rtc {
    ...
    namespace prer_bits {
        ...
        constexpr uint32_t PREDIV_S = (13 << 0);  ///< Synchronous prescaler factor
    }
...
namespace eth {
    ...
    struct Registers {
        ...
        volatile uint32_t MACRWUFFR;  ///< Offset: 0x28 - Ethernet MAC remote wakeup frame filter register
    };
    ...
    namespace macffr_bits {
        ...
        constexpr uint32_t PCF = (1U << 6);  ///< Pass control frames
    ...
    namespace macfcr_bits {
        constexpr uint32_t FCB = (1U << 0);  ///< Flow control busy/back pressure activate
    ...
    namespace macvlantr_bits {
        constexpr uint32_t VLANTI = (16 << 0);  ///< VLAN tag identifier
    ...
    namespace macdbgr_bits {
        constexpr uint32_t MMRPEA = (1U << 0);  ///< MAC MII receive protocol engine active
        constexpr uint32_t MSFRWCS = (1U << 1);  ///< MAC small FIFO read / write controllers status
        constexpr uint32_t RFWRA = (1U << 4);  ///< Rx FIFO write controller active
        constexpr uint32_t RFRCS = (1U << 5);  ///< Rx FIFO read controller status
        constexpr uint32_t RFFL = (1U << 8);  ///< Rx FIFO fill level
        constexpr uint32_t MMTEA = (1U << 16);  ///< MAC MII transmit engine active
        constexpr uint32_t MTFCS = (2 << 17);  ///< MAC transmit frame controller status
        constexpr uint32_t MTP = (1U << 19);  ///< MAC transmitter in pause
        constexpr uint32_t TFRS = (2 << 20);  ///< Tx FIFO read status
        constexpr uint32_t TFWA = (1U << 22);  ///< Tx FIFO write active
        constexpr uint32_t TFNE = (1U << 24);  ///< Tx FIFO not empty
        constexpr uint32_t TFF = (1U << 25);  ///< Tx FIFO full
    }
    ...
    namespace maca0hr_bits {
        ...
        constexpr uint32_t MO = (1U << 31);  ///< MO
    }
    ...
    namespace maca1lr_bits {
        constexpr uint32_t MACA1LR = (32 << 0);  ///< MAC address1 low
    }

    /// MACA2HR Register bits
    namespace maca2hr_bits {
        constexpr uint32_t MAC2AH = (16 << 0);  ///< MAC address2 high
        constexpr uint32_t MBC = (6 << 24);  ///< Mask byte control
        constexpr uint32_t SA = (1U << 30);  ///< Source address
        constexpr uint32_t AE = (1U << 31);  ///< Address enable
    }
...
namespace hash {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t ALGO = (1U << 7);  ///< Algorithm selection
...
namespace crypto {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t ALGOMODE = (3 << 3);  ///< Algorithm mode
...
namespace nvic {
    ...
    struct Registers {
        ...
        volatile uint32_t IPR17;  ///< Offset: 0x444 - Interrupt Priority Register
        volatile uint32_t IPR18;  ///< Offset: 0x448 - Interrupt Priority Register
        volatile uint32_t IPR19;  ///< Offset: 0x44C - Interrupt Priority Register
        volatile uint32_t IPR20;  ///< Offset: 0x450 - Interrupt Priority Register
    };
...
#endif // ALLOY_GENERATED_STM32F21X_PERIPHERALS_HPP