...
#ifndef ALLOY_GENERATED_STM32F301_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32F301_PERIPHERALS_HPP

#include <stdint.h>

namespace alloy::generated::stm32f301 {
...
namespace flash {
    ...
    namespace obr_bits {
        ...
        constexpr uint32_t RDPRT = (2 << 1);  ///< Read protection Level status
...
namespace rcc {
    ...
    namespace cfgr_bits {
        ...
        constexpr uint32_t PLLNODIV = (1U << 31);  ///< Do not divide PLL to MCO
    }
    ...
    namespace ahbenr_bits {
        ...
        constexpr uint32_t ADC1EN = (1U << 28);  ///< ADC 1
    }
    ...
    namespace ahbrstr_bits {
        ...
        constexpr uint32_t ADC1RST = (1U << 28);  ///< ADC1 reset
    }

    /// CFGR2 Register bits
    namespace cfgr2_bits {
        constexpr uint32_t PREDIV = (4 << 0);  ///< PREDIV division factor
        constexpr uint32_t ADC1PRES = (4 << 4);  ///< ADC1 prescaler
    }
    ...
    namespace cfgr3_bits {
        ...
        constexpr uint32_t TIM15SW = (1U << 10);  ///< Timer15 clock source selection
        constexpr uint32_t TIM16SW = (1U << 11);  ///< Timer16 clock source selection
        constexpr uint32_t TIM17SW = (2 << 13);  ///< Timer17 clock source selection
    }
...
namespace tim {
    ...
    /// CR1 Register bits
    namespace cr1_bits {
        constexpr uint32_t UIFREMAP = (2 << 11);  ///< UIF status bit remapping
    ...
    namespace cnt_bits {
        ...
        constexpr uint32_t CNT_or_UIFCPY = (1U << 31);  ///< CNT_or_UIFCPY
    }
    ...
    namespace ccr1_bits {
        ...
        constexpr uint32_t CCR1H = (16 << 16);  ///< High Capture/Compare 1 value
    }

    /// CCR2 Register bits
    namespace ccr2_bits {
        constexpr uint32_t CCR2L = (16 << 0);  ///< Low Capture/Compare 2 value
        constexpr uint32_t CCR2H = (16 << 16);  ///< High Capture/Compare 2 value
    }

    /// CCR3 Register bits
    namespace ccr3_bits {
        constexpr uint32_t CCR3L = (16 << 0);  ///< Low Capture/Compare value
        constexpr uint32_t CCR3H = (16 << 16);  ///< High Capture/Compare value
    }

    /// CCR4 Register bits
    namespace ccr4_bits {
        constexpr uint32_t CCR4L = (16 << 0);  ///< Low Capture/Compare value
        constexpr uint32_t CCR4H = (16 << 16);  ///< High Capture/Compare value
    }
...
namespace adc {
    /// Base addresses
    constexpr uint32_t ADC_BASE = 0x50000000;
    ...
    struct Registers {
        ...
        volatile uint32_t CFGR;  ///< Offset: 0x0C - ADC configuration register
        volatile uint32_t SMPR1;  ///< Offset: 0x14 - ADC sample time register 1
        volatile uint32_t SMPR2;  ///< Offset: 0x18 - ADC sample time register 2
        volatile uint32_t TR1;  ///< Offset: 0x20 - ADC watchdog threshold register 1
        volatile uint32_t TR2;  ///< Offset: 0x24 - ADC watchdog threshold register 2
        volatile uint32_t TR3;  ///< Offset: 0x28 - read-write
        volatile uint32_t SQR1;  ///< Offset: 0x30 - ADC regular sequence register 1
        volatile uint32_t SQR2;  ///< Offset: 0x34 - ADC regular sequence register 2
        volatile uint32_t SQR3;  ///< Offset: 0x38 - ADC regular sequence register 3
        volatile uint32_t SQR4;  ///< Offset: 0x3C - ADC regular sequence register 4
        volatile uint32_t DR;  ///< Offset: 0x40 - ADC regular Data Register
        volatile uint32_t JSQR;  ///< Offset: 0x4C - ADC injected sequence register
        volatile uint32_t OFR1;  ///< Offset: 0x60 - ADC offset register1
        volatile uint32_t OFR2;  ///< Offset: 0x64 - ADC offset register2
        volatile uint32_t OFR3;  ///< Offset: 0x68 - ADC offset register3
        volatile uint32_t OFR4;  ///< Offset: 0x6C - ADC offset register4
        volatile uint32_t JDR1;  ///< Offset: 0x80 - ADC offset register1
        volatile uint32_t JDR2;  ///< Offset: 0x84 - ADC offset register2
        volatile uint32_t JDR3;  ///< Offset: 0x88 - ADC offset register3
        volatile uint32_t JDR4;  ///< Offset: 0x8C - ADC offset register4
        ...
        volatile uint32_t DIFSEL;  ///< Offset: 0xB0 - ADC Differential Mode Selection Register
        volatile uint32_t CALFACT;  ///< Offset: 0xB4 - ADC Calibration Factors
        volatile uint32_t CSR;  ///< Offset: 0x300 - ADC Common status register
        volatile uint32_t CRR;  ///< Offset: 0x308 - ADC common control register
    };
    ...
    /// ISR Register bits
    namespace isr_bits {
        constexpr uint32_t JQOVF = (1U << 10);  ///< Injected context queue overflow
        constexpr uint32_t AWD3 = (1U << 9);  ///< Analog watchdog 3 flag
        constexpr uint32_t AWD2 = (1U << 8);  ///< Analog watchdog 2 flag
        constexpr uint32_t AWD1 = (1U << 7);  ///< Analog watchdog 1 flag
        constexpr uint32_t JEOS = (1U << 6);  ///< Injected channel end of sequence flag
        constexpr uint32_t JEOC = (1U << 5);  ///< Injected channel end of conversion flag
        constexpr uint32_t OVR = (1U << 4);  ///< ADC overrun
        constexpr uint32_t EOS = (1U << 3);  ///< End of regular sequence flag
    ...
    /// IER Register bits
    namespace ier_bits {
        constexpr uint32_t JQOVFIE = (1U << 10);  ///< Injected context queue overflow interrupt enable
        constexpr uint32_t AWD3IE = (1U << 9);  ///< Analog watchdog 3 interrupt enable
        constexpr uint32_t AWD2IE = (1U << 8);  ///< Analog watchdog 2 interrupt enable
        constexpr uint32_t AWD1IE = (1U << 7);  ///< Analog watchdog 1 interrupt enable
        constexpr uint32_t JEOSIE = (1U << 6);  ///< End of injected sequence of conversions interrupt enable
        constexpr uint32_t JEOCIE = (1U << 5);  ///< End of injected conversion interrupt enable
        constexpr uint32_t OVRIE = (1U << 4);  ///< Overrun interrupt enable
        constexpr uint32_t EOSIE = (1U << 3);  ///< End of regular sequence of conversions interrupt enable
        constexpr uint32_t EOCIE = (1U << 2);  ///< End of regular conversion interrupt enable
        constexpr uint32_t EOSMPIE = (1U << 1);  ///< End of sampling flag interrupt enable for regular conversions
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t ADCALDIF = (1U << 30);  ///< Differential mode for calibration
        constexpr uint32_t ADVREGEN = (2 << 28);  ///< ADC voltage regulator enable
        constexpr uint32_t JADST = (1U << 5);  ///< ADC stop of injected conversion command
        constexpr uint32_t ADSTP = (1U << 4);  ///< ADC stop of regular conversion command
        constexpr uint32_t JADSTART = (1U << 3);  ///< ADC start of injected conversion
        constexpr uint32_t ADSTART = (1U << 2);  ///< ADC start of regular conversion
        constexpr uint32_t ADDIS = (1U << 1);  ///< ADC disable command
        constexpr uint32_t ADEN = (1U << 0);  ///< ADC enable control
    }

    /// CFGR Register bits
    namespace cfgr_bits {
        constexpr uint32_t AWD1CH = (5 << 26);  ///< Analog watchdog 1 channel selection
        constexpr uint32_t JAUTO = (1U << 25);  ///< Automatic injected group conversion
        constexpr uint32_t JAWD1EN = (1U << 24);  ///< Analog watchdog 1 enable on injected channels
        constexpr uint32_t AWD1EN = (1U << 23);  ///< Analog watchdog 1 enable on regular channels
        constexpr uint32_t AWD1SGL = (1U << 22);  ///< Enable the watchdog 1 on a single channel or on all channels
        constexpr uint32_t JQM = (1U << 21);  ///< JSQR queue mode
        constexpr uint32_t JDISCEN = (1U << 20);  ///< Discontinuous mode on injected channels
        constexpr uint32_t DISCNUM = (3 << 17);  ///< Discontinuous mode channel count
        constexpr uint32_t DISCEN = (1U << 16);  ///< Discontinuous mode for regular channels
        constexpr uint32_t AUTDLY = (1U << 14);  ///< Delayed conversion mode
        constexpr uint32_t CONT = (1U << 13);  ///< Single / continuous conversion mode for regular conversions
        constexpr uint32_t OVRMOD = (1U << 12);  ///< Overrun Mode
        constexpr uint32_t EXTEN = (2 << 10);  ///< External trigger enable and polarity selection for regular channels
        constexpr uint32_t EXTSEL = (4 << 6);  ///< External trigger selection for regular group
        constexpr uint32_t ALIGN = (1U << 5);  ///< Data alignment
        constexpr uint32_t RES = (2 << 3);  ///< Data resolution
        constexpr uint32_t DMACFG = (1U << 1);  ///< Direct memory access configuration
        constexpr uint32_t DMAEN = (1U << 0);  ///< Direct memory access enable
    }

    /// SMPR1 Register bits
    namespace smpr1_bits {
        constexpr uint32_t SMP1 = (3 << 3);  ///< Channel 1 sampling time selection
        constexpr uint32_t SMP2 = (3 << 6);  ///< Channel 2 sampling time selection
        constexpr uint32_t SMP3 = (3 << 9);  ///< Channel 3 sampling time selection
        constexpr uint32_t SMP4 = (3 << 12);  ///< Channel 4 sampling time selection
        constexpr uint32_t SMP5 = (3 << 15);  ///< Channel 5 sampling time selection
        constexpr uint32_t SMP6 = (3 << 18);  ///< Channel 6 sampling time selection
        constexpr uint32_t SMP7 = (3 << 21);  ///< Channel 7 sampling time selection
        constexpr uint32_t SMP8 = (3 << 24);  ///< Channel 8 sampling time selection
        constexpr uint32_t SMP9 = (3 << 27);  ///< Channel 9 sampling time selection
    }

    /// SMPR2 Register bits
    namespace smpr2_bits {
        constexpr uint32_t SMP10 = (3 << 0);  ///< Channel 10 sampling time selection
        constexpr uint32_t SMP11 = (3 << 3);  ///< Channel 11 sampling time selection
        constexpr uint32_t SMP12 = (3 << 6);  ///< Channel 12 sampling time selection
        constexpr uint32_t SMP13 = (3 << 9);  ///< Channel 13 sampling time selection
        constexpr uint32_t SMP14 = (3 << 12);  ///< Channel 14 sampling time selection
        constexpr uint32_t SMP15 = (3 << 15);  ///< Channel 15 sampling time selection
        constexpr uint32_t SMP16 = (3 << 18);  ///< Channel 16 sampling time selection
        constexpr uint32_t SMP17 = (3 << 21);  ///< Channel 17 sampling time selection
        constexpr uint32_t SMP18 = (3 << 24);  ///< Channel 18 sampling time selection
    }

    /// TR1 Register bits
    namespace tr1_bits {
        constexpr uint32_t HT1 = (12 << 16);  ///< Analog watchdog 1 higher threshold
        constexpr uint32_t LT1 = (12 << 0);  ///< Analog watchdog 1 lower threshold
    }

    /// TR2 Register bits
    namespace tr2_bits {
        constexpr uint32_t HT2 = (8 << 16);  ///< Analog watchdog 2 higher threshold
        constexpr uint32_t LT2 = (8 << 0);  ///< Analog watchdog 2 lower threshold
    }

    /// TR3 Register bits
    namespace tr3_bits {
        constexpr uint32_t HT3 = (8 << 16);  ///< Analog watchdog 3 higher threshold
        constexpr uint32_t LT3 = (8 << 0);  ///< Analog watchdog 3 lower threshold
    }

    /// SQR1 Register bits
    namespace sqr1_bits {
        constexpr uint32_t SQ4 = (5 << 24);  ///< 4th conversion in regular sequence
        constexpr uint32_t SQ3 = (5 << 18);  ///< 3rd conversion in regular sequence
        constexpr uint32_t SQ2 = (5 << 12);  ///< 2nd conversion in regular sequence
        constexpr uint32_t SQ1 = (5 << 6);  ///< 1st conversion in regular sequence
        constexpr uint32_t L = (4 << 0);  ///< Regular channel sequence length
    }

    /// SQR2 Register bits
    namespace sqr2_bits {
        constexpr uint32_t SQ9 = (5 << 24);  ///< 9th conversion in regular sequence
        constexpr uint32_t SQ8 = (5 << 18);  ///< 8th conversion in regular sequence
        constexpr uint32_t SQ7 = (5 << 12);  ///< 7th conversion in regular sequence
        constexpr uint32_t SQ6 = (5 << 6);  ///< 6th conversion in regular sequence
        constexpr uint32_t SQ5 = (5 << 0);  ///< 5th conversion in regular sequence
    }

    /// SQR3 Register bits
    namespace sqr3_bits {
        constexpr uint32_t SQ14 = (5 << 24);  ///< 14th conversion in regular sequence
        constexpr uint32_t SQ13 = (5 << 18);  ///< 13th conversion in regular sequence
        constexpr uint32_t SQ12 = (5 << 12);  ///< 13th conversion in regular sequence
        constexpr uint32_t SQ11 = (5 << 6);  ///< 11th conversion in regular sequence
        constexpr uint32_t SQ10 = (5 << 0);  ///< 10th conversion in regular sequence
    }

    /// SQR4 Register bits
    namespace sqr4_bits {
        constexpr uint32_t SQ16 = (5 << 6);  ///< 16th conversion in regular sequence
        constexpr uint32_t SQ15 = (5 << 0);  ///< 15th conversion in regular sequence
    }
    ...
    /// JSQR Register bits
    namespace jsqr_bits {
        constexpr uint32_t JSQ4 = (5 << 26);  ///< 4th conversion in the injected sequence
        constexpr uint32_t JSQ3 = (5 << 20);  ///< 3rd conversion in the injected sequence
        constexpr uint32_t JSQ2 = (5 << 14);  ///< 2nd conversion in the injected sequence
        constexpr uint32_t JSQ1 = (5 << 8);  ///< 1st conversion in the injected sequence
        constexpr uint32_t JEXTEN = (2 << 6);  ///< External Trigger Enable and Polarity Selection for injected channels
        constexpr uint32_t JEXTSEL = (4 << 2);  ///< External Trigger Selection for injected group
        constexpr uint32_t JL = (2 << 0);  ///< Injected channel sequence length
    }

    /// OFR1 Register bits
    namespace ofr1_bits {
        constexpr uint32_t OFFSET1_EN = (1U << 31);  ///< Offset1 Enable
        constexpr uint32_t OFFSET1_CH = (5 << 26);  ///< Channel selection for the Data offset 1
        constexpr uint32_t OFFSET1 = (12 << 0);  ///< Data offset 1 for the channel programmed into bits OFFSET1_CH
    }

    /// OFR2 Register bits
    namespace ofr2_bits {
        constexpr uint32_t OFFSET2_EN = (1U << 31);  ///< Offset 2 Enable
        constexpr uint32_t OFFSET2_CH = (5 << 26);  ///< Channel selection for the Data offset 2
        constexpr uint32_t OFFSET2 = (12 << 0);  ///< Data offset 2 for the channel programmed into bits OFFSET2_CH
    }

    /// OFR3 Register bits
    namespace ofr3_bits {
        constexpr uint32_t OFFSET3_EN = (1U << 31);  ///< Offset y Enable
        constexpr uint32_t OFFSET3_CH = (5 << 26);  ///< Channel selection for the Data offset 3
        constexpr uint32_t OFFSET3 = (12 << 0);  ///< Data offset 3 for the channel programmed into bits OFFSET3_CH
    }

    /// OFR4 Register bits
    namespace ofr4_bits {
        constexpr uint32_t OFFSET4_EN = (1U << 31);  ///< Offset 4 Enable
        constexpr uint32_t OFFSET4_CH = (5 << 26);  ///< Channel selection for the Data offset 4
        constexpr uint32_t OFFSET4 = (12 << 0);  ///< Data offset 4 for the channel programmed into bits OFFSET4_CH
    }
    ...
    namespace awd2cr_bits {
        constexpr uint32_t AWD2CH = (18 << 1);  ///< Analog watchdog 2 channel selection
    }

    /// AWD3CR Register bits
    namespace awd3cr_bits {
        constexpr uint32_t AWD3CH = (18 << 1);  ///< Analog watchdog 3 channel selection
    }

    /// DIFSEL Register bits
    namespace difsel_bits {
        constexpr uint32_t DIFSEL = (18 << 1);  ///< Differential mode for channels 15 to 1
    }

    /// CALFACT Register bits
    namespace calfact_bits {
        constexpr uint32_t CALFACT_D = (7 << 16);  ///< Calibration Factors in differential mode
        constexpr uint32_t CALFACT_S = (7 << 0);  ///< Calibration Factors In Single-Ended mode
    }

    /// CSR Register bits
    namespace csr_bits {
        constexpr uint32_t JQOVF_SLV = (1U << 26);  ///< Injected Context Queue Overflow flag of the slave ADC
        constexpr uint32_t AWD3_SLV = (1U << 25);  ///< Analog watchdog 3 flag of the slave ADC
        constexpr uint32_t AWD2_SLV = (1U << 24);  ///< Analog watchdog 2 flag of the slave ADC
        constexpr uint32_t AWD1_SLV = (1U << 23);  ///< Analog watchdog 1 flag of the slave ADC
        constexpr uint32_t JEOS_SLV = (1U << 22);  ///< End of injected sequence flag of the slave ADC
        constexpr uint32_t JEOC_SLV = (1U << 21);  ///< End of injected conversion flag of the slave ADC
        constexpr uint32_t OVR_SLV = (1U << 20);  ///< Overrun flag of the slave ADC
        constexpr uint32_t EOS_SLV = (1U << 19);  ///< End of regular sequence flag of the slave ADC
        constexpr uint32_t EOC_SLV = (1U << 18);  ///< End of regular conversion of the slave ADC
        constexpr uint32_t EOSMP_SLV = (1U << 17);  ///< End of Sampling phase flag of the slave ADC
        constexpr uint32_t ADRDY_SLV = (1U << 16);  ///< Slave ADC ready
        constexpr uint32_t JQOVF_MST = (1U << 10);  ///< Injected Context Queue Overflow flag of the master ADC
        constexpr uint32_t AWD3_MST = (1U << 9);  ///< Analog watchdog 3 flag of the master ADC
        constexpr uint32_t AWD2_MST = (1U << 8);  ///< Analog watchdog 2 flag of the master ADC
        constexpr uint32_t AWD1_MST = (1U << 7);  ///< Analog watchdog 1 flag of the master ADC
        constexpr uint32_t JEOS_MST = (1U << 6);  ///< End of injected sequence flag of the master ADC
        constexpr uint32_t JEOC_MST = (1U << 5);  ///< End of injected conversion flag of the master ADC
        constexpr uint32_t OVR_MST = (1U << 4);  ///< Overrun flag of the master ADC
        constexpr uint32_t EOS_MST = (1U << 3);  ///< End of regular sequence flag of the master ADC
        constexpr uint32_t EOC_MST = (1U << 2);  ///< End of regular conversion of the master ADC
        constexpr uint32_t EOSMP_MST = (1U << 1);  ///< End of Sampling phase flag of the master ADC
        constexpr uint32_t ADRDY_MST = (1U << 0);  ///< Master ADC ready
    }

    /// CRR Register bits
    namespace crr_bits {
        constexpr uint32_t VBATEN = (1U << 24);  ///< VBATEN
...
namespace pwr {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t ENSD1 = (1U << 9);  ///< ENable SD1 ADC
        constexpr uint32_t ENSD2 = (1U << 10);  ///< ENable SD2 ADC
        constexpr uint32_t ENSD3 = (1U << 11);  ///< ENable SD3 ADC
    }
    ...
    namespace csr_bits {
        ...
        constexpr uint32_t EWUP3 = (1U << 10);  ///< Enable WKUP3 pin
    }
...
namespace dac {
    /// Base addresses
    constexpr uint32_t DAC1_BASE = 0x40007400;
...
namespace comp {
    ...
    struct Registers {
        ...
        volatile uint32_t SYSCFG_CFGR3;  ///< Offset: 0x50 - configuration register 3
        volatile uint32_t OPAMP2_CSR;  ///< Offset: 0x3C - OPAMP2 control register
    ...
    /// SYSCFG_CFGR3 Register bits
    namespace syscfg_cfgr3_bits {
        constexpr uint32_t DAC1_TRIG5_RMP = (1U << 17);  ///< DAC1_CH1 / DAC1_CH2 Trigger remap
        constexpr uint32_t DAC1_TRIG3_RMP = (1U << 16);  ///< DAC1_CH1 / DAC1_CH2 Trigger remap
        constexpr uint32_t ADC2_DMA_RMP_1 = (1U << 9);  ///< ADC2 DMA controller remapping bit
        constexpr uint32_t ADC2_DMA_RMP_0 = (2 << 6);  ///< ADC2 DMA channel remapping bit
        constexpr uint32_t I2C1_RX_DMA_RMP = (2 << 4);  ///< I2C1_RX DMA remapping bit
        constexpr uint32_t SPI1_TX_DMA_RMP = (2 << 2);  ///< SPI1_TX DMA remapping bit
        constexpr uint32_t SPI1_RX_DMA_RMP = (2 << 0);  ///< SPI1_RX DMA remapping bit
    }
    ...
    namespace comp2_csr_bits {
        ...
        constexpr uint32_t COMP2OUT = (1U << 30);  ///< Comparator 2 output
...
#endif // ALLOY_GENERATED_STM32F301_PERIPHERALS_HPP