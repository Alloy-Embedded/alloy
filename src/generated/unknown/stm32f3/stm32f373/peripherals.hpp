...
namespace alloy::generated::stm32f373 {
...
namespace flash {
    ...
    namespace obr_bits {
        ...
        constexpr uint32_t SDADC12_VDD_MONITOR = (1U << 15);  ///< SDADC12_VDD_MONITOR
...
namespace rcc {
    ...
    namespace cfgr_bits {
        ...
        constexpr uint32_t USBPRE = (1U << 22);  ///< USB prescaler
        constexpr uint32_t MCO = (3 << 24);  ///< Microcontroller clock output
        constexpr uint32_t SDPRE = (5 << 27);  ///< SDADC prescaler
    }
    ...
    namespace apb2rstr_bits {
        ...
        constexpr uint32_t TIM19RST = (1U << 19);  ///< TIM19 timer reset
        constexpr uint32_t SDAD1RST = (1U << 24);  ///< SDADC1 (Sigma delta ADC 1) reset
        constexpr uint32_t SDAD2RST = (1U << 25);  ///< SDADC2 (Sigma delta ADC 2) reset
        constexpr uint32_t SDAD3RST = (1U << 26);  ///< SDADC3 (Sigma delta ADC 3) reset
    }
    ...
    namespace apb1rstr_bits {
        ...
        constexpr uint32_t TIM18RST = (1U << 9);  ///< Timer 18 reset
        ...
        constexpr uint32_t DAC3RST = (1U << 26);  ///< DAC3 reset
    ...
    namespace apb2enr_bits {
        ...
        constexpr uint32_t TIM19EN = (1U << 19);  ///< TIM19 timer clock enable
        constexpr uint32_t DBGMCUEN = (1U << 22);  ///< MCU debug module clock enable
        constexpr uint32_t SDAD1EN = (1U << 24);  ///< SDADC1 (Sigma Delta ADC 1) clock enable
        constexpr uint32_t SDAD2EN = (1U << 25);  ///< SDADC2 (Sigma Delta ADC 2) clock enable
        constexpr uint32_t SDAD3EN = (1U << 26);  ///< SDADC3 (Sigma Delta ADC 3) clock enable
    }
    ...
    namespace apb1enr_bits {
        ...
        constexpr uint32_t TIM18EN = (1U << 9);  ///< Timer 18 clock enable
        ...
        constexpr uint32_t DAC3EN = (1U << 26);  ///< DAC3 interface clock enable
...
namespace tim {
    ...
    constexpr uint32_t TIM19_BASE = 0x40015C00;
    ...
    constexpr uint32_t TIM18_BASE = 0x40009C00;
    ...
    inline Registers* TIM19 = reinterpret_cast<Registers*>(TIM19_BASE);
    ...
    inline Registers* TIM18 = reinterpret_cast<Registers*>(TIM18_BASE);
    ...
    namespace cnt_bits {
        ...
        constexpr uint32_t CNTH = (16 << 16);  ///< High counter value
    }
...
namespace adc {
    ...
    constexpr uint32_t SDADC1_BASE = 0x40016000;
    constexpr uint32_t SDADC2_BASE = 0x40016400;
    constexpr uint32_t SDADC3_BASE = 0x40016800;
    ...
    inline Registers* SDADC1 = reinterpret_cast<Registers*>(SDADC1_BASE);
    inline Registers* SDADC2 = reinterpret_cast<Registers*>(SDADC2_BASE);
    inline Registers* SDADC3 = reinterpret_cast<Registers*>(SDADC3_BASE);
...
namespace dac {
    /// Base addresses
    constexpr uint32_t DAC2_BASE = 0x40009800;
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t MAMP13 = (1U << 11);  ///< DAC channel1 mask/amplitude selector
        constexpr uint32_t MAMP12 = (1U << 10);  ///< MAMP12
        constexpr uint32_t MAMP11 = (1U << 9);  ///< MAMP11
        constexpr uint32_t MAMP10 = (1U << 8);  ///< MAMP10
        constexpr uint32_t WAVE1 = (1U << 7);  ///< DAC channel1 noise/triangle wave generation enable
        constexpr uint32_t WAVE2 = (1U << 6);  ///< WAVE2
...
#endif // ALLOY_GENERATED_STM32F373_PERIPHERALS_HPP