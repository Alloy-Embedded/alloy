/// Auto-generated code for STM32F405
/// Generated by Alloy Code Generator
/// Source: st_stm32f405.json
...
namespace rcc {
    ...
    namespace plli2scfgr_bits {
        constexpr uint32_t PLLI2SRx = (3 << 28);  ///< PLLI2S division factor for I2S clocks
        constexpr uint32_t PLLI2SNx = (9 << 6);  ///< PLLI2S multiplication factor for VCO
    }
...
namespace sai1 {
    ...
    struct Registers {
        volatile uint32_t SAI_ACR1;  ///< Offset: 0x04 - SAI AConfiguration register 1
        volatile uint32_t SAI_BCR1;  ///< Offset: 0x24 - SAI BConfiguration register 1
        volatile uint32_t SAI_ACR2;  ///< Offset: 0x08 - SAI AConfiguration register 2
        volatile uint32_t SAI_BCR2;  ///< Offset: 0x28 - SAI BConfiguration register 2
        volatile uint32_t SAI_AFRCR;  ///< Offset: 0x0C - SAI AFrame configuration register
        volatile uint32_t SAI_BFRCR;  ///< Offset: 0x2C - SAI BFrame configuration register
        volatile uint32_t SAI_ASLOTR;  ///< Offset: 0x10 - SAI ASlot register
        volatile uint32_t SAI_BSLOTR;  ///< Offset: 0x30 - SAI BSlot register
        volatile uint32_t SAI_AIM;  ///< Offset: 0x14 - SAI AInterrupt mask register2
        volatile uint32_t SAI_BIM;  ///< Offset: 0x34 - SAI BInterrupt mask register2
        volatile uint32_t SAI_ASR;  ///< Offset: 0x18 - SAI AStatus register
        volatile uint32_t SAI_BSR;  ///< Offset: 0x38 - SAI BStatus register
        volatile uint32_t SAI_ACLRFR;  ///< Offset: 0x1C - SAI AClear flag register
        volatile uint32_t SAI_BCLRFR;  ///< Offset: 0x3C - SAI BClear flag register
        volatile uint32_t SAI_ADR;  ///< Offset: 0x20 - SAI AData register
        volatile uint32_t SAI_BDR;  ///< Offset: 0x40 - SAI BData register
    };
    ...
    namespace sai_acr1_bits {
        ...
        constexpr uint32_t SAIAEN = (1U << 16);  ///< Audio block enable
    ...
    namespace sai_bcr1_bits {
        ...
        constexpr uint32_t MONO = (1U << 12);  ///< Mono mode
        constexpr uint32_t OUTDRIV = (1U << 13);  ///< Output drive
        constexpr uint32_t SAIBEN = (1U << 16);  ///< Audio block enable
        constexpr uint32_t DMAEN = (1U << 17);  ///< DMA enable
        constexpr uint32_t NODIV = (1U << 19);  ///< No divider
        constexpr uint32_t MCKDIV = (4 << 20);  ///< Master clock divider
    }
    ...
    namespace sai_acr2_bits {
        ...
        constexpr uint32_t MUTECNT = (6 << 7);  ///< Mute counter
    ...
    namespace sai_asr_bits {
        ...
        constexpr uint32_t FLTH = (3 << 16);  ///< FIFO level threshold
    }
