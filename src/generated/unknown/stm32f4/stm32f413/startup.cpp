...
extern "C" {
    ...
    void EXTI17_RTC_Alarm_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void USART4_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void UART5_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void TIM6_GLB_IT_DAC1_DAC2_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void CRYPTO_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void RNG_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void FPU_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void USART7_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void USART8_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void I2CFMP1event_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void I2CFMP1error_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void lptim1_OR_it_eit_23_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void DFSDM2_FILTER1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void DFSDM2_FILTER2_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void DFSDM2_FILTER3_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void DFSDM2_FILTER4_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}