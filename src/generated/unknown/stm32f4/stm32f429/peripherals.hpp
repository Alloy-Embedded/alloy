/// Auto-generated code for STM32F429
/// Generated by Alloy Code Generator
/// Source: st_stm32f429.json
...
namespace fmc {
    ...
    struct Registers {
        ...
        volatile uint32_t BWTR3;  ///< Offset: 0x104 - SRAM/NOR-Flash write timing registers 3
        volatile uint32_t BWTR4;  ///< Offset: 0x10C - SRAM/NOR-Flash write timing registers 4
...
namespace rcc {
    ...
    namespace dckcfgr_bits {
        constexpr uint32_t PLLI2SDIVQ = (5 << 0);  ///< PLLI2S division factor for SAI1 clock
        ...
        constexpr uint32_t SAI1ASRC = (2 << 20);  ///< SAI1-A clock source selection
