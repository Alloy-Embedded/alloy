/// Auto-generated code for STM32F469
/// Generated by Alloy Code Generator
/// Source: st_stm32f469.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:53
#ifndef ALLOY_GENERATED_STM32F469_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32F469_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::stm32f469 {
...
namespace traits {
    ...
    constexpr bool has_dsihost = true;
    constexpr uint32_t num_dsihost_instances = 1;
    ...
    template<>
    struct peripheral_count<struct dsihost_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace rcc {
    ...
    namespace pllcfgr_bits {
        constexpr uint32_t PLLM = (6 << 0);  ///< Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
        constexpr uint32_t PLLN = (9 << 6);  ///< Main PLL (PLL) multiplication factor for VCO
        constexpr uint32_t PLLP = (2 << 16);  ///< Main PLL (PLL) division factor for main system clock
        constexpr uint32_t PLLSRC = (1U << 22);  ///< Main PLL(PLL) and audio PLL (PLLI2S) entry clock source
        constexpr uint32_t PLLQ = (4 << 24);  ///< Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
        constexpr uint32_t PLLR = (3 << 28);  ///< Main PLL division factor for DSI clock
    }
    ...
    namespace ahb3rstr_bits {
        ...
        constexpr uint32_t QSPIRST = (1U << 1);  ///< QUADSPI memory controller reset
    }
    ...
    namespace apb2rstr_bits {
        ...
        constexpr uint32_t DSIRST = (1U << 27);  ///< DSI host reset
    }
    ...
    namespace apb2enr_bits {
        ...
        constexpr uint32_t DSIEN = (1U << 27);  ///< DSI clocks enable
    }
    ...
    namespace apb2lpenr_bits {
        ...
        constexpr uint32_t LTDCLPEN = (1U << 26);  ///< LTDC clock enable
        constexpr uint32_t DSILPEN = (1U << 27);  ///< DSI clocks enable during Sleep mode
    }
    ...
    namespace pllsaicfgr_bits {
        ...
        constexpr uint32_t PLLSAIQ = (4 << 24);  ///< PLLSAI division factor for SAI1 clock
        constexpr uint32_t PLLSAIR = (3 << 28);  ///< PLLSAI division factor for LCD clock
    }

    /// DCKCFGR Register bits
    namespace dckcfgr_bits {
        constexpr uint32_t PLLIS2DIVQ = (5 << 0);  ///< PLLI2S division factor for SAIs clock
        constexpr uint32_t PLLSAIDIVQ = (5 << 8);  ///< PLLSAI division factor for SAIs clock
        constexpr uint32_t PLLSAIDIVR = (2 << 16);  ///< PLLSAIDIVR
        constexpr uint32_t SAI1ASRC = (2 << 20);  ///< SAI1 clock source selection
        constexpr uint32_t SAI1BSRC = (2 << 22);  ///< SAI1-B clock source selection
        constexpr uint32_t TIMPRE = (1U << 24);  ///< Timers clocks prescalers selection
        constexpr uint32_t MSEL = (1U << 27);  ///< 48 MHz clock source selection
        constexpr uint32_t SDMMCSEL = (1U << 28);  ///< SDIO clock source selection
        constexpr uint32_t DSISEL = (1U << 29);  ///< DSI clock source selection
    }
...
namespace pwr {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t LPLVDS = (1U << 10);  ///< Low-Power Regulator Low Voltage in deepsleep
        constexpr uint32_t MRLVDS = (1U << 11);  ///< Main regulator low voltage in deepsleep mode
...
namespace otg {
    ...
    struct Registers {
        ...
        volatile uint32_t FS_GRXSTSR_Host;  ///< Offset: 0x1C - OTG_FS Receive status debug read(Hostmode)
        ...
        volatile uint32_t FS_DIEPTXF4;  ///< Offset: 0x110 - OTG_FS device IN endpoint transmit FIFO size register...
        volatile uint32_t FS_DIEPTXF5;  ///< Offset: 0x114 - OTG_FS device IN endpoint transmit FIFO size register...
    };
...
namespace flash {
    ...
    namespace sr_bits {
        ...
        constexpr uint32_t RDERR = (1U << 8);  ///< Proprietary readout protection (PCROP) error
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t MER1 = (1U << 15);  ///< Mass Erase of sectors 12 to 23
    ...
    namespace optcr_bits {
        ...
        constexpr uint32_t BFB2 = (1U << 4);  ///< Dual-bank Boot option byte
        ...
        constexpr uint32_t DB1M = (1U << 30);  ///< Dual-bank on 1 Mbyte Flash memory devices
        constexpr uint32_t SPRMOD = (1U << 31);  ///< Selection of protection mode for nWPRi bits
    }
...
namespace sai {
    ...
    /// GCR Register bits
    namespace gcr_bits {
        constexpr uint32_t SYNCOUT = (2 << 0);  ///< Synchronization outputs
    }
...
namespace dsihost {
    /// Base addresses
    constexpr uint32_t DSIHOST_BASE = 0x40016C00;

    /// DSIHOST Register structure
    struct Registers {
        ...
        volatile uint32_t DSIHSOT_CCR;  ///< Offset: 0x08 - DSI HOST Clock Control Register
        ...
        volatile uint32_t DSI_TCCR1;  ///< Offset: 0x78 - DSI Host Timeout Counter Configuration Register1
        volatile uint32_t DSI_TCCR2;  ///< Offset: 0x7C - DSI Host Timeout Counter Configuration Register2
        volatile uint32_t DSI_TCCR3;  ///< Offset: 0x80 - DSI Host Timeout Counter Configuration Register3
        volatile uint32_t DSI_TCCR4;  ///< Offset: 0x84 - DSI Host Timeout Counter Configuration Register4
        volatile uint32_t DSI_TCCR5;  ///< Offset: 0x88 - DSI Host Timeout Counter Configuration Register5
        volatile uint32_t DSI_TCCR6;  ///< Offset: 0x8C - DSI Host Timeout Counter Configuration Register6
        ...
        volatile uint32_t DSI_PCCONFR;  ///< Offset: 0xA4 - DSI Host PHY Configuration Register
    ...
    /// Peripheral instances
    inline Registers* DSIHOST = reinterpret_cast<Registers*>(DSIHOST_BASE);
    ...
    /// DSIHSOT_CCR Register bits
    namespace dsihsot_ccr_bits {
        constexpr uint32_t TOCKDIV = (8 << 8);  ///< TOCKDIV
        constexpr uint32_t TXECKDIV = (8 << 0);  ///< TXECKDIV
    }
    ...
    namespace dsi_vmcr_bits {
        ...
        constexpr uint32_t LPHFE = (1U << 13);  ///< Low-Power Horizontal Front-Porch Enable
        constexpr uint32_t LPHBPE = (1U << 12);  ///< Low-Power Horizontal Back-Porch Enable
        constexpr uint32_t LVAE = (1U << 11);  ///< Low-Power Vertical Active Enable
    ...
    namespace dsi_vpcr_bits {
        constexpr uint32_t VPSIZE = (15 << 0);  ///< Video Packet Size
    }

    /// DSI_VCCR Register bits
    namespace dsi_vccr_bits {
        constexpr uint32_t NUMC = (14 << 0);  ///< Number of Chunks
    }

    /// DSI_VNPCR Register bits
    namespace dsi_vnpcr_bits {
        constexpr uint32_t NPSIZE = (14 << 0);  ///< Null Packet Size
    }

    /// DSI_VHSACR Register bits
    namespace dsi_vhsacr_bits {
        constexpr uint32_t HSA = (13 << 0);  ///< Horizontal Synchronism Active duration
    }

    /// DSI_VHBPCR Register bits
    namespace dsi_vhbpcr_bits {
        constexpr uint32_t HBP = (13 << 0);  ///< Horizontal Back-Porch duration
    }
    ...
    namespace dsi_gpsr_bits {
        constexpr uint32_t RCB = (1U << 6);  ///< RCB
        constexpr uint32_t PRDFF = (1U << 5);  ///< PRDFF
        constexpr uint32_t PRDFE = (1U << 4);  ///< PRDFE
        constexpr uint32_t PWRFF = (1U << 3);  ///< PWRFF
        constexpr uint32_t PWRFE = (1U << 2);  ///< PWRFE
        constexpr uint32_t CMDFF = (1U << 1);  ///< Acknowledge Request Enable
        constexpr uint32_t CMDFE = (1U << 0);  ///< Tearing Effect Acknowledge Request Enable
    }
    ...
    /// DSI_TCCR6 Register bits
    namespace dsi_tccr6_bits {
    ...
    /// DSI_PCCONFR Register bits
    namespace dsi_pcconfr_bits {
        constexpr uint32_t SW_TIME = (8 << 8);  ///< SW_TIME
        constexpr uint32_t NL = (2 << 0);  ///< NL
    }
    ...
    namespace dsi_vmccr_bits {
        constexpr uint32_t LPCE = (1U << 15);  ///< Low-Power Command Enable
        constexpr uint32_t FBTAAE = (1U << 14);  ///< Frame BTA Acknowledge Enable
        constexpr uint32_t LPHFE = (1U << 13);  ///< Low-Power Horizontal Front-Porch Enable
        constexpr uint32_t LPHBPE = (1U << 12);  ///< Low-power Horizontal Back-Porch Enable
        constexpr uint32_t LVAE = (1U << 11);  ///< Low-Power Vertical Active Enable
        constexpr uint32_t LPVFPE = (1U << 10);  ///< Low-power Vertical Front-Porch Enable
        constexpr uint32_t LPVBPE = (1U << 9);  ///< Low-power Vertical Back-Porch Enable
        constexpr uint32_t LPVSAE = (1U << 8);  ///< Low-Power Vertical Sync time Enable
        constexpr uint32_t VMT = (2 << 0);  ///< Video mode Type
    }
...
#endif // ALLOY_GENERATED_STM32F469_PERIPHERALS_HPP