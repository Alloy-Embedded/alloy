/// Auto-generated code for STM32F765
/// Generated by Alloy Code Generator
/// Source: st_stm32f765.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:00:54
#ifndef ALLOY_GENERATED_STM32F765_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32F765_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::stm32f765 {
...
namespace traits {
    ...
    constexpr uint32_t num_eth_instances = 3;
...
namespace dma {
    ...
    /// S0CR Register bits
    namespace s0cr_bits {
        constexpr uint32_t CHSEL = (4 << 25);  ///< Channel selection
...
namespace can {
    ...
    constexpr uint32_t CAN3_BASE = 0x40003400;
...
namespace flash {
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t MER1 = (1U << 2);  ///< Mass Erase of sectors 0 to 11
        constexpr uint32_t SNB = (5 << 3);  ///< Sector number
        constexpr uint32_t PSIZE = (2 << 8);  ///< Program size
        constexpr uint32_t MER2 = (1U << 15);  ///< Mass Erase of sectors 12 to 23
    ...
    namespace optcr_bits {
        ...
        constexpr uint32_t nDBOOT = (1U << 28);  ///< Dual Boot mode (valid only when nDBANK=0)
        constexpr uint32_t nDBANK = (1U << 29);  ///< Not dual bank mode
    }
...
namespace mdios {
    /// Base addresses
    constexpr uint32_t MDIOS_BASE = 0x40017800;

    /// MDIOS Register structure
    struct Registers {
        volatile uint32_t MDIOS_CR;  ///< Offset: 0x00 - MDIOS configuration register
        volatile uint32_t MDIOS_WRFR;  ///< Offset: 0x04 - MDIOS write flag register
        volatile uint32_t MDIOS_CWRFR;  ///< Offset: 0x08 - MDIOS clear write flag register
        volatile uint32_t MDIOS_RDFR;  ///< Offset: 0x0C - MDIOS read flag register
        volatile uint32_t MDIOS_CRDFR;  ///< Offset: 0x10 - MDIOS clear read flag register
        volatile uint32_t MDIOS_SR;  ///< Offset: 0x14 - MDIOS status register
        volatile uint32_t MDIOS_CLRFR;  ///< Offset: 0x18 - MDIOS clear flag register
        volatile uint32_t MDIOS_DINR0;  ///< Offset: 0x1C - MDIOS input data register 0
        volatile uint32_t MDIOS_DINR1;  ///< Offset: 0x20 - MDIOS input data register 1
        volatile uint32_t MDIOS_DINR2;  ///< Offset: 0x24 - MDIOS input data register 2
        volatile uint32_t MDIOS_DINR3;  ///< Offset: 0x28 - MDIOS input data register 3
        volatile uint32_t MDIOS_DINR4;  ///< Offset: 0x2C - MDIOS input data register 4
        volatile uint32_t MDIOS_DINR5;  ///< Offset: 0x30 - MDIOS input data register 5
        volatile uint32_t MDIOS_DINR6;  ///< Offset: 0x34 - MDIOS input data register 6
        volatile uint32_t MDIOS_DINR7;  ///< Offset: 0x38 - MDIOS input data register 7
        volatile uint32_t MDIOS_DINR8;  ///< Offset: 0x3C - MDIOS input data register 8
        volatile uint32_t MDIOS_DINR9;  ///< Offset: 0x40 - MDIOS input data register 9
        volatile uint32_t MDIOS_DINR10;  ///< Offset: 0x44 - MDIOS input data register 10
        volatile uint32_t MDIOS_DINR11;  ///< Offset: 0x48 - MDIOS input data register 11
        volatile uint32_t MDIOS_DINR12;  ///< Offset: 0x4C - MDIOS input data register 12
        volatile uint32_t MDIOS_DINR13;  ///< Offset: 0x50 - MDIOS input data register 13
        volatile uint32_t MDIOS_DINR14;  ///< Offset: 0x54 - MDIOS input data register 14
        volatile uint32_t MDIOS_DINR15;  ///< Offset: 0x58 - MDIOS input data register 15
        volatile uint32_t MDIOS_DINR16;  ///< Offset: 0x5C - MDIOS input data register 16
        volatile uint32_t MDIOS_DINR17;  ///< Offset: 0x60 - MDIOS input data register 17
        volatile uint32_t MDIOS_DINR18;  ///< Offset: 0x64 - MDIOS input data register 18
        volatile uint32_t MDIOS_DINR19;  ///< Offset: 0x68 - MDIOS input data register 19
        volatile uint32_t MDIOS_DINR20;  ///< Offset: 0x6C - MDIOS input data register 20
        volatile uint32_t MDIOS_DINR21;  ///< Offset: 0x70 - MDIOS input data register 21
        volatile uint32_t MDIOS_DINR22;  ///< Offset: 0x74 - MDIOS input data register 22
        volatile uint32_t MDIOS_DINR23;  ///< Offset: 0x78 - MDIOS input data register 23
        volatile uint32_t MDIOS_DINR24;  ///< Offset: 0x7C - MDIOS input data register 24
        volatile uint32_t MDIOS_DINR25;  ///< Offset: 0x80 - MDIOS input data register 25
        volatile uint32_t MDIOS_DINR26;  ///< Offset: 0x84 - MDIOS input data register 26
        volatile uint32_t MDIOS_DINR27;  ///< Offset: 0x88 - MDIOS input data register 27
        volatile uint32_t MDIOS_DINR28;  ///< Offset: 0x8C - MDIOS input data register 28
        volatile uint32_t MDIOS_DINR29;  ///< Offset: 0x90 - MDIOS input data register 29
        volatile uint32_t MDIOS_DINR30;  ///< Offset: 0x94 - MDIOS input data register 30
        volatile uint32_t MDIOS_DINR31;  ///< Offset: 0x98 - MDIOS input data register 31
        volatile uint32_t MDIOS_DOUTR0;  ///< Offset: 0x9C - MDIOS output data register 0
        volatile uint32_t MDIOS_DOUTR1;  ///< Offset: 0xA0 - MDIOS output data register 1
        volatile uint32_t MDIOS_DOUTR2;  ///< Offset: 0xA4 - MDIOS output data register 2
        volatile uint32_t MDIOS_DOUTR3;  ///< Offset: 0xA8 - MDIOS output data register 3
        volatile uint32_t MDIOS_DOUTR4;  ///< Offset: 0xAC - MDIOS output data register 4
        volatile uint32_t MDIOS_DOUTR5;  ///< Offset: 0xB0 - MDIOS output data register 5
        volatile uint32_t MDIOS_DOUTR6;  ///< Offset: 0xB4 - MDIOS output data register 6
        volatile uint32_t MDIOS_DOUTR7;  ///< Offset: 0xB8 - MDIOS output data register 7
        volatile uint32_t MDIOS_DOUTR8;  ///< Offset: 0xBC - MDIOS output data register 8
        volatile uint32_t MDIOS_DOUTR9;  ///< Offset: 0xC0 - MDIOS output data register 9
        volatile uint32_t MDIOS_DOUTR10;  ///< Offset: 0xC4 - MDIOS output data register 10
        volatile uint32_t MDIOS_DOUTR11;  ///< Offset: 0xC8 - MDIOS output data register 11
        volatile uint32_t MDIOS_DOUTR12;  ///< Offset: 0xCC - MDIOS output data register 12
        volatile uint32_t MDIOS_DOUTR13;  ///< Offset: 0xD0 - MDIOS output data register 13
        volatile uint32_t MDIOS_DOUTR14;  ///< Offset: 0xD4 - MDIOS output data register 14
        volatile uint32_t MDIOS_DOUTR15;  ///< Offset: 0xD8 - MDIOS output data register 15
        volatile uint32_t MDIOS_DOUTR16;  ///< Offset: 0xDC - MDIOS output data register 16
        volatile uint32_t MDIOS_DOUTR17;  ///< Offset: 0xE0 - MDIOS output data register 17
        volatile uint32_t MDIOS_DOUTR18;  ///< Offset: 0xE4 - MDIOS output data register 18
        volatile uint32_t MDIOS_DOUTR19;  ///< Offset: 0xE8 - MDIOS output data register 19
        volatile uint32_t MDIOS_DOUTR20;  ///< Offset: 0xEC - MDIOS output data register 20
        volatile uint32_t MDIOS_DOUTR21;  ///< Offset: 0xF0 - MDIOS output data register 21
        volatile uint32_t MDIOS_DOUTR22;  ///< Offset: 0xF4 - MDIOS output data register 22
        volatile uint32_t MDIOS_DOUTR23;  ///< Offset: 0xF8 - MDIOS output data register 23
        volatile uint32_t MDIOS_DOUTR24;  ///< Offset: 0xFC - MDIOS output data register 24
        volatile uint32_t MDIOS_DOUTR25;  ///< Offset: 0x100 - MDIOS output data register 25
        volatile uint32_t MDIOS_DOUTR26;  ///< Offset: 0x104 - MDIOS output data register 26
        volatile uint32_t MDIOS_DOUTR27;  ///< Offset: 0x108 - MDIOS output data register 27
        volatile uint32_t MDIOS_DOUTR28;  ///< Offset: 0x10C - MDIOS output data register 28
        volatile uint32_t MDIOS_DOUTR29;  ///< Offset: 0x110 - MDIOS output data register 29
        volatile uint32_t MDIOS_DOUTR30;  ///< Offset: 0x114 - MDIOS output data register 30
        volatile uint32_t MDIOS_DOUTR31;  ///< Offset: 0x118 - MDIOS output data register 31
    };
    ...
    // Bit definitions
    /// MDIOS_CR Register bits
    namespace mdios_cr_bits {
    ...
    /// MDIOS_WRFR Register bits
    namespace mdios_wrfr_bits {
        constexpr uint32_t WRF = (32 << 0);  ///< Write flags for MDIO registers 0 to 31
    }

    /// MDIOS_CWRFR Register bits
    namespace mdios_cwrfr_bits {
        constexpr uint32_t CWRF = (32 << 0);  ///< Clear the write flag
    }

    /// MDIOS_RDFR Register bits
    namespace mdios_rdfr_bits {
        constexpr uint32_t RDF = (32 << 0);  ///< Read flags for MDIO registers 0 to 31
    }

    /// MDIOS_CRDFR Register bits
    namespace mdios_crdfr_bits {
        constexpr uint32_t CRDF = (32 << 0);  ///< Clear the read flag
    }

    /// MDIOS_SR Register bits
    namespace mdios_sr_bits {
    ...
    /// MDIOS_CLRFR Register bits
    namespace mdios_clrfr_bits {
...
namespace jpeg {
    /// Base addresses
    constexpr uint32_t JPEG_BASE = 0x50051000;

    /// JPEG Register structure
    struct Registers {
        volatile uint32_t JPEG_CONFR0;  ///< Offset: 0x00 - JPEG codec configuration register 0
        ...
        volatile uint32_t QMEM0_0;  ///< Offset: 0x50 - JPEG quantization tables
        volatile uint32_t QMEM0_1;  ///< Offset: 0x54 - JPEG quantization tables
        volatile uint32_t QMEM0_2;  ///< Offset: 0x58 - JPEG quantization tables
        volatile uint32_t QMEM0_3;  ///< Offset: 0x5C - JPEG quantization tables
        volatile uint32_t QMEM0_4;  ///< Offset: 0x60 - JPEG quantization tables
        volatile uint32_t QMEM0_5;  ///< Offset: 0x64 - JPEG quantization tables
        volatile uint32_t QMEM0_6;  ///< Offset: 0x68 - JPEG quantization tables
        volatile uint32_t QMEM0_7;  ///< Offset: 0x6C - JPEG quantization tables
        volatile uint32_t QMEM0_8;  ///< Offset: 0x70 - JPEG quantization tables
        volatile uint32_t QMEM0_9;  ///< Offset: 0x74 - JPEG quantization tables
        volatile uint32_t QMEM0_10;  ///< Offset: 0x78 - JPEG quantization tables
        volatile uint32_t QMEM0_11;  ///< Offset: 0x7C - JPEG quantization tables
        volatile uint32_t QMEM0_12;  ///< Offset: 0x80 - JPEG quantization tables
        volatile uint32_t QMEM0_13;  ///< Offset: 0x84 - JPEG quantization tables
        volatile uint32_t QMEM0_14;  ///< Offset: 0x88 - JPEG quantization tables
        volatile uint32_t QMEM0_15;  ///< Offset: 0x8C - JPEG quantization tables
        volatile uint32_t QMEM1_0;  ///< Offset: 0x90 - JPEG quantization tables
        volatile uint32_t QMEM1_1;  ///< Offset: 0x94 - JPEG quantization tables
        volatile uint32_t QMEM1_2;  ///< Offset: 0x98 - JPEG quantization tables
        volatile uint32_t QMEM1_3;  ///< Offset: 0x9C - JPEG quantization tables
        volatile uint32_t QMEM1_4;  ///< Offset: 0xA0 - JPEG quantization tables
        volatile uint32_t QMEM1_5;  ///< Offset: 0xA4 - JPEG quantization tables
        volatile uint32_t QMEM1_6;  ///< Offset: 0xA8 - JPEG quantization tables
        volatile uint32_t QMEM1_7;  ///< Offset: 0xAC - JPEG quantization tables
        volatile uint32_t QMEM1_8;  ///< Offset: 0xB0 - JPEG quantization tables
        volatile uint32_t QMEM1_9;  ///< Offset: 0xB4 - JPEG quantization tables
        volatile uint32_t QMEM1_10;  ///< Offset: 0xB8 - JPEG quantization tables
        volatile uint32_t QMEM1_11;  ///< Offset: 0xBC - JPEG quantization tables
        volatile uint32_t QMEM1_12;  ///< Offset: 0xC0 - JPEG quantization tables
        volatile uint32_t QMEM1_13;  ///< Offset: 0xC4 - JPEG quantization tables
        volatile uint32_t QMEM1_14;  ///< Offset: 0xC8 - JPEG quantization tables
        volatile uint32_t QMEM1_15;  ///< Offset: 0xCC - JPEG quantization tables
        volatile uint32_t QMEM2_0;  ///< Offset: 0xD0 - JPEG quantization tables
        volatile uint32_t QMEM2_1;  ///< Offset: 0xD4 - JPEG quantization tables
        volatile uint32_t QMEM2_2;  ///< Offset: 0xD8 - JPEG quantization tables
        volatile uint32_t QMEM2_3;  ///< Offset: 0xDC - JPEG quantization tables
        volatile uint32_t QMEM2_4;  ///< Offset: 0xE0 - JPEG quantization tables
        volatile uint32_t QMEM2_5;  ///< Offset: 0xE4 - JPEG quantization tables
        volatile uint32_t QMEM2_6;  ///< Offset: 0xE8 - JPEG quantization tables
        volatile uint32_t QMEM2_7;  ///< Offset: 0xEC - JPEG quantization tables
        volatile uint32_t QMEM2_8;  ///< Offset: 0xF0 - JPEG quantization tables
        volatile uint32_t QMEM2_9;  ///< Offset: 0xF4 - JPEG quantization tables
        volatile uint32_t QMEM2_10;  ///< Offset: 0xF8 - JPEG quantization tables
        volatile uint32_t QMEM2_11;  ///< Offset: 0xFC - JPEG quantization tables
        volatile uint32_t QMEM2_12;  ///< Offset: 0x100 - JPEG quantization tables
        volatile uint32_t QMEM2_13;  ///< Offset: 0x104 - JPEG quantization tables
        volatile uint32_t QMEM2_14;  ///< Offset: 0x108 - JPEG quantization tables
        volatile uint32_t QMEM2_15;  ///< Offset: 0x10C - JPEG quantization tables
        volatile uint32_t QMEM3_0;  ///< Offset: 0x110 - JPEG quantization tables
        volatile uint32_t QMEM3_1;  ///< Offset: 0x114 - JPEG quantization tables
        volatile uint32_t QMEM3_2;  ///< Offset: 0x118 - JPEG quantization tables
        volatile uint32_t QMEM3_3;  ///< Offset: 0x11C - JPEG quantization tables
        volatile uint32_t QMEM3_4;  ///< Offset: 0x120 - JPEG quantization tables
        volatile uint32_t QMEM3_5;  ///< Offset: 0x124 - JPEG quantization tables
        volatile uint32_t QMEM3_6;  ///< Offset: 0x128 - JPEG quantization tables
        volatile uint32_t QMEM3_7;  ///< Offset: 0x12C - JPEG quantization tables
        volatile uint32_t QMEM3_8;  ///< Offset: 0x130 - JPEG quantization tables
        volatile uint32_t QMEM3_9;  ///< Offset: 0x134 - JPEG quantization tables
        volatile uint32_t QMEM3_10;  ///< Offset: 0x138 - JPEG quantization tables
        volatile uint32_t QMEM3_11;  ///< Offset: 0x13C - JPEG quantization tables
        volatile uint32_t QMEM3_12;  ///< Offset: 0x140 - JPEG quantization tables
        volatile uint32_t QMEM3_13;  ///< Offset: 0x144 - JPEG quantization tables
        volatile uint32_t QMEM3_14;  ///< Offset: 0x148 - JPEG quantization tables
        volatile uint32_t QMEM3_15;  ///< Offset: 0x14C - JPEG quantization tables
        volatile uint32_t HUFFMIN_0;  ///< Offset: 0x150 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_1;  ///< Offset: 0x154 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_2;  ///< Offset: 0x158 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_3;  ///< Offset: 0x15C - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_4;  ///< Offset: 0x160 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_5;  ///< Offset: 0x164 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_6;  ///< Offset: 0x168 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_7;  ///< Offset: 0x16C - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_8;  ///< Offset: 0x170 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_9;  ///< Offset: 0x174 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_10;  ///< Offset: 0x178 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_11;  ///< Offset: 0x17C - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_12;  ///< Offset: 0x180 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_13;  ///< Offset: 0x184 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_14;  ///< Offset: 0x188 - JPEG HuffMin tables
        volatile uint32_t HUFFMIN_15;  ///< Offset: 0x18C - JPEG HuffMin tables
        volatile uint32_t HUFFBASE0;  ///< Offset: 0x190 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE1;  ///< Offset: 0x194 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE2;  ///< Offset: 0x198 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE3;  ///< Offset: 0x19C - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE4;  ///< Offset: 0x1A0 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE5;  ///< Offset: 0x1A4 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE6;  ///< Offset: 0x1A8 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE7;  ///< Offset: 0x1AC - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE8;  ///< Offset: 0x1B0 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE9;  ///< Offset: 0x1B4 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE10;  ///< Offset: 0x1B8 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE11;  ///< Offset: 0x1BC - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE12;  ///< Offset: 0x1C0 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE13;  ///< Offset: 0x1C4 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE14;  ///< Offset: 0x1C8 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE15;  ///< Offset: 0x1CC - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE16;  ///< Offset: 0x1D0 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE17;  ///< Offset: 0x1D4 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE18;  ///< Offset: 0x1D8 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE19;  ///< Offset: 0x1DC - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE20;  ///< Offset: 0x1E0 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE21;  ///< Offset: 0x1E4 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE22;  ///< Offset: 0x1E8 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE23;  ///< Offset: 0x1EC - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE24;  ///< Offset: 0x1F0 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE25;  ///< Offset: 0x1F4 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE26;  ///< Offset: 0x1F8 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE27;  ///< Offset: 0x1FC - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE28;  ///< Offset: 0x200 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE29;  ///< Offset: 0x204 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE30;  ///< Offset: 0x208 - JPEG HuffSymb tables
        volatile uint32_t HUFFBASE31;  ///< Offset: 0x20C - JPEG HuffSymb tables
        volatile uint32_t HUFFSYMB0;  ///< Offset: 0x210 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB1;  ///< Offset: 0x214 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB2;  ///< Offset: 0x218 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB3;  ///< Offset: 0x21C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB4;  ///< Offset: 0x220 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB5;  ///< Offset: 0x224 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB6;  ///< Offset: 0x228 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB7;  ///< Offset: 0x22C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB8;  ///< Offset: 0x230 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB9;  ///< Offset: 0x234 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB10;  ///< Offset: 0x238 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB11;  ///< Offset: 0x23C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB12;  ///< Offset: 0x240 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB13;  ///< Offset: 0x244 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB14;  ///< Offset: 0x248 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB15;  ///< Offset: 0x24C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB16;  ///< Offset: 0x250 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB17;  ///< Offset: 0x254 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB18;  ///< Offset: 0x258 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB19;  ///< Offset: 0x25C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB20;  ///< Offset: 0x260 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB21;  ///< Offset: 0x264 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB22;  ///< Offset: 0x268 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB23;  ///< Offset: 0x26C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB24;  ///< Offset: 0x270 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB25;  ///< Offset: 0x274 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB26;  ///< Offset: 0x278 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB27;  ///< Offset: 0x27C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB28;  ///< Offset: 0x280 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB29;  ///< Offset: 0x284 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB30;  ///< Offset: 0x288 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB31;  ///< Offset: 0x28C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB32;  ///< Offset: 0x290 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB33;  ///< Offset: 0x294 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB34;  ///< Offset: 0x298 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB35;  ///< Offset: 0x29C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB36;  ///< Offset: 0x2A0 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB37;  ///< Offset: 0x2A4 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB38;  ///< Offset: 0x2A8 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB39;  ///< Offset: 0x2AC - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB40;  ///< Offset: 0x2B0 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB41;  ///< Offset: 0x2B4 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB42;  ///< Offset: 0x2B8 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB43;  ///< Offset: 0x2BC - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB44;  ///< Offset: 0x2C0 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB45;  ///< Offset: 0x2C4 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB46;  ///< Offset: 0x2C8 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB47;  ///< Offset: 0x2CC - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB48;  ///< Offset: 0x2D0 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB49;  ///< Offset: 0x2D4 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB50;  ///< Offset: 0x2D8 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB51;  ///< Offset: 0x2DC - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB52;  ///< Offset: 0x2E0 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB53;  ///< Offset: 0x2E4 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB54;  ///< Offset: 0x2E8 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB55;  ///< Offset: 0x2EC - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB56;  ///< Offset: 0x2F0 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB57;  ///< Offset: 0x2F4 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB58;  ///< Offset: 0x2F8 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB59;  ///< Offset: 0x2FC - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB60;  ///< Offset: 0x300 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB61;  ///< Offset: 0x304 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB62;  ///< Offset: 0x308 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB63;  ///< Offset: 0x30C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB64;  ///< Offset: 0x310 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB65;  ///< Offset: 0x314 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB66;  ///< Offset: 0x318 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB67;  ///< Offset: 0x31C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB68;  ///< Offset: 0x320 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB69;  ///< Offset: 0x324 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB70;  ///< Offset: 0x328 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB71;  ///< Offset: 0x32C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB72;  ///< Offset: 0x330 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB73;  ///< Offset: 0x334 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB74;  ///< Offset: 0x338 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB75;  ///< Offset: 0x33C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB76;  ///< Offset: 0x340 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB77;  ///< Offset: 0x344 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB78;  ///< Offset: 0x348 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB79;  ///< Offset: 0x34C - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB80;  ///< Offset: 0x350 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB81;  ///< Offset: 0x354 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB82;  ///< Offset: 0x358 - JPEG HUFFSYMB tables
        volatile uint32_t HUFFSYMB83;  ///< Offset: 0x35C - JPEG HUFFSYMB tables
        volatile uint32_t DHTMEM0;  ///< Offset: 0x360 - JPEG DHTMem tables
        volatile uint32_t DHTMEM2;  ///< Offset: 0x364 - JPEG DHTMem tables
        volatile uint32_t DHTMEM3;  ///< Offset: 0x368 - JPEG DHTMem tables
        volatile uint32_t DHTMEM4;  ///< Offset: 0x36C - JPEG DHTMem tables
        volatile uint32_t DHTMEM5;  ///< Offset: 0x370 - JPEG DHTMem tables
        volatile uint32_t DHTMEM6;  ///< Offset: 0x374 - JPEG DHTMem tables
        volatile uint32_t DHTMEM7;  ///< Offset: 0x378 - JPEG DHTMem tables
        volatile uint32_t DHTMEM8;  ///< Offset: 0x37C - JPEG DHTMem tables
        volatile uint32_t DHTMEM9;  ///< Offset: 0x380 - JPEG DHTMem tables
        volatile uint32_t DHTMEM10;  ///< Offset: 0x384 - JPEG DHTMem tables
        volatile uint32_t DHTMEM11;  ///< Offset: 0x388 - JPEG DHTMem tables
        volatile uint32_t DHTMEM12;  ///< Offset: 0x38C - JPEG DHTMem tables
        volatile uint32_t DHTMEM13;  ///< Offset: 0x390 - JPEG DHTMem tables
        volatile uint32_t DHTMEM14;  ///< Offset: 0x394 - JPEG DHTMem tables
        volatile uint32_t DHTMEM15;  ///< Offset: 0x398 - JPEG DHTMem tables
        volatile uint32_t DHTMEM16;  ///< Offset: 0x39C - JPEG DHTMem tables
        volatile uint32_t DHTMEM17;  ///< Offset: 0x3A0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM18;  ///< Offset: 0x3A4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM19;  ///< Offset: 0x3A8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM20;  ///< Offset: 0x3AC - JPEG DHTMem tables
        volatile uint32_t DHTMEM21;  ///< Offset: 0x3B0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM22;  ///< Offset: 0x3B4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM23;  ///< Offset: 0x3B8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM24;  ///< Offset: 0x3BC - JPEG DHTMem tables
        volatile uint32_t DHTMEM25;  ///< Offset: 0x3C0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM26;  ///< Offset: 0x3C4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM27;  ///< Offset: 0x3C8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM28;  ///< Offset: 0x3CC - JPEG DHTMem tables
        volatile uint32_t DHTMEM29;  ///< Offset: 0x3D0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM30;  ///< Offset: 0x3D4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM31;  ///< Offset: 0x3D8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM32;  ///< Offset: 0x3DC - JPEG DHTMem tables
        volatile uint32_t DHTMEM33;  ///< Offset: 0x3E0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM34;  ///< Offset: 0x3E4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM35;  ///< Offset: 0x3E8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM36;  ///< Offset: 0x3EC - JPEG DHTMem tables
        volatile uint32_t DHTMEM37;  ///< Offset: 0x3F0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM38;  ///< Offset: 0x3F4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM39;  ///< Offset: 0x3F8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM40;  ///< Offset: 0x3FC - JPEG DHTMem tables
        volatile uint32_t DHTMEM41;  ///< Offset: 0x400 - JPEG DHTMem tables
        volatile uint32_t DHTMEM42;  ///< Offset: 0x404 - JPEG DHTMem tables
        volatile uint32_t DHTMEM43;  ///< Offset: 0x408 - JPEG DHTMem tables
        volatile uint32_t DHTMEM44;  ///< Offset: 0x40C - JPEG DHTMem tables
        volatile uint32_t DHTMEM45;  ///< Offset: 0x410 - JPEG DHTMem tables
        volatile uint32_t DHTMEM46;  ///< Offset: 0x414 - JPEG DHTMem tables
        volatile uint32_t DHTMEM47;  ///< Offset: 0x418 - JPEG DHTMem tables
        volatile uint32_t DHTMEM48;  ///< Offset: 0x41C - JPEG DHTMem tables
        volatile uint32_t DHTMEM49;  ///< Offset: 0x420 - JPEG DHTMem tables
        volatile uint32_t DHTMEM50;  ///< Offset: 0x424 - JPEG DHTMem tables
        volatile uint32_t DHTMEM51;  ///< Offset: 0x428 - JPEG DHTMem tables
        volatile uint32_t DHTMEM52;  ///< Offset: 0x42C - JPEG DHTMem tables
        volatile uint32_t DHTMEM53;  ///< Offset: 0x430 - JPEG DHTMem tables
        volatile uint32_t DHTMEM54;  ///< Offset: 0x434 - JPEG DHTMem tables
        volatile uint32_t DHTMEM55;  ///< Offset: 0x438 - JPEG DHTMem tables
        volatile uint32_t DHTMEM56;  ///< Offset: 0x43C - JPEG DHTMem tables
        volatile uint32_t DHTMEM57;  ///< Offset: 0x440 - JPEG DHTMem tables
        volatile uint32_t DHTMEM58;  ///< Offset: 0x444 - JPEG DHTMem tables
        volatile uint32_t DHTMEM59;  ///< Offset: 0x448 - JPEG DHTMem tables
        volatile uint32_t DHTMEM60;  ///< Offset: 0x44C - JPEG DHTMem tables
        volatile uint32_t DHTMEM61;  ///< Offset: 0x450 - JPEG DHTMem tables
        volatile uint32_t DHTMEM62;  ///< Offset: 0x454 - JPEG DHTMem tables
        volatile uint32_t DHTMEM63;  ///< Offset: 0x458 - JPEG DHTMem tables
        volatile uint32_t DHTMEM64;  ///< Offset: 0x45C - JPEG DHTMem tables
        volatile uint32_t DHTMEM65;  ///< Offset: 0x460 - JPEG DHTMem tables
        volatile uint32_t DHTMEM66;  ///< Offset: 0x464 - JPEG DHTMem tables
        volatile uint32_t DHTMEM67;  ///< Offset: 0x468 - JPEG DHTMem tables
        volatile uint32_t DHTMEM68;  ///< Offset: 0x46C - JPEG DHTMem tables
        volatile uint32_t DHTMEM69;  ///< Offset: 0x470 - JPEG DHTMem tables
        volatile uint32_t DHTMEM70;  ///< Offset: 0x474 - JPEG DHTMem tables
        volatile uint32_t DHTMEM71;  ///< Offset: 0x478 - JPEG DHTMem tables
        volatile uint32_t DHTMEM72;  ///< Offset: 0x47C - JPEG DHTMem tables
        volatile uint32_t DHTMEM73;  ///< Offset: 0x480 - JPEG DHTMem tables
        volatile uint32_t DHTMEM74;  ///< Offset: 0x484 - JPEG DHTMem tables
        volatile uint32_t DHTMEM75;  ///< Offset: 0x488 - JPEG DHTMem tables
        volatile uint32_t DHTMEM76;  ///< Offset: 0x48C - JPEG DHTMem tables
        volatile uint32_t DHTMEM77;  ///< Offset: 0x490 - JPEG DHTMem tables
        volatile uint32_t DHTMEM78;  ///< Offset: 0x494 - JPEG DHTMem tables
        volatile uint32_t DHTMEM79;  ///< Offset: 0x498 - JPEG DHTMem tables
        volatile uint32_t DHTMEM80;  ///< Offset: 0x49C - JPEG DHTMem tables
        volatile uint32_t DHTMEM81;  ///< Offset: 0x4A0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM82;  ///< Offset: 0x4A4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM83;  ///< Offset: 0x4A8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM84;  ///< Offset: 0x4AC - JPEG DHTMem tables
        volatile uint32_t DHTMEM85;  ///< Offset: 0x4B0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM86;  ///< Offset: 0x4B4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM87;  ///< Offset: 0x4B8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM88;  ///< Offset: 0x4BC - JPEG DHTMem tables
        volatile uint32_t DHTMEM89;  ///< Offset: 0x4C0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM90;  ///< Offset: 0x4C4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM91;  ///< Offset: 0x4C8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM92;  ///< Offset: 0x4CC - JPEG DHTMem tables
        volatile uint32_t DHTMEM93;  ///< Offset: 0x4D0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM94;  ///< Offset: 0x4D4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM95;  ///< Offset: 0x4D8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM96;  ///< Offset: 0x4DC - JPEG DHTMem tables
        volatile uint32_t DHTMEM97;  ///< Offset: 0x4E0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM98;  ///< Offset: 0x4E4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM99;  ///< Offset: 0x4E8 - JPEG DHTMem tables
        volatile uint32_t DHTMEM100;  ///< Offset: 0x4EC - JPEG DHTMem tables
        volatile uint32_t DHTMEM101;  ///< Offset: 0x4F0 - JPEG DHTMem tables
        volatile uint32_t DHTMEM102;  ///< Offset: 0x4F4 - JPEG DHTMem tables
        volatile uint32_t DHTMEM103;  ///< Offset: 0x4F8 - JPEG DHTMem tables
        volatile uint32_t HUFFENC_AC0_0;  ///< Offset: 0x500 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_1;  ///< Offset: 0x504 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_2;  ///< Offset: 0x508 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_3;  ///< Offset: 0x50C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_4;  ///< Offset: 0x510 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_5;  ///< Offset: 0x514 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_6;  ///< Offset: 0x518 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_7;  ///< Offset: 0x51C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_8;  ///< Offset: 0x520 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_9;  ///< Offset: 0x524 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_10;  ///< Offset: 0x528 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_11;  ///< Offset: 0x52C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_12;  ///< Offset: 0x530 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_13;  ///< Offset: 0x534 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_14;  ///< Offset: 0x538 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_15;  ///< Offset: 0x53C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_16;  ///< Offset: 0x540 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_17;  ///< Offset: 0x544 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_18;  ///< Offset: 0x548 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_19;  ///< Offset: 0x54C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_20;  ///< Offset: 0x550 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_21;  ///< Offset: 0x554 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_22;  ///< Offset: 0x558 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_23;  ///< Offset: 0x55C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_24;  ///< Offset: 0x560 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_25;  ///< Offset: 0x564 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_26;  ///< Offset: 0x568 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_27;  ///< Offset: 0x56C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_28;  ///< Offset: 0x570 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_29;  ///< Offset: 0x574 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_30;  ///< Offset: 0x578 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_31;  ///< Offset: 0x57C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_32;  ///< Offset: 0x580 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_33;  ///< Offset: 0x584 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_34;  ///< Offset: 0x588 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_35;  ///< Offset: 0x58C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_36;  ///< Offset: 0x590 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_37;  ///< Offset: 0x594 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_38;  ///< Offset: 0x598 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_39;  ///< Offset: 0x59C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_40;  ///< Offset: 0x5A0 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_41;  ///< Offset: 0x5A4 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_42;  ///< Offset: 0x5A8 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_43;  ///< Offset: 0x5AC - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_44;  ///< Offset: 0x5B0 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_45;  ///< Offset: 0x5B4 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_46;  ///< Offset: 0x5B8 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_47;  ///< Offset: 0x5BC - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_48;  ///< Offset: 0x5C0 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_49;  ///< Offset: 0x5C4 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_50;  ///< Offset: 0x5C8 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_51;  ///< Offset: 0x5CC - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_52;  ///< Offset: 0x5D0 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_53;  ///< Offset: 0x5D4 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_54;  ///< Offset: 0x5D8 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_55;  ///< Offset: 0x5DC - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_56;  ///< Offset: 0x5E0 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_57;  ///< Offset: 0x5E4 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_58;  ///< Offset: 0x5E8 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_59;  ///< Offset: 0x5EC - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_60;  ///< Offset: 0x5F0 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_61;  ///< Offset: 0x5F4 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_62;  ///< Offset: 0x5F8 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_63;  ///< Offset: 0x5FC - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_64;  ///< Offset: 0x600 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_65;  ///< Offset: 0x604 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_66;  ///< Offset: 0x608 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_67;  ///< Offset: 0x60C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_68;  ///< Offset: 0x610 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_69;  ///< Offset: 0x614 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_70;  ///< Offset: 0x618 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_71;  ///< Offset: 0x61C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_72;  ///< Offset: 0x620 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_73;  ///< Offset: 0x624 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_74;  ///< Offset: 0x628 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_75;  ///< Offset: 0x62C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_76;  ///< Offset: 0x630 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_77;  ///< Offset: 0x634 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_78;  ///< Offset: 0x638 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_79;  ///< Offset: 0x63C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_80;  ///< Offset: 0x640 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_81;  ///< Offset: 0x644 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_82;  ///< Offset: 0x648 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_83;  ///< Offset: 0x64C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_84;  ///< Offset: 0x650 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_85;  ///< Offset: 0x654 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_86;  ///< Offset: 0x658 - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC0_87;  ///< Offset: 0x65C - JPEG encoder, AC Huffman table 0
        volatile uint32_t HUFFENC_AC1_0;  ///< Offset: 0x660 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_1;  ///< Offset: 0x664 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_2;  ///< Offset: 0x668 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_3;  ///< Offset: 0x66C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_4;  ///< Offset: 0x670 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_5;  ///< Offset: 0x674 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_6;  ///< Offset: 0x678 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_7;  ///< Offset: 0x67C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_8;  ///< Offset: 0x680 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_9;  ///< Offset: 0x684 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_10;  ///< Offset: 0x688 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_11;  ///< Offset: 0x68C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_12;  ///< Offset: 0x690 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_13;  ///< Offset: 0x694 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_14;  ///< Offset: 0x698 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_15;  ///< Offset: 0x69C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_16;  ///< Offset: 0x6A0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_17;  ///< Offset: 0x6A4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_18;  ///< Offset: 0x6A8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_19;  ///< Offset: 0x6AC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_20;  ///< Offset: 0x6B0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_21;  ///< Offset: 0x6B4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_22;  ///< Offset: 0x6B8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_23;  ///< Offset: 0x6BC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_24;  ///< Offset: 0x6C0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_25;  ///< Offset: 0x6C4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_26;  ///< Offset: 0x6C8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_27;  ///< Offset: 0x6CC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_28;  ///< Offset: 0x6D0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_29;  ///< Offset: 0x6D4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_30;  ///< Offset: 0x6D8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_31;  ///< Offset: 0x6DC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_32;  ///< Offset: 0x6E0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_33;  ///< Offset: 0x6E4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_34;  ///< Offset: 0x6E8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_35;  ///< Offset: 0x6EC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_36;  ///< Offset: 0x6F0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_37;  ///< Offset: 0x6F4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_38;  ///< Offset: 0x6F8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_39;  ///< Offset: 0x6FC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_40;  ///< Offset: 0x700 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_41;  ///< Offset: 0x704 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_42;  ///< Offset: 0x708 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_43;  ///< Offset: 0x70C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_44;  ///< Offset: 0x710 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_45;  ///< Offset: 0x714 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_46;  ///< Offset: 0x718 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_47;  ///< Offset: 0x71C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_48;  ///< Offset: 0x720 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_49;  ///< Offset: 0x724 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_50;  ///< Offset: 0x728 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_51;  ///< Offset: 0x72C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_52;  ///< Offset: 0x730 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_53;  ///< Offset: 0x734 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_54;  ///< Offset: 0x738 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_55;  ///< Offset: 0x73C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_56;  ///< Offset: 0x740 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_57;  ///< Offset: 0x744 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_58;  ///< Offset: 0x748 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_59;  ///< Offset: 0x74C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_60;  ///< Offset: 0x750 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_61;  ///< Offset: 0x754 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_62;  ///< Offset: 0x758 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_63;  ///< Offset: 0x75C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_64;  ///< Offset: 0x760 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_65;  ///< Offset: 0x764 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_66;  ///< Offset: 0x768 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_67;  ///< Offset: 0x76C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_68;  ///< Offset: 0x770 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_69;  ///< Offset: 0x774 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_70;  ///< Offset: 0x778 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_71;  ///< Offset: 0x77C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_72;  ///< Offset: 0x780 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_73;  ///< Offset: 0x784 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_74;  ///< Offset: 0x788 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_75;  ///< Offset: 0x78C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_76;  ///< Offset: 0x790 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_77;  ///< Offset: 0x794 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_78;  ///< Offset: 0x798 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_79;  ///< Offset: 0x79C - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_80;  ///< Offset: 0x7A0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_81;  ///< Offset: 0x7A4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_82;  ///< Offset: 0x7A8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_83;  ///< Offset: 0x7AC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_84;  ///< Offset: 0x7B0 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_85;  ///< Offset: 0x7B4 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_86;  ///< Offset: 0x7B8 - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_AC1_87;  ///< Offset: 0x7BC - JPEG encoder, AC Huffman table 1
        volatile uint32_t HUFFENC_DC0_0;  ///< Offset: 0x7C0 - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_1;  ///< Offset: 0x7C4 - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_2;  ///< Offset: 0x7C8 - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_3;  ///< Offset: 0x7CC - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_4;  ///< Offset: 0x7D0 - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_5;  ///< Offset: 0x7D4 - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_6;  ///< Offset: 0x7D8 - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC0_7;  ///< Offset: 0x7DC - JPEG encoder, DC Huffman table 0
        volatile uint32_t HUFFENC_DC1_0;  ///< Offset: 0x7E0 - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_1;  ///< Offset: 0x7E4 - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_2;  ///< Offset: 0x7E8 - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_3;  ///< Offset: 0x7EC - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_4;  ///< Offset: 0x7F0 - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_5;  ///< Offset: 0x7F4 - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_6;  ///< Offset: 0x7F8 - JPEG encoder, DC Huffman table 1
        volatile uint32_t HUFFENC_DC1_7;  ///< Offset: 0x7FC - JPEG encoder, DC Huffman table 1
    };
    ...
    namespace jpeg_confr1_bits {
        constexpr uint32_t NF = (2 << 0);  ///< Number of color components
        constexpr uint32_t DE = (1U << 3);  ///< Decoding Enable
        constexpr uint32_t COLORSPACE = (2 << 4);  ///< Color Space
        constexpr uint32_t NS = (2 << 6);  ///< Number of components for Scan
        constexpr uint32_t HDR = (1U << 8);  ///< Header Processing
        constexpr uint32_t YSIZE = (16 << 16);  ///< Y Size
    }

    /// JPEG_CONFR2 Register bits
    namespace jpeg_confr2_bits {
        constexpr uint32_t NMCU = (26 << 0);  ///< Number of MCU
    }

    /// JPEG_CONFR3 Register bits
    namespace jpeg_confr3_bits {
        constexpr uint32_t XSIZE = (16 << 16);  ///< X size
    }

    /// JPEG_CONFR4 Register bits
    namespace jpeg_confr4_bits {
        constexpr uint32_t HD = (1U << 0);  ///< Huffman DC
        constexpr uint32_t HA = (1U << 1);  ///< Huffman AC
        constexpr uint32_t QT = (2 << 2);  ///< Quantization Table
        constexpr uint32_t NB = (4 << 4);  ///< Number of Block
        constexpr uint32_t VSF = (4 << 8);  ///< Vertical Sampling Factor
        constexpr uint32_t HSF = (4 << 12);  ///< Horizontal Sampling Factor
    }
    ...
    namespace jpeg_cr_bits {
        constexpr uint32_t JCEN = (1U << 0);  ///< JPEG Core Enable
        constexpr uint32_t IFTIE = (1U << 1);  ///< Input FIFO Threshold Interrupt Enable
        constexpr uint32_t IFNFIE = (1U << 2);  ///< Input FIFO Not Full Interrupt Enable
        constexpr uint32_t OFTIE = (1U << 3);  ///< Output FIFO Threshold Interrupt Enable
        constexpr uint32_t OFNEIE = (1U << 4);  ///< Output FIFO Not Empty Interrupt Enable
        constexpr uint32_t EOCIE = (1U << 5);  ///< End of Conversion Interrupt Enable
        constexpr uint32_t HPDIE = (1U << 6);  ///< Header Parsing Done Interrupt Enable
        constexpr uint32_t IDMAEN = (1U << 11);  ///< Input DMA Enable
        constexpr uint32_t ODMAEN = (1U << 12);  ///< Output DMA Enable
        constexpr uint32_t IFF = (1U << 13);  ///< Input FIFO Flush
        constexpr uint32_t OFF = (1U << 14);  ///< Output FIFO Flush
    }

    /// JPEG_SR Register bits
    namespace jpeg_sr_bits {
        constexpr uint32_t IFTF = (1U << 1);  ///< Input FIFO Threshold Flag
        constexpr uint32_t IFNFF = (1U << 2);  ///< Input FIFO Not Full Flag
        constexpr uint32_t OFTF = (1U << 3);  ///< Output FIFO Threshold Flag
        constexpr uint32_t OFNEF = (1U << 4);  ///< Output FIFO Not Empty Flag
        constexpr uint32_t EOCF = (1U << 5);  ///< End of Conversion Flag
        constexpr uint32_t HPDF = (1U << 6);  ///< Header Parsing Done Flag
        constexpr uint32_t COF = (1U << 7);  ///< Codec Operation Flag
    }

    /// JPEG_CFR Register bits
    namespace jpeg_cfr_bits {
        constexpr uint32_t CEOCF = (1U << 5);  ///< Clear End of Conversion Flag
        constexpr uint32_t CHPDF = (1U << 6);  ///< Clear Header Parsing Done Flag
    }

    /// JPEG_DIR Register bits
    namespace jpeg_dir_bits {
        constexpr uint32_t DATAIN = (32 << 0);  ///< Data Input FIFO
    }

    /// JPEG_DOR Register bits
    namespace jpeg_dor_bits {
        constexpr uint32_t DATAOUT = (32 << 0);  ///< Data Output FIFO
    }

    /// QMEM0_0 Register bits
    namespace qmem0_0_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_1 Register bits
    namespace qmem0_1_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_2 Register bits
    namespace qmem0_2_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_3 Register bits
    namespace qmem0_3_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_4 Register bits
    namespace qmem0_4_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_5 Register bits
    namespace qmem0_5_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_6 Register bits
    namespace qmem0_6_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_7 Register bits
    namespace qmem0_7_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_8 Register bits
    namespace qmem0_8_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_9 Register bits
    namespace qmem0_9_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_10 Register bits
    namespace qmem0_10_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_11 Register bits
    namespace qmem0_11_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_12 Register bits
    namespace qmem0_12_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_13 Register bits
    namespace qmem0_13_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_14 Register bits
    namespace qmem0_14_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM0_15 Register bits
    namespace qmem0_15_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_0 Register bits
    namespace qmem1_0_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_1 Register bits
    namespace qmem1_1_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_2 Register bits
    namespace qmem1_2_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_3 Register bits
    namespace qmem1_3_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_4 Register bits
    namespace qmem1_4_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_5 Register bits
    namespace qmem1_5_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_6 Register bits
    namespace qmem1_6_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_7 Register bits
    namespace qmem1_7_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_8 Register bits
    namespace qmem1_8_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_9 Register bits
    namespace qmem1_9_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_10 Register bits
    namespace qmem1_10_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_11 Register bits
    namespace qmem1_11_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_12 Register bits
    namespace qmem1_12_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_13 Register bits
    namespace qmem1_13_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_14 Register bits
    namespace qmem1_14_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM1_15 Register bits
    namespace qmem1_15_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_0 Register bits
    namespace qmem2_0_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_1 Register bits
    namespace qmem2_1_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_2 Register bits
    namespace qmem2_2_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_3 Register bits
    namespace qmem2_3_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_4 Register bits
    namespace qmem2_4_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_5 Register bits
    namespace qmem2_5_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_6 Register bits
    namespace qmem2_6_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_7 Register bits
    namespace qmem2_7_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_8 Register bits
    namespace qmem2_8_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_9 Register bits
    namespace qmem2_9_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_10 Register bits
    namespace qmem2_10_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_11 Register bits
    namespace qmem2_11_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_12 Register bits
    namespace qmem2_12_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_13 Register bits
    namespace qmem2_13_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_14 Register bits
    namespace qmem2_14_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM2_15 Register bits
    namespace qmem2_15_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_0 Register bits
    namespace qmem3_0_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_1 Register bits
    namespace qmem3_1_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_2 Register bits
    namespace qmem3_2_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_3 Register bits
    namespace qmem3_3_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_4 Register bits
    namespace qmem3_4_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_5 Register bits
    namespace qmem3_5_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_6 Register bits
    namespace qmem3_6_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_7 Register bits
    namespace qmem3_7_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_8 Register bits
    namespace qmem3_8_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_9 Register bits
    namespace qmem3_9_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_10 Register bits
    namespace qmem3_10_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_11 Register bits
    namespace qmem3_11_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_12 Register bits
    namespace qmem3_12_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_13 Register bits
    namespace qmem3_13_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_14 Register bits
    namespace qmem3_14_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// QMEM3_15 Register bits
    namespace qmem3_15_bits {
        constexpr uint32_t QMem_RAM = (32 << 0);  ///< QMem RAM
    }

    /// HUFFMIN_0 Register bits
    namespace huffmin_0_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_1 Register bits
    namespace huffmin_1_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_2 Register bits
    namespace huffmin_2_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_3 Register bits
    namespace huffmin_3_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_4 Register bits
    namespace huffmin_4_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_5 Register bits
    namespace huffmin_5_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_6 Register bits
    namespace huffmin_6_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_7 Register bits
    namespace huffmin_7_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_8 Register bits
    namespace huffmin_8_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_9 Register bits
    namespace huffmin_9_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_10 Register bits
    namespace huffmin_10_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_11 Register bits
    namespace huffmin_11_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_12 Register bits
    namespace huffmin_12_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_13 Register bits
    namespace huffmin_13_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_14 Register bits
    namespace huffmin_14_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFMIN_15 Register bits
    namespace huffmin_15_bits {
        constexpr uint32_t HuffMin_RAM = (32 << 0);  ///< HuffMin RAM
    }

    /// HUFFBASE0 Register bits
    namespace huffbase0_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE1 Register bits
    namespace huffbase1_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE2 Register bits
    namespace huffbase2_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE3 Register bits
    namespace huffbase3_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE4 Register bits
    namespace huffbase4_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE5 Register bits
    namespace huffbase5_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE6 Register bits
    namespace huffbase6_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE7 Register bits
    namespace huffbase7_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE8 Register bits
    namespace huffbase8_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE9 Register bits
    namespace huffbase9_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE10 Register bits
    namespace huffbase10_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE11 Register bits
    namespace huffbase11_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE12 Register bits
    namespace huffbase12_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE13 Register bits
    namespace huffbase13_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE14 Register bits
    namespace huffbase14_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE15 Register bits
    namespace huffbase15_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE16 Register bits
    namespace huffbase16_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE17 Register bits
    namespace huffbase17_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE18 Register bits
    namespace huffbase18_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE19 Register bits
    namespace huffbase19_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE20 Register bits
    namespace huffbase20_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE21 Register bits
    namespace huffbase21_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE22 Register bits
    namespace huffbase22_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE23 Register bits
    namespace huffbase23_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE24 Register bits
    namespace huffbase24_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE25 Register bits
    namespace huffbase25_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE26 Register bits
    namespace huffbase26_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE27 Register bits
    namespace huffbase27_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE28 Register bits
    namespace huffbase28_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE29 Register bits
    namespace huffbase29_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE30 Register bits
    namespace huffbase30_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFBASE31 Register bits
    namespace huffbase31_bits {
        constexpr uint32_t HuffBase_RAM_0 = (9 << 0);  ///< HuffBase RAM
        constexpr uint32_t HuffBase_RAM_1 = (9 << 16);  ///< HuffBase RAM
    }

    /// HUFFSYMB0 Register bits
    namespace huffsymb0_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB1 Register bits
    namespace huffsymb1_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB2 Register bits
    namespace huffsymb2_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB3 Register bits
    namespace huffsymb3_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB4 Register bits
    namespace huffsymb4_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB5 Register bits
    namespace huffsymb5_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB6 Register bits
    namespace huffsymb6_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB7 Register bits
    namespace huffsymb7_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB8 Register bits
    namespace huffsymb8_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB9 Register bits
    namespace huffsymb9_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB10 Register bits
    namespace huffsymb10_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB11 Register bits
    namespace huffsymb11_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB12 Register bits
    namespace huffsymb12_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB13 Register bits
    namespace huffsymb13_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB14 Register bits
    namespace huffsymb14_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB15 Register bits
    namespace huffsymb15_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB16 Register bits
    namespace huffsymb16_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB17 Register bits
    namespace huffsymb17_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB18 Register bits
    namespace huffsymb18_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB19 Register bits
    namespace huffsymb19_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB20 Register bits
    namespace huffsymb20_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB21 Register bits
    namespace huffsymb21_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB22 Register bits
    namespace huffsymb22_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB23 Register bits
    namespace huffsymb23_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB24 Register bits
    namespace huffsymb24_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB25 Register bits
    namespace huffsymb25_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB26 Register bits
    namespace huffsymb26_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB27 Register bits
    namespace huffsymb27_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB28 Register bits
    namespace huffsymb28_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB29 Register bits
    namespace huffsymb29_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB30 Register bits
    namespace huffsymb30_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB31 Register bits
    namespace huffsymb31_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB32 Register bits
    namespace huffsymb32_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB33 Register bits
    namespace huffsymb33_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB34 Register bits
    namespace huffsymb34_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB35 Register bits
    namespace huffsymb35_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB36 Register bits
    namespace huffsymb36_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB37 Register bits
    namespace huffsymb37_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB38 Register bits
    namespace huffsymb38_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB39 Register bits
    namespace huffsymb39_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB40 Register bits
    namespace huffsymb40_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB41 Register bits
    namespace huffsymb41_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB42 Register bits
    namespace huffsymb42_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB43 Register bits
    namespace huffsymb43_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB44 Register bits
    namespace huffsymb44_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB45 Register bits
    namespace huffsymb45_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB46 Register bits
    namespace huffsymb46_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB47 Register bits
    namespace huffsymb47_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB48 Register bits
    namespace huffsymb48_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB49 Register bits
    namespace huffsymb49_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB50 Register bits
    namespace huffsymb50_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB51 Register bits
    namespace huffsymb51_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB52 Register bits
    namespace huffsymb52_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB53 Register bits
    namespace huffsymb53_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB54 Register bits
    namespace huffsymb54_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB55 Register bits
    namespace huffsymb55_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB56 Register bits
    namespace huffsymb56_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB57 Register bits
    namespace huffsymb57_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB58 Register bits
    namespace huffsymb58_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB59 Register bits
    namespace huffsymb59_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB60 Register bits
    namespace huffsymb60_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB61 Register bits
    namespace huffsymb61_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB62 Register bits
    namespace huffsymb62_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB63 Register bits
    namespace huffsymb63_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB64 Register bits
    namespace huffsymb64_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB65 Register bits
    namespace huffsymb65_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB66 Register bits
    namespace huffsymb66_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB67 Register bits
    namespace huffsymb67_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB68 Register bits
    namespace huffsymb68_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB69 Register bits
    namespace huffsymb69_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB70 Register bits
    namespace huffsymb70_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB71 Register bits
    namespace huffsymb71_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB72 Register bits
    namespace huffsymb72_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB73 Register bits
    namespace huffsymb73_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB74 Register bits
    namespace huffsymb74_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB75 Register bits
    namespace huffsymb75_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB76 Register bits
    namespace huffsymb76_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB77 Register bits
    namespace huffsymb77_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB78 Register bits
    namespace huffsymb78_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB79 Register bits
    namespace huffsymb79_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB80 Register bits
    namespace huffsymb80_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB81 Register bits
    namespace huffsymb81_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB82 Register bits
    namespace huffsymb82_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// HUFFSYMB83 Register bits
    namespace huffsymb83_bits {
        constexpr uint32_t HuffSymb_RAM = (32 << 0);  ///< DHTSymb RAM
    }

    /// DHTMEM0 Register bits
    namespace dhtmem0_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM2 Register bits
    namespace dhtmem2_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM3 Register bits
    namespace dhtmem3_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM4 Register bits
    namespace dhtmem4_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM5 Register bits
    namespace dhtmem5_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM6 Register bits
    namespace dhtmem6_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM7 Register bits
    namespace dhtmem7_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM8 Register bits
    namespace dhtmem8_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM9 Register bits
    namespace dhtmem9_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM10 Register bits
    namespace dhtmem10_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM11 Register bits
    namespace dhtmem11_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM12 Register bits
    namespace dhtmem12_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM13 Register bits
    namespace dhtmem13_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM14 Register bits
    namespace dhtmem14_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM15 Register bits
    namespace dhtmem15_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM16 Register bits
    namespace dhtmem16_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM17 Register bits
    namespace dhtmem17_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM18 Register bits
    namespace dhtmem18_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM19 Register bits
    namespace dhtmem19_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM20 Register bits
    namespace dhtmem20_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM21 Register bits
    namespace dhtmem21_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM22 Register bits
    namespace dhtmem22_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM23 Register bits
    namespace dhtmem23_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM24 Register bits
    namespace dhtmem24_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM25 Register bits
    namespace dhtmem25_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM26 Register bits
    namespace dhtmem26_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM27 Register bits
    namespace dhtmem27_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM28 Register bits
    namespace dhtmem28_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM29 Register bits
    namespace dhtmem29_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM30 Register bits
    namespace dhtmem30_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM31 Register bits
    namespace dhtmem31_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM32 Register bits
    namespace dhtmem32_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM33 Register bits
    namespace dhtmem33_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM34 Register bits
    namespace dhtmem34_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM35 Register bits
    namespace dhtmem35_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM36 Register bits
    namespace dhtmem36_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM37 Register bits
    namespace dhtmem37_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM38 Register bits
    namespace dhtmem38_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM39 Register bits
    namespace dhtmem39_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM40 Register bits
    namespace dhtmem40_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM41 Register bits
    namespace dhtmem41_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM42 Register bits
    namespace dhtmem42_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM43 Register bits
    namespace dhtmem43_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM44 Register bits
    namespace dhtmem44_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM45 Register bits
    namespace dhtmem45_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM46 Register bits
    namespace dhtmem46_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM47 Register bits
    namespace dhtmem47_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM48 Register bits
    namespace dhtmem48_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM49 Register bits
    namespace dhtmem49_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM50 Register bits
    namespace dhtmem50_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM51 Register bits
    namespace dhtmem51_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM52 Register bits
    namespace dhtmem52_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM53 Register bits
    namespace dhtmem53_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM54 Register bits
    namespace dhtmem54_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM55 Register bits
    namespace dhtmem55_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM56 Register bits
    namespace dhtmem56_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM57 Register bits
    namespace dhtmem57_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM58 Register bits
    namespace dhtmem58_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM59 Register bits
    namespace dhtmem59_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM60 Register bits
    namespace dhtmem60_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM61 Register bits
    namespace dhtmem61_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM62 Register bits
    namespace dhtmem62_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM63 Register bits
    namespace dhtmem63_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM64 Register bits
    namespace dhtmem64_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM65 Register bits
    namespace dhtmem65_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM66 Register bits
    namespace dhtmem66_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM67 Register bits
    namespace dhtmem67_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM68 Register bits
    namespace dhtmem68_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM69 Register bits
    namespace dhtmem69_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM70 Register bits
    namespace dhtmem70_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM71 Register bits
    namespace dhtmem71_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM72 Register bits
    namespace dhtmem72_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM73 Register bits
    namespace dhtmem73_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM74 Register bits
    namespace dhtmem74_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM75 Register bits
    namespace dhtmem75_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM76 Register bits
    namespace dhtmem76_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM77 Register bits
    namespace dhtmem77_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM78 Register bits
    namespace dhtmem78_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM79 Register bits
    namespace dhtmem79_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM80 Register bits
    namespace dhtmem80_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM81 Register bits
    namespace dhtmem81_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM82 Register bits
    namespace dhtmem82_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM83 Register bits
    namespace dhtmem83_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM84 Register bits
    namespace dhtmem84_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM85 Register bits
    namespace dhtmem85_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM86 Register bits
    namespace dhtmem86_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM87 Register bits
    namespace dhtmem87_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM88 Register bits
    namespace dhtmem88_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM89 Register bits
    namespace dhtmem89_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM90 Register bits
    namespace dhtmem90_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM91 Register bits
    namespace dhtmem91_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM92 Register bits
    namespace dhtmem92_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM93 Register bits
    namespace dhtmem93_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM94 Register bits
    namespace dhtmem94_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM95 Register bits
    namespace dhtmem95_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM96 Register bits
    namespace dhtmem96_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM97 Register bits
    namespace dhtmem97_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM98 Register bits
    namespace dhtmem98_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM99 Register bits
    namespace dhtmem99_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM100 Register bits
    namespace dhtmem100_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM101 Register bits
    namespace dhtmem101_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM102 Register bits
    namespace dhtmem102_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// DHTMEM103 Register bits
    namespace dhtmem103_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_0 Register bits
    namespace huffenc_ac0_0_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_1 Register bits
    namespace huffenc_ac0_1_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_2 Register bits
    namespace huffenc_ac0_2_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_3 Register bits
    namespace huffenc_ac0_3_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_4 Register bits
    namespace huffenc_ac0_4_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_5 Register bits
    namespace huffenc_ac0_5_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_6 Register bits
    namespace huffenc_ac0_6_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_7 Register bits
    namespace huffenc_ac0_7_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_8 Register bits
    namespace huffenc_ac0_8_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_9 Register bits
    namespace huffenc_ac0_9_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_10 Register bits
    namespace huffenc_ac0_10_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_11 Register bits
    namespace huffenc_ac0_11_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_12 Register bits
    namespace huffenc_ac0_12_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_13 Register bits
    namespace huffenc_ac0_13_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_14 Register bits
    namespace huffenc_ac0_14_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_15 Register bits
    namespace huffenc_ac0_15_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_16 Register bits
    namespace huffenc_ac0_16_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_17 Register bits
    namespace huffenc_ac0_17_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_18 Register bits
    namespace huffenc_ac0_18_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_19 Register bits
    namespace huffenc_ac0_19_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_20 Register bits
    namespace huffenc_ac0_20_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_21 Register bits
    namespace huffenc_ac0_21_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_22 Register bits
    namespace huffenc_ac0_22_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_23 Register bits
    namespace huffenc_ac0_23_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_24 Register bits
    namespace huffenc_ac0_24_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_25 Register bits
    namespace huffenc_ac0_25_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_26 Register bits
    namespace huffenc_ac0_26_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_27 Register bits
    namespace huffenc_ac0_27_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_28 Register bits
    namespace huffenc_ac0_28_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_29 Register bits
    namespace huffenc_ac0_29_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_30 Register bits
    namespace huffenc_ac0_30_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_31 Register bits
    namespace huffenc_ac0_31_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_32 Register bits
    namespace huffenc_ac0_32_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_33 Register bits
    namespace huffenc_ac0_33_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_34 Register bits
    namespace huffenc_ac0_34_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_35 Register bits
    namespace huffenc_ac0_35_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_36 Register bits
    namespace huffenc_ac0_36_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_37 Register bits
    namespace huffenc_ac0_37_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_38 Register bits
    namespace huffenc_ac0_38_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_39 Register bits
    namespace huffenc_ac0_39_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_40 Register bits
    namespace huffenc_ac0_40_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_41 Register bits
    namespace huffenc_ac0_41_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_42 Register bits
    namespace huffenc_ac0_42_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_43 Register bits
    namespace huffenc_ac0_43_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_44 Register bits
    namespace huffenc_ac0_44_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_45 Register bits
    namespace huffenc_ac0_45_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_46 Register bits
    namespace huffenc_ac0_46_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_47 Register bits
    namespace huffenc_ac0_47_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_48 Register bits
    namespace huffenc_ac0_48_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_49 Register bits
    namespace huffenc_ac0_49_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_50 Register bits
    namespace huffenc_ac0_50_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_51 Register bits
    namespace huffenc_ac0_51_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_52 Register bits
    namespace huffenc_ac0_52_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_53 Register bits
    namespace huffenc_ac0_53_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_54 Register bits
    namespace huffenc_ac0_54_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_55 Register bits
    namespace huffenc_ac0_55_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_56 Register bits
    namespace huffenc_ac0_56_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_57 Register bits
    namespace huffenc_ac0_57_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_58 Register bits
    namespace huffenc_ac0_58_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_59 Register bits
    namespace huffenc_ac0_59_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_60 Register bits
    namespace huffenc_ac0_60_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_61 Register bits
    namespace huffenc_ac0_61_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_62 Register bits
    namespace huffenc_ac0_62_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_63 Register bits
    namespace huffenc_ac0_63_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_64 Register bits
    namespace huffenc_ac0_64_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_65 Register bits
    namespace huffenc_ac0_65_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_66 Register bits
    namespace huffenc_ac0_66_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_67 Register bits
    namespace huffenc_ac0_67_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_68 Register bits
    namespace huffenc_ac0_68_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_69 Register bits
    namespace huffenc_ac0_69_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_70 Register bits
    namespace huffenc_ac0_70_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_71 Register bits
    namespace huffenc_ac0_71_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_72 Register bits
    namespace huffenc_ac0_72_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_73 Register bits
    namespace huffenc_ac0_73_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_74 Register bits
    namespace huffenc_ac0_74_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_75 Register bits
    namespace huffenc_ac0_75_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_76 Register bits
    namespace huffenc_ac0_76_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_77 Register bits
    namespace huffenc_ac0_77_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_78 Register bits
    namespace huffenc_ac0_78_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_79 Register bits
    namespace huffenc_ac0_79_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_80 Register bits
    namespace huffenc_ac0_80_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_81 Register bits
    namespace huffenc_ac0_81_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_82 Register bits
    namespace huffenc_ac0_82_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_83 Register bits
    namespace huffenc_ac0_83_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_84 Register bits
    namespace huffenc_ac0_84_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_85 Register bits
    namespace huffenc_ac0_85_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_86 Register bits
    namespace huffenc_ac0_86_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC0_87 Register bits
    namespace huffenc_ac0_87_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_0 Register bits
    namespace huffenc_ac1_0_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_1 Register bits
    namespace huffenc_ac1_1_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_2 Register bits
    namespace huffenc_ac1_2_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_3 Register bits
    namespace huffenc_ac1_3_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_4 Register bits
    namespace huffenc_ac1_4_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_5 Register bits
    namespace huffenc_ac1_5_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_6 Register bits
    namespace huffenc_ac1_6_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_7 Register bits
    namespace huffenc_ac1_7_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_8 Register bits
    namespace huffenc_ac1_8_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_9 Register bits
    namespace huffenc_ac1_9_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_10 Register bits
    namespace huffenc_ac1_10_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_11 Register bits
    namespace huffenc_ac1_11_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_12 Register bits
    namespace huffenc_ac1_12_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_13 Register bits
    namespace huffenc_ac1_13_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_14 Register bits
    namespace huffenc_ac1_14_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_15 Register bits
    namespace huffenc_ac1_15_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_16 Register bits
    namespace huffenc_ac1_16_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_17 Register bits
    namespace huffenc_ac1_17_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_18 Register bits
    namespace huffenc_ac1_18_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_19 Register bits
    namespace huffenc_ac1_19_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_20 Register bits
    namespace huffenc_ac1_20_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_21 Register bits
    namespace huffenc_ac1_21_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_22 Register bits
    namespace huffenc_ac1_22_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_23 Register bits
    namespace huffenc_ac1_23_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_24 Register bits
    namespace huffenc_ac1_24_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_25 Register bits
    namespace huffenc_ac1_25_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_26 Register bits
    namespace huffenc_ac1_26_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_27 Register bits
    namespace huffenc_ac1_27_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_28 Register bits
    namespace huffenc_ac1_28_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_29 Register bits
    namespace huffenc_ac1_29_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_30 Register bits
    namespace huffenc_ac1_30_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_31 Register bits
    namespace huffenc_ac1_31_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_32 Register bits
    namespace huffenc_ac1_32_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_33 Register bits
    namespace huffenc_ac1_33_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_34 Register bits
    namespace huffenc_ac1_34_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_35 Register bits
    namespace huffenc_ac1_35_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_36 Register bits
    namespace huffenc_ac1_36_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_37 Register bits
    namespace huffenc_ac1_37_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_38 Register bits
    namespace huffenc_ac1_38_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_39 Register bits
    namespace huffenc_ac1_39_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_40 Register bits
    namespace huffenc_ac1_40_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_41 Register bits
    namespace huffenc_ac1_41_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_42 Register bits
    namespace huffenc_ac1_42_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_43 Register bits
    namespace huffenc_ac1_43_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_44 Register bits
    namespace huffenc_ac1_44_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_45 Register bits
    namespace huffenc_ac1_45_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_46 Register bits
    namespace huffenc_ac1_46_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_47 Register bits
    namespace huffenc_ac1_47_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_48 Register bits
    namespace huffenc_ac1_48_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_49 Register bits
    namespace huffenc_ac1_49_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_50 Register bits
    namespace huffenc_ac1_50_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_51 Register bits
    namespace huffenc_ac1_51_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_52 Register bits
    namespace huffenc_ac1_52_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_53 Register bits
    namespace huffenc_ac1_53_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_54 Register bits
    namespace huffenc_ac1_54_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_55 Register bits
    namespace huffenc_ac1_55_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_56 Register bits
    namespace huffenc_ac1_56_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_57 Register bits
    namespace huffenc_ac1_57_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_58 Register bits
    namespace huffenc_ac1_58_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_59 Register bits
    namespace huffenc_ac1_59_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_60 Register bits
    namespace huffenc_ac1_60_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_61 Register bits
    namespace huffenc_ac1_61_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_62 Register bits
    namespace huffenc_ac1_62_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_63 Register bits
    namespace huffenc_ac1_63_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_64 Register bits
    namespace huffenc_ac1_64_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_65 Register bits
    namespace huffenc_ac1_65_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_66 Register bits
    namespace huffenc_ac1_66_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_67 Register bits
    namespace huffenc_ac1_67_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_68 Register bits
    namespace huffenc_ac1_68_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_69 Register bits
    namespace huffenc_ac1_69_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_70 Register bits
    namespace huffenc_ac1_70_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_71 Register bits
    namespace huffenc_ac1_71_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_72 Register bits
    namespace huffenc_ac1_72_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_73 Register bits
    namespace huffenc_ac1_73_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_74 Register bits
    namespace huffenc_ac1_74_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_75 Register bits
    namespace huffenc_ac1_75_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_76 Register bits
    namespace huffenc_ac1_76_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_77 Register bits
    namespace huffenc_ac1_77_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_78 Register bits
    namespace huffenc_ac1_78_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_79 Register bits
    namespace huffenc_ac1_79_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_80 Register bits
    namespace huffenc_ac1_80_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_81 Register bits
    namespace huffenc_ac1_81_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_82 Register bits
    namespace huffenc_ac1_82_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_83 Register bits
    namespace huffenc_ac1_83_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_84 Register bits
    namespace huffenc_ac1_84_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_85 Register bits
    namespace huffenc_ac1_85_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_86 Register bits
    namespace huffenc_ac1_86_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_AC1_87 Register bits
    namespace huffenc_ac1_87_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_0 Register bits
    namespace huffenc_dc0_0_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_1 Register bits
    namespace huffenc_dc0_1_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_2 Register bits
    namespace huffenc_dc0_2_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_3 Register bits
    namespace huffenc_dc0_3_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_4 Register bits
    namespace huffenc_dc0_4_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_5 Register bits
    namespace huffenc_dc0_5_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_6 Register bits
    namespace huffenc_dc0_6_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC0_7 Register bits
    namespace huffenc_dc0_7_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_0 Register bits
    namespace huffenc_dc1_0_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_1 Register bits
    namespace huffenc_dc1_1_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_2 Register bits
    namespace huffenc_dc1_2_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_3 Register bits
    namespace huffenc_dc1_3_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_4 Register bits
    namespace huffenc_dc1_4_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_5 Register bits
    namespace huffenc_dc1_5_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_6 Register bits
    namespace huffenc_dc1_6_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }

    /// HUFFENC_DC1_7 Register bits
    namespace huffenc_dc1_7_bits {
        constexpr uint32_t DHTMem_RAM = (32 << 0);  ///< DHTMem RAM
    }
...
namespace dfsdm1 {
    /// Base addresses
    constexpr uint32_t DFSDM1_BASE = 0x40017400;

    /// DFSDM1 Register structure
    struct Registers {
        volatile uint32_t DFSDM_CHCFG0R1;  ///< Offset: 0x00 - DFSDM channel configuration 0 register 1
        volatile uint32_t DFSDM_CHCFG1R1;  ///< Offset: 0x20 - DFSDM channel configuration 1 register 1
        volatile uint32_t DFSDM_CHCFG2R1;  ///< Offset: 0x40 - DFSDM channel configuration 2 register 1
        volatile uint32_t DFSDM_CHCFG3R1;  ///< Offset: 0x60 - DFSDM channel configuration 3 register 1
        volatile uint32_t DFSDM_CHCFG4R1;  ///< Offset: 0x80 - DFSDM channel configuration 4 register 1
        volatile uint32_t DFSDM_CHCFG5R1;  ///< Offset: 0xA0 - DFSDM channel configuration 5 register 1
        volatile uint32_t DFSDM_CHCFG6R1;  ///< Offset: 0xC0 - DFSDM channel configuration 6 register 1
        volatile uint32_t DFSDM_CHCFG7R1;  ///< Offset: 0xE0 - DFSDM channel configuration 7 register 1
        volatile uint32_t DFSDM_CHCFG0R2;  ///< Offset: 0x04 - DFSDM channel configuration 0 register 2
        volatile uint32_t DFSDM_CHCFG1R2;  ///< Offset: 0x24 - DFSDM channel configuration 1 register 2
        volatile uint32_t DFSDM_CHCFG2R2;  ///< Offset: 0x44 - DFSDM channel configuration 2 register 2
        volatile uint32_t DFSDM_CHCFG3R2;  ///< Offset: 0x64 - DFSDM channel configuration 3 register 2
        volatile uint32_t DFSDM_CHCFG4R2;  ///< Offset: 0x84 - DFSDM channel configuration 4 register 2
        volatile uint32_t DFSDM_CHCFG5R2;  ///< Offset: 0xA4 - DFSDM channel configuration 5 register 2
        volatile uint32_t DFSDM_CHCFG6R2;  ///< Offset: 0xC4 - DFSDM channel configuration 6 register 2
        volatile uint32_t DFSDM_CHCFG7R2;  ///< Offset: 0xE4 - DFSDM channel configuration 7 register 2
        volatile uint32_t DFSDM_AWSCD0R;  ///< Offset: 0x08 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD1R;  ///< Offset: 0x28 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD2R;  ///< Offset: 0x48 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD3R;  ///< Offset: 0x68 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD4R;  ///< Offset: 0x88 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD5R;  ///< Offset: 0xA8 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD6R;  ///< Offset: 0xC8 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_AWSCD7R;  ///< Offset: 0xE8 - DFSDM analog watchdog and short-circuit detector register
        volatile uint32_t DFSDM_CHWDAT0R;  ///< Offset: 0x0C - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT1R;  ///< Offset: 0x2C - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT2R;  ///< Offset: 0x4C - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT3R;  ///< Offset: 0x6C - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT4R;  ///< Offset: 0x8C - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT5R;  ///< Offset: 0xAC - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT6R;  ///< Offset: 0xCC - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHWDAT7R;  ///< Offset: 0xEC - DFSDM channel watchdog filter data register
        volatile uint32_t DFSDM_CHDATIN0R;  ///< Offset: 0x10 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN1R;  ///< Offset: 0x30 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN2R;  ///< Offset: 0x50 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN3R;  ///< Offset: 0x70 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN4R;  ///< Offset: 0x90 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN5R;  ///< Offset: 0xB0 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN6R;  ///< Offset: 0xD0 - DFSDM channel data input register
        volatile uint32_t DFSDM_CHDATIN7R;  ///< Offset: 0xF0 - DFSDM channel data input register
        volatile uint32_t DFSDM0_CR1;  ///< Offset: 0x100 - DFSDM control register 1
        volatile uint32_t DFSDM1_CR1;  ///< Offset: 0x180 - DFSDM control register 1
        volatile uint32_t DFSDM2_CR1;  ///< Offset: 0x200 - DFSDM control register 1
        volatile uint32_t DFSDM3_CR1;  ///< Offset: 0x380 - DFSDM control register 1
        volatile uint32_t DFSDM0_CR2;  ///< Offset: 0x104 - DFSDM control register 2
        volatile uint32_t DFSDM1_CR2;  ///< Offset: 0x184 - DFSDM control register 2
        volatile uint32_t DFSDM2_CR2;  ///< Offset: 0x204 - DFSDM control register 2
        volatile uint32_t DFSDM3_CR2;  ///< Offset: 0x384 - DFSDM control register 2
        volatile uint32_t DFSDM0_ISR;  ///< Offset: 0x108 - DFSDM interrupt and status register
        volatile uint32_t DFSDM1_ISR;  ///< Offset: 0x188 - DFSDM interrupt and status register
        volatile uint32_t DFSDM2_ISR;  ///< Offset: 0x208 - DFSDM interrupt and status register
        volatile uint32_t DFSDM3_ISR;  ///< Offset: 0x388 - DFSDM interrupt and status register
        volatile uint32_t DFSDM0_ICR;  ///< Offset: 0x10C - DFSDM interrupt flag clear register
        volatile uint32_t DFSDM1_ICR;  ///< Offset: 0x18C - DFSDM interrupt flag clear register
        volatile uint32_t DFSDM2_ICR;  ///< Offset: 0x20C - DFSDM interrupt flag clear register
        volatile uint32_t DFSDM3_ICR;  ///< Offset: 0x38C - DFSDM interrupt flag clear register
        volatile uint32_t DFSDM0_JCHGR;  ///< Offset: 0x110 - DFSDM injected channel group selection register
        volatile uint32_t DFSDM1_JCHGR;  ///< Offset: 0x190 - DFSDM injected channel group selection register
        volatile uint32_t DFSDM2_JCHGR;  ///< Offset: 0x210 - DFSDM injected channel group selection register
        volatile uint32_t DFSDM3_JCHGR;  ///< Offset: 0x310 - DFSDM injected channel group selection register
        volatile uint32_t DFSDM0_FCR;  ///< Offset: 0x114 - DFSDM filter control register
        volatile uint32_t DFSDM1_FCR;  ///< Offset: 0x194 - DFSDM filter control register
        volatile uint32_t DFSDM2_FCR;  ///< Offset: 0x214 - DFSDM filter control register
        volatile uint32_t DFSDM3_FCR;  ///< Offset: 0x314 - DFSDM filter control register
        volatile uint32_t DFSDM0_JDATAR;  ///< Offset: 0x118 - DFSDM data register for injected group
        volatile uint32_t DFSDM1_JDATAR;  ///< Offset: 0x198 - DFSDM data register for injected group
        volatile uint32_t DFSDM2_JDATAR;  ///< Offset: 0x218 - DFSDM data register for injected group
        volatile uint32_t DFSDM3_JDATAR;  ///< Offset: 0x318 - DFSDM data register for injected group
        volatile uint32_t DFSDM0_RDATAR;  ///< Offset: 0x11C - DFSDM data register for the regular channel
        volatile uint32_t DFSDM1_RDATAR;  ///< Offset: 0x198 - DFSDM data register for the regular channel
        volatile uint32_t DFSDM2_RDATAR;  ///< Offset: 0x218 - DFSDM data register for the regular channel
        volatile uint32_t DFSDM3_RDATAR;  ///< Offset: 0x318 - DFSDM data register for the regular channel
        volatile uint32_t DFSDM0_AWHTR;  ///< Offset: 0x120 - DFSDM analog watchdog high threshold register
        volatile uint32_t DFSDM1_AWHTR;  ///< Offset: 0x1A0 - DFSDM analog watchdog high threshold register
        volatile uint32_t DFSDM2_AWHTR;  ///< Offset: 0x220 - DFSDM analog watchdog high threshold register
        volatile uint32_t DFSDM3_AWHTR;  ///< Offset: 0x2A0 - DFSDM analog watchdog high threshold register
        volatile uint32_t DFSDM0_AWLTR;  ///< Offset: 0x124 - DFSDM analog watchdog low threshold register
        volatile uint32_t DFSDM1_AWLTR;  ///< Offset: 0x1A4 - DFSDM analog watchdog low threshold register
        volatile uint32_t DFSDM2_AWLTR;  ///< Offset: 0x224 - DFSDM analog watchdog low threshold register
        volatile uint32_t DFSDM3_AWLTR;  ///< Offset: 0x2A4 - DFSDM analog watchdog low threshold register
        volatile uint32_t DFSDM0_AWSR;  ///< Offset: 0x128 - DFSDM analog watchdog status register
        volatile uint32_t DFSDM1_AWSR;  ///< Offset: 0x1A8 - DFSDM analog watchdog status register
        volatile uint32_t DFSDM2_AWSR;  ///< Offset: 0x228 - DFSDM analog watchdog status register
        volatile uint32_t DFSDM3_AWSR;  ///< Offset: 0x2A8 - DFSDM analog watchdog status register
        volatile uint32_t DFSDM0_AWCFR;  ///< Offset: 0x12C - DFSDM analog watchdog clear flag register
        volatile uint32_t DFSDM1_AWCFR;  ///< Offset: 0x1AC - DFSDM analog watchdog clear flag register
        volatile uint32_t DFSDM2_AWCFR;  ///< Offset: 0x22C - DFSDM analog watchdog clear flag register
        volatile uint32_t DFSDM3_AWCFR;  ///< Offset: 0x2AC - DFSDM analog watchdog clear flag register
        volatile uint32_t DFSDM0_EXMAX;  ///< Offset: 0x130 - DFSDM Extremes detector maximum register
        volatile uint32_t DFSDM1_EXMAX;  ///< Offset: 0x1B0 - DFSDM Extremes detector maximum register
        volatile uint32_t DFSDM2_EXMAX;  ///< Offset: 0x230 - DFSDM Extremes detector maximum register
        volatile uint32_t DFSDM3_EXMAX;  ///< Offset: 0x2B0 - DFSDM Extremes detector maximum register
        volatile uint32_t DFSDM0_EXMIN;  ///< Offset: 0x134 - DFSDM Extremes detector minimum register
        volatile uint32_t DFSDM1_EXMIN;  ///< Offset: 0x1B4 - DFSDM Extremes detector minimum register
        volatile uint32_t DFSDM2_EXMIN;  ///< Offset: 0x234 - DFSDM Extremes detector minimum register
        volatile uint32_t DFSDM3_EXMIN;  ///< Offset: 0x2B4 - DFSDM Extremes detector minimum register
        volatile uint32_t DFSDM0_CNVTIMR;  ///< Offset: 0x138 - DFSDM conversion timer register
        volatile uint32_t DFSDM1_CNVTIMR;  ///< Offset: 0x1B8 - DFSDM conversion timer register
        volatile uint32_t DFSDM2_CNVTIMR;  ///< Offset: 0x238 - DFSDM conversion timer register
        volatile uint32_t DFSDM3_CNVTIMR;  ///< Offset: 0x2B8 - DFSDM conversion timer register
    };
...
namespace dsi {
    ...
    struct Registers {
        ...
        volatile uint32_t DSI_ISR0;  ///< Offset: 0xBC - DSI Host Interrupt & Status Register 0
        volatile uint32_t DSI_ISR1;  ///< Offset: 0xC0 - DSI Host Interrupt & Status Register 1
...
#endif // ALLOY_GENERATED_STM32F765_PERIPHERALS_HPP