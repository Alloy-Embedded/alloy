/// Auto-generated code for STM32G051
/// Generated by Alloy Code Generator
/// Source: st_stm32g051.json
...
namespace comp {
    ...
    struct Registers {
        ...
        volatile uint32_t COMP3_CSR;  ///< Offset: 0x08 - Comparator 2 control and status register
    };
    ...
    namespace comp1_csr_bits {
        ...
        constexpr uint32_t INMSEL = (4 << 4);  ///< Comparator 1 signal selector for inverting input INM This bitfield is controlled by software (if not locked). It selects the signal for the inverting input COMP1_INM of the comparator 1: > 1000: 1/4 VREFINT
        constexpr uint32_t INPSEL = (2 << 8);  ///< Comparator 1 signal selector for non-inverting input This bitfield is controlled by software (if not locked). It selects the signal for the non-inverting input COMP1_INP of the comparator 1 (also see the WINMODE bit):
        constexpr uint32_t WINMODE = (1U << 11);  ///< Comparator 1 non-inverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP1_INP input of the comparator 1:
        ...
        constexpr uint32_t PWRMODE = (2 << 18);  ///< Comparator 1 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 1: others: Reserved
        constexpr uint32_t BLANKSEL = (5 << 20);  ///< Comparator 1 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: xxxx1: TIM1 OC4 xxx1x: TIM1 OC5 xx1xx: TIM2 OC3 x1xxx: TIM3 OC3 1xxxx: TIM15 OC2
        constexpr uint32_t VALUE = (1U << 30);  ///< Comparator 1 output status This bit is read-only. It reflects the level of the comparator 1 output after the polarity selector and blanking, as indicated in .
        constexpr uint32_t LOCK = (1U << 31);  ///< COMP1_CSR register lock This bit is set by software and cleared by a system reset. It locks the whole content of the comparator 1 control register COMP1_CSR[31:0]:
    }
    ...
    namespace comp2_csr_bits {
        ...
        constexpr uint32_t INMSEL = (4 << 4);  ///< Comparator 2 signal selector for inverting input INM This bitfield is controlled by software (if not locked). It selects the signal for the inverting input COMP2_INM of the comparator 2: > 1000: 1/4 VREFINT
        constexpr uint32_t INPSEL = (2 << 8);  ///< Comparator 2 signal selector for non-inverting input This bitfield is controlled by software (if not locked). It selects the signal for the non-inverting input COMP2_INP of the comparator 2 (also see the WINMODE bit):
        constexpr uint32_t WINMODE = (1U << 11);  ///< Comparator 2 non-inverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP2_INP input of the comparator 2:
        ...
        constexpr uint32_t PWRMODE = (2 << 18);  ///< Comparator 2 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 2: others: Reserved
        constexpr uint32_t BLANKSEL = (5 << 20);  ///< Comparator 2 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: xxxx1: TIM1 OC4 xxx1x: TIM1 OC5 xx1xx: TIM2 OC3 x1xxx: TIM3 OC3 1xxxx: TIM15 OC2
        constexpr uint32_t VALUE = (1U << 30);  ///< Comparator 2 output status This bit is read-only. It reflects the level of the comparator 2 output after the polarity selector and blanking, as indicated in .
        constexpr uint32_t LOCK = (1U << 31);  ///< COMP2_CSR register lock This bit is set by software and cleared by a system reset. It locks the whole content of the comparator 2 control register COMP2_CSR[31:0]:
    }

    /// COMP3_CSR Register bits
    namespace comp3_csr_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Comparator 3 enable bit This bit is controlled by software (if not locked). It enables the comparator 3:
        constexpr uint32_t INMSEL = (4 << 4);  ///< Comparator 3 signal selector for inverting input INM This bitfield is controlled by software (if not locked). It selects the signal for the inverting input COMP3_INM of the comparator 3: > 1000: 1/4 VREFINT
        constexpr uint32_t INPSEL = (2 << 8);  ///< Comparator 3 signal selector for non-inverting input This bitfield is controlled by software (if not locked). It selects the signal for the non-inverting input COMP3_INP of the comparator 3 (also see the WINMODE bit):
        constexpr uint32_t WINMODE = (1U << 11);  ///< Comparator 3 non-inverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP3_INP input of the comparator 3:
        constexpr uint32_t WINOUT = (1U << 14);  ///< Comparator 3 output selector This bit is controlled by software (if not locked). It selects the comparator 3 output:
        constexpr uint32_t POLARITY = (1U << 15);  ///< Comparator 2 polarity selector This bit is controlled by software (if not locked). It selects the comparator 3 output polarity:
        constexpr uint32_t HYST = (2 << 16);  ///< Comparator 3 hysteresis selector This bitfield is controlled by software (if not locked). It selects the hysteresis of the comparator 3:
        constexpr uint32_t PWRMODE = (2 << 18);  ///< Comparator 3 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 3: others: Reserved
        constexpr uint32_t BLANKSEL = (5 << 20);  ///< Comparator 3 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: xxxx1: TIM1 OC4 xxx1x: TIM1 OC5 xx1xx: TIM2 OC3 x1xxx: TIM3 OC3 1xxxx: TIM15 OC2
        constexpr uint32_t VALUE = (1U << 30);  ///< Comparator 3 output status This bit is read-only. It reflects the level of the comparator 2 output after the polarity selector and blanking, as indicated in .
        constexpr uint32_t LOCK = (1U << 31);  ///< COMP3_CSR register lock This bit is set by software and cleared by a system reset. It locks the whole content of the comparator 3 control register COMP3_CSR[31:0]:
    }
...
namespace spi {
    ...
    namespace spi_cr1_bits {
        ...
        constexpr uint32_t SPE = (1U << 6);  ///< SPI enable Note: When disabling the SPI, follow the procedure described in SPI on pageÂ 1021. This bit is not used in I2S mode.
        ...
        constexpr uint32_t CRCNEXT = (1U << 12);  ///< Transmit CRC next Note: This bit has to be written as soon as the last data is written in the SPI_DR register. This bit is not used in I2S mode.
    ...
    namespace spi_sr_bits {
        ...
        constexpr uint32_t UDR = (1U << 3);  ///< Underrun flag This flag is set by hardware and reset by a software sequence. Refer to pageÂ 1057 for the software sequence. Note: This bit is not used in SPI mode.
        ...
        constexpr uint32_t MODF = (1U << 5);  ///< Mode fault This flag is set by hardware and reset by a software sequence. Refer to (MODF) on pageÂ 1031 for the software sequence. Note: This bit is not used in I2S mode.
        constexpr uint32_t OVR = (1U << 6);  ///< Overrun flag This flag is set by hardware and reset by a software sequence. Refer to pageÂ 1057 for the software sequence.
        ...
        constexpr uint32_t FRE = (1U << 8);  ///< Frame format error This flag is used for SPI in TI slave mode and I2S slave mode. Refer to error flags and . This flag is set by hardware and reset when SPI_SR is read by software.
