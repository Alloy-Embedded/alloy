/// Auto-generated code for STM32G070
/// Generated by Alloy Code Generator
/// Source: st_stm32g070.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 17:44:32
#ifndef ALLOY_GENERATED_STM32G070_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32G070_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::stm32g070 {
...
namespace traits {
    ...
    constexpr bool has_ucpd2 = true;
    constexpr uint32_t num_ucpd2_instances = 1;
    ...
    template<>
    struct peripheral_count<struct ucpd2_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace tim {
    ...
    /// CR1 Register bits
    namespace cr1_bits {
        constexpr uint32_t CEN = (1U << 0);  ///< Counter enable Note: External clock and gated mode can work only if the CEN bit has been previously set by software. However trigger mode can set the CEN bit automatically by hardware.
        ...
        constexpr uint32_t CKD = (2 << 8);  ///< Clock division This bitfield indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS) used by the dead-time generators and the digital filters (TIx)
    ...
    namespace cr2_bits {
        ...
        constexpr uint32_t MMS = (3 << 4);  ///< Master mode selection These bits allow to select the information to be sent in master mode to slave timers for synchronization (TRGO). The combination is as follows:
        constexpr uint32_t TI1S = (1U << 7);  ///< TI1 selection
        constexpr uint32_t OIS1 = (1U << 8);  ///< Output Idle state 1 (OC1 output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
        constexpr uint32_t OIS1N = (1U << 9);  ///< Output Idle state 1 (OC1N output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BDTR register).
        constexpr uint32_t OIS2 = (1U << 10);  ///< Output idle state 2 (OC2 output) Note: This bit cannot be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in the TIM15_BDTR register).
    }

    /// SMCR Register bits
    namespace smcr_bits {
        constexpr uint32_t SMS1 = (3 << 0);  ///< Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Other codes: reserved. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=â00100â). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
    ...
    namespace sr_bits {
        ...
        constexpr uint32_t COMIF = (1U << 5);  ///< COM interrupt flag This flag is set by hardware on a COM event (once the capture/compare control bits âCCxE, CCxNE, OCxMâ have been updated). It is cleared by software.
    ...
    namespace egr_bits {
        ...
        constexpr uint32_t COMG = (1U << 5);  ///< Capture/Compare control update generation This bit can be set by software, it is automatically cleared by hardware. Note: This bit acts only on channels that have a complementary output.
    ...
    /// CCER Register bits
    namespace ccer_bits {
        constexpr uint32_t CC1E = (1U << 0);  ///< Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to for details.
    ...
    namespace bdtr_bits {
        ...
        constexpr uint32_t OSSI = (1U << 10);  ///< Off-state selection for Idle mode This bit is used when MOE=0 on channels configured as outputs. See OC/OCN enable description for more details (enable register (TIM15_CCER) on pageÂ 818). Note: This bit can not be modified as soon as the LOCK level 2 has been programmed (LOCK bits in TIMx_BDTR register).
        constexpr uint32_t OSSR = (1U << 11);  ///< Off-state selection for Run mode This bit is used when MOE=1 on channels that have a complementary output which are configured as outputs. OSSR is not implemented if no complementary output is implemented in the timer. See OC/OCN enable description for more details (enable register (TIM15_CCER) on pageÂ 818). Note: This bit can not be modified as soon as the LOCK level 2 has been programmed (LOCK bits in TIMx_BDTR register).
        constexpr uint32_t BKE = (1U << 12);  ///< Break enable 1; Break inputs (BRK and CCS clock failure event) enabled This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
        constexpr uint32_t BKP = (1U << 13);  ///< Break polarity Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
    ...
    /// DCR Register bits
    namespace dcr_bits {
        constexpr uint32_t DBA = (5 << 0);  ///< DMA base address This 5-bit field defines the base-address for DMA transfers (when read/write access are done through the TIMx_DMAR address). DBA is defined as an offset starting from the address of the TIMx_CR1 register. Example: ...
        constexpr uint32_t DBL = (5 << 8);  ///< DMA burst length This 5-bit field defines the length of DMA transfers (the timer recognizes a burst transfer when a read or a write access is done to the TIMx_DMAR address). ...
    }
