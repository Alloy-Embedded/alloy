/// Auto-generated code for STM32G0B0
/// Generated by Alloy Code Generator
/// Source: st_stm32g0.json
...
namespace tim {
    ...
    struct Registers {
        ...
        volatile uint32_t TIM1_OR1;  ///< Offset: 0x50 - option register 1
        ...
        volatile uint32_t TIM1_CCR6;  ///< Offset: 0x5C - capture/compare register 4
        volatile uint32_t TIM1_AF1;  ///< Offset: 0x60 - DMA address for full transfer
        volatile uint32_t TIM1_AF2;  ///< Offset: 0x64 - DMA address for full transfer
    ...
    /// TIM1_OR1 Register bits
    namespace tim1_or1_bits {
        constexpr uint32_t OCREF_CLR = (1U << 0);  ///< Ocref_clr source selection This bit selects the ocref_clr input source.
    }
    ...
    namespace tim1_af1_bits {
        ...
        constexpr uint32_t BKCMP1E = (1U << 1);  ///< BRK COMP1 enable This bit enables the COMP1 for the timerâs BRK input. COMP1 output is 'ORedâ with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
        constexpr uint32_t BKCMP2E = (1U << 2);  ///< BRK COMP2 enable This bit enables the COMP2 for the timerâs BRK input. COMP2 output is 'ORedâ with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
        ...
        constexpr uint32_t BKCMP1P = (1U << 10);  ///< BRK COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
        constexpr uint32_t BKCMP2P = (1U << 11);  ///< BRK COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    ...
    namespace tim1_af2_bits {
        ...
        constexpr uint32_t BK2CMP1E = (1U << 1);  ///< BRK2 COMP1 enable This bit enables the COMP1 for the timerâs BRK2 input. COMP1 output is 'ORedâ with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
        constexpr uint32_t BK2CMP2E = (1U << 2);  ///< BRK2 COMP2 enable This bit enables the COMP2 for the timerâs BRK2 input. COMP2 output is 'ORedâ with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
        ...
        constexpr uint32_t BK2CMP1P = (1U << 10);  ///< BRK2 COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
        constexpr uint32_t BK2CMP2P = (1U << 11);  ///< BRK2 COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    }
...
namespace usart {
    ...
    constexpr uint32_t USART6_BASE = 0x40013C00;
...
namespace usb {
    ...
    struct Registers {
        ...
        volatile uint32_t USB_CNTR;  ///< Offset: 0x40 - USB Reset Software can set this bit to reset the USB...
        ...
        volatile uint32_t USB_DADDR;  ///< Offset: 0x4C - Device address Device mode These bits contain the USB...
        volatile uint32_t USB_LPMCSR;  ///< Offset: 0x54 - LPM support enable Device mode This bit is set by the...
        volatile uint32_t USB_BCDR;  ///< Offset: 0x58 - Battery charging detector (BCD) enable Device mode This...
    };
    ...
    namespace usb_chep0r_bits {
        ...
        constexpr uint32_t STATTX = (2 << 4);  ///< Status bits, for transmission transfers Device mode These bits contain the information about the endpoint status, listed in . These bits can be toggled by the software to initialize their value. When the application software writes 0, the value remains unchanged, while writing 1 makes the bit value to toggle. Hardware sets the STATTX bits to NAK, when a correct transfer has occurred (VTTX=1) corresponding to a IN or SETUP (control only) transaction addressed to this channel/endpoint. It then waits for the software to prepare the next set of data to be transmitted. Double-buffered bulk endpoints implement a special transaction flow control, which controls the status based on buffer availability condition (Refer to endpoints and usage in Device mode). If the endpoint is defined as isochronous, its status can only be âVALIDâ or âDISABLEDâ. Therefore, the hardware cannot change the status of the channel/endpoint/channel after a successful transaction. If the software sets the STATTX bits to 'STALLâ or 'NAKâ for an isochronous channel/endpoint, the USB peripheral behavior is not defined. These bits are read/write but they can be only toggled by writing 1. Host mode The STATTX bits contain the information about the channel status. Refer to for the full descriptions (âHost modeâ descriptions). Whereas in Device mode, these bits contain the status that are given out on the following transaction, in Host mode they capture the status last received from the device. If a NAK is received, STATTX contains the value indicating NAK.
        ...
        constexpr uint32_t LS_EP = (1U << 24);  ///< Low speed endpoint â host with HUB only Host mode This bit is set by the software to send an LS transaction to the corresponding endpoint.
    ...
    namespace usb_istr_bits {
        ...
        constexpr uint32_t WKUP = (1U << 12);  ///< Wakeup This bit is set to 1 by the hardware when, during suspend mode, activity is detected that wakes up the USB peripheral. This event asynchronously clears the SUSPRDY bit in the CTLR register and activates the USB_WAKEUP line, which can be used to notify the rest of the device (for example wakeup unit) about the start of the resume process. This bit is read/write but only 0 can be written and writing 1 has no effect.
        ...
        constexpr uint32_t LS_DCON = (1U << 30);  ///< Low speed device connected Host mode: This bit is set by hardware when an LS device connection is detected. Device connection is signaled after LS J-state is sampled for 22 consecutive cycles of the USB clock (48MHz) from the unconnected state.
    }
    ...
    namespace usb_fnr_bits {
        ...
        constexpr uint32_t RXDM = (1U << 14);  ///< Receive data - line status This bit can be used to observe the status of received data minus upstream port data line. It can be used during end-of-suspend routines to help determining the wakeup event.
        constexpr uint32_t RXDP = (1U << 15);  ///< Receive data + line status This bit can be used to observe the status of received data plus upstream port data line. It can be used during end-of-suspend routines to help determining the wakeup event.
    }
    ...
    namespace usb_bcdr_bits {
        ...
        constexpr uint32_t DCDEN = (1U << 1);  ///< Data contact detection (DCD) mode enable Device mode This bit is set by the software to put the BCD into DCD mode. Only one detection mode (DCD, PD, SD or OFF) should be selected to work correctly.
        constexpr uint32_t PDEN = (1U << 2);  ///< Primary detection (PD) mode enable Device mode This bit is set by the software to put the BCD into PD mode. Only one detection mode (DCD, PD, SD or OFF) should be selected to work correctly.
        constexpr uint32_t SDEN = (1U << 3);  ///< Secondary detection (SD) mode enable Device mode This bit is set by the software to put the BCD into SD mode. Only one detection mode (DCD, PD, SD or OFF) should be selected to work correctly.
        ...
        constexpr uint32_t PS2DET = (1U << 7);  ///< DM pull-up detection status Device mode This bit is active only during PD and gives the result of comparison between DM voltage level and VLGC threshold. In normal situation, the DM level should be below this threshold. If it is above, it means that the DM is externally pulled high. This can be caused by connection to a PS2 port (which pulls-up both DP and DM lines) or to some proprietary charger not following the BCD specification.
