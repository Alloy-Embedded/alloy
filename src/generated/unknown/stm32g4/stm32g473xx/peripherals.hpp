/// Auto-generated code for STM32G473xx
/// Generated by Alloy Code Generator
/// Source: st_stm32g473.json
...
namespace flash {
    ...
    namespace optr_bits {
        ...
        constexpr uint32_t CCMSRAM_RST = (1U << 25);  ///< CCM SRAM Erase when system reset
...
namespace can {
    ...
    constexpr uint32_t FDCANs_Message_RAM_BASE = 0x4000A400;
    ...
    inline Registers* FDCANs_Message_RAM = reinterpret_cast<Registers*>(FDCANs_Message_RAM_BASE);
