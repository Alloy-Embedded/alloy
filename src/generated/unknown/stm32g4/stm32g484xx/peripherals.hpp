/// Auto-generated code for STM32G484xx
/// Generated by Alloy Code Generator
/// Source: st_stm32g484.json
...
namespace traits {
    ...
    constexpr uint32_t num_tim_instances = 21;
    ...
    constexpr uint32_t num_adc_instances = 7;
...
namespace crypto {
    ...
    namespace susp0r_bits {
        constexpr uint32_t SUSP = (32 << 0);  ///< AES suspend
    }
...
namespace tim {
    ...
    constexpr uint32_t HRTIM_Master_BASE = 0x40016800;
    constexpr uint32_t HRTIM_TIMA_BASE = 0x40016880;
    constexpr uint32_t HRTIM_TIMB_BASE = 0x40016900;
    constexpr uint32_t HRTIM_TIMC_BASE = 0x40016980;
    constexpr uint32_t HRTIM_TIMD_BASE = 0x40016A00;
    constexpr uint32_t HRTIM_TIME_BASE = 0x40016A80;
    constexpr uint32_t HRTIM_TIMF_BASE = 0x40016B00;
    constexpr uint32_t HRTIM_Common_BASE = 0x40016B80;
    ...
    inline Registers* HRTIM_TIMF = reinterpret_cast<Registers*>(HRTIM_TIMF_BASE);
...
namespace fmc {
    ...
    namespace pcscntr_bits {
        constexpr uint32_t CSCOUNT = (16 << 0);  ///< CSCOUNT
        constexpr uint32_t CNTB1EN = (1U << 16);  ///< CNTB1EN
        constexpr uint32_t CNTB2EN = (1U << 17);  ///< CNTB2EN
        constexpr uint32_t CNTB3EN = (1U << 18);  ///< CNTB3EN
        constexpr uint32_t CNTB4EN = (1U << 19);  ///< CNTB4EN
    }
...
namespace comp {
    ...
    struct Registers {
        ...
        volatile uint32_t COMP_C5CSR;  ///< Offset: 0x10 - Comparator control/status register
        volatile uint32_t COMP_C6CSR;  ///< Offset: 0x14 - Comparator control/status register
        volatile uint32_t COMP_C7CSR;  ///< Offset: 0x18 - Comparator control/status register
    };
    ...
    /// COMP_C5CSR Register bits
    namespace comp_c5csr_bits {
        constexpr uint32_t EN = (1U << 0);  ///< EN
        constexpr uint32_t INMSEL = (3 << 4);  ///< INMSEL
        constexpr uint32_t INPSEL = (1U << 8);  ///< INPSEL
        constexpr uint32_t POL = (1U << 15);  ///< POL
    ...
    /// COMP_C6CSR Register bits
    namespace comp_c6csr_bits {
        constexpr uint32_t EN = (1U << 0);  ///< EN
        constexpr uint32_t INMSEL = (3 << 4);  ///< INMSEL
        constexpr uint32_t INPSEL = (1U << 8);  ///< INPSEL
        constexpr uint32_t POL = (1U << 15);  ///< POL
    ...
    /// COMP_C7CSR Register bits
    namespace comp_c7csr_bits {
        constexpr uint32_t EN = (1U << 0);  ///< EN
        constexpr uint32_t INMSEL = (3 << 4);  ///< INMSEL
        constexpr uint32_t INPSEL = (1U << 8);  ///< INPSEL
        constexpr uint32_t POL = (1U << 15);  ///< POL
...
namespace opamp {
    ...
    struct Registers {
        ...
        volatile uint32_t OPAMP4_CSR;  ///< Offset: 0x0C - OPAMP4 control/status register
        volatile uint32_t OPAMP5_CSR;  ///< Offset: 0x10 - OPAMP5 control/status register
        volatile uint32_t OPAMP6_CSR;  ///< Offset: 0x14 - OPAMP6 control/status register
        ...
        volatile uint32_t OPAMP4_TCMR;  ///< Offset: 0x24 - OPAMP4 control/status register
        volatile uint32_t OPAMP5_TCMR;  ///< Offset: 0x28 - OPAMP5 control/status register
        volatile uint32_t OPAMP6_TCMR;  ///< Offset: 0x2C - OPAMP6 control/status register
    };
    ...
    /// OPAMP5_CSR Register bits
    namespace opamp5_csr_bits {
        constexpr uint32_t OPAEN = (1U << 0);  ///< Operational amplifier Enable
        constexpr uint32_t FORCE_VP = (1U << 1);  ///< FORCE_VP
        constexpr uint32_t VP_SEL = (2 << 2);  ///< VP_SEL
        constexpr uint32_t USERTRIM = (1U << 4);  ///< USERTRIM
    ...
    /// OPAMP6_CSR Register bits
    namespace opamp6_csr_bits {
        constexpr uint32_t OPAEN = (1U << 0);  ///< Operational amplifier Enable
        constexpr uint32_t FORCE_VP = (1U << 1);  ///< FORCE_VP
        constexpr uint32_t VP_SEL = (2 << 2);  ///< VP_SEL
        constexpr uint32_t USERTRIM = (1U << 4);  ///< USERTRIM
    ...
    /// OPAMP4_TCMR Register bits
    namespace opamp4_tcmr_bits {
        constexpr uint32_t VMS_SEL = (1U << 0);  ///< VMS_SEL
        constexpr uint32_t VPS_SEL = (2 << 1);  ///< VPS_SEL
        constexpr uint32_t T1CM_EN = (1U << 3);  ///< T1CM_EN
        constexpr uint32_t T8CM_EN = (1U << 4);  ///< T8CM_EN
    ...
    /// OPAMP5_TCMR Register bits
    namespace opamp5_tcmr_bits {
        constexpr uint32_t VMS_SEL = (1U << 0);  ///< VMS_SEL
        constexpr uint32_t VPS_SEL = (2 << 1);  ///< VPS_SEL
        constexpr uint32_t T1CM_EN = (1U << 3);  ///< T1CM_EN
        constexpr uint32_t T8CM_EN = (1U << 4);  ///< T8CM_EN
    ...
    /// OPAMP6_TCMR Register bits
    namespace opamp6_tcmr_bits {
        constexpr uint32_t VMS_SEL = (1U << 0);  ///< VMS_SEL
        constexpr uint32_t VPS_SEL = (2 << 1);  ///< VPS_SEL
        constexpr uint32_t T1CM_EN = (1U << 3);  ///< T1CM_EN
        constexpr uint32_t T8CM_EN = (1U << 4);  ///< T8CM_EN
...
namespace adc {
    ...
    constexpr uint32_t ADC5_BASE = 0x50000600;
    ...
    inline Registers* ADC5 = reinterpret_cast<Registers*>(ADC5_BASE);
...
namespace can {
    ...
    constexpr uint32_t FDCAN2_BASE = 0x40006800;
    constexpr uint32_t FDCAN3_BASE = 0x40006C00;
    ...
    inline Registers* FDCAN3 = reinterpret_cast<Registers*>(FDCAN3_BASE);
