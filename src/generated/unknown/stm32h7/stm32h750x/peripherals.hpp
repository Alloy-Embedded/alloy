/// Auto-generated code for STM32H750x
...
namespace traits {
    ...
    constexpr uint32_t num_dma_instances = 7;
...
namespace comp {
    ...
    struct Registers {
        volatile uint32_t COMP1_SR;  ///< Offset: 0x00 - Comparator status register
        volatile uint32_t COMP1_ICFR;  ///< Offset: 0x04 - Comparator interrupt clear flag register
        volatile uint32_t COMP1_OR;  ///< Offset: 0x08 - Comparator option register
        volatile uint32_t COMP1_CFGR1;  ///< Offset: 0x0C - Comparator configuration register 1
        volatile uint32_t COMP1_CFGR2;  ///< Offset: 0x10 - Comparator configuration register 2
    };
    ...
    // Bit definitions
    /// COMP1_SR Register bits
    namespace comp1_sr_bits {
    ...
    /// COMP1_ICFR Register bits
    namespace comp1_icfr_bits {
    ...
    /// COMP1_OR Register bits
    namespace comp1_or_bits {
    ...
    /// COMP1_CFGR1 Register bits
    namespace comp1_cfgr1_bits {
    ...
    /// COMP1_CFGR2 Register bits
    namespace comp1_cfgr2_bits {
        constexpr uint32_t EN = (1U << 0);  ///< COMP channel 1 enable bit
        constexpr uint32_t BRGEN = (1U << 1);  ///< Scaler bridge enable
        constexpr uint32_t SCALEN = (1U << 2);  ///< Voltage scaler enable bit
        constexpr uint32_t POLARITY = (1U << 3);  ///< COMP channel 1 polarity selection bit
...
namespace crs {
    ...
    struct Registers {
        volatile uint32_t CRS_CR;  ///< Offset: 0x00 - CRS control register
        volatile uint32_t CRS_CFGR;  ///< Offset: 0x04 - This register can be written only when the frequency...
        volatile uint32_t CRS_ISR;  ///< Offset: 0x08 - CRS interrupt and status register
        volatile uint32_t CRS_ICR;  ///< Offset: 0x0C - CRS interrupt flag clear register
    };
    ...
    /// CRS_ICR Register bits
    namespace crs_icr_bits {
...
namespace dma {
    ...
    struct Registers {
        volatile uint32_t BDMA_ISR;  ///< Offset: 0x00 - DMA interrupt status register
        volatile uint32_t BDMA_IFCR;  ///< Offset: 0x04 - DMA interrupt flag clear register
        volatile uint32_t BDMA_CCR1;  ///< Offset: 0x08 - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR1;  ///< Offset: 0x0C - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR1;  ///< Offset: 0x10 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR1;  ///< Offset: 0x14 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR2;  ///< Offset: 0x1C - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR2;  ///< Offset: 0x20 - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR2;  ///< Offset: 0x24 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR2;  ///< Offset: 0x28 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR3;  ///< Offset: 0x30 - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR3;  ///< Offset: 0x34 - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR3;  ///< Offset: 0x38 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR3;  ///< Offset: 0x3C - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR4;  ///< Offset: 0x44 - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR4;  ///< Offset: 0x48 - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR4;  ///< Offset: 0x4C - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR4;  ///< Offset: 0x50 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR5;  ///< Offset: 0x58 - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR5;  ///< Offset: 0x5C - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR5;  ///< Offset: 0x60 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR5;  ///< Offset: 0x64 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR6;  ///< Offset: 0x6C - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR6;  ///< Offset: 0x70 - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR6;  ///< Offset: 0x74 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR6;  ///< Offset: 0x78 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR7;  ///< Offset: 0x80 - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR7;  ///< Offset: 0x84 - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR7;  ///< Offset: 0x88 - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR7;  ///< Offset: 0x8C - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CCR8;  ///< Offset: 0x94 - DMA channel x configuration register
        volatile uint32_t BDMA_CNDTR8;  ///< Offset: 0x98 - DMA channel x number of data register
        volatile uint32_t BDMA_CPAR8;  ///< Offset: 0x9C - This register must not be written when the channel is enabled.
        volatile uint32_t BDMA_CMAR8;  ///< Offset: 0xA0 - This register must not be written when the channel is enabled.
    };
    ...
    // Bit definitions
    /// BDMA_ISR Register bits
    namespace bdma_isr_bits {
    ...
    /// BDMA_IFCR Register bits
    namespace bdma_ifcr_bits {
    ...
    /// BDMA_CCR1 Register bits
    namespace bdma_ccr1_bits {
    ...
    /// BDMA_CNDTR1 Register bits
    namespace bdma_cndtr1_bits {
    ...
    /// BDMA_CPAR1 Register bits
    namespace bdma_cpar1_bits {
    ...
    /// BDMA_CMAR1 Register bits
    namespace bdma_cmar1_bits {
    ...
    /// BDMA_CCR2 Register bits
    namespace bdma_ccr2_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR2 Register bits
    namespace bdma_cndtr2_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR2 Register bits
    namespace bdma_cpar2_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR2 Register bits
    namespace bdma_cmar2_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CCR3 Register bits
    namespace bdma_ccr3_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR3 Register bits
    namespace bdma_cndtr3_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR3 Register bits
    namespace bdma_cpar3_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR3 Register bits
    namespace bdma_cmar3_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CCR4 Register bits
    namespace bdma_ccr4_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR4 Register bits
    namespace bdma_cndtr4_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR4 Register bits
    namespace bdma_cpar4_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR4 Register bits
    namespace bdma_cmar4_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CCR5 Register bits
    namespace bdma_ccr5_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR5 Register bits
    namespace bdma_cndtr5_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR5 Register bits
    namespace bdma_cpar5_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR5 Register bits
    namespace bdma_cmar5_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CCR6 Register bits
    namespace bdma_ccr6_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR6 Register bits
    namespace bdma_cndtr6_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR6 Register bits
    namespace bdma_cpar6_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR6 Register bits
    namespace bdma_cmar6_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CCR7 Register bits
    namespace bdma_ccr7_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR7 Register bits
    namespace bdma_cndtr7_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR7 Register bits
    namespace bdma_cpar7_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR7 Register bits
    namespace bdma_cmar7_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CCR8 Register bits
    namespace bdma_ccr8_bits {
        constexpr uint32_t EN = (1U << 0);  ///< Channel enable This bit is set and cleared by software.
        constexpr uint32_t TCIE = (1U << 1);  ///< Transfer complete interrupt enable This bit is set and cleared by software.
        constexpr uint32_t HTIE = (1U << 2);  ///< Half transfer interrupt enable This bit is set and cleared by software.
        constexpr uint32_t TEIE = (1U << 3);  ///< Transfer error interrupt enable This bit is set and cleared by software.
    ...
    /// BDMA_CNDTR8 Register bits
    namespace bdma_cndtr8_bits {
        constexpr uint32_t NDT = (16 << 0);  ///< Number of data to transfer Number of data to be transferred (0 up to 65535). This register can only be written when the channel is disabled. Once the channel is enabled, this register is read-only, indicating the remaining bytes to be transmitted. This register decrements after each DMA transfer. Once the transfer is completed, this register can either stay at zero or be reloaded automatically by the value previously programmed if the channel is configured in auto-reload mode. If this register is zero, no transaction can be served whether the channel is enabled or not.
    }

    /// BDMA_CPAR8 Register bits
    namespace bdma_cpar8_bits {
        constexpr uint32_t PA = (32 << 0);  ///< Peripheral address Base address of the peripheral data register from/to which the data will be read/written. When PSIZE is 01 (16-bit), the PA[0] bit is ignored. Access is automatically aligned to a half-word address. When PSIZE is 10 (32-bit), PA[1:0] are ignored. Access is automatically aligned to a word address.
    }

    /// BDMA_CMAR8 Register bits
    namespace bdma_cmar8_bits {
        constexpr uint32_t MA = (32 << 0);  ///< Memory address Base address of the memory area from/to which the data will be read/written. When MSIZE is 01 (16-bit), the MA[0] bit is ignored. Access is automatically aligned to a half-word address. When MSIZE is 10 (32-bit), MA[1:0] are ignored. Access is automatically aligned to a word address.
    }
...
namespace fmc {
    ...
    struct Registers {
        volatile uint32_t FMC_BCR1;  ///< Offset: 0x00 - This register contains the control information of each...
        volatile uint32_t FMC_BTR1;  ///< Offset: 0x04 - This register contains the control information of each...
        volatile uint32_t FMC_BCR2;  ///< Offset: 0x08 - This register contains the control information of each...
        volatile uint32_t FMC_BTR2;  ///< Offset: 0x0C - This register contains the control information of each...
        volatile uint32_t FMC_BCR3;  ///< Offset: 0x10 - This register contains the control information of each...
        volatile uint32_t FMC_BTR3;  ///< Offset: 0x14 - This register contains the control information of each...
        volatile uint32_t FMC_BCR4;  ///< Offset: 0x18 - This register contains the control information of each...
        volatile uint32_t FMC_BTR4;  ///< Offset: 0x1C - This register contains the control information of each...
        ...
        volatile uint32_t FMC_SDCR1;  ///< Offset: 0x140 - This register contains the control parameters for each...
        volatile uint32_t FMC_SDCR2;  ///< Offset: 0x144 - This register contains the control parameters for each...
        volatile uint32_t FMC_SDTR1;  ///< Offset: 0x148 - This register contains the timing parameters of each SDRAM bank
        volatile uint32_t FMC_SDTR2;  ///< Offset: 0x14C - This register contains the timing parameters of each SDRAM bank
        volatile uint32_t FMC_SDCMR;  ///< Offset: 0x150 - This register contains the command issued when the SDRAM...
        volatile uint32_t FMC_SDRTR;  ///< Offset: 0x154 - This register sets the refresh rate in number of SDCLK...
        volatile uint32_t FMC_SDSR;  ///< Offset: 0x158 - SDRAM Status register
    };
    ...
    /// FMC_SDCR1 Register bits
    namespace fmc_sdcr1_bits {
    ...
    /// FMC_SDCR2 Register bits
    namespace fmc_sdcr2_bits {
        constexpr uint32_t NC = (2 << 0);  ///< Number of column address bits These bits define the number of bits of a column address.
        constexpr uint32_t NR = (2 << 2);  ///< Number of row address bits These bits define the number of bits of a row address.
        constexpr uint32_t MWID = (2 << 4);  ///< Memory data bus width. These bits define the memory device width.
        constexpr uint32_t NB = (1U << 6);  ///< Number of internal banks This bit sets the number of internal banks.
    ...
    /// FMC_SDTR1 Register bits
    namespace fmc_sdtr1_bits {
    ...
    /// FMC_SDTR2 Register bits
    namespace fmc_sdtr2_bits {
        constexpr uint32_t TMRD = (4 << 0);  ///< Load Mode Register to Active These bits define the delay between a Load Mode Register command and an Active or Refresh command in number of memory clock cycles. ....
        constexpr uint32_t TXSR = (4 << 4);  ///< Exit Self-refresh delay These bits define the delay from releasing the Self-refresh command to issuing the Activate command in number of memory clock cycles. .... Note: If two SDRAM devices are used, the FMC_SDTR1 and FMC_SDTR2 must be programmed with the same TXSR timing corresponding to the slowest SDRAM device.
        constexpr uint32_t TRAS = (4 << 8);  ///< Self refresh time These bits define the minimum Self-refresh period in number of memory clock cycles. ....
        constexpr uint32_t TRC = (4 << 12);  ///< Row cycle delay These bits define the delay between the Refresh command and the Activate command, as well as the delay between two consecutive Refresh commands. It is expressed in number of memory clock cycles. The TRC timing is only configured in the FMC_SDTR1 register. If two SDRAM devices are used, the TRC must be programmed with the timings of the slowest device. .... Note: TRC must match the TRC and TRFC (Auto Refresh period) timings defined in the SDRAM device datasheet. Note: The corresponding bits in the FMC_SDTR2 register are dont care.
    ...
    /// FMC_SDCMR Register bits
    namespace fmc_sdcmr_bits {
    ...
    /// FMC_SDRTR Register bits
    namespace fmc_sdrtr_bits {
    ...
    /// FMC_SDSR Register bits
    namespace fmc_sdsr_bits {
...
namespace i2c {
    ...
    struct Registers {
        volatile uint32_t I2C_CR1;  ///< Offset: 0x00 - Access: No wait states, except if a write access occurs...
        volatile uint32_t I2C_CR2;  ///< Offset: 0x04 - Access: No wait states, except if a write access occurs...
        volatile uint32_t I2C_OAR1;  ///< Offset: 0x08 - Access: No wait states, except if a write access occurs...
        volatile uint32_t I2C_OAR2;  ///< Offset: 0x0C - Access: No wait states, except if a write access occurs...
        volatile uint32_t I2C_TIMINGR;  ///< Offset: 0x10 - Access: No wait states
        volatile uint32_t I2C_TIMEOUTR;  ///< Offset: 0x14 - Access: No wait states, except if a write access occurs...
        volatile uint32_t I2C_ISR;  ///< Offset: 0x18 - Access: No wait states
        volatile uint32_t I2C_ICR;  ///< Offset: 0x1C - Access: No wait states
        volatile uint32_t I2C_PECR;  ///< Offset: 0x20 - Access: No wait states
        volatile uint32_t I2C_RXDR;  ///< Offset: 0x24 - Access: No wait states
        volatile uint32_t I2C_TXDR;  ///< Offset: 0x28 - Access: No wait states
    };
...
namespace gpio {
    ...
    struct Registers {
        ...
        volatile uint32_t GPIO_LCKR;  ///< Offset: 0x1C - This register is used to lock the configuration of the...
...
namespace jpeg {
    ...
    struct Registers {
        ...
        volatile uint32_t JPEG_CONFRN1;  ///< Offset: 0x10 - JPEG codec configuration register 4-7
        volatile uint32_t JPEG_CONFRN2;  ///< Offset: 0x14 - JPEG codec configuration register 4-7
        volatile uint32_t JPEG_CONFRN3;  ///< Offset: 0x18 - JPEG codec configuration register 4-7
        volatile uint32_t JPEG_CONFRN4;  ///< Offset: 0x1C - JPEG codec configuration register 4-7
    ...
    /// JPEG_CONFRN1 Register bits
    namespace jpeg_confrn1_bits {
    ...
    /// JPEG_CONFRN2 Register bits
    namespace jpeg_confrn2_bits {
        constexpr uint32_t HD = (1U << 0);  ///< Huffman DC Selects the Huffman table for encoding the DC coefficients.
        constexpr uint32_t HA = (1U << 1);  ///< Huffman AC Selects the Huffman table for encoding the AC coefficients.
        constexpr uint32_t QT = (2 << 2);  ///< Quantization Table Selects quantization table associated with a color component.
        constexpr uint32_t NB = (4 << 4);  ///< Number of Block Number of data units minus 1 that belong to a particular color in the MCU.
    ...
    /// JPEG_CONFRN3 Register bits
    namespace jpeg_confrn3_bits {
        constexpr uint32_t HD = (1U << 0);  ///< Huffman DC Selects the Huffman table for encoding the DC coefficients.
        constexpr uint32_t HA = (1U << 1);  ///< Huffman AC Selects the Huffman table for encoding the AC coefficients.
        constexpr uint32_t QT = (2 << 2);  ///< Quantization Table Selects quantization table associated with a color component.
        constexpr uint32_t NB = (4 << 4);  ///< Number of Block Number of data units minus 1 that belong to a particular color in the MCU.
    ...
    /// JPEG_CONFRN4 Register bits
    namespace jpeg_confrn4_bits {
        constexpr uint32_t HD = (1U << 0);  ///< Huffman DC Selects the Huffman table for encoding the DC coefficients.
        constexpr uint32_t HA = (1U << 1);  ///< Huffman AC Selects the Huffman table for encoding the AC coefficients.
        constexpr uint32_t QT = (2 << 2);  ///< Quantization Table Selects quantization table associated with a color component.
        constexpr uint32_t NB = (4 << 4);  ///< Number of Block Number of data units minus 1 that belong to a particular color in the MCU.
...
namespace spi {
    ...
    struct Registers {
        volatile uint32_t QUADSPI_CR;  ///< Offset: 0x00 - QUADSPI control register
        volatile uint32_t QUADSPI_DCR;  ///< Offset: 0x04 - QUADSPI device configuration register
        volatile uint32_t QUADSPI_SR;  ///< Offset: 0x08 - QUADSPI status register
        volatile uint32_t QUADSPI_FCR;  ///< Offset: 0x0C - QUADSPI flag clear register
        volatile uint32_t QUADSPI_DLR;  ///< Offset: 0x10 - QUADSPI data length register
        volatile uint32_t QUADSPI_CCR;  ///< Offset: 0x14 - QUADSPI communication configuration register
        volatile uint32_t QUADSPI_AR;  ///< Offset: 0x18 - QUADSPI address register
        volatile uint32_t QUADSPI_ABR;  ///< Offset: 0x1C - QUADSPI alternate bytes registers
        volatile uint32_t QUADSPI_DR;  ///< Offset: 0x20 - QUADSPI data register
        volatile uint32_t QUADSPI_PSMKR;  ///< Offset: 0x24 - QUADSPI polling status mask register
        volatile uint32_t QUADSPI_PSMAR;  ///< Offset: 0x28 - QUADSPI polling status match register
        volatile uint32_t QUADSPI_PIR;  ///< Offset: 0x2C - QUADSPI polling interval register
        volatile uint32_t QUADSPI_LPTR;  ///< Offset: 0x30 - QUADSPI low-power timeout register
    };
    ...
    // Bit definitions
    /// QUADSPI_CR Register bits
    namespace quadspi_cr_bits {
    ...
    /// QUADSPI_DCR Register bits
    namespace quadspi_dcr_bits {
    ...
    /// QUADSPI_SR Register bits
    namespace quadspi_sr_bits {
    ...
    /// QUADSPI_FCR Register bits
    namespace quadspi_fcr_bits {
    ...
    /// QUADSPI_DLR Register bits
    namespace quadspi_dlr_bits {
    ...
    /// QUADSPI_CCR Register bits
    namespace quadspi_ccr_bits {
    ...
    /// QUADSPI_AR Register bits
    namespace quadspi_ar_bits {
    ...
    /// QUADSPI_ABR Register bits
    namespace quadspi_abr_bits {
    ...
    /// QUADSPI_DR Register bits
    namespace quadspi_dr_bits {
    ...
    /// QUADSPI_PSMKR Register bits
    namespace quadspi_psmkr_bits {
    ...
    /// QUADSPI_PSMAR Register bits
    namespace quadspi_psmar_bits {
    ...
    /// QUADSPI_PIR Register bits
    namespace quadspi_pir_bits {
    ...
    /// QUADSPI_LPTR Register bits
    namespace quadspi_lptr_bits {
...
namespace pwr {
    ...
    struct Registers {
        ...
        volatile uint32_t PWR_CSR1;  ///< Offset: 0x04 - PWR control status register 1
        volatile uint32_t PWR_CR2;  ///< Offset: 0x08 - This register is not reset by wakeup from Standby mode,...
        volatile uint32_t PWR_CR3;  ///< Offset: 0x0C - Reset only by POR only, not reset by wakeup from Standby...
        volatile uint32_t PWR_CPUCR;  ///< Offset: 0x10 - This register allows controlling CPU1 power.
        volatile uint32_t PWR_D3CR;  ///< Offset: 0x18 - This register allows controlling D3 domain...
        volatile uint32_t PWR_WKUPCR;  ///< Offset: 0x20 - reset only by system reset, not reset by wakeup from...
        volatile uint32_t PWR_WKUPFR;  ///< Offset: 0x24 - reset only by system reset, not reset by wakeup from Standby mode
        volatile uint32_t PWR_WKUPEPR;  ///< Offset: 0x28 - Reset only by system reset, not reset by wakeup from Standby mode
    };
    ...
    namespace pwr_cr3_bits {
        ...
        constexpr uint32_t SDEN = (1U << 2);  ///< SD converter Enable
    ...
    /// PWR_CPUCR Register bits
    namespace pwr_cpucr_bits {
    ...
    /// PWR_D3CR Register bits
    namespace pwr_d3cr_bits {
    ...
    /// PWR_WKUPCR Register bits
    namespace pwr_wkupcr_bits {
        constexpr uint32_t WKUPC = (6 << 0);  ///< Clear Wakeup pin flag for WKUP. These bits are always read as 0.
    }

    /// PWR_WKUPFR Register bits
    namespace pwr_wkupfr_bits {
    ...
    /// PWR_WKUPEPR Register bits
    namespace pwr_wkupepr_bits {
...
namespace adc {
    ...
    namespace cfgr_bits {
        ...
        constexpr uint32_t RES = (2 << 2);  ///< ADC data resolution
    ...
    namespace ccr_bits {
        ...
        constexpr uint32_t VSENSEEN = (1U << 23);  ///< Temperature sensor enable
...
namespace rcc {
    ...
    namespace apb1lrstr_bits {
        ...
        constexpr uint32_t HDMICECRST = (1U << 27);  ///< HDMI-CEC block reset
    ...
    namespace d3amr_bits {
        ...
        constexpr uint32_t BKPSRAMAMEN = (1U << 28);  ///< Backup RAM Autonomous mode enable
...
namespace eth {
    ...
    struct Registers {
        volatile uint32_t DMAMR;  ///< Offset: 0x00 - DMA mode register
        volatile uint32_t DMASBMR;  ///< Offset: 0x04 - System bus mode register
        volatile uint32_t DMAISR;  ///< Offset: 0x08 - Interrupt status register
        volatile uint32_t DMADSR;  ///< Offset: 0x0C - Debug status register
        volatile uint32_t DMACCR;  ///< Offset: 0x100 - Channel control register
        volatile uint32_t DMACTxCR;  ///< Offset: 0x104 - Channel transmit control register
        volatile uint32_t DMACRxCR;  ///< Offset: 0x108 - Channel receive control register
        volatile uint32_t DMACTxDLAR;  ///< Offset: 0x114 - Channel Tx descriptor list address register
        volatile uint32_t DMACRxDLAR;  ///< Offset: 0x11C - Channel Rx descriptor list address register
        volatile uint32_t DMACTxDTPR;  ///< Offset: 0x120 - Channel Tx descriptor tail pointer register
        volatile uint32_t DMACRxDTPR;  ///< Offset: 0x128 - Channel Rx descriptor tail pointer register
        volatile uint32_t DMACTxRLR;  ///< Offset: 0x12C - Channel Tx descriptor ring length register
        volatile uint32_t DMACRxRLR;  ///< Offset: 0x130 - Channel Rx descriptor ring length register
        volatile uint32_t DMACIER;  ///< Offset: 0x134 - Channel interrupt enable register
        volatile uint32_t DMACRxIWTR;  ///< Offset: 0x138 - Channel Rx interrupt watchdog timer register
        volatile uint32_t DMACCATxDR;  ///< Offset: 0x144 - Channel current application transmit descriptor register
        volatile uint32_t DMACCARxDR;  ///< Offset: 0x14C - Channel current application receive descriptor register
        volatile uint32_t DMACCATxBR;  ///< Offset: 0x154 - Channel current application transmit buffer register
        volatile uint32_t DMACCARxBR;  ///< Offset: 0x15C - Channel current application receive buffer register
        volatile uint32_t DMACSR;  ///< Offset: 0x160 - Channel status register
        volatile uint32_t DMACMFCR;  ///< Offset: 0x16C - Channel missed frame count register
    };
    ...
    // Bit definitions
    /// DMAMR Register bits
    namespace dmamr_bits {
        constexpr uint32_t SWR = (1U << 0);  ///< Software Reset
        constexpr uint32_t DA = (1U << 1);  ///< DMA Tx or Rx Arbitration Scheme
        constexpr uint32_t TXPR = (1U << 11);  ///< Transmit priority
        constexpr uint32_t PR = (3 << 12);  ///< Priority ratio
        constexpr uint32_t INTM = (1U << 16);  ///< Interrupt Mode
    }

    /// DMASBMR Register bits
    namespace dmasbmr_bits {
        constexpr uint32_t FB = (1U << 0);  ///< Fixed Burst Length
        constexpr uint32_t AAL = (1U << 12);  ///< Address-Aligned Beats
        constexpr uint32_t MB = (1U << 14);  ///< Mixed Burst
        constexpr uint32_t RB = (1U << 15);  ///< Rebuild INCRx Burst
    }

    /// DMAISR Register bits
    namespace dmaisr_bits {
        constexpr uint32_t DC0IS = (1U << 0);  ///< DMA Channel Interrupt Status
        constexpr uint32_t MTLIS = (1U << 16);  ///< MTL Interrupt Status
        constexpr uint32_t MACIS = (1U << 17);  ///< MAC Interrupt Status
    }

    /// DMADSR Register bits
    namespace dmadsr_bits {
        constexpr uint32_t AXWHSTS = (1U << 0);  ///< AHB Master Write Channel
        constexpr uint32_t RPS0 = (4 << 8);  ///< DMA Channel Receive Process State
        constexpr uint32_t TPS0 = (4 << 12);  ///< DMA Channel Transmit Process State
    }

    /// DMACCR Register bits
    namespace dmaccr_bits {
        constexpr uint32_t MSS = (14 << 0);  ///< Maximum Segment Size
        constexpr uint32_t PBLX8 = (1U << 16);  ///< 8xPBL mode
        constexpr uint32_t DSL = (3 << 18);  ///< Descriptor Skip Length
    }

    /// DMACTxCR Register bits
    namespace dmactxcr_bits {
        constexpr uint32_t ST = (1U << 0);  ///< Start or Stop Transmission Command
        constexpr uint32_t OSF = (1U << 4);  ///< Operate on Second Packet
        constexpr uint32_t TSE = (1U << 12);  ///< TCP Segmentation Enabled
        constexpr uint32_t TXPBL = (6 << 16);  ///< Transmit Programmable Burst Length
    }

    /// DMACRxCR Register bits
    namespace dmacrxcr_bits {
        constexpr uint32_t SR = (1U << 0);  ///< Start or Stop Receive Command
        constexpr uint32_t RBSZ = (14 << 1);  ///< Receive Buffer size
        constexpr uint32_t RXPBL = (6 << 16);  ///< RXPBL
        constexpr uint32_t RPF = (1U << 31);  ///< DMA Rx Channel Packet Flush
    }

    /// DMACTxDLAR Register bits
    namespace dmactxdlar_bits {
        constexpr uint32_t TDESLA = (30 << 2);  ///< Start of Transmit List
    }

    /// DMACRxDLAR Register bits
    namespace dmacrxdlar_bits {
        constexpr uint32_t RDESLA = (30 << 2);  ///< Start of Receive List
    }

    /// DMACTxDTPR Register bits
    namespace dmactxdtpr_bits {
        constexpr uint32_t TDT = (30 << 2);  ///< Transmit Descriptor Tail Pointer
    }

    /// DMACRxDTPR Register bits
    namespace dmacrxdtpr_bits {
        constexpr uint32_t RDT = (30 << 2);  ///< Receive Descriptor Tail Pointer
    }

    /// DMACTxRLR Register bits
    namespace dmactxrlr_bits {
        constexpr uint32_t TDRL = (10 << 0);  ///< Transmit Descriptor Ring Length
    }

    /// DMACRxRLR Register bits
    namespace dmacrxrlr_bits {
        constexpr uint32_t RDRL = (10 << 0);  ///< Receive Descriptor Ring Length
    }

    /// DMACIER Register bits
    namespace dmacier_bits {
        constexpr uint32_t TIE = (1U << 0);  ///< Transmit Interrupt Enable
        constexpr uint32_t TXSE = (1U << 1);  ///< Transmit Stopped Enable
        constexpr uint32_t TBUE = (1U << 2);  ///< Transmit Buffer Unavailable Enable
        constexpr uint32_t RIE = (1U << 6);  ///< Receive Interrupt Enable
        constexpr uint32_t RBUE = (1U << 7);  ///< Receive Buffer Unavailable Enable
        constexpr uint32_t RSE = (1U << 8);  ///< Receive Stopped Enable
        constexpr uint32_t RWTE = (1U << 9);  ///< Receive Watchdog Timeout Enable
        constexpr uint32_t ETIE = (1U << 10);  ///< Early Transmit Interrupt Enable
        constexpr uint32_t ERIE = (1U << 11);  ///< Early Receive Interrupt Enable
        constexpr uint32_t FBEE = (1U << 12);  ///< Fatal Bus Error Enable
        constexpr uint32_t CDEE = (1U << 13);  ///< Context Descriptor Error Enable
        constexpr uint32_t AIE = (1U << 14);  ///< Abnormal Interrupt Summary Enable
        constexpr uint32_t NIE = (1U << 15);  ///< Normal Interrupt Summary Enable
    }

    /// DMACRxIWTR Register bits
    namespace dmacrxiwtr_bits {
        constexpr uint32_t RWT = (8 << 0);  ///< Receive Interrupt Watchdog Timer Count
    }

    /// DMACCATxDR Register bits
    namespace dmaccatxdr_bits {
        constexpr uint32_t CURTDESAPTR = (32 << 0);  ///< Application Transmit Descriptor Address Pointer
    }

    /// DMACCARxDR Register bits
    namespace dmaccarxdr_bits {
        constexpr uint32_t CURRDESAPTR = (32 << 0);  ///< Application Receive Descriptor Address Pointer
    }

    /// DMACCATxBR Register bits
    namespace dmaccatxbr_bits {
        constexpr uint32_t CURTBUFAPTR = (32 << 0);  ///< Application Transmit Buffer Address Pointer
    }

    /// DMACCARxBR Register bits
    namespace dmaccarxbr_bits {
        constexpr uint32_t CURRBUFAPTR = (32 << 0);  ///< Application Receive Buffer Address Pointer
    }

    /// DMACSR Register bits
    namespace dmacsr_bits {
        constexpr uint32_t TI = (1U << 0);  ///< Transmit Interrupt
        constexpr uint32_t TPS = (1U << 1);  ///< Transmit Process Stopped
        constexpr uint32_t TBU = (1U << 2);  ///< Transmit Buffer Unavailable
        constexpr uint32_t RI = (1U << 6);  ///< Receive Interrupt
        constexpr uint32_t RBU = (1U << 7);  ///< Receive Buffer Unavailable
        constexpr uint32_t RPS = (1U << 8);  ///< Receive Process Stopped
        constexpr uint32_t RWT = (1U << 9);  ///< Receive Watchdog Timeout
        constexpr uint32_t ET = (1U << 10);  ///< Early Transmit Interrupt
        constexpr uint32_t ER = (1U << 11);  ///< Early Receive Interrupt
        constexpr uint32_t FBE = (1U << 12);  ///< Fatal Bus Error
        constexpr uint32_t CDE = (1U << 13);  ///< Context Descriptor Error
        constexpr uint32_t AIS = (1U << 14);  ///< Abnormal Interrupt Summary
        constexpr uint32_t NIS = (1U << 15);  ///< Normal Interrupt Summary
        constexpr uint32_t TEB = (3 << 16);  ///< Tx DMA Error Bits
        constexpr uint32_t REB = (3 << 19);  ///< Rx DMA Error Bits
    }

    /// DMACMFCR Register bits
    namespace dmacmfcr_bits {
        constexpr uint32_t MFC = (11 << 0);  ///< Dropped Packet Counters
        constexpr uint32_t MFCO = (1U << 15);  ///< Overflow status of the MFC Counter
    }
...
namespace dfsdm {
    ...
    struct Registers {
        ...
        volatile uint32_t CH0DLYR;  ///< Offset: 0x14 - channel y delay register
        volatile uint32_t CH1CFGR1;  ///< Offset: 0x20 - CH1CFGR1
        volatile uint32_t CH1CFGR2;  ///< Offset: 0x24 - CH1CFGR2
        volatile uint32_t CH1AWSCDR;  ///< Offset: 0x28 - CH1AWSCDR
        volatile uint32_t CH1WDATR;  ///< Offset: 0x2C - CH1WDATR
        volatile uint32_t CH1DATINR;  ///< Offset: 0x30 - CH1DATINR
        volatile uint32_t CH1DLYR;  ///< Offset: 0x34 - channel y delay register
        volatile uint32_t CH2CFGR1;  ///< Offset: 0x40 - CH2CFGR1
        volatile uint32_t CH2CFGR2;  ///< Offset: 0x44 - CH2CFGR2
        volatile uint32_t CH2AWSCDR;  ///< Offset: 0x48 - CH2AWSCDR
        volatile uint32_t CH2WDATR;  ///< Offset: 0x4C - CH2WDATR
        volatile uint32_t CH2DATINR;  ///< Offset: 0x50 - CH2DATINR
        volatile uint32_t CH2DLYR;  ///< Offset: 0x54 - channel y delay register
        volatile uint32_t CH3CFGR1;  ///< Offset: 0x60 - CH3CFGR1
        volatile uint32_t CH3CFGR2;  ///< Offset: 0x64 - CH3CFGR2
        volatile uint32_t CH3AWSCDR;  ///< Offset: 0x68 - CH3AWSCDR
        volatile uint32_t CH3WDATR;  ///< Offset: 0x6C - CH3WDATR
        volatile uint32_t CH3DATINR;  ///< Offset: 0x70 - CH3DATINR
        volatile uint32_t CH3DLYR;  ///< Offset: 0x74 - channel y delay register
        volatile uint32_t CH4CFGR1;  ///< Offset: 0x80 - CH4CFGR1
        volatile uint32_t CH4CFGR2;  ///< Offset: 0x84 - CH4CFGR2
        volatile uint32_t CH4AWSCDR;  ///< Offset: 0x88 - CH4AWSCDR
        volatile uint32_t CH4WDATR;  ///< Offset: 0x8C - CH4WDATR
        volatile uint32_t CH4DATINR;  ///< Offset: 0x90 - CH4DATINR
        volatile uint32_t CH4DLYR;  ///< Offset: 0x94 - channel y delay register
        volatile uint32_t CH5CFGR1;  ///< Offset: 0xA0 - CH5CFGR1
        volatile uint32_t CH5CFGR2;  ///< Offset: 0xA4 - CH5CFGR2
        volatile uint32_t CH5AWSCDR;  ///< Offset: 0xA8 - CH5AWSCDR
        volatile uint32_t CH5WDATR;  ///< Offset: 0xAC - CH5WDATR
        volatile uint32_t CH5DATINR;  ///< Offset: 0xB0 - CH5DATINR
        volatile uint32_t CH5DLYR;  ///< Offset: 0xB4 - channel y delay register
        volatile uint32_t CH6CFGR1;  ///< Offset: 0xC0 - CH6CFGR1
        volatile uint32_t CH6CFGR2;  ///< Offset: 0xC4 - CH6CFGR2
        volatile uint32_t CH6AWSCDR;  ///< Offset: 0xC8 - CH6AWSCDR
        volatile uint32_t CH6WDATR;  ///< Offset: 0xCC - CH6WDATR
        volatile uint32_t CH6DATINR;  ///< Offset: 0xD0 - CH6DATINR
        volatile uint32_t CH6DLYR;  ///< Offset: 0xD4 - channel y delay register
        volatile uint32_t CH7CFGR1;  ///< Offset: 0xE0 - CH7CFGR1
        volatile uint32_t CH7CFGR2;  ///< Offset: 0xE4 - CH7CFGR2
        volatile uint32_t CH7AWSCDR;  ///< Offset: 0xE8 - CH7AWSCDR
        volatile uint32_t CH7WDATR;  ///< Offset: 0xEC - CH7WDATR
        volatile uint32_t CH7DATINR;  ///< Offset: 0xF0 - CH7DATINR
        volatile uint32_t CH7DLYR;  ///< Offset: 0xF4 - channel y delay register
        volatile uint32_t DFSDM_FLT0CR1;  ///< Offset: 0x100 - control register 1
        volatile uint32_t DFSDM_FLT0CR2;  ///< Offset: 0x104 - control register 2
        volatile uint32_t DFSDM_FLT0ISR;  ///< Offset: 0x108 - interrupt and status register
        volatile uint32_t DFSDM_FLT0ICR;  ///< Offset: 0x10C - interrupt flag clear register
        volatile uint32_t DFSDM_FLT0JCHGR;  ///< Offset: 0x110 - injected channel group selection register
        volatile uint32_t DFSDM_FLT0FCR;  ///< Offset: 0x114 - filter control register
        volatile uint32_t DFSDM_FLT0JDATAR;  ///< Offset: 0x118 - data register for injected group
        volatile uint32_t DFSDM_FLT0RDATAR;  ///< Offset: 0x11C - data register for the regular channel
        volatile uint32_t DFSDM_FLT0AWHTR;  ///< Offset: 0x120 - analog watchdog high threshold register
        volatile uint32_t DFSDM_FLT0AWLTR;  ///< Offset: 0x124 - analog watchdog low threshold register
        volatile uint32_t DFSDM_FLT0AWSR;  ///< Offset: 0x128 - analog watchdog status register
        volatile uint32_t DFSDM_FLT0AWCFR;  ///< Offset: 0x12C - analog watchdog clear flag register
        volatile uint32_t DFSDM_FLT0EXMAX;  ///< Offset: 0x130 - Extremes detector maximum register
        volatile uint32_t DFSDM_FLT0EXMIN;  ///< Offset: 0x134 - Extremes detector minimum register
        volatile uint32_t DFSDM_FLT0CNVTIMR;  ///< Offset: 0x138 - conversion timer register
        volatile uint32_t DFSDM_FLT1CR1;  ///< Offset: 0x180 - control register 1
        volatile uint32_t DFSDM_FLT1CR2;  ///< Offset: 0x184 - control register 2
        volatile uint32_t DFSDM_FLT1ISR;  ///< Offset: 0x188 - interrupt and status register
        volatile uint32_t DFSDM_FLT1ICR;  ///< Offset: 0x18C - interrupt flag clear register
        volatile uint32_t DFSDM_FLT1CHGR;  ///< Offset: 0x190 - injected channel group selection register
        volatile uint32_t DFSDM_FLT1FCR;  ///< Offset: 0x194 - filter control register
        volatile uint32_t DFSDM_FLT1JDATAR;  ///< Offset: 0x198 - data register for injected group
        volatile uint32_t DFSDM_FLT1RDATAR;  ///< Offset: 0x19C - data register for the regular channel
        volatile uint32_t DFSDM_FLT1AWHTR;  ///< Offset: 0x1A0 - analog watchdog high threshold register
        volatile uint32_t DFSDM_FLT1AWLTR;  ///< Offset: 0x1A4 - analog watchdog low threshold register
        volatile uint32_t DFSDM_FLT1AWSR;  ///< Offset: 0x1A8 - analog watchdog status register
        volatile uint32_t DFSDM_FLT1AWCFR;  ///< Offset: 0x1AC - analog watchdog clear flag register
        volatile uint32_t DFSDM_FLT1EXMAX;  ///< Offset: 0x1B0 - Extremes detector maximum register
        volatile uint32_t DFSDM_FLT1EXMIN;  ///< Offset: 0x1B4 - Extremes detector minimum register
        volatile uint32_t DFSDM_FLT1CNVTIMR;  ///< Offset: 0x1B8 - conversion timer register
        volatile uint32_t DFSDM_FLT2CR1;  ///< Offset: 0x200 - control register 1
        volatile uint32_t DFSDM_FLT2CR2;  ///< Offset: 0x204 - control register 2
        volatile uint32_t DFSDM_FLT2ISR;  ///< Offset: 0x208 - interrupt and status register
        volatile uint32_t DFSDM_FLT2ICR;  ///< Offset: 0x20C - interrupt flag clear register
        volatile uint32_t DFSDM_FLT2JCHGR;  ///< Offset: 0x210 - injected channel group selection register
        volatile uint32_t DFSDM_FLT2FCR;  ///< Offset: 0x214 - filter control register
        volatile uint32_t DFSDM_FLT2JDATAR;  ///< Offset: 0x218 - data register for injected group
        volatile uint32_t DFSDM_FLT2RDATAR;  ///< Offset: 0x21C - data register for the regular channel
        volatile uint32_t DFSDM_FLT2AWHTR;  ///< Offset: 0x220 - analog watchdog high threshold register
        volatile uint32_t DFSDM_FLT2AWLTR;  ///< Offset: 0x224 - analog watchdog low threshold register
        volatile uint32_t DFSDM_FLT2AWSR;  ///< Offset: 0x228 - analog watchdog status register
        volatile uint32_t DFSDM_FLT2AWCFR;  ///< Offset: 0x22C - analog watchdog clear flag register
        volatile uint32_t DFSDM_FLT2EXMAX;  ///< Offset: 0x230 - Extremes detector maximum register
        volatile uint32_t DFSDM_FLT2EXMIN;  ///< Offset: 0x234 - Extremes detector minimum register
        volatile uint32_t DFSDM_FLT2CNVTIMR;  ///< Offset: 0x238 - conversion timer register
        volatile uint32_t DFSDM_FLT3CR1;  ///< Offset: 0x280 - control register 1
        volatile uint32_t DFSDM_FLT3CR2;  ///< Offset: 0x284 - control register 2
        volatile uint32_t DFSDM_FLT3ISR;  ///< Offset: 0x288 - interrupt and status register
        volatile uint32_t DFSDM_FLT3ICR;  ///< Offset: 0x28C - interrupt flag clear register
        volatile uint32_t DFSDM_FLT3JCHGR;  ///< Offset: 0x290 - injected channel group selection register
        volatile uint32_t DFSDM_FLT3FCR;  ///< Offset: 0x294 - filter control register
        volatile uint32_t DFSDM_FLT3JDATAR;  ///< Offset: 0x298 - data register for injected group
        volatile uint32_t DFSDM_FLT3RDATAR;  ///< Offset: 0x29C - data register for the regular channel
        volatile uint32_t DFSDM_FLT3AWHTR;  ///< Offset: 0x2A0 - analog watchdog high threshold register
        volatile uint32_t DFSDM_FLT3AWLTR;  ///< Offset: 0x2A4 - analog watchdog low threshold register
        volatile uint32_t DFSDM_FLT3AWSR;  ///< Offset: 0x2A8 - analog watchdog status register
        volatile uint32_t DFSDM_FLT3AWCFR;  ///< Offset: 0x2AC - analog watchdog clear flag register
        volatile uint32_t DFSDM_FLT3EXMAX;  ///< Offset: 0x2B0 - Extremes detector maximum register
        volatile uint32_t DFSDM_FLT3EXMIN;  ///< Offset: 0x2B4 - Extremes detector minimum register
        volatile uint32_t DFSDM_FLT3CNVTIMR;  ///< Offset: 0x2B8 - conversion timer register
    };
    ...
    /// DFSDM_FLT0CR1 Register bits
    namespace dfsdm_flt0cr1_bits {
    ...
    /// DFSDM_FLT0CR2 Register bits
    namespace dfsdm_flt0cr2_bits {
    ...
    /// DFSDM_FLT0ISR Register bits
    namespace dfsdm_flt0isr_bits {
    ...
    /// DFSDM_FLT0ICR Register bits
    namespace dfsdm_flt0icr_bits {
    ...
    /// DFSDM_FLT0JCHGR Register bits
    namespace dfsdm_flt0jchgr_bits {
        constexpr uint32_t JCHG = (8 << 0);  ///< Injected channel group selection
    }

    /// DFSDM_FLT0FCR Register bits
    namespace dfsdm_flt0fcr_bits {
    ...
    /// DFSDM_FLT0JDATAR Register bits
    namespace dfsdm_flt0jdatar_bits {
    ...
    /// DFSDM_FLT0RDATAR Register bits
    namespace dfsdm_flt0rdatar_bits {
    ...
    /// DFSDM_FLT0AWHTR Register bits
    namespace dfsdm_flt0awhtr_bits {
    ...
    /// DFSDM_FLT0AWLTR Register bits
    namespace dfsdm_flt0awltr_bits {
    ...
    /// DFSDM_FLT0AWSR Register bits
    namespace dfsdm_flt0awsr_bits {
    ...
    /// DFSDM_FLT0AWCFR Register bits
    namespace dfsdm_flt0awcfr_bits {
    ...
    /// DFSDM_FLT0EXMAX Register bits
    namespace dfsdm_flt0exmax_bits {
    ...
    /// DFSDM_FLT1CR2 Register bits
    namespace dfsdm_flt1cr2_bits {
        constexpr uint32_t AWDCH = (8 << 16);  ///< Analog watchdog channel selection
        constexpr uint32_t EXCH = (8 << 8);  ///< Extremes detector channel selection
        constexpr uint32_t CKABIE = (1U << 6);  ///< Clock absence interrupt enable
        constexpr uint32_t SCDIE = (1U << 5);  ///< Short-circuit detector interrupt enable
    ...
    /// DFSDM_FLT1ISR Register bits
    namespace dfsdm_flt1isr_bits {
        constexpr uint32_t SCDF = (8 << 24);  ///< short-circuit detector flag
        constexpr uint32_t CKABF = (8 << 16);  ///< Clock absence flag
        constexpr uint32_t RCIP = (1U << 14);  ///< Regular conversion in progress status
        constexpr uint32_t JCIP = (1U << 13);  ///< Injected conversion in progress status
    ...
    /// DFSDM_FLT1ICR Register bits
    namespace dfsdm_flt1icr_bits {
        constexpr uint32_t CLRSCDF = (8 << 24);  ///< Clear the short-circuit detector flag
        constexpr uint32_t CLRCKABF = (8 << 16);  ///< Clear the clock absence flag
        constexpr uint32_t CLRROVRF = (1U << 3);  ///< Clear the regular conversion overrun flag
        constexpr uint32_t CLRJOVRF = (1U << 2);  ///< Clear the injected conversion overrun flag
    ...
    /// DFSDM_FLT1CHGR Register bits
    namespace dfsdm_flt1chgr_bits {
        constexpr uint32_t JCHG = (8 << 0);  ///< Injected channel group selection
    }

    /// DFSDM_FLT1FCR Register bits
    namespace dfsdm_flt1fcr_bits {
        constexpr uint32_t FORD = (3 << 29);  ///< Sinc filter order
        constexpr uint32_t FOSR = (10 << 16);  ///< Sinc filter oversampling ratio (decimation rate)
        constexpr uint32_t IOSR = (8 << 0);  ///< Integrator oversampling ratio (averaging length)
    }

    /// DFSDM_FLT1JDATAR Register bits
    namespace dfsdm_flt1jdatar_bits {
        constexpr uint32_t JDATA = (24 << 8);  ///< Injected group conversion data
        constexpr uint32_t JDATACH = (3 << 0);  ///< Injected channel most recently converted
    }

    /// DFSDM_FLT1RDATAR Register bits
    namespace dfsdm_flt1rdatar_bits {
        constexpr uint32_t RDATA = (24 << 8);  ///< Regular channel conversion data
        constexpr uint32_t RPEND = (1U << 4);  ///< Regular channel pending data
        constexpr uint32_t RDATACH = (3 << 0);  ///< Regular channel most recently converted
    }

    /// DFSDM_FLT1AWHTR Register bits
    namespace dfsdm_flt1awhtr_bits {
        constexpr uint32_t AWHT = (24 << 8);  ///< Analog watchdog high threshold
        constexpr uint32_t BKAWH = (4 << 0);  ///< Break signal assignment to analog watchdog high threshold event
    }

    /// DFSDM_FLT1AWLTR Register bits
    namespace dfsdm_flt1awltr_bits {
        constexpr uint32_t AWLT = (24 << 8);  ///< Analog watchdog low threshold
        constexpr uint32_t BKAWL = (4 << 0);  ///< Break signal assignment to analog watchdog low threshold event
    }

    /// DFSDM_FLT1AWSR Register bits
    namespace dfsdm_flt1awsr_bits {
        constexpr uint32_t AWHTF = (8 << 8);  ///< Analog watchdog high threshold flag
        constexpr uint32_t AWLTF = (8 << 0);  ///< Analog watchdog low threshold flag
    }

    /// DFSDM_FLT1AWCFR Register bits
    namespace dfsdm_flt1awcfr_bits {
        constexpr uint32_t CLRAWHTF = (8 << 8);  ///< Clear the analog watchdog high threshold flag
        constexpr uint32_t CLRAWLTF = (8 << 0);  ///< Clear the analog watchdog low threshold flag
    }

    /// DFSDM_FLT1EXMAX Register bits
    namespace dfsdm_flt1exmax_bits {
        constexpr uint32_t EXMAX = (24 << 8);  ///< Extremes detector maximum value
        constexpr uint32_t EXMAXCH = (3 << 0);  ///< Extremes detector maximum data channel
    }

    /// DFSDM_FLT1EXMIN Register bits
    namespace dfsdm_flt1exmin_bits {
        constexpr uint32_t EXMIN = (24 << 8);  ///< EXMIN
        constexpr uint32_t EXMINCH = (3 << 0);  ///< Extremes detector minimum data channel
    }

    /// DFSDM_FLT1CNVTIMR Register bits
    namespace dfsdm_flt1cnvtimr_bits {
        constexpr uint32_t CNVCNT = (28 << 4);  ///< 28-bit timer counting conversion time t = CNVCNT[27:0] / fDFSDM_CKIN
    }

    /// DFSDM_FLT2CR1 Register bits
    namespace dfsdm_flt2cr1_bits {
        constexpr uint32_t AWFSEL = (1U << 30);  ///< Analog watchdog fast mode select
        constexpr uint32_t FAST = (1U << 29);  ///< Fast conversion mode selection for regular conversions
        constexpr uint32_t RCH = (3 << 24);  ///< Regular channel selection
        constexpr uint32_t RDMAEN = (1U << 21);  ///< DMA channel enabled to read data for the regular conversion
    ...
    /// DFSDM_FLT2CR2 Register bits
    namespace dfsdm_flt2cr2_bits {
        constexpr uint32_t AWDCH = (8 << 16);  ///< Analog watchdog channel selection
        constexpr uint32_t EXCH = (8 << 8);  ///< Extremes detector channel selection
        constexpr uint32_t CKABIE = (1U << 6);  ///< Clock absence interrupt enable
        constexpr uint32_t SCDIE = (1U << 5);  ///< Short-circuit detector interrupt enable
    ...
    /// DFSDM_FLT2ISR Register bits
    namespace dfsdm_flt2isr_bits {
        constexpr uint32_t SCDF = (8 << 24);  ///< short-circuit detector flag
        constexpr uint32_t CKABF = (8 << 16);  ///< Clock absence flag
        constexpr uint32_t RCIP = (1U << 14);  ///< Regular conversion in progress status
        constexpr uint32_t JCIP = (1U << 13);  ///< Injected conversion in progress status
    ...
    /// DFSDM_FLT2ICR Register bits
    namespace dfsdm_flt2icr_bits {
        constexpr uint32_t CLRSCDF = (8 << 24);  ///< Clear the short-circuit detector flag
        constexpr uint32_t CLRCKABF = (8 << 16);  ///< Clear the clock absence flag
        constexpr uint32_t CLRROVRF = (1U << 3);  ///< Clear the regular conversion overrun flag
        constexpr uint32_t CLRJOVRF = (1U << 2);  ///< Clear the injected conversion overrun flag
    ...
    /// DFSDM_FLT2JCHGR Register bits
    namespace dfsdm_flt2jchgr_bits {
        constexpr uint32_t JCHG = (8 << 0);  ///< Injected channel group selection
    }

    /// DFSDM_FLT2FCR Register bits
    namespace dfsdm_flt2fcr_bits {
        constexpr uint32_t FORD = (3 << 29);  ///< Sinc filter order
        constexpr uint32_t FOSR = (10 << 16);  ///< Sinc filter oversampling ratio (decimation rate)
        constexpr uint32_t IOSR = (8 << 0);  ///< Integrator oversampling ratio (averaging length)
    }

    /// DFSDM_FLT2JDATAR Register bits
    namespace dfsdm_flt2jdatar_bits {
        constexpr uint32_t JDATA = (24 << 8);  ///< Injected group conversion data
        constexpr uint32_t JDATACH = (3 << 0);  ///< Injected channel most recently converted
    }

    /// DFSDM_FLT2RDATAR Register bits
    namespace dfsdm_flt2rdatar_bits {
        constexpr uint32_t RDATA = (24 << 8);  ///< Regular channel conversion data
        constexpr uint32_t RPEND = (1U << 4);  ///< Regular channel pending data
        constexpr uint32_t RDATACH = (3 << 0);  ///< Regular channel most recently converted
    }

    /// DFSDM_FLT2AWHTR Register bits
    namespace dfsdm_flt2awhtr_bits {
        constexpr uint32_t AWHT = (24 << 8);  ///< Analog watchdog high threshold
        constexpr uint32_t BKAWH = (4 << 0);  ///< Break signal assignment to analog watchdog high threshold event
    }

    /// DFSDM_FLT2AWLTR Register bits
    namespace dfsdm_flt2awltr_bits {
        constexpr uint32_t AWLT = (24 << 8);  ///< Analog watchdog low threshold
        constexpr uint32_t BKAWL = (4 << 0);  ///< Break signal assignment to analog watchdog low threshold event
    }

    /// DFSDM_FLT2AWSR Register bits
    namespace dfsdm_flt2awsr_bits {
        constexpr uint32_t AWHTF = (8 << 8);  ///< Analog watchdog high threshold flag
        constexpr uint32_t AWLTF = (8 << 0);  ///< Analog watchdog low threshold flag
    }

    /// DFSDM_FLT2AWCFR Register bits
    namespace dfsdm_flt2awcfr_bits {
        constexpr uint32_t CLRAWHTF = (8 << 8);  ///< Clear the analog watchdog high threshold flag
        constexpr uint32_t CLRAWLTF = (8 << 0);  ///< Clear the analog watchdog low threshold flag
    }

    /// DFSDM_FLT2EXMAX Register bits
    namespace dfsdm_flt2exmax_bits {
        constexpr uint32_t EXMAX = (24 << 8);  ///< Extremes detector maximum value
        constexpr uint32_t EXMAXCH = (3 << 0);  ///< Extremes detector maximum data channel
    }

    /// DFSDM_FLT2EXMIN Register bits
    namespace dfsdm_flt2exmin_bits {
        constexpr uint32_t EXMIN = (24 << 8);  ///< EXMIN
        constexpr uint32_t EXMINCH = (3 << 0);  ///< Extremes detector minimum data channel
    }

    /// DFSDM_FLT2CNVTIMR Register bits
    namespace dfsdm_flt2cnvtimr_bits {
        constexpr uint32_t CNVCNT = (28 << 4);  ///< 28-bit timer counting conversion time t = CNVCNT[27:0] / fDFSDM_CKIN
    }

    /// DFSDM_FLT3CR1 Register bits
    namespace dfsdm_flt3cr1_bits {
        constexpr uint32_t AWFSEL = (1U << 30);  ///< Analog watchdog fast mode select
        constexpr uint32_t FAST = (1U << 29);  ///< Fast conversion mode selection for regular conversions
        constexpr uint32_t RCH = (3 << 24);  ///< Regular channel selection
        constexpr uint32_t RDMAEN = (1U << 21);  ///< DMA channel enabled to read data for the regular conversion
    ...
    /// DFSDM_FLT3CR2 Register bits
    namespace dfsdm_flt3cr2_bits {
        constexpr uint32_t AWDCH = (8 << 16);  ///< Analog watchdog channel selection
        constexpr uint32_t EXCH = (8 << 8);  ///< Extremes detector channel selection
        constexpr uint32_t CKABIE = (1U << 6);  ///< Clock absence interrupt enable
        constexpr uint32_t SCDIE = (1U << 5);  ///< Short-circuit detector interrupt enable
    ...
    /// DFSDM_FLT3ISR Register bits
    namespace dfsdm_flt3isr_bits {
        constexpr uint32_t SCDF = (8 << 24);  ///< short-circuit detector flag
        constexpr uint32_t CKABF = (8 << 16);  ///< Clock absence flag
        constexpr uint32_t RCIP = (1U << 14);  ///< Regular conversion in progress status
        constexpr uint32_t JCIP = (1U << 13);  ///< Injected conversion in progress status
    ...
    /// DFSDM_FLT3ICR Register bits
    namespace dfsdm_flt3icr_bits {
        constexpr uint32_t CLRSCDF = (8 << 24);  ///< Clear the short-circuit detector flag
        constexpr uint32_t CLRCKABF = (8 << 16);  ///< Clear the clock absence flag
        constexpr uint32_t CLRROVRF = (1U << 3);  ///< Clear the regular conversion overrun flag
        constexpr uint32_t CLRJOVRF = (1U << 2);  ///< Clear the injected conversion overrun flag
    ...
    /// DFSDM_FLT3JCHGR Register bits
    namespace dfsdm_flt3jchgr_bits {
        constexpr uint32_t JCHG = (8 << 0);  ///< Injected channel group selection
    }

    /// DFSDM_FLT3FCR Register bits
    namespace dfsdm_flt3fcr_bits {
        constexpr uint32_t FORD = (3 << 29);  ///< Sinc filter order
        constexpr uint32_t FOSR = (10 << 16);  ///< Sinc filter oversampling ratio (decimation rate)
        constexpr uint32_t IOSR = (8 << 0);  ///< Integrator oversampling ratio (averaging length)
    }

    /// DFSDM_FLT3JDATAR Register bits
    namespace dfsdm_flt3jdatar_bits {
        constexpr uint32_t JDATA = (24 << 8);  ///< Injected group conversion data
        constexpr uint32_t JDATACH = (3 << 0);  ///< Injected channel most recently converted
    }

    /// DFSDM_FLT3RDATAR Register bits
    namespace dfsdm_flt3rdatar_bits {
        constexpr uint32_t RDATA = (24 << 8);  ///< Regular channel conversion data
        constexpr uint32_t RPEND = (1U << 4);  ///< Regular channel pending data
        constexpr uint32_t RDATACH = (3 << 0);  ///< Regular channel most recently converted
    }

    /// DFSDM_FLT3AWHTR Register bits
    namespace dfsdm_flt3awhtr_bits {
        constexpr uint32_t AWHT = (24 << 8);  ///< Analog watchdog high threshold
        constexpr uint32_t BKAWH = (4 << 0);  ///< Break signal assignment to analog watchdog high threshold event
    }

    /// DFSDM_FLT3AWLTR Register bits
    namespace dfsdm_flt3awltr_bits {
        constexpr uint32_t AWLT = (24 << 8);  ///< Analog watchdog low threshold
        constexpr uint32_t BKAWL = (4 << 0);  ///< Break signal assignment to analog watchdog low threshold event
    }

    /// DFSDM_FLT3AWSR Register bits
    namespace dfsdm_flt3awsr_bits {
        constexpr uint32_t AWHTF = (8 << 8);  ///< Analog watchdog high threshold flag
        constexpr uint32_t AWLTF = (8 << 0);  ///< Analog watchdog low threshold flag
    }

    /// DFSDM_FLT3AWCFR Register bits
    namespace dfsdm_flt3awcfr_bits {
        constexpr uint32_t CLRAWHTF = (8 << 8);  ///< Clear the analog watchdog high threshold flag
        constexpr uint32_t CLRAWLTF = (8 << 0);  ///< Clear the analog watchdog low threshold flag
    }

    /// DFSDM_FLT3EXMAX Register bits
    namespace dfsdm_flt3exmax_bits {
        constexpr uint32_t EXMAX = (24 << 8);  ///< Extremes detector maximum value
        constexpr uint32_t EXMAXCH = (3 << 0);  ///< Extremes detector maximum data channel
    }

    /// DFSDM_FLT3EXMIN Register bits
    namespace dfsdm_flt3exmin_bits {
        constexpr uint32_t EXMIN = (24 << 8);  ///< EXMIN
        constexpr uint32_t EXMINCH = (3 << 0);  ///< Extremes detector minimum data channel
    }

    /// DFSDM_FLT3CNVTIMR Register bits
    namespace dfsdm_flt3cnvtimr_bits {
        constexpr uint32_t CNVCNT = (28 << 4);  ///< 28-bit timer counting conversion time t = CNVCNT[27:0] / fDFSDM_CKIN
    }
...
namespace dbgmcu {
    /// Base addresses
    constexpr uint32_t DBGMCU_BASE = 0x5C001000;

    /// DBGMCU Register structure
    struct Registers {
        volatile uint32_t IDC;  ///< Offset: 0x00 - DBGMCU Identity Code Register
        volatile uint32_t CR;  ///< Offset: 0x04 - DBGMCU Configuration Register
        volatile uint32_t APB3FZ1;  ///< Offset: 0x34 - DBGMCU APB3 peripheral freeze register
        volatile uint32_t APB1LFZ1;  ///< Offset: 0x3C - DBGMCU APB1L peripheral freeze register
        volatile uint32_t APB2FZ1;  ///< Offset: 0x4C - DBGMCU APB2 peripheral freeze register
        volatile uint32_t APB4FZ1;  ///< Offset: 0x54 - DBGMCU APB4 peripheral freeze register
    };
    ...
    /// IDC Register bits
    namespace idc_bits {
        constexpr uint32_t DEV_ID = (12 << 0);  ///< Device ID
        constexpr uint32_t REV_ID = (16 << 16);  ///< Revision
    }

    /// CR Register bits
    namespace cr_bits {
        constexpr uint32_t DBGSLEEP_D1 = (1U << 0);  ///< Allow D1 domain debug in Sleep mode
        constexpr uint32_t DBGSTOP_D1 = (1U << 1);  ///< Allow D1 domain debug in Stop mode
        constexpr uint32_t DBGSTBY_D1 = (1U << 2);  ///< Allow D1 domain debug in Standby mode
        constexpr uint32_t DBGSLEEP_D2 = (1U << 3);  ///< Allow D2 domain debug in Sleep mode
        constexpr uint32_t DBGSTOP_D2 = (1U << 4);  ///< Allow D2 domain debug in Stop mode
        constexpr uint32_t DBGSTBY_D2 = (1U << 5);  ///< Allow D2 domain debug in Standby mode
        constexpr uint32_t DBGSTOP_D3 = (1U << 7);  ///< Allow debug in D3 Stop mode
        constexpr uint32_t DBGSTBY_D3 = (1U << 8);  ///< Allow debug in D3 Standby mode
        constexpr uint32_t TRACECLKEN = (1U << 20);  ///< Trace port clock enable
        constexpr uint32_t D1DBGCKEN = (1U << 21);  ///< D1 debug clock enable
        constexpr uint32_t D3DBGCKEN = (1U << 22);  ///< D3 debug clock enable
        constexpr uint32_t TRGOEN = (1U << 28);  ///< External trigger output enable
    }

    /// APB3FZ1 Register bits
    namespace apb3fz1_bits {
        constexpr uint32_t WWDG1 = (1U << 6);  ///< WWDG1 stop in debug
    }

    /// APB1LFZ1 Register bits
    namespace apb1lfz1_bits {
        constexpr uint32_t DBG_TIM2 = (1U << 0);  ///< TIM2 stop in debug
        constexpr uint32_t DBG_TIM3 = (1U << 1);  ///< TIM3 stop in debug
        constexpr uint32_t DBG_TIM4 = (1U << 2);  ///< TIM4 stop in debug
        constexpr uint32_t DBG_TIM5 = (1U << 3);  ///< TIM5 stop in debug
        constexpr uint32_t DBG_TIM6 = (1U << 4);  ///< TIM6 stop in debug
        constexpr uint32_t DBG_TIM7 = (1U << 5);  ///< TIM7 stop in debug
        constexpr uint32_t DBG_TIM12 = (1U << 6);  ///< TIM12 stop in debug
        constexpr uint32_t DBG_TIM13 = (1U << 7);  ///< TIM13 stop in debug
        constexpr uint32_t DBG_TIM14 = (1U << 8);  ///< TIM14 stop in debug
        constexpr uint32_t DBG_LPTIM1 = (1U << 9);  ///< LPTIM1 stop in debug
        constexpr uint32_t DBG_I2C1 = (1U << 21);  ///< I2C1 SMBUS timeout stop in debug
        constexpr uint32_t DBG_I2C2 = (1U << 22);  ///< I2C2 SMBUS timeout stop in debug
        constexpr uint32_t DBG_I2C3 = (1U << 23);  ///< I2C3 SMBUS timeout stop in debug
    }

    /// APB2FZ1 Register bits
    namespace apb2fz1_bits {
        constexpr uint32_t DBG_TIM1 = (1U << 0);  ///< TIM1 stop in debug
        constexpr uint32_t DBG_TIM8 = (1U << 1);  ///< TIM8 stop in debug
        constexpr uint32_t DBG_TIM15 = (1U << 16);  ///< TIM15 stop in debug
        constexpr uint32_t DBG_TIM16 = (1U << 17);  ///< TIM16 stop in debug
        constexpr uint32_t DBG_TIM17 = (1U << 18);  ///< TIM17 stop in debug
        constexpr uint32_t DBG_HRTIM = (1U << 29);  ///< HRTIM stop in debug
    }

    /// APB4FZ1 Register bits
    namespace apb4fz1_bits {
        constexpr uint32_t DBG_I2C4 = (1U << 7);  ///< I2C4 SMBUS timeout stop in debug
        constexpr uint32_t DBG_LPTIM2 = (1U << 9);  ///< LPTIM2 stop in debug
        constexpr uint32_t DBG_LPTIM3 = (1U << 10);  ///< LPTIM2 stop in debug
        constexpr uint32_t DBG_LPTIM4 = (1U << 11);  ///< LPTIM4 stop in debug
        constexpr uint32_t DBG_LPTIM5 = (1U << 12);  ///< LPTIM5 stop in debug
        constexpr uint32_t DBG_RTC = (1U << 16);  ///< RTC stop in debug
        constexpr uint32_t DBG_WDGLSD1 = (1U << 18);  ///< Independent watchdog for D1 stop in debug
    }
