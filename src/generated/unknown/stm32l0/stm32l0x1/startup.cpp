...
extern "C" {
    ...
    void DMA1_Channel4_7_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void USART4_USART5_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void AES_RNG_LPUART1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}