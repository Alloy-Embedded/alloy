/// Auto-generated code for STM32L15xxxA
...
namespace alloy::generated::stm32l15xxxa {
...
namespace rcc {
    ...
    namespace cir_bits {
        ...
        constexpr uint32_t LSECSSC = (1U << 22);  ///< LSE CSS interrupt clear
        ...
        constexpr uint32_t LSECSSIE = (1U << 14);  ///< LSE CSS interrupt enable
        ...
        constexpr uint32_t LSECSSF = (1U << 6);  ///< LSE CSS Interrupt flag
    ...
    namespace csr_bits {
        ...
        constexpr uint32_t OBLRSTF = (1U << 25);  ///< Options bytes loading reset flag
        ...
        constexpr uint32_t LSECSSD = (1U << 12);  ///< CSS on LSE failure Detection
        constexpr uint32_t LSECSSON = (1U << 11);  ///< CSS on LSE enable
...
namespace ri {
    ...
    struct Registers {
        volatile uint32_t ICR;  ///< Offset: 0x00 - RI input capture register
        volatile uint32_t ASCR1;  ///< Offset: 0x04 - RI analog switches control register 1
        volatile uint32_t ASCR2;  ///< Offset: 0x08 - RI analog switches control register 2
        volatile uint32_t HYSCR1;  ///< Offset: 0x0C - RI hysteresis control register 1
        volatile uint32_t HYSCR2;  ///< Offset: 0x10 - RI hysteresis control register 2
        volatile uint32_t HYSCR3;  ///< Offset: 0x14 - RI hysteresis control register 3
        volatile uint32_t HYSCR4;  ///< Offset: 0x18 - Hysteresis control register
        volatile uint32_t ASMR1;  ///< Offset: 0x1C - Analog switch mode register
        volatile uint32_t CMR1;  ///< Offset: 0x20 - Channel mask register
        volatile uint32_t CICR1;  ///< Offset: 0x24 - Channel identification for capture register
        volatile uint32_t ASMR2;  ///< Offset: 0x28 - Analog switch mode register
        volatile uint32_t CMR2;  ///< Offset: 0x2C - Channel mask register
        volatile uint32_t CICR2;  ///< Offset: 0x30 - Channel identification for capture register
        volatile uint32_t ASMR3;  ///< Offset: 0x34 - Analog switch mode register
        volatile uint32_t CMR3;  ///< Offset: 0x38 - Channel mask register
        volatile uint32_t CICR3;  ///< Offset: 0x3C - Channel identification for capture register
        volatile uint32_t ASMR4;  ///< Offset: 0x40 - Analog switch mode register
        volatile uint32_t CMR4;  ///< Offset: 0x44 - Channel mask register
        volatile uint32_t CICR4;  ///< Offset: 0x48 - Channel identification for capture register
        volatile uint32_t ASMR5;  ///< Offset: 0x4C - Analog switch mode register
        volatile uint32_t CMR5;  ///< Offset: 0x50 - Channel mask register
        volatile uint32_t CICR5;  ///< Offset: 0x54 - Channel identification for capture register
    };
    ...
    /// ASMR1 Register bits
    namespace asmr1_bits {
        constexpr uint32_t PA = (16 << 0);  ///< Port A analog switch mode selection
    }

    /// CMR1 Register bits
    namespace cmr1_bits {
        constexpr uint32_t PA = (16 << 0);  ///< Port A channel masking
    }

    /// CICR1 Register bits
    namespace cicr1_bits {
        constexpr uint32_t PA = (16 << 0);  ///< Port A channel identification for capture
    }

    /// ASMR2 Register bits
    namespace asmr2_bits {
        constexpr uint32_t PB = (16 << 0);  ///< Port B analog switch mode selection
    }

    /// CMR2 Register bits
    namespace cmr2_bits {
        constexpr uint32_t PB = (16 << 0);  ///< Port B channel masking
    }

    /// CICR2 Register bits
    namespace cicr2_bits {
        constexpr uint32_t PB = (16 << 0);  ///< Port B channel identification for capture
    }

    /// ASMR3 Register bits
    namespace asmr3_bits {
        constexpr uint32_t PC = (16 << 0);  ///< Port C analog switch mode selection
    }

    /// CMR3 Register bits
    namespace cmr3_bits {
        constexpr uint32_t PC = (16 << 0);  ///< Port C channel masking
    }

    /// CICR3 Register bits
    namespace cicr3_bits {
        constexpr uint32_t PC = (16 << 0);  ///< Port C channel identification for capture
    }

    /// ASMR4 Register bits
    namespace asmr4_bits {
        constexpr uint32_t PF = (16 << 0);  ///< Port F analog switch mode selection
    }

    /// CMR4 Register bits
    namespace cmr4_bits {
        constexpr uint32_t PF = (16 << 0);  ///< Port F channel masking
    }

    /// CICR4 Register bits
    namespace cicr4_bits {
        constexpr uint32_t PF = (16 << 0);  ///< Port F channel identification for capture
    }

    /// ASMR5 Register bits
    namespace asmr5_bits {
        constexpr uint32_t PG = (16 << 0);  ///< Port G analog switch mode selection
    }

    /// CMR5 Register bits
    namespace cmr5_bits {
        constexpr uint32_t PG = (16 << 0);  ///< Port G channel masking
    }

    /// CICR5 Register bits
    namespace cicr5_bits {
        constexpr uint32_t PG = (16 << 0);  ///< Port G channel identification for capture
    }
