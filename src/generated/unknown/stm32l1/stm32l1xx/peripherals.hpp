/// Auto-generated code for STM32L1xx
/// Generated by Alloy Code Generator
/// Source: st_stm32l1.json
/// DO NOT EDIT - Changes will be overwritten
///
/// Generated: 2025-10-31 12:01:29
#ifndef ALLOY_GENERATED_STM32L1XX_PERIPHERALS_HPP
#define ALLOY_GENERATED_STM32L1XX_PERIPHERALS_HPP

#include <cstdint>

namespace alloy::generated::stm32l1xx {
...
namespace traits {
    ...
    constexpr bool has_ri = true;
    constexpr uint32_t num_ri_instances = 1;
    ...
    template<>
    struct peripheral_count<struct ri_tag> {
        static constexpr uint32_t value = 1;
    };
    template<>
...
namespace crypto {
    ...
    struct Registers {
        ...
        volatile uint32_t KEYR0;  ///< Offset: 0x10 - AES Key register 0
        volatile uint32_t KEYR1;  ///< Offset: 0x14 - AES Key register 1
        volatile uint32_t KEYR2;  ///< Offset: 0x18 - AES Key register 2
        volatile uint32_t KEYR3;  ///< Offset: 0x1C - AES Key register 3
    ...
    namespace cr_bits {
        ...
        constexpr uint32_t DATATYPE = (2 << 1);  ///< Data type selection
    ...
    /// DINR Register bits
    namespace dinr_bits {
        constexpr uint32_t DINR = (32 << 0);  ///< Data input
    }

    /// DOUTR Register bits
    namespace doutr_bits {
        constexpr uint32_t DOUTR = (32 << 0);  ///< Data output
    }

    /// KEYR0 Register bits
    namespace keyr0_bits {
        constexpr uint32_t KEYR0 = (32 << 0);  ///< AES key
    }

    /// KEYR1 Register bits
    namespace keyr1_bits {
        constexpr uint32_t KEYR1 = (32 << 0);  ///< AES key
    }

    /// KEYR2 Register bits
    namespace keyr2_bits {
        constexpr uint32_t KEYR2 = (32 << 0);  ///< AES key
    }

    /// KEYR3 Register bits
    namespace keyr3_bits {
        constexpr uint32_t KEYR3 = (32 << 0);  ///< AES key
    }

    /// IVR0 Register bits
    namespace ivr0_bits {
        constexpr uint32_t IVR0 = (32 << 0);  ///< Initialization Vector Register
    }

    /// IVR1 Register bits
    namespace ivr1_bits {
        constexpr uint32_t IVR1 = (32 << 0);  ///< Initialization Vector Register
    }

    /// IVR2 Register bits
    namespace ivr2_bits {
        constexpr uint32_t IVR2 = (32 << 0);  ///< Initialization Vector Register
    }

    /// IVR3 Register bits
    namespace ivr3_bits {
        constexpr uint32_t IVR3 = (32 << 0);  ///< Initialization Vector Register
    }
...
namespace gpio {
    ...
    constexpr uint32_t GPIOF_BASE = 0x40021800;
    constexpr uint32_t GPIOG_BASE = 0x40021C00;
    constexpr uint32_t GPIOH_BASE = 0x40021400;
...
namespace opamp {
    /// Base addresses
    constexpr uint32_t OPAMP_BASE = 0x40007C5C;

    /// OPAMP Register structure
    struct Registers {
        volatile uint32_t CSR;  ///< Offset: 0x00 - control/status register
        volatile uint32_t OTR;  ///< Offset: 0x04 - offset trimming register for normal mode
        volatile uint32_t LPOTR;  ///< Offset: 0x08 - OPAMP offset trimming register for low power mode
    };
    ...
    /// CSR Register bits
    namespace csr_bits {
        constexpr uint32_t OPA3CALOUT = (1U << 31);  ///< OPAMP3 calibration output
        constexpr uint32_t OPA2CALOUT = (1U << 30);  ///< OPAMP2 calibration output
        constexpr uint32_t OPA1CALOUT = (1U << 29);  ///< OPAMP1 calibration output
        constexpr uint32_t AOP_RANGE = (1U << 28);  ///< Power range selection
        constexpr uint32_t S7SEL2 = (1U << 27);  ///< Switch 7 for OPAMP2 enable
        constexpr uint32_t ANAWSEL3 = (1U << 26);  ///< Switch SanA enable for OPAMP3
        constexpr uint32_t ANAWSEL2 = (1U << 25);  ///< Switch SanA enable for OPAMP2
        constexpr uint32_t ANAWSEL1 = (1U << 24);  ///< Switch SanA enable for OPAMP1
        constexpr uint32_t OPA3LPM = (1U << 23);  ///< OPAMP3 low power mode
        constexpr uint32_t OPA3CAL_H = (1U << 22);  ///< OPAMP3 offset calibration for N differential pair
        constexpr uint32_t OPA3CAL_L = (1U << 21);  ///< OPAMP3 offset Calibration for P differential pair
        constexpr uint32_t S6SEL3 = (1U << 20);  ///< Switch 6 for OPAMP3 enable
        constexpr uint32_t S5SEL3 = (1U << 19);  ///< Switch 5 for OPAMP3 enable
        constexpr uint32_t S4SEL3 = (1U << 18);  ///< Switch 4 for OPAMP3 enable
        constexpr uint32_t S3SEL3 = (1U << 17);  ///< Switch 3 for OPAMP3 Enable
        constexpr uint32_t OPA3PD = (1U << 16);  ///< OPAMP3 power down
        constexpr uint32_t OPA2LPM = (1U << 15);  ///< OPAMP2 low power mode
        constexpr uint32_t OPA2CAL_H = (1U << 14);  ///< OPAMP2 offset calibration for N differential pair
        constexpr uint32_t OPA2CAL_L = (1U << 13);  ///< OPAMP2 offset Calibration for P differential pair
        constexpr uint32_t S6SEL2 = (1U << 12);  ///< Switch 6 for OPAMP2 enable
        constexpr uint32_t S5SEL2 = (1U << 11);  ///< Switch 5 for OPAMP2 enable
        constexpr uint32_t S4SEL2 = (1U << 10);  ///< Switch 4 for OPAMP2 enable
        constexpr uint32_t S3SEL2 = (1U << 9);  ///< Switch 3 for OPAMP2 enable
        constexpr uint32_t OPA2PD = (1U << 8);  ///< OPAMP2 power down
        constexpr uint32_t OPA1LPM = (1U << 7);  ///< OPAMP1 low power mode
        constexpr uint32_t OPA1CAL_H = (1U << 6);  ///< OPAMP1 offset calibration for N differential pair
        constexpr uint32_t OPA1CAL_L = (1U << 5);  ///< OPAMP1 offset calibration for P differential pair
        constexpr uint32_t S6SEL1 = (1U << 4);  ///< Switch 6 for OPAMP1 enable
        constexpr uint32_t S5SEL1 = (1U << 3);  ///< Switch 5 for OPAMP1 enable
        constexpr uint32_t S4SEL1 = (1U << 2);  ///< Switch 4 for OPAMP1 enable
        constexpr uint32_t S3SEL1 = (1U << 1);  ///< Switch 3 for OPAMP1 enable
        constexpr uint32_t OPA1PD = (1U << 0);  ///< OPAMP1 power down
    }

    /// OTR Register bits
    namespace otr_bits {
        constexpr uint32_t OT_USER = (1U << 31);  ///< Select user or factory trimming value
        constexpr uint32_t AO3_OPT_OFFSET_TRIM = (10 << 20);  ///< OPAMP3, 10-bit offset trim value for normal mode
        constexpr uint32_t AO2_OPT_OFFSET_TRIM = (10 << 10);  ///< OPAMP2, 10-bit offset trim value for normal mode
        constexpr uint32_t AO1_OPT_OFFSET_TRIM = (10 << 0);  ///< OPAMP1, 10-bit offset trim value for normal mode
    }

    /// LPOTR Register bits
    namespace lpotr_bits {
        constexpr uint32_t AO3_OPT_OFFSET_TRIM_LP = (10 << 20);  ///< OPAMP3, 10-bit offset trim value for low power mode
        constexpr uint32_t AO2_OPT_OFFSET_TRIM_LP = (10 << 10);  ///< OPAMP2, 10-bit offset trim value for low power mode
        constexpr uint32_t AO1_OPT_OFFSET_TRIM_LP = (10 << 0);  ///< OPAMP1, 10-bit offset trim value for low power mode
    }
...
namespace rcc {
    ...
    namespace ahbrstr_bits {
        constexpr uint32_t FSMCRST = (1U << 30);  ///< FSMC reset
        constexpr uint32_t DMA2RST = (1U << 25);  ///< DMA2 reset
        constexpr uint32_t DMA1RST = (1U << 24);  ///< DMA1 reset
        constexpr uint32_t FLITFRST = (1U << 15);  ///< FLITF reset
        constexpr uint32_t CRCRST = (1U << 12);  ///< CRC reset
        constexpr uint32_t GPIOGRST = (1U << 7);  ///< IO port G reset
        constexpr uint32_t GPIOFRST = (1U << 6);  ///< IO port F reset
        constexpr uint32_t GPIOHRST = (1U << 5);  ///< IO port H reset
    ...
    namespace apb2rstr_bits {
        ...
        constexpr uint32_t SDIORST = (1U << 11);  ///< SDIORST
    ...
    namespace ahbenr_bits {
        constexpr uint32_t FSMCEN = (1U << 30);  ///< FSMCEN
        constexpr uint32_t DMA2EN = (1U << 25);  ///< DMA2 clock enable
        constexpr uint32_t DMA1EN = (1U << 24);  ///< DMA1 clock enable
        constexpr uint32_t FLITFEN = (1U << 15);  ///< FLITF clock enable
        constexpr uint32_t CRCEN = (1U << 12);  ///< CRC clock enable
        constexpr uint32_t GPIOPGEN = (1U << 7);  ///< IO port G clock enable
        constexpr uint32_t GPIOPFEN = (1U << 6);  ///< IO port F clock enable
        constexpr uint32_t GPIOPHEN = (1U << 5);  ///< IO port H clock enable
        constexpr uint32_t GPIOPEEN = (1U << 4);  ///< IO port E clock enable
    ...
    namespace apb1enr_bits {
        ...
        constexpr uint32_t USART5EN = (1U << 20);  ///< UART 5 clock enable
        constexpr uint32_t USART4EN = (1U << 19);  ///< UART 4 clock enable
    ...
    namespace ahblpenr_bits {
        constexpr uint32_t DMA2LPEN = (1U << 25);  ///< DMA2 clock enable during Sleep mode
        constexpr uint32_t DMA1LPEN = (1U << 24);  ///< DMA1 clock enable during Sleep mode
        ...
        constexpr uint32_t GPIOGLPEN = (1U << 7);  ///< IO port G clock enable during Sleep mode
        constexpr uint32_t GPIOFLPEN = (1U << 6);  ///< IO port F clock enable during Sleep mode
        constexpr uint32_t GPIOHLPEN = (1U << 5);  ///< IO port H clock enable during Sleep mode
    ...
    namespace apb2lpenr_bits {
        ...
        constexpr uint32_t SDIOLPEN = (1U << 11);  ///< Reserved
...
namespace sdio {
    ...
    namespace power_bits {
        constexpr uint32_t PWRCTRL = (2 << 0);  ///< Power supply control bits.
    }
    ...
    namespace resp1_bits {
        constexpr uint32_t CARDSTATUS1 = (32 << 0);  ///< see Table 133.
    }

    /// RESP2 Register bits
    namespace resp2_bits {
        constexpr uint32_t CARDSTATUS2 = (32 << 0);  ///< see Table 133.
    }

    /// RESP3 Register bits
    namespace resp3_bits {
        constexpr uint32_t CARDSTATUS3 = (32 << 0);  ///< see Table 133.
    }

    /// RESP4 Register bits
    namespace resp4_bits {
        constexpr uint32_t CARDSTATUS4 = (32 << 0);  ///< see Table 133.
    }
    ...
    namespace dctrl_bits {
        ...
        constexpr uint32_t DTEN = (1U << 0);  ///< Data transfer enabled bit
    }
    ...
    /// FIFO Register bits
    namespace fifo_bits {
        constexpr uint32_t FIF0Data = (32 << 0);  ///< FIF0Data
    }
