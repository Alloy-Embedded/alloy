...
extern "C" {
    ...
    void DSIHSOT_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void AES_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void RNG_HASH_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void LCD_TFT_ER_IRQHandler() __attribute__((weak, alias("Default_Handler")));
