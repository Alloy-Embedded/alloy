...
extern "C" {
    ...
    void TIM15_LPTIM3_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void I2C2_I2C3_I2C4_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    ...
    void USART3_LPUART1_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void USART4_LPUART3_IRQHandler() __attribute__((weak, alias("Default_Handler")));
    void AES_RNG_IRQHandler() __attribute__((weak, alias("Default_Handler")));
}