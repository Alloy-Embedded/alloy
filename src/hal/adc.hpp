/**
 * Universal ADC Header
 *
 * Automatically includes the correct ADC implementation based on the platform
...
#pragma once
    ...
    #include "platform/arm/adc.hpp"
#elif defined(ALLOY_PLATFORM_LINUX)
    #include "platform/linux/adc.hpp"
#elif defined(ALLOY_PLATFORM_SAME70)
    #include "platform/same70/adc.hpp"
#elif defined(ALLOY_PLATFORM_SAMV71)
    #include "platform/samv71/adc.hpp"
#elif defined(ALLOY_PLATFORM_STM32F0)
    #include "platform/stm32f0/adc.hpp"
#elif defined(ALLOY_PLATFORM_STM32F1)
    #include "platform/stm32f1/adc.hpp"
#elif defined(ALLOY_PLATFORM_STM32F4)
    #include "platform/stm32f4/adc.hpp"
...
/**
 * After including this header, you can use the ADC implementation
 * for the selected platform without any code changes.
 *
 * Example:
 *   // Works on any platform with ADC support
 *   #include "hal/adc.hpp"
 *
 *   // Use ADC API (platform-specific implementation)
 *   // ... your code here ...
 */
