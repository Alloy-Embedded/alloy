 ...
 *
 * Automatically includes the correct GPIO implementation based on the platform
...
/**
 * After including this header, you can use the GPIO implementation
 * for the selected platform without any code changes.
 *
 * Example:
 *   // Works on any platform with GPIO support
 *   #include "hal/gpio.hpp"
 *
 *   // Use GPIO API (platform-specific implementation)
 *   // ... your code here ...
 */
