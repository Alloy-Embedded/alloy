/**
 * @file gpio.hpp
 * @brief Template-based GPIO implementation for STM32F0 (Platform Layer)
 *
...
#include "hal/vendors/st/stm32f0/registers/gpioa_registers.hpp"

// Bitfields (family-level, if available)
// #include "hal/vendors/st/stm32f0/bitfields/gpioa_bitfields.hpp"

// Hardware definitions (MCU-specific - if available)
// Note: Board files should include hardware.hpp from specific MCU if needed
// #include "hal/vendors/st/stm32f0/{mcu}/hardware.hpp"
...
/**
 * @brief Template-based GPIO pin for STM32F0
 *
