/**
 * Universal PWM Header
 *
 * Automatically includes the correct PWM implementation based on the platform
...
#pragma once
    ...
    #include "platform/arm/pwm.hpp"
#elif defined(ALLOY_PLATFORM_LINUX)
    #include "platform/linux/pwm.hpp"
#elif defined(ALLOY_PLATFORM_SAME70)
    #include "platform/same70/pwm.hpp"
#elif defined(ALLOY_PLATFORM_SAMV71)
    #include "platform/samv71/pwm.hpp"
#elif defined(ALLOY_PLATFORM_STM32F0)
    #include "platform/stm32f0/pwm.hpp"
#elif defined(ALLOY_PLATFORM_STM32F1)
    #include "platform/stm32f1/pwm.hpp"
#elif defined(ALLOY_PLATFORM_STM32F4)
    #include "platform/stm32f4/pwm.hpp"
...
/**
 * After including this header, you can use the PWM implementation
 * for the selected platform without any code changes.
 *
 * Example:
 *   // Works on any platform with PWM support
 *   #include "hal/pwm.hpp"
 *
 *   // Use PWM API (platform-specific implementation)
 *   // ... your code here ...
 */
