...
namespace alloy::hal::stm32f103::stm32f103r4 {

// ============================================================================
// MCU Characteristics for STM32F103R4
// Auto-generated from SVD: STM32F103
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F103R4";
    ...
    static constexpr uint32_t FLASH_SIZE = 16 * 1024;      // 16 KB
    static constexpr uint32_t SRAM_SIZE = 6 * 1024;       // 6 KB
