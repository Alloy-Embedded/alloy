...
namespace alloy::hal::stm32f103::stm32f103r8 {

// ============================================================================
// MCU Characteristics for STM32F103R8
// Auto-generated from SVD: STM32F103
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F103R8";
    ...
    static constexpr uint32_t FLASH_SIZE = 64 * 1024;      // 64 KB
