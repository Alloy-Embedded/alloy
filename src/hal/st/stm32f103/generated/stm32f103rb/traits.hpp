...
namespace alloy::hal::stm32f103::stm32f103rb {

// ============================================================================
// MCU Characteristics for STM32F103RB
// Auto-generated from SVD: STM32F103
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F103RB";
    ...
    static constexpr uint32_t FLASH_SIZE = 128 * 1024;      // 128 KB
    static constexpr uint32_t SRAM_SIZE = 20 * 1024;       // 20 KB
