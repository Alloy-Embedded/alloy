...
namespace alloy::hal::stm32f103::stm32f103rd {

// ============================================================================
// MCU Characteristics for STM32F103RD
// Auto-generated from SVD: STM32F103
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F103RD";
    ...
    static constexpr uint32_t FLASH_SIZE = 384 * 1024;      // 384 KB
