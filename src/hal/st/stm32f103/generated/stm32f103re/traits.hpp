...
namespace alloy::hal::stm32f103::stm32f103re {

// ============================================================================
// MCU Characteristics for STM32F103RE
// Auto-generated from SVD: STM32F103
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F103RE";
    ...
    static constexpr uint8_t PIN_COUNT = 67;

    // Memory configuration
    static constexpr uint32_t FLASH_SIZE = 512 * 1024;      // 512 KB
    static constexpr uint32_t SRAM_SIZE = 64 * 1024;       // 64 KB
