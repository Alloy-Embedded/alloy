...
namespace alloy::hal::atmel::atsam3x8e::atsam3x8e::chipid {
...
namespace cidr {
    ...
    namespace nvpsiz {
        ...
        constexpr uint32_t 8K = 1;
        constexpr uint32_t 16K = 2;
        constexpr uint32_t 32K = 3;
        constexpr uint32_t 64K = 5;
        constexpr uint32_t 128K = 7;
        constexpr uint32_t 256K = 9;
        constexpr uint32_t 512K = 10;
        constexpr uint32_t 1024K = 12;
        constexpr uint32_t 2048K = 14;
    }
    ...
    namespace sramsiz {
        constexpr uint32_t 48K = 0;
        constexpr uint32_t 192K = 1;
        constexpr uint32_t 2K = 2;
        constexpr uint32_t 6K = 3;
        constexpr uint32_t 24K = 4;
        constexpr uint32_t 4K = 5;
        constexpr uint32_t 80K = 6;
        constexpr uint32_t 160K = 7;
        constexpr uint32_t 8K = 8;
        constexpr uint32_t 16K = 9;
        constexpr uint32_t 32K = 10;
        constexpr uint32_t 64K = 11;
        constexpr uint32_t 128K = 12;
        constexpr uint32_t 256K = 13;
        constexpr uint32_t 96K = 14;
        constexpr uint32_t 512K = 15;
    }
    ...
    namespace arch {
        constexpr uint32_t SAM3AxC = 131;
        constexpr uint32_t SAM3XxC = 132;
        constexpr uint32_t SAM3XxE = 133;
        constexpr uint32_t SAM3XxG = 134;
    }
