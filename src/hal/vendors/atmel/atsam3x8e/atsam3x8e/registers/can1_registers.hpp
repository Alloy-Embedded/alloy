...
namespace alloy::hal::atmel::atsam3x8e::atsam3x8e::can1 {
...
static_assert(sizeof(CAN1_Registers) >= 768, "CAN1_Registers size mismatch");

/// CAN1 peripheral instance
constexpr CAN1_Registers* CAN1 = 
    reinterpret_cast<CAN1_Registers*>(0x400B8000);
