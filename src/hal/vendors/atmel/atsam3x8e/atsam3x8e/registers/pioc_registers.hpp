/// Auto-generated register definitions for PIOC
/// Device: ATSAM3X8E
/// Vendor: Atmel
///
...
namespace alloy::hal::atmel::atsam3x8e::atsam3x8e::pioc {
...
static_assert(sizeof(PIOC_Registers) >= 236, "PIOC_Registers size mismatch");

/// PIOC peripheral instance
constexpr PIOC_Registers* PIOC = 
    reinterpret_cast<PIOC_Registers*>(0x400E1200);
