/// Auto-generated register definitions for PIOD
/// Device: ATSAM3X8E
/// Vendor: Atmel
///
...
namespace alloy::hal::atmel::atsam3x8e::atsam3x8e::piod {
...
struct PIOD_Registers {
    ...
    uint8_t RESERVED_0090[16]; ///< Reserved
...
static_assert(sizeof(PIOD_Registers) >= 236, "PIOD_Registers size mismatch");

/// PIOD peripheral instance
constexpr PIOD_Registers* PIOD = 
    reinterpret_cast<PIOD_Registers*>(0x400E1400);
