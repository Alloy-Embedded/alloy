/// Auto-generated register definitions for TC2
/// Device: ATSAM3X8E
/// Vendor: Atmel
///
...
/// TC2 Register Structure
struct TC2_Registers {
...
static_assert(sizeof(TC2_Registers) >= 232, "TC2_Registers size mismatch");

/// TC2 peripheral instance
constexpr TC2_Registers* TC2 = 
    reinterpret_cast<TC2_Registers*>(0x40088000);
