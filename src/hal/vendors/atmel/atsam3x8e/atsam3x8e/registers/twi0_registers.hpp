/// Auto-generated register definitions for TWI0
/// Device: ATSAM3X8E
/// Vendor: Atmel
///
...
/// TWI0 Register Structure
struct TWI0_Registers {
...
static_assert(sizeof(TWI0_Registers) >= 296, "TWI0_Registers size mismatch");

/// TWI0 peripheral instance
constexpr TWI0_Registers* TWI0 = 
    reinterpret_cast<TWI0_Registers*>(0x4008C000);
