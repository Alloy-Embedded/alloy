...
namespace alloy::hal::atmel::atsam3x8e::atsam3x8e::usart0 {
...
static_assert(sizeof(USART0_Registers) >= 296, "USART0_Registers size mismatch");

/// USART0 peripheral instance
constexpr USART0_Registers* USART0 = 
    reinterpret_cast<USART0_Registers*>(0x40098000);
