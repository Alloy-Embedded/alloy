/// Auto-generated register definitions for USART2
/// Device: ATSAM3X8E
/// Vendor: Atmel
///
...
namespace alloy::hal::atmel::atsam3x8e::atsam3x8e::usart2 {
...
static_assert(sizeof(USART2_Registers) >= 296, "USART2_Registers size mismatch");

/// USART2 peripheral instance
constexpr USART2_Registers* USART2 = 
    reinterpret_cast<USART2_Registers*>(0x400A0000);
