/// Auto-generated startup code for ATSAML11E15A
...
__attribute__((section(".isr_vector"), used)) void (*const vector_table[])() = {
    ...
    SERCOM2_0_Handler,                       // IRQ 30: SERCOM2_0
    SERCOM2_1_Handler,                       // IRQ 31: SERCOM2_1
    SERCOM2_2_Handler,                       // IRQ 32: SERCOM2_2
    SERCOM2_OTHER_Handler,                   // IRQ 33: SERCOM2_OTHER
