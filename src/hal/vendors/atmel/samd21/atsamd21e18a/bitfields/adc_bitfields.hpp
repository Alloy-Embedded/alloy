...
namespace alloy::hal::atmel::samd21::atsamd21e18a::adc {
...
namespace avgctrl {
    ...
    namespace samplenum {
        ...
        constexpr uint32_t 2 = 1;
        constexpr uint32_t 4 = 2;
        constexpr uint32_t 8 = 3;
        constexpr uint32_t 16 = 4;
        constexpr uint32_t 32 = 5;
        constexpr uint32_t 64 = 6;
        constexpr uint32_t 128 = 7;
        constexpr uint32_t 256 = 8;
        constexpr uint32_t 512 = 9;
        constexpr uint32_t 1024 = 10;
    }
...
namespace ctrlb {
    ...
    namespace ressel {
        constexpr uint32_t 12BIT = 0;
        constexpr uint32_t 16BIT = 1;
        constexpr uint32_t 10BIT = 2;
        constexpr uint32_t 8BIT = 3;
    }
...
namespace inputctrl {
    ...
    namespace gain {
        constexpr uint32_t 1X = 0;
        constexpr uint32_t 2X = 1;
        constexpr uint32_t 4X = 2;
        constexpr uint32_t 8X = 3;
        constexpr uint32_t 16X = 4;
