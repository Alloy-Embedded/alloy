...
namespace alloy::hal::atmel::samd21::atsamd21g18a::wdt {
...
namespace config {
    ...
    namespace per {
        ...
        constexpr uint32_t 1K = 7;
        constexpr uint32_t 2K = 8;
        constexpr uint32_t 4K = 9;
        constexpr uint32_t 8K = 10;
        constexpr uint32_t 16K = 11;
    }
