...
namespace alloy::hal::atmel::samd21::atsamd21j18a::pm {
...
namespace apbcmask {
    ...
    /// Position: 14, Width: 1
    using TC6_ = BitField<14, 1>;
    constexpr uint32_t TC6__Pos = 14;
    constexpr uint32_t TC6__Msk = TC6_::mask;

    /// TC7 APB Clock Enable
    /// Position: 15, Width: 1
    using TC7_ = BitField<15, 1>;
    constexpr uint32_t TC7__Pos = 15;
    constexpr uint32_t TC7__Msk = TC7_::mask;
