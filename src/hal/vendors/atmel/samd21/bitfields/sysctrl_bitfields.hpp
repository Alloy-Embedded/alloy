...
constexpr uint32_t _2 = 2;
constexpr uint32_t _3 = 3;
constexpr uint32_t _4 = 4;
}  // namespace gain
...
namespace ltime {
constexpr uint32_t DEFAULT = 0;
constexpr uint32_t _8MS = 4;
constexpr uint32_t _9MS = 5;
constexpr uint32_t _10MS = 6;
constexpr uint32_t _11MS = 7;
}  // namespace ltime
