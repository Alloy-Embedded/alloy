/// Auto-generated startup code for ATSAME53N20A
...
extern "C" void SERCOM6_0_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM6_1_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM6_2_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM6_OTHER_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM7_0_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM7_1_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM7_2_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void SERCOM7_OTHER_Handler() __attribute__((weak, alias("Default_Handler")));
...
extern "C" void TCC3_OTHER_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void TCC3_MC0_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void TCC3_MC1_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void TCC4_OTHER_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void TCC4_MC0_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void TCC4_MC1_Handler() __attribute__((weak, alias("Default_Handler")));
...
extern "C" void SDHC1_Handler() __attribute__((weak, alias("Default_Handler")));
...
__attribute__((section(".isr_vector"), used)) void (*const vector_table[])() = {
    ...
    SERCOM6_0_Handler,                       // IRQ 70: SERCOM6_0
    SERCOM6_1_Handler,                       // IRQ 71: SERCOM6_1
    SERCOM6_2_Handler,                       // IRQ 72: SERCOM6_2
    SERCOM6_OTHER_Handler,                   // IRQ 73: SERCOM6_OTHER
    SERCOM7_0_Handler,                       // IRQ 74: SERCOM7_0
    SERCOM7_1_Handler,                       // IRQ 75: SERCOM7_1
    SERCOM7_2_Handler,                       // IRQ 76: SERCOM7_2
    SERCOM7_OTHER_Handler,                   // IRQ 77: SERCOM7_OTHER
    ...
    TCC3_OTHER_Handler,                      // IRQ 101: TCC3_OTHER
    TCC3_MC0_Handler,                        // IRQ 102: TCC3_MC0
    TCC3_MC1_Handler,                        // IRQ 103: TCC3_MC1
    TCC4_OTHER_Handler,                      // IRQ 104: TCC4_OTHER
    TCC4_MC0_Handler,                        // IRQ 105: TCC4_MC0
    TCC4_MC1_Handler,                        // IRQ 106: TCC4_MC1
    TC0_Handler,                             // IRQ 107: TC0
    TC1_Handler,                             // IRQ 108: TC1
    TC2_Handler,                             // IRQ 109: TC2
    TC3_Handler,                             // IRQ 110: TC3
    TC4_Handler,                             // IRQ 111: TC4
    TC5_Handler,                             // IRQ 112: TC5
    TC6_Handler,                             // IRQ 113: TC6
    TC7_Handler,                             // IRQ 114: TC7
