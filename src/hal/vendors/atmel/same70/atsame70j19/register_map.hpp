/// Complete Register Map for ATSAME70J19
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70j19/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70j19;
///
///   // Access registers
...
namespace alloy::hal::atmel::same70::atsame70j19 {
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70j19;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
