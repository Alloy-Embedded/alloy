...
namespace alloy::hal::atmel::same70::atsame70j19b::tc0 {
...
/// CMR_CAPTURE_MODE - Channel Mode Register (channel = 0)
namespace cmr_capture_mode {
    /// Clock Selection
    /// Position: 0, Width: 3
...
/// CMR_WAVEFORM_MODE - Channel Mode Register (channel = 0)
namespace cmr_waveform_mode {
    /// Clock Selection
    /// Position: 0, Width: 3
    using TCCLKS = BitField<0, 3>;
    constexpr uint32_t TCCLKS_Pos = 0;
...
namespace bmr {
    ...
    /// Position: 18, Width: 1
    using AUTOC = BitField<18, 1>;
    constexpr uint32_t AUTOC_Pos = 18;
    constexpr uint32_t AUTOC_Msk = AUTOC::mask;
    ...
    /// Position: 26, Width: 4
    using MAXCMP = BitField<26, 4>;
    constexpr uint32_t MAXCMP_Pos = 26;
    constexpr uint32_t MAXCMP_Msk = MAXCMP::mask;
...
namespace qier {
    ...
    /// Position: 3, Width: 1
    using MPE = BitField<3, 1>;
    constexpr uint32_t MPE_Pos = 3;
