/// Complete Register Map for ATSAME70J19B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70j19b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70j19b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70j19b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
