/// Complete Register Map for ATSAME70J20
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70j20/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70j20;
///
///   // Access registers
...
namespace alloy::hal::atmel::same70::atsame70j20 {
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70j20;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
