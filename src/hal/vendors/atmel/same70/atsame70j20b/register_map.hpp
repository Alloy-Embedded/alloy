/// Complete Register Map for ATSAME70J20B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70j20b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70j20b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70j20b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
