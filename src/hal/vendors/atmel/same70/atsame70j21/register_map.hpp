/// Complete Register Map for ATSAME70J21
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70j21/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70j21;
///
///   // Access registers
...
namespace alloy::hal::atmel::same70::atsame70j21 {
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70j21;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
