...
namespace alloy::hal::atmel::same70::atsame70j21b::mcan0 {
...
namespace psr {
    ...
    /// Data Phase Last Error Code (set to 111 on read)
    /// Position: 8, Width: 3
    ...
    /// Position: 13, Width: 1
    using RFDF = BitField<13, 1>;
    constexpr uint32_t RFDF_Pos = 13;
    constexpr uint32_t RFDF_Msk = RFDF::mask;

    /// Protocol Exception Event (cleared on read)
    /// Position: 14, Width: 1
...
/// TDCR - Transmit Delay Compensation Register
namespace tdcr {
...
namespace ir {
    ...
    /// Position: 27, Width: 1
    using PEA = BitField<27, 1>;
    constexpr uint32_t PEA_Pos = 27;
    constexpr uint32_t PEA_Msk = PEA::mask;

    /// Protocol Error in Data Phase
    /// Position: 28, Width: 1
    using PED = BitField<28, 1>;
    constexpr uint32_t PED_Pos = 28;
    constexpr uint32_t PED_Msk = PED::mask;

    /// Access to Reserved Address
    /// Position: 29, Width: 1
    using ARA = BitField<29, 1>;
    constexpr uint32_t ARA_Pos = 29;
...
namespace ie {
    ...
    /// Position: 27, Width: 1
    using PEAE = BitField<27, 1>;
    constexpr uint32_t PEAE_Pos = 27;
    constexpr uint32_t PEAE_Msk = PEAE::mask;

    /// Protocol Error in Data Phase Enable
    /// Position: 28, Width: 1
    using PEDE = BitField<28, 1>;
    constexpr uint32_t PEDE_Pos = 28;
    constexpr uint32_t PEDE_Msk = PEDE::mask;

    /// Access to Reserved Address Enable
    /// Position: 29, Width: 1
    using ARAE = BitField<29, 1>;
    constexpr uint32_t ARAE_Pos = 29;
...
namespace ils {
    ...
    /// Position: 27, Width: 1
    using PEAL = BitField<27, 1>;
    constexpr uint32_t PEAL_Pos = 27;
    constexpr uint32_t PEAL_Msk = PEAL::mask;

    /// Protocol Error in Data Phase Line
    /// Position: 28, Width: 1
    using PEDL = BitField<28, 1>;
    constexpr uint32_t PEDL_Pos = 28;
    constexpr uint32_t PEDL_Msk = PEDL::mask;

    /// Access to Reserved Address Line
    /// Position: 29, Width: 1
    using ARAL = BitField<29, 1>;
    constexpr uint32_t ARAL_Pos = 29;
    constexpr uint32_t ARAL_Msk = ARAL::mask;
