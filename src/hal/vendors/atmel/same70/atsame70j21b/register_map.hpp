/// Complete Register Map for ATSAME70J21B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70j21b/register_map.hpp>
///
///   using namespace ucore::hal::atmel::same70::atsame70j21b;
///
///   // Access registers
...
namespace ucore::hal::atmel::same70::atsame70j21b {
...
///
/// namespace mcu = ucore::hal::atmel::same70::atsame70j21b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
