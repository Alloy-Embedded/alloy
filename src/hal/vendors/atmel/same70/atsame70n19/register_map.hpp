/// Complete Register Map for ATSAME70N19
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70n19/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70n19;
///
///   // Access registers
...
namespace alloy::hal::atmel::same70::atsame70n19 {
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70n19;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
