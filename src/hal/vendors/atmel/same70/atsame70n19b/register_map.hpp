/// Complete Register Map for ATSAME70N19B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70n19b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70n19b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70n19b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
