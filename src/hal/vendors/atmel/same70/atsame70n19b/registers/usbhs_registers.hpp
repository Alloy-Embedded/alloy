...
namespace alloy::hal::atmel::same70::atsame70n19b::usbhs {
...
struct USBHS_Registers {
    ...
    /// Offset: 0x0130
    /// Access: read-only
    volatile uint32_t DEVEPTISR_CTRL_MODE[10];

    /// Device Endpoint Interrupt Status Register
    /// Offset: 0x0130
    /// Access: read-only
    volatile uint32_t DEVEPTISR_ISO_MODE[10];

    /// Device Endpoint Interrupt Status Register
    /// Offset: 0x0130
    /// Access: read-only
    volatile uint32_t DEVEPTISR_BLK_MODE[10];

    /// Device Endpoint Interrupt Status Register
    /// Offset: 0x0130
    /// Access: read-only
    volatile uint32_t DEVEPTISR_INTRPT_MODE[10];
    uint8_t RESERVED_0134[44]; ///< Reserved

    /// Device Endpoint Interrupt Clear Register
    /// Offset: 0x0160
    /// Access: write-only
    volatile uint32_t DEVEPTICR_CTRL_MODE[10];

    /// Device Endpoint Interrupt Clear Register
    /// Offset: 0x0160
    /// Access: write-only
    volatile uint32_t DEVEPTICR_ISO_MODE[10];

    /// Device Endpoint Interrupt Clear Register
    /// Offset: 0x0160
    /// Access: write-only
    volatile uint32_t DEVEPTICR_BLK_MODE[10];

    /// Device Endpoint Interrupt Clear Register
    /// Offset: 0x0160
    /// Access: write-only
    volatile uint32_t DEVEPTICR_INTRPT_MODE[10];
    uint8_t RESERVED_0164[44]; ///< Reserved

    /// Device Endpoint Interrupt Set Register
    /// Offset: 0x0190
    /// Access: write-only
    volatile uint32_t DEVEPTIFR_CTRL_MODE[10];

    /// Device Endpoint Interrupt Set Register
    /// Offset: 0x0190
    /// Access: write-only
    volatile uint32_t DEVEPTIFR_ISO_MODE[10];

    /// Device Endpoint Interrupt Set Register
    /// Offset: 0x0190
    /// Access: write-only
    volatile uint32_t DEVEPTIFR_BLK_MODE[10];

    /// Device Endpoint Interrupt Set Register
    /// Offset: 0x0190
    /// Access: write-only
    volatile uint32_t DEVEPTIFR_INTRPT_MODE[10];
    uint8_t RESERVED_0194[44]; ///< Reserved

    /// Device Endpoint Interrupt Mask Register
    /// Offset: 0x01C0
    /// Access: read-only
    volatile uint32_t DEVEPTIMR_CTRL_MODE[10];

    /// Device Endpoint Interrupt Mask Register
    /// Offset: 0x01C0
    /// Access: read-only
    volatile uint32_t DEVEPTIMR_ISO_MODE[10];

    /// Device Endpoint Interrupt Mask Register
    /// Offset: 0x01C0
    /// Access: read-only
    volatile uint32_t DEVEPTIMR_BLK_MODE[10];

    /// Device Endpoint Interrupt Mask Register
    /// Offset: 0x01C0
    /// Access: read-only
    volatile uint32_t DEVEPTIMR_INTRPT_MODE[10];
    uint8_t RESERVED_01C4[44]; ///< Reserved

    /// Device Endpoint Interrupt Enable Register
    /// Offset: 0x01F0
    /// Access: write-only
    volatile uint32_t DEVEPTIER_CTRL_MODE[10];

    /// Device Endpoint Interrupt Enable Register
    /// Offset: 0x01F0
    /// Access: write-only
    volatile uint32_t DEVEPTIER_ISO_MODE[10];

    /// Device Endpoint Interrupt Enable Register
    /// Offset: 0x01F0
    /// Access: write-only
    volatile uint32_t DEVEPTIER_BLK_MODE[10];

    /// Device Endpoint Interrupt Enable Register
    /// Offset: 0x01F0
    /// Access: write-only
    volatile uint32_t DEVEPTIER_INTRPT_MODE[10];
    uint8_t RESERVED_01F4[44]; ///< Reserved

    /// Device Endpoint Interrupt Disable Register
    /// Offset: 0x0220
    /// Access: write-only
    volatile uint32_t DEVEPTIDR_CTRL_MODE[10];

    /// Device Endpoint Interrupt Disable Register
    /// Offset: 0x0220
    /// Access: write-only
    volatile uint32_t DEVEPTIDR_ISO_MODE[10];

    /// Device Endpoint Interrupt Disable Register
    /// Offset: 0x0220
    /// Access: write-only
    volatile uint32_t DEVEPTIDR_BLK_MODE[10];

    /// Device Endpoint Interrupt Disable Register
    /// Offset: 0x0220
    /// Access: write-only
    volatile uint32_t DEVEPTIDR_INTRPT_MODE[10];
    ...
    /// Host Pipe Configuration Register
    /// Offset: 0x0500
    volatile uint32_t HSTPIPCFG_CTRL_BULK_MODE[10];
    uint8_t RESERVED_0504[44]; ///< Reserved

    /// Host Pipe Status Register
    /// Offset: 0x0530
    /// Access: read-only
    volatile uint32_t HSTPIPISR_CTRL_MODE[10];

    /// Host Pipe Status Register
    /// Offset: 0x0530
    /// Access: read-only
    volatile uint32_t HSTPIPISR_ISO_MODE[10];

    /// Host Pipe Status Register
    /// Offset: 0x0530
    /// Access: read-only
    volatile uint32_t HSTPIPISR_BLK_MODE[10];

    /// Host Pipe Status Register
    /// Offset: 0x0530
    /// Access: read-only
    volatile uint32_t HSTPIPISR_INTRPT_MODE[10];
    uint8_t RESERVED_0534[44]; ///< Reserved

    /// Host Pipe Clear Register
    /// Offset: 0x0560
    /// Access: write-only
    volatile uint32_t HSTPIPICR_CTRL_MODE[10];

    /// Host Pipe Clear Register
    /// Offset: 0x0560
    /// Access: write-only
    volatile uint32_t HSTPIPICR_ISO_MODE[10];

    /// Host Pipe Clear Register
    /// Offset: 0x0560
    /// Access: write-only
    volatile uint32_t HSTPIPICR_BLK_MODE[10];

    /// Host Pipe Clear Register
    /// Offset: 0x0560
    /// Access: write-only
    volatile uint32_t HSTPIPICR_INTRPT_MODE[10];
    uint8_t RESERVED_0564[44]; ///< Reserved

    /// Host Pipe Set Register
    /// Offset: 0x0590
    /// Access: write-only
    volatile uint32_t HSTPIPIFR_CTRL_MODE[10];

    /// Host Pipe Set Register
    /// Offset: 0x0590
    /// Access: write-only
    volatile uint32_t HSTPIPIFR_ISO_MODE[10];

    /// Host Pipe Set Register
    /// Offset: 0x0590
    /// Access: write-only
    volatile uint32_t HSTPIPIFR_BLK_MODE[10];

    /// Host Pipe Set Register
    /// Offset: 0x0590
    /// Access: write-only
    volatile uint32_t HSTPIPIFR_INTRPT_MODE[10];
    uint8_t RESERVED_0594[44]; ///< Reserved

    /// Host Pipe Mask Register
    /// Offset: 0x05C0
    /// Access: read-only
    volatile uint32_t HSTPIPIMR_CTRL_MODE[10];

    /// Host Pipe Mask Register
    /// Offset: 0x05C0
    /// Access: read-only
    volatile uint32_t HSTPIPIMR_ISO_MODE[10];

    /// Host Pipe Mask Register
    /// Offset: 0x05C0
    /// Access: read-only
    volatile uint32_t HSTPIPIMR_BLK_MODE[10];

    /// Host Pipe Mask Register
    /// Offset: 0x05C0
    /// Access: read-only
    volatile uint32_t HSTPIPIMR_INTRPT_MODE[10];
    uint8_t RESERVED_05C4[44]; ///< Reserved

    /// Host Pipe Enable Register
    /// Offset: 0x05F0
    /// Access: write-only
    volatile uint32_t HSTPIPIER_CTRL_MODE[10];

    /// Host Pipe Enable Register
    /// Offset: 0x05F0
    /// Access: write-only
    volatile uint32_t HSTPIPIER_ISO_MODE[10];

    /// Host Pipe Enable Register
    /// Offset: 0x05F0
    /// Access: write-only
    volatile uint32_t HSTPIPIER_BLK_MODE[10];

    /// Host Pipe Enable Register
    /// Offset: 0x05F0
    /// Access: write-only
    volatile uint32_t HSTPIPIER_INTRPT_MODE[10];
    uint8_t RESERVED_05F4[44]; ///< Reserved

    /// Host Pipe Disable Register
    /// Offset: 0x0620
    /// Access: write-only
    volatile uint32_t HSTPIPIDR_CTRL_MODE[10];

    /// Host Pipe Disable Register
    /// Offset: 0x0620
    /// Access: write-only
    volatile uint32_t HSTPIPIDR_ISO_MODE[10];

    /// Host Pipe Disable Register
    /// Offset: 0x0620
    /// Access: write-only
    volatile uint32_t HSTPIPIDR_BLK_MODE[10];

    /// Host Pipe Disable Register
    /// Offset: 0x0620
    /// Access: write-only
    volatile uint32_t HSTPIPIDR_INTRPT_MODE[10];
