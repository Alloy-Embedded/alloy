/// Complete Register Map for ATSAME70N20B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70n20b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70n20b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70n20b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
