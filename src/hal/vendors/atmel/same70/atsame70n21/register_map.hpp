/// Complete Register Map for ATSAME70N21
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70n21/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70n21;
///
///   // Access registers
...
namespace alloy::hal::atmel::same70::atsame70n21 {
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70n21;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
