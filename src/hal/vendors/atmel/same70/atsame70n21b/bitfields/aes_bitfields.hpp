...
namespace alloy::hal::atmel::same70::atsame70n21b::aes {
...
/// IVR[4] - Initialization Vector Register
namespace ivr[4] {
...
/// GHASHR[4] - GCM Intermediate Hash Word Register
namespace ghashr[4] {
...
/// TAGR[4] - GCM Authentication Tag Word Register
namespace tagr[4] {
