/// Complete Register Map for ATSAME70N21B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70n21b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70n21b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70n21b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
