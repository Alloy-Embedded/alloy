...
namespace alloy::hal::atmel::same70::atsame70q19b::pins {

// ============================================================================
// Pin Definitions for ATSAME70Q19B
// Package: LQFP144
// ============================================================================
...
constexpr uint8_t PA26 = 26;  // A26
constexpr uint8_t PA27 = 27;  // A27
constexpr uint8_t PA28 = 28;  // A28
constexpr uint8_t PA29 = 29;  // A29
...
constexpr uint8_t PB4 = 36;  // B4
constexpr uint8_t PB5 = 37;  // B5
constexpr uint8_t PB6 = 38;  // B6
constexpr uint8_t PB7 = 39;  // B7
constexpr uint8_t PB8 = 40;  // B8
constexpr uint8_t PB9 = 41;  // B9
constexpr uint8_t PB10 = 42;  // B10
constexpr uint8_t PB11 = 43;  // B11
constexpr uint8_t PB12 = 44;  // B12
constexpr uint8_t PB13 = 45;  // B13
...
constexpr uint8_t PC20 = 84;  // C20
constexpr uint8_t PC21 = 85;  // C21
constexpr uint8_t PC22 = 86;  // C22
constexpr uint8_t PC23 = 87;  // C23
constexpr uint8_t PC24 = 88;  // C24
constexpr uint8_t PC25 = 89;  // C25
constexpr uint8_t PC26 = 90;  // C26
constexpr uint8_t PC27 = 91;  // C27
constexpr uint8_t PC28 = 92;  // C28
constexpr uint8_t PC29 = 93;  // C29
constexpr uint8_t PC30 = 94;  // C30
constexpr uint8_t PC31 = 95;  // C31
...
constexpr uint8_t PD22 = 118;  // D22
constexpr uint8_t PD23 = 119;  // D23
constexpr uint8_t PD24 = 120;  // D24
constexpr uint8_t PD25 = 121;  // D25
constexpr uint8_t PD26 = 122;  // D26
constexpr uint8_t PD27 = 123;  // D27
constexpr uint8_t PD28 = 124;  // D28
constexpr uint8_t PD29 = 125;  // D29
constexpr uint8_t PD30 = 126;  // D30
constexpr uint8_t PD31 = 127;  // D31

// Port E pins
constexpr uint8_t PE0 = 128;  // E0
constexpr uint8_t PE1 = 129;  // E1
constexpr uint8_t PE2 = 130;  // E2
constexpr uint8_t PE3 = 131;  // E3
constexpr uint8_t PE4 = 132;  // E4
constexpr uint8_t PE5 = 133;  // E5
...
constexpr Port get_port() {
    ...
    if constexpr (PortChar == 'E') return Port::E;
