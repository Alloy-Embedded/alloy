/// Complete Register Map for ATSAME70Q19B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70q19b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70q19b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70q19b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
