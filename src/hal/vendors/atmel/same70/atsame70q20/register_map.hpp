/// Complete Register Map for ATSAME70Q20
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70q20/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70q20;
///
///   // Access registers
...
namespace alloy::hal::atmel::same70::atsame70q20 {
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70q20;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
