...
namespace alloy::hal::atmel::same70::atsame70q20b::pmc {
...
namespace scer {
    ...
    /// Position: 15, Width: 1
    using PCK7 = BitField<15, 1>;
    constexpr uint32_t PCK7_Pos = 15;
    constexpr uint32_t PCK7_Msk = PCK7::mask;
...
namespace ier {
    ...
    /// Position: 15, Width: 1
    using PCKRDY7 = BitField<15, 1>;
    constexpr uint32_t PCKRDY7_Pos = 15;
    constexpr uint32_t PCKRDY7_Msk = PCKRDY7::mask;
