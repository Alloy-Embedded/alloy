/// Complete Register Map for ATSAME70Q20B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70q20b/register_map.hpp>
///
///   using namespace alloy::hal::atmel::same70::atsame70q20b;
///
///   // Access registers
...
///
/// namespace mcu = alloy::hal::atmel::same70::atsame70q20b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
...
//   - 43 peripheral register structures
