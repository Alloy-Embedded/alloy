...
namespace alloy::hal::atmel::same70::atsame70q21b::pwm0 {
...
/// CMR - PWM Channel Mode Register (ch_num = 0)
namespace cmr {
    /// Channel Pre-scaler
    /// Position: 0, Width: 4
...
/// CDTY - PWM Channel Duty Cycle Register (ch_num = 0)
namespace cdty {
    /// Channel Duty-Cycle
    /// Position: 0, Width: 24
...
/// CDTYUPD - PWM Channel Duty Cycle Update Register (ch_num = 0)
namespace cdtyupd {
...
/// CPRD - PWM Channel Period Register (ch_num = 0)
namespace cprd {
    /// Channel Period
    /// Position: 0, Width: 24
...
/// CPRDUPD - PWM Channel Period Update Register (ch_num = 0)
namespace cprdupd {
...
/// CCNT - PWM Channel Counter Register (ch_num = 0)
namespace ccnt {
...
/// DT - PWM Channel Dead Time Register (ch_num = 0)
namespace dt {
...
/// DTUPD - PWM Channel Dead Time Update Register (ch_num = 0)
namespace dtupd {
