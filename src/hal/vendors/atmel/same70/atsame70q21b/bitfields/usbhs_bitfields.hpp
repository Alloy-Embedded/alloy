...
namespace devisr {
    ...
    /// Position: 22, Width: 1
    using PEP_10 = BitField<22, 1>;
    constexpr uint32_t PEP_10_Pos = 22;
    constexpr uint32_t PEP_10_Msk = PEP_10::mask;

    /// Endpoint 11 Interrupt
    /// Position: 23, Width: 1
    using PEP_11 = BitField<23, 1>;
    constexpr uint32_t PEP_11_Pos = 23;
    constexpr uint32_t PEP_11_Msk = PEP_11::mask;
...
namespace devimr {
    ...
    /// Endpoint 10 Interrupt Mask
    /// Position: 22, Width: 1
    using PEP_10 = BitField<22, 1>;
    constexpr uint32_t PEP_10_Pos = 22;
    constexpr uint32_t PEP_10_Msk = PEP_10::mask;

    /// Endpoint 11 Interrupt Mask
    /// Position: 23, Width: 1
    using PEP_11 = BitField<23, 1>;
    constexpr uint32_t PEP_11_Pos = 23;
    constexpr uint32_t PEP_11_Msk = PEP_11::mask;
...
namespace devidr {
    ...
    /// Endpoint 10 Interrupt Disable
    /// Position: 22, Width: 1
    using PEP_10 = BitField<22, 1>;
    constexpr uint32_t PEP_10_Pos = 22;
    constexpr uint32_t PEP_10_Msk = PEP_10::mask;

    /// Endpoint 11 Interrupt Disable
    /// Position: 23, Width: 1
    using PEP_11 = BitField<23, 1>;
    constexpr uint32_t PEP_11_Pos = 23;
    constexpr uint32_t PEP_11_Msk = PEP_11::mask;
...
namespace hstisr {
    ...
    /// Pipe 10 Interrupt
    /// Position: 18, Width: 1
    using PEP_10 = BitField<18, 1>;
    constexpr uint32_t PEP_10_Pos = 18;
    constexpr uint32_t PEP_10_Msk = PEP_10::mask;

    /// Pipe 11 Interrupt
    /// Position: 19, Width: 1
    using PEP_11 = BitField<19, 1>;
    constexpr uint32_t PEP_11_Pos = 19;
    constexpr uint32_t PEP_11_Msk = PEP_11::mask;
...
namespace hstimr {
    ...
    /// Pipe 10 Interrupt Enable
    /// Position: 18, Width: 1
    using PEP_10 = BitField<18, 1>;
    constexpr uint32_t PEP_10_Pos = 18;
    constexpr uint32_t PEP_10_Msk = PEP_10::mask;

    /// Pipe 11 Interrupt Enable
    /// Position: 19, Width: 1
    using PEP_11 = BitField<19, 1>;
    constexpr uint32_t PEP_11_Pos = 19;
    constexpr uint32_t PEP_11_Msk = PEP_11::mask;
...
namespace hstidr {
    ...
    /// Pipe 10 Interrupt Disable
    /// Position: 18, Width: 1
    using PEP_10 = BitField<18, 1>;
    constexpr uint32_t PEP_10_Pos = 18;
    constexpr uint32_t PEP_10_Msk = PEP_10::mask;

    /// Pipe 11 Interrupt Disable
    /// Position: 19, Width: 1
    using PEP_11 = BitField<19, 1>;
    constexpr uint32_t PEP_11_Pos = 19;
    constexpr uint32_t PEP_11_Msk = PEP_11::mask;
