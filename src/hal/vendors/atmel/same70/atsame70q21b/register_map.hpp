/// Complete Register Map for ATSAME70Q21B
...
///
/// Usage:
///   #include <hal/atmel/same70/atsame70q21b/register_map.hpp>
///
///   using namespace ucore::hal::atmel::same70::atsame70q21b;
///
///   // Access registers
...
namespace ucore::hal::atmel::same70::atsame70q21b {
...
///
/// namespace mcu = ucore::hal::atmel::same70::atsame70q21b;
///
/// Then use:
///   mcu::rcc::RCC->CR = ...
