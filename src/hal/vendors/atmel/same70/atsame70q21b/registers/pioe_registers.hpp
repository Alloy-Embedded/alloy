/// Auto-generated register definitions for PIOE
/// Device: ATSAME70Q21
...
// Base Address: 0x400E1600
// ============================================================================

/// PIOE Register Structure
struct PIOE_Registers {
...
static_assert(sizeof(PIOE_Registers) >= 360, "PIOE_Registers size mismatch");

/// PIOE peripheral instance
inline PIOE_Registers* PIOE() {
    return reinterpret_cast<PIOE_Registers*>(0x400E1600);
}
