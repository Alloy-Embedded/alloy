 ...
 */
constexpr auto same70_vector_table =
    make_vector_table<StartupConfig::VECTOR_COUNT>()
 ...
 */
__attribute__((section(".isr_vector"), used)) const auto vectors = same70_vector_table;
