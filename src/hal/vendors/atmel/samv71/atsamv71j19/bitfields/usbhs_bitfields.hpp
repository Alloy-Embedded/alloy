...
namespace alloy::hal::atmel::samv71::atsamv71j19::usbhs {
...
/// DEVDMANXTDSC - Device DMA Channel Next Descriptor Address Register (n = 1)
...
/// HSTDMANXTDSC - Host DMA Channel Next Descriptor Address Register (n = 1)
...
/// DEVDMAADDRESS - Device DMA Channel Address Register (n = 1)
...
/// HSTDMAADDRESS - Host DMA Channel Address Register (n = 1)
...
/// DEVDMACONTROL - Device DMA Channel Control Register (n = 1)
...
/// HSTDMACONTROL - Host DMA Channel Control Register (n = 1)
...
/// DEVDMASTATUS - Device DMA Channel Status Register (n = 1)
...
/// HSTDMASTATUS - Host DMA Channel Status Register (n = 1)
...
/// TSTA1 - General Test A1 Register
namespace tsta1 {
    /// Counter A
    /// Position: 0, Width: 15
    using CounterA = BitField<0, 15>;
    constexpr uint32_t CounterA_Pos = 0;
    constexpr uint32_t CounterA_Msk = CounterA::mask;

    /// Load CounterA
    /// Position: 15, Width: 1
    using LoadCntA = BitField<15, 1>;
    constexpr uint32_t LoadCntA_Pos = 15;
    constexpr uint32_t LoadCntA_Msk = LoadCntA::mask;

    /// Counter B
    /// Position: 16, Width: 6
    using CounterB = BitField<16, 6>;
    constexpr uint32_t CounterB_Pos = 16;
    constexpr uint32_t CounterB_Msk = CounterB::mask;

    /// Load CounterB
    /// Position: 23, Width: 1
    using LoadCntB = BitField<23, 1>;
    constexpr uint32_t LoadCntB_Pos = 23;
    constexpr uint32_t LoadCntB_Msk = LoadCntB::mask;

    /// SOF Counter Max
    /// Position: 24, Width: 7
    using SOFCntMa1 = BitField<24, 7>;
    constexpr uint32_t SOFCntMa1_Pos = 24;
    constexpr uint32_t SOFCntMa1_Msk = SOFCntMa1::mask;

    /// Load SOF Counter
    /// Position: 31, Width: 1
    using LoadSOFCnt = BitField<31, 1>;
    constexpr uint32_t LoadSOFCnt_Pos = 31;
    constexpr uint32_t LoadSOFCnt_Msk = LoadSOFCnt::mask;

}  // namespace tsta1

/// TSTA2 - General Test A2 Register
namespace tsta2 {
    /// Full Detach Enable
    /// Position: 0, Width: 1
    using FullDetachEn = BitField<0, 1>;
    constexpr uint32_t FullDetachEn_Pos = 0;
    constexpr uint32_t FullDetachEn_Msk = FullDetachEn::mask;

    /// HS Serial Mode
    /// Position: 1, Width: 1
    using HSSerialMode = BitField<1, 1>;
    constexpr uint32_t HSSerialMode_Pos = 1;
    constexpr uint32_t HSSerialMode_Msk = HSSerialMode::mask;

    /// Loop-back Mode
    /// Position: 2, Width: 1
    using LoopBackMode = BitField<2, 1>;
    constexpr uint32_t LoopBackMode_Pos = 2;
    constexpr uint32_t LoopBackMode_Msk = LoopBackMode::mask;

    /// Disable Gated Clock
    /// Position: 3, Width: 1
    using DisableGatedClock = BitField<3, 1>;
    constexpr uint32_t DisableGatedClock_Pos = 3;
    constexpr uint32_t DisableGatedClock_Msk = DisableGatedClock::mask;

    /// Force SuspendM to 1
    /// Position: 4, Width: 1
    using ForceSuspendMTo1 = BitField<4, 1>;
    constexpr uint32_t ForceSuspendMTo1_Pos = 4;
    constexpr uint32_t ForceSuspendMTo1_Msk = ForceSuspendMTo1::mask;

    /// Bypass DPLL
    /// Position: 5, Width: 1
    using ByPassDpll = BitField<5, 1>;
    constexpr uint32_t ByPassDpll_Pos = 5;
    constexpr uint32_t ByPassDpll_Msk = ByPassDpll::mask;

    /// Host HS Disconnect Disable
    /// Position: 6, Width: 1
    using HostHSDisconnectDisable = BitField<6, 1>;
    constexpr uint32_t HostHSDisconnectDisable_Pos = 6;
    constexpr uint32_t HostHSDisconnectDisable_Msk = HostHSDisconnectDisable::mask;

    /// Force HS Reset to 50 ms
    /// Position: 7, Width: 1
    using ForceHSRst_50ms = BitField<7, 1>;
    constexpr uint32_t ForceHSRst_50ms_Pos = 7;
    constexpr uint32_t ForceHSRst_50ms_Msk = ForceHSRst_50ms::mask;

    /// Remove Pull-up When TX
    /// Position: 9, Width: 1
    using RemovePUWhenTX = BitField<9, 1>;
    constexpr uint32_t RemovePUWhenTX_Pos = 9;
    constexpr uint32_t RemovePUWhenTX_Msk = RemovePUWhenTX::mask;

}  // namespace tsta2

/// VERSION - General Version Register
namespace version {
    /// Version Number
    /// Position: 0, Width: 12
