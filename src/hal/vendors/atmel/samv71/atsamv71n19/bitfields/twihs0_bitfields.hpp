...
namespace alloy::hal::atmel::samv71::atsamv71n19::twihs0 {
...
namespace dr {
    /// SleepWalking Enable
    /// Position: 0, Width: 1
    using SWEN = BitField<0, 1>;
    constexpr uint32_t SWEN_Pos = 0;
    constexpr uint32_t SWEN_Msk = SWEN::mask;

    /// Clock Request
    /// Position: 1, Width: 1
    using CLKRQ = BitField<1, 1>;
    constexpr uint32_t CLKRQ_Pos = 1;
    constexpr uint32_t CLKRQ_Msk = CLKRQ::mask;

    /// SleepWalking Match
    /// Position: 2, Width: 1
    using SWMATCH = BitField<2, 1>;
    constexpr uint32_t SWMATCH_Pos = 2;
    constexpr uint32_t SWMATCH_Msk = SWMATCH::mask;

    /// Transfer Pending
    /// Position: 3, Width: 1
    using TRP = BitField<3, 1>;
    constexpr uint32_t TRP_Pos = 3;
