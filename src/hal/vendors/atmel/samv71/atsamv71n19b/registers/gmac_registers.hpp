...
struct GMAC_Registers {
    ...
    /// Offset: 0x0400
    /// Access: read-only
    volatile uint32_t ISRPQ[5];
    uint8_t RESERVED_0404[60]; ///< Reserved

    /// Transmit Buffer Queue Base Address Register Priority Queue (1..5)
    /// Offset: 0x0440
    volatile uint32_t TBQBAPQ[5];
    uint8_t RESERVED_0444[60]; ///< Reserved

    /// Receive Buffer Queue Base Address Register Priority Queue (1..5)
    /// Offset: 0x0480
    volatile uint32_t RBQBAPQ[5];
    uint8_t RESERVED_0484[28]; ///< Reserved

    /// Receive Buffer Size Register Priority Queue (1..5)
    /// Offset: 0x04A0
    volatile uint32_t RBSRPQ[5];
    ...
    uint8_t RESERVED_0544[188]; ///< Reserved

    /// Interrupt Enable Register Priority Queue (1..5)
    /// Offset: 0x0600
    /// Access: write-only
    volatile uint32_t IERPQ[5];
    uint8_t RESERVED_0604[28]; ///< Reserved

    /// Interrupt Disable Register Priority Queue (1..5)
    /// Offset: 0x0620
    /// Access: write-only
    volatile uint32_t IDRPQ[5];
    uint8_t RESERVED_0624[28]; ///< Reserved

    /// Interrupt Mask Register Priority Queue (1..5)
    /// Offset: 0x0640
    volatile uint32_t IMRPQ[5];
...
static_assert(sizeof(GMAC_Registers) >= 1764, "GMAC_Registers size mismatch");
