...
namespace alloy::hal::atmel::samv71::atsamv71n21::icm {
...
namespace cfg {
    ...
    /// Position: 16, Width: 6
    using HAPROT = BitField<16, 6>;
    constexpr uint32_t HAPROT_Pos = 16;
    constexpr uint32_t HAPROT_Msk = HAPROT::mask;

    /// Region Descriptor Area Protection
    /// Position: 24, Width: 6
    using DAPROT = BitField<24, 6>;
    constexpr uint32_t DAPROT_Pos = 24;
    constexpr uint32_t DAPROT_Msk = DAPROT::mask;
