...
namespace alloy::hal::atmel::samv71::atsamv71n21b::gmac {
...
namespace ncr {
    ...
    /// Position: 19, Width: 1
    using TXLPIEN = BitField<19, 1>;
    constexpr uint32_t TXLPIEN_Pos = 19;
    constexpr uint32_t TXLPIEN_Msk = TXLPIEN::mask;
...
/// ST2CW0 - Screening Type 2 Compare Word 0 Register
namespace st2cw0 {
    /// Mask Value
    /// Position: 0, Width: 16
...
/// ST2CW1 - Screening Type 2 Compare Word 1 Register
namespace st2cw1 {
...
namespace nsr {
    ...
    /// LPI Indication
    /// Position: 7, Width: 1
    using RXLPIS = BitField<7, 1>;
    constexpr uint32_t RXLPIS_Pos = 7;
    constexpr uint32_t RXLPIS_Msk = RXLPIS::mask;
...
/// RXLPI - Received LPI Transitions
namespace rxlpi {
    /// Count of RX LPI transitions (cleared on read)
    /// Position: 0, Width: 16
...
/// RXLPITIME - Received LPI Time
namespace rxlpitime {
    /// Time in LPI (cleared on read)
    /// Position: 0, Width: 24
    using LPITIME = BitField<0, 24>;
    constexpr uint32_t LPITIME_Pos = 0;
    constexpr uint32_t LPITIME_Msk = LPITIME::mask;

}  // namespace rxlpitime

/// TXLPI - Transmit LPI Transitions
namespace txlpi {
    /// Count of LPI transitions (cleared on read)
    /// Position: 0, Width: 16
    using COUNT = BitField<0, 16>;
    constexpr uint32_t COUNT_Pos = 0;
    constexpr uint32_t COUNT_Msk = COUNT::mask;
...
/// ISRPQ[5] - Interrupt Status Register Priority Queue (1..5)
namespace isrpq {
    /// Receive Complete
    /// Position: 1, Width: 1
    using RCOMP = BitField<1, 1>;
...
/// TBQBAPQ[5] - Transmit Buffer Queue Base Address Register Priority Queue (1..5)
namespace tbqbapq {
    /// Transmit Buffer Queue Base Address
    /// Position: 2, Width: 30
...
/// RBQBAPQ[5] - Receive Buffer Queue Base Address Register Priority Queue (1..5)
namespace rbqbapq {
    /// Receive Buffer Queue Base Address
    /// Position: 2, Width: 30
...
/// RBSRPQ[5] - Receive Buffer Size Register Priority Queue (1..5)
namespace rbsrpq {
    /// Receive Buffer Size
    /// Position: 0, Width: 16
...
/// ST1RPQ[4] - Screening Type 1 Register Priority Queue
namespace st1rpq {
    /// Queue Number (0-5)
    /// Position: 0, Width: 3
...
/// ST2RPQ[8] - Screening Type 2 Register Priority Queue
namespace st2rpq {
    /// Queue Number (0-5)
    /// Position: 0, Width: 3
    using QNB = BitField<0, 3>;
...
/// IERPQ[5] - Interrupt Enable Register Priority Queue (1..5)
namespace ierpq {
    /// Receive Complete
    /// Position: 1, Width: 1
    using RCOMP = BitField<1, 1>;
...
/// IDRPQ[5] - Interrupt Disable Register Priority Queue (1..5)
namespace idrpq {
    /// Receive Complete
    /// Position: 1, Width: 1
    using RCOMP = BitField<1, 1>;
...
/// IMRPQ[5] - Interrupt Mask Register Priority Queue (1..5)
namespace imrpq {
    /// Receive Complete
    /// Position: 1, Width: 1
    using RCOMP = BitField<1, 1>;
...
/// ST2ER[4] - Screening Type 2 Ethertype Register
namespace st2er {
