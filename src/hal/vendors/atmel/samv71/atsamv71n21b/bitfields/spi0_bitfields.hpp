...
namespace alloy::hal::atmel::samv71::atsamv71n21b::spi0 {
...
namespace mr {
    ...
    /// Enumerated values for PCS
    namespace pcs {
        constexpr uint32_t NPCS0 = 14;
        constexpr uint32_t NPCS1 = 13;
        constexpr uint32_t NPCS2 = 11;
        constexpr uint32_t NPCS3 = 7;
    }
...
namespace csr {
    ...
    namespace cpol {
        constexpr uint32_t IDLE_LOW = 0;
        constexpr uint32_t IDLE_HIGH = 1;
    }
    ...
    /// Enumerated values for NCPHA
    namespace ncpha {
        constexpr uint32_t VALID_LEADING_EDGE = 1;
        constexpr uint32_t VALID_TRAILING_EDGE = 0;
    }
