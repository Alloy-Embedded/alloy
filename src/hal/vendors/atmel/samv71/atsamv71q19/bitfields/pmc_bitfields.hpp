...
namespace alloy::hal::atmel::samv71::atsamv71q19::pmc {
...
/// APLLACR - Audio PLL Analog Configuration Register
namespace apllacr {
    /// DCO Filter Selection
    /// Position: 0, Width: 4
    using DCOFLTSEL = BitField<0, 4>;
    constexpr uint32_t DCOFLTSEL_Pos = 0;
    constexpr uint32_t DCOFLTSEL_Msk = DCOFLTSEL::mask;

    /// PLL Filter Selection
    /// Position: 4, Width: 4
    using FLTSEL = BitField<4, 4>;
    constexpr uint32_t FLTSEL_Pos = 4;
    constexpr uint32_t FLTSEL_Msk = FLTSEL::mask;

    /// Bias Voltage Selection
    /// Position: 8, Width: 2
    using BIAS = BitField<8, 2>;
    constexpr uint32_t BIAS_Pos = 8;
    constexpr uint32_t BIAS_Msk = BIAS::mask;

}  // namespace apllacr

/// WMST - Wait Mode Startup Time Register
namespace wmst {
    /// Wait Mode Startup Time
    /// Position: 0, Width: 8
    using WMST = BitField<0, 8>;
    constexpr uint32_t WMST_Pos = 0;
    constexpr uint32_t WMST_Msk = WMST::mask;
