...
namespace alloy::hal::atmel::samv71::atsamv71q19::uart0 {
...
namespace cr {
    ...
    /// Debug Enable
    /// Position: 15, Width: 1
    using DBGE = BitField<15, 1>;
    constexpr uint32_t DBGE_Pos = 15;
    constexpr uint32_t DBGE_Msk = DBGE::mask;
...
namespace sr {
    ...
    /// SleepWalking Enable Status
    /// Position: 21, Width: 1
    using SWES = BitField<21, 1>;
    constexpr uint32_t SWES_Pos = 21;
    constexpr uint32_t SWES_Msk = SWES::mask;

    /// Clock Request
    /// Position: 22, Width: 1
    using CLKREQ = BitField<22, 1>;
    constexpr uint32_t CLKREQ_Pos = 22;
    constexpr uint32_t CLKREQ_Msk = CLKREQ::mask;

    /// Wake-Up Request
    /// Position: 23, Width: 1
    using WKUPREQ = BitField<23, 1>;
    constexpr uint32_t WKUPREQ_Pos = 23;
    constexpr uint32_t WKUPREQ_Msk = WKUPREQ::mask;
