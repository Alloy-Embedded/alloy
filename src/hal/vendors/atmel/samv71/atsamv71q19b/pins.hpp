...
constexpr uint8_t PD28 = 28;  // D28
constexpr uint8_t PD29 = 29;  // D29
constexpr uint8_t PD30 = 30;  // D30
constexpr uint8_t PD31 = 31;  // D31

// Port E pins
constexpr uint8_t PE0 = 0;  // E0
constexpr uint8_t PE1 = 1;  // E1
constexpr uint8_t PE2 = 2;  // E2
constexpr uint8_t PE3 = 3;  // E3
constexpr uint8_t PE4 = 4;  // E4
constexpr uint8_t PE5 = 5;  // E5
