/// Auto-generated startup code for ATSAMV71Q19B
...
extern "C" __attribute__((weak)) void MLB_Handler() {
    Default_Handler();
}
...
extern "C" __attribute__((weak)) void CCW_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void CCF_Handler() {
    Default_Handler();
}
...
extern "C" __attribute__((weak)) void I2SC0_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void I2SC1_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void GMAC_Q3_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void GMAC_Q4_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void GMAC_Q5_Handler() {
    Default_Handler();
}
...
void (* const vector_table[])() = {
    ...
    I2SC0_Handler, // IRQ 69: I2SC0
    I2SC1_Handler, // IRQ 70: I2SC1
