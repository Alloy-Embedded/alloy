...
#include "registers/pioe_registers.hpp"

namespace alloy::hal::atmel::samv71::atsamv71q20b::hardware {

// ============================================================================
// Hardware Adapter for ATSAMV71Q20B
//
...
constexpr uint32_t FLASH_SIZE = 1024U * 1024U;
