...
/// IDATAR[%s] - Input Data Register 0
namespace idatar[%s] {
    /// Input Data Word
    /// Position: 0, Width: 32
...
/// ODATAR[%s] - Output Data Register 0
namespace odatar[%s] {
    /// Output Data
    /// Position: 0, Width: 32
...
/// IVR[%s] - Initialization Vector Register 0
namespace ivr[%s] {
...
/// GHASHR[%s] - GCM Intermediate Hash Word Register 0
namespace ghashr[%s] {
...
/// TAGR[%s] - GCM Authentication Tag Word Register 0
namespace tagr[%s] {
