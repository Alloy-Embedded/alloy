...
namespace alloy::hal::atmel::samv71::atsamv71q21::enums {
...
/// Register: MR
/// Field: CMTYP1 [24:24]
enum class AES_MR_CMTYP1 : uint32_t {
    NOPROT_EXTKEY = 0x0,
    PROT_EXTKEY = 0x1,
};
...
/// Register: MR
/// Field: CMTYP2 [25:25]
enum class AES_MR_CMTYP2 : uint32_t {
    NO_PAUSE = 0x0,
    PAUSE = 0x1,
};
...
/// Register: MR
/// Field: CMTYP3 [26:26]
enum class AES_MR_CMTYP3 : uint32_t {
    NO_DUMMY = 0x0,
    DUMMY = 0x1,
};
...
/// Register: MR
/// Field: CMTYP4 [27:27]
enum class AES_MR_CMTYP4 : uint32_t {
    NO_RESTART = 0x0,
    RESTART = 0x1,
};
...
/// Register: MR
/// Field: CMTYP5 [28:28]
enum class AES_MR_CMTYP5 : uint32_t {
    NO_ADDACCESS = 0x0,
    ADDACCESS = 0x1,
};
...
/// Register: MR
/// Field: CMTYP6 [29:29]
enum class AES_MR_CMTYP6 : uint32_t {
    NO_IDLECURRENT = 0x0,
    IDLECURRENT = 0x1,
};
...
/// Register: MADR
/// Field: TB [30:30]
enum class MLB_MADR_TB : uint32_t {
    CTR = 0x0,
    DBR = 0x1,
};
...
/// Register: ACTL
/// Field: MPB [4:4]
enum class MLB_ACTL_MPB : uint32_t {
    SINGLE_PACKET = 0x0,
    MULTIPLE_PACKET = 0x1,
};
...
/// Register: WMST
/// Field: KEY [24:31]
enum class PMC_WMST_KEY : uint32_t {
    PASSWD = 0x5A,
};
...
/// Register: MR
/// Field: MODE [0:2]
enum class SDRAMC_MR_MODE : uint32_t {
    NORMAL = 0x0,
    NOP = 0x1,
    ALLBANKS_PRECHARGE = 0x2,
    LOAD_MODEREG = 0x3,
    AUTO_REFRESH = 0x4,
    EXT_LOAD_MODEREG = 0x5,
    DEEP_POWERDOWN = 0x6,
};
...
/// Register: CR
/// Field: NC [0:1]
enum class SDRAMC_CR_NC : uint32_t {
    COL8 = 0x0,
    COL9 = 0x1,
    COL10 = 0x2,
    COL11 = 0x3,
...
/// Register: CR
/// Field: NR [2:3]
enum class SDRAMC_CR_NR : uint32_t {
    ROW11 = 0x0,
    ROW12 = 0x1,
    ROW13 = 0x2,
};
...
/// Register: CR
/// Field: NB [4:4]
enum class SDRAMC_CR_NB : uint32_t {
    BANK2 = 0x0,
    BANK4 = 0x1,
};
...
/// Register: CR
/// Field: CAS [5:6]
enum class SDRAMC_CR_CAS : uint32_t {
    LATENCY1 = 0x1,
    LATENCY2 = 0x2,
    LATENCY3 = 0x3,
};
...
/// Register: LPR
/// Field: LPCB [0:1]
enum class SDRAMC_LPR_LPCB : uint32_t {
    DISABLED = 0x0,
    SELF_REFRESH = 0x1,
    POWER_DOWN = 0x2,
    DEEP_POWER_DOWN = 0x3,
...
/// Register: LPR
/// Field: TIMEOUT [12:13]
enum class SDRAMC_LPR_TIMEOUT : uint32_t {
    LP_LAST_XFER = 0x0,
    LP_LAST_XFER_64 = 0x1,
    LP_LAST_XFER_128 = 0x2,
};

/// Memory Device Type
/// Register: MDR
/// Field: MD [0:1]
enum class SDRAMC_MDR_MD : uint32_t {
    SDRAM = 0x0,
    LPSDRAM = 0x1,
};
...
/// Register: CFR1
/// Field: UNAL [8:8]
enum class SDRAMC_CFR1_UNAL : uint32_t {
    UNSUPPORTED = 0x0,
    SUPPORTED = 0x1,
};
...
/// Register: MODE
/// Field: EXNW_MODE [4:5]
enum class SMC_MODE_EXNW_MODE : uint32_t {
    DISABLED = 0x0,
    FROZEN = 0x2,
    READY = 0x3,
};
...
/// Register: MODE
/// Field: BAT [8:8]
enum class SMC_MODE_BAT : uint32_t {
    BYTE_SELECT = 0x0,
    BYTE_WRITE = 0x1,
};
...
/// Register: WPMR
/// Field: WPKEY [8:31]
enum class SMC_WPMR_WPKEY : uint32_t {
    PASSWD = 0x534D43,
};
...
enum class SPI0_CSR_4_BITS : uint32_t {
    ...
    VAL_13_BIT = 0x5,  // _13_BIT
    VAL_14_BIT = 0x6,  // _14_BIT
    VAL_15_BIT = 0x7,  // _15_BIT
    VAL_16_BIT = 0x8,  // _16_BIT
};
...
/// Register: FSM
/// Field: DRDSTATE [0:3]
enum class USBHS_FSM_DRDSTATE : uint32_t {
    A_IDLESTATE = 0x0,
    A_WAIT_VRISE = 0x1,
    A_WAIT_BCON = 0x2,
    A_HOST = 0x3,
