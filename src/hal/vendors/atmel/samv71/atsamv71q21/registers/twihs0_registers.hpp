...
struct TWIHS0_Registers {
    ...
    uint8_t RESERVED_0050[128]; ///< Reserved

    /// Debug Register
    /// Offset: 0x00D0
    /// Access: read-only
    volatile uint32_t DR;
    uint8_t RESERVED_00D4[16]; ///< Reserved
...
static_assert(sizeof(TWIHS0_Registers) >= 256, "TWIHS0_Registers size mismatch");

/// TWIHS0 peripheral instance
inline TWIHS0_Registers* TWIHS0() {
