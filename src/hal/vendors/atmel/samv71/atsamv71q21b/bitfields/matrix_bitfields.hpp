...
namespace alloy::hal::atmel::samv71::atsamv71q21b::matrix {
...
namespace pras {
    ...
    /// Master 7 Priority
    /// Position: 28, Width: 2
    using M7PR = BitField<28, 2>;
    constexpr uint32_t M7PR_Pos = 28;
    constexpr uint32_t M7PR_Msk = M7PR::mask;
...
namespace mrcr {
    ...
    /// Position: 7, Width: 1
    using RCB7 = BitField<7, 1>;
    constexpr uint32_t RCB7_Pos = 7;
    constexpr uint32_t RCB7_Msk = RCB7::mask;
