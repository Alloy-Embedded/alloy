...
/// bit0: APP CPU interrupt enable bit1: APP CPU non-maskable interrupt enable bit3: PRO CPU
/// interrupt enable bit4: PRO CPU non-maskable interrupt enable bit5: SDIO's extent interrupt
/// enable Position: 13, Width: 5 Access: read-write
...
/// invert the output enable value if you want to revert the output enable value setting the value
/// to 1 Position: 11, Width: 1 Access: read-write
