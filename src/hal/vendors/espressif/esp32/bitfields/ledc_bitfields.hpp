...
/// There are four high speed timers the two bits are used to select one of them for high speed
/// channel0. 2'b00: seletc hstimer0. 2'b01: select hstimer1. 2'b10: select hstimer2. 2'b11: select
/// hstimer3. Position: 0, Width: 2 Access: read-write
...
/// The output value changes to high when htimerx(x=[0 3]) selected by high speed channel0 has
/// reached reg_hpoint_hsch0[19:0] Position: 0, Width: 20 Access: read-write
...
/// This register is used to increase or decrease the duty every reg_duty_cycle_hsch0 cycles for
/// high speed channel0. Position: 10, Width: 10 Access: read-write
using DUTY_CYCLE = BitField<10, 10>;
constexpr uint32_t DUTY_CYCLE_Pos = 10;
constexpr uint32_t DUTY_CYCLE_Msk = DUTY_CYCLE::mask;

/// This register is used to control the num of increased or decreased times for high speed
/// channel0. Position: 20, Width: 10 Access: read-write
using DUTY_NUM = BitField<20, 10>;
constexpr uint32_t DUTY_NUM_Pos = 20;
constexpr uint32_t DUTY_NUM_Msk = DUTY_NUM::mask;

/// This register is used to increase the duty of output signal or decrease the duty of output
/// signal for high speed channel0. Position: 30, Width: 1 Access: read-write
using DUTY_INC = BitField<30, 1>;
constexpr uint32_t DUTY_INC_Pos = 30;
constexpr uint32_t DUTY_INC_Msk = DUTY_INC::mask;

/// When reg_duty_num_hsch0 reg_duty_cycle_hsch0 and reg_duty_scale_hsch0 has been configured. these
/// register won't take effect until set reg_duty_start_hsch0. this bit is automatically cleared by
/// hardware. Position: 31, Width: 1 Access: read-write
...
/// There are four low speed timers the two bits are used to select one of them for low speed
/// channel0. 2'b00: seletc lstimer0. 2'b01: select lstimer1. 2'b10: select lstimer2. 2'b11: select
/// lstimer3. Position: 0, Width: 2 Access: read-write
using TIMER_SEL = BitField<0, 2>;
constexpr uint32_t TIMER_SEL_Pos = 0;
constexpr uint32_t TIMER_SEL_Msk = TIMER_SEL::mask;
...
/// This bit is used to update register LEDC_LSCH0_HPOINT and LEDC_LSCH0_DUTY for low speed
/// channel0. Position: 4, Width: 1 Access: read-write
...
/// The output value changes to high when lstimerx(x=[0 3]) selected by low speed channel0 has
/// reached reg_hpoint_lsch0[19:0] Position: 0, Width: 20 Access: read-write
using HPOINT = BitField<0, 20>;
constexpr uint32_t HPOINT_Pos = 0;
constexpr uint32_t HPOINT_Msk = HPOINT::mask;
...
/// This register is used to increase or decrease the duty every reg_duty_cycle_lsch0 cycles for low
/// speed channel0. Position: 10, Width: 10 Access: read-write
using DUTY_CYCLE = BitField<10, 10>;
constexpr uint32_t DUTY_CYCLE_Pos = 10;
constexpr uint32_t DUTY_CYCLE_Msk = DUTY_CYCLE::mask;
...
/// This register is used to increase the duty of output signal or decrease the duty of output
/// signal for low speed channel6. Position: 30, Width: 1 Access: read-write
using DUTY_INC = BitField<30, 1>;
constexpr uint32_t DUTY_INC_Pos = 30;
constexpr uint32_t DUTY_INC_Msk = DUTY_INC::mask;

/// When reg_duty_num_hsch1 reg_duty_cycle_hsch1 and reg_duty_scale_hsch1 has been configured. these
/// register won't take effect until set reg_duty_start_hsch1. this bit is automatically cleared by
/// hardware. Position: 31, Width: 1 Access: read-write
using DUTY_START = BitField<31, 1>;
constexpr uint32_t DUTY_START_Pos = 31;
constexpr uint32_t DUTY_START_Msk = DUTY_START::mask;
...
/// This register controls the range of the counter in high speed timer0. the counter range is [0
/// 2**reg_hstimer0_lim] the max bit width for counter is 20. Position: 0, Width: 5 Access:
/// read-write
using DUTY_RES = BitField<0, 5>;
constexpr uint32_t DUTY_RES_Pos = 0;
constexpr uint32_t DUTY_RES_Msk = DUTY_RES::mask;

/// This register is used to configure parameter for divider in high speed timer0 the least
/// significant eight bits represent the decimal part. Position: 5, Width: 18 Access: read-write
...
/// This register controls the range of the counter in low speed timer0. the counter range is [0
/// 2**reg_lstimer0_lim] the max bit width for counter is 20. Position: 0, Width: 5 Access:
/// read-write
using DUTY_RES = BitField<0, 5>;
constexpr uint32_t DUTY_RES_Pos = 0;
constexpr uint32_t DUTY_RES_Msk = DUTY_RES::mask;

/// This register is used to configure parameter for divider in low speed timer0 the least
/// significant eight bits represent the decimal part. Position: 5, Width: 18 Access: read-write
using DIV_NUM = BitField<5, 18>;
constexpr uint32_t DIV_NUM_Pos = 5;
constexpr uint32_t DIV_NUM_Msk = DIV_NUM::mask;
