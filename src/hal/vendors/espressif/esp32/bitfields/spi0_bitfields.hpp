...
/// The bit will be cleared once the operation done.1: enable 0: disable. Position: 16, Width: 1
/// Access: read-write
...
/// The bit will be cleared once the operation done.1: enable 0: disable. Position: 17, Width: 1
/// Access: read-write
using FLASH_PES = BitField<17, 1>;
constexpr uint32_t FLASH_PES_Pos = 17;
constexpr uint32_t FLASH_PES_Msk = FLASH_PES::mask;

/// User define command enable. An operation will be triggered when the bit is set. The bit will be
/// cleared once the operation done.1: enable 0: disable. Position: 18, Width: 1 Access: read-write
using USR = BitField<18, 1>;
constexpr uint32_t USR_Pos = 18;
constexpr uint32_t USR_Msk = USR::mask;

/// Drive Flash into high performance mode. The bit will be cleared once the operation done.1:
/// enable 0: disable. Position: 19, Width: 1 Access: read-write
using FLASH_HPM = BitField<19, 1>;
constexpr uint32_t FLASH_HPM_Pos = 19;
constexpr uint32_t FLASH_HPM_Msk = FLASH_HPM::mask;

/// This bit combined with reg_resandres bit releases Flash from the power-down state or high
/// performance mode and obtains the devices ID. The bit will be cleared once the operation done.1:
/// enable 0: disable. Position: 20, Width: 1 Access: read-write
using FLASH_RES = BitField<20, 1>;
constexpr uint32_t FLASH_RES_Pos = 20;
constexpr uint32_t FLASH_RES_Msk = FLASH_RES::mask;

/// Drive Flash into power down. An operation will be triggered when the bit is set. The bit will be
/// cleared once the operation done.1: enable 0: disable. Position: 21, Width: 1 Access: read-write
using FLASH_DP = BitField<21, 1>;
constexpr uint32_t FLASH_DP_Pos = 21;
constexpr uint32_t FLASH_DP_Msk = FLASH_DP::mask;

/// Chip erase enable. Chip erase operation will be triggered when the bit is set. The bit will be
/// cleared once the operation done.1: enable 0: disable. Position: 22, Width: 1 Access: read-write
using FLASH_CE = BitField<22, 1>;
constexpr uint32_t FLASH_CE_Pos = 22;
constexpr uint32_t FLASH_CE_Msk = FLASH_CE::mask;

/// Block erase enable. A 64KB block is erased via SPI command D8H. Block erase operation will be
/// triggered when the bit is set. The bit will be cleared once the operation done.1: enable 0:
/// disable. Position: 23, Width: 1 Access: read-write
using FLASH_BE = BitField<23, 1>;
constexpr uint32_t FLASH_BE_Pos = 23;
constexpr uint32_t FLASH_BE_Msk = FLASH_BE::mask;

/// Sector erase enable. A 4KB sector is erased via SPI command 20H. Sector erase operation will be
/// triggered when the bit is set. The bit will be cleared once the operation done.1: enable 0:
/// disable. Position: 24, Width: 1 Access: read-write
using FLASH_SE = BitField<24, 1>;
constexpr uint32_t FLASH_SE_Pos = 24;
constexpr uint32_t FLASH_SE_Msk = FLASH_SE::mask;

/// Page program enable(1 byte ~256 bytes data to be programmed). Page program operation will be
/// triggered when the bit is set. The bit will be cleared once the operation done .1: enable 0:
/// disable. Position: 25, Width: 1 Access: read-write
using FLASH_PP = BitField<25, 1>;
constexpr uint32_t FLASH_PP_Pos = 25;
constexpr uint32_t FLASH_PP_Msk = FLASH_PP::mask;

/// Write status register enable. Write status operation will be triggered when the bit is set. The
/// bit will be cleared once the operation done.1: enable 0: disable. Position: 26, Width: 1 Access:
/// read-write
using FLASH_WRSR = BitField<26, 1>;
constexpr uint32_t FLASH_WRSR_Pos = 26;
constexpr uint32_t FLASH_WRSR_Msk = FLASH_WRSR::mask;

/// Read status register-1. Read status operation will be triggered when the bit is set. The bit
/// will be cleared once the operation done.1: enable 0: disable. Position: 27, Width: 1 Access:
/// read-write
using FLASH_RDSR = BitField<27, 1>;
constexpr uint32_t FLASH_RDSR_Pos = 27;
constexpr uint32_t FLASH_RDSR_Msk = FLASH_RDSR::mask;

/// Read JEDEC ID . Read ID command will be sent when the bit is set. The bit will be cleared once
/// the operation done. 1: enable 0: disable. Position: 28, Width: 1 Access: read-write
using FLASH_RDID = BitField<28, 1>;
constexpr uint32_t FLASH_RDID_Pos = 28;
constexpr uint32_t FLASH_RDID_Msk = FLASH_RDID::mask;

/// Write flash disable. Write disable command will be sent when the bit is set. The bit will be
/// cleared once the operation done. 1: enable 0: disable. Position: 29, Width: 1 Access: read-write
using FLASH_WRDI = BitField<29, 1>;
constexpr uint32_t FLASH_WRDI_Pos = 29;
constexpr uint32_t FLASH_WRDI_Msk = FLASH_WRDI::mask;

/// Write flash enable. Write enable command will be sent when the bit is set. The bit will be
/// cleared once the operation done. 1: enable 0: disable. Position: 30, Width: 1 Access: read-write
using FLASH_WREN = BitField<30, 1>;
constexpr uint32_t FLASH_WREN_Pos = 30;
constexpr uint32_t FLASH_WREN_Msk = FLASH_WREN::mask;

/// Read flash enable. Read flash operation will be triggered when the bit is set. The bit will be
/// cleared once the operation done. 1: enable 0: disable. Position: 31, Width: 1 Access: read-write
...
/// This bit enable the bits: spi_fread_qio spi_fread_dio spi_fread_qout and spi_fread_dout. 1:
/// enable 0: disable. Position: 13, Width: 1 Access: read-write
...
/// The Device ID is read out to SPI_RD_STATUS register, this bit combine with spi_flash_res bit. 1:
/// enable 0: disable. Position: 15, Width: 1 Access: read-write
...
/// modify spi clock duty ratio when the value is lager than 8, the bits are combined with
/// spi_clkcnt_N bits and spi_clkcnt_L bits. Position: 8, Width: 4 Access: read-write
...
/// modify spi clock duty ratio when the value is lager than 8, the bits are combined with
/// spi_clkcnt_N bits and spi_clkcnt_H bits. Position: 12, Width: 4 Access: read-write
...
/// MISO signals are delayed by spi_clk. 0: zero 1: if spi_ck_out_edge or spi_ck_i_edge is set 1
/// delayed by half cycle else delayed by one cycle 2: if spi_ck_out_edge or spi_ck_i_edge is set 1
/// delayed by one cycle else delayed by half cycle 3: delayed one cycle Position: 16, Width: 2
/// Access: read-write
...
/// MOSI signals are delayed by spi_clk. 0: zero 1: if spi_ck_out_edge or spi_ck_i_edge is set 1
/// delayed by half cycle else delayed by one cycle 2: if spi_ck_out_edge or spi_ck_i_edge is set 1
/// delayed by one cycle else delayed by half cycle 3: delayed one cycle Position: 21, Width: 2
/// Access: read-write
...
/// spi_cs signal is delayed by spi_clk . 0: zero 1: if spi_ck_out_edge or spi_ck_i_edge is set 1
/// delayed by half cycle else delayed by one cycle 2: if spi_ck_out_edge or spi_ck_i_edge is set 1
/// delayed by one cycle else delayed by half cycle 3: delayed one cycle Position: 26, Width: 2
/// Access: read-write
...
/// system/(spi_clkdiv_pre+1)/(spi_clkcnt_N+1) Position: 12, Width: 6 Access: read-write
...
/// In the slave mode the bit is same as spi_ck_out_edge in master mode. It is combined with
/// spi_miso_delay_mode bits. Position: 6, Width: 1 Access: read-write
...
/// 1: enable 0: disable. Position: 16, Width: 1 Access: read-write
using SIO = BitField<16, 1>;
constexpr uint32_t SIO_Pos = 16;
constexpr uint32_t SIO_Msk = SIO::mask;

/// It is combined with hold bits to set the polarity of spi hold line 1: spi will be held when spi
/// hold line is high 0: spi will be held when spi hold line is low Position: 17, Width: 1 Access:
/// read-write
...
/// In the slave mode this register are the status register for the master to write into. In the
/// master mode this register are the higher 32bits in the 64 bits address condition. Position: 0,
/// Width: 32 Access: read-write
...
/// In the master mode the bits are the polarity of spi cs line the value is equivalent to spi_cs ^
/// spi_master_cs_pol. Position: 6, Width: 3 Access: read-write
...
/// In the master mode spi cs line is enable as spi clk it is combined with spi_cs0_dis spi_cs1_dis
/// spi_cs2_dis. Position: 11, Width: 3 Access: read-write
...
/// The interrupt raw bit for the completion of any operation in both the master mode and the slave
/// mode. Position: 4, Width: 1 Access: read-write
...
/// In the slave mode this bits used to synchronize the input spi cs signal and eliminate spi cs
/// jitter. Position: 10, Width: 2 Access: read-write
...
/// 1: slave mode commands are defined in SPI_SLAVE3. 0: slave mode commands are fixed as: 1:
/// write-status 2: write-buffer and 3: read-buffer. Position: 27, Width: 1 Access: read-write
...
/// In the slave mode it is the address length in bits for write-buffer operation. The register
/// value shall be (bit_num-1). Position: 4, Width: 6 Access: read-write
...
/// In the slave mode it is the address length in bits for read-buffer operation. The register value
/// shall be (bit_num-1). Position: 10, Width: 6 Access: read-write
...
/// SLAVE2 - SLAVE2
namespace slave2 {
/// In the slave mode it is the length in spi_clk cycles of dummy phase for read-status operations.
/// The register value shall be (cycle_num-1). Position: 0, Width: 8 Access: read-write
...
/// In the slave mode it is the length in spi_clk cycles of dummy phase for write-status operations.
/// The register value shall be (cycle_num-1). Position: 8, Width: 8 Access: read-write
...
/// In the slave mode it is the length in spi_clk cycles of dummy phase for read-buffer operations.
/// The register value shall be (cycle_num-1). Position: 16, Width: 8 Access: read-write
...
/// In the slave mode it is the length in spi_clk cycles of dummy phase for write-buffer operations.
/// The register value shall be (cycle_num-1). Position: 24, Width: 8 Access: read-write
...
/// In the slave mode it is the length in bits for write-buffer operations. The register value shall
/// be (bit_num-1). Position: 0, Width: 24 Access: read-write
...
/// In the slave mode it is the length in bits for read-buffer operations. The register value shall
/// be (bit_num-1). Position: 0, Width: 24 Access: read-write
...
/// For SPI0 In the sram mode it is the length in bits of address phase. The register value shall be
/// (bit_num-1). Position: 14, Width: 8 Access: read-write
...
/// For SPI0 In the sram mode it is the length in bits of address phase. The register value shall be
/// (bit_num-1). Position: 22, Width: 6 Access: read-write
...
/// SRAM_CMD - SRAM_CMD
namespace sram_cmd {
/// For SPI0 SRAM DIO mode enable . SRAM DIO enable command will be send when the bit is set. The
/// bit will be cleared once the operation done. Position: 0, Width: 1 Access: read-write
using SRAM_DIO = BitField<0, 1>;
constexpr uint32_t SRAM_DIO_Pos = 0;
constexpr uint32_t SRAM_DIO_Msk = SRAM_DIO::mask;

/// For SPI0 SRAM QIO mode enable . SRAM QIO enable command will be send when the bit is set. The
/// bit will be cleared once the operation done. Position: 1, Width: 1 Access: read-write
using SRAM_QIO = BitField<1, 1>;
constexpr uint32_t SRAM_QIO_Pos = 1;
constexpr uint32_t SRAM_QIO_Msk = SRAM_QIO::mask;

/// For SPI0 SRAM IO mode reset enable. SRAM IO mode reset operation will be triggered when the bit
/// is set. The bit will be cleared once the operation done Position: 4, Width: 1 Access: read-write
...
/// For SPI0 When cache mode is enable it is the length in bits of command phase for SRAM. The
/// register value shall be (bit_num-1). Position: 28, Width: 4 Access: read-write
...
/// For SPI0 When cache mode is enable it is the in bits of command phase for SRAM. The register
/// value shall be (bit_num-1). Position: 28, Width: 4 Access: read-write
...
/// EXT3 - EXT3
namespace ext3 {
/// This register is for two SPI masters to share the same cs clock and data signals. The bits of
/// one SPI are set if the other SPI is busy the SPI will be hold. 1(3): hold at ¡°idle¡± phase 2:
/// hold at ¡°prepare¡± phase. Position: 0, Width: 2 Access: read-write
...
/// out eof flag generation mode . 1: when dma pop all data from fifo 0:when ahb push all data to
/// fifo. Position: 9, Width: 1 Access: read-write
