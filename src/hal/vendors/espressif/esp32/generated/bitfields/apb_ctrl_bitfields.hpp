...
/// 1: sar_sel will be coded by the MSB of the 16-bit output data in this case the resolution should
/// not be larger than 11 bits. Position: 25, Width: 1 Access: read-write
