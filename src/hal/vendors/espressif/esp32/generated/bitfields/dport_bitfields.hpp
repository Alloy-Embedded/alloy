...
constexpr uint32_t PRO_CPU_DISABLED_CACHE_IA_OPPOSITE_Msk =
    PRO_CPU_DISABLED_CACHE_IA_OPPOSITE::mask;
...
constexpr uint32_t APP_CPU_DISABLED_CACHE_IA_OPPOSITE_Msk =
    APP_CPU_DISABLED_CACHE_IA_OPPOSITE::mask;
