...
/// This register is used to control the mode of channel0's input negedge signal for unit0. 2'd1:
/// increase at the negedge of input signal 2'd2:decrease at the negedge of input signal
/// others:forbidden Position: 16, Width: 2 Access: read-write
...
/// This register is used to control the mode of channel0's input posedge signal for unit0. 2'd1:
/// increase at the posedge of input signal 2'd2:decrease at the posedge of input signal
/// others:forbidden Position: 18, Width: 2 Access: read-write
...
/// 2'd0:increase when control signal is low 2'd1: decrease when control signal is high
/// others:forbidden Position: 20, Width: 2 Access: read-write
...
/// 2'd0:increase when control signal is low 2'd1: decrease when control signal is high
/// others:forbidden Position: 22, Width: 2 Access: read-write
...
/// This register is used to control the mode of channel1's input negedge signal for unit0. 2'd1:
/// increase at the negedge of input signal 2'd2:decrease at the negedge of input signal
/// others:forbidden Position: 24, Width: 2 Access: read-write
...
/// This register is used to control the mode of channel1's input posedge signal for unit0. 2'd1:
/// increase at the posedge of input signal 2'd2:decrease at the posedge of input signal
/// others:forbidden Position: 26, Width: 2 Access: read-write
...
/// 2'd0:increase when control signal is low 2'd1: decrease when control signal is high
/// others:forbidden Position: 28, Width: 2 Access: read-write
...
/// 2'd0:increase when control signal is low 2'd1: decrease when control signal is high
/// others:forbidden Position: 30, Width: 2 Access: read-write
