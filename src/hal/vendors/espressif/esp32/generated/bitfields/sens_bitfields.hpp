...
/// 1: SAR ADC1 controller (in RTC) is started by SW 0: SAR ADC1 controller is started by
/// ULP-coprocessor Position: 18, Width: 1 Access: read-write
...
/// 1: SAR ADC1 pad enable bitmap is controlled by SW 0: SAR ADC1 pad enable bitmap is controlled by
/// ULP-coprocessor Position: 31, Width: 1 Access: read-write
...
/// 1: when the counter is greater then the threshold the touch pad is considered as "touched" 0:
/// when the counter is less than the threshold the touch pad is considered as "touched" Position:
...
/// 1: wakeup interrupt is generated if SET1 is "touched" 0: wakeup interrupt is generated only if
/// SET1 & SET2 is both "touched" Position: 25, Width: 1 Access: read-write
...
/// 1: TOUCH_START & TOUCH_XPD is controlled by touch fsm 0: TOUCH_START & TOUCH_XPD is controlled
/// by registers Position: 11, Width: 1 Access: read-write
...
/// Bitmap defining SET2 for generating wakeup interrupt. SET2 is "touched" only if at least one of
/// touch pad in SET2 is "touched". Position: 10, Width: 10 Access: read-write
...
/// Bitmap defining SET1 for generating wakeup interrupt. SET1 is "touched" only if at least one of
/// touch pad in SET1 is "touched". Position: 20, Width: 10 Access: read-write
...
/// 1: SAR ADC2 controller (in RTC) is started by SW 0: SAR ADC2 controller is started by
/// ULP-coprocessor Position: 18, Width: 1 Access: read-write
...
/// 1: SAR ADC2 pad enable bitmap is controlled by SW 0: SAR ADC2 pad enable bitmap is controlled by
/// ULP-coprocessor Position: 31, Width: 1 Access: read-write
...
/// 1: to select CW generator as source to PDAC1_DAC[7:0] 0: to select register reg_pdac1_dac[7:0]
/// as source to PDAC1_DAC[7:0] Position: 24, Width: 1 Access: read-write
using DAC_CW_EN1 = BitField<24, 1>;
constexpr uint32_t DAC_CW_EN1_Pos = 24;
constexpr uint32_t DAC_CW_EN1_Msk = DAC_CW_EN1::mask;

/// 1: to select CW generator as source to PDAC2_DAC[7:0] 0: to select register reg_pdac2_dac[7:0]
/// as source to PDAC2_DAC[7:0] Position: 25, Width: 1 Access: read-write
