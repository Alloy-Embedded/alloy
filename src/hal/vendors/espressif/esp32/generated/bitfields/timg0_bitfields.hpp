...
/// T0UPDATE - T0UPDATE
namespace t0update {
/// Write any value will trigger a timer 0 time-base counter value update (timer 0 current value
/// will be stored in registers above) Position: 0, Width: 32 Access: write-only
...
/// T1UPDATE - T1UPDATE
namespace t1update {
/// Write any value will trigger a timer 1 time-base counter value update (timer 1 current value
/// will be stored in registers above) Position: 0, Width: 32 Access: write-only
using UPDATE = BitField<0, 32>;
constexpr uint32_t UPDATE_Pos = 0;
constexpr uint32_t UPDATE_Msk = UPDATE::mask;
...
/// length of system reset selection. 0: 100ns 1: 200ns 2: 300ns 3: 400ns 4: 500ns 5: 800ns 6: 1.6us
/// 7: 3.2us Position: 15, Width: 3 Access: read-write
...
/// length of CPU reset selection. 0: 100ns 1: 200ns 2: 300ns 3: 400ns 4: 500ns 5: 800ns 6: 1.6us
/// 7: 3.2us Position: 18, Width: 3 Access: read-write
