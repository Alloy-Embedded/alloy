...
namespace gpio {
    ...
    struct Registers {
        volatile uint32_t BT_SELECT;  ///< Offset: 0x00 - NA
        volatile uint32_t OUT;  ///< Offset: 0x04 - GPIO0~31 output value
        volatile uint32_t OUT_W1TS;  ///< Offset: 0x08 - GPIO0~31 output value write 1 to set
        volatile uint32_t OUT_W1TC;  ///< Offset: 0x0C - GPIO0~31 output value write 1 to clear
        volatile uint32_t OUT1;  ///< Offset: 0x10 - GPIO32~39 output value
        volatile uint32_t OUT1_W1TS;  ///< Offset: 0x14 - GPIO32~39 output value write 1 to set
        volatile uint32_t OUT1_W1TC;  ///< Offset: 0x18 - GPIO32~39 output value write 1 to clear
        volatile uint32_t SDIO_SELECT;  ///< Offset: 0x1C - SDIO PADS on/off control from outside
        volatile uint32_t ENABLE;  ///< Offset: 0x20 - GPIO0~31 output enable
        volatile uint32_t ENABLE_W1TS;  ///< Offset: 0x24 - GPIO0~31 output enable write 1 to set
        volatile uint32_t ENABLE_W1TC;  ///< Offset: 0x28 - GPIO0~31 output enable write 1 to clear
        volatile uint32_t ENABLE1;  ///< Offset: 0x2C - GPIO32~39 output enable
        volatile uint32_t ENABLE1_W1TS;  ///< Offset: 0x30 - GPIO32~39 output enable write 1 to set
        volatile uint32_t ENABLE1_W1TC;  ///< Offset: 0x34 - GPIO32~39 output enable write 1 to clear
        volatile uint32_t STRAP;  ///< Offset: 0x38 - GPIO strapping results
        volatile uint32_t IN;  ///< Offset: 0x3C - GPIO0~31 input value
        volatile uint32_t IN1;  ///< Offset: 0x40 - GPIO32~39 input value
        volatile uint32_t STATUS;  ///< Offset: 0x44 - GPIO0~31 interrupt status
        volatile uint32_t STATUS_W1TS;  ///< Offset: 0x48 - GPIO0~31 interrupt status write 1 to set
        volatile uint32_t STATUS_W1TC;  ///< Offset: 0x4C - GPIO0~31 interrupt status write 1 to clear
        volatile uint32_t STATUS1;  ///< Offset: 0x50 - GPIO32~39 interrupt status
        volatile uint32_t STATUS1_W1TS;  ///< Offset: 0x54 - GPIO32~39 interrupt status write 1 to set
        volatile uint32_t STATUS1_W1TC;  ///< Offset: 0x58 - GPIO32~39 interrupt status write 1 to clear
    };
