...
// with single-cycle access. Base Address: 0xD0000000
// ============================================================================

/// SIO Register Structure
struct SIO_Registers {
    /// Processor core identifier\n Value is 0 when read from processor core 0, and 1 when read from
    /// processor core 1. Offset: 0x0000 Reset value: 0x00000000 Access: read-only
    ...
    /// 1 direction, and one core 1 -> core 0. Both are 32 bits wide and 8 words deep.\n Core 0 can
    /// see the read side of the 1->0 FIFO (RX), and the write side of 0->1 FIFO (TX).\n Core 1 can
    /// see the read side of the 0->1 FIFO (RX), and the write side of 1->0 FIFO (TX).\n The SIO IRQ
    /// for each core is the logical OR of the VLD, WOF and ROE fields of its FIFO_ST register.
    /// Offset: 0x0050
    ...
    /// intended for debugging. Offset: 0x005C Reset value: 0x00000000 Access: read-only
    ...
    /// starts an\n unsigned calculation, and the S alias starts a signed calculation. Offset:
    /// 0x0060 Reset value: 0x00000000 Access: read-write
    ...
    /// REMAINDER.\n UDIVIDEND/SDIVIDEND are aliases of the same internal register. The U alias
    /// starts an\n unsigned calculation, and the S alias starts a signed calculation. Offset:
    /// 0x0064 Reset value: 0x00000000 Access: read-write
    volatile uint32_t DIV_UDIVISOR;

    /// Divider signed dividend\n The same as UDIVIDEND, but starts a signed calculation, rather
    /// than unsigned. Offset: 0x0068 Reset value: 0x00000000 Access: read-write
    volatile uint32_t DIV_SDIVIDEND;

    /// Divider signed divisor\n The same as UDIVISOR, but starts a signed calculation, rather than
    /// unsigned. Offset: 0x006C Reset value: 0x00000000 Access: read-write
    volatile uint32_t DIV_SDIVISOR;

    /// Divider result quotient\n The result of `DIVIDEND / DIVISOR` (division). Contents undefined
    ...
    /// save/restore purposes. This halts any\n in-progress calculation and sets the CSR_READY and
    /// CSR_DIRTY flags.\n Reading from QUOTIENT clears the CSR_DIRTY flag, so should read results
    /// in the order\n REMAINDER, QUOTIENT if CSR_DIRTY is used. Offset: 0x0070 Reset value:
    ...
    /// This halts any\n in-progress calculation and sets the CSR_READY and CSR_DIRTY flags. Offset:
    /// 0x0074 Reset value: 0x00000000 Access: read-write
    ...
    /// Values written here are atomically added to ACCUM0\n Reading yields lane 0's raw shift and
    /// mask value (BASE0 not added). Offset: 0x00B4 Reset value: 0x00000000
    volatile uint32_t INTERP0_ACCUM0_ADD;

    /// Values written here are atomically added to ACCUM1\n Reading yields lane 1's raw shift and
    /// mask value (BASE1 not added). Offset: 0x00B8 Reset value: 0x00000000
    volatile uint32_t INTERP0_ACCUM1_ADD;

    /// On write, the lower 16 bits go to BASE0, upper bits to BASE1 simultaneously.\n Each half is
    /// sign-extended to 32 bits if that lane's SIGNED flag is set. Offset: 0x00BC Reset value:
    /// 0x00000000 Access: read-write
    ...
    /// Values written here are atomically added to ACCUM0\n Reading yields lane 0's raw shift and
    /// mask value (BASE0 not added). Offset: 0x00F4 Reset value: 0x00000000
    volatile uint32_t INTERP1_ACCUM0_ADD;

    /// Values written here are atomically added to ACCUM1\n Reading yields lane 1's raw shift and
    /// mask value (BASE1 not added). Offset: 0x00F8 Reset value: 0x00000000
    volatile uint32_t INTERP1_ACCUM1_ADD;

    /// On write, the lower 16 bits go to BASE0, upper bits to BASE1 simultaneously.\n Each half is
    /// sign-extended to 32 bits if that lane's SIGNED flag is set. Offset: 0x00FC Reset value:
    /// 0x00000000 Access: read-write
    volatile uint32_t INTERP1_BASE_1AND0;

    /// Reading from a spinlock address will:\n - Return 0 if lock is already locked\n - Otherwise
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0100 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0104 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0108 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x010C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0110 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0114 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0118 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x011C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0120 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0124 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0128 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x012C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0130 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0134 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0138 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x013C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0140 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0144 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0148 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x014C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0150 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0154 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0158 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x015C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0160 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0164 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0168 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x016C Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0170 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0174 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x0178 Reset value: 0x00000000
    /// Access: read-only
    ...
    /// return nonzero, and simultaneously claim the lock\n\n Writing (any value) releases the
    /// lock.\n If core 0 and core 1 attempt to claim the same lock simultaneously, core 0 wins.\n
    /// The value returned on success is 0x1 << lock number. Offset: 0x017C Reset value: 0x00000000
    /// Access: read-only
