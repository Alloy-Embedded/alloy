...
namespace keyr {
    /// Flash Key
    /// Position: 0, Width: 32
    using FKEYR = BitField<0, 32>;
    constexpr uint32_t FKEYR_Pos = 0;
    constexpr uint32_t FKEYR_Msk = FKEYR::mask;
...
namespace sr {
    ...
    /// Position: 4, Width: 1
    /// Access: read-write
    using WRPRT = BitField<4, 1>;
    constexpr uint32_t WRPRT_Pos = 4;
    constexpr uint32_t WRPRT_Msk = WRPRT::mask;
...
namespace cr {
    ...
    /// Position: 13, Width: 1
    using FORCE_OPTLOAD = BitField<13, 1>;
    constexpr uint32_t FORCE_OPTLOAD_Pos = 13;
    constexpr uint32_t FORCE_OPTLOAD_Msk = FORCE_OPTLOAD::mask;
...
namespace obr {
    ...
    /// Position: 1, Width: 1
    using LEVEL1_PROT = BitField<1, 1>;
    constexpr uint32_t LEVEL1_PROT_Pos = 1;
    constexpr uint32_t LEVEL1_PROT_Msk = LEVEL1_PROT::mask;

    /// Level 2 protection status
    /// Position: 2, Width: 1
    using LEVEL2_PROT = BitField<2, 1>;
    constexpr uint32_t LEVEL2_PROT_Pos = 2;
    constexpr uint32_t LEVEL2_PROT_Msk = LEVEL2_PROT::mask;

    /// WDG_SW
    /// Position: 8, Width: 1
    using WDG_SW = BitField<8, 1>;
    constexpr uint32_t WDG_SW_Pos = 8;
    constexpr uint32_t WDG_SW_Msk = WDG_SW::mask;

    /// nRST_STOP
    /// Position: 9, Width: 1
    using nRST_STOP = BitField<9, 1>;
    constexpr uint32_t nRST_STOP_Pos = 9;
    constexpr uint32_t nRST_STOP_Msk = nRST_STOP::mask;

    /// nRST_STDBY
    /// Position: 10, Width: 1
    using nRST_STDBY = BitField<10, 1>;
    constexpr uint32_t nRST_STDBY_Pos = 10;
    constexpr uint32_t nRST_STDBY_Msk = nRST_STDBY::mask;

    /// BOOT1
    /// Position: 12, Width: 1
    using BOOT1 = BitField<12, 1>;
    constexpr uint32_t BOOT1_Pos = 12;
    constexpr uint32_t BOOT1_Msk = BOOT1::mask;

    /// VDDA_MONITOR
    /// Position: 13, Width: 1
    using VDDA_MONITOR = BitField<13, 1>;
    constexpr uint32_t VDDA_MONITOR_Pos = 13;
    constexpr uint32_t VDDA_MONITOR_Msk = VDDA_MONITOR::mask;

    /// Data0
    /// Position: 16, Width: 8
    using Data0 = BitField<16, 8>;
    constexpr uint32_t Data0_Pos = 16;
    constexpr uint32_t Data0_Msk = Data0::mask;

    /// Data1
    /// Position: 24, Width: 8
    using Data1 = BitField<24, 8>;
    constexpr uint32_t Data1_Pos = 24;
