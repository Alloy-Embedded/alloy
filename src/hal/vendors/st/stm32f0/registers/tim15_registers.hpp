/// Auto-generated register definitions for TIM15
/// Family: stm32f0
/// Vendor: STMicro
///
...
namespace alloy::hal::st::stm32f0::tim15 {
...
static_assert(sizeof(TIM15_Registers) >= 80, "TIM15_Registers size mismatch");

/// TIM15 peripheral instance
inline TIM15_Registers* TIM15() {
    return reinterpret_cast<TIM15_Registers*>(0x40014000);
}
