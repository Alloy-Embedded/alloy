...
namespace alloy::hal::stm32f030::stm32f030c6::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F030C6
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F030C6 (LQFP48)! "
