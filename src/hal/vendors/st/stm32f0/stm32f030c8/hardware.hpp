...
namespace alloy::hal::stm32f030::stm32f030c8::hardware {

// ============================================================================
// Hardware Register Addresses for STM32F030C8
...
constexpr uintptr_t GPIOC_BASE = 0x48000800;
constexpr uintptr_t GPIOD_BASE = 0x48000C00;
constexpr uintptr_t GPIOF_BASE = 0x48001400;
...
namespace alloy::hal::stm32f030::stm32f030c8 {
