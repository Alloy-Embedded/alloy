...
namespace alloy::hal::stm32f103::stm32f103c4::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F103C4
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F103C4 (LQFP48)! "
