...
namespace alloy::hal::stm32f103::stm32f103c6::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F103C6
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F103C6 (LQFP48)! "
