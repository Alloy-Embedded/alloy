...
namespace alloy::hal::stm32f103::stm32f103rb::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F103RB
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F103RB (LQFP64)! "
