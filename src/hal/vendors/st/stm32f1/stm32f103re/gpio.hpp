...
// ============================================================================
// Single-include GPIO header for STM32F103RE
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f1/stm32f103re/gpio.hpp"
//
...
namespace alloy::hal::stm32f1::stm32f103re {
...
namespace gpio = alloy::hal::stm32f1::stm32f103re;
