...
namespace alloy::hal::st::stm32f1::stm32f103xx::adc1 {
...
namespace cr1 {
    ...
    /// Dual mode selection
    /// Position: 16, Width: 4
    using DUALMOD = BitField<16, 4>;
    constexpr uint32_t DUALMOD_Pos = 16;
    constexpr uint32_t DUALMOD_Msk = DUALMOD::mask;
...
namespace dr {
    ...
    using ADC2DATA = BitField<16, 16>;
    constexpr uint32_t ADC2DATA_Pos = 16;
    constexpr uint32_t ADC2DATA_Msk = ADC2DATA::mask;
