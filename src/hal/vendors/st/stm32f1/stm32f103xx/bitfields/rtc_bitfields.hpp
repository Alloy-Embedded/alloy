...
namespace alloy::hal::st::stm32f1::stm32f103xx::rtc {
...
/// PRLH - RTC Prescaler Load Register
          High
namespace prlh {
...
/// PRLL - RTC Prescaler Load Register
          Low
namespace prll {
...
/// DIVH - RTC Prescaler Divider Register
          High
namespace divh {
    /// RTC prescaler divider register
              high
...
/// DIVL - RTC Prescaler Divider Register
          Low
namespace divl {
    /// RTC prescaler divider register
              Low
