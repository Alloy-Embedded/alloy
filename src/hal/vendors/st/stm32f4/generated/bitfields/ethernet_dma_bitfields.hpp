...
/// DMATPDR - Ethernet DMA transmit poll demand register
namespace dmatpdr {
    /// TPD
    /// Position: 0, Width: 32
...
/// DMARPDR - EHERNET DMA receive poll demand register
namespace dmarpdr {
    /// RPD
    /// Position: 0, Width: 32
...
/// DMARDLAR - Ethernet DMA receive descriptor list address register
namespace dmardlar {
    /// SRL
    /// Position: 0, Width: 32
...
/// DMATDLAR - Ethernet DMA transmit descriptor list address register
namespace dmatdlar {
    /// STL
    /// Position: 0, Width: 32
...
/// DMAOMR - Ethernet DMA operation mode register
namespace dmaomr {
    /// SR
    /// Position: 1, Width: 1
...
/// DMAIER - Ethernet DMA interrupt enable register
namespace dmaier {
    /// TIE
    /// Position: 0, Width: 1
...
/// DMAMFBOCR - Ethernet DMA missed frame and buffer overflow counter register
namespace dmamfbocr {
    /// MFC
    /// Position: 0, Width: 16
...
/// DMARSWTR - Ethernet DMA receive status watchdog timer register
namespace dmarswtr {
    /// RSWTC
    /// Position: 0, Width: 8
...
/// DMACHTDR - Ethernet DMA current host transmit descriptor register
namespace dmachtdr {
    /// HTDAP
    /// Position: 0, Width: 32
...
/// DMACHRDR - Ethernet DMA current host receive descriptor register
namespace dmachrdr {
    /// HRDAP
    /// Position: 0, Width: 32
...
/// DMACHTBAR - Ethernet DMA current host transmit buffer address register
namespace dmachtbar {
    /// HTBAP
    /// Position: 0, Width: 32
...
/// DMACHRBAR - Ethernet DMA current host receive buffer address register
namespace dmachrbar {
    /// HRBAP
    /// Position: 0, Width: 32
