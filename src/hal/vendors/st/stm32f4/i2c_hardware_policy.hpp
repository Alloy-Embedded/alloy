 ...
 * @brief Hardware Policy for I2C on STM32F4 (Policy-Based Design)
 *
...
#include "hal/vendors/st/stm32f4/generated/registers/i2c3_registers.hpp"

// Bitfield definitions
#include "hal/vendors/st/stm32f4/generated/bitfields/i2c3_bitfields.hpp"
...
namespace i2c = st::stm32f4::i2c3;

/**
 * @brief Hardware Policy for I2C on STM32F4
 *
 ...
 *
 * The STM32F4 I2C peripheral uses legacy register layout (CR1/CR2/SR1/SR2/DR)
 * compared to STM32G0 which uses modern registers (TIMINGR/ISR/ICR).
 *
 * Template Parameters:
 * - BASE_ADDR: I2C peripheral base address
 * - PERIPH_CLOCK_HZ: Peripheral clock frequency in Hz (APB1)
 *
 * Usage:
 * @code
 * // Platform-specific alias
 * using I2c1 = I2cImpl<Stm32f4I2cHardwarePolicy<0x40005400, 42000000>>;
 * @endcode
 *
...
struct Stm32f4I2cHardwarePolicy {
    ...
    using RegisterType = I2C3_Registers;
     ...
     * - or PERIPH_CLOCK_HZ / (25 * 400000) (duty cycle 16:9)
     *
...
/**
 * @example STM32F4 I2C Example
 * @code
 * #include "hal/platform/stm32f4/i2c.hpp"
 *
