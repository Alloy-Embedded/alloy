...
// ============================================================================
// Single-include GPIO header for STM32F401CC
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f401cc/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f401cc {
...
namespace gpio = alloy::hal::stm32f4::stm32f401cc;
