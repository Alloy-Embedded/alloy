...
namespace alloy::hal::stm32f401::stm32f401cc::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F401CC
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F401CC (LQFP48)! "
