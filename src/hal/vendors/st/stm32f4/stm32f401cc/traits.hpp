...
namespace alloy::hal::stm32f401::stm32f401cc {

// ============================================================================
// MCU Characteristics for STM32F401CC
// Auto-generated from SVD: STM32F401
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F401CC";
    static constexpr const char* VENDOR = "STMicroelectronics";
    static constexpr const char* FAMILY = "STM32F401";
    static constexpr const char* SERIES = "STM32F401";
    ...
    struct Peripherals {
        ...
        static constexpr uint8_t SPI_COUNT = 4;
