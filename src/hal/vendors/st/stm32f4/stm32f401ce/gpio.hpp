...
// ============================================================================
// Single-include GPIO header for STM32F401CE
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f401ce/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f401ce {
...
namespace gpio = alloy::hal::stm32f4::stm32f401ce;
