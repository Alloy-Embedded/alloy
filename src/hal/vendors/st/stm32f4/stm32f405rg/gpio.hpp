...
// ============================================================================
// Single-include GPIO header for STM32F405RG
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f405rg/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f405rg {
...
namespace gpio = alloy::hal::stm32f4::stm32f405rg;
