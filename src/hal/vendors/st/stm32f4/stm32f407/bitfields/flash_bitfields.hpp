...
namespace alloy::hal::st::stm32f4::stm32f407::flash {
...
namespace acr {
    ...
    /// Position: 10, Width: 1
    /// Access: read-write
    using DCEN = BitField<10, 1>;
    constexpr uint32_t DCEN_Pos = 10;
    constexpr uint32_t DCEN_Msk = DCEN::mask;
    ...
    /// Position: 12, Width: 1
    /// Access: read-write
    using DCRST = BitField<12, 1>;
    constexpr uint32_t DCRST_Pos = 12;
    constexpr uint32_t DCRST_Msk = DCRST::mask;
...
namespace optcr {
    ...
    /// Position: 5, Width: 1
    using WDG_SW = BitField<5, 1>;
    constexpr uint32_t WDG_SW_Pos = 5;
