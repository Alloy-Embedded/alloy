...
/// FS_GRXSTSR_Device - OTG_FS Receive status debug read(Device
          mode)
...
/// FS_GRXSTSR_Host - OTG_FS Receive status debug read(Host
          mode)
...
/// FS_DIEPTXF2 - OTG_FS device IN endpoint transmit FIFO size
