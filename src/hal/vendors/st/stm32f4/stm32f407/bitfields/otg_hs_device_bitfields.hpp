...
namespace alloy::hal::st::stm32f4::stm32f407::otg_hs_device {
...
/// OTG_HS_DCFG - OTG_HS device configuration
          register
...
/// OTG_HS_DOEPMSK - OTG_HS device OUT endpoint common interrupt
          mask register
...
/// OTG_HS_DAINT - OTG_HS device all endpoints interrupt
          register
...
/// OTG_HS_DVBUSPULSE - OTG_HS device VBUS pulsing time
          register
...
/// OTG_HS_DTHRCTL - OTG_HS Device threshold control
          register
...
/// OTG_HS_DIEPEMPMSK - OTG_HS device IN endpoint FIFO empty
...
/// OTG_HS_DEACHINTMSK - OTG_HS device each endpoint interrupt
          register mask
...
namespace otg_hs_diepeachmsk1 {
    ...
    /// NAK interrupt mask
    /// Position: 13, Width: 1
    using NAKM = BitField<13, 1>;
    constexpr uint32_t NAKM_Pos = 13;
...
namespace otg_hs_doepeachmsk1 {
    ...
    /// Bubble error interrupt
              mask
    /// Position: 12, Width: 1
    using BERRM = BitField<12, 1>;
    constexpr uint32_t BERRM_Pos = 12;
    constexpr uint32_t BERRM_Msk = BERRM::mask;
    ...
    /// NYET interrupt mask
    /// Position: 14, Width: 1
    using NYETM = BitField<14, 1>;
    constexpr uint32_t NYETM_Pos = 14;
    constexpr uint32_t NYETM_Msk = NYETM::mask;

}  // namespace otg_hs_doepeachmsk1

/// OTG_HS_DIEPCTL0 - OTG device endpoint-0 control
          register
...
/// OTG_HS_DTXFSTS0 - OTG_HS device IN endpoint transmit FIFO
          status register
...
/// OTG_HS_DIEPTSIZ1 - OTG_HS device endpoint transfer size
          register
...
/// OTG_HS_DIEPDMA2 - OTG_HS device endpoint-2 DMA address
          register
...
/// OTG_HS_DIEPTSIZ2 - OTG_HS device endpoint transfer size
          register
...
/// OTG_HS_DTXFSTS2 - OTG_HS device IN endpoint transmit FIFO
          status register
...
/// OTG_HS_DIEPDMA4 - OTG_HS device endpoint-4 DMA address
          register
...
/// OTG_HS_DTXFSTS3 - OTG_HS device IN endpoint transmit FIFO
          status register
...
/// OTG_HS_DTXFSTS5 - OTG_HS device IN endpoint transmit FIFO
          status register
...
/// OTG_HS_DOEPINT0 - OTG_HS device endpoint-0 interrupt
          register
...
/// OTG_HS_DOEPCTL1 - OTG device endpoint-1 control
          register
...
/// OTG_HS_DOEPINT1 - OTG_HS device endpoint-1 interrupt
          register
...
/// OTG_HS_DOEPCTL2 - OTG device endpoint-2 control
          register
...
/// OTG_HS_DOEPCTL3 - OTG device endpoint-3 control
          register
