...
/// OTG_HS_GRXSTSR_Host - OTG_HS Receive status debug read register
          (host mode)
...
/// OTG_HS_GRXSTSR_Peripheral - OTG_HS Receive status debug read register
          (peripheral mode mode)
namespace otg_hs_grxstsr_peripheral {
    /// Endpoint number
    /// Position: 0, Width: 4
...
/// OTG_HS_GRXSTSP_Peripheral - OTG_HS status read and pop register
          (peripheral mode)
namespace otg_hs_grxstsp_peripheral {
    /// Endpoint number
    /// Position: 0, Width: 4
    using EPNUM = BitField<0, 4>;
    constexpr uint32_t EPNUM_Pos = 0;
...
/// OTG_HS_GNPTXFSIZ_Host - OTG_HS nonperiodic transmit FIFO size
          register (host mode)
namespace otg_hs_gnptxfsiz_host {
...
/// OTG_HS_TX0FSIZ_Peripheral - Endpoint 0 transmit FIFO size (peripheral
          mode)
namespace otg_hs_tx0fsiz_peripheral {
...
namespace otg_hs_gccfg {
    ...
    /// Position: 17, Width: 1
    using I2CPADEN = BitField<17, 1>;
    constexpr uint32_t I2CPADEN_Pos = 17;
    constexpr uint32_t I2CPADEN_Msk = I2CPADEN::mask;
    ...
    /// VBUS sensing disable
              option
    /// Position: 21, Width: 1
    using NOVBUSSENS = BitField<21, 1>;
    constexpr uint32_t NOVBUSSENS_Pos = 21;
    constexpr uint32_t NOVBUSSENS_Msk = NOVBUSSENS::mask;
...
/// OTG_HS_DIEPTXF4 - OTG_HS device IN endpoint transmit FIFO size
          register
...
/// OTG_HS_DIEPTXF5 - OTG_HS device IN endpoint transmit FIFO size
          register
...
/// OTG_HS_DIEPTXF6 - OTG_HS device IN endpoint transmit FIFO size
          register
