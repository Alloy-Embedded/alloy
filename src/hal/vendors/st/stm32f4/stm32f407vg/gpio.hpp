...
// ============================================================================
// Single-include GPIO header for STM32F407VG
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f407vg/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f407vg {
...
namespace gpio = alloy::hal::stm32f4::stm32f407vg;
