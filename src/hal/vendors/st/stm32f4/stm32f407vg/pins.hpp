...
namespace alloy::hal::stm32f407::stm32f407vg::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F407VG
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F407VG (LQFP100)! "
