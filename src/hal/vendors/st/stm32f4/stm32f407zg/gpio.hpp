...
// ============================================================================
// Single-include GPIO header for STM32F407ZG
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f407zg/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f407zg {
...
namespace gpio = alloy::hal::stm32f4::stm32f407zg;
