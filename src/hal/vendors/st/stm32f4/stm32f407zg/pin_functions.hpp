...
namespace alloy::hal::stm32f407::stm32f407zg::pin_functions {

// ============================================================================
// Pin Alternate Functions for STM32F407ZG
...
namespace eth {
    ...
    // ETH_MII_TXD3 available on: PB8, PE2
    constexpr uint8_t ETH_MII_TXD3                           = pins::PB8;
    constexpr uint8_t ETH_MII_TXD3_REMAP1                    = pins::PE2;
...
namespace sdio {
    ...
    constexpr uint8_t SDIO_CK                        = pins::PC12;
    constexpr uint8_t SDIO_CMD                       = pins::PD2;
    constexpr uint8_t SDIO_D0                        = pins::PC8;
    constexpr uint8_t SDIO_D1                        = pins::PC9;
    constexpr uint8_t SDIO_D2                        = pins::PC10;
    constexpr uint8_t SDIO_D3                        = pins::PC11;
    constexpr uint8_t SDIO_D4                        = pins::PB8;
    constexpr uint8_t SDIO_D5                        = pins::PB9;
    constexpr uint8_t SDIO_D6                        = pins::PC6;
    constexpr uint8_t SDIO_D7                        = pins::PC7;
...
namespace uart {
    ...
    constexpr uint8_t UART7_RX                       = pins::PE7;
