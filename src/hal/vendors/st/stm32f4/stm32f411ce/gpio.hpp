...
// ============================================================================
// Single-include GPIO header for STM32F411CE
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f411ce/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f411ce {
...
namespace gpio = alloy::hal::stm32f4::stm32f411ce;
