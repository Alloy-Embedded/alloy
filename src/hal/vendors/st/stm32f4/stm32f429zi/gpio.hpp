...
// ============================================================================
// Single-include GPIO header for STM32F429ZI
// Include this file to get all GPIO functionality
//
// Usage:
//   #include "hal/vendors/st/stm32f4/stm32f429zi/gpio.hpp"
//
...
namespace alloy::hal::stm32f4::stm32f429zi {
...
namespace gpio = alloy::hal::stm32f4::stm32f429zi;
