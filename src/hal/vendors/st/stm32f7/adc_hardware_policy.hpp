 ...
 * @brief Hardware Policy for ADC on STM32F7 (Policy-Based Design)
 *
...
// Register definitions (STM32F7 uses same ADC register layout as F4)
#include "hal/vendors/st/stm32f7/generated/registers/adc2_registers.hpp"

// Bitfield definitions
#include "hal/vendors/st/stm32f7/generated/bitfields/adc2_bitfields.hpp"
...
namespace adc = st::stm32f7::adc2;

/**
 * @brief Hardware Policy for ADC on STM32F7
 *
 ...
 *
 * The STM32F7 ADC peripheral is register-compatible with STM32F4.
 *
 * Template Parameters:
 ...
 * using Adc1 = AdcImpl<Stm32f7AdcHardwarePolicy<0x40012000, 108000000>>;
 * @endcode
 *
...
struct Stm32f7AdcHardwarePolicy {
    // ========================================================================
    // Type Definitions
    // ========================================================================

    using RegisterType = ADC2_Registers;
    ...
    static constexpr uint32_t ADC_TIMEOUT =
        100000;  ///< ADC timeout in loop iterations (~10ms at 216MHz)
    ...
    // ========================================================================
    // Hardware Policy Methods (Same as STM32F4)
    // ========================================================================
...
/**
 * @example STM32F7 ADC Example
 * @code
 * #include "hal/platform/stm32f7/adc.hpp"
 *
