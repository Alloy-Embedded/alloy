...
namespace alloy::hal::st::stm32f7::tim1 {
...
namespace smcr {
    ...
    /// Position: 16, Width: 1
    using SMS_3 = BitField<16, 1>;
    constexpr uint32_t SMS_3_Pos = 16;
    constexpr uint32_t SMS_3_Msk = SMS_3::mask;
...
namespace ccmr3_output {
    ...
    /// Output Compare 5 mode
    /// Position: 16, Width: 1
    using OC5M3 = BitField<16, 1>;
    constexpr uint32_t OC5M3_Pos = 16;
    constexpr uint32_t OC5M3_Msk = OC5M3::mask;

    /// Output Compare 6 mode
    /// Position: 24, Width: 1
    using OC6M3 = BitField<24, 1>;
    constexpr uint32_t OC6M3_Pos = 24;
    constexpr uint32_t OC6M3_Msk = OC6M3::mask;
