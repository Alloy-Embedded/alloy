/// Auto-generated bit field definitions for TIM5
/// Family: stm32f7
/// Vendor: STMicro
///
...
namespace alloy::hal::st::stm32f7::tim5 {

using namespace alloy::hal::bitfields;

// ============================================================================
// TIM5 Bit Field Definitions
// ============================================================================
...
namespace or_ {
    /// Timer Input 4 remap
    /// Position: 6, Width: 2
    using TI4_RMP = BitField<6, 2>;
    constexpr uint32_t TI4_RMP_Pos = 6;
    constexpr uint32_t TI4_RMP_Msk = TI4_RMP::mask;
