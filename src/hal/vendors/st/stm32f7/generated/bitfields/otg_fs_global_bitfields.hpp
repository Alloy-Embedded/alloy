...
/// Position: 2, Width: 1
/// Access: read-write
using VBVALOEN = BitField<2, 1>;
constexpr uint32_t VBVALOEN_Pos = 2;
constexpr uint32_t VBVALOEN_Msk = VBVALOEN::mask;

/// VBUS valid override value
/// Position: 3, Width: 1
/// Access: read-write
using VBVALOVAL = BitField<3, 1>;
constexpr uint32_t VBVALOVAL_Pos = 3;
constexpr uint32_t VBVALOVAL_Msk = VBVALOVAL::mask;

/// A-peripheral session valid override enable
/// Position: 4, Width: 1
/// Access: read-write
using AVALOEN = BitField<4, 1>;
constexpr uint32_t AVALOEN_Pos = 4;
constexpr uint32_t AVALOEN_Msk = AVALOEN::mask;

/// A-peripheral session valid override value
/// Position: 5, Width: 1
/// Access: read-write
using AVALOVAL = BitField<5, 1>;
constexpr uint32_t AVALOVAL_Pos = 5;
constexpr uint32_t AVALOVAL_Msk = AVALOVAL::mask;

/// B-peripheral session valid override enable
/// Position: 6, Width: 1
/// Access: read-write
using BVALOEN = BitField<6, 1>;
constexpr uint32_t BVALOEN_Pos = 6;
constexpr uint32_t BVALOEN_Msk = BVALOEN::mask;

/// B-peripheral session valid override value
/// Position: 7, Width: 1
/// Access: read-write
using BVALOVAL = BitField<7, 1>;
constexpr uint32_t BVALOVAL_Pos = 7;
constexpr uint32_t BVALOVAL_Msk = BVALOVAL::mask;
...
/// Position: 20, Width: 1
/// Access: read-write
using OTGVER = BitField<20, 1>;
constexpr uint32_t OTGVER_Pos = 20;
constexpr uint32_t OTGVER_Msk = OTGVER::mask;

}  // namespace otg_fs_gotgctl

/// OTG_FS_GOTGINT - OTG_FS interrupt register (OTG_FS_GOTGINT)
namespace otg_fs_gotgint {
...
/// Position: 23, Width: 1
/// Access: read-write
using RSTDET = BitField<23, 1>;
constexpr uint32_t RSTDET_Pos = 23;
constexpr uint32_t RSTDET_Msk = RSTDET::mask;
...
/// Incomplete periodic transfer mask(Host mode)/Incomplete isochronous OUT transfer mask(Device
/// mode) Position: 21, Width: 1 Access: read-write
...
/// Position: 23, Width: 1
/// Access: read-write
using RSTDETM = BitField<23, 1>;
constexpr uint32_t RSTDETM_Pos = 23;
constexpr uint32_t RSTDETM_Msk = RSTDETM::mask;
...
/// Position: 27, Width: 1
/// Access: read-write
using LPMIN = BitField<27, 1>;
constexpr uint32_t LPMIN_Pos = 27;
constexpr uint32_t LPMIN_Msk = LPMIN::mask;
...
namespace otg_fs_grxstsr_device {
/// Endpoint number
/// Position: 0, Width: 4
...
namespace otg_fs_grxstsp_device {
/// Endpoint number
/// Position: 0, Width: 4
using EPNUM = BitField<0, 4>;
constexpr uint32_t EPNUM_Pos = 0;
...
namespace otg_fs_dieptxf0_device {
...
namespace otg_fs_hnptxfsiz_host {
