/// Auto-generated bit field definitions for TIM13
/// Family: stm32f7
/// Vendor: STMicro
///
...
namespace or_ {
    ...
    /// Position: 0, Width: 2
    using TI1_RMP = BitField<0, 2>;
    constexpr uint32_t TI1_RMP_Pos = 0;
    constexpr uint32_t TI1_RMP_Msk = TI1_RMP::mask;
