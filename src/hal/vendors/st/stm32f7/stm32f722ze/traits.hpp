...
namespace alloy::hal::stm32f7::stm32f722ze {

// ============================================================================
// MCU Characteristics for STM32F722ZE
// Auto-generated from SVD: STM32F7x2
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F722ZE";
    static constexpr const char* VENDOR = "STMicroelectronics";
    static constexpr const char* FAMILY = "STM32F7";
    static constexpr const char* SERIES = "STM32F7X2";
    ...
    struct Peripherals {
        ...
        static constexpr uint8_t SPI_COUNT = 6;
