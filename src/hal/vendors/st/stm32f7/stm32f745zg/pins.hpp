...
namespace alloy::hal::stm32f745::stm32f745zg::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F745ZG
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F745ZG (LQFP144)! "
