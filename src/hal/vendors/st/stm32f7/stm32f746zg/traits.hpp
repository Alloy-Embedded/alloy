...
namespace alloy::hal::stm32f745::stm32f746zg {

// ============================================================================
// MCU Characteristics for STM32F746ZG
// Auto-generated from SVD: STM32F745
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F746ZG";
    static constexpr const char* VENDOR = "STMicroelectronics";
    static constexpr const char* FAMILY = "STM32F745";
    static constexpr const char* SERIES = "STM32F745";

    // Package information
    static constexpr const char* PACKAGE = "LQFP144";
    static constexpr uint8_t PIN_COUNT = 112;
    ...
    struct Peripherals {
        static constexpr uint8_t UART_COUNT = 8;
        static constexpr uint8_t I2C_COUNT = 4;
        static constexpr uint8_t SPI_COUNT = 7;
        static constexpr uint8_t ADC_COUNT = 3;
        static constexpr uint8_t ADC_CHANNELS = 17;
        static constexpr uint8_t TIMER_COUNT = 15;
