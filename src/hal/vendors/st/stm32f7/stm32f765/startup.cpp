/// Auto-generated startup code for STM32F765
...
void (* const vector_table[])() = {
    ...
    I2C2_EV_Handler,               // IRQ 33: I2C2_EV - I2C2_EV
    I2C2_ER_Handler,               // IRQ 34: I2C2_ER - I2C2_ER
    ...
    ETH_WKUP_Handler,              // IRQ 62: ETH_WKUP - Ethernet Wakeup through EXTI
        line
    ...
    UART7_Handler,                 // IRQ 82: UART7 - UART 7 global interrupt
    ...
    SPDIFRX_Handler,               // IRQ 97: SPDIFRX - SPDIFRX
    DSIHOST_Handler,               // IRQ 98: DSIHOST - DSI host global interrupt
    DFSDM1_FLT0_Handler,           // IRQ 99: DFSDM1_FLT0 - DFSDM1 Filter 0 global interrupt
    DFSDM1_FLT1_Handler,           // IRQ 100: DFSDM1_FLT1 - DFSDM1 Filter 1 global interrupt
    DFSDM1_FLT2_Handler,           // IRQ 101: DFSDM1_FLT2 - DFSDM1 Filter 2 global interrupt
    DFSDM1_FLT3_Handler,           // IRQ 102: DFSDM1_FLT3 - DFSDM1 Filter 3 global interrupt
    SDMMC2_Handler,                // IRQ 103: SDMMC2 - SDMMC2 global interrupt
    CAN3_TX_Handler,               // IRQ 104: CAN3_TX - CAN3 TX interrupt
    CAN3_RX0_Handler,              // IRQ 105: CAN3_RX0 - CAN3 RX0 interrupt
    CAN3_RX1_Handler,              // IRQ 106: CAN3_RX1 - CAN3 RX1 interrupt
    CAN3_SCE_Handler,              // IRQ 107: CAN3_SCE - CAN3 SCE interrupt
    JPEG_Handler,                  // IRQ 108: JPEG - JPEG global interrupt
    MDIOS_Handler,                 // IRQ 109: MDIOS - MDIO slave global interrupt
};
