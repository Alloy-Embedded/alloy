...
extern "C" __attribute__((weak)) void DSIHOST_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void DFSDM1_FLT0_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void DFSDM1_FLT1_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void DFSDM1_FLT2_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void DFSDM1_FLT3_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void SDMMC2_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void CAN3_TX_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void CAN3_RX0_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void CAN3_RX1_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void CAN3_SCE_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void JPEG_Handler() {
    Default_Handler();
}
extern "C" __attribute__((weak)) void MDIOS_Handler() {
    Default_Handler();
}
...
__attribute__((section(".isr_vector"), used)) void (*const vector_table[])() = {
    ...
    EXTI line RTC_WKUP_Handler,  // IRQ 3: RTC_WKUP - RTC Tamper or TimeStamp /CSS on LSE through
    EXTI line 19 interrupts FLASH_Handler,  // IRQ 4: FLASH - Flash global interrupt
    ...
    interrupt TIM1_UP_TIM10_Handler,  // IRQ 25: TIM1_UP_TIM10 - TIM1_UP_TIM10
    TIM1_TRG_COM_TIM11_Handler,       // IRQ 26: TIM1_TRG_COM_TIM11 - TIM1 Trigger and Commutation
                                      // interrupts and
    TIM11 global interrupt TIM1_CC_Handler,  // IRQ 27: TIM1_CC - TIM1_CC
    ...
    error interrupt TIM7_Handler,    // IRQ 55: TIM7 - TIM7 global interrupt
    ...
    line CAN2_TX_Handler,            // IRQ 63: CAN2_TX - CAN2 TX interrupts
    ...
    interrupt DMA2_Stream5_Handler,  // IRQ 68: DMA2_Stream5 - DMA2 Stream5 global interrupt
    ...
    interrupt OTG_HS_WKUP_Handler,  // IRQ 76: OTG_HS_WKUP - USB On The Go HS Wakeup through EXTI
    interrupt OTG_HS_Handler,       // IRQ 77: OTG_HS - USB On The Go HS global
    interrupt DCMI_Handler,         // IRQ 78: DCMI - DCMI global interrupt
