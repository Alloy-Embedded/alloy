...
namespace alloy::hal::stm32f765::stm32f765vi::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F765VI
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F765VI (LQFP100)! "
