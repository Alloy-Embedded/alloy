...
namespace alloy::hal::stm32f765::stm32f765vi {

// ============================================================================
// MCU Characteristics for STM32F765VI
// Auto-generated from SVD: STM32F765
// ============================================================================

struct Traits {
    // Device identification
    static constexpr const char* DEVICE_NAME = "STM32F765VI";
    ...
    // Package information
    static constexpr const char* PACKAGE = "LQFP100";
    static constexpr uint8_t PIN_COUNT = 80;
