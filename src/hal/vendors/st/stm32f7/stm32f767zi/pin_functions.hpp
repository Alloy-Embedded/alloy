...
namespace alloy::hal::stm32f765::stm32f767zi::pin_functions {

// ============================================================================
// Pin Alternate Functions for STM32F767ZI
...
namespace adc {
    ...
    constexpr uint8_t ADC3_IN14                      = pins::PF4;
    constexpr uint8_t ADC3_IN15                      = pins::PF5;
    constexpr uint8_t ADC3_IN4                       = pins::PF6;
    constexpr uint8_t ADC3_IN5                       = pins::PF7;
    constexpr uint8_t ADC3_IN6                       = pins::PF8;
    constexpr uint8_t ADC3_IN7                       = pins::PF9;
    constexpr uint8_t ADC3_IN8                       = pins::PF10;
    constexpr uint8_t ADC3_IN9                       = pins::PF3;
...
namespace dcmi {
    ...
    // DCMI_D11 available on: PD2, PF10
    constexpr uint8_t DCMI_D11                           = pins::PD2;
    constexpr uint8_t DCMI_D11_REMAP1                    = pins::PF10;
    // DCMI_D12 available on: PF11, PG6
    constexpr uint8_t DCMI_D12                           = pins::PF11;
    constexpr uint8_t DCMI_D12_REMAP1                    = pins::PG6;
    // DCMI_D13 available on: PG15, PG7
    constexpr uint8_t DCMI_D13                           = pins::PG15;
    constexpr uint8_t DCMI_D13_REMAP1                    = pins::PG7;
    // DCMI_D2 available on: PC8, PE0, PG10
    constexpr uint8_t DCMI_D2                           = pins::PC8;
    constexpr uint8_t DCMI_D2_REMAP1                    = pins::PE0;
    constexpr uint8_t DCMI_D2_REMAP2                    = pins::PG10;
    // DCMI_D3 available on: PC9, PE1, PG11
    constexpr uint8_t DCMI_D3                           = pins::PC9;
    constexpr uint8_t DCMI_D3_REMAP1                    = pins::PE1;
    constexpr uint8_t DCMI_D3_REMAP2                    = pins::PG11;
    ...
    // DCMI_VSYNC available on: PB7, PG9
    constexpr uint8_t DCMI_VSYNC                           = pins::PB7;
    constexpr uint8_t DCMI_VSYNC_REMAP1                    = pins::PG9;
...
namespace eth {
    ...
    // ETH_MII_TXD0 available on: PB12, PG13
    constexpr uint8_t ETH_MII_TXD0                           = pins::PB12;
    constexpr uint8_t ETH_MII_TXD0_REMAP1                    = pins::PG13;
    // ETH_MII_TXD1 available on: PB13, PG14
    constexpr uint8_t ETH_MII_TXD1                           = pins::PB13;
    constexpr uint8_t ETH_MII_TXD1_REMAP1                    = pins::PG14;
    constexpr uint8_t ETH_MII_TXD2                   = pins::PC2;
    constexpr uint8_t ETH_MII_TXD3                   = pins::PE2;
    constexpr uint8_t ETH_MII_TX_CLK                 = pins::PC3;
    // ETH_MII_TX_EN available on: PB11, PG11
    constexpr uint8_t ETH_MII_TX_EN                           = pins::PB11;
    constexpr uint8_t ETH_MII_TX_EN_REMAP1                    = pins::PG11;
    ...
    // ETH_RMII_TXD0 available on: PB12, PG13
    constexpr uint8_t ETH_RMII_TXD0                           = pins::PB12;
    constexpr uint8_t ETH_RMII_TXD0_REMAP1                    = pins::PG13;
    // ETH_RMII_TXD1 available on: PB13, PG14
    constexpr uint8_t ETH_RMII_TXD1                           = pins::PB13;
    constexpr uint8_t ETH_RMII_TXD1_REMAP1                    = pins::PG14;
    // ETH_RMII_TX_EN available on: PB11, PG11
    constexpr uint8_t ETH_RMII_TX_EN                           = pins::PB11;
    constexpr uint8_t ETH_RMII_TX_EN_REMAP1                    = pins::PG11;
...
namespace fmc {
    ...
    constexpr uint8_t FMC_A0                         = pins::PF0;
    constexpr uint8_t FMC_A1                         = pins::PF1;
    constexpr uint8_t FMC_A10                        = pins::PG0;
    constexpr uint8_t FMC_A11                        = pins::PG1;
    constexpr uint8_t FMC_A12                        = pins::PG2;
    constexpr uint8_t FMC_A13                        = pins::PG3;
    constexpr uint8_t FMC_A14                        = pins::PG4;
    constexpr uint8_t FMC_A15                        = pins::PG5;
    ...
    constexpr uint8_t FMC_A2                         = pins::PF2;
    ...
    constexpr uint8_t FMC_A24                        = pins::PG13;
    constexpr uint8_t FMC_A25                        = pins::PG14;
    constexpr uint8_t FMC_A3                         = pins::PF3;
    constexpr uint8_t FMC_A4                         = pins::PF4;
    constexpr uint8_t FMC_A5                         = pins::PF5;
    constexpr uint8_t FMC_A6                         = pins::PF12;
    constexpr uint8_t FMC_A7                         = pins::PF13;
    constexpr uint8_t FMC_A8                         = pins::PF14;
    constexpr uint8_t FMC_A9                         = pins::PF15;
    constexpr uint8_t FMC_ALE                        = pins::PD12;
    constexpr uint8_t FMC_BA0                        = pins::PG4;
    constexpr uint8_t FMC_BA1                        = pins::PG5;
    ...
    constexpr uint8_t FMC_INT                        = pins::PG7;
    constexpr uint8_t FMC_NBL0                       = pins::PE0;
    constexpr uint8_t FMC_NBL1                       = pins::PE1;
    constexpr uint8_t FMC_NCE                        = pins::PG9;
    constexpr uint8_t FMC_NE1                        = pins::PD7;
    constexpr uint8_t FMC_NE2                        = pins::PG9;
    constexpr uint8_t FMC_NE3                        = pins::PG10;
    constexpr uint8_t FMC_NE4                        = pins::PG12;
    ...
    constexpr uint8_t FMC_SDCLK                      = pins::PG8;
    constexpr uint8_t FMC_SDNCAS                     = pins::PG15;
    constexpr uint8_t FMC_SDNE0                      = pins::PC2;
    constexpr uint8_t FMC_SDNRAS                     = pins::PF11;
...
namespace i2c {
    ...
    // I2C2_SCL available on: PB10, PF1
    constexpr uint8_t I2C2_SCL                           = pins::PB10;
    constexpr uint8_t I2C2_SCL_REMAP1                    = pins::PF1;
    // I2C2_SDA available on: PB11, PF0
    constexpr uint8_t I2C2_SDA                           = pins::PB11;
    constexpr uint8_t I2C2_SDA_REMAP1                    = pins::PF0;
    // I2C2_SMBA available on: PB12, PF2
    constexpr uint8_t I2C2_SMBA                           = pins::PB12;
    constexpr uint8_t I2C2_SMBA_REMAP1                    = pins::PF2;
...
namespace quadspi {
    ...
    // QUADSPI_BK1_IO0 available on: PC9, PD11, PF8
    constexpr uint8_t QUADSPI_BK1_IO0                           = pins::PC9;
    constexpr uint8_t QUADSPI_BK1_IO0_REMAP1                    = pins::PD11;
    constexpr uint8_t QUADSPI_BK1_IO0_REMAP2                    = pins::PF8;
    // QUADSPI_BK1_IO1 available on: PC10, PD12, PF9
    constexpr uint8_t QUADSPI_BK1_IO1                           = pins::PC10;
    constexpr uint8_t QUADSPI_BK1_IO1_REMAP1                    = pins::PD12;
    constexpr uint8_t QUADSPI_BK1_IO1_REMAP2                    = pins::PF9;
    // QUADSPI_BK1_IO2 available on: PE2, PF7
    constexpr uint8_t QUADSPI_BK1_IO2                           = pins::PE2;
    constexpr uint8_t QUADSPI_BK1_IO2_REMAP1                    = pins::PF7;
    // QUADSPI_BK1_IO3 available on: PA1, PD13, PF6
    constexpr uint8_t QUADSPI_BK1_IO3                           = pins::PA1;
    constexpr uint8_t QUADSPI_BK1_IO3_REMAP1                    = pins::PD13;
    constexpr uint8_t QUADSPI_BK1_IO3_REMAP2                    = pins::PF6;
    ...
    // QUADSPI_BK2_IO2 available on: PE9, PG9
    constexpr uint8_t QUADSPI_BK2_IO2                           = pins::PE9;
    constexpr uint8_t QUADSPI_BK2_IO2_REMAP1                    = pins::PG9;
    // QUADSPI_BK2_IO3 available on: PE10, PG14
    constexpr uint8_t QUADSPI_BK2_IO3                           = pins::PE10;
    constexpr uint8_t QUADSPI_BK2_IO3_REMAP1                    = pins::PG14;
...
namespace rcc {
    ...
    constexpr uint8_t OSC_IN                         = pins::PH0;
    constexpr uint8_t OSC_OUT                        = pins::PH1;
...
namespace spi {
    ...
    constexpr uint8_t SPI5_MISO                      = pins::PF8;
    // SPI5_MOSI available on: PF11, PF9
    constexpr uint8_t SPI5_MOSI                           = pins::PF11;
    constexpr uint8_t SPI5_MOSI_REMAP1                    = pins::PF9;
    constexpr uint8_t SPI5_NSS                       = pins::PF6;
    constexpr uint8_t SPI5_SCK                       = pins::PF7;
    constexpr uint8_t SPI6_NSS                       = pins::PG8;
...
namespace tim {
    ...
    // TIM10_CH1 available on: PB8, PF6
    constexpr uint8_t TIM10_CH1                           = pins::PB8;
    constexpr uint8_t TIM10_CH1_REMAP1                    = pins::PF6;
    // TIM11_CH1 available on: PB9, PF7
    constexpr uint8_t TIM11_CH1                           = pins::PB9;
    constexpr uint8_t TIM11_CH1_REMAP1                    = pins::PF7;
    constexpr uint8_t TIM12_CH1                      = pins::PB14;
    constexpr uint8_t TIM12_CH2                      = pins::PB15;
    // TIM13_CH1 available on: PA6, PF8
    constexpr uint8_t TIM13_CH1                           = pins::PA6;
    constexpr uint8_t TIM13_CH1_REMAP1                    = pins::PF8;
    // TIM14_CH1 available on: PA7, PF9
    constexpr uint8_t TIM14_CH1                           = pins::PA7;
    constexpr uint8_t TIM14_CH1_REMAP1                    = pins::PF9;
...
namespace uart {
    ...
    // UART7_CTS available on: PE10, PF9
    constexpr uint8_t UART7_CTS                           = pins::PE10;
    constexpr uint8_t UART7_CTS_REMAP1                    = pins::PF9;
    // UART7_RTS available on: PE9, PF8
    constexpr uint8_t UART7_RTS                           = pins::PE9;
    constexpr uint8_t UART7_RTS_REMAP1                    = pins::PF8;
    // UART7_RX available on: PA8, PE7, PF6
    constexpr uint8_t UART7_RX                           = pins::PA8;
    constexpr uint8_t UART7_RX_REMAP1                    = pins::PE7;
    constexpr uint8_t UART7_RX_REMAP2                    = pins::PF6;
    // UART7_TX available on: PE8, PF7
    constexpr uint8_t UART7_TX                           = pins::PE8;
    constexpr uint8_t UART7_TX_REMAP1                    = pins::PF7;
...
namespace usart {
    ...
    // USART6_CK available on: PC8, PG7
    constexpr uint8_t USART6_CK                           = pins::PC8;
    constexpr uint8_t USART6_CK_REMAP1                    = pins::PG7;
    // USART6_CTS available on: PG13, PG15
    constexpr uint8_t USART6_CTS                           = pins::PG13;
    constexpr uint8_t USART6_CTS_REMAP1                    = pins::PG15;
    // USART6_RTS available on: PG12, PG8
    constexpr uint8_t USART6_RTS                           = pins::PG12;
    constexpr uint8_t USART6_RTS_REMAP1                    = pins::PG8;
    // USART6_RX available on: PC7, PG9
    constexpr uint8_t USART6_RX                           = pins::PC7;
    constexpr uint8_t USART6_RX_REMAP1                    = pins::PG9;
    // USART6_TX available on: PC6, PG14
    constexpr uint8_t USART6_TX                           = pins::PC6;
    constexpr uint8_t USART6_TX_REMAP1                    = pins::PG14;
