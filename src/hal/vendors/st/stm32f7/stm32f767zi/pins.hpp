...
namespace alloy::hal::stm32f765::stm32f767zi::pins {

// ============================================================================
// Auto-generated pin definitions for STM32F767ZI
// Generated from SVD: STM32F765
// Package: LQFP144
// GPIO Pins: 114
// ============================================================================
...
// Port H pins (2 pins)
constexpr uint8_t PH0 = 0;

// Port A pins (16 pins)
constexpr uint8_t PA1 = 1;

// Port H pins (2 pins)
constexpr uint8_t PH1 = 1;
...
constexpr void validate_pin() {
    static_assert(ValidPin<Pin>, "Invalid pin for STM32F767ZI (LQFP144)! "
                                 "Check the datasheet for available pins on this package.");
}

// Constants
constexpr size_t TOTAL_PIN_COUNT = detail::PIN_COUNT;  // 114 pins
constexpr size_t GPIO_PORT_COUNT = 8;                  // 8 ports
