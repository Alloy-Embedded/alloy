...
extern "C" __attribute__((weak)) void RNG_Handler() {
    Default_Handler();
}
...
__attribute__((section(".isr_vector"), used)) void (*const vector_table[])() = {
    ...
    FSMC_Handler,                            // IRQ 48: FSMC - FMC global interrupt
    ...
    OTG_HS_EP1_OUT_Handler,          // IRQ 74: OTG_HS_EP1_OUT - USB On The Go HS End Point 1 Out
    OTG_HS_EP1_IN_Handler,           // IRQ 75: OTG_HS_EP1_IN - USB On The Go HS End Point 1 In
    OTG_HS_WKUP_Handler,             // IRQ 76: OTG_HS_WKUP - USB On The Go HS Wakeup through
    OTG_HS_Handler,                  // IRQ 77: OTG_HS - USB On The Go HS global
    interrupt AES_Handler,           // IRQ 79: AES - AES global interrupt
    RNG_Handler,                     // IRQ 80: RNG - Rng global interrupt
