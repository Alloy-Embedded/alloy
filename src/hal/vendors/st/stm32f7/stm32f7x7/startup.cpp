...
extern "C" __attribute__((weak)) void LP_Timer1_Handler() {
    Default_Handler();
}
...
__attribute__((section(".isr_vector"), used)) void (*const vector_table[])() = {
    ...
    interrupt TIM1_UP_TIM10_Handler,  // IRQ 25: TIM1_UP_TIM10 - TIM1 Update interrupt and TIM10
    ...
    LP_Timer1_Handler,              // IRQ 93: LP_Timer1 - LP Timer1 global interrupt
