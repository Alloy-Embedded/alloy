/// Auto-generated bit field definitions for GPIOB
/// Family: stm32g0
/// Vendor: STMicro
///
...
namespace afrl {
    ...
    /// Position: 0, Width: 4
    using AFSEL0 = BitField<0, 4>;
    constexpr uint32_t AFSEL0_Pos = 0;
    constexpr uint32_t AFSEL0_Msk = AFSEL0::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 4, Width: 4
    using AFSEL1 = BitField<4, 4>;
    constexpr uint32_t AFSEL1_Pos = 4;
    constexpr uint32_t AFSEL1_Msk = AFSEL1::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 8, Width: 4
    using AFSEL2 = BitField<8, 4>;
    constexpr uint32_t AFSEL2_Pos = 8;
    constexpr uint32_t AFSEL2_Msk = AFSEL2::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 12, Width: 4
    using AFSEL3 = BitField<12, 4>;
    constexpr uint32_t AFSEL3_Pos = 12;
    constexpr uint32_t AFSEL3_Msk = AFSEL3::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 16, Width: 4
    using AFSEL4 = BitField<16, 4>;
    constexpr uint32_t AFSEL4_Pos = 16;
    constexpr uint32_t AFSEL4_Msk = AFSEL4::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 20, Width: 4
    using AFSEL5 = BitField<20, 4>;
    constexpr uint32_t AFSEL5_Pos = 20;
    constexpr uint32_t AFSEL5_Msk = AFSEL5::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 24, Width: 4
    using AFSEL6 = BitField<24, 4>;
    constexpr uint32_t AFSEL6_Pos = 24;
    constexpr uint32_t AFSEL6_Msk = AFSEL6::mask;

    /// Alternate function selection for port x bit y (y = 0..7)
    /// Position: 28, Width: 4
    using AFSEL7 = BitField<28, 4>;
    constexpr uint32_t AFSEL7_Pos = 28;
    constexpr uint32_t AFSEL7_Msk = AFSEL7::mask;
...
namespace afrh {
    ...
    /// Position: 0, Width: 4
    using AFSEL8 = BitField<0, 4>;
    constexpr uint32_t AFSEL8_Pos = 0;
    constexpr uint32_t AFSEL8_Msk = AFSEL8::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 4, Width: 4
    using AFSEL9 = BitField<4, 4>;
    constexpr uint32_t AFSEL9_Pos = 4;
    constexpr uint32_t AFSEL9_Msk = AFSEL9::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 8, Width: 4
    using AFSEL10 = BitField<8, 4>;
    constexpr uint32_t AFSEL10_Pos = 8;
    constexpr uint32_t AFSEL10_Msk = AFSEL10::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 12, Width: 4
    using AFSEL11 = BitField<12, 4>;
    constexpr uint32_t AFSEL11_Pos = 12;
    constexpr uint32_t AFSEL11_Msk = AFSEL11::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 16, Width: 4
    using AFSEL12 = BitField<16, 4>;
    constexpr uint32_t AFSEL12_Pos = 16;
    constexpr uint32_t AFSEL12_Msk = AFSEL12::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 20, Width: 4
    using AFSEL13 = BitField<20, 4>;
    constexpr uint32_t AFSEL13_Pos = 20;
    constexpr uint32_t AFSEL13_Msk = AFSEL13::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 24, Width: 4
    using AFSEL14 = BitField<24, 4>;
    constexpr uint32_t AFSEL14_Pos = 24;
    constexpr uint32_t AFSEL14_Msk = AFSEL14::mask;

    /// Alternate function selection for port x bit y (y = 8..15)
    /// Position: 28, Width: 4
    using AFSEL15 = BitField<28, 4>;
    constexpr uint32_t AFSEL15_Pos = 28;
    constexpr uint32_t AFSEL15_Msk = AFSEL15::mask;
