...
namespace ucore::hal::st::stm32g0::dbg {
...
namespace dbg_cr {
/// Debug Stop mode Debug options in Stop mode. Upon Stop mode exit, the software must re-establish
/// the desired clock configuration. Position: 1, Width: 1 Access: read-write
...
/// Clocking of TIM2 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM2 when the core is halted: Position: 0, Width: 1 Access: read-write
...
/// Clocking of TIM3 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM3 when the core is halted: Position: 1, Width: 1 Access: read-write
...
/// Clocking of TIM6 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM6 when the core is halted: Position: 4, Width: 1 Access: read-write
...
/// Clocking of TIM7 counter when the core is halted. This bit enables/disables the clock to the
/// counter of ITIM7 when the core is halted: Position: 5, Width: 1 Access: read-write
...
/// Clocking of RTC counter when the core is halted This bit enables/disables the clock to the
/// counter of RTC when the core is halted: Position: 10, Width: 1 Access: read-write
...
/// Clocking of WWDG counter when the core is halted This bit enables/disables the clock to the
/// counter of WWDG when the core is halted: Position: 11, Width: 1 Access: read-write
...
/// Clocking of IWDG counter when the core is halted This bit enables/disables the clock to the
/// counter of IWDG when the core is halted: Position: 12, Width: 1 Access: read-write
...
/// Clocking of LPTIMER2 counter when the core is halted This bit enables/disables the clock to the
/// counter of LPTIMER2 when the core is halted: Position: 30, Width: 1 Access: read-write
...
/// Clocking of LPTIMER1 counter when the core is halted This bit enables/disables the clock to the
/// counter of LPTIMER1 when the core is halted: Position: 31, Width: 1 Access: read-write
...
/// Clocking of TIM1 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM1 when the core is halted: Position: 11, Width: 1 Access: read-write
...
/// Clocking of TIM14 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM14 when the core is halted: Position: 15, Width: 1 Access: read-write
...
/// Clocking of TIM15 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM15 when the core is halted: Only available on STM32G071xx and STM32G081xx,
/// reserved on STM32G031xx and STM32G041xx. Position: 16, Width: 1 Access: read-write
...
/// Clocking of TIM16 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM16 when the core is halted: Position: 17, Width: 1 Access: read-write
...
/// Clocking of TIM17 counter when the core is halted This bit enables/disables the clock to the
/// counter of TIM17 when the core is halted: Position: 18, Width: 1 Access: read-write
