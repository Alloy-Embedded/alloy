...
/// be set again by software (channel x re-activated) until the TEIFx bit of the DMA_ISR register is
/// cleared (by setting the CTEIFx bit of the DMA_IFCR register). Note: this bit is set and cleared
...
/// transfer complete interrupt enable Note: this bit is set and cleared by software. It must not be
/// written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled
/// (ENÂ =Â 1). Position: 1, Width: 1 Access: read-write
...
/// half transfer interrupt enable Note: this bit is set and cleared by software. It must not be
/// written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled
/// (ENÂ =Â 1). Position: 2, Width: 1 Access: read-write
...
/// transfer error interrupt enable Note: this bit is set and cleared by software. It must not be
/// written when the channel is enabled (EN = 1). It is not read-only when the channel is enabled
/// (ENÂ =Â 1). Position: 3, Width: 1 Access: read-write
...
/// peripheral-to-memory modes. Source attributes are defined by PSIZE and PINC, plus the DMA_CPARx
/// register. This is still valid in a memory-to-memory mode. Destination attributes are defined by
/// MSIZE and MINC, plus the DMA_CMARx register. This is still valid in a peripheral-to-peripheral
/// mode. Destination attributes are defined by PSIZE and PINC, plus the DMA_CPARx register. This is
/// still valid in a memory-to-memory mode. Source attributes are defined by MSIZE and MINC, plus
/// the DMA_CMARx register. This is still valid in a peripheral-to-peripheral mode. Note: this bit
/// is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It
/// is read-only when the channel is enabled (ENÂ =Â 1). Position: 4, Width: 1 Access: read-write
...
/// circular mode Note: this bit is set and cleared by software. It must not be written when the
/// channel is enabled (EN = 1). It is not read-only when the channel is enabled (ENÂ =Â 1).
/// Position: 5, Width: 1
/// Access: read-write
...
/// peripheral increment mode Defines the increment mode for each DMA transfer to the identified
/// peripheral. n memory-to-memory mode, this field identifies the memory destination if DIRÂ =Â 1
/// and the memory source if DIRÂ =Â 0. In peripheral-to-peripheral mode, this field identifies the
/// peripheral destination if DIRÂ =Â 1 and the peripheral source if DIRÂ =Â 0. Note: this bit is
/// set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is
/// read-only when the channel is enabled (ENÂ =Â 1). Position: 6, Width: 1 Access: read-write
...
/// memory increment mode Defines the increment mode for each DMA transfer to the identified memory.
/// In memory-to-memory mode, this field identifies the memory source if DIRÂ =Â 1 and the memory
/// destination if DIRÂ =Â 0. In peripheral-to-peripheral mode, this field identifies the peripheral
/// source if DIRÂ =Â 1 and the peripheral destination if DIRÂ =Â 0. Note: this bit is set and
/// cleared by software. It must not be written when the channel is enabled (EN = 1). It is
/// read-only when the channel is enabled (ENÂ =Â 1). Position: 7, Width: 1 Access: read-write
...
/// peripheral size Defines the data size of each DMA transfer to the identified peripheral. In
/// memory-to-memory mode, this field identifies the memory destination if DIRÂ =Â 1 and the memory
/// source if DIRÂ =Â 0. In peripheral-to-peripheral mode, this field identifies the peripheral
/// destination if DIRÂ =Â 1 and the peripheral source if DIRÂ =Â 0. Note: this field is set and
/// cleared by software. It must not be written when the channel is enabled (EN = 1). It is
/// read-only when the channel is enabled (ENÂ =Â 1). Position: 8, Width: 2 Access: read-write
...
/// memory size Defines the data size of each DMA transfer to the identified memory. In
/// memory-to-memory mode, this field identifies the memory source if DIRÂ =Â 1 and the memory
/// destination if DIRÂ =Â 0. In peripheral-to-peripheral mode, this field identifies the peripheral
/// source if DIRÂ =Â 1 and the peripheral destination if DIRÂ =Â 0. Note: this field is set and
/// cleared by software. It must not be written when the channel is enabled (EN = 1). It is
/// read-only when the channel is enabled (ENÂ =Â 1). Position: 10, Width: 2 Access: read-write
...
/// priority level Note: this field is set and cleared by software. It must not be written when the
/// channel is enabled (EN = 1). It is read-only when the channel is enabled (ENÂ =Â 1). Position:
/// 12, Width: 2 Access: read-write
...
/// memory-to-memory mode Note: this bit is set and cleared by software. It must not be written when
/// the channel is enabled (EN = 1). It is read-only when the channel is enabled (ENÂ =Â 1).
/// Position: 14, Width: 1
/// Access: read-write
...
/// number of data to transfer (0 to 216Â -Â 1) This field is updated by hardware when the channel
/// is enabled: It is decremented after each single DMA 'read followed by writeâ transfer,
/// indicating the remaining amount of data items to transfer. It is kept at zero when the
/// programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRCÂ
/// =Â 0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value,
/// when the transfer is complete, if the channel is in circular mode (CIRCÂ =Â 1). If this field is
/// zero, no transfer can be served whatever the channel status (enabled or not). Note: this field
/// is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It
/// is read-only when the channel is enabled (ENÂ =Â 1). Position: 0, Width: 16 Access: read-write
...
namespace dma_cpar1 {
/// peripheral address It contains the base address of the peripheral data register from/to which
/// the data will be read/written. When PSIZE[1:0]Â =Â 01 (16 bits), bit 0 of PA[31:0] is ignored.
/// Access is automatically aligned to a half-word address. When PSIZEÂ =Â 10 (32 bits), bits 1 and
/// 0 of PA[31:0] are ignored. Access is automatically aligned to a word address. In
/// memory-to-memory mode, this register identifies the memory destination address if DIRÂ =Â 1 and
/// the memory source address if DIRÂ =Â 0. In peripheral-to-peripheral mode, this register
/// identifies the peripheral destination address DIRÂ =Â 1 and the peripheral source address if
/// DIRÂ =Â 0. Note: this register is set and cleared by software. It must not be written when the
/// channel is enabled (EN = 1). It is not read-only when the channel is enabled (ENÂ =Â 1).
/// Position: 0, Width: 32
/// Access: read-write
...
namespace dma_cmar1 {
/// peripheral address It contains the base address of the memory from/to which the data will be
/// read/written. When MSIZE[1:0]Â =Â 01 (16 bits), bit 0 of MA[31:0] is ignored. Access is
/// automatically aligned to a half-word address. When MSIZEÂ =Â 10 (32 bits), bits 1 and 0 of
/// MA[31:0] are ignored. Access is automatically aligned to a word address. In memory-to-memory
/// mode, this register identifies the memory source address if DIRÂ =Â 1 and the memory destination
/// address if DIRÂ =Â 0. In peripheral-to-peripheral mode, this register identifies the peripheral
/// source address DIRÂ =Â 1 and the peripheral destination address if DIRÂ =Â 0. Note: this
/// register is set and cleared by software. It must not be written when the channel is enabled (EN
/// = 1). It is not read-only when the channel is enabled (ENÂ =Â 1). Position: 0, Width: 32 Access:
/// read-write
