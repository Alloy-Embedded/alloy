...
/// DMA request identification Selects the input DMA request. See the DMAMUX table about assignments
/// of multiplexer inputs to resources. Position: 0, Width: 6 Access: read-write
...
/// Number of DMA requests minus 1 to forward Defines the number of DMA requests to forward to the
/// DMA controller after a synchronization event, and/or the number of DMA requests before an output
/// event is generated. This field shall only be written when both SE and EGE bits are low.
/// Position: 19, Width: 5
/// Access: read-write
...
/// Synchronization identification Selects the synchronization input (see inputs to resources
/// STM32G0). Position: 24, Width: 5 Access: read-write
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 0,
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 1,
/// Width: 1 Access: read-only
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 2,
/// Width: 1 Access: read-only
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 3,
/// Width: 1 Access: read-only
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 4,
/// Width: 1 Access: read-only
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 5,
/// Width: 1 Access: read-only
...
/// Synchronization overrun event flag The flag is set when a synchronization event occurs on a DMA
/// request line multiplexer channel x, while the DMA request counter value is lower than NBREQ. The
/// flag is cleared by writing 1 to the corresponding CSOFx bit in DMAMUX_CFR register. Position: 6,
/// Width: 1 Access: read-only
...
/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 0, Width: 1 Access: write-only
using CSOF0 = BitField<0, 1>;
constexpr uint32_t CSOF0_Pos = 0;
constexpr uint32_t CSOF0_Msk = CSOF0::mask;

/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 1, Width: 1 Access: write-only
using CSOF1 = BitField<1, 1>;
constexpr uint32_t CSOF1_Pos = 1;
constexpr uint32_t CSOF1_Msk = CSOF1::mask;

/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 2, Width: 1 Access: write-only
using CSOF2 = BitField<2, 1>;
constexpr uint32_t CSOF2_Pos = 2;
constexpr uint32_t CSOF2_Msk = CSOF2::mask;

/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 3, Width: 1 Access: write-only
using CSOF3 = BitField<3, 1>;
constexpr uint32_t CSOF3_Pos = 3;
constexpr uint32_t CSOF3_Msk = CSOF3::mask;

/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 4, Width: 1 Access: write-only
using CSOF4 = BitField<4, 1>;
constexpr uint32_t CSOF4_Pos = 4;
constexpr uint32_t CSOF4_Msk = CSOF4::mask;

/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 5, Width: 1 Access: write-only
using CSOF5 = BitField<5, 1>;
constexpr uint32_t CSOF5_Pos = 5;
constexpr uint32_t CSOF5_Msk = CSOF5::mask;

/// Clear synchronization overrun event flag Writing 1 in each bit clears the corresponding overrun
/// flag SOFx in the DMAMUX_CSR register. Position: 6, Width: 1 Access: write-only
...
/// Signal identification Selects the DMA request trigger input used for the channel x of the DMA
/// request generator Position: 0, Width: 5 Access: read-write
...
/// Number of DMA requests to be generated (minus 1) Defines the number of DMA requests to be
/// generated after a trigger event. The actual number of generated DMA requests is GNBREQ +1. Note:
/// This field shall only be written when GE bit is disabled. Position: 19, Width: 5 Access:
/// read-write
...
/// Trigger overrun event flag The flag is set when a new trigger event occurs on DMA request
/// generator channel x, before the request counter underrun (the internal request counter
/// programmed via the GNBREQ field of the DMAMUX_RGxCR register). The flag is cleared by writing 1
/// to the corresponding COFx bit in the DMAMUX_RGCFR register. Position: 0, Width: 1 Access:
/// read-only
...
/// generator channel x, before the request counter underrun (the internal request counter
/// programmed via the GNBREQ field of the DMAMUX_RGxCR register). The flag is cleared by writing 1
/// to the corresponding COFx bit in the DMAMUX_RGCFR register. Position: 1, Width: 1 Access:
/// read-only
...
/// generator channel x, before the request counter underrun (the internal request counter
/// programmed via the GNBREQ field of the DMAMUX_RGxCR register). The flag is cleared by writing 1
/// to the corresponding COFx bit in the DMAMUX_RGCFR register. Position: 2, Width: 1 Access:
/// read-only
...
/// generator channel x, before the request counter underrun (the internal request counter
/// programmed via the GNBREQ field of the DMAMUX_RGxCR register). The flag is cleared by writing 1
/// to the corresponding COFx bit in the DMAMUX_RGCFR register. Position: 3, Width: 1 Access:
/// read-only
...
/// Clear trigger overrun event flag Writing 1 in each bit clears the corresponding overrun flag OFx
/// in the DMAMUX_RGSR register. Position: 0, Width: 1 Access: write-only
using COF0 = BitField<0, 1>;
constexpr uint32_t COF0_Pos = 0;
constexpr uint32_t COF0_Msk = COF0::mask;

/// Clear trigger overrun event flag Writing 1 in each bit clears the corresponding overrun flag OFx
/// in the DMAMUX_RGSR register. Position: 1, Width: 1 Access: write-only
using COF1 = BitField<1, 1>;
constexpr uint32_t COF1_Pos = 1;
constexpr uint32_t COF1_Msk = COF1::mask;

/// Clear trigger overrun event flag Writing 1 in each bit clears the corresponding overrun flag OFx
/// in the DMAMUX_RGSR register. Position: 2, Width: 1 Access: write-only
using COF2 = BitField<2, 1>;
constexpr uint32_t COF2_Pos = 2;
constexpr uint32_t COF2_Msk = COF2::mask;

/// Clear trigger overrun event flag Writing 1 in each bit clears the corresponding overrun flag OFx
/// in the DMAMUX_RGSR register. Position: 3, Width: 1 Access: write-only
