...
/// Active level for tamper 1 input (active mode disabled) If TAMPFLT = 00 Tamper 1 input rising
/// edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 1 input falling
/// edge and low level triggers a tamper detection event. Position: 24, Width: 1 Access: read-write
...
/// Active level for tamper 2 input (active mode disabled) If TAMPFLT = 00 Tamper 2 input rising
/// edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 2 input falling
/// edge and low level triggers a tamper detection event. Position: 25, Width: 1 Access: read-write
...
/// Tamper sampling frequency Determines the frequency at which each of the TAMP_INx inputs are
/// sampled. Position: 0, Width: 3 Access: read-write
...
/// TAMP_INx filter count These bits determines the number of consecutive samples at the specified
/// level (TAMP*TRG) needed to activate a tamper event. TAMPFLT is valid for each of the TAMP_INx
/// inputs. Position: 3, Width: 2 Access: read-write
...
/// TAMP_INx precharge duration These bit determines the duration of time during which the
/// pull-up/is activated before each sample. TAMPPRCH is valid for each of the TAMP_INx inputs.
/// Position: 5, Width: 2
/// Access: read-write
...
/// TAMP_INx pull-up disable This bit determines if each of the TAMPx pins are precharged before
/// each sample. Position: 7, Width: 1 Access: read-write
...
namespace tamp_sr {
/// TAMP1 detection flag This flag is set by hardware when a tamper detection event is detected on
/// the TAMP1 input. Position: 0, Width: 1 Access: read-only
using TAMP1F = BitField<0, 1>;
constexpr uint32_t TAMP1F_Pos = 0;
constexpr uint32_t TAMP1F_Msk = TAMP1F::mask;

/// TAMP2 detection flag This flag is set by hardware when a tamper detection event is detected on
/// the TAMP2 input. Position: 1, Width: 1 Access: read-only
using TAMP2F = BitField<1, 1>;
constexpr uint32_t TAMP2F_Pos = 1;
constexpr uint32_t TAMP2F_Msk = TAMP2F::mask;

/// LSE monitoring tamper detection flag This flag is set by hardware when a tamper detection event
/// is detected on the internal tamper 3. Position: 18, Width: 1 Access: read-only
using ITAMP3F = BitField<18, 1>;
constexpr uint32_t ITAMP3F_Pos = 18;
constexpr uint32_t ITAMP3F_Msk = ITAMP3F::mask;

/// HSE monitoring tamper detection flag This flag is set by hardware when a tamper detection event
/// is detected on the internal tamper 4. Position: 19, Width: 1 Access: read-only
using ITAMP4F = BitField<19, 1>;
constexpr uint32_t ITAMP4F_Pos = 19;
constexpr uint32_t ITAMP4F_Msk = ITAMP4F::mask;

/// RTC calendar overflow tamper detection flag This flag is set by hardware when a tamper detection
/// event is detected on the internal tamper 5. Position: 20, Width: 1 Access: read-only
using ITAMP5F = BitField<20, 1>;
constexpr uint32_t ITAMP5F_Pos = 20;
constexpr uint32_t ITAMP5F_Msk = ITAMP5F::mask;

/// ST manufacturer readout tamper detection flag This flag is set by hardware when a tamper
/// detection event is detected on the internal tamper 6. Position: 21, Width: 1 Access: read-only
...
/// LSE monitoring tamper interrupt masked flag This flag is set by hardware when the internal
/// tamper 3 interrupt is raised. Position: 18, Width: 1 Access: read-only
using ITAMP3MF = BitField<18, 1>;
constexpr uint32_t ITAMP3MF_Pos = 18;
constexpr uint32_t ITAMP3MF_Msk = ITAMP3MF::mask;

/// HSE monitoring tamper interrupt masked flag This flag is set by hardware when the internal
/// tamper 4 interrupt is raised. Position: 19, Width: 1 Access: read-only
using ITAMP4MF = BitField<19, 1>;
constexpr uint32_t ITAMP4MF_Pos = 19;
constexpr uint32_t ITAMP4MF_Msk = ITAMP4MF::mask;

/// RTC calendar overflow tamper interrupt masked flag This flag is set by hardware when the
/// internal tamper 5 interrupt is raised. Position: 20, Width: 1 Access: read-only
using ITAMP5MF = BitField<20, 1>;
constexpr uint32_t ITAMP5MF_Pos = 20;
constexpr uint32_t ITAMP5MF_Msk = ITAMP5MF::mask;

/// ST manufacturer readout tamper interrupt masked flag This flag is set by hardware when the
/// internal tamper 6 interrupt is raised. Position: 21, Width: 1 Access: read-only
...
/// Clear ITAMP3 detection flag Writing 1 in this bit clears the ITAMP3F bit in the TAMP_SR
/// register. Position: 18, Width: 1 Access: write-only
using CITAMP3F = BitField<18, 1>;
constexpr uint32_t CITAMP3F_Pos = 18;
constexpr uint32_t CITAMP3F_Msk = CITAMP3F::mask;

/// Clear ITAMP4 detection flag Writing 1 in this bit clears the ITAMP4F bit in the TAMP_SR
/// register. Position: 19, Width: 1 Access: write-only
using CITAMP4F = BitField<19, 1>;
constexpr uint32_t CITAMP4F_Pos = 19;
constexpr uint32_t CITAMP4F_Msk = CITAMP4F::mask;

/// Clear ITAMP5 detection flag Writing 1 in this bit clears the ITAMP5F bit in the TAMP_SR
/// register. Position: 20, Width: 1 Access: write-only
using CITAMP5F = BitField<20, 1>;
constexpr uint32_t CITAMP5F_Pos = 20;
constexpr uint32_t CITAMP5F_Msk = CITAMP5F::mask;

/// Clear ITAMP6 detection flag Writing 1 in this bit clears the ITAMP6F bit in the TAMP_SR
/// register. Position: 21, Width: 1 Access: write-only
...
/// The application can write or read data to and from these registers. They are powered-on by VBAT
/// when VDD is switched off, so that they are not reset by System reset, and their contents remain
/// valid when the device operates in low-power mode. In the default configuration this register is
/// reset on a tamper detection event. It is forced to reset value as long as there is at least one
/// internal or external tamper flag being set. This register is also reset when the readout
/// protection (RDP) is disabled. Position: 0, Width: 32 Access: read-write
