 ...
 * @brief Hardware Policy for GPIO on STM32G0 (Policy-Based Design)
 *
 * This file provides platform-specific hardware access for GPIO using
 ...
 * - Mock hooks for testing (#ifdef ALLOY_GPIO_MOCK_HW)
 *
 * Auto-generated from: stm32g0/gpio.json
...
using namespace ucore::hal::st::stm32g0::gpioa;

/**
 * @brief Hardware Policy for GPIO on STM32G0
 *
 ...
 *
 * @tparam BASE_ADDR GPIO peripheral base address
...
struct Stm32g0GPIOHardwarePolicy {
     ...
     * @param pin_mask Pin mask
     *
     * @note Test hook: ALLOY_GPIO_TEST_HOOK_BRR
     */
    static inline void clear_output(uint32_t pin_mask) {
#ifdef ALLOY_GPIO_TEST_HOOK_BRR
        ALLOY_GPIO_TEST_HOOK_BRR(pin_mask);
#endif
...
/**
 * @example
 * Using the hardware policy with generic GPIO API:
 *
 * @code
 ...
 *
 * // Create GPIO with hardware policy
 * using Uart0 = UartImpl<Stm32g0GPIOHardwarePolicy<UART0_BASE, 150000000>>;
 *
 * int main() {
