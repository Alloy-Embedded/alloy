/// Auto-generated startup code for STM32G071
...
extern "C" void UCPD1_UCPD2_Handler() __attribute__((weak, alias("Default_Handler")));
...
extern "C" void TIM1_BRK_UP_TRG_COMP_Handler() __attribute__((weak, alias("Default_Handler")));
...
extern "C" void TIM6_DAC_LPTIM1_Handler() __attribute__((weak, alias("Default_Handler")));
extern "C" void TIM7_LPTIM2_Handler() __attribute__((weak, alias("Default_Handler")));
...
extern "C" void USART3_USART4_LPUART1_Handler() __attribute__((weak, alias("Default_Handler")));
...
void (* const vector_table[])() = {
    ...
    UCPD1_UCPD2_Handler,  // IRQ 8: UCPD1_UCPD2
    ...
    TIM1_BRK_UP_TRG_COMP_Handler,  // IRQ 13: TIM1_BRK_UP_TRG_COMP
    ...
    USART3_USART4_LPUART1_Handler,  // IRQ 29: USART3_USART4_LPUART1
    CEC_Handler,  // IRQ 30: CEC
    RNG_Handler,  // IRQ 31: RNG
};
