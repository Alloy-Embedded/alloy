/// Auto-generated startup code for STM32L1xx
...
__attribute__((section(".isr_vector"), used)) void (*const vector_table[])() = {
    ...
    SDIO_Handler,                            // IRQ 45: SDIO
    TIM5_Handler,                            // IRQ 46: TIM5
    SPI3_Handler,                            // IRQ 47: SPI3
    DMA2_CH1_Handler,                        // IRQ 50: DMA2_CH1
    DMA2_CH2_Handler,                        // IRQ 51: DMA2_CH2
    DMA2_CH3_Handler,                        // IRQ 52: DMA2_CH3
    DMA2_CH4_Handler,                        // IRQ 53: DMA2_CH4
    DMA2_CH5_Handler,                        // IRQ 54: DMA2_CH5
    AES_Handler,                             // IRQ 55: AES
};
