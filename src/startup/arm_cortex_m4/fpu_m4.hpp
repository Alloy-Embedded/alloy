// Alloy Framework - ARM Cortex-M4 FPU (Floating Point Unit)
//
// Provides FPU initialization and configuration for Cortex-M4F cores
// (M4 cores with FPU support)
//
// Features:
// - FPU enable/disable
...
//
// Note: Cortex-M4F has single-precision FPU (32-bit float)
// For double precision, see Cortex-M7 (fpu_m7.hpp)
