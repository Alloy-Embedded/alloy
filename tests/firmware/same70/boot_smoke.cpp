...
constexpr std::uint32_t kBootMarkerMainReached = 0xA1107001u;
constexpr std::uint32_t kBootMarkerUartConfigFailed = 0xA1107002u;
constexpr auto kBootBanner = "alloy renode same70 boot ok\n";
