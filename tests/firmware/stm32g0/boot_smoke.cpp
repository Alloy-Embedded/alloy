...
constexpr std::uint32_t kBootMarkerMainReached = 0xA1100001u;
constexpr std::uint32_t kBootMarkerUartConfigFailed = 0xA1100002u;
constexpr auto kBootBanner = "alloy renode stm32g0 boot ok\n";
