...
def generate_for_board_mcus(verbose: bool = False, tracker=None) -> int:
    """
    Generate register map headers for all MCUs with pin functions.

    This ensures register_map.hpp is generated for every MCU that has
    ...
    """
    print_header("Generating Complete Register Maps for MCUs with Pin Functions")
