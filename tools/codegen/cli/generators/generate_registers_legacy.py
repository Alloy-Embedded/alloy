#!/usr/bin/env python3
"""
Generate Register Structure Headers from SVD (LEGACY)

⚠️  DEPRECATED: This is the legacy register generator.
    New code should use the UnifiedGenerator system.
...
import warnings
warnings.warn(
    "generate_registers_legacy.py is deprecated. Use UnifiedGenerator instead.",
    DeprecationWarning,
    stacklevel=2
)
