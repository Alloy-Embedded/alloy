...
from .commands import list_cmd, show_cmd, search_cmd, config_cmd, metadata_cmd, validate_cmd, init_cmd, build_cmd, docs_cmd
...
app.add_typer(docs_cmd.app, name="docs", help="Access documentation and examples")
