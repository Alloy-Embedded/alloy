...
constexpr uintptr_t I2SC1 = 0x40090000;  // 
...
constexpr uintptr_t PIOC = 0x400E1200;  // 
constexpr uintptr_t PIOD = 0x400E1400;  // 
constexpr uintptr_t PIOE = 0x400E1600;  // 
...
constexpr uintptr_t SDRAMC = 0x40084000;  // SDRAM Controller
constexpr uintptr_t SMC = 0x40080000;  // Static Memory Controller
constexpr uintptr_t SPI0 = 0x40008000;  // Serial Peripheral Interface
constexpr uintptr_t SPI1 = 0x40058000;  // 
...
namespace id {
constexpr uint8_t SUPC = 0;    // SUPC
constexpr uint8_t RSTC = 1;    // RSTC
constexpr uint8_t RTC = 2;    // RTC
constexpr uint8_t RTT = 3;    // RTT
constexpr uint8_t WDT = 4;    // WDT
constexpr uint8_t PMC = 5;    // PMC
constexpr uint8_t EFC = 6;    // EFC
constexpr uint8_t UART0 = 7;    // UART0
constexpr uint8_t UART1 = 8;    // UART1
constexpr uint8_t PIOA = 10;    // PIOA
constexpr uint8_t PIOB = 11;    // PIOB
constexpr uint8_t PIOC = 12;    // PIOC
constexpr uint8_t USART0 = 13;    // USART0
...
constexpr uint8_t HSMCI = 18;    // HSMCI
constexpr uint8_t TWIHS0 = 19;    // TWIHS0
constexpr uint8_t TWIHS1 = 20;    // TWIHS1
constexpr uint8_t SPI0 = 21;    // SPI0
constexpr uint8_t SSC = 22;    // SSC
constexpr uint8_t TC0 = 23;    // TC0
constexpr uint8_t TC1 = 24;    // TC1
constexpr uint8_t TC2 = 25;    // TC2
constexpr uint8_t TC3 = 26;    // TC3
constexpr uint8_t AFEC0 = 29;    // AFEC0
constexpr uint8_t DACC = 30;    // DACC
constexpr uint8_t PWM0 = 31;    // PWM0
constexpr uint8_t ICM = 32;    // ICM
constexpr uint8_t ACC = 33;    // ACC
constexpr uint8_t USBHS = 34;    // USBHS
constexpr uint8_t GMAC = 39;    // GMAC
constexpr uint8_t AFEC1 = 40;    // AFEC1
constexpr uint8_t TWIHS2 = 41;    // TWIHS2
constexpr uint8_t SPI1 = 42;    // SPI1
constexpr uint8_t QSPI = 43;    // QSPI
constexpr uint8_t UART2 = 44;    // UART2
constexpr uint8_t UART3 = 45;    // UART3
constexpr uint8_t UART4 = 46;    // UART4
constexpr uint8_t AES = 56;    // AES
constexpr uint8_t TRNG = 57;    // TRNG
constexpr uint8_t XDMAC = 58;    // XDMAC
constexpr uint8_t ISI = 59;    // ISI
constexpr uint8_t PWM1 = 60;    // PWM1
constexpr uint8_t FPU = 61;    // FPU
constexpr uint8_t SDRAMC = 62;    // SDRAMC
constexpr uint8_t RSWDT = 63;    // RSWDT
constexpr uint8_t I2SC0 = 69;    // I2SC0
constexpr uint8_t I2SC1 = 70;    // I2SC1
}  // namespace id
